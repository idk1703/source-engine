...
IMPLEMENT_DMEPANEL_FACTORY(CDmeDagEditPanel, DmeSourceAnimation, "DmeSourceAnimationPreview2",
						   "MDL Animation Previewer 2", false);
IMPLEMENT_DMEPANEL_FACTORY(CDmeDagEditPanel, DmeDCCMakefile, "DmeMakeFileOutputPreview2",
						   "DCC MakeFile Output Previewer 2", false);
...
static int __cdecl AnimationNameSortFunc(vgui::ListPanel *pPanel, const vgui::ListPanelItem &item1,
...
// constructor, destructor
//-----------------------------------------------------------------------------
CDmeAnimationListPanel::CDmeAnimationListPanel(vgui::Panel *pParent, const char *pName) : BaseClass(pParent, pName)
{
...
private:
	...
	void GenerateProceduralPresetValues(CDmElement *pPreset, const CDmrElementArray<CDmElement> &controls,
										bool bIdentity, float flForceValue = -1.0f);
...
// Sets preset values
//-----------------------------------------------------------------------------
void CDmeCombinationOperatorPanel::GenerateProceduralPresetValues(CDmElement *pPreset, CDmElement *ctrl,
																  bool bForceValue, float flForceValue)
{
...
void CDmeCombinationOperatorPanel::GenerateProceduralPresetValues(CDmElement *pPreset,
																  const CDmrElementArray<CDmElement> &controls,
																  bool bIdentity, float flForceValue /*= -1.0f*/)
{
