...
{
	if(IsDropMenuButtonStyle() && m_pDropMenuImage)
	{
		int mx, my;
...
// This style is like the IE "back" button where the left side acts like a regular button, the the right side has a
// little
