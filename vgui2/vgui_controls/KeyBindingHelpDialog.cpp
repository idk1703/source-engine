...
CKeyBindingHelpDialog::CKeyBindingHelpDialog(Panel *parent, Panel *panelToView, KeyBindingContextHandle_t handle,
...
{
	if(!Q_stricmp(cmd, "OK") || !Q_stricmp(cmd, "cancel") || !Q_stricmp(cmd, "Close"))
	{
		MarkForDeletion();
	}
