...
//-----------------------------------------------------------------------------
bool ProgressBar::ConstructTimeRemainingString(wchar_t *output, int outputBufferSizeInBytes, float startTime,
		...
		case PROGRESS_EAST:
			if(bUsePrev)
			{
				if(bGain)
				{
					...
					surface()->DrawFilledRect(x + (int)(wide * _prevProgress), y, x + (int)(wide * _progress),
											  y + tall);
					break;
				}
				else
				{
					...
					surface()->DrawFilledRect(x + (int)(wide * _progress), y, x + (int)(wide * _prevProgress),
											  y + tall);
				}
			}
			surface()->DrawSetColor(GetFgColor());
			...
			if(bUsePrev)
			{
				if(bGain)
				{
					...
					surface()->DrawFilledRect(x + (int)(wide * (1.0f - _progress)), y,
											  x + (int)(wide * (1.0f - _prevProgress)), y + tall);
					break;
				}
				else
				{
					// Delta
					surface()->DrawSetColor(m_colorLoss);
					surface()->DrawFilledRect(x + (int)(wide * (1.0f - _prevProgress)), y,
											  x + (int)(wide * (1.0f - _progress)), y + tall);
				}
			}
			surface()->DrawSetColor(GetFgColor());
		...
		case PROGRESS_NORTH:
			if(bUsePrev)
			{
				if(bGain)
				{
					...
					// Delta
					surface()->DrawSetColor(m_colorGain);
					surface()->DrawFilledRect(x, y + (int)(tall * (1.0f - _progress)), x + wide,
											  y + (int)(tall * (1.0f - _prevProgress)));
					break;
				}
				else
				{
					// Delta
					surface()->DrawSetColor(m_colorLoss);
					surface()->DrawFilledRect(x, y + (int)(tall * (1.0f - _prevProgress)), x + wide,
											  y + (int)(tall * (1.0f - _progress)));
				}
			}
			surface()->DrawSetColor(GetFgColor());
