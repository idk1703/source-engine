...
void *CVguiMatSysApp::CreateAppWindow(char const *pTitle, bool bWindowed, int w, int h)
{
	...
	// Create the window
	void *hWnd = CreateWindow(wc.lpszClassName, pTitle, style, 0, 0, windowRect.right - windowRect.left,
	...
	SetWindowPos((HWND)hWnd, NULL, CenterX, CenterY, 0, 0, SWP_NOSIZE | SWP_NOZORDER | SWP_SHOWWINDOW | SWP_DRAWFRAME);
