...
public:
	...
	virtual void LoadBlockFromFileName(
		const char *pFilename,
		IRecordingSession *pSession); // NOTE: This will not actually add the block to the session block manager - this
									  // is for loading blocks and adding them to recording sessions so they can be
									  // deleted from disk and cleaned up from the fileserver if necessary.
...
private:
	...
	{
		return "blocks." GENERIC_FILE_EXTENSION;
	}
};
