...
CPublishTester::CPublishTester() : m_pGarbageBuffer(NULL), m_pJob(NULL), m_pCleanerJob(NULL)
{
...
bool CPublishTester::Test_Path(const char *pDescription, const char *pPath, bool bForwardSlashesAllowed,
							   bool bBackslashesAllowed)
{
