...
class CReplayMovieManager : public CGenericPersistentManager<CReplayMovie>, public IReplayMovieManager
{
...
public:
	...
	virtual bool RenderingCancelled() const
	{
		return m_bRenderingCancelled;
	}
	...
	RenderMovieParams_t &GetRenderMovieSettings()
	{
		return *m_pRenderMovieSettings;
	}
...
private:
	...
	{
		return "movies." GENERIC_FILE_EXTENSION;
	}
