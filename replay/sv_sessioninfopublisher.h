...
public:
	...
	bool IsPublishingSessionInfo() const
	{
		return m_flSessionInfoPublishTime != 0.0f || m_pFilePublisher;
	}
	bool IsDone() const;
...
private:
	...
	bool m_bShouldPublish; // True if we should publish - can be true while already publishing.  Means another publish
						   // is needed.
};
