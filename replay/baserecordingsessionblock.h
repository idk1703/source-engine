...
public:
	...
	{
		ERROR_NONE,
		ERROR_NOTONDISK,   // The replay was lost somehow - eg a server crash before the replay had a chance to write to
						   // disk
	...
	uint32
		m_uFileSize; // Size in bytes of the binary block file (if compressed, this represents the compressed file size)
	...
	CompressorType_t m_nCompressorType; // What type of compressor/decompressor was/should be used, if any?  Can be
										// COMPRESSORTYPE_INVALID if not compressed.
