...
public:
	...
	CBaseRecordingSession *GetRecordingSessionInProgress()
	{
		return m_pRecordingSession;
	}

	bool LastSessionDitched() const
	{
		return m_bLastSessionDitched;
	}
...
protected:
	...
	{
		return "sessions." GENERIC_FILE_EXTENSION;
	}
	...
	virtual bool ShouldUnloadSessions() const
	{
		return false;
	}
