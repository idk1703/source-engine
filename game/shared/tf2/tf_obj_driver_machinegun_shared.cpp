...
ConVar obj_driver_machinegun_health("obj_driver_machinegun_health", "100", FCVAR_REPLICATED,
									"Driver's mounted machinegun health");
ConVar obj_driver_machinegun_range("obj_driver_machinegun_range", "1048", FCVAR_REPLICATED,
								   "Driver's mounted machinegun range");
ConVar obj_driver_machinegun_damage("obj_driver_machinegun_damage", "10", FCVAR_REPLICATED,
									"Driver's mounted machinegun damage");
ConVar obj_driver_machinegun_max_ammo("obj_driver_machinegun_max_ammo", "30", FCVAR_REPLICATED,
									  "Driver's mounted machinegun ammo");
ConVar obj_driver_machinegun_ammo_recharge_rate("obj_driver_machinegun_ammo_recharge_rate", "0.5", FCVAR_REPLICATED,
												"Driver's mounted machinegun ammo recharge rate");
...
void CObjectDriverMachinegun::Fire(CBaseTFPlayer *pDriver)
{
	...
	TFGameRules()->FireBullets(CTakeDamageInfo(this, pDriver, obj_driver_machinegun_damage.GetFloat(), DMG_BULLET), 1,
							   vecSrc, vecAim, spread, obj_driver_machinegun_range.GetFloat(), m_nAmmoType, 4,
							   entindex(), m_nBarrelAttachment);
