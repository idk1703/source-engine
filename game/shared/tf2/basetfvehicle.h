...
public:
	...
	virtual float Weapon_PrimaryCanFireAt(void)
	{
		return gpGlobals->curtime;
	} // Return the time at which this vehicle's primary weapon can fire again
	virtual float Weapon_SecondaryCanFireAt(void)
	{
		return gpGlobals->curtime;
	} // Return the time at which this vehicle's secondary weapon can fire again
	...
	virtual bool IsPassengerDamagable(int nRole)
	{
	...
	virtual bool IsPassengerUsingStandardWeapons(int nRole = VEHICLE_DRIVER)
	{
		return false;
	}
