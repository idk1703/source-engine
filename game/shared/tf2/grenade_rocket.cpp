...
()
	...
	// Function Pointers
	DEFINE_FUNCTION(MissileTouch), DEFINE_FUNCTION(FollowThink),
...
//-----------------------------------------------------------------------------
CGrenadeRocket *CGrenadeRocket::Create(const Vector &vecOrigin, const Vector &vecForward, edict_t *pentOwner = NULL,
									   CBaseEntity *pRealOwner = NULL)
{
