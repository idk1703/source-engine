...
// Damage CVars
static ConVar weapon_objectsapper_damage("weapon_objectsapper_damage", "50", FCVAR_NONE,
										 "Damage done, per second, by the object sapper.");
...
//-----------------------------------------------------------------------------
CGrenadeObjectSapper *CGrenadeObjectSapper::Create(const Vector &vecOrigin, const Vector &vecForward,
												   CBasePlayer *pOwner, CBaseObject *pObject)
{
