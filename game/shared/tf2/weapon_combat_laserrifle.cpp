...
ConVar weapon_combat_laserrifle_range("weapon_combat_laserrifle_range", "1000", FCVAR_REPLICATED,
									  "Laser rifle maximum range");
ConVar weapon_combat_laserrifle_ducking_mod("weapon_combat_laserrifle_ducking_mod", "0.75", FCVAR_REPLICATED,
											"Laser rifle ducking ROF modifier");
...
void CWeaponCombatLaserRifle::PrimaryAttack(void)
{
	...
	TFGameRules()->FireBullets(CTakeDamageInfo(this, pPlayer, weapon_combat_laserrifle_damage.GetFloat(), DMG_PLASMA),
							   1, vecSrc, vecAiming, vecSpread, weapon_combat_laserrifle_range.GetFloat(),
							   m_iPrimaryAmmoType, 0, entindex(), 0);
...
void CWeaponCombatLaserRifle::DrawCrosshair(void)
{
	...
	vgui::surface()->DrawFilledRect(iLeft + iTotalWidth - iBarWidth, iMidHeight - 1, iLeft + iTotalWidth,
									iMidHeight + 2);
	...
	vgui::surface()->DrawFilledRect(iMidWidth - 1, iTop + iTotalHeight - iBarHeight, iMidWidth + 2,
									iTop + iTotalHeight);
