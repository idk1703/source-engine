...
// Damage CVars
ConVar weapon_limpetmine_grenade_damage("weapon_limpetmine_grenade_damage", "0", FCVAR_NONE,
										"Limpet Mine's grenade maximum damage");
ConVar weapon_limpetmine_grenade_radius("weapon_limpetmine_grenade_radius", "0", FCVAR_NONE,
										"Limpet Mine's grenade splash radius");

// Global Savedata for friction modifier
BEGIN_DATADESC(CLimpetMine)
	// Function Pointers
	DEFINE_THINKFUNC(LiveThink), DEFINE_ENTITYFUNC(StickyTouch), DEFINE_THINKFUNC(LimpetThink),
END_DATADESC()
