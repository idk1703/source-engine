...
// Inaccuracy Data
// These values are all max inaccuracies. The accuracy used is between 0 & Max, based upon how close the player gets to
// hitting the fire button at the right time on the mortar firing slider bar. Perpendicular-to-the-shot inaccuracy
