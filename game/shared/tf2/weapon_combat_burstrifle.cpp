...
ConVar weapon_combat_burstrifle_range("weapon_combat_burstrifle_range", "500", FCVAR_REPLICATED,
									  "Burst Rifle maximum range");
ConVar weapon_combat_burstrifle_ducking_mod("weapon_combat_burstrifle_ducking_mod", "0.75", FCVAR_REPLICATED,
											"Burst Rifle ducking speed modifier");
...
void CWeaponCombatBurstRifle::PrimaryAttack(void)
{
	...
	*/
	...
	CPowerPlasmaProjectile *pPlasma =
		CPowerPlasmaProjectile::CreatePredicted(vecStartSpot, vecDir, gunOffset, DMG_ENERGYBEAM, pPlayer);
	if(pPlasma)
	{
