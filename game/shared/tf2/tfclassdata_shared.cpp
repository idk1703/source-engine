...
BEGIN_PREDICTION_DATA_NO_BASE(PlayerClassReconData_t)
	...
	DEFINE_FIELD(m_nJumpCount, FIELD_INTEGER), DEFINE_FIELD(m_flSuppressionJumpTime, FIELD_FLOAT),
		DEFINE_FIELD(m_flSuppressionImpactTime, FIELD_FLOAT), DEFINE_FIELD(m_flActiveJumpTime, FIELD_FLOAT),
		DEFINE_FIELD(m_flStickTime, FIELD_FLOAT), DEFINE_FIELD(m_vecImpactNormal, FIELD_VECTOR),
		DEFINE_FIELD(m_flImpactDist, FIELD_FLOAT), DEFINE_FIELD(m_vecUnstickVelocity, FIELD_VECTOR),
