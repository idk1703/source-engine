...
struct PlayerClassCommandoData_t
{
	...
	enum
	{
		PLAYERCLASS_ID = TFCLASS_COMMANDO
	};
...
struct PlayerClassDefenderData_t
{
	...
	enum
	{
		PLAYERCLASS_ID = TFCLASS_DEFENDER
	};
};
...
struct PlayerClassInfiltratorData_t
{
	...
	enum
	{
		PLAYERCLASS_ID = TFCLASS_INFILTRATOR
	};
};
...
struct PlayerClassSupportData_t
{
	...
	enum
	{
		PLAYERCLASS_ID = TFCLASS_SUPPORT
	};
};
