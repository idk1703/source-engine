...
ConVar weapon_combat_shotgun_powered_damage("weapon_combat_shotgun_powered_damage", "10", FCVAR_REPLICATED,
											"Shotgun damage per pellet when powered");
ConVar weapon_combat_shotgun_range("weapon_combat_shotgun_range", "900", FCVAR_REPLICATED, "Shotgun maximum range");
ConVar weapon_combat_shotgun_pellets("weapon_combat_shotgun_pellets", "8", FCVAR_REPLICATED,
									 "Shotgun pellets per fire");
ConVar weapon_combat_shotgun_ducking_mod("weapon_combat_shotgun_ducking_mod", "0.75", FCVAR_REPLICATED,
										 "Shotgun ducking speed modifier");
ConVar weapon_combat_shotgun_energy_cost("weapon_combat_shotgun_energy_cost", "0.1", FCVAR_REPLICATED,
										 "Sapper's energy cost to fire a powered shotgun round");
...
void CWeaponCombatShotgun::PrimaryAttack(void)
{
	...
	TFGameRules()->FireBullets(info, weapon_combat_shotgun_pellets.GetFloat(), vecSrc, vecAiming, GetBulletSpread(),
							   weapon_combat_shotgun_range.GetFloat(), m_iPrimaryAmmoType, 2, entindex(), 0);
...
// Purpose:
//-----------------------------------------------------------------------------
bool CWeaponCombatShotgun::OnFireEvent(C_BaseViewModel *pViewModel, const Vector &origin, const QAngle &angles,
