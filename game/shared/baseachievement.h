...
public:
	...
	} // for debugging, achievements may report additional status in achievement_status concmd
...
protected:
	...
	bool m_bStoreProgressInSteam; // should incremental progress be stored in Steam.  A counter with same name as
...
#define DECLARE_MAP_EVENT_ACHIEVEMENT_(achievementID, achievementName, gameDirFilter, iPointValue, bHidden)       \
	...
	DECLARE_ACHIEVEMENT_(CAchievement##achievementID, achievementID, achievementName, gameDirFilter, iPointValue, \
						 bHidden)
