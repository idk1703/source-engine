...
static HL2MPViewVectors g_HL2MPViewVectors(Vector(0, 0, 64), // VEC_VIEW (m_vView)
...
END_RECV_TABLE()
#else
void *SendProxy_HL2MPRules(const SendProp *pProp, const void *pStructBase, const void *pData,
