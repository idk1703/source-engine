...
public:
	...
	friend ISDKPlayerAnimState *CreatePlayerAnimState(CBaseAnimatingOverlay *pEntity,
													  ISDKPlayerAnimStateHelpers *pHelpers, LegAnimType_t legAnimType,
	...
	void InitSDK(CBaseAnimatingOverlay *pPlayer, ISDKPlayerAnimStateHelpers *pHelpers, LegAnimType_t legAnimType,
				 bool bUseAimSequences);
...
ISDKPlayerAnimState *CreatePlayerAnimState(CBaseAnimatingOverlay *pEntity, ISDKPlayerAnimStateHelpers *pHelpers,
...
void CSDKPlayerAnimState::InitSDK(CBaseAnimatingOverlay *pEntity, ISDKPlayerAnimStateHelpers *pHelpers,
								  LegAnimType_t legAnimType, bool bUseAimSequences)
{
...
#ifdef CLIENT_DLL
void CSDKPlayerAnimState::UpdateLayerSequenceGeneric(CStudioHdr *pStudioHdr, int iLayer, bool &bEnabled,
