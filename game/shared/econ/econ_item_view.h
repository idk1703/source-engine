...
public:
	...
	void AdjustRuntimeAttributeRefundableCurrency(const CEconItemAttributeDefinition *pAttrDef,
												  int iRefundableCurrencyAdjustment)
	{
		SetRuntimeAttributeRefundableCurrency(pAttrDef, GetRuntimeAttributeRefundableCurrency(pAttrDef) +
															iRefundableCurrencyAdjustment);
	}
...
#ifdef CLIENT_DLL // we avoid using "BUILD_ITEM_NAME_AND_DESC" to prevent everything depending on the
...
public:
	...
	const class CEconItemDescription *GetDescription() const
	{
