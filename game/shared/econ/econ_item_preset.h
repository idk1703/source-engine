...
struct PresetSlotItem_t
{
	...
	itemid_t m_ulItemOriginalID; // Original ID of the item in this slot. We store this instead of the current ID to
								 // avoid breaking presets when items get renamed, etc.
};
...
public:
	...
	equipped_class_t GetClass() const
	{
		return m_unClassID;
	}
#endif // GC_DLL
