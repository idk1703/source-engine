...
enum
{
	...
	kGameAccountFlags_DONT_USE_THIS_BUI_LIES =
		1 << 7, // some accounts might have this set! it used to be the "needs to thank a friend" bit
	...
	kGameAccountFlags_GC_UpgradedToPremium = 1 << 12, // we did something (used an item, whatever) on the GC that means
													  // the GC has decided we're premium regardless of what Steam says
	// Deprecated
