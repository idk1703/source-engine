...
#define PRECACHE_WEAPON_REGISTER(className) \
	static CPrecacheRegister precache_weapon_##className(&CPrecacheRegister::PrecacheFn_Other, #className)
#define PRECACHE_REGISTER(className) \
	static CPrecacheRegister precache_other_##className(&CPrecacheRegister::PrecacheFn_Other, #className)
