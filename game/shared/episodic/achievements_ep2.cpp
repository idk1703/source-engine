...
DECLARE_ACHIEVEMENT(CAchievementEp2KillEnemiesWithCar, ACHIEVEMENT_EP2_KILL_ENEMIES_WITHCAR, "EP2_KILL_ENEMIES_WITHCAR",
					5);
...
DECLARE_ACHIEVEMENT(CAchievementEp2KillHunterWithFlechette, ACHIEVEMENT_EP2_KILL_HUNTER_WITHFLECHETTES,
...
class CAchievementEp2FindAllWebCaches : public CBaseAchievement
{
	virtual void Init()
	{
		static const char *szComponents[] = {"EP2_WEBCACHE_01", "EP2_WEBCACHE_02", "EP2_WEBCACHE_03",
...
DECLARE_ACHIEVEMENT(CAchievementEp2KillChopperNoMisses, ACHIEVEMENT_EP2_KILL_CHOPPER_NOMISSES,
...
class CAchievementEp2FindAllRadarCaches : public CBaseAchievement
{
	virtual void Init()
	{
		static const char *szComponents[] = {"EP2_RADARCACHE_VAN", "EP2_RADARCACHE_SHACK", "EP2_RADARCACHE_RPG",
...
DECLARE_ACHIEVEMENT(CAchievementEp2FindAllRadarCaches, ACHIEVEMENT_EP2_FIND_ALLRADARCACHES, "EP2_FIND_ALLRADARCACHES",
					10);

// Ep2-specific macro that sets game dir filter.  We need this because Ep1/Ep2/... share a binary so we need runtime
// check against running game.
...
DECLARE_EP2_MAP_EVENT_ACHIEVEMENT(ACHIEVEMENT_EP2_BEAT_OUTLAND12_NOBUILDINGSDESTROYED,
