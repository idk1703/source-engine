...
DECLARE_ACHIEVEMENT(CAchievementPortalBeat2AdvancedMaps, ACHIEVEMENT_PORTAL_BEAT_2ADVANCEDMAPS,
					"PORTAL_BEAT_2ADVANCEDMAPS", 10);
...
DECLARE_ACHIEVEMENT(CAchievementPortalBeat4AdvancedMaps, ACHIEVEMENT_PORTAL_BEAT_4ADVANCEDMAPS,
					"PORTAL_BEAT_4ADVANCEDMAPS", 20);
...
DECLARE_ACHIEVEMENT(CAchievementPortalBeat6AdvancedMaps, ACHIEVEMENT_PORTAL_BEAT_6ADVANCEDMAPS,
					"PORTAL_BEAT_6ADVANCEDMAPS", 30);
...
DECLARE_ACHIEVEMENT(CAchievementPortalDetachAllCameras, ACHIEVEMENT_PORTAL_DETACH_ALL_CAMERAS,
					"PORTAL_DETACH_ALL_CAMERAS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementPortalHitTurretWithTurret, ACHIEVEMENT_PORTAL_HIT_TURRET_WITH_TURRET,
					"PORTAL_HIT_TURRET_WITH_TURRET", 5);
...
DECLARE_ACHIEVEMENT(CAchievementPortalFindAllDinosaurs, ACHIEVEMENT_PORTAL_TRANSMISSION_RECEIVED,
					"PORTAL_TRANSMISSION_RECEIVED", 0);
#endif // _XBOX
