...
void RegisterUserMessages()
{
	...
	usermessages->Register("Damage",
						   18); // BUG: floats are sent for coords, no variable bitfields in hud & fixed size Msg
	...
	usermessages->Register("EntityPortalled", sizeof(long) + sizeof(long) + sizeof(Vector) +
												  sizeof(QAngle)); // something got teleported through a portal
