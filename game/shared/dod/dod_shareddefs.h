...
#define VEC_PRONE_HULL_MAX \
	DODGameRules()->GetDODViewVectors()->m_vProneHullMax // MUST be shorter than duck hull for deploy check

#define VEC_PRONE_HULL_MIN_SCALED(player) \
	(DODGameRules()->GetDODViewVectors()->m_vProneHullMin * player->GetModelScale())
#define VEC_PRONE_HULL_MAX_SCALED(player) \
	(DODGameRules()->GetDODViewVectors()->m_vProneHullMax * player->GetModelScale())
