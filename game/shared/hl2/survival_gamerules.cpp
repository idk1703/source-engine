...
BEGIN_RECV_TABLE(CHalfLife2SurvivalProxy, DT_HalfLife2SurvivalProxy)
	RecvPropDataTable("hl2_survival_gamerules_data", 0, 0, &REFERENCE_RECV_TABLE(DT_HL2SurvivalGameRules),
					  RecvProxy_HL2SurvivalGameRules)
END_RECV_TABLE()
#else
void *SendProxy_HL2SurvivalGameRules(const SendProp *pProp, const void *pStructBase, const void *pData,
...
BEGIN_SEND_TABLE(CHalfLife2SurvivalProxy, DT_HalfLife2SurvivalProxy)
	SendPropDataTable("hl2_survival_gamerules_data", 0, &REFERENCE_SEND_TABLE(DT_HL2SurvivalGameRules),
					  SendProxy_HL2SurvivalGameRules)
END_SEND_TABLE()
#endif
...
void CHalfLife2Survival::PlayerSpawn(CBasePlayer *pPlayer)
{
	...
	{
		pPlayer->CBasePlayer::GiveAmmo(m_SurvivalSettings.m_Ammo[i].m_iAmount,
