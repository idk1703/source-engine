...
// entity capabilities
// These are caps bits to indicate what an object's capabilities (currently used for +USE, save/restore and level
// transitions)
...
#define FCAP_NOTIFY_ON_TRANSITION \
	0x00000008 // Entity will receive Inside/Outside transition inputs when a transition occurs
