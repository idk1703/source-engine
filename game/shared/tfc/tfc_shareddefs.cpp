...
const char *g_AmmoTypeNames[] = {"DUMMY AMMO",			TFC_AMMO_SHELLS_NAME,	 TFC_AMMO_NAILS_NAME,
								 TFC_AMMO_ROCKETS_NAME, TFC_AMMO_CELLS_NAME,	 TFC_AMMO_MEDIKIT_NAME,
								 TFC_AMMO_DETPACK_NAME, TFC_AMMO_GRENADES1_NAME, TFC_AMMO_GRENADES2_NAME};
