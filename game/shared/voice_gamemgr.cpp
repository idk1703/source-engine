...
CPlayerBitVec
	g_SentGameRulesMasks[VOICE_MAX_PLAYERS]; // These store the masks we last sent to each client so we can determine if
...
ConVar sv_alltalk("sv_alltalk", "0", FCVAR_NOTIFY | FCVAR_REPLICATED,
