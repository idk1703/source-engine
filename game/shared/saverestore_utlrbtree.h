...
public:
	...
	virtual void Save(const SaveRestoreFieldInfo_t &fieldInfo, ISave *pSave)
	{
		...
		typedescription_t dataDesc = {
			(fieldtype_t)FIELD_TYPE, "elem", {0, 0}, 1, FTYPEDESC_SAVE, NULL, NULL, NULL, pTreeTypeDatamap, -1,
		};
	...
	virtual void Restore(const SaveRestoreFieldInfo_t &fieldInfo, IRestore *pRestore)
	{
		datamap_t *pTreeTypeDatamap = CTypedescDeducer<FIELD_TYPE>::Deduce((UTLRBTREE *)NULL);
		typedescription_t dataDesc = {
			(fieldtype_t)FIELD_TYPE, "elems", {0, 0}, 1, FTYPEDESC_SAVE, NULL, NULL, NULL, pTreeTypeDatamap, -1,
		};
...
#define DEFINE_UTLRBTREE(name, fieldtype)                                                                \
	{                                                                                                    \
		FIELD_CUSTOM, #name, {offsetof(classNameTypedef, name), 0}, 1, FTYPEDESC_SAVE, NULL,             \
			CUtlRBTreeDataopsInstantiator<fieldtype>::GetDataOps(&(((classNameTypedef *)0)->name)), NULL \
	}
