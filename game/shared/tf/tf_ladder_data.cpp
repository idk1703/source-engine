...
bool CSOTFLadderData::BIsKeyLess(const CSharedObject &soRHS) const
{
	...
	if(obj.account_id() < rhs.account_id())
		return true;
	if(obj.account_id() > rhs.account_id())
		return false;
	if(obj.match_group() < rhs.match_group())
		return true;
	if(obj.match_group() > rhs.match_group())
		return false;
...
bool CSOTFLadderData::BYieldingAddWriteToTransaction(GCSDK::CSQLAccess &sqlAccess, const CUtlVector<int> &fields)
{
	...
	FOR_EACH_VEC(fields, nField)
	{
		...
		{
			case CSOTFLadderPlayerStats::kAccountIdFieldNumber:
				csDatabaseDirty.BAddColumn(CSchLadderData::k_iField_unAccountID);
				break;
			case CSOTFLadderPlayerStats::kMatchGroupFieldNumber:
				csDatabaseDirty.BAddColumn(CSchLadderData::k_iField_nMatchGroup);
				break;
			case CSOTFLadderPlayerStats::kSeasonIdFieldNumber:
				csDatabaseDirty.BAddColumn(CSchLadderData::k_iField_unSeasonID);
				break;

			case CSOTFLadderPlayerStats::kRankFieldNumber:
				csDatabaseDirty.BAddColumn(CSchLadderData::k_iField_unRank);
				break;
			case CSOTFLadderPlayerStats::kHighestRankFieldNumber:
				csDatabaseDirty.BAddColumn(CSchLadderData::k_iField_unHighestRank);
				break;
			case CSOTFLadderPlayerStats::kExperienceFieldNumber:
				csDatabaseDirty.BAddColumn(CSchLadderData::k_iField_unExperience);
				break;
			case CSOTFLadderPlayerStats::kLastAckdExperienceFieldNumber:
				csDatabaseDirty.BAddColumn(CSchLadderData::k_iField_unLastAckdExperience);
				break;

			case CSOTFLadderPlayerStats::kGamesFieldNumber:
				csDatabaseDirty.BAddColumn(CSchLadderData::k_iField_unGames);
				break;
			case CSOTFLadderPlayerStats::kScoreFieldNumber:
				csDatabaseDirty.BAddColumn(CSchLadderData::k_iField_unScore);
				break;
			case CSOTFLadderPlayerStats::kKillsFieldNumber:
				csDatabaseDirty.BAddColumn(CSchLadderData::k_iField_unKills);
				break;
			case CSOTFLadderPlayerStats::kDeathsFieldNumber:
				csDatabaseDirty.BAddColumn(CSchLadderData::k_iField_unDeaths);
				break;
			case CSOTFLadderPlayerStats::kDamageFieldNumber:
				csDatabaseDirty.BAddColumn(CSchLadderData::k_iField_unDamage);
				break;
			case CSOTFLadderPlayerStats::kHealingFieldNumber:
				csDatabaseDirty.BAddColumn(CSchLadderData::k_iField_unHealing);
				break;
			case CSOTFLadderPlayerStats::kSupportFieldNumber:
				csDatabaseDirty.BAddColumn(CSchLadderData::k_iField_unSupport);
				break;

			case CSOTFLadderPlayerStats::kScoreBronzeFieldNumber:
				csDatabaseDirty.BAddColumn(CSchLadderData::k_iField_unScoreBronze);
				break;
			case CSOTFLadderPlayerStats::kScoreSilverFieldNumber:
				csDatabaseDirty.BAddColumn(CSchLadderData::k_iField_unScoreSilver);
				break;
			case CSOTFLadderPlayerStats::kScoreGoldFieldNumber:
				csDatabaseDirty.BAddColumn(CSchLadderData::k_iField_unScoreGold);
				break;
			case CSOTFLadderPlayerStats::kKillsBronzeFieldNumber:
				csDatabaseDirty.BAddColumn(CSchLadderData::k_iField_unKillsBronze);
				break;
			case CSOTFLadderPlayerStats::kKillsSilverFieldNumber:
				csDatabaseDirty.BAddColumn(CSchLadderData::k_iField_unKillsSilver);
				break;
			case CSOTFLadderPlayerStats::kKillsGoldFieldNumber:
				csDatabaseDirty.BAddColumn(CSchLadderData::k_iField_unKillsGold);
				break;
			case CSOTFLadderPlayerStats::kDamageBronzeFieldNumber:
				csDatabaseDirty.BAddColumn(CSchLadderData::k_iField_unDamageBronze);
				break;
			case CSOTFLadderPlayerStats::kDamageSilverFieldNumber:
				csDatabaseDirty.BAddColumn(CSchLadderData::k_iField_unDamageSilver);
				break;
			case CSOTFLadderPlayerStats::kDamageGoldFieldNumber:
				csDatabaseDirty.BAddColumn(CSchLadderData::k_iField_unDamageGold);
				break;
			case CSOTFLadderPlayerStats::kHealingBronzeFieldNumber:
				csDatabaseDirty.BAddColumn(CSchLadderData::k_iField_unHealingBronze);
				break;
			case CSOTFLadderPlayerStats::kHealingSilverFieldNumber:
				csDatabaseDirty.BAddColumn(CSchLadderData::k_iField_unHealingSilver);
				break;
			case CSOTFLadderPlayerStats::kHealingGoldFieldNumber:
				csDatabaseDirty.BAddColumn(CSchLadderData::k_iField_unHealingGold);
				break;
			case CSOTFLadderPlayerStats::kSupportBronzeFieldNumber:
				csDatabaseDirty.BAddColumn(CSchLadderData::k_iField_unSupportBronze);
				break;
			case CSOTFLadderPlayerStats::kSupportSilverFieldNumber:
				csDatabaseDirty.BAddColumn(CSchLadderData::k_iField_unSupportSilver);
				break;
			case CSOTFLadderPlayerStats::kSupportGoldFieldNumber:
				csDatabaseDirty.BAddColumn(CSchLadderData::k_iField_unSupportGold);
				break;
...
void GetLocalPlayerMatchHistory(EMatchGroup nMatchGroup, CUtlVector<CSOTFMatchResultPlayerStats> &vecMatchesOut)
{
	if(steamapicontext && steamapicontext->SteamUser())
	{
		...
		if(pSOCache)
		{
			GCSDK::CGCClientSharedObjectTypeCache *pTypeCache =
				pSOCache->FindTypeCache(CSOTFMatchResultPlayerInfo::k_nTypeID);
			if(pTypeCache)
			{
				for(uint32 i = 0; i < pTypeCache->GetCount(); ++i)
				{
...
// Purpose:
//-----------------------------------------------------------------------------
bool CSOTFMatchResultPlayerInfo::BYieldingAddWriteToTransaction(GCSDK::CSQLAccess &sqlAccess,
																const CUtlVector<int> &fields)
{
	CSchMatchResultPlayerInfo schMatchInfo;
	WriteToRecord(&schMatchInfo);
	...
	FOR_EACH_VEC(fields, nField)
	{
		switch(fields[nField])
		{
			case CSOTFMatchResultPlayerStats::kMatchIdFieldNumber:
				csDatabaseDirty.BAddColumn(CSchMatchResultPlayerInfo::k_iField_unMatchID);
				break;
			case CSOTFMatchResultPlayerStats::kAccountIdFieldNumber:
				csDatabaseDirty.BAddColumn(CSchMatchResultPlayerInfo::k_iField_unAccountID);
				break;
			case CSOTFMatchResultPlayerStats::kMatchGroupFieldNumber:
				csDatabaseDirty.BAddColumn(CSchMatchResultPlayerInfo::k_iField_nMatchGroup);
				break;
			case CSOTFMatchResultPlayerStats::kEndtimeFieldNumber:
				csDatabaseDirty.BAddColumn(CSchMatchResultPlayerInfo::k_iField_RTime32Stamp);
				break;
			case CSOTFMatchResultPlayerStats::kSeasonIdFieldNumber:
				csDatabaseDirty.BAddColumn(CSchMatchResultPlayerInfo::k_iField_unSeasonID);
				break;
			case CSOTFMatchResultPlayerStats::kStatusFieldNumber:
				csDatabaseDirty.BAddColumn(CSchMatchResultPlayerInfo::k_iField_unStatus);
				break;

			case CSOTFMatchResultPlayerStats::kPartyIdFieldNumber:
				csDatabaseDirty.BAddColumn(CSchMatchResultPlayerInfo::k_iField_unPartyID);
				break;
			case CSOTFMatchResultPlayerStats::kTeamFieldNumber:
				csDatabaseDirty.BAddColumn(CSchMatchResultPlayerInfo::k_iField_unTeam);
				break;
			case CSOTFMatchResultPlayerStats::kScoreFieldNumber:
				csDatabaseDirty.BAddColumn(CSchMatchResultPlayerInfo::k_iField_unScore);
				break;
			case CSOTFMatchResultPlayerStats::kPingFieldNumber:
				csDatabaseDirty.BAddColumn(CSchMatchResultPlayerInfo::k_iField_unPing);
				break;
			case CSOTFMatchResultPlayerStats::kFlagsFieldNumber:
				csDatabaseDirty.BAddColumn(CSchMatchResultPlayerInfo::k_iField_unFlags);
				break;
			case CSOTFMatchResultPlayerStats::kDisplayRatingFieldNumber:
				csDatabaseDirty.BAddColumn(CSchMatchResultPlayerInfo::k_iField_unDisplayRating);
				break;
			case CSOTFMatchResultPlayerStats::kDisplayRatingChangeFieldNumber:
				csDatabaseDirty.BAddColumn(CSchMatchResultPlayerInfo::k_iField_nDisplayRatingChange);
				break;
			case CSOTFMatchResultPlayerStats::kRankFieldNumber:
				csDatabaseDirty.BAddColumn(CSchMatchResultPlayerInfo::k_iField_unRank);
				break;
			case CSOTFMatchResultPlayerStats::kClassesPlayedFieldNumber:
				csDatabaseDirty.BAddColumn(CSchMatchResultPlayerInfo::k_iField_unClassesPlayed);
				break;

			case CSOTFMatchResultPlayerStats::kKillsFieldNumber:
				csDatabaseDirty.BAddColumn(CSchMatchResultPlayerInfo::k_iField_unKills);
				break;
			case CSOTFMatchResultPlayerStats::kDeathsFieldNumber:
				csDatabaseDirty.BAddColumn(CSchMatchResultPlayerInfo::k_iField_unDeaths);
				break;
			case CSOTFMatchResultPlayerStats::kDamageFieldNumber:
				csDatabaseDirty.BAddColumn(CSchMatchResultPlayerInfo::k_iField_unDamage);
				break;
			case CSOTFMatchResultPlayerStats::kHealingFieldNumber:
				csDatabaseDirty.BAddColumn(CSchMatchResultPlayerInfo::k_iField_unHealing);
				break;
			case CSOTFMatchResultPlayerStats::kSupportFieldNumber:
				csDatabaseDirty.BAddColumn(CSchMatchResultPlayerInfo::k_iField_unSupport);
				break;

			case CSOTFMatchResultPlayerStats::kScoreMedalFieldNumber:
				csDatabaseDirty.BAddColumn(CSchMatchResultPlayerInfo::k_iField_unScoreMedal);
				break;
			case CSOTFMatchResultPlayerStats::kKillsMedalFieldNumber:
				csDatabaseDirty.BAddColumn(CSchMatchResultPlayerInfo::k_iField_unKillsMedal);
				break;
			case CSOTFMatchResultPlayerStats::kDamageMedalFieldNumber:
				csDatabaseDirty.BAddColumn(CSchMatchResultPlayerInfo::k_iField_unDamageMedal);
				break;
			case CSOTFMatchResultPlayerStats::kHealingMedalFieldNumber:
				csDatabaseDirty.BAddColumn(CSchMatchResultPlayerInfo::k_iField_unHealingMedal);
				break;
			case CSOTFMatchResultPlayerStats::kSupportMedalFieldNumber:
				csDatabaseDirty.BAddColumn(CSchMatchResultPlayerInfo::k_iField_unSupportMedal);
				break;

			case CSOTFMatchResultPlayerStats::kMapIndexFieldNumber:
				csDatabaseDirty.BAddColumn(CSchMatchResultPlayerInfo::k_iField_unMapIndex);
				break;
