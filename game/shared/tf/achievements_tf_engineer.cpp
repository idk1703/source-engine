...
public:
									...
									IGameEvent *event)
	{
		...
		if(pAttacker == C_BasePlayer::GetLocalPlayer() && pVictim == m_pSentryKiller &&
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_RevengeCritForSentryKiller,
					ACHIEVEMENT_TF_ENGINEER_REVENGE_CRIT_SENTRY_KILLER, "TF_ENGINEER_REVENGE_CRIT_SENTRY_KILLER", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_ManualSentryKillsBeyondRange,
					ACHIEVEMENT_TF_ENGINEER_MANUAL_SENTRY_KILLS_BEYOND_RANGE,
					"TF_ENGINEER_MANUAL_SENTRY_KILLS_BEYOND_RANGE", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_ManualSentryAbsorbDamage, ACHIEVEMENT_TF_ENGINEER_MANUAL_SENTRY_ABSORB_DMG,
					"TF_ENGINEER_MANUAL_SENTRY_ABSORB_DMG", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_HelpTeammateBuildStructure, ACHIEVEMENT_TF_ENGINEER_HELP_BUILD_STRUCTURE,
					"TF_ENGINEER_HELP_BUILD_STRUCTURE", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_ShotgunKillPreviousSentryTarget,
					ACHIEVEMENT_TF_ENGINEER_SHOTGUN_KILL_PREV_SENTRY_TARGET,
					"TF_ENGINEER_SHOTGUN_KILL_PREV_SENTRY_TARGET", 5);
...
public:
									...
									IGameEvent *event)
	{
		...
		else if(pVictim == m_pPlayerKiller && m_flPlayerDeathStartTime != 0.0f &&
				(gpGlobals->curtime - m_flPlayerDeathStartTime) < kRevengeTimeLimit)
		{
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_SentryAvengesYou, ACHIEVEMENT_TF_ENGINEER_SENTRY_AVENGES_YOU,
					"TF_ENGINEER_SENTRY_AVENGES_YOU", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_RepairRecentlyDamagedSentryWhileBeingHealed,
					ACHIEVEMENT_TF_ENGINEER_REPAIR_SENTRY_W_MEDIC, "TF_ENGINEER_REPAIR_SENTRY_W_MEDIC", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_SentryKillPlayersCapturingPoint, ACHIEVEMENT_TF_ENGINEER_SENTRY_KILL_CAPS,
					"TF_ENGINEER_SENTRY_KILL_CAPS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_DestroySappersOnNonOwnedBuildings, ACHIEVEMENT_TF_ENGINEER_DESTROY_SAPPERS,
					"TF_ENGINEER_DESTROY_SAPPERS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_HelpManualSentry, ACHIEVEMENT_TF_ENGINEER_HELP_MANUAL_SENTRY,
					"TF_ENGINEER_HELP_MANUAL_SENTRY", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_RevengeCritLife, ACHIEVEMENT_TF_ENGINEER_REVENGE_CRIT_LIFE,
					"TF_ENGINEER_REVENGE_CRIT_LIFE", 5);
...
class CAchievementTFEngineer_TeleportGrind : public CBaseTFAchievement
{
	...
	void FireGameEvent_Internal(IGameEvent *event)
	{
		...
		if(FStrEq(pszEventName, "player_teleported"))
		{
			...
			C_TFPlayer *pLocalPlayer = C_TFPlayer::GetLocalTFPlayer();
			if(pLocalPlayer && pLocalPlayer->GetUserID() == builderid && pLocalPlayer->GetUserID() != userid &&
			   dist > 1200)
			{
				IncrementCount();
			}
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_TeleportGrind, ACHIEVEMENT_TF_ENGINEER_TELEPORT_GRIND,
					"TF_ENGINEER_TELEPORT_GRIND", 5);
...
class CAchievemeentTFEngineer_DispenserExtinguish : public CBaseTFAchievement
{
	...
	void FireGameEvent_Internal(IGameEvent *event)
	{
		...
		if(FStrEq(pszEventName, "player_extinguished"))
		{
			...
			C_TFPlayer *pLocalPlayer = C_TFPlayer::GetLocalTFPlayer();
			if(pLocalPlayer && pLocalPlayer->entindex() == healerid && pLocalPlayer->entindex() != victimid &&
...
DECLARE_ACHIEVEMENT(CAchievemeentTFEngineer_DispenserExtinguish, ACHIEVEMENT_TF_ENGINEER_DISPENSER_EXTINGUISH,
					"TF_ENGINEER_DISPENSER_EXTINGUISH", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_ManualCloakedSpyKill, ACHIEVEMENT_TF_ENGINEER_MANUAL_CLOAKED_SPY_KILL,
					"TF_ENGINEER_MANUAL_CLOAKED_SPY_KILL", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_UpgradeBuildings, ACHIEVEMENT_TF_ENGINEER_UPGRADE_BUILDINGS,
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_SentryKillLifetimeGrind, ACHIEVEMENT_TF_ENGINEER_SENTRY_KILL_LIFETIME_GRIND,
					"TF_ENGINEER_SENTRY_KILL_LIFETIME_GRIND", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_DispenserHealGroup, ACHIEVEMENT_TF_ENGINEER_DISPENSER_HEAL_GROUP,
					"TF_ENGINEER_DISPENSER_HEAL_GROUP", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_WasteMetalGrind, ACHIEVEMENT_TF_ENGINEER_WASTE_METAL_GRIND,
					"TF_ENGINEER_WASTE_METAL_GRIND", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_KillFlagCarriers, ACHIEVEMENT_TF_ENGINEER_KILL_FLAG_CARRIERS,
					"TF_ENGINEER_KILL_FLAG_CARRIERS", 5);
...
class CAchievementTFEngineer_KillDisguisedSpy : public CBaseTFAchievement
{
									...
									IGameEvent *event)
	{
		...
		if(pTFVictim && pTFVictim->IsPlayerClass(TF_CLASS_SPY) && pTFVictim->m_Shared.InCond(TF_COND_DISGUISED) &&
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_KillDisguisedSpy, ACHIEVEMENT_TF_ENGINEER_KILL_DISGUISED_SPY,
					"TF_ENGINEER_KILL_DISGUISED_SPY", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_FreezeTaunt, ACHIEVEMENT_TF_ENGINEER_FREEZECAM_TAUNT,
					"TF_ENGINEER_FREEZECAM_TAUNT", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_FreezeWithSentry, ACHIEVEMENT_TF_ENGINEER_FREEZECAM_SENTRY,
					"TF_ENGINEER_FREEZECAM_SENTRY", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_KillSpyTwoSappers, ACHIEVEMENT_TF_ENGINEER_KILL_SPY_TWO_SAPPERS,
					"TF_ENGINEER_KILL_SPY_TWO_SAPPERS", 5);
...
class CAchievementTFEngineer_RemoveSapperLongDist : public CBaseTFAchievement
{
	...
	void FireGameEvent_Internal(IGameEvent *event)
	{
		...
		{
			if(event->GetInt("objecttype") == OBJ_ATTACHMENT_SAPPER &&
			   event->GetInt("attacker") == pLocalPlayer->GetUserID() && event->GetInt("index") == iSapperIndex)
			{
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_RemoveSapperLongDist, ACHIEVEMENT_TF_ENGINEER_REMOVE_SAPPER_LONG_DIST,
					"TF_ENGINEER_REMOVE_SAPPER_LONG_DIST", 5);
...
class CAchievementTFEngineer_TauntKill : public CBaseTFAchievement
{
									...
									IGameEvent *event)
	{
		...
		if((iEvent == TF_DMG_CUSTOM_TAUNTATK_ENGINEER_GUITAR_SMASH) ||
		   (iEvent == TF_DMG_CUSTOM_TAUNTATK_ALLCLASS_GUITAR_RIFF))
		{
			IncrementCount();
		}
	}
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_DestroyStickies, ACHIEVEMENT_TF_ENGINEER_DESTROY_STICKIES,
					"TF_ENGINEER_DESTROY_STICKIES", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_KillSnipersSentry, ACHIEVEMENT_TF_ENGINEER_KILL_SNIPERS_SENTRY,
					"TF_ENGINEER_KILL_SNIPERS_SENTRY", 5);
...
class CAchievementTFEngineer_KillSentryWithSentry : public CBaseTFAchievement
{
	...
	void FireGameEvent_Internal(IGameEvent *event)
	{
		...
		if(FStrEq(event->GetName(), "object_destroyed"))
		{
			...
			if(event->GetInt("objecttype") == OBJ_SENTRYGUN && event->GetInt("attacker") == pLocalPlayer->GetUserID() &&
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_KillSentryWithSentry, ACHIEVEMENT_TF_ENGINEER_KILL_SENTRY_WITH_SENTRY,
					"TF_ENGINEER_KILL_SENTRY_WITH_SENTRY", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_MoveSentryGetKill, ACHIEVEMENT_TF_ENGINEER_MOVE_SENTRY_GET_KILL,
					"TF_ENGINEER_MOVE_SENTRY_GET_KILL", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_BuildingCarry, ACHIEVEMENT_TF_ENGINEER_BUILDING_CARRY,
					"TF_ENGINEER_BUILDING_CARRY", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_KillAssist, ACHIEVEMENT_TF_ENGINEER_KILL_ASSIST, "TF_ENGINEER_KILL_ASSIST",
					5);
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_DispenserHealGrind, ACHIEVEMENT_TF_ENGINEER_DISPENSER_HEAL_GRIND,
					"TF_ENGINEER_DISPENSER_HEAL_GRIND", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_RepairTeamGrind, ACHIEVEMENT_TF_ENGINEER_REPAIR_TEAM_GRIND,
					"TF_ENGINEER_REPAIR_TEAM_GRIND", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_TankDamage, ACHIEVEMENT_TF_ENGINEER_TANK_DAMAGE, "TF_ENGINEER_TANK_DAMAGE",
					5);
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_HeavyAssist, ACHIEVEMENT_TF_ENGINEER_HEAVY_ASSIST,
					"TF_ENGINEER_HEAVY_ASSIST", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_AchieveProgress1, ACHIEVEMENT_TF_ENGINEER_ACHIEVE_PROGRESS1,
					"TF_ENGINEER_ACHIEVE_PROGRESS1", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_AchieveProgress2, ACHIEVEMENT_TF_ENGINEER_ACHIEVE_PROGRESS2,
					"TF_ENGINEER_ACHIEVE_PROGRESS2", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFEngineer_AchieveProgress3, ACHIEVEMENT_TF_ENGINEER_ACHIEVE_PROGRESS3,
					"TF_ENGINEER_ACHIEVE_PROGRESS3", 5);
