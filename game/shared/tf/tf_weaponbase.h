...
public:
	...
	virtual bool ShouldHitEntity(IHandleEntity *pServerEntity, int contentsMask)
	{
		...
		if((pEntity->IsPlayer() || pEntity->IsCombatItem()) &&
		   (pEntity->GetTeamNumber() == m_iIgnoreTeam || m_iIgnoreTeam == TEAM_ANY))
		{
			return false;
		}
...
public:
	...
	CTraceFilterIgnoreFriendlyCombatItems(const IHandleEntity *passentity, int collisionGroup, int iIgnoreTeam,
	...
	virtual bool ShouldHitEntity(IHandleEntity *pServerEntity, int contentsMask)
	{
		...
		// pEntity->GetTeamNumber() == m_iIgnoreTeam ) 			return false;
		//
...
#endif
{
	...
	virtual void ApplyOnHitAttributes(CBaseEntity *pVictimBaseEntity, CTFPlayer *pAttacker,
									  const CTakeDamageInfo &info);
	virtual void ApplyPostHitEffects(const CTakeDamageInfo &inputInfo, CTFPlayer *pPlayer);
	virtual void ApplyOnInjuredAttributes(CTFPlayer *pVictim, CTFPlayer *pAttacker,
										  const CTakeDamageInfo &info); // when owner of this weapon is hit

	virtual void Use(CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value);

	virtual bool DeflectProjectiles();
	virtual bool DeflectPlayer(CTFPlayer *pTarget, CTFPlayer *pOwner, Vector &vecForward, Vector &vecCenter,
							   Vector &vecSize);
	virtual bool DeflectEntity(CBaseEntity *pTarget, CTFPlayer *pOwner, Vector &vecForward, Vector &vecCenter,
							   Vector &vecSize);
	static void SendObjectDeflectedEvent(CTFPlayer *pNewOwner, CTFPlayer *pPrevOwner, int iWeaponID,
...
protected:
	...
	void StartEffectBarRegen(
		void); // Call this when you want your bar to start recharging (usually when you've deployed your action)
...
public:
	...
	float GetInspectAnimTime() const
	{
