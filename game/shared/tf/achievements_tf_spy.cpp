...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_SpyBackstabSnipers, ACHIEVEMENT_TF_SPY_BACKSTAB_SNIPERS,
					"TF_SPY_BACKSTAB_SNIPERS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_SpyBackstabDisguisedSpy, ACHIEVEMENT_TF_SPY_BACKSTAB_DISGUISED_SPY,
					"TF_SPY_BACKSTAB_DISGUISED_SPY", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_SpyBackstabDisguiseTarget, ACHIEVEMENT_TF_SPY_BACKSTAB_DISGUISE_TARGET,
					"TF_SPY_BACKSTAB_DISGUISE_TARGET", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_SpyDominateSniper, ACHIEVEMENT_TF_SPY_DOMINATE_SNIPER, "TF_SPY_DOMINATE_SNIPER",
					5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_SpyBumpCloakedSpy, ACHIEVEMENT_TF_SPY_BUMP_CLOAKED_SPY, "TF_SPY_BUMP_CLOAKED_SPY",
					5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_SpyKillSpyWithKnife, ACHIEVEMENT_TF_SPY_KILL_SPY_WITH_KNIFE,
					"TF_SPY_KILL_SPY_WITH_KNIFE", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_SpyRevengeBackstab, ACHIEVEMENT_TF_SPY_REVENGE_WITH_BACKSTAB,
					"TF_SPY_REVENGE_WITH_BACKSTAB", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_SpyKnifeKillWhileJarated, ACHIEVEMENT_TF_SPY_KNIFE_KILL_WHILE_JARATED,
					"TF_SPY_KNIFE_KILL_WHILE_JARATED", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_SpyBackstabMedicCharged, ACHIEVEMENT_TF_SPY_BACKSTAB_MEDIC_CHARGED,
					"TF_SPY_BACKSTAB_MEDIC_CHARGED", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_SpyBackstabDominatingEnemy, ACHIEVEMENT_TF_SPY_BACKSTAB_DOMINATING_ENEMY,
					"TF_SPY_BACKSTAB_DOMINATING_ENEMY", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_SpyBackstabFriends, ACHIEVEMENT_TF_SPY_BACKSTAB_FRIENDS,
					"TF_SPY_BACKSTAB_FRIENDS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_SpyAmbassadorGrind, ACHIEVEMENT_TF_SPY_AMBASSADOR_GRIND,
					"TF_SPY_AMBASSADOR_GRIND", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_SpyAmbassadorSniperGrind, ACHIEVEMENT_TF_SPY_AMBASSADOR_SNIPER_GRIND,
					"TF_SPY_AMBASSADOR_SNIPER_GRIND", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_SpyAmbassadorScoutGrind, ACHIEVEMENT_TF_SPY_AMBASSADOR_SCOUT_GRIND,
					"TF_SPY_AMBASSADOR_SCOUT_GRIND", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_SpyMedicHealingKillEnemy, ACHIEVEMENT_TF_SPY_MEDIC_HEALING_KILL_ENEMY,
					"TF_SPY_MEDIC_HEALING_KILL_ENEMY", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_SpyBackstabQuickKills, ACHIEVEMENT_TF_SPY_BACKSTAB_QUICK_KILLS,
					"TF_SPY_BACKSTAB_QUICK_KILLS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_SpyBackstabCappingEnemies, ACHIEVEMENT_TF_SPY_BACKSTAB_CAPPING_ENEMIES,
					"TF_SPY_BACKSTAB_CAPPING_ENEMIES", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_SpyKillCPDefenders, ACHIEVEMENT_TF_SPY_KILL_CP_DEFENDERS,
					"TF_SPY_KILL_CP_DEFENDERS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_FYIMedic, ACHIEVEMENT_TF_SPY_BACKSTAB_MEDIC_HEALING_YOU,
					"TF_SPY_BACKSTAB_MEDIC_HEALING_YOU", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_KillMedicPair, ACHIEVEMENT_TF_SPY_BACKSTAB_MEDIC_PAIR,
					"TF_SPY_BACKSTAB_MEDIC_PAIR", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_FeignDeathKill, ACHIEVEMENT_TF_SPY_FEIGN_DEATH_KILL, "TF_SPY_FEIGN_DEATH_KILL",
					5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_ShieldKill, ACHIEVEMENT_TF_SPY_BREAK_SHIELD_KILL_SNIPER,
					"TF_SPY_BREAK_SHIELD_KILL_SNIPER", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_KillWorkingEngineer, ACHIEVEMENT_TF_SPY_KILL_WORKING_ENGY,
					"TF_SPY_KILL_WORKING_ENGY", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_TFSpySurviveBurning, ACHIEVEMENT_TF_SPY_SURVIVE_BURNING, "TF_SPY_SURVIVE_BURNING",
					5);
...
class CAchievementTFSpy_SpyBackstabEnemySwitchPyro : public CBaseTFAchievementSimple
{
	...
	void FireGameEvent_Internal(IGameEvent *event)
	{
		...
		else if(FStrEq(pszEventName, "localplayer_changeclass") || FStrEq(pszEventName, "localplayer_changeteam"))
		{
			ResetBackstabbedPlayers();
		}
	}
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_SpyBackstabEnemySwitchPyro, ACHIEVEMENT_TF_SPY_BACKSTAB_ENEMY_SWITCH_PYRO,
					"TF_SPY_BACKSTAB_ENEMY_SWITCH_PYRO", 5);
...
class CAchievementTFSpy_SpyBackstabEngySapBuilding : public CBaseTFAchievement
{
									...
									IGameEvent *event)
	{
		if(pAttacker == C_BasePlayer::GetLocalPlayer())
		{
			...
			CheckAchievementEarned(); // checks the achievement list, but also cleans out old entries (based on
									  // flTimeToBeat)
		}
	}
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_SpyBackstabEngySapBuilding, ACHIEVEMENT_TF_SPY_BACKSTAB_ENGY_SAP_BUILDING,
					"TF_SPY_BACKSTAB_ENGY_SAP_BUILDING", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_SpySapBuildingBackstabEngy, ACHIEVEMENT_TF_SPY_SAP_BUILDING_BACKSTAB_ENGY,
					"TF_SPY_SAP_BUILDING_BACKSTAB_ENGY", 5);
...
class CAchievementTFSpy_SapperTeamwork : public CBaseTFAchievement
{
	...
	void CheckAchievementEarned(void)
	{
		...
		if(gpGlobals->curtime - m_flLocalPlayerTime > 3.0)
		{
			...
			// then a teammate saps something > 3 seconds later (otherwise, the new entry would be removed in the for
			// loop below)
			m_nLocalPlayerTarget = -1;
			m_flLocalPlayerTime = -1;
			return;
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_AchieveProgress1, ACHIEVEMENT_TF_SPY_ACHIEVE_PROGRESS1,
					"TF_SPY_ACHIEVE_PROGRESS1", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_AchieveProgress2, ACHIEVEMENT_TF_SPY_ACHIEVE_PROGRESS2,
					"TF_SPY_ACHIEVE_PROGRESS2", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_AchieveProgress3, ACHIEVEMENT_TF_SPY_ACHIEVE_PROGRESS3,
					"TF_SPY_ACHIEVE_PROGRESS3", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSpy_KillBackScatterScout, ACHIEVEMENT_TF_SPY_KILL_BACKSCATTER_SCOUT,
					"TF_SPY_KILL_BACKSCATTER_SCOUT", 5);
