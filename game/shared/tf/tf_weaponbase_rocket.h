...
#define TF_ROCKET_RADIUS_FOR_RJS \
	(110.0f * 1.1f)						  // radius * TF scale up factor (121) - Used when applying damage to attacker.
...
public:
	...
	static CTFBaseRocket *Create(CBaseEntity *pLauncher, const char *szClassname, const Vector &vecOrigin,
								 const QAngle &vecAngles, CBaseEntity *pOwner = NULL);
	...
	{
		return gpGlobals->curtime > m_flDestroyableTime;
	}
