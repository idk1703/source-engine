...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_KillSoldierGrind, ACHIEVEMENT_TF_DEMOMAN_KILL_SOLDIER_GRIND,
					"TF_DEMOMAN_KILL_SOLDIER_GRIND", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_DestroyBuildingsWithMedic,
					ACHIEVEMENT_TF_DEMOMAN_DESTROY_BUILDINGS_WITH_MEDIC, "TF_DEMOMAN_DESTROY_BUILDINGS_WITH_MEDIC", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_DecapitateCloakedSpy, ACHIEVEMENT_TF_DEMOMAN_DECAPITATE_CLOAKED_SPY,
					"TF_DEMOMAN_DECAPITATE_CLOAKED_SPY", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_KillWithDirectPipe, ACHIEVEMENT_TF_DEMOMAN_KILL_X_WITH_DIRECTPIPE,
					"TF_DEMOMAN_KILL_X_WITH_DIRECTPIPE", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_BounceAndKill, ACHIEVEMENT_TF_DEMOMAN_BOUNCE_AND_KILL,
					"TF_DEMOMAN_BOUNCE_AND_KILL", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_DecapitatePlayers, ACHIEVEMENT_TF_DEMOMAN_DECAPITATE_PLAYERS,
					"TF_DEMOMAN_DECAPITATE_PLAYERS", 5);
...
class CAchievementTFDemoman_DecapitatePlayersFast : public CBaseTFAchievement
{
									...
									IGameEvent *event)
	{
		...
		if(customdmg == TF_DMG_CUSTOM_DECAPITATION)
		{
			if((m_iTimelyDecapitations == 0) ||
			   ((m_iTimelyDecapitations > 0) && (gpGlobals->curtime < m_flLastDecapTime + 10.f)))
			{
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_DecapitatePlayersFast, ACHIEVEMENT_TF_DEMOMAN_DECAPITATE_PLAYERS_FAST,
					"TF_DEMOMAN_DECAPITATE_PLAYERS_FAST", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSoldier_DuoDemomanKills, ACHIEVEMENT_TF_DEMOMAN_DUO_DEMOMAN_KILLS,
					"TF_DEMOMAN_DUO_DEMOMAN_KILLS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_KillTwoDuringStickyJump, ACHIEVEMENT_TF_DEMOMAN_KILL_TWO_DURING_STICKYJUMP,
					"TF_DEMOMAN_KILL_TWO_DURING_STICKYJUMP", 5);
									...
									IGameEvent *event)
	{
		...
		if(event->GetInt("weaponid") == TF_WEAPON_GRENADE_PIPEBOMB)
		{
			if(pTFVictim->m_Shared.InCond(TF_COND_TELEPORTED) &&
			   (gpGlobals->curtime - pTFVictim->m_Shared.GetTimeTeleEffectAdded() <= 5.0))
			{
				IncrementCount();
			}
		}
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_KillPlayerAfterTeleport, ACHIEVEMENT_TF_DEMOMAN_KILL_PLAYER_AFTER_TP,
					"TF_DEMOMAN_KILL_PLAYER_AFTER_TP", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_DominateEngineerThreeTimes, ACHIEVEMENT_TF_DEMOMAN_DOMINATE_THREE_ENGINEERS,
					"TF_DEMOMAN_DOMINATE_THREE_ENGINEERS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_KillBuildingDirectHit, ACHIEVEMENT_TF_DEMOMAN_KILL_BUILDING_DIRECT_HIT,
					"TF_DEMOMAN_KILL_BUILDING_DIRECT_HIT", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_MeleeKillWhileJumping, ACHIEVEMENT_TF_DEMOMAN_MELEE_KILL_WHILE_STICKYJUMPING,
					"TF_DEMOMAN_MELEE_KILL_WHILE_STICKYJUMPING", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_KillEngiSentryDispenser, ACHIEVEMENT_TF_DEMOMAN_KILL_ENGI_SENTRY_DISPENSER,
					"TF_DEMOMAN_KILL_ENGI_SENTRY_DISPENSER", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_DecapitateEqualizer, ACHIEVEMENT_TF_DEMOMAN_DECAPITATE_EQUALIZER,
					"TF_DEMOMAN_DECAPITATE_EQUALIZER", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_DecapitateNemesis, ACHIEVEMENT_TF_DEMOMAN_DECAPITATE_NEMESIS,
					"TF_DEMOMAN_DECAPITATE_NEMESIS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_DamageGrind, ACHIEVEMENT_TF_DEMOMAN_DAMAGE_GRIND, "TF_DEMOMAN_DAMAGE_GRIND",
					5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_KillXCapping, ACHIEVEMENT_TF_DEMOMAN_KILL_X_CAPPING_ONEDET,
					"TF_DEMOMAN_KILL_X_CAPPING_ONEDET", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_KillXDefending, ACHIEVEMENT_TF_DEMOMAN_KILL_X_DEFENDING,
					"TF_DEMOMAN_KILL_X_DEFENDING", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_DestroyBuildings, ACHIEVEMENT_TF_DEMOMAN_DESTROY_BUILDINGS_GRIND,
					"TF_DEMOMAN_DESTROY_BUILDINGS_GRIND", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_KillXHeaviesAtFull, ACHIEVEMENT_TF_DEMOMAN_KILL_X_HEAVIES_FULLHP_ONEDET,
					"TF_DEMOMAN_KILL_X_HEAVIES_FULLHP_ONEDET", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_KillXScoutsPyros, ACHIEVEMENT_TF_DEMOMAN_KILL_X_SCOUTS_PYROS,
					"TF_DEMOMAN_KILL_X_SCOUTS_PYROS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_CritSwordKill, ACHIEVEMENT_TF_DEMOMAN_CRIT_SWORD_KILL,
					"TF_DEMOMAN_CRIT_SWORD_KILL", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_AirBurstKills, ACHIEVEMENT_TF_DEMOMAN_AIR_BURST_KILLS,
					"TF_DEMOMAN_AIR_BURST_KILLS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_StickyJumpCap, ACHIEVEMENT_TF_DEMOMAN_STICKYJUMP_CAP,
					"TF_DEMOMAN_STICKYJUMP_CAP", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_FreezeTaunt, ACHIEVEMENT_TF_DEMOMAN_FREEZECAM_SMILE,
					"TF_DEMOMAN_FREEZECAM_SMILE", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_FreezeTauntRump, ACHIEVEMENT_TF_DEMOMAN_FREEZECAM_RUMP,
					"TF_DEMOMAN_FREEZECAM_RUMP", 5);
									...
									IGameEvent *event)
	{
		...
		if(pTFVictim->m_Shared.GetWeaponKnockbackID() == pLocalPlayer->GetUserID())
		{
			...
			if((damagebits & DMG_VEHICLE) ||			   // They were hit by a freakin' train!
			   ...
			   (custom == TF_DMG_CUSTOM_SUICIDE) || (custom == TF_DMG_CUSTOM_TRIGGER_HURT)) // A trigger-hurt got him!
			{
				IncrementCount();
			}
		}
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_EnvironmentalKill, ACHIEVEMENT_TF_DEMOMAN_ENVIRONMENTAL_KILL,
					"TF_DEMOMAN_ENVIRONMENTAL_KILL", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_DestroyStickyBombs, ACHIEVEMENT_TF_DEMOMAN_DESTROY_X_STICKYBOMBS,
					"TF_DEMOMAN_DESTROY_X_STICKYBOMBS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_StickyJumpDistance, ACHIEVEMENT_TF_DEMOMAN_STICKJUMP_DISTANCE,
					"TF_DEMOMAN_STICKJUMP_DISTANCE", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_Kill3WithDetonation, ACHIEVEMENT_TF_DEMOMAN_KILL3_WITH_DETONATION,
					"TF_DEMOMAN_KILL3_WITH_DETONATION", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_KillXSappingSpies, ACHIEVEMENT_TF_DEMOMAN_KILLXSAPPINGSPIES,
					"TF_DEMOMAN_KILLXSAPPINGSPIES", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_Kill3WithPipeSetup, ACHIEVEMENT_TF_DEMOMAN_KILL3_WITH_PIPE_SETUPS,
					"TF_DEMOMAN_KILL3_WITH_PIPE_SETUPS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_AchieveProgress1, ACHIEVEMENT_TF_DEMOMAN_ACHIEVE_PROGRESS1,
					"TF_DEMOMAN_ACHIEVE_PROGRESS1", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_AchieveProgress2, ACHIEVEMENT_TF_DEMOMAN_ACHIEVE_PROGRESS2,
					"TF_DEMOMAN_ACHIEVE_PROGRESS2", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_AchieveProgress3, ACHIEVEMENT_TF_DEMOMAN_ACHIEVE_PROGRESS3,
					"TF_DEMOMAN_ACHIEVE_PROGRESS3", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_ParachuteKillGroup, ACHIEVEMENT_TF_DEMOMAN_PARACHUTE_KILL_GROUP,
					"TF_DEMOMAN_PARACHUTE_KILL_GROUP", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_ParachuteDistance, ACHIEVEMENT_TF_DEMOMAN_PARACHUTE_DISTANCE,
					"TF_DEMOMAN_PARACHUTE_DISTANCE", 5);
...
public:
									...
									IGameEvent *event)
	{
		...
		{
			if((pTFAttacker->m_Shared.InCond(TF_COND_PARACHUTE_DEPLOYED)) &&
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_ParachuteKillParachute, ACHIEVEMENT_TF_DEMOMAN_PARACHUTE_KILL_PARACHUTE,
					"TF_DEMOMAN_PARACHUTE_KILL_PARACHUTE", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_KillPlayerYouDidntSee, ACHIEVEMENT_TF_DEMOMAN_KILL_PLAYER_YOU_DIDNT_SEE,
					"TF_DEMOMAN_KILL_PLAYER_YOU_DIDNT_SEE", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDemoman_ChargeKillChargingDemo, ACHIEVEMENT_TF_DEMOMAN_CHARGE_KILL_CHARGING_DEMO,
					"TF_DEMOMAN_CHARGE_KILL_CHARGING_DEMO", 5);
