...
public:
#ifdef STAGING_ONLY
	CTFMedigunShield *GetMedigunShield() const
	{
		return m_hMedigunShield;
	}
...
protected:
	...
	CUtlVector<targetdetachtimes_t>
		m_DetachedTargets; // Tracks times we last applied charge to a target. Used to drain faster for more targets.
...
#ifdef STAGING_ONLY
	void SetPermanentShield(bool bPermanent)
	{
		m_bPermanentShield = bPermanent;
	}
#endif // STAGING_ONLY
