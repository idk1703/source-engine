...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_CompletePopFile, ACHIEVEMENT_TF_MVM_COMPLETE_POP_FILE,
					"TF_MVM_COMPLETE_POP_FILE", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_EarnMoneyBonus, ACHIEVEMENT_TF_MVM_EARN_MONEY_BONUS, "TF_MVM_EARN_MONEY_BONUS",
					5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_AdvancedEarnAllBonuses, ACHIEVEMENT_TF_MVM_ADVANCED_EARN_ALL_BONUSES,
					"TF_MVM_ADVANCED_EARN_ALL_BONUSES", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_PickupMoneyAboutToExpire, ACHIEVEMENT_TF_MVM_PICKUP_MONEY_ABOUT_TO_EXPIRE,
					"TF_MVM_PICKUP_MONEY_ABOUT_TO_EXPIRE", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_CollectMoneyGrind, ACHIEVEMENT_TF_MVM_COLLECT_MONEY_GRIND,
					"TF_MVM_COLLECT_MONEY_GRIND", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_PlayGameFriends, ACHIEVEMENT_TF_MVM_PLAY_GAME_FRIENDS,
					"TF_MVM_PLAY_GAME_FRIENDS", 5);
...
public:
	void Init()
	{
		...
		SetGoal((TF_LAST_NORMAL_CLASS - 1) - TF_FIRST_NORMAL_CLASS +
				1); //( TF_LAST_NORMAL_CLASS - 1 ) to exclude the new civilian class
	...
	void FireGameEvent_Internal(IGameEvent *event)
	{
		...
		else if(FStrEq(pszEventName,
					   "localplayer_changeclass") || // can't change class or team after the first round starts
			...
			if(!m_bChangedClass)
			{
				...
				if(pTFPlayer)
				{
					...
					if(iClass >= TF_FIRST_NORMAL_CLASS &&
					   iClass <=
						   (TF_LAST_NORMAL_CLASS - 1)) //( TF_LAST_NORMAL_CLASS - 1 ) to exclude the new civilian class
					{
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_DestroyTwoTanks, ACHIEVEMENT_TF_MVM_DESTROY_TWO_TANKS,
					"TF_MVM_DESTROY_TWO_TANKS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_DestroyTankWhileDeploying, ACHIEVEMENT_TF_MVM_DESTROY_TANK_WHILE_DEPLOYING,
					"TF_MVM_DESTROY_TANK_WHILE_DEPLOYING", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_DestroyTankQuickly, ACHIEVEMENT_TF_MVM_DESTROY_TANK_QUICKLY,
					"TF_MVM_DESTROY_TANK_QUICKLY", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_KillBombCarriers, ACHIEVEMENT_TF_MVM_KILL_BOMB_CARRIERS,
					"TF_MVM_KILL_BOMB_CARRIERS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_CompleteWaveWithoutDying, ACHIEVEMENT_TF_MVM_COMPLETE_WAVE_WITHOUT_DYING,
					"TF_MVM_COMPLETE_WAVE_WITHOUT_DYING", 5);
...
public:
	void Init()
	{
		...
		static const char *szComponents[] = {"scripts/population/mvm_decoy.pop", "scripts/population/mvm_coaltown.pop",
											 "scripts/population/mvm_mannworks.pop"};
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_UseTeleportBottle, ACHIEVEMENT_TF_MVM_USE_TELEPORT_BOTTLE,
					"TF_MVM_USE_TELEPORT_BOTTLE", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_UseBuildBottle, ACHIEVEMENT_TF_MVM_USE_BUILD_BOTTLE, "TF_MVM_USE_BUILD_BOTTLE",
					5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_MaxPrimaryUpgrades, ACHIEVEMENT_TF_MVM_MAX_PRIMARY_UPGRADES,
					"TF_MVM_MAX_PRIMARY_UPGRADES", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_MaxPlayerResistances, ACHIEVEMENT_TF_MVM_MAX_PLAYER_RESISTANCES,
					"TF_MVM_MAX_PLAYER_RESISTANCES", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_NoAlarmsInFinalWave, ACHIEVEMENT_TF_MVM_NO_ALARMS_IN_FINAL_WAVE,
					"TF_MVM_NO_ALARMS_IN_FINAL_WAVE", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_KillMedicsCharged, ACHIEVEMENT_TF_MVM_KILL_MEDICS_CHARGED,
					"TF_MVM_KILL_MEDICS_CHARGED", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_KillRobotGrind, ACHIEVEMENT_TF_MVM_KILL_ROBOT_GRIND, "TF_MVM_KILL_ROBOT_GRIND",
					5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_KillRobotMegaGrind, ACHIEVEMENT_TF_MVM_KILL_ROBOT_MEGA_GRIND,
					"TF_MVM_KILL_ROBOT_MEGA_GRIND", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_KillSentryBuster, ACHIEVEMENT_TF_MVM_KILL_SENTRY_BUSTER,
					"TF_MVM_KILL_SENTRY_BUSTER", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_SoldierBuffTeam, ACHIEVEMENT_TF_MVM_SOLDIER_BUFF_TEAM,
					"TF_MVM_SOLDIER_BUFF_TEAM", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_HeavyRagePushDeployingRobot, ACHIEVEMENT_TF_MVM_HEAVY_RAGE_PUSH_DEPLOYING_ROBOT,
					"TF_MVM_HEAVY_RAGE_PUSH_DEPLOYING_ROBOT", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_MedicShareBottles, ACHIEVEMENT_TF_MVM_MEDIC_SHARE_BOTTLES,
					"TF_MVM_MEDIC_SHARE_BOTTLES", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_ScoutMarkForDeath, ACHIEVEMENT_TF_MVM_SCOUT_MARK_FOR_DEATH,
					"TF_MVM_SCOUT_MARK_FOR_DEATH", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_SniperKillGroup, ACHIEVEMENT_TF_MVM_SNIPER_KILL_GROUP,
					"TF_MVM_SNIPER_KILL_GROUP", 5);
...
public:
	...
	void FireGameEvent_Internal(IGameEvent *event)
	{
		...
		else if(FStrEq(pszEventName, "mvm_wave_complete") || FStrEq(pszEventName, "teamplay_round_active"))
		{
			m_iResetCountInWave = 0;
		}
	}
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_EngineerEscapeSentryBuster, ACHIEVEMENT_TF_MVM_ENGINEER_ESCAPE_SENTRY_BUSTER,
					"TF_MVM_ENGINEER_ESCAPE_SENTRY_BUSTER", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_Maps_Rottenburg_Tank, ACHIEVEMENT_TF_MVM_MAPS_ROTTENBURG_TANK,
					"TF_MVM_MAPS_ROTTENBURG_TANK", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_Maps_Rottenburg_Bomb, ACHIEVEMENT_TF_MVM_MAPS_ROTTENBURG_BOMB,
					"TF_MVM_MAPS_ROTTENBURG_BOMB", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_Maps_Rottenburg_PitGrind, ACHIEVEMENT_TF_MVM_MAPS_ROTTENBURG_PIT_GRIND,
					"TF_MVM_MAPS_ROTTENBURG_PIT_GRIND", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_Maps_Manhattan_Pit, ACHIEVEMENT_TF_MVM_MAPS_MANNHATTAN_PIT,
					"TF_MVM_MAPS_MANNHATTAN_PIT", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_Maps_Manhattan_Mystery, ACHIEVEMENT_TF_MVM_MAPS_MANNHATTAN_MYSTERY,
					"TF_MVM_MAPS_MANNHATTAN_MYSTERY", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_Maps_Manhattan_NoGates, ACHIEVEMENT_TF_MVM_MAPS_MANNHATTAN_NO_GATES,
					"TF_MVM_MAPS_MANNHATTAN_NO_GATES", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_Maps_Manhattan_KillStunRadiowave,
					ACHIEVEMENT_TF_MVM_MAPS_MANNHATTAN_STUN_RADIOWAVE, "TF_MVM_MAPS_MANNHATTAN_STUN_RADIOWAVE", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_Maps_Manhattan_BombBotGrind, ACHIEVEMENT_TF_MVM_MAPS_MANNHATTAN_BOMB_BOT_GRIND,
					"TF_MVM_MAPS_MANNHATTAN_BOMB_BOT_GRIND", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_SentryBusterFriendlyFire, ACHIEVEMENT_TF_MVM_SENTRY_BUSTER_FRIENDLY_FIRE,
					"TF_MVM_SENTRY_BUSTER_FRIENDLY_FIRE", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_Sniper_CollectHeadshotMoney, ACHIEVEMENT_TF_MVM_SNIPER_COLLECT_HEADSHOT_MONEY,
					"TF_MVM_SNIPER_COLLECT_HEADSHOT_MONEY", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_Medic_ShieldBlockDamage, ACHIEVEMENT_TF_MVM_MEDIC_SHIELD_BLOCK_DAMAGE,
					"TF_MVM_MEDIC_SHIELD_BLOCK_DAMAGE", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_Medic_ReviveTeammates, ACHIEVEMENT_TF_MVM_MEDIC_REVIVE_TEAMMATES,
					"TF_MVM_MEDIC_REVIVE_TEAMMATES", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_RocketSpecialistKillGrind, ACHIEVEMENT_TF_MVM_ROCKET_SPECIALIST_KILL_GRIND,
					"TF_MVM_ROCKET_SPECIALIST_KILL_GRIND", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTF_MvM_RocketSpecialistStunGrind, ACHIEVEMENT_TF_MVM_ROCKET_SPECIALIST_STUN_GRIND,
					"TF_MVM_ROCKET_SPECIALIST_STUN_GRIND", 5);
