														 ...
														 float timer, int iFlags)
{
	CTFGrenadeEmpProjectile *pGrenade = static_cast<CTFGrenadeEmpProjectile *>(
		CTFWeaponBaseGrenadeProj::Create("tf_weapon_grenade_emp_projectile", position, angles, velocity, angVelocity,
...
void CTFGrenadeEmpProjectile::Detonate()
{
	...
	CTakeDamageInfo info(this, GetThrower(), vec3_origin, GetAbsOrigin(), flDamage,
						 DMG_EMP | DMG_PREVENT_PHYSICS_FORCE);
