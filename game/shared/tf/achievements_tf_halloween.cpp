...
DECLARE_ACHIEVEMENT(CAchievementTFHalloweenCollectPumpkins, ACHIEVEMENT_TF_HALLOWEEN_COLLECT_PUMPKINS,
					"TF_HALLOWEEN_COLLECT_PUMPKINS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHalloweenDominateForHat, ACHIEVEMENT_TF_HALLOWEEN_DOMINATE_FOR_HAT,
					"TF_HALLOWEEN_DOMINATE_FOR_HAT", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHalloweenKillScaredPlayer, ACHIEVEMENT_TF_HALLOWEEN_KILL_SCARED_PLAYER,
					"TF_HALLOWEEN_KILL_SCARED_PLAYER", 1);
...
DECLARE_ACHIEVEMENT(CAchievementTFHalloweenPumpkinKill, ACHIEVEMENT_TF_HALLOWEEN_PUMPKIN_KILL,
					"TF_HALLOWEEN_PUMPKIN_KILL", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHalloweenDisguisedSpyKill, ACHIEVEMENT_TF_HALLOWEEN_DISGUISED_SPY_KILL,
					"TF_HALLOWEEN_DISGUISED_SPY_KILL", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHalloweenBossKillMelee, ACHIEVEMENT_TF_HALLOWEEN_BOSS_KILL_MELEE,
					"TF_HALLOWEEN_BOSS_KILL_MELEE", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHalloweenCollectGoodyBag, ACHIEVEMENT_TF_HALLOWEEN_COLLECT_GOODY_BAG,
					"TF_HALLOWEEN_COLLECT_GOODY_BAG", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHalloweenCraftSaxtonMask, ACHIEVEMENT_TF_HALLOWEEN_CRAFT_SAXTON_MASK,
					"TF_HALLOWEEN_CRAFT_SAXTON_MASK", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHalloweenEyeBossKill, ACHIEVEMENT_TF_HALLOWEEN_EYEBOSS_KILL,
					"TF_HALLOWEEN_EYEBOSS_KILL", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHalloweenLootIsland, ACHIEVEMENT_TF_HALLOWEEN_LOOT_ISLAND, "TF_HALLOWEEN_LOOT_ISLAND",
					5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHalloweenMerasmusKill, ACHIEVEMENT_TF_HALLOWEEN_MERASMUS_KILL,
					"TF_HALLOWEEN_MERASMUS_KILL", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHalloweenMerasmusCollectLoot, ACHIEVEMENT_TF_HALLOWEEN_MERASMUS_COLLECT_LOOT,
					"TF_HALLOWEEN_MERASMUS_COLLECT_LOOT", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHalloweenHelltowerRareSpell, ACHIEVEMENT_TF_HALLOWEEN_HELLTOWER_RARE_SPELL,
					"TF_HALLOWEEN_HELLTOWER_RARE_SPELL", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHalloweenHelltowerWinRounds, ACHIEVEMENT_TF_HALLOWEEN_HELLTOWER_WIN_ROUNDS,
					"TF_HALLOWEEN_HELLTOWER_WIN_ROUNDS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHalloweenHelltowerEnvironmentalKills,
					ACHIEVEMENT_TF_HALLOWEEN_HELLTOWER_ENVIRONMENTAL_KILLS,
					"TF_HALLOWEEN_HELLTOWER_ENVIRONMENTAL_KILLS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHalloweenHelltowerSkeletonGrind, ACHIEVEMENT_TF_HALLOWEEN_HELLTOWER_SKELETON_GRIND,
					"TF_HALLOWEEN_HELLTOWER_SKELETON_GRIND", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHalloweenHelltowerKillGrind, ACHIEVEMENT_TF_HALLOWEEN_HELLTOWER_KILL_GRIND,
					"TF_HALLOWEEN_HELLTOWER_KILL_GRIND", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHalloweenHelltowerKillBrothers, ACHIEVEMENT_TF_HALLOWEEN_HELLTOWER_KILL_BROTHERS,
					"TF_HALLOWEEN_HELLTOWER_KILL_BROTHERS", 5);
...
public:
	...
	{
		BaseClass::Init();
		SetAchievementsRequired(4, ACHIEVEMENT_TF_HALLOWEEN_HELLTOWER_RARE_SPELL,
								ACHIEVEMENT_TF_HALLOWEEN_HELLTOWER_KILL_BROTHERS);
	}
};
DECLARE_ACHIEVEMENT(CAchievementTFHalloweenHelltowerMilestone, ACHIEVEMENT_TF_HALLOWEEN_HELLTOWER_MILESTONE,
					"TF_HALLOWEEN_HELLTOWER_MILESTONE", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHalloweenHelltowerSkullIslandReward,
					ACHIEVEMENT_TF_HALLOWEEN_HELLTOWER_SKULL_ISLAND_REWARD,
					"TF_HALLOWEEN_HELLTOWER_SKULL_ISLAND_REWARD", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHalloweenDoomsdayKillKarts, ACHIEVEMENT_TF_HALLOWEEN_DOOMSDAY_KILL_KARTS,
					"TF_HALLOWEEN_DOOMSDAY_KILL_KARTS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHalloweenDoomsdayCollectDucks, ACHIEVEMENT_TF_HALLOWEEN_DOOMSDAY_COLLECT_DUCKS,
					"TF_HALLOWEEN_DOOMSDAY_COLLECT_DUCKS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHalloweenDoomsdayScoreGoals, ACHIEVEMENT_TF_HALLOWEEN_DOOMSDAY_SCORE_GOALS,
					"TF_HALLOWEEN_DOOMSDAY_SCORE_GOALS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHalloweenDoomsdayRespawnTeammates,
					ACHIEVEMENT_TF_HALLOWEEN_DOOMSDAY_RESPAWN_TEAMMATES, "TF_HALLOWEEN_DOOMSDAY_RESPAWN_TEAMMATES", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHalloweenDoomsdayTinySmasher, ACHIEVEMENT_TF_HALLOWEEN_DOOMSDAY_TINY_SMASHER,
					"TF_HALLOWEEN_DOOMSDAY_TINY_SMASHER", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHalloweenDoomsdayWinMinigames, ACHIEVEMENT_TF_HALLOWEEN_DOOMSDAY_WIN_MINIGAMES,
					"TF_HALLOWEEN_DOOMSDAY_WIN_MINIGAMES", 5);
...
public:
	...
	{
		BaseClass::Init();
		SetAchievementsRequired(4, ACHIEVEMENT_TF_HALLOWEEN_DOOMSDAY_KILL_KARTS,
								ACHIEVEMENT_TF_HALLOWEEN_DOOMSDAY_WIN_MINIGAMES);
	}
};
DECLARE_ACHIEVEMENT(CAchievementTFHalloweenDoomsdayMilestone, ACHIEVEMENT_TF_HALLOWEEN_DOOMSDAY_MILESTONE,
					"TF_HALLOWEEN_DOOMSDAY_MILESTONE", 5);
