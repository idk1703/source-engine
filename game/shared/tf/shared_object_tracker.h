...
#else
class CSOTrackerManager : public CLocalSteamSharedObjectListener,
...
private:
	...
	virtual CBaseSOTracker *AllocateNewTracker(const CSharedObject *pItem, CSteamID steamIDOwner,
											   CSOTrackerManager *pManager) const = 0;
	...
	virtual int CompareRecords(const ::google::protobuf::Message *pNewProtoMsg,
							   const ::google::protobuf::Message *pExistingProtoMsg) const = 0;
