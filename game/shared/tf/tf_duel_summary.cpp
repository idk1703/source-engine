...
bool CTFDuelSummary::BYieldingAddWriteToTransaction(GCSDK::CSQLAccess &sqlAccess, const CUtlVector<int> &fields)
{
	...
	FOR_EACH_VEC(fields, nField)
	{
		...
		{
			case CSOTFDuelSummary::kLastDuelAccountIdFieldNumber:
				csDatabaseDirty.BAddColumn(CSchDuelSummary::k_iField_unLastDuelAccountID);
				break;
			case CSOTFDuelSummary::kLastDuelTimestampFieldNumber:
				csDatabaseDirty.BAddColumn(CSchDuelSummary::k_iField_rtLastDuelTimestamp);
				break;
			case CSOTFDuelSummary::kLastDuelStatusFieldNumber:
				csDatabaseDirty.BAddColumn(CSchDuelSummary::k_iField_eLastDuelStatus);
				break;
			case CSOTFDuelSummary::kDuelLossesFieldNumber:
				csDatabaseDirty.BAddColumn(CSchDuelSummary::k_iField_unDuelLosses);
				break;
			case CSOTFDuelSummary::kDuelWinsFieldNumber:
				csDatabaseDirty.BAddColumn(CSchDuelSummary::k_iField_unDuelWins);
				break;
		}
	}
...
ENUMSTRINGS_START(eDuelEndReason) {kDuelEndReason_DuelOver, "Complete"},
	{kDuelEndReason_PlayerDisconnected, "Player Disconnected"},
	{kDuelEndReason_PlayerSwappedTeams, "Player Swapped Teams"}, {kDuelEndReason_LevelShutdown, "Level Shutdown"},
	{kDuelEndReason_ScoreTiedAtZero, "Tied"}, {kDuelEndReason_PlayerKicked, "Player Kicked"},
	{kDuelEndReason_PlayerForceSwappedTeams, "Forced to Swap Teams"}, {kDuelEndReason_ScoreTied, "Tied"},
