...
DECLARE_ACHIEVEMENT(CAchievementTFFoundry_KillCappingEnemy, ACHIEVEMENT_TF_MAPS_FOUNDRY_KILL_CAPPING_ENEMY,
					"TF_MAPS_FOUNDRY_KILL_CAPPING_ENEMY", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFFoundry_PlayGameFriends, ACHIEVEMENT_TF_MAPS_FOUNDRY_PLAY_GAME_FRIENDS,
					"TF_MAPS_FOUNDRY_PLAY_GAME_FRIENDS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFFoundry_WinMinTime, ACHIEVEMENT_TF_MAPS_FOUNDRY_WIN_MINTIME,
					"TF_MAPS_FOUNDRY_WIN_MINTIME", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFFoundry_WinRounds, ACHIEVEMENT_TF_MAPS_FOUNDRY_WIN_ROUNDS,
					"TF_MAPS_FOUNDRY_WIN_ROUNDS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFFoundry_FastFinalCap, ACHIEVEMENT_TF_MAPS_FOUNDRY_FAST_FINAL_CAP,
					"TF_MAPS_FOUNDRY_FAST_FINAL_CAP", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFFoundry_TeleportAndCap, ACHIEVEMENT_TF_MAPS_FOUNDRY_TELEPORT_AND_CAP,
					"TF_MAPS_FOUNDRY_TELEPORT_AND_CAP", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFFoundry_PushIntoCauldron, ACHIEVEMENT_TF_MAPS_FOUNDRY_PUSH_INTO_CAULDRON,
					"TF_MAPS_FOUNDRY_PUSH_INTO_CAULDRON", 5);
	...
	void FireGameEvent_Internal(IGameEvent *event)
	{
		...
		else if(FStrEq(pszEventName, "teamplay_point_startcapture"))
		{
			if(ObjectiveResource() &&
			   (ObjectiveResource()->GetBaseControlPointForTeam(GetLocalPlayerTeam()) == event->GetInt("cp")))
			{
...
DECLARE_ACHIEVEMENT(CAchievementTFFoundry_PushBackAndWin, ACHIEVEMENT_TF_MAPS_FOUNDRY_PUSH_BACK_AND_WIN,
					"TF_MAPS_FOUNDRY_PUSH_BACK_AND_WIN", 5);
...
class CAchievementTFFoundry_PlayEachClass : public CBaseTFAchievementSimple
{
	...
	{
		CTFPlayer *pLocalPlayer = ToTFPlayer(C_BasePlayer::GetLocalPlayer());
		if(pLocalPlayer && (pLocalPlayer == pAttacker) && (pVictim != pAttacker) &&
		   (pLocalPlayer->m_Shared.GetDesiredPlayerClassIndex() > TF_CLASS_UNDEFINED))
		{
...
DECLARE_ACHIEVEMENT(CAchievementTFFoundry_PlayEachClass, ACHIEVEMENT_TF_MAPS_FOUNDRY_PLAY_EACH_CLASS,
					"TF_MAPS_FOUNDRY_PLAY_EACH_CLASS", 5);
...
public:
	...
	void FireGameEvent_Internal(IGameEvent *event)
	{
		...
		else if(FStrEq(pszEventName, "player_killed_achievement_zone"))
		{
			...
			if(pLocalPlayer && (pLocalPlayer == pAttacker) && pVictim &&
			   (pVictim->GetTeamNumber() != pAttacker->GetTeamNumber()))
			{
				iKillCount++;
				if(iKillCount >= 2)
				{
...
DECLARE_ACHIEVEMENT(CAchievementTFFoundry_KillEnemyOnRoof, ACHIEVEMENT_TF_MAPS_FOUNDRY_KILL_ENEMY_ON_ROOF,
					"TF_MAPS_FOUNDRY_KILL_ENEMY_ON_ROOF", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFFoundry_BackAndForthBattle, ACHIEVEMENT_TF_MAPS_FOUNDRY_BACK_AND_FORTH_BATTLE,
					"TF_MAPS_FOUNDRY_BACK_AND_FORTH_BATTLE", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFFoundry_AchieveProgress1, ACHIEVEMENT_TF_MAPS_FOUNDRY_ACHIEVE_PROGRESS1,
					"TF_MAPS_FOUNDRY_ACHIEVE_PROGRESS1", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDoomsday_SoloCapture, ACHIEVEMENT_TF_MAPS_DOOMSDAY_SOLO_CAPTURE,
					"TF_MAPS_DOOMSDAY_SOLO_CAPTURE", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDoomsday_PlayGameFriends, ACHIEVEMENT_TF_MAPS_DOOMSDAY_PLAY_GAME_FRIENDS,
					"TF_MAPS_DOOMSDAY_PLAY_GAME_FRIENDS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDoomsday_WinRounds, ACHIEVEMENT_TF_MAPS_DOOMSDAY_WIN_ROUNDS,
					"TF_MAPS_DOOMSDAY_WIN_ROUNDS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDoomsday_PlayEachClass, ACHIEVEMENT_TF_MAPS_DOOMSDAY_PLAY_EACH_CLASS,
					"TF_MAPS_DOOMSDAY_PLAY_EACH_CLASS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDoomsday_KillEnemiesOnElevator, ACHIEVEMENT_TF_MAPS_DOOMSDAY_KILL_ENEMIES_ON_ELEVATOR,
					"TF_MAPS_DOOMSDAY_KILL_ENEMIES_ON_ELEVATOR", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDoomsday_PushBackAndWin, ACHIEVEMENT_TF_MAPS_DOOMSDAY_PUSH_BACK_AND_WIN,
					"TF_MAPS_DOOMSDAY_PUSH_BACK_AND_WIN", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDoomsday_KillCarriers, ACHIEVEMENT_TF_MAPS_DOOMSDAY_KILL_CARRIERS,
					"TF_MAPS_DOOMSDAY_KILL_CARRIERS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDoomsday_RideTheElevator, ACHIEVEMENT_TF_MAPS_DOOMSDAY_RIDE_THE_ELEVATOR,
					"TF_MAPS_DOOMSDAY_RIDE_THE_ELEVATOR", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDoomsday_DenyNeutralPickup, ACHIEVEMENT_TF_MAPS_DOOMSDAY_DENY_NEUTRAL_PICKUP,
					"TF_MAPS_DOOMSDAY_DENY_NEUTRAL_PICKUP", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDoomsday_PushIntoExhaust, ACHIEVEMENT_TF_MAPS_DOOMSDAY_PUSH_INTO_EXHAUST,
					"TF_MAPS_DOOMSDAY_PUSH_INTO_EXHAUST", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDoomsday_DefendCarrier, ACHIEVEMENT_TF_MAPS_DOOMSDAY_DEFEND_CARRIER,
					"TF_MAPS_DOOMSDAY_DEFEND_CARRIER", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFDoomsday_AchieveProgress1, ACHIEVEMENT_TF_MAPS_DOOMSDAY_ACHIEVE_PROGRESS1,
					"TF_MAPS_DOOMSDAY_ACHIEVE_PROGRESS1", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFStandin_WinRounds, ACHIEVEMENT_TF_MAPS_STANDIN_WIN_ROUNDS,
					"TF_MAPS_STANDIN_WIN_ROUNDS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFProcess_WinRounds, ACHIEVEMENT_TF_MAPS_PROCESS_WIN_ROUNDS,
					"TF_MAPS_PROCESS_WIN_ROUNDS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSnakewater_WinRounds, ACHIEVEMENT_TF_MAPS_SNAKEWATER_WIN_ROUNDS,
					"TF_MAPS_SNAKEWATER_WIN_ROUNDS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSnakewater_PushBackAndWin, ACHIEVEMENT_TF_MAPS_SNAKEWATER_PUSH_BACK_AND_WIN,
					"TF_MAPS_SNAKEWATER_PUSH_BACK_AND_WIN", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSnakewater_TeamKill, ACHIEVEMENT_TF_MAPS_SNAKEWATER_TEAM_KILL,
					"TF_MAPS_SNAKEWATER_TEAM_KILL", 5);
...
class CAchievementTFSnakewater_DoubleAirDeaths : public CBaseTFAchievementSimple
{
									...
									IGameEvent *event)
	{
		...
		{
			if(pTFAttacker && pTFVictim && (pTFAttacker != pTFVictim) &&
			   ((pTFAttacker == pTFLocalPlayer) || (pTFVictim == pTFLocalPlayer)))
			{
				...
				if((iWeaponID == TF_WEAPON_ROCKETLAUNCHER) || (iWeaponID == TF_WEAPON_ROCKETLAUNCHER_DIRECTHIT))
				{
					...
					if((m_nKilledLocalPlayer > -1) &&
					   (m_PotentialPartners.Find(m_nKilledLocalPlayer) != m_PotentialPartners.InvalidIndex()))
					{
						AwardAchievement();
					}
				}
...
DECLARE_ACHIEVEMENT(CAchievementTFSnakewater_DoubleAirDeaths, ACHIEVEMENT_TF_MAPS_SNAKEWATER_DOUBLE_AIR_DEATHS,
					"TF_MAPS_SNAKEWATER_DOUBLE_AIR_DEATHS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSnakewater_KillEnemiesInMiddle, ACHIEVEMENT_TF_MAPS_SNAKEWATER_KILL_ENEMIES_IN_MIDDLE,
					"TF_MAPS_SNAKEWATER_KILL_ENEMIES_IN_MIDDLE", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFPowerhouse_WinRounds, ACHIEVEMENT_TF_MAPS_POWERHOUSE_WIN_ROUNDS,
					"TF_MAPS_POWERHOUSE_WIN_ROUNDS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFPowerhouse_PushBackAndWin, ACHIEVEMENT_TF_MAPS_POWERHOUSE_PUSH_BACK_AND_WIN,
					"TF_MAPS_POWERHOUSE_PUSH_BACK_AND_WIN", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFPowerhouse_FastFinalCap, ACHIEVEMENT_TF_MAPS_POWERHOUSE_FAST_FINAL_CAP,
					"TF_MAPS_POWERHOUSE_FAST_FINAL_CAP", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFPowerhouse_KillCappingPlayer, ACHIEVEMENT_TF_MAPS_POWERHOUSE_KILL_CAPPING_PLAYER,
					"TF_MAPS_POWERHOUSE_KILL_CAPPING_PLAYER", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFPowerhouse_KillEnemyInWater, ACHIEVEMENT_TF_MAPS_POWERHOUSE_KILL_ENEMY_IN_WATER,
					"TF_MAPS_POWERHOUSE_KILL_ENEMY_IN_WATER", 5);
