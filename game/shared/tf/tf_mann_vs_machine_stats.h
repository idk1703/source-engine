...
{
	CMannVsMachinePlayerStats() : nDeaths(0), nBotDamage(0), nGiantDamage(0), nTankDamage(0) {}
...
{
	CPlayerWaveSpendingStats() : nCreditsSpentOnBuyBacks(0), nCreditsSpentOnBottles(0), nCreditsSpentOnUpgrades(0) {}
...
public:
	...
	void PlayerEvent_Upgraded(CTFPlayer *pTFPlayer, uint16 nItemDef, uint16 nAttributeDef, uint8 nQuality, int16 nCost,
							  bool bIsBottle);
	...
	void SW_ReportClientUpgradePurchase(uint8 waveIdx, uint16 nItemDef, uint16 nAttributeDef, uint8 nQuality,
										int16 nCost);
