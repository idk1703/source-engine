...
{
	CTFGrenadeGasProjectile *pGrenade = static_cast<CTFGrenadeGasProjectile *>(
		CTFWeaponBaseGrenadeProj::Create("tf_weapon_grenade_gas_projectile", position, angles, velocity, angVelocity,
...
void CTFGrenadeGasProjectile::Think_Emit(void)
{
	...
	float flDamage = 10;
	CTakeDamageInfo info(this, GetThrower(), vec3_origin, vecOrigin, flDamage,
						 DMG_NERVEGAS | DMG_PREVENT_PHYSICS_FORCE);
