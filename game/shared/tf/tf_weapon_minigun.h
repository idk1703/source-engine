...
private:
	...
	virtual void ViewModelAttachmentBlending(CStudioHdr *hdr, Vector pos[], Quaternion q[], float currentTime,
											 int boneMask);
#endif
...
private:
	...
	} // override base class call to play shoot sound; we handle that ourselves separately
