...
bool CXPSource::BYieldingAddWriteToTransaction(GCSDK::CSQLAccess &sqlAccess, const CUtlVector<int> &fields)
{
	...
	FOR_EACH_VEC(fields, nField)
	{
		...
		{
			case CMsgTFXPSource::kAccountIdFieldNumber:
				csDatabaseDirty.BAddColumn(CSchPlayerXPSources::k_iField_unAccountID);
				break;
			case CMsgTFXPSource::kAmountFieldNumber:
				csDatabaseDirty.BAddColumn(CSchPlayerXPSources::k_iField_unAmount);
				break;
			case CMsgTFXPSource::kTypeFieldNumber:
				csDatabaseDirty.BAddColumn(CSchPlayerXPSources::k_iField_eSource);
				break;
			case CMsgTFXPSource::kMatchGroupFieldNumber:
				csDatabaseDirty.BAddColumn(CSchPlayerXPSources::k_iField_eMatchGroup);
				break;
			case CMsgTFXPSource::kMatchIdFieldNumber:
				csDatabaseDirty.BAddColumn(CSchPlayerXPSources::k_iField_unMatchID);
				break;
			default:
				Assert(false);
		}
