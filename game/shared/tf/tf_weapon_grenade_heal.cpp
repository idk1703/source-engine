...
ConVar tf_grenade_heal_amount("tf_grenade_heal_amount", "100", FCVAR_CHEAT,
							  "Amount healed by the medic heal grenade.\n");
...
{
	CTFGrenadeHealProjectile *pGrenade = static_cast<CTFGrenadeHealProjectile *>(
		CTFWeaponBaseGrenadeProj::Create("tf_weapon_grenade_heal_projectile", position, angles, velocity, angVelocity,
