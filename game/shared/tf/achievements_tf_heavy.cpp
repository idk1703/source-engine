...
DECLARE_ACHIEVEMENT(CAchievementTFHeavy_DamageTypesTaken, ACHIEVEMENT_TF_HEAVY_TAKE_MULTI_DAMAGE,
					"TF_HEAVY_TAKE_MULTI_DAMAGE", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHeavy_SurviveCrocket, ACHIEVEMENT_TF_HEAVY_SURVIVE_CROCKET,
					"TF_HEAVY_SURVIVE_CROCKET", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHeavy_KillHeaviesGloves, ACHIEVEMENT_TF_HEAVY_KILL_HEAVIES_GLOVES,
					"TF_HEAVY_KILL_HEAVIES_GLOVES", 5);
									...
									IGameEvent *event)
	{
		...
		if(pLocalPlayer)
		{
			...
			if(iAssisterIndex > 0)
			{
				...
				{
					if(pTFAssister && pTFAssister->IsPlayerClass(TF_CLASS_HEAVYWEAPONS) && pTFAttacker &&
					   pTFAttacker->IsPlayerClass(TF_CLASS_HEAVYWEAPONS))
					{
						IncrementCount();
					}
				}
...
DECLARE_ACHIEVEMENT(CAchievementTFHeavy_AssistHeavyGrind, ACHIEVEMENT_TF_HEAVY_ASSIST_HEAVY_GRIND,
					"TF_HEAVY_ASSIST_HEAVY_GRIND", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHeavy_KillDominated, ACHIEVEMENT_TF_HEAVY_KILL_DOMINATED, "TF_HEAVY_KILL_DOMINATED",
					5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHeavy_KillCritPunch, ACHIEVEMENT_TF_HEAVY_KILL_CRIT_PUNCH, "TF_HEAVY_KILL_CRIT_PUNCH",
					5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHeavy_KillUnderwater, ACHIEVEMENT_TF_HEAVY_KILL_UNDERWATER,
					"TF_HEAVY_KILL_UNDERWATER", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHeavy_ReceiveUberGrind, ACHIEVEMENT_TF_HEAVY_RECEIVE_UBER_GRIND,
					"TF_HEAVY_RECEIVE_UBER_GRIND", 5);
...
class CAchievementTFHeavy_KillWhileSpunup : public CBaseTFAchievement
{
	...
	void FireGameEvent_Internal(IGameEvent *event)
	{
		if(FStrEq(event->GetName(), "localplayer_winddown") || FStrEq(event->GetName(), "teamplay_round_active") ||
...
DECLARE_ACHIEVEMENT(CAchievementTFHeavy_KillWhileSpunup, ACHIEVEMENT_TF_HEAVY_KILL_WHILE_SPUNUP,
					"TF_HEAVY_KILL_WHILE_SPUNUP", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHeavy_PayloadCapGrind, ACHIEVEMENT_TF_HEAVY_PAYLOAD_CAP_GRIND,
					"TF_HEAVY_PAYLOAD_CAP_GRIND", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHeavy_KillMidAirMinigun, ACHIEVEMENT_TF_HEAVY_KILL_MIDAIR_MINIGUN,
					"TF_HEAVY_KILL_MIDAIR_MINIGUN", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHeavy_DefendControlPoint, ACHIEVEMENT_TF_HEAVY_DEFEND_CONTROL_POINT,
					"TF_HEAVY_DEFEND_CONTROL_POINT", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHeavy_EarnDominationForMedic, ACHIEVEMENT_TF_HEAVY_EARN_MEDIC_DOMINATION,
					"TF_HEAVY_EARN_MEDIC_DOMINATION", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHeavy_ClearStickybombs, ACHIEVEMENT_TF_HEAVY_CLEAR_STICKYBOMBS,
					"TF_HEAVY_CLEAR_STICKYBOMBS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHeavy_TeleportFastKill, ACHIEVEMENT_TF_HEAVY_TELEPORT_FAST_KILL,
					"TF_HEAVY_TELEPORT_FAST_KILL", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHeavy_FreezecamTaunt, ACHIEVEMENT_TF_HEAVY_FREEZECAM_TAUNT,
					"TF_HEAVY_FREEZECAM_TAUNT", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHeavy_RevengeAssist, ACHIEVEMENT_TF_HEAVY_REVENGE_ASSIST, "TF_HEAVY_REVENGE_ASSIST",
					5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHeavy_KillCappingEnemies, ACHIEVEMENT_TF_HEAVY_KILL_CAPPING_ENEMIES,
					"TF_HEAVY_KILL_CAPPING_ENEMIES", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHeavy_BlockInvulnHeavy, ACHIEVEMENT_TF_HEAVY_BLOCK_INVULN_HEAVY,
					"TF_HEAVY_BLOCK_INVULN_HEAVY", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHeavy_KillFlagCarriers, ACHIEVEMENT_TF_HEAVY_KILL_FLAG_CARRIERS,
					"TF_HEAVY_KILL_FLAG_CARRIERS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHeavy_StandNearDispenser, ACHIEVEMENT_TF_HEAVY_STAND_NEAR_DISPENSER,
					"TF_HEAVY_STAND_NEAR_DISPENSER", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHeavy_EatSandwiches, ACHIEVEMENT_TF_HEAVY_EAT_SANDWICHES, "TF_HEAVY_EAT_SANDWICHES",
					5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHeavy_AssistMedicLarge, ACHIEVEMENT_TF_HEAVY_ASSIST_MEDIC_LARGE,
					"TF_HEAVY_ASSIST_MEDIC_LARGE", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHeavy_KillMedicPair, ACHIEVEMENT_TF_HEAVY_KILL_MEDIC_PAIR, "TF_HEAVY_KILL_MEDIC_PAIR",
					5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHeavy_AchieveProgress1, ACHIEVEMENT_TF_HEAVY_ACHIEVE_PROGRESS1,
					"TF_HEAVY_ACHIEVE_PROGRESS1", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHeavy_AchieveProgress2, ACHIEVEMENT_TF_HEAVY_ACHIEVE_PROGRESS2,
					"TF_HEAVY_ACHIEVE_PROGRESS2", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFHeavy_AchieveProgress3, ACHIEVEMENT_TF_HEAVY_ACHIEVE_PROGRESS3,
					"TF_HEAVY_ACHIEVE_PROGRESS3", 5);
