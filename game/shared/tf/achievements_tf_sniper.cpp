...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_JarateDominated, ACHIEVEMENT_TF_SNIPER_JARATE_DOMINATED,
					"TF_SNIPER_JARATE_DOMINATED", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_CaptureTheFlag, ACHIEVEMENT_TF_SNIPER_CAPTURE_FLAG, "TF_SNIPER_CAPTURE_FLAG",
					5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_InvisibleSpyKill, ACHIEVEMENT_TF_SNIPER_KILL_INVIS_SPY,
					"TF_SNIPER_KILL_INVIS_SPY", 5);
...
class CAchievementTFSniper_HeadShotSnipers : public CBaseTFAchievement
{
									...
									IGameEvent *event)
	{
		...
		if(pTFVictim && (pAttacker == C_TFPlayer::GetLocalTFPlayer()) && (IsHeadshot(event->GetInt("customkill"))) &&
		   pTFVictim->IsPlayerClass(TF_CLASS_SNIPER))
		{
			IncrementCount();
		}
	}
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_HeadShotSnipers, ACHIEVEMENT_TF_SNIPER_HEADSHOT_SNIPERS,
					"TF_SNIPER_HEADSHOT_SNIPERS", 5);
...
class CAchievementTFSniper_HeadShotDemoman : public CBaseTFAchievement
{
									...
									IGameEvent *event)
	{
		...
		if(pTFVictim && (pAttacker == C_TFPlayer::GetLocalTFPlayer()) && (IsHeadshot(event->GetInt("customkill"))) &&
		   pTFVictim->IsPlayerClass(TF_CLASS_DEMOMAN))
		{
			IncrementCount();
		}
	}
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_HeadShotDemoman, ACHIEVEMENT_TF_SNIPER_HEADSHOT_DEMOMAN,
					"TF_SNIPER_HEADSHOT_DEMOMAN", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_SpyKukriKills, ACHIEVEMENT_TF_SNIPER_KILL_SPIES_MELEE,
					"TF_SNIPER_KILL_SPIES_MELEE", 5);
									...
									IGameEvent *event)
	{
		if(pAttacker == C_BasePlayer::GetLocalPlayer())
		{
			...
			if(pTFVictim && pTFVictim->IsPlayerClass(TF_CLASS_SCOUT) &&
			   WeaponID_IsSniperRifleOrBow(event->GetInt("weaponid")))
			{
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_ScoutMidairKill, ACHIEVEMENT_TF_SNIPER_KILL_MIDAIR_SCOUT,
					"TF_SNIPER_KILL_MIDAIR_SCOUT", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_KillChargedMedic, ACHIEVEMENT_TF_SNIPER_KILL_CHARGED_MEDIC,
					"TF_SNIPER_KILL_CHARGED_MEDIC", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_Consolation_Backstabs, ACHIEVEMENT_TF_SNIPER_GET_BACKSTABBED,
					"TF_SNIPER_GET_BACKSTABBED", 5);

//----------------------------------------------------------------------------------------------------------------
// Dominate an enemy sniper - NOTE: This will probably be iffy if the player you dominated just switched to sniper for
// that death
//----------------------------------------------------------------------------------------------------------------
class CAchievementTFSniper_DominateEnemySniper : public CBaseTFAchievement
{
									...
									IGameEvent *event)
	{
		...
		if(pTFVictim && pAttacker == C_TFPlayer::GetLocalTFPlayer() && pTFVictim->IsPlayerClass(TF_CLASS_SNIPER) &&
		   bDomination == true)
		{
			IncrementCount();
		}
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_DominateEnemySniper, ACHIEVEMENT_TF_SNIPER_DOMINATE_SNIPER,
					"TF_SNIPER_DOMINATE_SNIPER", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_KillNoScope, ACHIEVEMENT_TF_SNIPER_KILL_UNSCOPED, "TF_SNIPER_KILL_UNSCOPED",
					5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_KillWhileDead, ACHIEVEMENT_TF_SNIPER_BOW_KILL_WHILEDEAD,
					"TF_SNIPER_BOW_KILL_WHILEDEAD", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_JarateExtinguish, ACHIEVEMENT_TF_SNIPER_JARATE_EXTINGUISH,
					"TF_SNIPER_JARATE_EXTINGUISH", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_TopScoreboard, ACHIEVEMENT_TF_SNIPER_TOP_SCOREBOARD_GRIND,
					"TF_SNIPER_TOP_SCOREBOARD_GRIND", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_KillRoundStart, ACHIEVEMENT_TF_SNIPER_KILL_AT_ROUNDSTART,
					"TF_SNIPER_KILL_AT_ROUNDSTART", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_FreezecamHat, ACHIEVEMENT_TF_SNIPER_FREEZECAM_HAT, "TF_SNIPER_FREEZECAM_HAT",
					5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_FreezecamWave, ACHIEVEMENT_TF_SNIPER_FREEZECAM_WAVE,
					"TF_SNIPER_FREEZECAM_WAVE", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_DifferentWeaponsKill, ACHIEVEMENT_TF_SNIPER_KILL_WEAPONS,
					"TF_SNIPER_KILL_WEAPONS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_DestroySentry, ACHIEVEMENT_TF_SNIPER_DESTROY_SENTRYGUNS,
					"TF_SNIPER_DESTROY_SENTRYGUNS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_KillEnemiesImportant, ACHIEVEMENT_TF_SNIPER_KILL_OBJECTIVES,
					"TF_SNIPER_KILL_OBJECTIVES", 5);
...
class CAchievementTFSniper_HeadShotPostInvuln : public CBaseTFAchievement
{
									...
									IGameEvent *event)
	{
		...
		{
			if(pTFVictim->m_Shared.GetInvulOffTime() > 0.0f &&
			   (gpGlobals->curtime - pTFVictim->m_Shared.GetInvulOffTime()) <= 1.0f)
			{
				IncrementCount();
			}
		}
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_HeadShotPostInvuln, ACHIEVEMENT_TF_SNIPER_HEADSHOT_POST_INVULN,
					"TF_SNIPER_HEADSHOT_POST_INVULN", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_JarateMedicPair, ACHIEVEMENT_TF_SNIPER_JARATE_MEDIC_PAIR,
					"TF_SNIPER_JARATE_MEDIC_PAIR", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_JarateReveal, ACHIEVEMENT_TF_SNIPER_JARATE_REVEAL_SPY,
					"TF_SNIPER_JARATE_REVEAL_SPY", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_JarateKillMelee, ACHIEVEMENT_TF_SNIPER_JARATE_KILL_MELEE,
					"TF_SNIPER_JARATE_KILL_MELEE", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_ShieldFailedSpy, ACHIEVEMENT_TF_SNIPER_KILL_FAILED_SPY,
					"TF_SNIPER_KILL_FAILED_SPY", 5);
			...
			else
			{
				...
				if(pTFVictim->IsPlayerClass(TF_CLASS_HEAVYWEAPONS))
				{
					for(int i = 1; i <= gpGlobals->maxClients; i++)
					{
						...
						if(pNewTarget && pNewTarget->IsPlayerClass(TF_CLASS_MEDIC) &&
						   pNewTarget->MedicGetHealTarget() == pTFVictim)
						{
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_KillMedicPair, ACHIEVEMENT_TF_SNIPER_BOW_KILL_MEDIC_PAIR,
					"TF_SNIPER_BOW_KILL_MEDIC_PAIR", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_JarateAssists, ACHIEVEMENT_TF_SNIPER_JARATE_ASSISTS,
					"TF_SNIPER_JARATE_ASSISTS", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_KillFlagCarrierBow, ACHIEVEMENT_TF_SNIPER_BOW_KILL_FLAGCARRIER,
					"TF_SNIPER_BOW_KILL_FLAGCARRIER", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_Pincushion, ACHIEVEMENT_TF_SNIPER_BOW_PINCUSHION, "TF_SNIPER_BOW_PINCUSHION",
					5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_SniperRifleNoMissing, ACHIEVEMENT_TF_SNIPER_RIFLE_NO_MISSING,
					"TF_SNIPER_RIFLE_NO_MISSING", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_AchieveProgress1, ACHIEVEMENT_TF_SNIPER_ACHIEVE_PROGRESS1,
					"TF_SNIPER_ACHIEVE_PROGRESS1", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_AchieveProgress2, ACHIEVEMENT_TF_SNIPER_ACHIEVE_PROGRESS2,
					"TF_SNIPER_ACHIEVE_PROGRESS2", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_AchieveProgress3, ACHIEVEMENT_TF_SNIPER_ACHIEVE_PROGRESS3,
					"TF_SNIPER_ACHIEVE_PROGRESS3", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_ClassicRifleNoScopeHeadshot,
					ACHIEVEMENT_TF_SNIPER_CLASSIC_RIFLE_NOSCOPE_HEADSHOT, "TF_SNIPER_CLASSIC_RIFLE_NOSCOPE_HEADSHOT",
					5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_ClassicRifleHeadshotJumper,
					ACHIEVEMENT_TF_SNIPER_CLASSIC_RIFLE_HEADSHOT_JUMPER, "TF_SNIPER_CLASSIC_RIFLE_HEADSHOT_JUMPER", 5);
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_ClassicRifleGibGrind, ACHIEVEMENT_TF_SNIPER_CLASSIC_RIFLE_GIB_GRIND,
					"TF_SNIPER_CLASSIC_RIFLE_GIB_GRIND", 5);
									...
									IGameEvent *event)
	{
		if(pVictim && (pAttacker == CBasePlayer::GetLocalPlayer()))
		{
			...
			if(pTFVictim && (pAttacker == C_TFPlayer::GetLocalTFPlayer()) &&
			   (IsHeadshot(event->GetInt("customkill"))) && (event->GetInt("damagebits") & DMG_CRITICAL) &&
...
DECLARE_ACHIEVEMENT(CAchievementTFSniper_ParachuteGrind, ACHIEVEMENT_TF_SNIPER_PARACHUTE_GRIND,
					"TF_SNIPER_PARACHUTE_GRIND", 5);
