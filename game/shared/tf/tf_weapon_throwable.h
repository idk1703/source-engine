...
//	virtual void		SetCustomPipebombModel()			{ SetModel(
...
public:
	...
	virtual void SetCustomPipebombModel()
	{
		SetModel("models/props_gameplay/small_loaf.mdl");
	}
	virtual bool ExplodesOnHit()
	{
		return false;
	...
	{
		Explode();
	} // Timer based 'Explode' Just Remove
...
public:
	...
	virtual void SetCustomPipebombModel(void) OVERRIDE
	{
		return;
	}
	virtual float GetShakeAmplitude(void) OVERRIDE
	{
		return 10.f;
	}
	...
	virtual void Detonate(); // Timer based Explode
	virtual void Explode();	 // Explode Helper
	virtual float GetDamageRadius(void) const OVERRIDE
	{
		return 200.f;
	}

	virtual const char *GetExplodeEffectParticle(void) const OVERRIDE
	{
		return "mvm_soldier_shockwave";
	}
	virtual const char *GetExplodeEffectSound(void) const OVERRIDE
	{
		return "Weapon_Grenade_Concussion.Explode";
	}
#endif // GAME_DLL
};
...
public:
	...
	virtual bool ExplodesOnHit() OVERRIDE
	{
		return true;
	}
	...
	virtual const char *GetExplodeEffectSound(void) const OVERRIDE
	{
		return "Weapon_Grenade_Teleport.Explode";
	}
...
public:
	...
	virtual void SetCustomPipebombModel()
	{
		SetModel("models/workshop_partner/weapons/c_models/c_sd_cleaver/c_sd_cleaver.mdl");
	}
#else
	virtual void SetCustomPipebombModel()
	{
		SetModel("models/weapons/c_models/c_sd_cleaver/c_sd_cleaver.mdl");
	}
#endif
	virtual bool ExplodesOnHit()
	{
	...
	virtual int GetProjectileType(void) const OVERRIDE
	{
		return TF_PROJECTILE_THROWING_KNIFE;
	}
	...
	virtual float GetBackHitDamage()
	{
		return RemapVal(m_flChargePercent, 0, 1, 35.0f, 60.0f);
	} // x3 for crit
	virtual float GetDamageRadius() const
	{
		return 0.0f;
