...
//---------------------------------------------------------------------------------
class CTFRatingData
	: public GCSDK::CProtoBufSharedObject<CSOTFRatingData, k_EProtoObjectTFRatingData, /* bPublicMutable */ false>
{
public:
	CTFRatingData();
	...
	virtual bool BIsNetworked() const OVERRIDE
	{
		return true;
	}
	virtual bool BIsDatabaseBacked() const OVERRIDE
	{
		return true;
	}
...
private:
	...
	bool BYieldingUpdateRatingAndAddToTransaction(CSQLAccess &transaction, const MMRatingData_t &newData,
												  EMMRatingSource eAdjustmentSource, uint64_t unSourceEventID,
												  RTime32 rtTimestamp);
#endif // GC
