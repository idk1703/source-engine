...
private:
	...
	void CollisionAABBToWorldAABB(const Vector &entityMins, const Vector &entityMaxs, Vector *pWorldMins,
...
{
	return ((m_usSolidFlags & FSOLID_FORCE_WORLD_ALIGNED) == 0) && (m_nSolidType != SOLID_BBOX) &&
