...
BEGIN_DATADESC(CCrossbowBolt)
	// Function Pointers
	DEFINE_FUNCTION(BubbleThink), DEFINE_FUNCTION(BoltTouch), DEFINE_FUNCTION(ExplodeThink),
END_DATADESC()
...
void CCrossbowBolt::BoltTouch(CBaseEntity *pOther)
{
	...
	if(pOther->m_takedamage != DAMAGE_NO)
	{
		...
		{
			CTakeDamageInfo dmgInfo(this, GetOwnerEntity(),
									sk_plr_dmg_xbow_bolt_npc.GetFloat() * g_pGameRules->GetDamageMultiplier(),
		...
		UTIL_TraceLine(GetAbsOrigin(), GetAbsOrigin() + vForward * 128, MASK_OPAQUE, pOther, COLLISION_GROUP_NONE,
					   &tr2);
...
void CCrossbowBolt::ExplodeThink(void)
{
	...
	CTakeDamageInfo dmgInfo(this, GetOwnerEntity(),
							sk_plr_dmg_xbow_bolt_npc.GetFloat() * g_pGameRules->GetDamageMultiplier(), DMG_BLAST);
