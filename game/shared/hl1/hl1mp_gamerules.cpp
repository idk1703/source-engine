...
END_RECV_TABLE()
#else
void *SendProxy_HL1MPRules(const SendProp *pProp, const void *pStructBase, const void *pData,
...
void CHL1MPRules::ClientSettingsChanged(CBasePlayer *pPlayer)
{
	...
	Q_FileBase(engine->GetClientConVarValue(engine->IndexOfEdict(pPlayer->edict()), "cl_playermodel"), szTempModelName,
			   128);
