...
namespace GCSDK
{
	...
	class CPartyInvite : public GCSDK::CProtoBufSharedObject<CSOPartyInvite, k_EProtoObjectPartyInvite>,
						 public GCSDK::IPlayerGroupInvite
	{
		...
		// specific versions of them DECLARE_CLASS_MEMPOOL( CPartyInvite );
