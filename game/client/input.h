...
public:
	...
	Vector2D PerformSteamControllerCameraMove(ESteamControllerPad ePad, Vector2D vecPadPosition, bool bFingerDown,
											  float flFrametime);
...
private:
	...
	// Used to support hotplugging by reinitializing the advanced joystick system when we toggle between some/none
	// joysticks.
