...
RecvPropBool(RECVINFO(m_bIsInfiniteLife)), RecvPropFloat(RECVINFO(m_fTimeTillDeath)),
...
()
	...
	// Purpose:
	//-----------------------------------------------------------------------------
	C_PropEnergyBall::C_PropEnergyBall()
	: m_bIsInfiniteLife(false), m_fTimeTillDeath(-1), m_fCurAlpha(1.0f)
{
}
...
//-----------------------------------------------------------------------------
// Purpose: Use our custom body materials for energy ball, but otherwise use the base class materials (base being
// C_PropCombineBall) Output : bool
//-----------------------------------------------------------------------------
