...
public:
	...
	CCSBaseAchievement *GetAchievementInfo(void)
	{
		return m_pSourceAchievement;
	}
...
public:
	CAchievementsPageGroupPanel(vgui::PanelListPanel *parent, CAchievementsPage *owner, const char *name,
								int iListItemID);
	...
	int GetFirstAchievementID()
	{
		return m_iFirstAchievementID;
	}
	int GetLastAchievementID()
	{
		return m_iLastAchievementID;
	}
