...
WinPanel_Round::WinPanel_Round(const char *pElementName)
	: BorderedPanel(NULL, pElementName), CHudElement(pElementName), m_bIsFading(false), m_fFadeBeginTime(0.0f)
{
...
//=============================================================================
ConVar cl_nowinpanel("cl_nowinpanel", "0", FCVAR_ARCHIVE, "Turn on/off win panel on client");
//=============================================================================
// HPE_END
//=============================================================================
		...
		*/
		...
		if(strlen(funfactToken) != 0)
		{
			...
			if(iFunFactPlayer >= 1 && iFunFactPlayer <= MAX_PLAYERS)
			{
				...
				if(playerName && Q_strcmp(playerName, PLAYER_UNCONNECTED_NAME) != 0 &&
				   Q_strcmp(playerName, PLAYER_ERROR_NAME) != 0)
				{
...
void WinPanel_Round::SetMVP(C_CSPlayer *pPlayer, CSMvpReason_t reason)
{
	...
	//=============================================================================
	{
		...
		g_pVGuiLocalize->ConvertANSIToUnicode(UTIL_SafeName(pPlayer->GetPlayerName()), wszPlayerName,
