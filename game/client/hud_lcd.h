...
{
public:
	CLCDItem() : m_bActive(true), m_nSubPage(0), m_Type(LCDITEM_UNKNOWN), m_Handle(0), x(0), y(0), w(0), h(0) {}
...
public:
	CLCDItemText() : m_bHasWildcard(false), m_iSize(0), m_iAlign(0)
	{
		m_Type = LCDITEM_TEXT;
	}
...
public:
	CLCDItemAggregate() : m_AggType(AGGTYPE_UNKNOWN), m_dwNextUpdateTime(0), m_yincrement(0)
	{
...
{
public:
	CLCDPage() : m_bSubItem(false), m_bTitlePage(false), m_bRequiresPlayer(false), m_nSubPageCount(1)
	{
		m_Type = LCDITEM_PAGE;
	}
