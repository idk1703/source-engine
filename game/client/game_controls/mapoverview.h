...
typedef bool (*FnCustomMapOverviewObjectPaint)(int textureID, Vector pos, float scale, float angle, const char *text,
											   Color *textColor, float status, Color *statusColor);
...
public:
	...
	// Object settings
	virtual int AddObject(const char *icon, int entity,
