...
public:
	CReplayPerformanceSaveDlg(Panel *pParent, const char *pName, OnConfirmSaveCallback pfnCallback, void *pContext,
												...
												bool bExitEditorWhenDone)
{
	...
	ms_hDlg = vgui::SETUP_PANEL(
		new CReplayPerformanceSaveDlg(NULL, "ReplayInputPanel", pfnCallback, pContext, pReplay, bExitEditorWhenDone));
...
bool CReplayPerformanceSaveDlg::ConfirmOverwriteOrSaveNow()
{
	...
	{
		ShowConfirmDialog("#Replay_OverwriteDlgTitle", "#Replay_OverwriteDlgText", "#Replay_ConfirmOverwrite",
						  "#Replay_Cancel", OnConfirmOverwrite, NULL, this);
		return false;
	}
