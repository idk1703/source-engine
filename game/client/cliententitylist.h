...
#define INPVS_THISFRAME \
	0x0002 // Accumulated as different views are rendered during the frame and used to notify the entity if
...
private:
	...
	CUtlMap<IClientUnknown *, unsigned short, unsigned short>
		m_PVSNotifierMap; // Maps IClientUnknowns to indices into m_PVSNotifyInfos.
};
