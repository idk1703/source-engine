...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CHudDODDamageIndicator::CHudDODDamageIndicator(const char *pElementName)
...
void CHudDODDamageIndicator::DrawDamageIndicator(int side)
{
	...
	int y[4] = {(int)(m_flDmgY), (int)(m_flDmgY + insetY), (int)(m_flDmgY + m_flDmgTall1 - insetY),
				(int)(m_flDmgY + m_flDmgTall1)};
	int alpha[4] = {0, 1, 1, 0};
	...
	switch(side)
	{
		case 0: // left
		{
			if(bHighDamage)
			{
				r = m_DmgHighColorLeft[0], g = m_DmgHighColorLeft[1], b = m_DmgHighColorLeft[2],
				a = m_DmgHighColorLeft[3];
			}
			else
			{
		...
		case 1: // right
		{
			if(bHighDamage)
			{
				r = m_DmgHighColorRight[0], g = m_DmgHighColorRight[1], b = m_DmgHighColorRight[2],
				a = m_DmgHighColorRight[3];
			}
			else
			{
...
void CHudDODDamageIndicator::DrawFullscreenDamageIndicator()
{
	...
	CMeshBuilder meshBuilder;
	meshBuilder.Begin(pMesh, MATERIAL_QUADS, 1);
	int r = m_DmgFullscreenColor[0], g = m_DmgFullscreenColor[1], b = m_DmgFullscreenColor[2],
		a = m_DmgFullscreenColor[3];
