...
RecvPropFloat(RECVINFO(m_SpawnRate)), RecvPropFloat(RECVINFO(m_ParticleLifetime)),
	RecvPropFloat(RECVINFO(m_StopEmitTime)), RecvPropInt(RECVINFO(m_bEmit)), RecvPropInt(RECVINFO(m_nAttachment)),
END_RECV_TABLE
()
