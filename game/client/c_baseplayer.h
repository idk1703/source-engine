...
public:
	...
	virtual bool GetRagdollInitBoneArrays(matrix3x4_t *pDeltaBones0, matrix3x4_t *pDeltaBones1,
										  matrix3x4_t *pCurrentBones, float boneDt) OVERRIDE;
	...
	void BuildFirstPersonMeathookTransformations(CStudioHdr *hdr, Vector *pos, Quaternion q[],
...
protected:
	...
	void CalcVehicleView(IClientVehicle *pVehicle, Vector &eyeOrigin, QAngle &eyeAngles, float &zNear, float &zFar,
						 float &fov);
