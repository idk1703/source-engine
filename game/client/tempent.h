...
#define FTENT_CLIENTCUSTOM \
	0x00100000 // Must specify callback.  Callback function is responsible for killing tempent and updating fields (
...
#define FTENT_CHANGERENDERONCOLLIDE \
	0x01000000 // when we collide with something, change our rendergroup to RENDER_GROUP_OTHER
