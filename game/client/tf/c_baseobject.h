...
class C_BaseObject : public C_BaseCombatCharacter,
					 ...
					 public ITargetIDProvidesHint,
					 public IBaseObjectAutoList
{
...
public:
	...
	virtual void GetTargetIDString(OUT_Z_BYTECAP(iMaxLenInBytes) wchar_t *sIDString, int iMaxLenInBytes,
								   bool bSpectator);
	...
	{
		return ((m_flInvisibilityPercent != 1.f && flValue == 1.f) ||
				(m_flInvisibilityPercent == 1.f && flValue != 1.f));
	}
