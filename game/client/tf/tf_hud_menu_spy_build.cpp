...
const SpyConstructBuilding_t g_kSpyBuildings[NUM_SPY_BUILDINGS] = {
	// Sap Trap
	SpyConstructBuilding_t(true, OBJ_SPY_TRAP, MODE_SPY_TRAP_RADIUS_STEALTH, "spy_trap_active.res",
						   "spy_trap_already_built.res", "spy_trap_cant_afford.res", "spy_trap_unavailable.res",
						   "spy_trap_active.res", "spy_trap_inactive.res", "spy_trap_inactive.res"),

	// Reprogrammer
	SpyConstructBuilding_t(true, OBJ_SPY_TRAP, MODE_SPY_TRAP_REPROGRAM, "spy_trap_reprog_active.res",
						   "spy_trap_reprog_already_built.res", "spy_trap_reprog_cant_afford.res",
						   "spy_trap_reprog_unavailable.res", "spy_trap_reprog_active.res",
						   "spy_trap_reprog_inactive.res", "spy_trap_reprog_inactive.res"),

	// Pulse Magnet
	SpyConstructBuilding_t(true, OBJ_SPY_TRAP, MODE_SPY_TRAP_MAGNET, "spy_trap_magnet_active.res",
						   "spy_trap_magnet_already_built.res", "spy_trap_magnet_cant_afford.res",
						   "spy_trap_magnet_unavailable.res", "spy_trap_magnet_active.res",
						   "spy_trap_magnet_inactive.res", "spy_trap_magnet_inactive.res"),
...
const SpyConstructBuildingReplacement_t s_alternateSpyBuildings[] = {
	// Temp - modify this
	SpyConstructBuildingReplacement_t(OBJ_CATAPULT, 0, "spy_trap_active.res", "spy_trap_already_built.res",
									  "spy_trap_cant_afford.res", "spy_trap_unavailable.res", "spy_trap_active.res",
									  "spy_trap_inactive.res", "spy_trap_inactive.res", trapSlots[0], trapSlots[1]),
...
// Purpose:
//-----------------------------------------------------------------------------
CHudMenuSpyBuild::CHudMenuSpyBuild(const char *pElementName) : CHudBaseBuildMenu(pElementName, "HudMenuSpyBuild")
{
...
void CHudMenuSpyBuild::ApplySchemeSettings(IScheme *pScheme)
{
	...
	if(b360Style)
	{
		...
		// ); 		m_pAlreadyBuiltObjects[2]->LoadControlSettings(
...
// Purpose:
//-----------------------------------------------------------------------------
void CHudMenuSpyBuild::GetBuildingIDAndModeFromSlot(int iSlot, int &iBuilding, int &iMode,
...
int CHudMenuSpyBuild::HudElementKeyInput(int down, ButtonCode_t keynum, const char *pszCurrentBinding)
{
	...
	else
	{
		...
		if(pszCurrentBinding && (!Q_strncmp(pszCurrentBinding, "slot", NUM_SPY_BUILDINGS) &&
								 Q_strlen(pszCurrentBinding) > NUM_SPY_BUILDINGS))
		{
