...
public:
	CItemAttributeProgressPanel(vgui::Panel *pParent, const char *pElementName,
								const CQuestObjectiveDefinition *pObjectiveDef, const char *pszResFileName);
...
public:
	CItemTrackerPanel(vgui::Panel *pParent, const char *pElementName, const CEconItem *pItem,
	...
	{
		return m_flStandardCurrentProgress == m_flStandardTargetProgress &&
	...
	const CUtlVector<CItemAttributeProgressPanel *> &GetAttributePanels() const
	{
		return m_vecAttribPanels;
	}
