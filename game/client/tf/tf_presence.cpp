...
static s_MapName s_Scenarios[] = {
	{"ctf_2fort", "2Fort"},			{"cp_dustbowl", "Dustbowl"}, {"cp_granary", "Granary"}, {"cp_well", "Well"},
	{"cp_gravelpit", "Gravel Pit"}, {"tc_hydro", "Hydro"},		 {"cloak", "Cloak (CTF)"},	{"cp_cloak", "Cloak (CP)"},
};
...
#if 0 // defined( _X360 ) // absolutely nothing happens in this loop, so I disabled it. It was breaking the compiler in
	  // LTCG mode. -egr
