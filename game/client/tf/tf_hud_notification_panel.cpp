...
ConVar tf_hud_notification_duration("tf_hud_notification_duration", "3.0", 0,
...
ConVar tf_hud_notification_show_count_ghost_controls("tf_hud_notification_show_count_ghost_controls", "0",
													 FCVAR_ARCHIVE);
ConVar tf_hud_notification_show_count_ghost_controls_no_respawn(
	"tf_hud_notification_show_count_ghost_controls_no_respawn", "0", FCVAR_ARCHIVE);
	...
	: CHudElement(pElementName), BaseClass(NULL, "NotificationPanel")
{
	...
	m_mapShowCounts.Insert(HUD_NOTIFY_HOW_TO_CONTROL_GHOST,
						   ShowCount_t(3, 300.f, &tf_hud_notification_show_count_ghost_controls));
	m_mapShowCounts.Insert(HUD_NOTIFY_HOW_TO_CONTROL_KART,
						   ShowCount_t(3, 300.f, &tf_hud_notification_show_count_kart_controls));
	m_mapShowCounts.Insert(HUD_NOTIFY_HOW_TO_CONTROL_GHOST_NO_RESPAWN,
						   ShowCount_t(3, 300.f, &tf_hud_notification_show_count_ghost_controls_no_respawn));
}
