...
public:
	CTFCasualWelcomeDialog() : CTFMessageBoxDialog(NULL, (const char *)NULL, NULL, NULL, NULL) {}
...
//-----------------------------------------------------------------------------
CLobbyContainerFrame_Casual::CLobbyContainerFrame_Casual() : CBaseLobbyContainerFrame("LobbyContainerFrame")
{
...
void CLobbyContainerFrame_Casual::ShowPanel(bool bShow)
{
	if(bShow)
	{
		if(tf_casual_welcome_hide.GetBool() == false && tf_casual_welcome_hide_forever.GetBool() == false &&
