...
public:
	...
	void DirtyQuestLayout()
	{
		m_bQuestsLayoutDirty = true;
	}
	...
	void SetCompletingPanel(const CQuestItemPanel *pItem)
	{
		m_pCompletingPanel = pItem;
	}
	const CQuestItemPanel *GetCompletingPanel() const
	{
		return m_pCompletingPanel;
	}
...
public:
	...
	virtual bool NeedsUpdate(void) OVERRIDE
	{
		return false;
	}
	virtual bool HasInputElements(void) OVERRIDE
	{
		return true;
	}
