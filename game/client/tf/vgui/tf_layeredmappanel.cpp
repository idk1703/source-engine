...
//=========================================================
void CLayeredMapToolTip::GetPosition(itempanel_tooltippos_t iTooltipPosition, CTFLayeredMapItemPanel *pItemPanel,
...
//=========================================================
bool CLayeredMapToolTip::ValidatePosition(CTFLayeredMapItemPanel *pItemPanel, int iItemX, int iItemY, int *iXPos,
										  int *iYPos)
{
...
void CTFLayeredMapPanel::ApplySchemeSettings(vgui::IScheme *pScheme)
{
	...
	if(m_pLayeredMapKv)
	{
		...
		{
			CTFLayeredMapItemPanel *pItem =
				dynamic_cast<CTFLayeredMapItemPanel *>(FindChildByName(VarArgs("MapItem%d", i)));
			if(pItem)
			{
