...
{
public:
	CNextMapWinnerDashboardState(const char *pszName, const char *pszResFile) : CTFMatchmakingPopup(pszName, pszResFile)
	{
	}
...
REG_MM_POPUP_FACTORY(CNextMapWinnerDashboardState, "NextMapWinner",
