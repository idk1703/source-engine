...
private:
	...
	{
	public:
		CRecipeComponentAttributeCounter() : m_nInputCount(0) {}
	...
	private:
		...
		static int LeastCommonInputSortFunc(const CCopyableUtlVector<InputComponent_t> *p1,
											const CCopyableUtlVector<InputComponent_t> *p2);
	...
	void SetRecipeComponentIntoPanel(itemid_t nSrcRecipeIndex, CRecipeComponentItemModelPanel *pSrcPanel, int nSrcPage,
