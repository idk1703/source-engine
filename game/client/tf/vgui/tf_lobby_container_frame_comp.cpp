...
public:
	CTFCompetitiveWelcomeDialog() : CTFMessageBoxDialog(NULL, (const char *)NULL, NULL, NULL, NULL) {}
...
//-----------------------------------------------------------------------------
CLobbyContainerFrame_Comp::CLobbyContainerFrame_Comp() : CBaseLobbyContainerFrame("LobbyContainerFrame")
{
...
void CLobbyContainerFrame_Comp::ShowPanel(bool bShow)
{
	if(bShow)
	{
		if(tf_comp_welcome_hide.GetBool() == false && tf_comp_welcome_hide_forever.GetBool() == false &&
