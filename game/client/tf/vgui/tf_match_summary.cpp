...
void CTFMatchSummary::SetVisible(bool state)
{
	...
	if(state)
	{
		...
		g_pClientMode->GetViewportAnimationController()->StartAnimationSequence("CompetitiveGame_LowerChatWindow",
																				false);
	}
	else
	{
...
void CTFMatchSummary::InitPlayerList(TFSectionedListPanel *pPlayerList, int nTeam)
{
	...
	pPlayerList->AddColumnToSection(0, "medal", "",
									SectionedListPanel::COLUMN_IMAGE | SectionedListPanel::COLUMN_CENTER,
									pPlayerList->m_iMedalWidth);
	pPlayerList->AddColumnToSection(0, "avatar", "",
									SectionedListPanel::COLUMN_IMAGE | SectionedListPanel::COLUMN_RIGHT,
									pPlayerList->m_iAvatarWidth);
	...
	pPlayerList->AddColumnToSection(0, "class", "", SectionedListPanel::COLUMN_IMAGE | SectionedListPanel::COLUMN_RIGHT,
									pPlayerList->m_iClassWidth);
	pPlayerList->AddColumnToSection(0, "score",
									bStandard ? "#TF_Comp_Scoreboard_Score_Standard" : "#TF_Comp_Scoreboard_Score",
									SectionedListPanel::COLUMN_RIGHT, pPlayerList->m_iStatsWidth);
	pPlayerList->AddColumnToSection(0, "score_medal", "",
									SectionedListPanel::COLUMN_IMAGE | SectionedListPanel::COLUMN_RIGHT,
									pPlayerList->m_iAwardWidth);
	pPlayerList->AddColumnToSection(0, "kills",
									bStandard ? "#TF_Comp_Scoreboard_Kills_Standard" : "#TF_Comp_Scoreboard_Kills",
									SectionedListPanel::COLUMN_RIGHT, pPlayerList->m_iStatsWidth);
	pPlayerList->AddColumnToSection(0, "kills_medal", "",
									SectionedListPanel::COLUMN_IMAGE | SectionedListPanel::COLUMN_RIGHT,
									pPlayerList->m_iAwardWidth);
	pPlayerList->AddColumnToSection(0, "damage",
									bStandard ? "#TF_Comp_Scoreboard_Damage_Standard" : "#TF_Comp_Scoreboard_Damage",
									SectionedListPanel::COLUMN_RIGHT, pPlayerList->m_iStatsWidth);
	pPlayerList->AddColumnToSection(0, "damage_medal", "",
									SectionedListPanel::COLUMN_IMAGE | SectionedListPanel::COLUMN_RIGHT,
									pPlayerList->m_iAwardWidth);
	pPlayerList->AddColumnToSection(0, "healing",
									bStandard ? "#TF_Comp_Scoreboard_Healing_Standard" : "#TF_Comp_Scoreboard_Healing",
									SectionedListPanel::COLUMN_RIGHT, pPlayerList->m_iStatsWidth);
	pPlayerList->AddColumnToSection(0, "healing_medal", "",
									SectionedListPanel::COLUMN_IMAGE | SectionedListPanel::COLUMN_RIGHT,
									pPlayerList->m_iAwardWidth);
	pPlayerList->AddColumnToSection(0, "support",
									bStandard ? "#TF_Comp_Scoreboard_Support_Standard" : "#TF_Comp_Scoreboard_Support",
									SectionedListPanel::COLUMN_RIGHT, pPlayerList->m_iStatsWidth);
	pPlayerList->AddColumnToSection(0, "support_medal", "",
									SectionedListPanel::COLUMN_IMAGE | SectionedListPanel::COLUMN_RIGHT,
									pPlayerList->m_iAwardWidth);
}
...
//-----------------------------------------------------------------------------
matchsummary_columns_t CTFMatchSummary::InternalAddMedalKeyValues(int iIndex, StatMedal_t eMedal, KeyValues *pKeyValues,
																  int nTotalMedals /*= -1*/)
{
...
void CTFMatchSummary::UpdatePlayerList()
{
	...
	for(int playerIndex = 1; playerIndex <= MAX_PLAYERS; playerIndex++)
	{
		if(g_PR->IsConnected(playerIndex) || g_PR->IsValid(playerIndex))
		{
			...
			{
				pKeyValues->SetInt("class", tf_scoreboard_alt_class_icons.GetBool() ? m_iImageClassAlt[iClass]
			...
			int nSupport = g_TF_PR->GetDamageAssist(playerIndex) + g_TF_PR->GetHealingAssist(playerIndex) +
						   g_TF_PR->GetDamageBlocked(playerIndex) + (g_TF_PR->GetBonusPoints(playerIndex) * 25);
			...
			else if(m_iCurrentState == MS_STATE_SILVER_MEDALS)
			{
				...
				InternalAddMedalKeyValues(playerIndex, StatMedal_Bronze, pKeyValues);
				eParticleColumn =
					InternalAddMedalKeyValues(playerIndex, StatMedal_Silver, pKeyValues, m_nMedalsRevealed);
				eParticleMedal = StatMedal_Silver;
			}
			else if(m_iCurrentState == MS_STATE_BRONZE_MEDALS)
			{
				eParticleColumn =
					InternalAddMedalKeyValues(playerIndex, StatMedal_Bronze, pKeyValues, m_nMedalsRevealed);
			...
			if(pKey && pKey->GetInt())
			{
				...
				pPlayerList->SetColorOverrideForCell(0, itemID, MS_COLUMN_SCORE,
													 (nMedal == (int)StatMedal_Bronze)	 ? m_clrBronzeMedal
													 : (nMedal == (int)StatMedal_Silver) ? m_clrSilverMedal
																						 : m_clrGoldMedal);
			}
			...
			{
				int nMedal = pKey->GetInt();
				pPlayerList->SetColorOverrideForCell(0, itemID, MS_COLUMN_KILLS,
													 (nMedal == (int)StatMedal_Bronze)	 ? m_clrBronzeMedal
													 : (nMedal == (int)StatMedal_Silver) ? m_clrSilverMedal
																						 : m_clrGoldMedal);
			}
			...
			{
				int nMedal = pKey->GetInt();
				pPlayerList->SetColorOverrideForCell(0, itemID, MS_COLUMN_DAMAGE,
													 (nMedal == (int)StatMedal_Bronze)	 ? m_clrBronzeMedal
													 : (nMedal == (int)StatMedal_Silver) ? m_clrSilverMedal
																						 : m_clrGoldMedal);
			}
			...
			{
				int nMedal = pKey->GetInt();
				pPlayerList->SetColorOverrideForCell(0, itemID, MS_COLUMN_HEALING,
													 (nMedal == (int)StatMedal_Bronze)	 ? m_clrBronzeMedal
													 : (nMedal == (int)StatMedal_Silver) ? m_clrSilverMedal
																						 : m_clrGoldMedal);
			}
			...
			{
				int nMedal = pKey->GetInt();
				pPlayerList->SetColorOverrideForCell(0, itemID, MS_COLUMN_SUPPORT,
													 (nMedal == (int)StatMedal_Bronze)	 ? m_clrBronzeMedal
													 : (nMedal == (int)StatMedal_Silver) ? m_clrSilverMedal
																						 : m_clrGoldMedal);
			}
...
// Purpose:
//-----------------------------------------------------------------------------
void CTFMatchSummary::FireMedalEffects(Panel *pPanel, int nPanelXPos, int nPanelYPos, int nPanelWide, int nPanelTall,
		...
		if(pPlayerList)
		{
			...
			for(int i = 0; i < pPlayerList->GetItemCount(); i++)
			{
...
#endif // STAGING_ONLY
				{
					...
					if((nPanelXPos != xGrandParent + xParent + x) || (nPanelYPos != yGrandParent + yParent + y) ||
					   (nPanelWide != wide) || (nPanelTall != tall))
					{
...
void CTFMatchSummary::FireGameEvent(IGameEvent *event)
{
	...
	else if(FStrEq(type, "competitive_stats_update"))
	{
		...
		if(iIndex > 0 && iIndex <= MAX_PLAYERS)
		{
			...
			m_SkillRatings[iIndex].nScoreRank =
				event->GetInt("score_rank"); // Medal for Score (Gold, Silver, Bronze, or nothing)
	...
	else if(FStrEq(type, "show_match_summary"))
	{
		...
		if(m_pPlayerListRedParent->GetParent())
		{
			...
			FOR_EACH_VEC(m_pRedBadgePanels, i)
			{
				g_pClientMode->GetViewportAnimationController()->RunAnimationCommand(
					m_pRedBadgePanels[i], "xpos", m_pRedBadgePanels[i]->GetXPos() - nRedBadgeOffset, 0.25, 0.25,
		...
		if(m_pPlayerListBlueParent->GetParent())
		{
			...
			{
				g_pClientMode->GetViewportAnimationController()->RunAnimationCommand(
					m_pBlueBadgePanels[i], "xpos", m_pBlueBadgePanels[i]->GetXPos() - nBlueBadgeOffset, 0.25, 0.25,
					vgui::AnimationController::INTERPOLATOR_ACCEL);
			}
		}

		g_pClientMode->GetViewportAnimationController()->StartAnimationSequence(m_pTeamScoresPanel,
																				"HudMatchSummary_SlideInPanels", false);
	}
}
...
void CTFMatchSummary::OnTick()
{
	...
	if(pMatchDesc->m_params.m_bAllowDrawingAtMatchSummary && m_pDrawingPanel && (m_flDrawingPanelTime > 0) &&
...
#ifdef STAGING_ONLY
	bool bUseMatchSummaryStage =
		tf_test_match_summary.GetBool() || (pMatchDesc && pMatchDesc->m_params.m_bUseMatchSummaryStage);
#else
	...
	switch(m_iCurrentState)
	{
		case MS_STATE_INITIAL:
		{
			...
			m_flNextActionTime =
				bUseStage ? gpGlobals->curtime + MS_STATE_TRANSITION_TO_STATS : gpGlobals->curtime + 2.f;
			m_bXPShown = false;
		...
		case MS_STATE_DRAWING:
		{
			if(gpGlobals->curtime > m_flNextActionTime)
			{
				...
				g_pClientMode->GetViewportAnimationController()->RunAnimationCommand(
					m_pStatsLabelPanel, "ypos",
					m_bLargeMatchGroup ? m_iAnimStatsLabelPanel12v12YPos : m_iAnimStatsLabelPanel6v6YPos, 0.0, 0.1,
					vgui::AnimationController::INTERPOLATOR_ACCEL);
				g_pClientMode->GetViewportAnimationController()->RunAnimationCommand(
					m_pBlueMedalsPanel, "ypos", m_iAnimBlueMedalsYPos, 0.0, 0.1,
					vgui::AnimationController::INTERPOLATOR_ACCEL);
				g_pClientMode->GetViewportAnimationController()->RunAnimationCommand(
					m_pRedMedalsPanel, "ypos", m_iAnimRedMedalsYPos, 0.0, 0.1,
					vgui::AnimationController::INTERPOLATOR_ACCEL);
				g_pClientMode->GetViewportAnimationController()->RunAnimationCommand(
					m_pBlueTeamName, "ypos",
					m_bLargeMatchGroup ? m_iAnimBlueTeamLabel12v12YPos : m_iAnimBlueTeamLabel6v6YPos, 0.0, 0.1,
					vgui::AnimationController::INTERPOLATOR_ACCEL);
				g_pClientMode->GetViewportAnimationController()->RunAnimationCommand(
					m_pRedTeamName, "ypos",
					m_bLargeMatchGroup ? m_iAnimRedTeamLabel12v12YPos : m_iAnimRedTeamLabel6v6YPos, 0.0, 0.1,
					vgui::AnimationController::INTERPOLATOR_ACCEL);
				g_pClientMode->GetViewportAnimationController()->RunAnimationCommand(
					m_pPlayerListBlueParent, "wide", m_iAnimBluePlayerListParent, 0.0, 0.1,
					vgui::AnimationController::INTERPOLATOR_ACCEL);
				g_pClientMode->GetViewportAnimationController()->RunAnimationCommand(
					m_pBlueTeamScore, "wide", m_iAnimBlueTeamScore, 0.0, 0.1,
					vgui::AnimationController::INTERPOLATOR_ACCEL);
				g_pClientMode->GetViewportAnimationController()->RunAnimationCommand(
					m_pBlueTeamScoreDropshadow, "wide", m_iAnimBlueTeamScoreDropshadow, 0.0, 0.1,
					vgui::AnimationController::INTERPOLATOR_ACCEL);
				g_pClientMode->GetViewportAnimationController()->RunAnimationCommand(
					m_pBlueTeamScoreBG, "wide", m_iAnimBlueTeamScoreBG, 0.0, 0.1,
					vgui::AnimationController::INTERPOLATOR_ACCEL);
				g_pClientMode->GetViewportAnimationController()->RunAnimationCommand(
					m_pBluePlayerListBG, "wide", m_iAnimBluePlayerListBG, 0.0, 0.1,
					vgui::AnimationController::INTERPOLATOR_ACCEL);
				g_pClientMode->GetViewportAnimationController()->RunAnimationCommand(
					m_pRedTeamScore, "wide", m_iAnimRedTeamScoreWide, 0.0, 0.1,
					vgui::AnimationController::INTERPOLATOR_ACCEL);
				g_pClientMode->GetViewportAnimationController()->RunAnimationCommand(
					m_pRedTeamScore, "xpos", m_iAnimRedTeamScoreXPos, 0.0, 0.1,
					vgui::AnimationController::INTERPOLATOR_ACCEL);
				g_pClientMode->GetViewportAnimationController()->RunAnimationCommand(
					m_pRedTeamScoreDropshadow, "wide", m_iAnimRedTeamScoreDropshadowWide, 0.0, 0.1,
					vgui::AnimationController::INTERPOLATOR_ACCEL);
				g_pClientMode->GetViewportAnimationController()->RunAnimationCommand(
					m_pRedTeamScoreDropshadow, "xpos", m_iAnimRedTeamScoreDropshadowXPos, 0.0, 0.1,
					vgui::AnimationController::INTERPOLATOR_ACCEL);
				g_pClientMode->GetViewportAnimationController()->RunAnimationCommand(
					m_pRedTeamScoreBG, "wide", m_iAnimRedTeamScoreBGWide, 0.0, 0.1,
					vgui::AnimationController::INTERPOLATOR_ACCEL);
				g_pClientMode->GetViewportAnimationController()->RunAnimationCommand(
					m_pRedTeamScoreBG, "xpos", m_iAnimRedTeamScoreBGXPos, 0.0, 0.1,
					vgui::AnimationController::INTERPOLATOR_ACCEL);
				g_pClientMode->GetViewportAnimationController()->RunAnimationCommand(
					m_pPlayerListRedParent, "wide", m_iAnimRedPlayerListParentWide, 0.0, 0.1,
					vgui::AnimationController::INTERPOLATOR_ACCEL);
				g_pClientMode->GetViewportAnimationController()->RunAnimationCommand(
					m_pPlayerListRedParent, "xpos", m_iAnimRedPlayerListParentXPos, 0.0, 0.1,
					vgui::AnimationController::INTERPOLATOR_ACCEL);
				g_pClientMode->GetViewportAnimationController()->RunAnimationCommand(
					m_pRedPlayerListBG, "wide", m_iAnimRedPlayerListBGWide, 0.0, 0.1,
					vgui::AnimationController::INTERPOLATOR_ACCEL);
				g_pClientMode->GetViewportAnimationController()->RunAnimationCommand(
					m_pRedPlayerListBG, "xpos", m_iAnimRedPlayerListBGXPos, 0.0, 0.1,
					vgui::AnimationController::INTERPOLATOR_ACCEL);
				g_pClientMode->GetViewportAnimationController()->RunAnimationCommand(
					m_pBlueTeamWinner, "wide", m_iAnimBlueTeamScore, 0.0, 0.1,
					vgui::AnimationController::INTERPOLATOR_ACCEL);
				g_pClientMode->GetViewportAnimationController()->RunAnimationCommand(
					m_pBlueTeamWinnerDropshadow, "wide", m_iAnimBlueTeamScoreDropshadow, 0.0, 0.1,
					vgui::AnimationController::INTERPOLATOR_ACCEL);
				g_pClientMode->GetViewportAnimationController()->RunAnimationCommand(
					m_pRedTeamWinner, "wide", m_iAnimRedTeamScoreWide, 0.0, 0.1,
					vgui::AnimationController::INTERPOLATOR_ACCEL);
				g_pClientMode->GetViewportAnimationController()->RunAnimationCommand(
					m_pRedTeamWinner, "xpos", m_iAnimRedTeamScoreXPos, 0.0, 0.1,
					vgui::AnimationController::INTERPOLATOR_ACCEL);
				g_pClientMode->GetViewportAnimationController()->RunAnimationCommand(
					m_pRedTeamWinnerDropshadow, "wide", m_iAnimRedTeamScoreDropshadowWide, 0.0, 0.1,
					vgui::AnimationController::INTERPOLATOR_ACCEL);
				g_pClientMode->GetViewportAnimationController()->RunAnimationCommand(
					m_pRedTeamWinnerDropshadow, "xpos", m_iAnimRedTeamScoreDropshadowXPos, 0.0, 0.1,
					vgui::AnimationController::INTERPOLATOR_ACCEL);
				...
				{
					g_pClientMode->GetViewportAnimationController()->RunAnimationCommand(
						m_pRedBadgePanels[i], "xpos", m_pRedBadgePanels[i]->GetXPos() - nRedBadgeOffset, 0.0, 0.1,
						vgui::AnimationController::INTERPOLATOR_ACCEL);
				}
				...
				if(pLocalPlayer)
				{
					if(bShowPerformanceMedals)
					{
						const char *pszEntryName =
							UTIL_GetRandomSoundFromEntry("Announcer.CompSummaryScreenOutlierQuestion");
				...
				m_pStatsAndMedals->SetText(
					bShowPerformanceMedals ? g_pVGuiLocalize->Find("#TF_CompSummary_StatsAndMedals") : L"");
				m_pStatsAndMedalsShadow->SetText(
					bShowPerformanceMedals ? g_pVGuiLocalize->Find("#TF_CompSummary_StatsAndMedals") : L"");
			}
			break;
		}
			...
			if(gpGlobals->curtime > m_flNextActionTime)
			{
				if(!m_bBlueBronzeValueRevealed && !m_bRedBronzeValueRevealed)
				{
					...
					if(pChild)
					{
						...
						FireMedalEffects(pChild, nXPos, nYPos, nWide, nTall,
										 (m_nMedalsToAward_Bronze_Blue > 0) ? StatMedal_Bronze : StatMedal_None);
					}
					...
					if(pChild)
					{
						...
						pChild->GetBounds(nXPos, nYPos, nWide, nTall);
						FireMedalEffects(pChild, nXPos, nYPos, nWide, nTall,
										 (m_nMedalsToAward_Bronze_Red > 0) ? StatMedal_Bronze : StatMedal_None);
					}
			...
			if(gpGlobals->curtime > m_flNextActionTime)
			{
				if(!m_bBlueSilverValueRevealed && !m_bRedSilverValueRevealed)
				{
					...
					if(pChild)
					{
						...
						pChild->GetBounds(nXPos, nYPos, nWide, nTall);
						FireMedalEffects(pChild, nXPos, nYPos, nWide, nTall,
										 (m_nMedalsToAward_Silver_Blue > 0) ? StatMedal_Silver : StatMedal_None);
					}
					...
					if(pChild)
					{
						...
						pChild->GetBounds(nXPos, nYPos, nWide, nTall);
						FireMedalEffects(pChild, nXPos, nYPos, nWide, nTall,
										 (m_nMedalsToAward_Silver_Red > 0) ? StatMedal_Silver : StatMedal_None);
					}
			...
			if(gpGlobals->curtime > m_flNextActionTime)
			{
				if(!m_bBlueGoldValueRevealed && !m_bRedGoldValueRevealed)
				{
					...
					if(pChild)
					{
						...
						pChild->GetBounds(nXPos, nYPos, nWide, nTall);
						FireMedalEffects(pChild, nXPos, nYPos, nWide, nTall,
										 (m_nMedalsToAward_Gold_Blue > 0) ? StatMedal_Gold : StatMedal_None);
					}
					...
					if(pChild)
					{
						...
						pChild->GetBounds(nXPos, nYPos, nWide, nTall);
						FireMedalEffects(pChild, nXPos, nYPos, nWide, nTall,
										 (m_nMedalsToAward_Gold_Red > 0) ? StatMedal_Gold : StatMedal_None);
					}
				...
				else
				{
					...
					else
					{
						...
						if(pLocalPlayer)
						{
							...
							m_flMedalSoundTime =
								gpGlobals->curtime + enginesound->GetSoundDuration(pszSoundName) + 0.5f;
		...
		case MS_STATE_FINAL:
		{
			...
			if(!m_bXPShown /*&& ( !bShowMedals || bMedalSoundTimeComplete ) */)
			{
				g_pClientMode->GetViewportAnimationController()->StartAnimationSequence(
					"CompetitiveGame_ShowPvPRankPanel", false);
				m_bXPShown = true;
			}
				...
				if(bMedalSoundTimeComplete)
				{
					   ...
					   (m_SkillRatings[iLocalPlayerIndex].nSupportRank != StatMedal_None))
					{
						if(pLocalPlayer)
						{
							...
							pLocalPlayer->EmitSound(
								VarArgs("%s.CompSummaryScreenOutlier", g_aPlayerClassNames_NonLocalized[iClass]));
						}
					}
				}
			}
