...
RecvPropInt(RECVINFO(m_iMode)), RecvPropInt(RECVINFO(m_glowColor), 0, RecvProxy_IntToColor32),
	RecvPropBool(RECVINFO(m_bDisabled)), RecvPropEHandle(RECVINFO(m_hTarget)),
END_RECV_TABLE
()
