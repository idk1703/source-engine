...
public:
	...
	static void CreateHudElementsForClass(C_TFPlayer *pPlayer,
...
{
public:
	CHudItemEffectMeter_Weapon(const char *pszElementName, C_TFPlayer *pPlayer, int iWeaponID, bool bBeeps = true,
							   const char *pszResFile = NULL);
	...
	virtual const char *GetLabelText(void)
	{
		return m_pWeapon ? m_pWeapon->GetEffectLabelText() : "";
	}
	virtual const char *GetIconName(void)
	{
		return "../hud/ico_stickybomb_red";
...
public:
	...
	virtual const char *GetResFile(void)
	{
		return "resource/UI/HudItemEffectMeter_Tranq.res";
	}
