...
CTFDisconnectConfirmDialog::CTFDisconnectConfirmDialog(const char *pTitle, const char *pTextKey,
...
CTFDisconnectConfirmDialog *BuildDisconnectConfirmDialog()
{
	...
	CTFDisconnectConfirmDialog *pDialog = vgui::SETUP_PANEL(
		new CTFDisconnectConfirmDialog(pszTitle, pszBody, pszConfirm, "#TF_MM_Rejoin_Stay", NULL, NULL));
...
CON_COMMAND(cl_disconnect_prompt, "Prompt about disconnect")
{
	CTFDisconnectConfirmDialog *pDialog = vgui::SETUP_PANEL(new CTFDisconnectConfirmDialog(
		"#TF_MM_Abandon_Title", "#TF_MM_Abandon", "#TF_Coach_Yes", "#TF_Coach_No", NULL, NULL));
...
//-----------------------------------------------------------------------------
CTFRejoinConfirmDialog::CTFRejoinConfirmDialog(const char *pTitle, const char *pTextKey, const char *pConfirmBtnText,
