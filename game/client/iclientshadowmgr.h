...
public:
	...
	// Create flashlight.
	// FLASHLIGHTFIXME: need to rename all of the shadow stuff to projectedtexture and have flashlights and shadows as
	// instances.
	...
	virtual void AddShadowToReceiver(ClientShadowHandle_t handle, IClientRenderable * pRenderable,
									 ShadowReceiver_t type) = 0;

	virtual void RemoveAllShadowsFromReceiver(IClientRenderable * pRenderable, ShadowReceiver_t type) = 0;
