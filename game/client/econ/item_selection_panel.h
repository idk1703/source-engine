...
protected:
	...
	DuplicateCountsMap_t
		m_DuplicateCounts; // A map of item def indices to item counts. Derived classes should fill this out.
...
public:
	CItemCriteriaSelectionPanel(Panel *parent, const CItemSelectionCriteria *pCriteria, itemid_t pExceptions[] = NULL,
...
public:
	...
	void UpdateOnShow(const CItemSelectionCriteria *pCriteria, bool bForceBackpack, itemid_t pExceptions[] = NULL,
					  int iNumExceptions = 0);
