...
public:
	...
	virtual void RenderingRootModel(IMatRenderContext *pRenderContext, CStudioHdr *pStudioHdr, MDLHandle_t mdlHandle,
									matrix3x4_t *pWorldMatrix) OVERRIDE;
...
private:
	...
	bool UpdateParticle(IMatRenderContext *pRenderContext, CStudioHdr *pStudioHdr, MDLHandle_t mdlHandle,
...
public:
	...
	{
		CEquippableResult() : m_pEconItemView(NULL), m_eDisplayType(kSlotDisplay_Invalid)
		{
			//
		}
	...
	CEquippableItemsForSlotGenerator(int iClass, int iSlot, equip_region_mask_t unUsedEquipRegionMask,
...
private:
	...
	CEconItemView *m_pEquippedItemView; // if kSlotGenerator_EquippedSpecialHandling is passed in, this will store our
										// equipped item; otherwise NULL
};
