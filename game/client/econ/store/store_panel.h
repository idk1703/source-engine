...
public:
	...
	// Steam Interaction
	STEAM_CALLBACK(CStorePanel, OnMicroTransactionAuthResponse, MicroTxnAuthorizationResponse_t,
				   m_CallbackMicroTransactionAuthResponse);
...
void OpenStoreStatusDialog(vgui::Panel *pParent, const char *pszText, bool bAllowClose, bool bShowOnExit,
						   bool bCancel = false);
