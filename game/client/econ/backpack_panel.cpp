...
const ItemSortTypeData_t g_BackpackSortTypes[] = {
	{"#Backpack_SortBy_Header", kGCItemSort_NoSort},	 {"#Backpack_SortBy_Rarity", kGCItemSort_SortByRarity},
	{"#Backpack_SortBy_Type", kGCItemSort_SortByType},	 {"#Backpack_SortBy_Class", kTFGCItemSort_SortByClass},
	{"#Backpack_SortBy_Slot", kTFGCItemSort_SortBySlot}, {"#Backpack_SortBy_Date", kGCItemSort_SortByDate},
};

// Array of borders for rarities. Three borders for each rarity: Base, Mouseover, and Selected
const char *g_szItemBorders[][5] = {
	{"BackpackItemBorder", "BackpackItemMouseOverBorder", "BackpackItemSelectedBorder", "BackpackItemGreyedOutBorder",
	 "BackpackItemGreyedOutSelectedBorder"}, // AE_NORMAL = 0
	{"BackpackItemBorder_1", "BackpackItemMouseOverBorder_1", "BackpackItemSelectedBorder",
	 "BackpackItemGreyedOutBorder_1", "BackpackItemGreyedOutSelectedBorder_1"}, // AE_RARITY1 = 1
	{"BackpackItemBorder_2", "BackpackItemMouseOverBorder_2", "BackpackItemSelectedBorder",
	 "BackpackItemGreyedOutBorder_2", "BackpackItemGreyedOutSelectedBorder_2"}, // AE_RARITY2 = 2
	{"BackpackItemBorder_Vintage", "BackpackItemMouseOverBorder_Vintage", "BackpackItemSelectedBorder",
	 "BackpackItemGreyedOutBorder_Vintage", "BackpackItemGreyedOutSelectedBorder_Vintage"}, // AE_VINTAGE = 3
	{"BackpackItemBorder_3", "BackpackItemMouseOverBorder_3", "BackpackItemSelectedBorder",
	 "BackpackItemGreyedOutBorder_3", "BackpackItemGreyedOutSelectedBorder_3"}, // AE_RARITY3
	{"BackpackItemBorder_4", "BackpackItemMouseOverBorder_4", "BackpackItemSelectedBorder",
	 "BackpackItemGreyedOutBorder_4", "BackpackItemGreyedOutSelectedBorder_4"}, // AE_RARITY4
	{"BackpackItemBorder_Unique", "BackpackItemMouseOverBorder_Unique", "BackpackItemSelectedBorder",
	 "BackpackItemGreyedOutBorder_Unique", "BackpackItemGreyedOutSelectedBorder_Unique"}, // AE_UNIQUE
	{"BackpackItemBorder_Community", "BackpackItemMouseOverBorder_Community", "BackpackItemSelectedBorder",
	 "BackpackItemGreyedOutBorder_Community", "BackpackItemGreyedOutSelectedBorder_Community"}, // AE_COMMUNITY
	{"BackpackItemBorder_Developer", "BackpackItemMouseOverBorder_Developer", "BackpackItemSelectedBorder",
	 "BackpackItemGreyedOutBorder_Developer", "BackpackItemGreyedOutSelectedBorder_Developer"}, // AE_DEVELOPER
	{"BackpackItemBorder_SelfMade", "BackpackItemMouseOverBorder_SelfMade", "BackpackItemSelectedBorder",
	 "BackpackItemGreyedOutBorder_SelfMade", "BackpackItemGreyedOutSelectedBorder_SelfMade"}, // AE_SELFMADE
	{"BackpackItemBorder_Customized", "BackpackItemMouseOverBorder_Customized", "BackpackItemSelectedBorder",
	 "BackpackItemGreyedOutBorder_Customized", "BackpackItemGreyedOutSelectedBorder_Customized"}, // AE_CUSTOMIZED
	{"BackpackItemBorder_Strange", "BackpackItemMouseOverBorder_Strange", "BackpackItemSelectedBorder",
	 "BackpackItemGreyedOutBorder_Strange", "BackpackItemGreyedOutSelectedBorder_Strange"}, // AE_STRANGE
	{"BackpackItemBorder_Completed", "BackpackItemMouseOverBorder_Completed", "BackpackItemSelectedBorder",
	 "BackpackItemGreyedOutBorder_Completed", "BackpackItemGreyedOutSelectedBorder_Completed"}, // AE_COMPLETED
	{"BackpackItemBorder_Haunted", "BackpackItemMouseOverBorder_Haunted", "BackpackItemSelectedBorder",
	 "BackpackItemGreyedOutBorder_Haunted", "BackpackItemGreyedOutSelectedBorder_Haunted"}, // AE_HAUNTED
	{"BackpackItemBorder_Collectors", "BackpackItemMouseOverBorder_Collectors", "BackpackItemSelectedBorder",
	 "BackpackItemGreyedOutBorder_Collectors", "BackpackItemGreyedOutSelectedBorder_Collectors"}, // AE_COLLECTORS

	{"BackpackItemBorder_PaintkitWeapon", "BackpackItemMouseOverBorder_PaintkitWeapon", "BackpackItemSelectedBorder",
	 "BackpackItemGreyedOutBorder_PaintkitWeapon", "BackpackItemGreyedOutSelectedBorder_PaintkitWeapon"}, // AE_Paintkit
	{"BackpackItemBorder_RarityDefault", "BackpackItemMouseOverBorder_RarityDefault", "BackpackItemSelectedBorder",
	 "BackpackItemGreyedOutBorder_RarityDefault",
	 "BackpackItemGreyedOutSelectedBorder_RarityDefault"}, // AE_RARITY_DEFAULT,
	{"BackpackItemBorder_RarityCommon", "BackpackItemMouseOverBorder_RarityCommon", "BackpackItemSelectedBorder",
	 "BackpackItemGreyedOutBorder_RarityCommon",
	 "BackpackItemGreyedOutSelectedBorder_RarityCommon"}, // AE_RARITY_COMMON,
	{"BackpackItemBorder_RarityUncommon", "BackpackItemMouseOverBorder_RarityUncommon", "BackpackItemSelectedBorder",
	 "BackpackItemGreyedOutBorder_RarityUncommon",
	 "BackpackItemGreyedOutSelectedBorder_RarityUncommon"}, // AE_RARITY_UNCOMMON,
	{"BackpackItemBorder_RarityRare", "BackpackItemMouseOverBorder_RarityRare", "BackpackItemSelectedBorder",
	 "BackpackItemGreyedOutBorder_RarityRare", "BackpackItemGreyedOutSelectedBorder_RarityRare"}, // AE_RARITY_RARE,
	{"BackpackItemBorder_RarityMythical", "BackpackItemMouseOverBorder_RarityMythical", "BackpackItemSelectedBorder",
	 "BackpackItemGreyedOutBorder_RarityMythical",
	 "BackpackItemGreyedOutSelectedBorder_RarityMythical"}, // AE_RARITY_MYTHICAL,
	{"BackpackItemBorder_RarityLegendary", "BackpackItemMouseOverBorder_RarityLegendary", "BackpackItemSelectedBorder",
	 "BackpackItemGreyedOutBorder_RarityLegendary",
	 "BackpackItemGreyedOutSelectedBorder_RarityLegendary"}, // AE_RARITY_LEGENDARY,
	{"BackpackItemBorder_RarityAncient", "BackpackItemMouseOverBorder_RarityAncient", "BackpackItemSelectedBorder",
	 "BackpackItemGreyedOutBorder_RarityAncient",
	 "BackpackItemGreyedOutSelectedBorder_RarityAncient"}, // AE_RARITY_ANCIENT,
};
...
static bool HasCustomAttribute(const CEconItemView *pEconItemView, const char *szAttrName, int)
{
	...
	return pAttrDef ? pEconItemView->FindAttribute(pAttrDef) : NULL;
}
...
static bool HasRemovableCustomName(const CEconItemView *pEconItemView, const char *, int)
{
	...
	if(pEconItemView->GetQuality() == AE_UNIQUE && pEconItemView->GetItemDefinition()->GetArmoryDescString() &&
	   !V_stricmp(pEconItemView->GetItemDefinition()->GetArmoryDescString(), "stockitem"))
		return false;
...
void GetCustomDialogToken_StrangePartName(const CEconItemView *pEconItemView, int iUserData,
										  CUtlConstWideString &out_String)
{
	extern uint32 GetScoreTypeForKillEaterAttr(const IEconItemInterface *pEconItem,
											   const CEconItemAttributeDefinition *pAttribDef);
	extern const wchar_t *GetLocalizedStringForKillEaterTypeAttr(
		const CLocalizationProvider *pLocalizationProvider,
		uint32 unKillEaterEventType); // return type changed from locchar_t * because the backpack panel only exists on
									  // the client
...
void GetCustomDialogToken_UserAttributeName(const CEconItemView *pEconItemView, int iUserData,
											CUtlConstWideString &out_String)
{
...
typedef void (*GetCustomDialogLocalizationTokenFunc_t)(const CEconItemView *pEconItemView, int iUserData,
													   CUtlConstWideString &out_String);
...
static RefurbishableProperty g_RemoveableAttributes[] = {
	{&HasRemovableCustomName, NULL, NULL, "#RefurbishItem_RemoveNameCombo", "#RefurbishItem_RemoveNameTitle",
	 "#RefurbishItem_RemoveName", kCustomizationRemove_Name, kNoUserData}, // does this item have a custom name?
	{&HasRemovableCustomDesc, NULL, NULL, "#RefurbishItem_RemoveDescCombo", "#RefurbishItem_RemoveDescTitle",
	 "#RefurbishItem_RemoveDesc", kCustomizationRemove_Desc, kNoUserData}, // does this item have a custom description?
	{&HasPaint, &GetCustomDialogToken_PaintName, "set item tint rgb", "#RefurbishItem_RemovePaintCombo",
	 "#RefurbishItem_RemovePaintTitle", "#RefurbishItem_RemovePaint", kCustomizationRemove_Paint,
	 kNoUserData}, // is this item painted?
	{&HasCustomAttribute, NULL, "custom texture hi", "#RefurbishItem_RemoveCustomTextureCombo",
	 "#RefurbishItem_RemoveCustomTextureTitle", "#RefurbishItem_RemoveCustomTexture",
	 kCustomizationRemove_CustomTexture, kNoUserData}, // does this have a custom texture applied?
	{&HasCustomAttribute, NULL, "makers mark id", "#RefurbishItem_RemoveMakersMarkCombo",
	 "#RefurbishItem_RemoveMakersMarkTitle", "#RefurbishItem_RemoveMakersMark", kCustomizationRemove_MakersMark,
	 kNoUserData}, // was this item crafted by a specific dude?
	{&HasCustomAttribute, NULL, "killstreak tier", "#RefurbishItem_RemoveKillStreakCombo",
	 "#RefurbishItem_RemoveKillStreakTitle", "#RefurbishItem_RemoveKillStreak", kCustomizationRemove_KillStreak,
	 kNoUserData}, // Killstreak Effect
	{&HasCustomAttribute, NULL, "gifter account id", "#RefurbishItem_RemoveGifterCombo",
	 "#RefurbishItem_RemoveGifterTitle", "#RefurbishItem_RemoveGifter", kCustomizationRemove_GiftedBy,
	 kNoUserData}, // Gifted by
	{&HasCustomAttribute, NULL, "is_festivized", "#RefurbishItem_RemoveFestivizerCombo",
	 "#RefurbishItem_RemoveFestivizerTitle", "#RefurbishItem_RemoveFestivizer", kCustomizationRemove_Festivizer,
	 kNoUserData}, // Festivizer
...
{
	return ARRAYSIZE(g_RemoveableAttributes) + GetKillEaterAttrCount() +
...
RefurbishableProperty RemovableAttributes_GetAttributeDetails(int i)
{
	...
	if(iStrangePartIndex < GetKillEaterAttrCount())
	{
		...
		if(GetKillEaterAttr_IsUserCustomizable(iKillEaterAttrIndex))
		{
			...
			static RefurbishableProperty sStrangePartProperty = {&HasCustomAttribute,
																 &GetCustomDialogToken_StrangePartName,
																 NULL,
																 "#RefurbishItem_RemoveStrangePartCombo",
																 "#RefurbishItem_RemoveStrangePartTitle",
																 "#RefurbishItem_RemoveStrangePart",
																 kCustomizationRemove_StrangePart,
																 kNoUserData};

			RefurbishableProperty partReturnProp = sStrangePartProperty;
			partReturnProp.m_szArg = GetKillEaterAttr_Score(iKillEaterAttrIndex)
										 ->GetDefinitionName(); // ...then we check for the presence of a score
																// attribute if this slot is a strange part...
		...
		static RefurbishableProperty sStrangeFilterProperty = {&HasCustomAttribute,
															   &GetCustomDialogToken_StrangePartName,
															   NULL,
															   "#RefurbishItem_RemoveStrangeFilterCombo",
															   "#RefurbishItem_RemoveStrangeFilterTitle",
	...
	if(iCardUpgradeIndex < GetMaxCardUpgradesPerItem())
	{
		...
		static RefurbishableProperty sCardUpgradeProperty = {&HasCustomUserAttribute,
															 &GetCustomDialogToken_UserAttributeName,
															 NULL,
															 "#RefurbishItem_RemoveSpellCombo",
															 "#RefurbishItem_RemoveSpellTitle",
															 "#RefurbishItem_RemoveSpellUpgrade",
															 kCustomizationRemove_UpgradeCard,
															 kNoUserData};
	...
	static RefurbishableProperty sStrangeScoreReset = {&HasResettableScoreAttributes,
													   NULL,
													   NULL,
													   "#RefurbishItem_RemoveStrangeScoresCombo",
													   "#RefurbishItem_RemoveStrangeScoresTitle",
													   "#RefurbishItem_RemoveStrangeScores",
													   kCustomizationRemove_StrangeScores,
													   kNoUserData};
...
// Purpose:
//-----------------------------------------------------------------------------
ConVar cl_showbackpackrarities("cl_showbackpackrarities", "0", FCVAR_ARCHIVE,
							   "0 = Show no backpack icon border colors. 1 = Show item rarities within the backpack. 2 "
							   "= Show item rarities only for Market-listable items.");
ConVar cl_show_market_data_on_items("cl_show_market_data_on_items", "1", FCVAR_ARCHIVE,
									"0 = Never. 1 = Only when showing borders for Market-listable items. 2 = Always.");

ConVar tf_explanations_backpackpanel("tf_explanations_backpackpanel", "0", FCVAR_ARCHIVE,
									 "Whether the user has seen explanations for this panel.");

ConVar tf_backpack_page_button_delay(
	"tf_backpack_page_button_delay", "0.5", FCVAR_ARCHIVE,
	"Amount of time the mouse cursor needs to hover over the page button to select the page.");
...
CBackpackPanel::CBackpackPanel(vgui::Panel *parent, const char *panelName) : CBaseLoadoutPanel(parent, panelName)
{
	...
	m_pInspectCosmeticPanel =
		new CTFStorePreviewItemPanel2(this, "Resource/UI/econ/InspectionPanel_Cosmetic.res", "storepreviewitem", NULL);
...
void CBackpackPanel::PositionItemPanel(CItemModelPanel *pPanel, int iIndex)
{
	...
	int iXPos = (iCenter + m_iItemBackpackOffcenterX) + (iButtonX * m_pItemModelPanels[iIndex]->GetWide()) +
				(m_iItemBackpackXDelta * iButtonX);
		...
		for(int i = 0; i < m_Pages.Count(); ++i)
		{
			...
			if(pPage)
			{
				...
				if(bVisible)
				{
					...
					pPage->SetBounds(iStart + iColumn * iPageButtonWidthPlusDelta,
									 m_iPageButtonYPos + iRow * iPageButtonHeightPlusDelta, iPageButtonWidth,
									 m_iPageButtonHeight);
...
void CBackpackPanel::AssignItemToPanel(CItemModelPanel *pPanel, int iIndex)
{
		...
		if(pInventory)
		{
			...
			for(int i = iStart; i < pInventory->GetItemCount(); i++)
			{
				...
				else
				{
					...
					if((m_ToolSelectionItem.GetStaticData()->GetCapabilities() & ITEM_CAP_DECODABLE) &&
					   pItem->GetStaticData()->GetEconTool() &&
					   (Q_strcmp(pItem->GetStaticData()->GetEconTool()->GetTypeName(), "decoder_ring") != 0))
					{
						continue;
					}
				}
	...
	else
	{
		...
		if(pItemData			// Want to put in an item
		   ...
		   && pItemData->GetItemID() ==
				  pPanel->GetItem()->GetItemID()			 // That panel has the same item that we want to put in
...
void CBackpackPanel::UpdateModelPanels(void)
{
	...
	{
		wchar_t wTemp[256];
		g_pVGuiLocalize->ConstructString_safe(wTemp, g_pVGuiLocalize->Find("BackpackApplyTool"), 1,
											  m_ToolSelectionItem.GetItemName());
...
void CBackpackPanel::OnConfirmDelete(KeyValues *data)
{
	...
	// If we're embedded in the discard item panel, it needs to know we made room. Send a message to our parent that it
	// can catch.
...
void CBackpackPanel::OnItemPanelMouseReleased(vgui::Panel *panel)
{
	...
	if(pItemPanel && IsVisible())
	{
		...
		else
		{
			...
			{
				StopDrag(true);
				if((pItemPanel != m_pItemDraggedFromPanel || m_iDraggedFromPage != GetCurrentPage()) &&
				   m_pMouseDragItemPanel->HasItem())
				{
	...
	if(pInv)
	{
		for(int i = 0; i < pInv->GetItemCount(); ++i)
		{
			...
			if(pInvItem->GetStaticData()->IsTool() && CEconSharedToolSupport::ToolCanApplyTo(pInvItem, pItem) &&
			   pInvItem->GetStaticData()->GetEconTool() &&
			   (Q_strcmp(pInvItem->GetStaticData()->GetEconTool()->GetTypeName(), "decoder_ring") == 0))
			{
				return pInvItem;
			}
		}
...
bool CreateMarketPriceString(item_definition_index_t iDefIndex, wchar_t *pszString, int iBufferSize)
{
	...
	g_pVGuiLocalize->ConstructString_safe(pszConstructed, g_pVGuiLocalize->Find("#TF_MarketPrice"), 1,
										  pszCurrencyString);
...
bool CreateStorePriceString(item_definition_index_t iDefIndex, wchar_t *pszString, int iBufferSize)
{
	...
	wchar_t pszConstructed[kLocalizedPriceSizeInChararacters];
	g_pVGuiLocalize->ConstructString_safe(pszConstructed, g_pVGuiLocalize->Find("#TF_StorePrice"), 1,
										  pszCurrencyString);
...
void CBackpackPanel::AddCommerceSubmenus(Menu *pSubMenu, item_definition_index_t iItemDef, const char *pszActionFmt)
{
	...
	{
		int nIndex = pSubMenu->AddMenuItem(
			"", new KeyValues("Command", "command", CFmtStr("%s%s%d", "store_", pszActionFmt, iItemDef)), this);
	...
	{
		int nIndex = pSubMenu->AddMenuItem(
			"", new KeyValues("Command", "command", CFmtStr("%s%s%d", "market_", pszActionFmt, iItemDef)), this);
		vgui::MenuItem *pMenuItem = pSubMenu->GetMenuItem(nIndex);
		pMenuItem->SetText(wPriceListing);
		pMenuItem->InvalidateLayout(true, false);
	}
...
{
	GameItemDefinition_t *pPaintCanDef =
		dynamic_cast<GameItemDefinition_t *>(GEconItemSchema().GetItemDefinition(iPaintDef));
	if(!pPaintCanDef)
		return;
	...
	char szItemName[256];
	g_pVGuiLocalize->ConvertUnicodeToANSI(g_pVGuiLocalize->Find(pPaintCanDef->GetItemBaseName()), szItemName,
										  sizeof(szItemName));
	...
	{
		int nIndex =
			pPaintSubMenu->AddMenuItem("", new KeyValues("Command", "command", CFmtStr("paint%d", iPaintDef)), this);
		...
		pCustomPanel->m_colPaintColors.AddToTail(Color(clamp((unPaintRGB0 & 0xFF0000) >> 16, 0, 255),
													   clamp((unPaintRGB0 & 0xFF00) >> 8, 0, 255),
													   clamp((unPaintRGB0 & 0xFF), 0, 255), 255));
		pCustomPanel->m_colPaintColors.AddToTail(Color(clamp((unPaintRGB1 & 0xFF0000) >> 16, 0, 255),
													   clamp((unPaintRGB1 & 0xFF00) >> 8, 0, 255),
													   clamp((unPaintRGB1 & 0xFF), 0, 255), 255));
	}
	else
	{
		//
		...
		CItemMaterialCustomizationIconPanel *pCustomPanel =
			new CItemMaterialCustomizationIconPanel(pPaintSubMenu, "paint");
		pCustomPanel->SetZPos(100);
...
//
// Add commerce context options for an item.  Adds 'Store' and 'Market' options if appropriate (and Pricing) other wise
// just click to use
//
void CBackpackPanel::AddCommerceToContextMenu(Menu *pMenu, const char *pszActionFmt,
											  item_definition_index_t iItemDefIndex, bool bAddMarket, bool bAddStore)
{
	GameItemDefinition_t *pItemDef =
		dynamic_cast<GameItemDefinition_t *>(GEconItemSchema().GetItemDefinition(iItemDefIndex));
	if(!pItemDef)
		return;
	...
	{
		int nIndex = pMenu->AddMenuItem(
			"", new KeyValues("Command", "command", CFmtStr("%s%d", pszActionFmt, iItemDefIndex)), this);
...
void CBackpackPanel::OpenContextMenu()
{
	...
	if(vecSelectedItems.Count() == 1)
	{
		...
		uint32 unEscrowTime;
		const bool bToolIsInEscrow =
			pItem->FindAttribute(pAttrib_ToolEscrowUntil, &unEscrowTime) && unEscrowTime > CRTime::RTime32TimeCur();
		...
		{
			contextMenuBuilder.AddMenuItem("#ApplyOnItem", new KeyValues("Context_OpenStrangeCountTransfer"),
										   "primaryaction");
		}
		...
		else if(pItem->GetItemDefinition()->GetCapabilities() & ITEM_CAP_DECODABLE)
		{
			...
			if(GetDecodedByItemDefIndex(pItem))
			{
				...
				contextMenuBuilder.AddMenuItem("#BuyAndUseKey", new KeyValues("Context_BuyKeyAndOpenCrate"),
											   "primaryaction");
			}
		}
		...
		{
			contextMenuBuilder.AddMenuItem("#Duck_ViewLeaderboards", new KeyValues("Context_OpenDuckLeaderboards"),
										   "primaryaction");
			...
			if(GetDecodedByItemDefIndex(pItem))
			{
				contextMenuBuilder.AddMenuItem("#GetDuckToken", new KeyValues("Context_GetItemFromStore"),
											   "primaryaction");
			}
		}
				...
				))
		{
			...
			{
				contextMenuBuilder.AddMenuItem("#Context_InspectModel", new KeyValues("Context_InspectModel"),
											   "primaryaction");
			}
		}
		...
		// Add equip sub menu
		{
			...
			for(int iClass = TF_FIRST_NORMAL_CLASS; iClass < TF_LAST_NORMAL_CLASS; iClass++)
			{
				...
				pEquipSubMenu->AddMenuItem(pszClassName,
										   new KeyValues("Command", "command", CFmtStr("equipclass%d", iClass)), this);
			}
		}
		...
		if(!pItem->IsTemporaryItem())
		{
			...
			if(bCanCraftUp || bCanStatClockTrade)
			{
				...
				if(bCanCraftUp)
				{
					int nIndex = pMannCoTradeSubMenu->AddMenuItem(
						"", new KeyValues("Command", "command", "Context_CraftUpCollection"), this);
				...
				{
					int nIndex = pMannCoTradeSubMenu->AddMenuItem(
						"", new KeyValues("Command", "command", "Context_CraftCommonStatClock"), this);
					vgui::MenuItem *pMenuItem = pMannCoTradeSubMenu->GetMenuItem(nIndex);
			...
			if(pItem->FindAttribute(pAttrDef_IsOperationPass))
			{
				...
				contextMenuBuilder.AddCascadingMenuItem("#Context_MannCoTrade", pMannCoCoinTradeSubMenu,
														"customization");

				int nIndex = pMannCoCoinTradeSubMenu->AddMenuItem(
					"", new KeyValues("Command", "command", "Context_CraftUpCollection"), this);
				vgui::MenuItem *pMenuItem = pMannCoCoinTradeSubMenu->GetMenuItem(nIndex);
				pMenuItem->SetText("#Context_TradeUp");
				pMenuItem->InvalidateLayout(true, false);

				nIndex = pMannCoCoinTradeSubMenu->AddMenuItem(
					"", new KeyValues("Command", "command", "Context_CraftCommonStatClock"), this);
			...
			if(pAttrDef_HalloweenOffering && pItem->FindAttribute(pAttrDef_HalloweenOffering) &&
			   pItem->FindAttribute(pAttrDef_DeactiveDate, &unDeactiveDate) && unDeactiveDate > unCurrentDate)
			{
				vgui::MenuItem *pMenuItem = contextMenuBuilder.AddMenuItem(
					"#Context_HalloweenOffering", new KeyValues("Context_HalloweenOffering"), "customization");
			...
			// Change name
			GameItemDefinition_t *pNameTagDef =
				dynamic_cast<GameItemDefinition_t *>(GEconItemSchema().GetItemDefinitionByName("Name Tag"));
			if(CEconSharedToolSupport::ToolCanApplyToDefinition(dynamic_cast<const GameItemDefinition_t *>(pNameTagDef),
																pItemDef))
			{
			...
			// Change description
			GameItemDefinition_t *pDescTagDef =
				dynamic_cast<GameItemDefinition_t *>(GEconItemSchema().GetItemDefinitionByName("Description Tag"));
			if(CEconSharedToolSupport::ToolCanApplyToDefinition(dynamic_cast<const GameItemDefinition_t *>(pDescTagDef),
																pItemDef))
			{
			...
			{
				GameItemDefinition_t *pPaintCanDef =
					dynamic_cast<GameItemDefinition_t *>(GEconItemSchema().GetItemDefinition(m_vecPaintCans[0]));
				if(pPaintCanDef && CEconSharedToolSupport::ToolCanApplyToDefinition(
									   dynamic_cast<const GameItemDefinition_t *>(pPaintCanDef), pItemDef))
				{
			...
			if(BIsItemStrange(pItem))
			{
				...
				FOR_EACH_VEC(m_vecStrangeParts, i)
				{
					...
					// GameItemDefinition_t *pStrangePartDef = dynamic_cast<GameItemDefinition_t*>(
					// GEconItemSchema().GetItemDefinition( m_vecStrangeParts[i] ) );
					...
					if(CEconSharedToolSupport::ToolCanApplyTo(&partItemView, pItem))
					{
						...
						if(!pStrangePartsSubMenu)
						{
							...
							pStrangePartsSubMenu->SetBorder(
								scheme()->GetIScheme(GetScheme())->GetBorder(pszContextMenuBorder));
							pStrangePartsSubMenu->SetFont(
								scheme()->GetIScheme(GetScheme())->GetFont(pszContextMenuFont));
							contextMenuBuilder.AddCascadingMenuItem("#Context_StrangeParts", pStrangePartsSubMenu,
																	"customization");
						}
				...
				if(pStrangePartsSubMenu)
				{
					if(vecOwnedParts.Count() > 0)
					{
						// Add Header and loop
						int nIndex =
							pStrangePartsSubMenu->AddMenuItem("", new KeyValues("Command", "command", ""), this);
						...
						{
							AddCommerceToContextMenu(pStrangePartsSubMenu, "strangepart_", vecOwnedParts[i], false,
													 false);
						}
					}
					...
					if(vecStoreParts.Count() > 0)
					{
						...
						{
							AddCommerceToContextMenu(pStrangePartsSubMenu, "strangepart_", vecStoreParts[i], true,
													 false);
						}
					}
				}
			...
			{
				contextMenuBuilder.AddMenuItem("#Context_MarketPlaceSell", new KeyValues("DoSellMarketplace"),
											   "economy");
			}
			...
			if(pItem->GetItemDefinition()->GetCapabilities() & ITEM_CAP_CAN_BE_RESTORED)
			{
				...
				{
					contextMenuBuilder.AddMenuItem("#RefurbishItem", new KeyValues("Context_RefurbishItem"),
												   "destructive");
				}
			}
		}
	...
	if(m_bDragging && m_pMouseDragItemPanel)
	{
		...
		if(m_flPreventDragPageSwitchUntil < Plat_FloatTime())
		{
			...
			if(!bDragNext && m_pNextPageButton && m_pNextPageButton->IsEnabled())
			{
				...
				bDragNext = (x >= iDragX && x <= (iDragX + m_pNextPageButton->GetWide()) && y >= iDragY &&
							 y <= (iDragY + m_pNextPageButton->GetTall()));
			}
			if(bDragNext)
			{
				OnCommand("nextpage");
			...
			if(!bDragPrev && m_pPrevPageButton && m_pPrevPageButton->IsEnabled())
			{
				...
				bDragPrev = (x >= iDragX && x <= (iDragX + m_pPrevPageButton->GetWide()) && y >= iDragY &&
							 y <= (iDragY + m_pPrevPageButton->GetTall()));
			}
			if(bDragPrev)
			{
				OnCommand("prevpage");
...
void CBackpackPanel::OnItemContentsChanged(CEconItemView *pEconItemView)
{
	...
	for(int i = 0; i < m_pItemModelPanels.Count(); i++)
	{
		CEconItemView *pInternalItem =
			m_pItemModelPanels[i] && m_pItemModelPanels[i]->HasItem() ? m_pItemModelPanels[i]->GetItem() : NULL;
...
const char *CBackpackPanel::GetGreyOutItemPanelReason(CItemModelPanel *pItemPanel)
{
	if(InToolSelectionMode())
	{
		bool bIsSelectedTool = (m_ToolSelectionItem.IsValid() && pItemPanel->HasItem())
								   ? (m_ToolSelectionItem == *pItemPanel->GetItem())
								   : false;
		if(!bIsSelectedTool)
		{
			if(m_ToolSelectionItem.GetStaticData()->IsTool())
...
public:
	...
	{
		GetCustomDialogLocalizationTokenFunc_t m_pDialogCustomTokenFunc =
...
private:
	virtual void PopulateComboBoxOptions()
	{
		...
		for(int i = 0; i < GetRemovableAttributesCount(); i++)
		{
			if(RemovableAttributes_DoesAttributeApply(i, m_pItem))
			{
				...
				CConstructLocalizedString localizedUI(
					GLocalizationProvider()->Find(prop.m_pszSelectionUILocalizationToken),
					wsDialogCustomToken.IsEmpty() ? L"" : wsDialogCustomToken.Get());
	...
	virtual void OnComboBoxApplication()
	{
		...
		CTFRemoveItemCustomizationConfirmDialog *pDialog =
			new CTFRemoveItemCustomizationConfirmDialog(RefurbProp, m_pItem);
		if(pDialog)
		{
			pDialog->Show();
		}
...
void CBackpackPanel::HandleToolItemSelection(CEconItemView *pItem)
{
	...
	if(pItem)
	{
		...
		if(pItem->FindAttribute(pAttrDef_CanShuffleCrateContents))
		{
			CInputStringForItemBackpackOverlayDialog *pDialog =
				vgui::SETUP_PANEL(new CInputStringForItemBackpackOverlayDialog(this, pItem, &m_ToolSelectionItem));
			if(pDialog)
			{
				pDialog->Show();
				CancelToolSelection();
		...
		{
			CInputStringForItemBackpackOverlayDialog *pDialog =
				vgui::SETUP_PANEL(new CInputStringForItemBackpackOverlayDialog(this, &m_ToolSelectionItem, pItem));
			if(pDialog)
			{
				pDialog->Show();
				CancelToolSelection();
...
void CBackpackPanel::DoSellMarketplace()
{
	...
	if(m_vecSelected.Count() && steamapicontext && steamapicontext->SteamFriends() && steamapicontext->SteamUtils())
	{
		...
		char szURL[512];
		V_snprintf(szURL, sizeof(szURL), "http://%ssteamcommunity.com/my/inventory/?sellOnLoad=1#%d_%d_%llu", pszPrefix,
				   engine->GetAppID(), nAssetContext, pItem->GetItemID());
...
void CBackpackPanel::DoApplyOnItem()
{
	...
	if(m_ToolSelectionItem.IsValid())
	{
		...
		if(pEconTool && recipeIterator.GetMatchingComponentInputs().Count() > 0)
		{
			...
			{
				m_pDynamicRecipePanel =
					vgui::SETUP_PANEL(new CDynamicRecipePanel(this, "dynamic_recipe_panel", &m_ToolSelectionItem));
			}
		...
		if(pInv)
		{
			...
			if(!bHasValidTargetItem)
			{
				...
				const CEconItemSchema::SortedItemDefinitionMap_t &mapItems =
					GetItemSchema()->GetSortedItemDefinitionMap();
...
void CBackpackPanel::DoDeliverItem()
{
...
#ifdef TF_CLIENT_DLL
	const CEconTool_WrappedGift *pWrappedGiftTool =
		m_ToolSelectionItem.GetItemDefinition()
	...
	else if(pWrappedGiftTool && pWrappedGiftTool->BIsGlobalGift())
	{
		...
		CTFGenericConfirmDialog *pDialog = ShowConfirmDialog(
			"#TF_DeliverGiftDialog_Title", "#TF_DeliverGiftDialog_Random_Text", "#TF_DeliverGiftDialog_Confirm",
			"#TF_DeliverGiftDialog_Cancel", &UseUntargetedGiftConfirm);
...
void CBackpackPanel::DoShuffle()
{
	...
	CInputStringForItemBackpackOverlayDialog *pDialog =
		vgui::SETUP_PANEL(new CInputStringForItemBackpackOverlayDialog(this, &m_ToolSelectionItem));
	if(pDialog)
	{
		pDialog->Show();
	}
...
void CBackpackPanel::DoRefurbishItem()
{
	...
	CRefurbishItemDialog *pRefurbishDialog =
		vgui::SETUP_PANEL(new CRefurbishItemDialog(this, &m_ComboBoxOverlaySelectionItem));
	if(pRefurbishDialog)
	{
...
void CBackpackPanel::DoOpenDuckLeaderboards()
{
	...
	CDucksLeaderboardManager *pDuckLeaderboards =
		vgui::SETUP_PANEL(new CDucksLeaderboardManager(pCharInfo, "DucksLeaderboardPanel"));
...
void CBackpackPanel::DoCraftCommonStatClock()
{
	...
	{
		m_pMannCoTradePanel =
			vgui::SETUP_PANEL(new CCraftCommonStatClockPanel(this, m_pMouseOverTooltip)); // make this more generic
...
void CBackpackPanel::DoInspectModel()
{
	...
	if(pItem)
	{
		float flInspect = 0;
		static CSchemaAttributeDefHandle pAttrib_WeaponAllowInspect("weapon_allow_inspect");
		if((FindAttribute_UnsafeBitwiseCast<attrib_value_t>(pItem, pAttrib_WeaponAllowInspect, &flInspect) &&
			flInspect != 0.f)
#ifdef STAGING_ONLY
		   || tf_weapon_force_allow_inspect.GetBool()
#endif
...
void CBackpackPanel::OpenInspectModelPanelAndCopyItem(CEconItemView *pItemView)
{
	...
	float flInspect = 0;
	static CSchemaAttributeDefHandle pAttrib_WeaponAllowInspect("weapon_allow_inspect");
	if(FindAttribute_UnsafeBitwiseCast<attrib_value_t>(pItemView, pAttrib_WeaponAllowInspect, &flInspect) &&
	   flInspect != 0.f)
	{
		m_pInspectPanel->SetVisible(true);
...
{
	PostMessage(GetParent()->GetParent()->GetParent(),
				new KeyValues("OpenArmoryDirect", "itemdef", item->GetItemDefIndex()));
}
