...
protected:
	CConfirmApplyPaintCanBaseDialog(vgui::Panel *pParent, const char *szType, CEconItemView *pTool,
...
protected:
	...
	static void SetupPaintModelPanel(CItemModelPanel *pPaintModelPanel, CEconItemView *pToolSubjectView, int iTeam,
									 int iPaintRGB)
	{
...
public:
	...
	virtual void ApplySchemeSettings(vgui::IScheme *pScheme)
	{
		...
		SetupPaintModelPanel(m_pPaintModelPanel, m_pSubjectModelPanel->GetItem(), kTeamID0,
							 m_pToolModelPanel->GetItem()->GetModifiedRGBValue(false));
	}
...
public:
	...
	virtual void ApplySchemeSettings(vgui::IScheme *pScheme)
	{
		...
		SetupPaintModelPanel(m_pPaintModelPanel_Red, m_pSubjectModelPanel->GetItem(), kTeamID0,
							 m_pToolModelPanel->GetItem()->GetModifiedRGBValue(false));
		SetupPaintModelPanel(m_pPaintModelPanel_Blue, m_pSubjectModelPanel->GetItem(), kTeamID1,
							 m_pToolModelPanel->GetItem()->GetModifiedRGBValue(true));
...
GC_REG_JOB(GCSDK::CGCClient, CGCPaintItemResponse, "CGCPaintItemResponse", k_EMsgGCPaintItemResponse,
