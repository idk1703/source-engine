...
const char *ImpactHurtShards_Wood_Small_Models[WOOD_SHARDS] = {
	"models/props_debris/wood_shard_001.mdl", "models/props_debris/wood_shard_002.mdl",
	"models/props_debris/wood_shard_003.mdl", "models/props_debris/wood_shard_004.mdl",
...
const char *ImpactHurtShards_Foliage_Small_Models[FOLIAGE_SHARDS] = {
	"models/props_debris/foliage_shard_001.mdl", "models/props_debris/foliage_shard_002.mdl",
	"models/props_debris/foliage_shard_003.mdl", "models/props_debris/foliage_shard_004.mdl",
...
const char *ImpactHurtShards_Metal_Small_Models[METAL_SHARDS] = {
	"models/props_debris/metal_shard_001.mdl", "models/props_debris/metal_shard_002.mdl",
	"models/props_debris/metal_shard_003.mdl", "models/props_debris/metal_shard_004.mdl",
	"models/props_debris/metal_shard_005.mdl", "models/props_debris/metal_shard_006.mdl",
};
// Model pointers for the above
...
void ImpactCreateHurtGibs(Vector &vecOrigin, trace_t &tr, Vector &shotDir, int iMaterial, bool bLarge)
{
	...
	if(iMaterial == CHAR_TEX_FOLIAGE)
	{
		...
		for(int i = 0; i < iNumGibs; i++)
		{
			...
			// pProp->CreateClientsideProp( ImpactHurtGibs_Wood_Small[ random->RandomInt(0,NUM_WOOD_GIBS_SMALL-1) ],
			// vecSpawnOrigin, vecForceDir, angVel );
		}
	}
	else
	{
