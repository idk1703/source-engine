...
IPhysicsObject *PhysModelCreateCustom(C_BaseEntity *pEntity, const CPhysCollide *pModel, const Vector &origin,
									  const QAngle &angles, const char *props)
{
	solid_t solid;
...
IPhysicsObject *PhysModelCreateRagdoll(C_BaseEntity *pEntity, int modelIndex, const Vector &origin,
									   const QAngle &angles)
{
	...
	IPhysicsObject *pObject =
		physenv->CreatePolyObject(pCollide->solids[0], surfaceProp, origin, angles, &solid.params);
