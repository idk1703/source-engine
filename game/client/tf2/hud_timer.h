...
public:
	...
	//	m_bFixedTime == true:  Timer can't be paused. Time displayed is an offset from the originally specified start
	//time.
	//  m_bFixedTime == false: Timer can be stopped & started. Time displayed is calculated on the client, and regularly
