...
protected:
	...
	vgui::Panel *GetDeterioratingPanel()
	{
		return m_pDeterioratingPanel;
	}
	vgui::Panel *GetDismantlingPanel()
	{
		return m_pDismantlingPanel;
	}
...
public:
	CCommandChainingPanel(vgui::Panel *parent, const char *panelName) : BaseClass(parent, panelName)
	{
