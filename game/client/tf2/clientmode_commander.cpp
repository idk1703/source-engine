...
CCommanderViewportPanel::CCommanderViewportPanel(void)
	: m_CursorCommander(vgui::dc_arrow), m_CursorRightMouseMove(vgui::dc_hand)
{
...
void CClientModeCommander::IsometricMove(CUserCmd *cmd)
{
	...
	GetCommanderViewport()->GetCommanderOverlayPanel()->BoundOrigin(
		GetCommanderViewport()->GetCommanderOverlayPanel()->TacticalOrigin());
}
...
void CClientModeCommander::CreateMove(float flInputSampleTime, CUserCmd *cmd)
{
	...
	m_ScaledSlueSpeed =
		Commander_SlueSpeed.GetFloat() * GetCommanderViewport()->GetCommanderOverlayPanel()->WorldUnitsPerPixel();
	m_ScaledMouseSpeed =
		Commander_MouseSpeed.GetFloat() * GetCommanderViewport()->GetCommanderOverlayPanel()->WorldUnitsPerPixel();
