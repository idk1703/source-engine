...
void C_WalkerStrider::OnDataChanged(DataUpdateType_t type)
{
	...
	if(type == DATA_UPDATE_CREATED)
	{
		if(cl_brush_ropes.GetInt())
		{
			...
			int indices[7] = {LookupAttachment("kneeL"),	  LookupAttachment("kneeR"),
							  LookupAttachment("kneeB"),

							  LookupAttachment("MiniGun"),	  LookupAttachment("left foot"),
							  LookupAttachment("right foot"), LookupAttachment("back foot")};
