...
public:
	...
	bool InternalWorldToMinimap(MinimapPosType_t posType, const Vector &pos, const Vector &origin, float zoomscale,
...
#define DESTRUCT_MINIMAP_PANEL()   DESTRUCT_METACLASS_PANEL(m_MinimapTrace)
