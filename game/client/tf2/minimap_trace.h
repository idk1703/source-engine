...
protected:
	...
	bool BeginRender(CMinimapPanel *pPanel, float &x, float &y, int &team)
	{
		return false;
	}
...
public:
	CMinimapTraceBitmapPanel(vgui::Panel *parent, const char *panelName) : BaseClass(parent, panelName) {}
...
public:
	CMinimapTraceTeamBitmapPanel(vgui::Panel *parent, const char *panelName) : BaseClass(parent, panelName) {}
