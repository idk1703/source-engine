...
void CHudCommanderOverlayMgrImp::CreatePanel(int overlay)
{
	...
	vgui::Panel *pPanel = PanelMetaClassMgr()->CreatePanelMetaClass(panel.m_Name.String(), 0, panel.m_hEntity.Get(),
																	panel.m_pParentPanel, pTeamName);
...
// add an overlay element to the commander mode
//-----------------------------------------------------------------------------
OverlayHandle_t CHudCommanderOverlayMgrImp::AddOverlay(char const *pOverlayInstance, C_BaseEntity *pEntity,
													   vgui::Panel *pParent)
{
