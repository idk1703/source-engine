...
RecvPropFloat(RECVINFO(m_flDeployFinishTime)), RecvPropInt(RECVINFO(m_eDeployMode)),
	RecvPropInt(RECVINFO(m_bBoostUpgrade)), RecvPropInt(RECVINFO(m_nBoostTimeLeft)),
END_RECV_TABLE
()
