...
RecvPropVirtualArray(RecvProxy_TeleportStationCount, 32,
...
CMCVMinimapPanel::CMCVMinimapPanel(vgui::Panel *pParent, const char *pElementName) : CMinimapPanel(pElementName)
{
	SetParent(pParent);
