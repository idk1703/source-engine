...
public:
	...
	static C_RopeKeyframe *Create(C_BaseEntity *pStartEnt, C_BaseEntity *pEndEnt, int iStartAttachment = 0,
								  int iEndAttachment = 0, float ropeWidth = 2,
	...
	static int GetRopesIntersectingAABB(C_RopeKeyframe **pRopes, int nMaxRopes, const Vector &vAbsMin,
	...
	void BuildRope(RopeSegData_t *pRopeSegment, const Vector &vCurrentViewForward, const Vector &vCurrentViewOrigin,
				   BuildRopeQueuedData_t *pQueuedData, bool bQueued);
...
private:
	...
	Vector ConstrainNode(const Vector &vNormal, const Vector &vNodePosition, const Vector &vMidpiont,
						 float fNormalLength);
