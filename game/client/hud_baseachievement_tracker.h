...
protected:
	...
	CPanelAnimationVarAliasType(int, m_iPadding, "Padding", "1",
								"proportional_int"); // space between description and bar
};
...
protected:
	...
	CPanelAnimationVarAliasType(
		int, m_iScrollDistance, "ScrollDistance", "40",
		"proportional_int"); // how far the floating number will scroll up before disappearing completely
};
...
protected:
	...
	CPanelAnimationVarAliasType(int, m_iItemPadding, "ItemPadding", "8",
								"proportional_int"); // space between each achievement item
};
