...
ConVar sixense_hold_spin_damp("sixense_hold_spin_damp", "0.95", FCVAR_ARCHIVE,
							  "dampening for camera panning, 0 is no dampening");
ConVar sixense_hold_spin_max_angle(
	"sixense_hold_spin_max_angle", "75", FCVAR_ARCHIVE,
	"disallow camera tracking if the held object is greater than this angle relative to the players view");
...
ConVar sixense_feet_angles_offset_stick_spin_horiz_multiplier("sixense_feet_angles_offset_stick_spin_horiz_multiplier",
															  "4.0", FCVAR_ARCHIVE);
ConVar sixense_feet_angles_offset_stick_spin_vert_multiplier("sixense_feet_angles_offset_stick_spin_vert_multiplier",
															 "2.0", FCVAR_ARCHIVE);
ConVar sixense_feet_angles_offset_stick_spin_invert_pitch("sixense_feet_angles_offset_stick_spin_invert_pitch", "1.0",
														  FCVAR_ARCHIVE);
ConVar sixense_feet_angles_offset_stick_spin_exponent("sixense_feet_angles_offset_stick_spin_exponent", "1.0",
													  FCVAR_ARCHIVE);
...
void SixenseInput::UpdateValuesFromConvars()
{
	...
	m_pFPSEvents->setParameter(sixenseUtils::IFPSEvents::WEAPON_SELECT_SENSITIVITY,
							   sixense_weapon_select_sensitivity.GetFloat());
	...
	m_pFPSEvents->setParameter(sixenseUtils::IFPSEvents::CONTROLLER_ANGLE_MODE,
							   sixense_controller_angle_mode.GetFloat());

#ifdef PORTAL2
	m_pFPSEvents->setParameter(sixenseUtils::IFPSEvents::AUTO_ONE_TO_ONE_START_VEL,
							   sixense_auto_one_to_one_start_vel.GetFloat());
	m_pFPSEvents->setParameter(sixenseUtils::IFPSEvents::AUTO_ONE_TO_ONE_START_ACCEL,
							   sixense_auto_one_to_one_start_accel.GetFloat());
	m_pFPSEvents->setParameter(sixenseUtils::IFPSEvents::AUTO_ONE_TO_ONE_START_ACCEL_TIMER,
							   sixense_auto_one_to_one_start_accel_timer.GetFloat());
	m_pFPSEvents->setParameter(sixenseUtils::IFPSEvents::AUTO_ONE_TO_ONE_START_ANGLE_THRESH,
							   sixense_auto_one_to_one_angle_thresh.GetFloat());
	m_pFPSEvents->setParameter(sixenseUtils::IFPSEvents::AUTO_ONE_TO_ONE_STOP_XY_DIST,
							   sixense_auto_one_to_one_stop_xy_dist.GetFloat());
	m_pFPSEvents->setParameter(sixenseUtils::IFPSEvents::AUTO_ONE_TO_ONE_STOP_Z_DIST,
							   sixense_auto_one_to_one_stop_z_dist.GetFloat());
#endif

	m_pFPSViewAngles->setParameter(sixenseUtils::IFPSViewAngles::AIM_METROID_HEADING_MULTIPLIER,
								   sixense_aim_freeaim_heading_multiplier.GetFloat());
	m_pFPSViewAngles->setParameter(sixenseUtils::IFPSViewAngles::AIM_METROID_PITCH_MULTIPLIER,
								   sixense_aim_freeaim_pitch_multiplier.GetFloat());
	m_pFPSViewAngles->setParameter(sixenseUtils::IFPSViewAngles::AIM_METROID_DEAD_ZONE_RADIUS,
								   sixense_aim_freeaim_dead_zone_radius.GetFloat());
	m_pFPSViewAngles->setParameter(sixenseUtils::IFPSViewAngles::AIM_METROID_ACCEL_BAND_SIZE,
								   sixense_aim_freeaim_accel_band_size.GetFloat());
	m_pFPSViewAngles->setParameter(sixenseUtils::IFPSViewAngles::AIM_METROID_AUTO_LEVEL_RATE,
								   sixense_aim_freeaim_auto_level_rate.GetFloat());
	m_pFPSViewAngles->setParameter(sixenseUtils::IFPSViewAngles::AIM_METROID_ACCEL_BAND_EXPONENT,
								   sixense_aim_freeaim_accel_band_exponent.GetFloat());

	m_pFPSViewAngles->setParameter(sixenseUtils::IFPSViewAngles::AIM_METROID_SWITCH_BLEND_TIME_EXIT,
								   sixense_aim_freeaim_switch_blend_time_exit.GetFloat());
	m_pFPSViewAngles->setParameter(sixenseUtils::IFPSViewAngles::CONTROLLER_ANGLE_MODE,
								   sixense_controller_angle_mode.GetFloat());
	m_pFPSViewAngles->setParameter(sixenseUtils::IFPSViewAngles::ROLL_CORRECTION_BLEND,
								   sixense_roll_correct_blend.GetFloat());
	m_pFPSViewAngles->setParameter(sixenseUtils::IFPSViewAngles::EXIT_METROID_BLEND,
								   sixense_exit_metroid_blend.GetFloat());

	m_pFPSViewAngles->setParameter(sixenseUtils::IFPSViewAngles::SPRING_VIEW_MIN_SPRING,
								   sixense_spring_view_min_spring.GetFloat());
	m_pFPSViewAngles->setParameter(sixenseUtils::IFPSViewAngles::SPRING_VIEW_MAX_SPRING,
								   sixense_spring_view_max_spring.GetFloat());
	m_pFPSViewAngles->setParameter(sixenseUtils::IFPSViewAngles::SPRING_VIEW_MIN_ANGLE,
								   sixense_spring_view_min_angle.GetFloat());
	m_pFPSViewAngles->setParameter(sixenseUtils::IFPSViewAngles::SPRING_VIEW_MAX_ANGLE,
								   sixense_spring_view_max_angle.GetFloat());
	m_pFPSViewAngles->setParameter(sixenseUtils::IFPSViewAngles::PITCH_CHANGE_BLEND_VAL,
								   sixense_melee_pitch_blend_val.GetFloat());

	m_pFPSViewAngles->setParameter(sixenseUtils::IFPSViewAngles::AIM_1TO1_RATCHET_VERTICAL,
								   sixense_aim_1to1_ratchet_vertical.GetFloat());
	...
	{
		m_pFPSViewAngles->setParameter(sixenseUtils::IFPSViewAngles::AIM_1TO1_HEADING_MULTIPLIER,
									   sixense_aim_1to1_heading_multiplier.GetFloat());
		m_pFPSViewAngles->setParameter(sixenseUtils::IFPSViewAngles::AIM_1TO1_PITCH_MULTIPLIER,
									   sixense_aim_1to1_pitch_multiplier.GetFloat());
		m_pFPSViewAngles->setParameter(sixenseUtils::IFPSViewAngles::SPRING_VIEW_ENABLED,
									   sixense_spring_view_enabled.GetFloat());
	}
	else if(sixense_mode.GetInt() == 0)
	{
		...
		m_pFPSViewAngles->setParameter(sixenseUtils::IFPSViewAngles::AIM_1TO1_HEADING_MULTIPLIER,
									   sixense_aim_scope_heading_multiplier.GetFloat());
		m_pFPSViewAngles->setParameter(sixenseUtils::IFPSViewAngles::AIM_1TO1_PITCH_MULTIPLIER,
									   sixense_aim_scope_pitch_multiplier.GetFloat());

		// No springview when looking down scope
		m_pFPSViewAngles->setParameter(sixenseUtils::IFPSViewAngles::SPRING_VIEW_ENABLED, 0);
	}

	m_pFPSViewAngles->setParameter(sixenseUtils::IFPSViewAngles::FEET_ANGLES_OFFSET_STICK_SPIN_HORIZ_MULTIPLIER,
								   sixense_feet_angles_offset_stick_spin_horiz_multiplier.GetFloat());
	m_pFPSViewAngles->setParameter(sixenseUtils::IFPSViewAngles::FEET_ANGLES_OFFSET_STICK_SPIN_VERT_MULTIPLIER,
								   sixense_feet_angles_offset_stick_spin_vert_multiplier.GetFloat());
	m_pFPSViewAngles->setParameter(sixenseUtils::IFPSViewAngles::FEET_ANGLES_OFFSET_STICK_SPIN_INVERT_PITCH,
								   sixense_feet_angles_offset_stick_spin_invert_pitch.GetFloat());
	m_pFPSViewAngles->setParameter(sixenseUtils::IFPSViewAngles::FEET_ANGLES_OFFSET_STICK_SPIN_EXPONENT,
								   sixense_feet_angles_offset_stick_spin_exponent.GetFloat());

	m_pFPSPlayerMovement->setParameter(sixenseUtils::IFPSPlayerMovement::DEAD_ZONE_PERCENT,
									   sixense_walking_dead_zone_percent.GetFloat());
	m_pFPSPlayerMovement->setParameter(sixenseUtils::IFPSPlayerMovement::EXPONENTIAL,
									   sixense_walking_exponent.GetFloat());
...
bool SixenseInput::LoadModules()
{
	...
	if(g_pSixenseUtilsModule)
	{
		...
		if(factory)
		{
			...
			m_pFPSPlayerMovement =
				reinterpret_cast<sixenseUtils::IFPSPlayerMovement *>(factory("FPSPlayerMovement0", NULL));
			...
			m_pControllerManager =
				reinterpret_cast<sixenseUtils::IControllerManager *>(factory("ControllerManager", NULL));
...
static void SixenseAutosave(const CCommand &args)
{
	if(sixense_enabled.GetInt())
	{
		...
		engine->SaveGame(szSaveName, IsX360(), szFullSaveFileName, sizeof(szFullSaveFileName), szComment,
						 sizeof(szComment));
	}
}
...
{
	if(UTIL_IsScaledCube(cl_entitylist->GetBaseEntity(entityID)) && !m_bIsIn1to1Mode && m_pFPSViewAngles &&
	   (m_pFPSViewAngles->getParameter(sixenseUtils::IFPSViewAngles::AIM_METROID_MAX_SPEED) <=
		sixense_aim_freeaim_max_speed.GetFloat()))
	{
		m_pFPSViewAngles->forceMetroidBlend(
			m_pFPSViewAngles->getParameter(sixenseUtils::IFPSViewAngles::AIM_METROID_MAX_SPEED) /
			sixense_aim_freeaim_max_speed.GetFloat());
	}
}
...
void SixenseInput::PlayerPortalled(const VMatrix &PortalMatrix)
{
	...
	// Msg("Fixed local view angles %f %f %f\n", corrected_viewangles[YAW], corrected_viewangles[PITCH],
	// corrected_viewangles[ROLL] );
...
void SixenseInput::SetPortalTweakingParameters(bool bIsTweaking)
{
	...
	if(m_bIsTweaking != bIsTweaking)
	{
		...
		else
		{
			...
			if(m_pFPSViewAngles->getParameter(sixenseUtils::IFPSViewAngles::AIM_METROID_MAX_SPEED) <=
			   sixense_aim_freeaim_max_speed.GetFloat())
			{
				m_pFPSViewAngles->forceMetroidBlend(
					m_pFPSViewAngles->getParameter(sixenseUtils::IFPSViewAngles::AIM_METROID_MAX_SPEED) /
...
void SixenseInput::SetOneToOneMode(bool bOnOrOff)
{
	...
	if(bOnOrOff)
	{
		...
		// Start glowing
		m_nGlowIndex =
			g_GlowObjectManager.RegisterGlowObject(GetHeldObject(), glowColor, 0.25f, GET_ACTIVE_SPLITSCREEN_SLOT());
...
bool SixenseInput::IsInAlwaysOneToOneMode()
{
	...
	return (C_BasePlayer::GetLocalPlayer()->GetSixenseFlags() &
			CBasePlayer::PLAYER_SIXENSE_HOLDING_OBJECT_ALWAYS_ONE_TO_ONE)
			   ? true
			   : false;
}
#endif
	...
	else if(m_bIsEnabled && !bEnabled)
	{
		...
		if(m_bPlayerValid)
		{
			...
			if(pPlayer)
			{
				...
				QAngle ident;
				ident.Init();
				pPlayer->SetEyeAngleOffset(
					ident); // This is the way the player is looking, and the orientation of the weapon model
			}
		}
...
#if(defined(HL2_CLIENT_DLL) || defined(TF_CLIENT_DLL) || defined(CSTRIKE_DLL)) && !defined(CSTRIKE15) && \
	!defined(TERROR)
...
bool SixenseInput::InMenuMode()
{
	...
	char *panel_names[] = {PANEL_OVERVIEW,		 PANEL_CLASS,		 PANEL_TEAM,
						   PANEL_SPECMENU,		 PANEL_INFO,		 PANEL_BUY,
						   PANEL_BUY_CT,		 PANEL_BUY_TER,		 PANEL_BUY_EQUIP_CT,
						   PANEL_BUY_EQUIP_TER,	 PANEL_NAV_PROGRESS, PANEL_BUYPRESET_MAIN,
						   PANEL_BUYPRESET_EDIT, PANEL_INTRO,		 PANEL_COMMENTARY_MODELVIEWER,
						   PANEL_SURVEY};
#else // css
	...
	if(
#ifdef PORTAL2
		(pPlayer && pPlayer->IsTaunting()) || (engine->IsLocalPlayerResolvable() && IsRadialMenuOpen()) ||
#endif
...
#endif
		(SixenseInput::m_SixenseFrame && SixenseInput::m_SixenseFrame->IsVisible()) || engine->IsPaused() ||
		(enginevgui && enginevgui->IsGameUIVisible()) || vgui::surface()->IsCursorVisible() ||
...
bool SixenseInput::SixenseFrame(float flFrametime, CUserCmd *pCmd)
{
	...
	if(m_pACD->controllers[0].enabled && m_pACD->controllers[1].enabled)
	{
		...
		bool controllers_docked = m_pACD->controllers[0].is_docked || m_pACD->controllers[1].is_docked ||
								  !m_pSixenseAPI->sixenseIsBaseConnected(0);
	...
	if(m_nLeftIndex < 0 || m_nRightIndex < 0)
		return false;
	...
	else
	{
		...
		if(pScaledCube)
		{
			...
			if(vecScale[1] > fMaxScale)
				fMaxScale = vecScale[1];
			if(vecScale[2] > fMaxScale)
				fMaxScale = vecScale[2];

			float fSpinMult =
				1.0 - sqrt(clamp((fMaxScale - 1.0f) / (sixense_scaling_max.GetFloat() - 1.0f), 0.0f, 1.0f));
	...
	m_pFPSViewAngles->setParameter(sixenseUtils::IFPSViewAngles::AIM_METROID_MAX_SPEED,
								   freeAimSpinSpeed); // sixense_aim_freeaim_max_speed.GetFloat() );
	...
	if(m_fTeleportWaitToBlendTime - gpGlobals->curtime <= 0.0f)
	{
		...
		{
			float fBlendTime =
				clamp(freeAimSpinSpeed * 0.16f * sixense_aim_freeaim_switch_blend_time_enter.GetFloat(), 0.1f, 2.0f);
			m_pFPSViewAngles->setParameter(sixenseUtils::IFPSViewAngles::AIM_METROID_SWITCH_BLEND_TIME_ENTER,
										   fBlendTime);
		}
	}
	else
	...
	if(m_pFPSViewAngles->update(&m_pACD->controllers[m_nLeftIndex], &m_pACD->controllers[m_nRightIndex],
								flFrametime * 1000.0f) == SIXENSE_FAILURE ||
	   m_pControllerManager->isMenuVisible() || vgui::surface()->IsCursorVisible())
	{
	...
	filtered_frametime =
		filtered_frametime * frametime_filt_param + flFrametime * 1000.0f * (1.0f - frametime_filt_param);

	m_pFPSPlayerMovement->update(&m_pACD->controllers[m_nLeftIndex], &m_pACD->controllers[m_nRightIndex],
								 filtered_frametime);
...
void SixenseInput::SwitchViewModes(CUserCmd *pCmd)
{
	...
	if((!IsHoldingObject() && m_bIsIn1to1Mode && !m_bExitOneWhenAimingForwards) ||
	   (m_bIs1to1ModeLocked && !m_bIs1to1ModeScaling && m_pRightButtonStates->justPressed(lock_button) &&
		(pPortalPlayer && !pPortalPlayer->IsScalingUseItem() && !pPortalPlayer->IsScalingUseItemTurret())))
	{
	...
	else if(!m_bIs1to1ModeLocked && !m_bIs1to1ModeScaling && IsHoldingObject() &&
			(pPortalPlayer && (pPortalPlayer->IsScalingUseItem() || pPortalPlayer->IsScalingUseItemTurret())))
	{
	...
	else if((!IsHoldingObject() && m_bIsIn1to1Mode) ||
			(m_bIs1to1ModeLocked && m_bIs1to1ModeScaling &&
			 (pPortalPlayer && !pPortalPlayer->IsScalingUseItem() && !pPortalPlayer->IsScalingUseItemTurret())))
	{
		m_bIs1to1ModeScaling = false;
		m_bIs1to1ModeRatcheting = false;
...
void SixenseInput::SetPlayerHandPositions(CUserCmd *pCmd, float flFrametime)
{
	...
	sixenseMath::Vector3 base_offset(sixense_base_offset_x.GetFloat(), sixense_base_offset_y.GetFloat(),
									 sixense_base_offset_z.GetFloat());
	...
	if(sixense_dist_one_to_one_enabled.GetInt())
	{
		...
		player->SetSixenseFlags(player->GetSixenseFlags() |
								CBasePlayer::PLAYER_SIXENSE_HOLDING_OBJECT_ALWAYS_ONE_TO_ONE);
	}
	else
	{
	...
	// Set rotation first
	left_mat = sixenseMath::Matrix4::rotation(sixenseMath::Quat(
		m_pACD->controllers[m_nLeftIndex].rot_quat[0], m_pACD->controllers[m_nLeftIndex].rot_quat[1],
		m_pACD->controllers[m_nLeftIndex].rot_quat[2], m_pACD->controllers[m_nLeftIndex].rot_quat[3]));
	...
	// Fill in translation
	Vector3 ss_left_pos =
		sixenseMath::Vector3(m_pACD->controllers[m_nLeftIndex].pos[0], m_pACD->controllers[m_nLeftIndex].pos[1],
							 m_pACD->controllers[m_nLeftIndex].pos[2]) +
		base_offset;
	...
	// Set rotation first
	right_mat = sixenseMath::Matrix4::rotation(sixenseMath::Quat(
		m_pACD->controllers[m_nRightIndex].rot_quat[0], m_pACD->controllers[m_nRightIndex].rot_quat[1],
		m_pACD->controllers[m_nRightIndex].rot_quat[2], m_pACD->controllers[m_nRightIndex].rot_quat[3]));

	// Correct for controller angle mode
	right_mat = sixenseMath::Matrix4::rotation(-angle_mode_angle, sixenseMath::Vector3(1.0f, 0.0f, 0.0f)) * right_mat;

	// Fill in translation
	Vector3 ss_right_pos =
		sixenseMath::Vector3(m_pACD->controllers[m_nRightIndex].pos[0], m_pACD->controllers[m_nRightIndex].pos[1],
							 m_pACD->controllers[m_nRightIndex].pos[2]) +
		base_offset;
	...
	if(!m_bScalingLockedOneToOne && (Vector3(ss_right_pos[0], ss_right_pos[1], 0.0f).length() < xy_radius) &&
	...
	QAngle controller_rot_left =
		QAngle(RAD2DEG(left_contoller_angles[2]), RAD2DEG(left_contoller_angles[0]), RAD2DEG(left_contoller_angles[1]));
	QAngle controller_rot_right = QAngle(RAD2DEG(right_contoller_angles[2]), RAD2DEG(right_contoller_angles[0]),
										 RAD2DEG(right_contoller_angles[1]));
	//	QAngle controller_rot_left = left_rot;
	//	QAngle controller_rot_right = right_rot;
	//	if( left_mat_source[2][2] < 0.0f ) {
	//		controller_rot_left.x = (controller_rot_left.x > 0.0f) ? (180.0f - controller_rot_left.x) : (-180.0f +
	//controller_rot_left.x);
	//	}
	//	if( right_mat_source[2][2] < 0.0f ) {
	//		controller_rot_right.x = (controller_rot_right.x > 0.0f) ? (180.0f - controller_rot_right.x) : (-180.0f +
	//controller_rot_right.x);
	//	}
	...
	if(m_bIsIn1to1Mode && !m_nFreeaimSpinDisabled)
	{
		...
		if(pHeldObject)
		{
			...
			if(angle < hold_spin_max_angle)
			{
				...
				{
					horiz_speed_mult =
						((abs(screen.x) - (1.0 - hold_spin_start_screen_ratio)) / hold_spin_start_screen_ratio);
				...
				{
					vert_speed_mult =
						((abs(screen.y) - (1.0 - hold_spin_start_screen_ratio)) / hold_spin_start_screen_ratio);
				...
				if(hold_spin_fade_max_dist != 0.0f && hold_spin_fade_max_dist != 0.0f)
				{
					...
					float spin_fade = (dist_from_player - hold_spin_fade_min_dist) /
									  (hold_spin_fade_max_dist - hold_spin_fade_min_dist);
			...
			m_pFPSViewAngles->setHoldingTurnSpeed(horiz_speed_mult * hold_spin_speed,
												  vert_speed_mult * hold_spin_speed);
		}
	}
	else
	{
	...
	// Compute the angles that point from the player to the hand positions. This can be used to aim the weapon model at
	// the object being moved. The goofy offsets are because the gun doesn't rotate around the right position, so they
	// fudge it so it looks like it's pointing correctly
...
void SixenseInput::SetView(float flInputSampleFrametime, CUserCmd *pCmd)
{
	...
	// Keep track of the total accumulated spin angle. This accumulation is done outisde of sixenseUtils because we need
	// to keep a close look on the engine time to do proper time sync.
	QAngle accumulated_spin_angles;
	accumulated_spin_angles =
		FixAngles(m_pFPSViewAngles->getFeetAnglesMetroid()) + (spin_speed * flInputSampleFrametime * 30.0f);
	...
	C_BasePlayer::GetLocalPlayer()->SetEyeAngleOffset(
		GetViewAngleOffset()); // This is the way the player is looking, and the orientation of the weapon model
...
void SixenseInput::SixenseUpdateKeys(float flFrametime, CUserCmd *pCmd)
{
	...
	// Sometimes we get called but Sixense isn't ready to produce any new data yet. We want to preseve whatever we were
	// doing before, ie walking, so keep track of the last state we used.
	...
	// If the controller manager is up or the game is paused, don't do anything.
	if(InMenuMode() || (C_BasePlayer::GetLocalPlayer() && C_BasePlayer::GetLocalPlayer()->IsObserver()) ||
	   (m_nLeftIndex == -1) || (m_nRightIndex == -1) || (m_nGesturesDisabled == 1))
	{
		...
		if(pCmd)
		{
			// Sometimes we get called but Sixense isn't ready to produce any new data yet. We want to preseve whatever
			// we were doing before, ie walking, so keep track of the last state we used.
		...
		if(gViewPortInterface)
		{
			...
			if(panel)
			{
				...
				if((Q_strcmp(panel->GetName(), "class_blue") == 0) || (Q_strcmp(panel->GetName(), "class_red") == 0) ||
	...
	// zooom
	{
		...
		if((m_pACD->controllers[m_nRightIndex].buttons & SIXENSE_BUTTON_JOYSTICK) && !momentary_zoom &&
	...
	if(sixense_features_enabled.GetInt())
	{
		...
		// Button one-to-one
		if(!sixense_dist_one_to_one_enabled.GetInt() && sixense_auto_one_to_one_enabled.GetInt() && IsHoldingObject() &&
		   !m_bIs1to1ModeScaling &&
		   (C_Portal_Player::GetLocalPortalPlayer() && !C_Portal_Player::GetLocalPortalPlayer()->IsScalingUseItem() &&
		...
		// dist one-to-one
		if(sixense_dist_one_to_one_enabled.GetInt() && IsHoldingObject() && !m_bIs1to1ModeScaling &&
			...
			!C_Portal_Player::GetLocalPortalPlayer()->IsScalingUseItemTurret()))
		{
			...
			if(!IsInOneToOneMode() &&
			   (C_Portal_Player::GetLocalPortalPlayer() &&
				C_Portal_Player::GetLocalPortalPlayer()->GetActiveWeapon()) &&
			   ((delta_vec[2] < -sixense_dist_one_to_one_dist.GetFloat()) || // start one to one if you reach forwards
				(delta_vec[1] > 1.5f * sixense_dist_one_to_one_dist
										   .GetFloat()))) // start one to one if you raise up 1.5 times the dist too...
			{
				SetOneToOneMode(true);
				fEndOneToOneRatchetDelayTime = 0.0f;
			}
			else if(IsInOneToOneMode() && (delta_vec[2] > -sixense_dist_one_to_one_dist.GetFloat()) &&
					(delta_vec[1] < 1.5f * sixense_dist_one_to_one_dist.GetFloat()) &&
					(delta_vec.length() < 2.0f * sixense_dist_one_to_one_dist.GetFloat()) && IsAimingForwards())
			{
				// if ratcheting when ending 1to1 mode, first end ratchet, then end 1to1 after a short delay so end
				// ratchet can propogate to server
				if(m_bIs1to1ModeRatcheting)
				{
					m_pFPSViewAngles->setRatcheting(false);
					m_bIs1to1ModeRatcheting = false;
					fEndOneToOneRatchetDelayTime = gpGlobals->curtime;
						...
						((gpGlobals->curtime - fEndOneToOneRatchetDelayTime) >
						 sixense_dist_one_to_one_end_ratchet_delay.GetFloat()))
				{
					SetOneToOneMode(false);
					fEndOneToOneRatchetDelayTime = 0.0f;
				}
	...
	{
		m_fDisableJumpUntil =
			(sixenseUtils::Time::getTimeInMilliseconds()) + sixense_scale_disables_jump_timer.GetFloat() * 1000.0f;
	}
...

	{
		...
		if(m_pRightButtonStates->justPressed(SIXENSE_BUTTON_1))
		{
			...
			// This is a hack to center wheatley. Basically recenter whenever the 1 button is pressed. It's ok to
			// recenter on drop.
			SetBaseOffset();
		...
		if((m_pRightButtonStates->justPressed(SIXENSE_BUTTON_1) ||
			m_pRightButtonStates->justPressed(SIXENSE_BUTTON_2)) &&
		   !(last_buttons & IN_USE))
		{
			new_buttons |= IN_USE;
		...
		if(((m_pACD->controllers[m_nRightIndex].buttons & SIXENSE_BUTTON_1) ||
			(m_pACD->controllers[m_nRightIndex].buttons & SIXENSE_BUTTON_2)) &&
		   !momentary_hold)
		{
		...
		if(momentary_hold &&
		   (m_pRightButtonStates->justReleased(SIXENSE_BUTTON_1) ||
			m_pRightButtonStates->justReleased(SIXENSE_BUTTON_2)) &&
		   IsHoldingObject())
		{
			new_buttons |= IN_USE;
			momentary_hold_release_count = 30;
...
void SixenseInput::SixenseUpdateMouseCursor()
{
...
#endif
	{
		...
		if(m_pLaserPointer)
		{
			...
			if(engine->IsLocalPlayerResolvable())
				radial_menu_up_last_frame = IsRadialMenuOpen();
#endif
			...
			// Round to +/- 180
			if(heading_angle > 360.0f)
				heading_angle -= 360.0f;
			if(heading_angle < 0.0f)
				heading_angle += 360.0f;
			if(heading_angle > 180.0f)
				heading_angle -= 360.0f;
			...
			int title_bar_height =
				GetSystemMetrics(SM_CYCAPTION) + 2; // fudge these a little bit so we can't click on the borders
			...
			float win_norm_left = (float)win_rect.left / desktop_width,
				  win_norm_right = (float)win_rect.right / desktop_width;
			float win_norm_top = (float)win_rect.top / desktop_height,
				  win_norm_bottom = (float)win_rect.bottom / desktop_height;

			Vector2 abs_mouse_pos(win_norm_left + norm_coord[0] * (win_norm_right - win_norm_left),
								  win_norm_bottom + norm_coord[1] * (win_norm_top - win_norm_bottom));
...
void SixenseInput::Rumble(unsigned char playerIndex, unsigned char handIndex, unsigned char rumbleData,
						  unsigned char rumbleFlags)
{
	...
	{
		case 0:
			controller_index = m_pControllerManager->getIndex((0 == handIndex) ? sixenseUtils::IControllerManager::P1L
																			   : sixenseUtils::IControllerManager::P1R);
			break;
		case 1:
			controller_index = m_pControllerManager->getIndex((0 == handIndex) ? sixenseUtils::IControllerManager::P2L
																			   : sixenseUtils::IControllerManager::P2R);
			break;
		case 2:
			controller_index = m_pControllerManager->getIndex((0 == handIndex) ? sixenseUtils::IControllerManager::P3L
																			   : sixenseUtils::IControllerManager::P3R);
			break;
		case 3:
			controller_index = m_pControllerManager->getIndex((0 == handIndex) ? sixenseUtils::IControllerManager::P4L
...
SixenseGUIFrame::SixenseGUIFrame(vgui::VPANEL parent, char const *panelName) : BaseClass(NULL, panelName)
{
...
SixenseBaseWarning::SixenseBaseWarning(vgui::Panel *parent, const char *panelName) : BaseClass(parent, panelName)
{
...
bool actionFromString(CUtlString action_str, sixenseUtils::IButtonStates::ActionType *action)
{
	...
	{
		Msg("Unknown action %s, shoud be 'button_press' 'trigger_press' 'tilt_gesture' 'point_gesture' "
			"'velocity_gesture' or 'joystick_move'\n",
			action_str.String());
		*action = sixenseUtils::IButtonStates::ACTION_BUTTON_PRESS;
		return false;
	}
...
static void SixenseBind(const CCommand &args)
{
	...
	{
		g_pSixenseInput->GetGestureBindings()->AddBinding(hand_str, action_str, argument_str, press_command,
														  release_command);
	}
}
...
static ConCommand sixense_write_bindings_cc("sixense_write_bindings", SixenseWriteBindings,
											"Save the sixense bindings to a file.");
static ConCommand sixense_clear_bindings_cc("sixense_clear_bindings", SixenseClearBindings,
											"Clear all sixense bindings.");
static ConCommand sixense_delete_binding_cc("sixense_delete_binding", SixenseDeleteBinding,
											"Delete a single binding by index.");
static ConCommand sixense_create_default_binding_cc(
	"sixense_create_default_bindings", SixenseCreateDefaultBindings,
	"Erase all current bindings and load the default bindings for this game.");
