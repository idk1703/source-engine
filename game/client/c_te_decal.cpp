...
RecvPropVector(RECVINFO(m_vecOrigin)), RecvPropVector(RECVINFO(m_vecStart)), RecvPropInt(RECVINFO(m_nEntity)),
	RecvPropInt(RECVINFO(m_nHitbox)), RecvPropInt(RECVINFO(m_nIndex)),
END_RECV_TABLE
()
