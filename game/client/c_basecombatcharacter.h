...
public:
	...
	bool IsAbleToSee(const CBaseEntity *entity,
					 FieldOfViewCheckType checkFOV); // Visible starts with line of sight, and adds all the extra game
													 // checks like fog, smoke, camo...
	bool IsAbleToSee(C_BaseCombatCharacter *pBCC,
					 FieldOfViewCheckType checkFOV); // Visible starts with line of sight, and adds all the extra game
													 // checks like fog, smoke, camo...
	...
	C_BaseCombatWeapon *Weapon_OwnsThisType(const char *pszWeapon,
