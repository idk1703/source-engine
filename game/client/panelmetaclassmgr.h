...
public:
	...
	virtual vgui::Panel *Create(const char *pMetaClassName, KeyValues *pKeyValues, void *pInitData,
								vgui::Panel *pParent) = 0;
};
...
public:
	...
	virtual vgui::Panel *CreatePanelMetaClass(const char *pMetaClassType, int sortorder, void *pInitData,
...
public:
	...
	// Creation, destruction methods
	virtual vgui::Panel *Create(const char *pMetaClassName, KeyValues *pKeyValues, void *pVoidInitData,
								vgui::Panel *pParent)
	{
