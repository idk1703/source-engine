...
public:
	...
	void MuzzleFlash(const Vector &pos1, const QAngle &angles, int type, ClientEntityHandle_t hEntity,
...
void CHL1TempEnts::MuzzleFlash(const Vector &pos1, const QAngle &angles, int type, ClientEntityHandle_t hEntity,
							   bool firstPerson)
{
