...
RecvPropInt(RECVINFO(m_bHasLongJump)), RecvPropInt(RECVINFO(m_nFlashBattery)),
	RecvPropBool(RECVINFO(m_bIsPullingObject)),

	RecvPropFloat(RECVINFO(m_flStartCharge)), RecvPropFloat(RECVINFO(m_flAmmoStartCharge)),
	RecvPropFloat(RECVINFO(m_flPlayAftershock)), RecvPropFloat(RECVINFO(m_flNextAmmoBurn))
END_RECV_TABLE
()
