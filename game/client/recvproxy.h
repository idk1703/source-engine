...
RecvProp RecvPropTime(const char *pVarName, int offset, int sizeofVar = SIZEOF_IGNORE);

#if !defined(NO_ENTITY_PREDICTION)
RecvProp RecvPropPredictableId(const char *pVarName, int offset, int sizeofVar = SIZEOF_IGNORE);
#endif

RecvProp RecvPropEHandle(const char *pVarName, int offset, int sizeofVar = SIZEOF_IGNORE,
						 RecvVarProxyFn proxyFn = RecvProxy_IntToEHandle);

RecvProp RecvPropBool(const char *pVarName, int offset, int sizeofVar);

RecvProp RecvPropBool(const char *pVarName, int offset, int sizeofVar, int flags, RecvVarProxyFn varProxy);

RecvProp RecvPropIntWithMinusOneFlag(const char *pVarName, int offset, int sizeofVar = SIZEOF_IGNORE,
