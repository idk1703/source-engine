...
int ramp1[][3] = {
	{255, 243, 227}, {223, 171, 39}, {191, 119, 47}, {127, 59, 43},
	{99, 47, 31},	 {75, 35, 19},	 {47, 23, 11},	 {175, 103, 35},
};

int ramp2[][3] = {
	{255, 243, 227}, {239, 203, 31}, {223, 171, 39}, {207, 143, 43},
	{191, 119, 47},	 {175, 99, 47},	 {143, 67, 51},	 {115, 55, 35},
};

int ramp3[][3] = {
	{223, 171, 39}, {191, 119, 47}, {91, 91, 91}, {75, 75, 75}, {63, 63, 63}, {47, 47, 47},
};

#define SPARK_COLORCOUNT 9

int gSparkRamp[SPARK_COLORCOUNT][3] = {{255, 255, 255}, {255, 247, 199}, {255, 243, 147},
									   {255, 243, 27},	{239, 203, 31},	 {223, 171, 39},
									   {207, 143, 43},	{127, 59, 43},	 {35, 19, 7}};
...
CTEParticleRenderer::CTEParticleRenderer(const char *pDebugName) : CParticleEffect(pDebugName)
{
	m_ParticleSize = 1.5f;
...
void CTEParticleRenderer::RenderParticles(CParticleRenderIterator *pIterator)
{
	...
	while(pParticle)
	{
		...
		RenderParticle_ColorSize(pIterator->GetParticleDraw(), tPos, vColor, pParticle->m_Color[3] / 255.9f,
								 m_ParticleSize);
			...
			switch(GetParticleType(pParticle))
			{
				...
				case pt_fire:
					...
					else
					{
						...
						pParticle->SetColor((float)(*colorIndex)[0] / 255.0f, (float)(*colorIndex)[1] / 255.0f,
											(float)(*colorIndex)[2] / 255.0f);
					}
