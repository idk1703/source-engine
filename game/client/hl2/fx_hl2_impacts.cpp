...
void FX_AirboatGunImpact(const Vector &origin, const Vector &normal, float scale)
{
	...
	for(int i = 0; i < numSparks; i++)
	{
		...
		pParticle->m_vecVelocity =
			dir * random->RandomFloat((128.0f * (2.0f - spreadOfs)), (512.0f * (2.0f - spreadOfs)));
	...
	FX_AddQuad(origin, normal, random->RandomFloat(16, 32), random->RandomFloat(32, 48), 0.75f, 1.0f, 0.0f, 0.4f,
			   random->RandomInt(0, 360), 0, Vector(1.0f, 1.0f, 1.0f), 0.05f, "effects/combinemuzzle2_nocull",
