...
// Input  : *name -
//-----------------------------------------------------------------------------
CTEBeamPoints::CTEBeamPoints(const char *name) : CTEBaseBeam(name)
{
...
SendPropVector(SENDINFO(m_vecStartPoint), -1, SPROP_COORD), SendPropVector(SENDINFO(m_vecEndPoint), -1, SPROP_COORD),
END_SEND_TABLE
()
