...
// Input  : *name -
//-----------------------------------------------------------------------------
CTEBeamEntPoint::CTEBeamEntPoint(const char *name) : CTEBaseBeam(name)
{
	m_nStartEntity = 0;
	m_nEndEntity = 0;
...
SendPropInt(SENDINFO(m_nStartEntity), 24, SPROP_UNSIGNED), SendPropInt(SENDINFO(m_nEndEntity), 24, SPROP_UNSIGNED),
