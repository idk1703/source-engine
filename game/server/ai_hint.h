...
#define bits_HAS_EYEPOSITION_LOS_TO_PLAYER \
	0x00002000 // Like HAS LOS TO PLAYER, but checks NPC's eye position at the node, not node origin.
...
public:
	...
	static CAI_Hint *FindHint(CAI_BaseNPC *pNPC, Hint_e nHintType, int nFlags, float flMaxDist,
	...
	static int FindAllHints(CAI_BaseNPC *pNPC, const Vector &position, const CHintCriteria &hintCriteria,
...
public:
	...
	bool HintMatchesCriteria(CAI_BaseNPC *pNPC, const CHintCriteria &hintCriteria, const Vector &position,
							 float *flNearestDistance, bool bIgnoreLock = false, bool bIgnoreHintType = false);
