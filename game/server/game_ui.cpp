...
BEGIN_DATADESC(CGameUI)
	...
	DEFINE_KEYFIELD(m_flFieldOfView, FIELD_FLOAT, "FieldOfView"), DEFINE_FIELD(m_hSaveWeapon, FIELD_EHANDLE),
		DEFINE_FIELD(m_bForceUpdate, FIELD_BOOLEAN), DEFINE_FIELD(m_player, FIELD_EHANDLE),
		...
		DEFINE_OUTPUT(m_pressedMoveLeft, "PressedMoveLeft"), DEFINE_OUTPUT(m_pressedMoveRight, "PressedMoveRight"),
		DEFINE_OUTPUT(m_pressedForward, "PressedForward"), DEFINE_OUTPUT(m_pressedBack, "PressedBack"),
		...
		DEFINE_OUTPUT(m_unpressedForward, "UnpressedForward"), DEFINE_OUTPUT(m_unpressedBack, "UnpressedBack"),
		DEFINE_OUTPUT(m_unpressedAttack, "UnpressedAttack"), DEFINE_OUTPUT(m_unpressedAttack2, "UnpressedAttack2"),

		DEFINE_OUTPUT(m_xaxis, "XAxis"), DEFINE_OUTPUT(m_yaxis, "YAxis"), DEFINE_OUTPUT(m_attackaxis, "AttackAxis"),
...
void CGameUI::Deactivate(CBaseEntity *pActivator)
{
	...
	else
	{
		Warning("%s Deactivate(): I have no player when called by %s!\n", GetEntityName().ToCStr(),
				pActivator->GetEntityName().ToCStr());
	}
