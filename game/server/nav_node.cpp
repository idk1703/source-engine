 ...
 */
bool CNavNode::TestForCrouchArea(NavCornerType cornerNum, const Vector &mins, const Vector &maxs,
 ...
 */
void CNavNode::ConnectTo(CNavNode *node, NavDirType dir, float obstacleHeight, float obstacleStartDist,
