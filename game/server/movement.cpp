...
BEGIN_DATADESC(CPathKeyFrame)
	...
	DEFINE_FIELD(m_Origin, FIELD_VECTOR), DEFINE_FIELD(m_Angles, FIELD_VECTOR),
		...
		DEFINE_KEYFIELD(m_flSpeed, FIELD_FLOAT, "MoveSpeed"), DEFINE_FIELD(m_pNextKey, FIELD_CLASSPTR),
...
BEGIN_DATADESC(CBaseMoveBehavior)
	...
	DEFINE_KEYFIELD(m_iPositionInterpolator, FIELD_INTEGER, "PositionInterpolator"),
		...
		DEFINE_FIELD(m_pCurrentKeyFrame, FIELD_CLASSPTR), DEFINE_FIELD(m_pTargetKeyFrame, FIELD_CLASSPTR),
		DEFINE_FIELD(m_pPreKeyFrame, FIELD_CLASSPTR), DEFINE_FIELD(m_pPostKeyFrame, FIELD_CLASSPTR),

		DEFINE_FIELD(m_flAnimStartTime, FIELD_FLOAT), DEFINE_FIELD(m_flAnimEndTime, FIELD_FLOAT),
		DEFINE_FIELD(m_flAverageSpeedAcrossFrame, FIELD_FLOAT), DEFINE_FIELD(m_flTimeIntoFrame, FIELD_FLOAT),
