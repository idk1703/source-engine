...
BEGIN_DATADESC(CFuncSmokeVolume)
	...
	DEFINE_KEYFIELD(m_Color1, FIELD_COLOR32, "Color1"), DEFINE_KEYFIELD(m_Color2, FIELD_COLOR32, "Color2"),
...
SendPropInt(SENDINFO(m_Color1), 32, SPROP_UNSIGNED, SendProxy_Color32ToInt),
	...
	SendPropString(SENDINFO(m_MaterialName)), SendPropFloat(SENDINFO(m_ParticleDrawWidth), 0, SPROP_NOSCALE),
	...
	SendPropFloat(SENDINFO(m_MovementSpeed), 0, SPROP_NOSCALE), SendPropFloat(SENDINFO(m_Density), 0, SPROP_NOSCALE),
