...
//---------------------------------------------------------------------------------------------
void CTFBotMissionSuicideBomber::StartDetonate(CTFBot *me, bool bWasSuccessful /* = false */,
...
void CTFBotMissionSuicideBomber::Detonate(CTFBot *me)
{
	...
	if(!m_bWasSuccessful)
	{
		...
		{
			TFGameRules()->HaveAllPlayersSpeakConceptIfAllowed(MP_CONCEPT_MVM_SENTRY_BUSTER_DOWN,
