...
public:
	...
	virtual EventDesiredResult<CTFBot> OnOtherKilled(CTFBot *me, CBaseCombatCharacter *victim,
...
private:
	...
	const CKnownEntity *SelectMoreDangerousThreatInternal(const INextBot *me, const CBaseCombatCharacter *subject,
														  const CKnownEntity *threat1,
