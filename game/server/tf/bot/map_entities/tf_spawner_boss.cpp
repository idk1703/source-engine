...
BEGIN_DATADESC(CTFSpawnerBoss)
	DEFINE_KEYFIELD(m_spawnCount, FIELD_INTEGER, "count"),
		...
		DEFINE_KEYFIELD(m_spawnInterval, FIELD_FLOAT, "interval"), DEFINE_KEYFIELD(m_teamName, FIELD_STRING, "team"),
		...
		DEFINE_OUTPUT(m_onBotKilled, "OnBotKilled"), DEFINE_OUTPUT(m_onBotStunned, "OnBotStunned"),
