...
public:
	CRestartGameIssue()
		: CBaseTFIssue("RestartGame")
	{} // This string will have "Vote_" glued onto the front for localization (i.e. "#Vote_RestartGame")

	virtual void ExecuteCommand(void) OVERRIDE;
	virtual bool IsEnabled(void) OVERRIDE;
	virtual bool CanCallVote(int iEntIndex, const char *pszDetails, vote_create_failed_t &nFailCode,
							 int &nTime) OVERRIDE;
...
public:
	CKickIssue()
		: CBaseTFIssue("Kick")
	{} // This string will have "Vote_" glued onto the front for localization (i.e. "#Vote_Kick")
...
public:
	CChangeLevelIssue()
		: CBaseTFIssue("ChangeLevel")
	{} // This string will have "Vote_" glued onto the front for localization (i.e. "#Vote_ChangeLevel")
...
public:
	CNextLevelIssue()
		: CBaseTFIssue("NextLevel")
	{} // This string will have "Vote_" glued onto the front for localization (i.e. "#Vote_NextLevel")
...
public:
	CExtendLevelIssue()
		: CBaseTFIssue("ExtendLevel")
	{} // This string will have "Vote_" glued onto the front for localization (i.e. "#Vote_ExtendLevel")
...
public:
	CScrambleTeams()
		: CBaseTFIssue("ScrambleTeams")
	{} // This string will have "Vote_" glued onto the front for localization (i.e. "#Vote_ScrambleTeams")
...
public:
	CMannVsMachineChangeChallengeIssue()
		: CBaseTFIssue("ChangeMission")
	{} // This string will have "Vote_" glued onto the front for localization (i.e. "#Vote_ChangeMission")
...
public:
	CEnableTemporaryHalloweenIssue()
		: CBaseTFIssue("Eternaween")
	{} // This string will have "Vote_" glued onto the front for localization (i.e. "#Vote_Eternaween")
...
public:
	CTeamAutoBalanceIssue()
		: CBaseTFIssue("TeamAutoBalance")
	{} // This string will have "Vote_" glued onto the front for localization (i.e. "#Vote_TeamAutoBalance")
...
public:
	CClassLimitsIssue()
		: CBaseTFIssue("ClassLimits")
	{} // This string will have "Vote_" glued onto the front for localization (i.e. "#Vote_ClassLimits")
...
public:
	CPauseGameIssue()
		: CBaseTFIssue("PauseGame")
	{} // This string will have "Vote_" glued onto the front for localization (i.e. "#Vote_PauseGame")
