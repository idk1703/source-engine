...
ActionResult<CEyeballBoss> CEyeballBossIdle::Update(CEyeballBoss *me, float interval)
{
	...
	else
	{
		...
		{
			m_isLaughReady = false;
			return SuspendFor(new CEyeballBossEmote(me->LookupSequence("laugh"), "Halloween.EyeballBossLaugh"),
							  "Taunt our victim");
		}
	}
...
//---------------------------------------------------------------------------------------------
EventDesiredResult<CEyeballBoss> CEyeballBossIdle::OnOtherKilled(CEyeballBoss *me, CBaseCombatCharacter *victim,
