...
void TE_TFExplosion(IRecipientFilter &filter, float flDelay, const Vector &vecOrigin, const Vector &vecNormal,
					int iWeaponID, int nEntIndex, int nDefID = -1, int nSound = SPECIAL1,
					int iCustomParticle = INVALID_STRING_INDEX);
...
void TE_TFParticleEffect(IRecipientFilter &filter, float flDelay, const char *pszParticleName, Vector vecOrigin,
						 ...
						 ParticleAttachment_t iAttachType = PATTACH_CUSTOMORIGIN);
void TE_TFParticleEffect(IRecipientFilter &filter, float flDelay, const char *pszParticleName, Vector vecOrigin,
...
void TE_TFParticleEffectComplex(IRecipientFilter &filter, float flDelay, const char *pszParticleName, Vector vecOrigin,
								...
								CBaseEntity *pEntity = NULL, ParticleAttachment_t eAttachType = PATTACH_CUSTOMORIGIN,
