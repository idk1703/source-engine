...
public:
	...
	bool IsReady(
		void); // is this teleporter connected and functional? (ie: not sapped, disabled, upgrading, unconnected, etc)
...
#ifdef STAGING_ONLY
	// STAGING_ENGY
	bool IsSpeedPad(void)
	{
		return m_iTeleportType == TTYPE_SPEEDPAD;
	}
#endif
