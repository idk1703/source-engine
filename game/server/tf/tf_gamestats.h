...
public:
	...
	void Event_KillDetail(CTFPlayer *pKiller, CTFPlayer *pVictim, CTFPlayer *pAssister,
	...
	void Event_HalloweenBossEvent(uint8 unBossType, uint16 unBossLevel, uint8 unEventType, uint8 unPlayersInvolved,
								  float fElapsedTime);
	...
	void SW_GameStats_WriteKill(CTFPlayer *pKiller, CTFPlayer *pVictim, CTFPlayer *pAssister,
								IGameEvent *event /*player_death*/, const CTakeDamageInfo &info);
...
public:
	...
	PlayerStats_t m_aPlayerStats[MAX_PLAYERS + 1]; // List of stats for each player for current life - reset after each
