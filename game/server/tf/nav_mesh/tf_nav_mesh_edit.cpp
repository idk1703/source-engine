...
static ConCommand ClearAllAttributes("tf_wipe_attributes", TF_EditClearAllAttributes,
									 "Clear all TF-specific attributes of selected area.", FCVAR_CHEAT);
...
static AttributeLookup s_TFAttributeTable[] = {{"BLUE_SETUP_GATE", TF_NAV_BLUE_SETUP_GATE},
 ...
 */
static int AttributeAutocomplete(const char *input,
...
static ConCommand ClearAttributeTF("tf_clear_attribute", TF_EditClearAttribute,
								   "Remove given attribute from all areas in the selected set.", FCVAR_CHEAT,
...
static ConCommand MarkAttribute("tf_mark", TF_EditMarkAttribute, "Set attribute of selected area.", FCVAR_CHEAT,
								AttributeAutocomplete);
...
static ConCommand SelectWithAttribute("tf_select_with_attribute", TF_EditSelectWithAttribute,
									  "Selects areas with the given attribute.", FCVAR_CHEAT, AttributeAutocomplete);