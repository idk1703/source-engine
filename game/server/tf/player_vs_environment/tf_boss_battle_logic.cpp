...
ConVar tf_bot_npc_minion_wave_initial_launch_interval("tf_bot_npc_minion_wave_initial_launch_interval",
													  "15" /*, FCVAR_CHEAT*/);
...
ConVar tf_bot_npc_grunt_wave_initial_launch_interval("tf_bot_grunt_wave_initial_launch_interval",
													 "25" /*, FCVAR_CHEAT*/);
