...
public:
	...
	int NearestNodeToPoint(CAI_BaseNPC *pNPC, const Vector &vecOrigin, bool bCheckVisiblity,
...
private:
	...
	int ListNodesInBox(CNodeList &list, int maxListCount, const Vector &mins, const Vector &maxs,
