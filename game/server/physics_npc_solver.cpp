...
public:
	...
	static CPhysicsNPCSolver *Create(CAI_BaseNPC *pNPC, CBaseEntity *pPhysicsObject, bool disableCollisions,
...
BEGIN_DATADESC(CPhysicsNPCSolver)
	...
	DEFINE_FIELD(m_hNPC, FIELD_EHANDLE), DEFINE_FIELD(m_hEntity, FIELD_EHANDLE),
		DEFINE_FIELD(m_separationDuration, FIELD_FLOAT), DEFINE_FIELD(m_cancelTime, FIELD_TIME),
		DEFINE_FIELD(m_allowIntersection, FIELD_BOOLEAN), DEFINE_PHYSPTR(m_pController),
...
CPhysicsNPCSolver *CPhysicsNPCSolver::Create(CAI_BaseNPC *pNPC, CBaseEntity *pPhysicsObject, bool disableCollisions,
											 float separationTime)
{
	CPhysicsNPCSolver *pSolver =
		(CPhysicsNPCSolver *)CBaseEntity::CreateNoSpawn("physics_npc_solver", vec3_origin, vec3_angle, NULL);
...
void CPhysicsNPCSolver::Init(CAI_BaseNPC *pNPC, CBaseEntity *pPhysicsObject, bool disableCollisions,
							 float separationTime)
{
	m_hNPC = pNPC;
...
bool CPhysicsNPCSolver::IsContactOnNPCHead(IPhysicsFrictionSnapshot *pSnapshot, IPhysicsObject *pPhysics,
										   CAI_BaseNPC *pNPC)
{
...
CBaseEntity *NPCPhysics_CreateSolver(CAI_BaseNPC *pNPC, CBaseEntity *pPhysicsObject, bool disableCollisions,
...
BEGIN_DATADESC(CPhysicsEntitySolver)
	...
	DEFINE_FIELD(m_hMovingEntity, FIELD_EHANDLE), DEFINE_FIELD(m_hPhysicsBlocker, FIELD_EHANDLE),
		DEFINE_FIELD(m_separationDuration, FIELD_FLOAT), DEFINE_FIELD(m_cancelTime, FIELD_TIME),
...
CPhysicsEntitySolver *CPhysicsEntitySolver::Create(CBaseEntity *pMovingEntity, CBaseEntity *pPhysicsBlocker,
												   float separationTime)
{
	CPhysicsEntitySolver *pSolver =
		(CPhysicsEntitySolver *)CBaseEntity::CreateNoSpawn("physics_entity_solver", vec3_origin, vec3_angle, NULL);
...
CBaseEntity *EntityPhysics_CreateSolver(CBaseEntity *pMovingEntity, CBaseEntity *pPhysicsObject, bool disableCollisions,
										float separationDuration)
{
