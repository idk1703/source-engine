...
BEGIN_DATADESC(CLogicMeasureMovement)
	...
	DEFINE_KEYFIELD(m_strMeasureTarget, FIELD_STRING, "MeasureTarget"),
		...
		DEFINE_FIELD(m_hMeasureTarget, FIELD_EHANDLE), DEFINE_FIELD(m_hMeasureReference, FIELD_EHANDLE),
		DEFINE_FIELD(m_hTarget, FIELD_EHANDLE), DEFINE_FIELD(m_hTargetReference, FIELD_EHANDLE),
