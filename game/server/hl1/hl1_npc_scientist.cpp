...
BEGIN_DATADESC(CNPC_Scientist)
	DEFINE_FIELD(m_flFearTime, FIELD_TIME), DEFINE_FIELD(m_flHealTime, FIELD_TIME),
		...
		case TASK_MOVE_TO_TARGET_RANGE_SCARED:
		{
			...
			else
			{
				...
				if((distance < pTask->flTaskData) ||
				   (GetNavigator()->GetPath()->ActualGoalPosition() - GetTarget()->GetAbsOrigin()).Length() >
			...
			if(HasCondition(COND_NEW_ENEMY))
			{
				if(GetFollowTarget() && GetEnemy())
				{
					...
					if(relationship != D_FR ||
					   relationship != D_HT && (!HasCondition(COND_LIGHT_DAMAGE) || !HasCondition(COND_HEAVY_DAMAGE)))
					{
...
char *CNPC_DeadScientist::m_szPoses[] = {"lying_on_back", "lying_on_stomach", "dead_sitting", "dead_hang",
...
BEGIN_DATADESC(CNPC_SittingScientist)
	DEFINE_FIELD(m_iHeadTurn, FIELD_INTEGER), DEFINE_FIELD(m_flResponseDelay, FIELD_FLOAT),
...
AI_BEGIN_CUSTOM_NPC(monster_scientist, CNPC_Scientist)
	...
	// > SCHED_SCI_HEAL
	//=========================================================
	DEFINE_SCHEDULE(SCHED_SCI_HEAL,
	...
	//=========================================================
	DEFINE_SCHEDULE(SCHED_SCI_FACETARGET,
	...
	// > SCHED_SCI_COVER
	//=========================================================
	DEFINE_SCHEDULE(SCHED_SCI_COVER,
	...
	// > SCHED_SCI_HIDE
	//=========================================================
	DEFINE_SCHEDULE(SCHED_SCI_HIDE,
	...
	// > SCHED_SCI_IDLESTAND
	//=========================================================
	DEFINE_SCHEDULE(SCHED_SCI_IDLESTAND,
	...
	// > SCHED_SCI_PANIC
	//=========================================================
	DEFINE_SCHEDULE(SCHED_SCI_PANIC,
	...
	//=========================================================
	DEFINE_SCHEDULE(SCHED_SCI_FOLLOWSCARED,
	...
	//=========================================================
	DEFINE_SCHEDULE(SCHED_SCI_FACETARGETSCARED,
	...
	// > SCHED_SCI_STARTLE
	//=========================================================
	DEFINE_SCHEDULE(SCHED_SCI_STARTLE,
