...
BEGIN_DATADESC(CNPC_HAssassin)
	DEFINE_FIELD(m_flLastShot, FIELD_TIME), DEFINE_FIELD(m_flDiviation, FIELD_FLOAT),

		DEFINE_FIELD(m_flNextJump, FIELD_TIME), DEFINE_FIELD(m_vecJumpVelocity, FIELD_VECTOR),

		DEFINE_FIELD(m_flNextGrenadeCheck, FIELD_TIME), DEFINE_FIELD(m_vecTossVelocity, FIELD_VECTOR),
		DEFINE_FIELD(m_fThrowGrenade, FIELD_BOOLEAN),

		DEFINE_FIELD(m_iTargetRanderamt, FIELD_INTEGER), DEFINE_FIELD(m_iFrustration, FIELD_INTEGER),
...
AI_BEGIN_CUSTOM_NPC(monster_human_assassin, CNPC_HAssassin)
	...
	//=========================================================
	DEFINE_SCHEDULE(SCHED_ASSASSIN_EXPOSED,
	...
	//=========================================================
	DEFINE_SCHEDULE(SCHED_ASSASSIN_JUMP_ATTACK,
	...
	//=========================================================
	DEFINE_SCHEDULE(SCHED_ASSASSIN_JUMP_LAND,
	...
	// > SCHED_ASSASSIN_FAIL
	//=========================================================
	DEFINE_SCHEDULE(SCHED_ASSASSIN_FAIL,
	...
	// > SCHED_ASSASSIN_TAKE_COVER_FROM_ENEMY1
	//=========================================================
	DEFINE_SCHEDULE(SCHED_ASSASSIN_TAKE_COVER_FROM_ENEMY1,
	...
	// > SCHED_ASSASSIN_TAKE_COVER_FROM_ENEMY2
	//=========================================================
	DEFINE_SCHEDULE(SCHED_ASSASSIN_TAKE_COVER_FROM_ENEMY2,
	...
	// > SCHED_ASSASSIN_TAKE_COVER_FROM_BEST_SOUND
	//=========================================================
	DEFINE_SCHEDULE(SCHED_ASSASSIN_TAKE_COVER_FROM_BEST_SOUND,
	...
	// > SCHED_ASSASSIN_HIDE
	//=========================================================
	DEFINE_SCHEDULE(SCHED_ASSASSIN_HIDE,
	...
	// > SCHED_ASSASSIN_HUNT
	//=========================================================
	DEFINE_SCHEDULE(SCHED_ASSASSIN_HUNT,
