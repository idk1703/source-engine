...
BEGIN_DATADESC(CNPC_AlienGrunt)
	DEFINE_FIELD(m_fCanHornetAttack, FIELD_BOOLEAN), DEFINE_FIELD(m_flNextHornetAttackCheck, FIELD_TIME),
		DEFINE_FIELD(m_flNextPainTime, FIELD_TIME), DEFINE_FIELD(m_flNextSpeakTime, FIELD_TIME),
		DEFINE_FIELD(m_flNextWordTime, FIELD_TIME), DEFINE_FIELD(m_flDamageTime, FIELD_TIME),
END_DATADESC()
...
void CNPC_AlienGrunt::HandleAnimEvent(animevent_t *pEvent)
{
	switch(pEvent->event)
	{
		...
		case AGRUNT_AE_LEFT_PUNCH:
		{
			...
			CBaseEntity *pHurt =
				CheckTraceHullAttack(AGRUNT_MELEE_DIST, vecMins, vecMaxs, sk_agrunt_dmg_punch.GetFloat(), DMG_CLUB);
	...
	switch(pTask->iTask)
	{
		...
		case TASK_AGRUNT_SETUP_HIDE_ATTACK:
			...
			if(pEnemyMonsterPtr)
			{
				...
				UTIL_TraceLine(WorldSpaceCenter() + vForward * 128, vecEnemyLKP, MASK_SOLID_BRUSHONLY, this,
				...
				if(!fSkip)
				{
					UTIL_TraceLine(WorldSpaceCenter() + vForward * 256, vecEnemyLKP, MASK_SOLID_BRUSHONLY, this,
								   COLLISION_GROUP_NONE, &tr);
					if(tr.fraction == 1.0)
					{
	...
	switch(m_NPCState)
	{
		case NPC_STATE_COMBAT:
		{
			...
			if(HasCondition(COND_CAN_RANGE_ATTACK1) &&
			   OccupyStrategySlotRange(AGRUNT_SQUAD_SLOT_HORNET1, AGRUNT_SQUAD_SLOT_HORNET2))
			{
...
AI_BEGIN_CUSTOM_NPC(monster_alien_grunt, CNPC_AlienGrunt)
	...
	// Fail Schedule
	//=========================================================
	DEFINE_SCHEDULE(SCHED_AGRUNT_FAIL, "	Tasks"
									   "	TASK_STOP_MOVING			0"
	...
	//=========================================================
	DEFINE_SCHEDULE(SCHED_AGRUNT_COMBAT_FAIL, "	Tasks"
											  "	TASK_STOP_MOVING			0"
											  "	TASK_SET_ACTIVITY			ACTIVITY:ACT_IDLE"
	...
	//=========================================================
	DEFINE_SCHEDULE(SCHED_AGRUNT_STANDOFF,
	...
	// Suppress
	//=========================================================
	DEFINE_SCHEDULE(SCHED_AGRUNT_SUPPRESS_HORNET, "	Tasks"
												  "	TASK_STOP_MOVING			0"
	...
	//=========================================================
	DEFINE_SCHEDULE(SCHED_AGRUNT_RANGE_ATTACK, "	Tasks"
											   "	TASK_STOP_MOVING			0"
											   "	TASK_FACE_ENEMY				0"
											   "	TASK_RANGE_ATTACK1			0"
											   "	"
	...
	DEFINE_SCHEDULE(SCHED_AGRUNT_HIDDEN_RANGE_ATTACK, "	Tasks"
	...
	// cover!
	//=========================================================
	DEFINE_SCHEDULE(SCHED_AGRUNT_TAKE_COVER_FROM_ENEMY, "	Tasks"
														"	TASK_STOP_MOVING				0"
														"	TASK_WAIT						0.2"
	...
	// Victory dance!
	//=========================================================
	DEFINE_SCHEDULE(SCHED_AGRUNT_VICTORY_DANCE,
					"	Tasks"
					"	TASK_STOP_MOVING							0"
	...
	//=========================================================
	//=========================================================
	DEFINE_SCHEDULE(SCHED_AGRUNT_THREAT_DISPLAY, "	Tasks"
												 "	TASK_STOP_MOVING		0"
												 "	TASK_FACE_ENEMY			0"
												 "	TASK_PLAY_SEQUENCE		ACTIVITY:ACT_THREAT_DISPLAY"
												 "	"
