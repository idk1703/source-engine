...
BEGIN_DATADESC(CHL1NPCTalker)
	...
	DEFINE_ENTITYFUNC(Touch), DEFINE_FIELD(m_bInBarnacleMouth, FIELD_BOOLEAN), DEFINE_USEFUNC(FollowerUse),
...
int CHL1NPCTalker::PlayScriptedSentence(const char *pszSentence, float delay, float volume, soundlevel_t soundlevel,
...
// Purpose:
//-----------------------------------------------------------------------------
bool CHL1NPCTalker::OnObstructingDoor(AILocalMoveGoal_t *pMoveGoal, CBaseDoor *pDoor, float distClear,
...
AI_BEGIN_CUSTOM_NPC(monster_hl1talker, CHL1NPCTalker)
	...
	//=========================================================
	DEFINE_SCHEDULE(SCHED_HL1TALKER_FOLLOW_MOVE_AWAY,
	...
	//=========================================================
	DEFINE_SCHEDULE(SCHED_HL1TALKER_IDLE_SPEAK_WAIT,
	...
	//=========================================================
	DEFINE_SCHEDULE(SCHED_HL1TALKER_BARNACLE_HIT,
	...
	//=========================================================
	DEFINE_SCHEDULE(SCHED_HL1TALKER_BARNACLE_PULL,
	...
	//=========================================================
	DEFINE_SCHEDULE(SCHED_HL1TALKER_BARNACLE_CHOMP,
