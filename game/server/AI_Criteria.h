...
public:
	...
	void Init(ResponseType_t type, const char *responseName, const AI_CriteriaSet &criteria,
			  const AI_ResponseParams &responseparams, const char *matchingRule, const char *applyContext,
