...
ConVar cv_bot_difficulty(
	"bot_difficulty", "1", FCVAR_REPLICATED,
...
ConVar cv_bot_quota("bot_quota", "0", FCVAR_REPLICATED | FCVAR_NOTIFY,
...
ConVar cv_bot_prefix("bot_prefix", "", FCVAR_REPLICATED,
					 ...
					 "replaced with the bot's difficulty.\n<weaponclass> will be replaced with the bot's desired "
					 "weapon class.\n<skill> will be replaced with a 0-100 representation of the bot's skill.",
					 PrefixChanged);
ConVar cv_bot_allow_rogues(
	"bot_allow_rogues", "1", FCVAR_REPLICATED,
...
ConVar cv_bot_allow_sub_machine_guns("bot_allow_sub_machine_guns", "1", FCVAR_REPLICATED,
...
ConVar cv_bot_allow_machine_guns("bot_allow_machine_guns", "1", FCVAR_REPLICATED,
...
ConVar cv_bot_join_after_player("bot_join_after_player", "1", FCVAR_REPLICATED,
...
ConVar cv_bot_dont_shoot("bot_dont_shoot", "0", FCVAR_REPLICATED | FCVAR_CHEAT,
						 "If nonzero, bots will not fire weapons (for debugging).");
ConVar cv_bot_eco_limit("bot_eco_limit", "2000", FCVAR_REPLICATED,
...
ConVar cv_bot_flipout("bot_flipout", "0", FCVAR_REPLICATED | FCVAR_CHEAT,
