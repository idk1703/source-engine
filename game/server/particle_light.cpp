...
BEGIN_DATADESC(CParticleLight)
	...
	// Keyvalue fields
	DEFINE_KEYFIELD(m_flIntensity, FIELD_FLOAT, "Intensity"), DEFINE_KEYFIELD(m_vColor, FIELD_VECTOR, "Color"),
		DEFINE_KEYFIELD(m_PSName, FIELD_STRING, "PSName"), DEFINE_KEYFIELD(m_bDirectional, FIELD_BOOLEAN, "Directional")
