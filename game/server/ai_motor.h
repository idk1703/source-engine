...
public:
	...
	AIMotorMoveResult_t MoveGroundStep(const Vector &newPos, CBaseEntity *pMoveTarget = NULL, float yaw = -1,
									   bool bAsFarAsCan = true, bool bTestZ = true, AIMoveTrace_t *pTraceResult = NULL);
...
protected:
	...
	AIMotorMoveResult_t MoveGroundExecuteWalk(const AILocalMoveGoal_t &move, float speed, float dist,
