...
BEGIN_DATADESC(CParticlePerformanceMonitor)
	DEFINE_FIELD(m_bDisplayPerf, FIELD_BOOLEAN), DEFINE_FIELD(m_bMeasurePerf, FIELD_BOOLEAN),
...
SendPropInt(SENDINFO(m_bDisplayPerf), 1, SPROP_UNSIGNED), SendPropInt(SENDINFO(m_bMeasurePerf), 1, SPROP_UNSIGNED),
END_SEND_TABLE
()
