 ...
 * Vision determines what see see and notice -> Attention determines which of those things we look at -> Low level
 * head/aiming simulation actually moves our head/eyes
 */
...
public:
	...
	virtual int CompareSignificance(const CBaseEntity *a,
									const CBaseEntity *b) const; // returns <0 if a < b, 0 if a==b, or >0 if a>b
