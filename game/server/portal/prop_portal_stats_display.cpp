...
BEGIN_DATADESC(CPropPortalStatsDisplay)
	DEFINE_FIELD(m_bEnabled, FIELD_BOOLEAN),
		...
		DEFINE_FIELD(m_iNumPortalsPlaced, FIELD_INTEGER), DEFINE_FIELD(m_iNumStepsTaken, FIELD_INTEGER),
		DEFINE_FIELD(m_fNumSecondsTaken, FIELD_FLOAT),

		DEFINE_FIELD(m_iBronzeObjective, FIELD_INTEGER), DEFINE_FIELD(m_iSilverObjective, FIELD_INTEGER),
		DEFINE_FIELD(m_iGoldObjective, FIELD_INTEGER),

		DEFINE_AUTO_ARRAY(szChallengeFileName, FIELD_CHARACTER), DEFINE_AUTO_ARRAY(szChallengeMapName, FIELD_CHARACTER),
...
SendPropBool(SENDINFO(m_bEnabled)),
	...
	SendPropInt(SENDINFO(m_iNumPortalsPlaced)), SendPropInt(SENDINFO(m_iNumStepsTaken)),
	SendPropFloat(SENDINFO(m_fNumSecondsTaken)),

	SendPropInt(SENDINFO(m_iBronzeObjective)), SendPropInt(SENDINFO(m_iSilverObjective)),
	SendPropInt(SENDINFO(m_iGoldObjective)),

	SendPropString(SENDINFO(szChallengeFileName)), SendPropString(SENDINFO(szChallengeMapName)),
...
void CPropPortalStatsDisplay::Spawn(void)
{
	...
	BonusMapChallengeNames(szChallengeFileName.GetForModify(), szChallengeMapName.GetForModify(),
						   szChallengeName.GetForModify());
