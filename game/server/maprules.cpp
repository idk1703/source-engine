...
BEGIN_DATADESC(CGameText)
	...
	DEFINE_KEYFIELD(m_iszMessage, FIELD_STRING, "message"),
		...
		DEFINE_KEYFIELD(m_textParms.x, FIELD_FLOAT, "x"), DEFINE_KEYFIELD(m_textParms.y, FIELD_FLOAT, "y"),
...
BEGIN_DATADESC(CGamePlayerZone)
	...
	DEFINE_INPUTFUNC(FIELD_VOID, "CountPlayersInZone", InputCountPlayersInZone),
		...
		// Outputs
		DEFINE_OUTPUT(m_OnPlayerInZone, "OnPlayerInZone"), DEFINE_OUTPUT(m_OnPlayerOutZone, "OnPlayerOutZone"),
		DEFINE_OUTPUT(m_PlayersInCount, "PlayersInCount"), DEFINE_OUTPUT(m_PlayersOutCount, "PlayersOutCount"),
...
BEGIN_DATADESC(CGamePlayerEquip)
	...
	DEFINE_AUTO_ARRAY(m_weaponNames, FIELD_STRING), DEFINE_AUTO_ARRAY(m_weaponCount, FIELD_INTEGER),
