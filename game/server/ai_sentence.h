...
public:
	...
	int Speak(const char *pSentence, SentencePriority_t nSoundPriority = SENTENCE_PRIORITY_NORMAL,
	...
	int SpeakQueued(const char *pSentence, SentencePriority_t nSoundPriority = SENTENCE_PRIORITY_NORMAL,
					SentenceCriteria_t nCriteria = SENTENCE_CRITERIA_IN_SQUAD);
