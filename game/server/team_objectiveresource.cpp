...
SendPropInt(SENDINFO(m_iTimerToShowInHUD), MAX_EDICT_BITS, SPROP_UNSIGNED),
	...
	SendPropInt(SENDINFO(m_iNumControlPoints), 4, SPROP_UNSIGNED), SendPropBool(SENDINFO(m_bPlayingMiniRounds)),
	...
	SendPropArray3(SENDINFO_ARRAY3(m_iTeamReqCappers),
				   SendPropInt(SENDINFO_ARRAY(m_iTeamReqCappers), 4, SPROP_UNSIGNED)),
	...
	SendPropArray3(SENDINFO_ARRAY3(m_flPathDistance),
				   SendPropFloat(SENDINFO_ARRAY(m_flPathDistance), 8, 0, 0.0f, 1.0f)),
	...
	SendPropArray3(SENDINFO_ARRAY3(m_nNumNodeHillData),
				   SendPropInt(SENDINFO_ARRAY(m_nNumNodeHillData), 4, SPROP_UNSIGNED)),
	SendPropArray3(SENDINFO_ARRAY3(m_flNodeHillData),
				   SendPropFloat(SENDINFO_ARRAY(m_flNodeHillData), 8, 0, 0.0f, 1.0f)),
	...
	// state variables
	SendPropArray3(SENDINFO_ARRAY3(m_iNumTeamMembers),
				   SendPropInt(SENDINFO_ARRAY(m_iNumTeamMembers), 4, SPROP_UNSIGNED)),
	...
	SendPropArray3(SENDINFO_ARRAY3(m_bCPCapRateScalesWithPlayers),
				   SendPropBool(SENDINFO_ARRAY(m_bCPCapRateScalesWithPlayers))),
	SendPropString(SENDINFO(m_pszCapLayoutInHUD)), SendPropFloat(SENDINFO(m_flCustomPositionX)),
	SendPropFloat(SENDINFO(m_flCustomPositionY)),

END_SEND_TABLE
()

	BEGIN_DATADESC(CBaseTeamObjectiveResource) DEFINE_FIELD(m_iTimerToShowInHUD, FIELD_INTEGER),
	DEFINE_FIELD(m_iStopWatchTimer, FIELD_INTEGER), DEFINE_FIELD(m_iNumControlPoints, FIELD_INTEGER),
	DEFINE_FIELD(m_bPlayingMiniRounds, FIELD_BOOLEAN), DEFINE_FIELD(m_bControlPointsReset, FIELD_BOOLEAN),
	DEFINE_FIELD(m_iUpdateCapHudParity, FIELD_INTEGER), DEFINE_FIELD(m_flCustomPositionX, FIELD_FLOAT),
	DEFINE_FIELD(m_flCustomPositionY, FIELD_FLOAT), DEFINE_ARRAY(m_vCPPositions, FIELD_VECTOR, MAX_CONTROL_POINTS),
	...
	DEFINE_ARRAY(m_flCPTimerTimes, FIELD_FLOAT, MAX_CONTROL_POINTS), DEFINE_THINKFUNC(ObjectiveThink),
END_DATADESC
()
