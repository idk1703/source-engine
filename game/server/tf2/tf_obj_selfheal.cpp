...
ConVar obj_selfheal_rate("obj_selfheal_rate", "1.0", FCVAR_NONE,
						 "Rate at which the Self-Heal object repairs it's parent");
ConVar obj_selfheal_amount("obj_selfheal_amount", "3", FCVAR_NONE,
						   "Amount of health healed by a Self-Heal object per tick");
