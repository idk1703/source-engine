...
ConVar shield_explosive_damage("shield_explosive_damage", "10", FCVAR_REPLICATED,
							   "Shield power damage from explosions");
...
void CShield::RegisterDeflection(const Vector &vecDir, int bitsDamageType, trace_t *ptr)
{
	...
	// If this is a buckshot round, don't pay the power cost to stop it once we've gone over our max buckshot hits this
	// frame
