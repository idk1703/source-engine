...
void SendProxy_TeleportStationElement(const SendProp *pProp, const void *pStructBase, const void *pData, DVariant *pOut,
...
SendPropVirtualArray(SendProxy_TeleportStationCount,
