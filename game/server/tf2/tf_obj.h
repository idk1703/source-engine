...
public:
	...
	bool FindNearestBuildPoint(CBaseEntity *pEntity, Vector vecBuildOrigin, float &flNearestPoint,
	...
	virtual bool ShouldAttachToParent(void)
	{
		return true;
	}
	void SetVehicleBay(CVGuiScreenVehicleBay *pBay)
	{
		m_hVehicleBay = pBay;
	}
	...
	virtual bool WantsCoverFromSentryGun()
	{
		return false;
	}
	...
	virtual bool ComputeEMPDamageState(void)
	{
		return true;
	}
	...
	bool IsDeteriorating(void)
	{
		return m_bDeteriorating;
	};
