...
public:
	...
	{
		return (m_eDeployMode == VEHICLE_MODE_DEPLOYED);
	}
	bool IsDeploying(void)
	{
		return (m_eDeployMode == VEHICLE_MODE_DEPLOYING);
	}
	bool IsUndeploying(void)
	{
		return (m_eDeployMode == VEHICLE_MODE_UNDEPLOYING);
	}
	bool InDeployMode(void)
	{
		return (m_eDeployMode != VEHICLE_MODE_NORMAL);
	}
