...
public:
	...
	virtual OrderEventType GetType()
	{
		return ORDER_EVENT_PLAYER_DISCONNECTED;
	}
...
public:
	...
	virtual OrderEventType GetType()
	{
		return ORDER_EVENT_PLAYER_KILLED;
	}
...
public:
	...
	virtual OrderEventType GetType()
	{
		return ORDER_EVENT_PLAYER_RESPAWNED;
	}
...
public:
	...
	virtual OrderEventType GetType()
	{
		return ORDER_EVENT_OBJECT_DESTROYED;
	}
...
public:
	virtual OrderEventType GetType()
	{
		return ORDER_EVENT_PLAYER_DAMAGED;
	}
