...
bool CNPC_Bug_Warrior::HandleInteraction(int interactionType, void *data, CBaseCombatCharacter *sender)
{
	...
	if(interactionType == g_interactionBugSquadAttacking)
	{
		...
		if(IsCurSchedule(SCHED_WBUG_FLEE_ENEMY) || IsCurSchedule(SCHED_WBUG_CHASE_ENEMY_FAILED))
		{
...
void CNPC_Bug_Warrior::HandleAnimEvent(animevent_t *pEvent)
{
	switch(pEvent->event)
	{
		case BUG_WARRIOR_AE_MELEE_HIT1:
			MeleeAttack(BUG_WARRIOR_MELEE1_RANGE, npc_bug_warrior_swipe_damage.GetFloat(), QAngle(20.0f, 0.0f, 0.0f),
						Vector(-350.0f, 1.0f, 1.0f));
			return;
			break;
...
// Chase Enemy
//=========================================================
AI_DEFINE_SCHEDULE(SCHED_WBUG_CHASE_ENEMY,
...
//=========================================================
AI_DEFINE_SCHEDULE(SCHED_WBUG_CHASE_ENEMY_FAILED,
...
// Flee from our enemy
//=========================================================
AI_DEFINE_SCHEDULE(SCHED_WBUG_FLEE_ENEMY,
...
//=========================================================
AI_DEFINE_SCHEDULE(SCHED_WBUG_PATROL,
...
//=========================================================
AI_DEFINE_SCHEDULE(SCHED_WBUG_RETURN_TO_BUGHOLE,
...
//=========================================================
AI_DEFINE_SCHEDULE(SCHED_WBUG_RETURN_TO_BUGHOLE_AND_REMOVE,
...
//=========================================================
AI_DEFINE_SCHEDULE(SCHED_WBUG_ASSIST_FELLOW_BUG,
