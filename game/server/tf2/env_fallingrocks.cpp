...
public:
	...
	static CFallingRock *Create(const Vector &vecOrigin, const QAngle &vecAngles, const Vector &vecVelocity,
								const AngularImpulse &vecRotationSpeed);
...
//-----------------------------------------------------------------------------
CFallingRock *CFallingRock::Create(const Vector &vecOrigin, const QAngle &vecAngles, const Vector &vecVelocity,
								   const AngularImpulse &vecRotationSpeed)
{
...
void CEnv_FallingRocks::RockThink(void)
{
	...
	CFallingRock::Create(GetAbsOrigin(), GetAbsAngles(), (vecForward * m_flFallStrength),
