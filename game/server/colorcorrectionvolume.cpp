...
BEGIN_DATADESC(CColorCorrectionVolume)
	...
	DEFINE_THINKFUNC(ThinkFunc),
		...
		DEFINE_FIELD(m_Weight, FIELD_FLOAT), DEFINE_FIELD(m_LastEnterWeight, FIELD_FLOAT),
		DEFINE_FIELD(m_LastEnterTime, FIELD_FLOAT), DEFINE_FIELD(m_LastExitWeight, FIELD_FLOAT),
