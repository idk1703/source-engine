...
BEGIN_DATADESC(CAreaPortal)
	...
	DEFINE_KEYFIELD(m_portalNumber, FIELD_INTEGER, "portalnumber"), DEFINE_FIELD(m_state, FIELD_INTEGER),
		...
		DEFINE_INPUTFUNC(FIELD_VOID, "TurnOn", InputClose), DEFINE_INPUTFUNC(FIELD_VOID, "TurnOff", InputOpen),
