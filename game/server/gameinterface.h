...
{
public:
	virtual bool ClientConnect(edict_t *pEntity, char const *pszName, char const *pszAddress, char *reject,
...
public:
	...
	virtual bool LevelInit(const char *pMapName, char const *pMapEntities, char const *pOldLevel,
	...
	virtual void PreClientUpdate(
		bool simulating) OVERRIDE; // called after all GameFrame() calls, before sending data to clients
	...
	virtual void SaveWriteFields(CSaveRestoreData *, char const *, void *, datamap_t *, typedescription_t *,
								 int) OVERRIDE;
	virtual void SaveReadFields(CSaveRestoreData *, char const *, void *, datamap_t *, typedescription_t *,
								int) OVERRIDE;
