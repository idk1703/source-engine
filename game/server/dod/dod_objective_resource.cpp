...
SendPropInt(SENDINFO(m_iNumControlPoints), 4, SPROP_UNSIGNED),
	...
	SendPropArray3(SENDINFO_ARRAY3(m_iAlliesReqCappers),
				   SendPropInt(SENDINFO_ARRAY(m_iAlliesReqCappers), 4, SPROP_UNSIGNED)),
	SendPropArray3(SENDINFO_ARRAY3(m_iAxisReqCappers),
				   SendPropInt(SENDINFO_ARRAY(m_iAxisReqCappers), 4, SPROP_UNSIGNED)),
	...
	SendPropArray3(SENDINFO_ARRAY3(m_iBombsRemaining),
				   SendPropInt(SENDINFO_ARRAY(m_iBombsRemaining), 2, SPROP_UNSIGNED)),
	SendPropArray3(SENDINFO_ARRAY3(m_bBombBeingDefused),
				   SendPropInt(SENDINFO_ARRAY(m_bBombBeingDefused), 1, SPROP_UNSIGNED)),
...
void CDODObjectiveResource::SetCPIcons(int index, int iAlliesIcon, int iAxisIcon, int iNeutralIcon, int iTimerCapIcon,
									   int iBombedIcon)
{
