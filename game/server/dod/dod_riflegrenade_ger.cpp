...
()
	...
	CDODRifleGrenadeGER *CDODRifleGrenadeGER::Create(const Vector &position, const QAngle &angles,
													 const Vector &velocity, const AngularImpulse &angVelocity,
													 CBaseCombatCharacter *pOwner, float timer, DODWeaponID weaponID)
{
	CDODRifleGrenadeGER *pGrenade =
		(CDODRifleGrenadeGER *)CBaseEntity::Create("grenade_riflegren_ger", position, angles, pOwner);
