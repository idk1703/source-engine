...
public:
	...
	{
		return (iMode != OBS_MODE_DEATHCAM && iMode != OBS_MODE_FREEZECAM);
	}
...
public:
	...
	void Stats_WeaponHit(CDODPlayer *pVictim, int weaponID, int iDamage, int iDamageGiven, int hitgroup,
						 float flHitDistance);
...
public:
	...
	int iNumKilledByUnanswered[MAX_PLAYERS +
							   1]; // how many unanswered kills this player has been dealt by every other player
