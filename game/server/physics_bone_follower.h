...
void CreateBoneFollowersFromRagdoll(CBaseAnimating *pEntity, class CBoneFollowerManager *pManager,
									vcollide_t *pCollide);
...
public:
	...
	void AddBoneFollower(CBaseAnimating *pParentEntity, const char *pFollowerBoneName,
...
private:
	bool CreatePhysicsFollower(CBaseAnimating *pParentEntity, physfollower_t &follow, const char *pBoneName,
							   solid_t *pSolid);
...
public:
	...
	// locals
	bool Init(CBaseEntity *pOwner, const char *pModelName, solid_t &solid, const Vector &position,
	...
	// factory
	static CBoneFollower *Create(CBaseEntity *pOwner, const char *pModelName, solid_t &solid, const Vector &position,
								 const QAngle &orientation);
