...
public:
	...
	int tp_grenades_1() const
	{
		return GetClassInfo()->m_iGrenadeType1;
	}
	int tp_grenades_2() const
	{
		return GetClassInfo()->m_iGrenadeType2;
	}
	int no_grenades_1() const
	{
		return GetAmmoCount(TFC_AMMO_GRENADES1);
	}
	int no_grenades_2() const
	{
		return GetAmmoCount(TFC_AMMO_GRENADES2);
	}
