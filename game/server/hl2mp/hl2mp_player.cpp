...
SendPropAngle(SENDINFO_VECTORELEM(m_angEyeAngles, 0), 11, SPROP_CHANGES_OFTEN),
	...
	SendPropExclude("DT_BaseAnimating", "m_flPoseParameter"), SendPropExclude("DT_BaseFlex", "m_viewtarget"),
...
()
	...
	const char *g_ppszRandomCitizenModels[] = {
		...
		"models/humans/group03/female_01.mdl", "models/humans/group03/male_03.mdl",
		"models/humans/group03/female_02.mdl", "models/humans/group03/male_04.mdl",
		"models/humans/group03/female_03.mdl", "models/humans/group03/male_05.mdl",
		"models/humans/group03/female_04.mdl", "models/humans/group03/male_06.mdl",
		"models/humans/group03/female_06.mdl", "models/humans/group03/male_07.mdl",
		"models/humans/group03/female_07.mdl", "models/humans/group03/male_08.mdl",
...
bool CHL2MP_Player::WantsLagCompensationOnEntity(const CBasePlayer *pPlayer, const CUserCmd *pCmd,
...
void CHL2MP_Player::SetAnimation(PLAYER_ANIM playerAnim)
{
	...
	{
		if(GetActivity() == ACT_HOVER || GetActivity() == ACT_SWIM || GetActivity() == ACT_HOP ||
		   GetActivity() == ACT_LEAP || GetActivity() == ACT_DIESIMPLE)
		{
...
CHL2MPPlayerStateInfo *CHL2MP_Player::State_LookupInfo(HL2MPPlayerState state)
{
	...
	static CHL2MPPlayerStateInfo playerStateInfos[] = {
		...
		{STATE_OBSERVER_MODE, "STATE_OBSERVER_MODE", &CHL2MP_Player::State_Enter_OBSERVER_MODE, NULL,
...
void CHL2MP_Player::State_Enter_ACTIVE()
{
	...
	// md 8/15/07 - They'll get set back to solid when they actually respawn. If we set them solid now and
	// mp_forcerespawn is false, then they'll be spectating but blocking live players from moving. RemoveSolidFlags(
	// FSOLID_NOT_SOLID );
...
void CHL2MP_Player::State_PreThink_ACTIVE()
{
	...
	// This state_prethink structure came over from CS:S and was doing an assert check that fails the way hl2dm handles
	// death
}
