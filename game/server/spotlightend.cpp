...
SendPropFloat(SENDINFO(m_flLightScale), 0, SPROP_NOSCALE), SendPropFloat(SENDINFO(m_Radius), 0, SPROP_NOSCALE),
...
()
	...
	DEFINE_FIELD(m_Radius, FIELD_FLOAT), DEFINE_FIELD(m_vSpotlightDir, FIELD_VECTOR),
