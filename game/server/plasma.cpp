...
SendPropFloat(SENDINFO(m_flScale), 0, SPROP_NOSCALE), SendPropFloat(SENDINFO(m_flScaleTime), 0, SPROP_NOSCALE),
	SendPropInt(SENDINFO(m_nFlags), 8, SPROP_UNSIGNED), SendPropModelIndex(SENDINFO(m_nPlasmaModelIndex)),
	SendPropModelIndex(SENDINFO(m_nPlasmaModelIndex2)), SendPropModelIndex(SENDINFO(m_nGlowModelIndex)),
END_SEND_TABLE
()
	...
	DEFINE_FIELD(m_flScaleTime, FIELD_FLOAT), DEFINE_FIELD(m_nFlags, FIELD_INTEGER),
