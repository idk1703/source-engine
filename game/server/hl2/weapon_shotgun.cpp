...
BEGIN_DATADESC(CWeaponShotgun)
	...
	DEFINE_FIELD(m_bNeedPump, FIELD_BOOLEAN), DEFINE_FIELD(m_bDelayedFire1, FIELD_BOOLEAN),
...
void CWeaponShotgun::PrimaryAttack(void)
{
	...
	pPlayer->FireBullets(sk_plr_num_shotgun_pellets.GetInt(), vecSrc, vecAiming, GetBulletSpread(), MAX_TRACE_LENGTH,
						 m_iPrimaryAmmoType, 0, -1, -1, 0, NULL, true, true);
...
void CWeaponShotgun::SecondaryAttack(void)
{
	...
	// Fire the bullets
	pPlayer->FireBullets(12, vecSrc, vecAiming, GetBulletSpread(), MAX_TRACE_LENGTH, m_iPrimaryAmmoType, 0, -1, -1, 0,
						 NULL, false, false);
...
void CWeaponShotgun::ItemPostFrame(void)
{
	...
	else if((m_bDelayedFire1 || pOwner->m_nButtons & IN_ATTACK) && m_flNextPrimaryAttack <= gpGlobals->curtime)
	{
		...
		if((m_iClip1 <= 0 && UsesClipsForAmmo1()) ||
		   (!UsesClipsForAmmo1() && !pOwner->GetAmmoCount(m_iPrimaryAmmoType)))
		{
