...
void CWeaponExtinguisher::Event_Killed(const CTakeDamageInfo &info)
{
	...
	FireSystem_ExtinguishInRadius(GetAbsOrigin(), fire_extinguisher_explode_radius.GetInt(),
								  fire_extinguisher_explode_strength.GetFloat());
...
void CWeaponExtinguisher::ItemPostFrame(void)
{
	...
	if(pOwner->m_nButtons & IN_ATTACK)
	{
		...
		FireSystem_ExtinguishInRadius(tr.endpos, fire_extinguisher_radius.GetInt(),
									  fire_extinguisher_strength.GetFloat());
