...
#define BASECHOPPER_WASH_RAMP_TIME \
	1.0 // Time it takes to ramp from the initial to the max force on an object in the wash (at the center of the wash)
...
protected:
	...
	void InputMoveTopSpeed(
		inputdata_t &inputdata); // Causes the helicopter to immediately accelerate to its desired velocity
...
public:
	...
	static void ComputeAvoidanceForces(CBaseEntity *pEntity, float flEntityRadius, float flAvoidTime,
