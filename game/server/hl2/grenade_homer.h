...
public:
	...
	static CGrenadeHomer *CreateGrenadeHomer(string_t nModelName, string_t sFlySound, const Vector &vecOrigin,
											 const QAngle &vecAngles, edict_t *pentOwner);

	virtual void Precache(void);
	void Spawn(void);
	void Launch(CBaseEntity *pOwner, CBaseEntity *pTarget, const Vector &vInitVelocity, float m_flHomingSpeed,
