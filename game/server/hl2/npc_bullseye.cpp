...
int FindBullseyesInCone(CBaseEntity **pList, int listMax, const Vector &coneOrigin, const Vector &coneAxis,
...
BEGIN_DATADESC(CNPC_Bullseye)
	...
	DEFINE_FIELD(m_hPainPartner, FIELD_EHANDLE), DEFINE_KEYFIELD(m_fAutoaimRadius, FIELD_FLOAT, "autoaimradius"),
