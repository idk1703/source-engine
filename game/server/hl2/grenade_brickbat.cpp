...
BEGIN_DATADESC(CGrenade_Brickbat)
	...
	DEFINE_FIELD(m_nType, FIELD_INTEGER), DEFINE_FIELD(m_bExplodes, FIELD_BOOLEAN),
...
{
	CWeaponBrickbat *pBrickbat =
		(CWeaponBrickbat *)CBaseEntity::CreateNoSpawn("weapon_brickbat", GetLocalOrigin(), GetLocalAngles(), NULL);
