...
BEGIN_DATADESC(CGrenadeAR2)
	...
	DEFINE_FIELD(m_hSmokeTrail, FIELD_EHANDLE), DEFINE_FIELD(m_fSpawnTime, FIELD_TIME),
...
void CGrenadeAR2::GrenadeAR2Think(void)
{
	...
	CSoundEnt::InsertSound(SOUND_DANGER, GetAbsOrigin() + GetAbsVelocity() * 0.5, m_fDangerRadius, 0.2, this,
