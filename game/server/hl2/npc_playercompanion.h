...
public:
	CCompanionActivityRemap(void)
		: m_fUsageBits(0), m_readiness(AIRL_RELAXED), m_bAiming(false), m_bWeaponRequired(false), m_bInVehicle(false)
	{
	}
...
protected:
	...
	int m_iNumConsecutiveBarrelsExploded; // Companions keep track of the # of consecutive barrels exploded by the
										  // player and speaks a response as it increases
	int m_iNumConsecutivePlayerKills;	  // Alyx keeps track of the # of consecutive kills by the player and speaks a
										  // response as it increases
