...
BEGIN_DATADESC(CNPC_EnemyFinder)
	...
	DEFINE_EMBEDDED(m_PlayerFreePass), DEFINE_EMBEDDED(m_ChooseEnemyTimer),
		...
		// Inputs
		DEFINE_INPUT(m_nStartOn, FIELD_INTEGER, "StartOn"), DEFINE_INPUT(m_flFieldOfView, FIELD_FLOAT, "FieldOfView"),
...
BEGIN_DATADESC(CNPC_EnemyFinderCombineCannon)
	DEFINE_FIELD(m_flTimeNextHateNPC, FIELD_TIME), DEFINE_FIELD(m_flTimeStopHateNPC, FIELD_TIME),
		DEFINE_FIELD(m_flOriginalFOV, FIELD_FLOAT), DEFINE_FIELD(m_flTimeWideFOV, FIELD_TIME),
