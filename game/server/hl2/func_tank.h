...
#define SF_TANK_IGNORE_RANGE_IN_VIEWCONE \
	0x2000							  // 8192		Don't use range as a factor in determining if something is in view cone
...
#ifdef HL2_EPISODIC
	string_t
		m_iszAmmoType; // The name of the ammodef that we use when we fire. Bullet damage still comes from keyvalues.
