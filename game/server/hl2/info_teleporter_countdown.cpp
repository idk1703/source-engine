...
BEGIN_DATADESC(CInfoTeleporterCountdown)
	...
	DEFINE_FIELD(m_bCountdownStarted, FIELD_BOOLEAN), DEFINE_FIELD(m_bDisabled, FIELD_BOOLEAN),
		DEFINE_FIELD(m_flStartTime, FIELD_TIME), DEFINE_FIELD(m_flTimeRemaining, FIELD_FLOAT),
...
SendPropInt(SENDINFO(m_bCountdownStarted), 1, SPROP_UNSIGNED), SendPropInt(SENDINFO(m_bDisabled), 1, SPROP_UNSIGNED),
	SendPropTime(SENDINFO(m_flStartTime)), SendPropFloat(SENDINFO(m_flTimeRemaining), 0, SPROP_NOSCALE),
END_SEND_TABLE
()
