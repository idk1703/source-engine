...
class CNPC_Strider : public CAI_BlendingHost<CAI_BaseNPC>, public IStriderMinigunHost
{
...
public:
	...
	bool GetWeaponLosZ(const Vector &vOrigin, float minZ, float maxZ, float increment, CBaseEntity *pTarget,
					   float *pResult);
