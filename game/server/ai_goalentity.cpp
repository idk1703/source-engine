...
BEGIN_DATADESC(CAI_GoalEntity)
	...
	DEFINE_KEYFIELD(m_iszActor, FIELD_STRING, "Actor"), DEFINE_KEYFIELD(m_iszGoal, FIELD_STRING, "Goal"),
		...
		DEFINE_KEYFIELD(m_SearchType, FIELD_INTEGER, "SearchType"), DEFINE_UTLVECTOR(m_actors, FIELD_EHANDLE),
		DEFINE_FIELD(m_hGoalEntity, FIELD_EHANDLE), DEFINE_FIELD(m_flags, FIELD_INTEGER),
