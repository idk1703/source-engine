...
#define MAX_NODE_LINK_DIST_SQ \
	(MAX_NODE_LINK_DIST * MAX_NODE_LINK_DIST) //   distance allowed to travel to node via local moves
...
#define MAX_AIR_NODE_LINK_DIST_SQ \
	(MAX_AIR_NODE_LINK_DIST * MAX_AIR_NODE_LINK_DIST) //   distance allowed to travel to node via local moves
