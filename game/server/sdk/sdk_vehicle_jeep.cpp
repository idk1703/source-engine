...
BEGIN_DATADESC(CPropJeep)
	DEFINE_FIELD(m_bGunHasBeenCutOff, FIELD_BOOLEAN), DEFINE_FIELD(m_flDangerSoundTime, FIELD_TIME),
		...
		DEFINE_FIELD(m_flOverturnedTime, FIELD_TIME), DEFINE_FIELD(m_flAmmoCrateCloseTime, FIELD_FLOAT),
		...
		DEFINE_FIELD(m_hLastPlayerInVehicle, FIELD_EHANDLE), DEFINE_FIELD(m_bHasPoop, FIELD_BOOLEAN),
...
void CPropJeep::UpdateSteeringAngle(void)
{
	...
	float flSteeringDegrees =
		JEEP_STEERING_FAST_ANGLE + ((JEEP_STEERING_SLOW_ANGLE - JEEP_STEERING_FAST_ANGLE) * flRatio);
