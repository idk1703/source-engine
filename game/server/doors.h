...
#define SF_DOOR_NEW_USE_RULES \
	65536 // For func_door entities, behave more like prop_door_rotating with respect to +USE (changelist 242482)
...
private:
	...
	void CloseAreaPortalsThink(
		void); ///< Delays turning off area portals when closing doors to prevent visual artifacts
};
