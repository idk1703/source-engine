...
BEGIN_DATADESC(CPointPlayerMoveConstraint)
	...
	DEFINE_KEYFIELD(m_flRadius, FIELD_FLOAT, "radius"), DEFINE_KEYFIELD(m_flConstraintWidth, FIELD_FLOAT, "width"),
		...
		DEFINE_THINKFUNC(ConstraintThink), DEFINE_INPUTFUNC(FIELD_VOID, "TurnOn", InputTurnOn),
