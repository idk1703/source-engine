...
protected:
	...
	AI_NavPathProgress_t ProgressFlyPath(float flInterval, const CBaseEntity *pNewTarget, unsigned collisionMask,
	...
	IMotionEvent::simresult_e Simulate(IPhysicsMotionController * pController, IPhysicsObject * pObject,
