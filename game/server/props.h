...
private:
	...
	COutputEvent m_OnPhysCannonPullAnimFinished;   // We've had our pull anim finished, or the post-pull has finished if
												   // there is one
...
{
public:
	virtual void OnParentCollisionInteraction(parentCollisionInteraction_t eType, int index,
											  gamevcollisionevent_t *pEvent) = 0;
...
CPhysicsProp *CreatePhysicsProp(const char *pModelName, const Vector &vTraceStart, const Vector &vTraceEnd,
								const IHandleEntity *pTraceIgnore, bool bRequireVCollide,
								const char *pClassName = "physics_prop");
