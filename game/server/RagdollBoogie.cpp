...
BEGIN_DATADESC(CRagdollBoogie)
	...
	DEFINE_FIELD(m_flStartTime, FIELD_TIME), DEFINE_FIELD(m_flBoogieLength, FIELD_FLOAT),
...
// Input  : pTarget -
//-----------------------------------------------------------------------------
CRagdollBoogie *CRagdollBoogie::Create(CBaseEntity *pTarget, float flMagnitude, float flStartTime, float flLengthTime,
									   int nSpawnFlags)
{
