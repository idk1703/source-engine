...
BEGIN_DATADESC(CEnvEntityMaker)
	...
	DEFINE_FIELD(m_hCurrentInstance, FIELD_EHANDLE), DEFINE_FIELD(m_hCurrentBlocker, FIELD_EHANDLE),
		DEFINE_FIELD(m_vecBlockerOrigin, FIELD_VECTOR), DEFINE_KEYFIELD(m_iszTemplate, FIELD_STRING, "EntityTemplate"),
...
bool CEnvEntityMaker::HasRoomToSpawn()
{
	...
	trace_t tr;
	UTIL_TraceHull(GetAbsOrigin(), GetAbsOrigin(), m_vecEntityMins, m_vecEntityMaxs, MASK_SOLID, this,
