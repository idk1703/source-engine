...
void CWeaponCubemap::Spawn(void)
{
	...
	// Problem is the model has huge bounds so the new pickup code that checks if the player can see the model fails
	// cause half the entity's bounds are inside the ground. Since this is just a dev tool I made this quick hack so
	// level designers can use it again asap. - Adrian
