...
SendPropVector(SENDINFO(m_vOrigin), 0, SPROP_COORD), SendPropVector(SENDINFO(m_vDirection), 0, SPROP_NOSCALE)
END_SEND_TABLE
()
...
BEGIN_DATADESC(CParticleFire)
	...
	DEFINE_FIELD(m_vOrigin, FIELD_POSITION_VECTOR), DEFINE_FIELD(m_vDirection, FIELD_VECTOR),
