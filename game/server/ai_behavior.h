...
public:
	CAI_BehaviorBase(CAI_BaseNPC *pOuter = NULL) : CAI_Component(pOuter), m_pBackBridge(NULL) {}
	...
	{
		return;
	} // Override this and your behavior will call this in place of GatherConditions() when your behavior is NOT the
	  // active one.
	...
	static void SaveBehaviors(ISave & save, CAI_BehaviorBase * pCurrentBehavior, CAI_BehaviorBase * *ppBehavior,
							  int nBehaviors);
	static int RestoreBehaviors(IRestore & restore, CAI_BehaviorBase * *ppBehavior,
...
protected:
	CAI_Behavior(NPC_CLASS *pOuter = NULL) : CAI_ComponentWithOuter<NPC_CLASS, CAI_BehaviorBase>(pOuter) {}
...
{
	int localId =
		AI_IdIsGlobal(scheduleType) ? GetClassScheduleIdSpace()->ScheduleGlobalToLocal(scheduleType) : scheduleType;
...
inline bool CAI_BehaviorBase::BridgeSelectFailSchedule(int failedSchedule, int failedTask,
													   AI_TaskFailureCode_t taskFailCode, int *pResult)
{
	m_fOverrode = true;
...
inline bool CAI_BehaviorBase::BridgeIsValidShootPosition(const Vector &vLocation, CAI_Node *pNode,
...
inline bool CAI_BehaviorBase::BridgeOnCalcBaseMove(AILocalMoveGoal_t *pMoveGoal, float distClear,
...
inline void CAI_BehaviorBase::BridgeTeleport(const Vector *newPosition, const QAngle *newAngles,
...
template<class BASE_NPC>
inline int CAI_BehaviorHost<BASE_NPC>::SelectFailSchedule(int failedSchedule, int failedTask,
...
template<class BASE_NPC>
inline bool CAI_BehaviorHost<BASE_NPC>::BackBridge_IsValidShootPosition(const Vector &vLocation, CAI_Node *pNode,
																		CAI_Hint const *pHint)
{
...
template<class BASE_NPC>
inline void CAI_BehaviorHost<BASE_NPC>::BackBridge_OnFriendDamaged(CBaseCombatCharacter *pSquadmate,
...
template<class BASE_NPC>
inline bool CAI_BehaviorHost<BASE_NPC>::BackBridge_OnCalcBaseMove(AILocalMoveGoal_t *pMoveGoal, float distClear,
																  AIMoveResult_t *pResult)
{
...
template<class BASE_NPC>
inline void CAI_BehaviorHost<BASE_NPC>::BackBridge_Teleport(const Vector *newPosition, const QAngle *newAngles,
															const Vector *newVelocity)
{
...
template<class BASE_NPC>
inline void CAI_BehaviorHost<BASE_NPC>::OnChangeActiveWeapon(CBaseCombatWeapon *pOldWeapon,
...
template<class BASE_NPC>
inline bool CAI_BehaviorHost<BASE_NPC>::IsValidShootPosition(const Vector &vLocation, CAI_Node *pNode,
															 CAI_Hint const *pHint)
{
	if(m_pCurBehavior)
...
template<class BASE_NPC>
inline bool CAI_BehaviorHost<BASE_NPC>::ScheduledMoveToGoalEntity(int scheduleType, CBaseEntity *pGoalEntity,
...
template<class BASE_NPC>
inline bool CAI_BehaviorHost<BASE_NPC>::ScheduledFollowPath(int scheduleType, CBaseEntity *pPathStart,
															Activity movementActivity)
{
	// If a behavior is active, we need to stop running it
	ChangeBehaviorTo(NULL);
...
template<class BASE_NPC>
inline void CAI_BehaviorHost<BASE_NPC>::ForceSelectedGo(CBaseEntity *pPlayer, const Vector &targetPos,
...
template<class BASE_NPC>
inline bool CAI_BehaviorHost<BASE_NPC>::OnCalcBaseMove(AILocalMoveGoal_t *pMoveGoal, float distClear,
													   AIMoveResult_t *pResult)
{
	if(m_pCurBehavior)
...
template<class BASE_NPC>
inline void CAI_BehaviorHost<BASE_NPC>::Teleport(const Vector *newPosition, const QAngle *newAngles,
												 const Vector *newVelocity)
{
	if(m_pCurBehavior)
	{
...
template<class BASE_NPC>
inline void CAI_BehaviorHost<BASE_NPC>::OnChangeRunningBehavior(CAI_BehaviorBase *pOldBehavior,
