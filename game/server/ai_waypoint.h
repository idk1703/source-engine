...
public:
	...
	bool IsReducible()
	{
		return (pNext && m_iWPType == pNext->m_iWPType &&
				!(m_fWaypointFlags & (bits_WP_TO_GOAL | bits_WP_TO_PATHCORNER | bits_WP_DONT_SIMPLIFY)));
	}
...
public:
	...
	CAI_WaypointList(AI_Waypoint_t *pFirstWaypoint) : m_pFirstWaypoint(pFirstWaypoint) {}
