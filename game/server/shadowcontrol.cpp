...
BEGIN_DATADESC(CShadowControl)
	...
	DEFINE_KEYFIELD(m_flShadowMaxDist, FIELD_FLOAT, "distance"),
		...
		// Inputs
		DEFINE_INPUT(m_shadowColor, FIELD_COLOR32, "color"), DEFINE_INPUT(m_shadowDirection, FIELD_VECTOR, "direction"),
...
SendPropVector(SENDINFO(m_shadowDirection), -1, SPROP_NOSCALE),
	...
	SendPropFloat(SENDINFO(m_flShadowMaxDist), 0, SPROP_NOSCALE), SendPropBool(SENDINFO(m_bDisableShadows)),
END_SEND_TABLE
()
