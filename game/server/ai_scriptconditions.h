...
private:
	...
	// @Note (toml 07-17-02): At some point, it may be desireable to switch to using function objects instead of
	// functions. Probably if support for NPCs addiing custom conditions becomes necessary
