...
public:
	...
	virtual bool LoadPositions(char const *filename, Panel *parent, vgui::IToolWindowFactory *factory, char const *key,
							   bool force = false);
...
bool CWindowPositionMgr::LoadPositions(char const *filename, vgui::Panel *parent, vgui::IToolWindowFactory *factory,
