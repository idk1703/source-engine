...
public:
	CFoundryViewMenuButton(CFoundryTool *parent, const char *panelName, const char *text,
...
CFoundryViewMenuButton::CFoundryViewMenuButton(CFoundryTool *parent, const char *panelName, const char *text,
											   vgui::Panel *pActionSignalTarget)
	: BaseClass(parent, panelName, text, pActionSignalTarget)
{
	...
	AddCheckableMenuItem("entityreport", "#FoundryEntityReport", new KeyValues("OnToggleEntityReport"),
						 pActionSignalTarget);
...
public:
	CFoundryToolMenuButton(CFoundryTool *parent, const char *panelName, const char *text,
						   vgui::Panel *pActionSignalTarget);
	virtual void OnShowMenu(vgui::Menu *menu);
...
CFoundryToolMenuButton::CFoundryToolMenuButton(CFoundryTool *parent, const char *panelName, const char *text,
											   vgui::Panel *pActionSignalTarget)
	: BaseClass(parent, panelName, text, pActionSignalTarget)
{
	m_pTool = parent;
...
void CFoundryTool::OnDefaultLayout()
{
	...
	ToolWindow *pPropertyWindow =
		m_ToolWindowFactory.InstanceToolWindow(GetClientArea(), false, properties, "#FoundryProperties", false);
	ToolWindow *pEntityReportWindow =
		m_ToolWindowFactory.InstanceToolWindow(GetClientArea(), false, pEntityReport, "#FoundryEntityReport", false);
...
//-----------------------------------------------------------------------------
void CFoundryTool::OnFileOperationCompleted(const char *pFileType, bool bWroteFile,
											vgui::FileOpenStateMachine::CompletionState_t state,
											KeyValues *pContextKeyValues)
{
	if(bWroteFile)
...
//-----------------------------------------------------------------------------
void CFoundryTool::SetupFileOpenDialog(vgui::FileOpenDialog *pDialog, bool bOpenFile, const char *pFileFormat,
									   KeyValues *pContextKeyValues)
{
