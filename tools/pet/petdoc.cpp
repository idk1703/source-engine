...
bool CPetDoc::GetIntChoiceList(const char *pChoiceListType, CDmElement *pElement, const char *pAttributeName,
...
void CPetDoc::DeleteParticleSystemDefinition(CDmeParticleSystemDefinition *pParticleSystem)
{
	...
	for(int i = 0; i < nChildCount; ++i)
	{
		...
		CDmeParticleSystemDefinition *pParent =
			FindReferringElement<CDmeParticleSystemDefinition>(pChildReference, "children");
		if(!pParent)
			continue;
...
//-----------------------------------------------------------------------------
bool CPetDoc::GetStringChoiceList(const char *pChoiceListType, CDmElement *pElement, const char *pAttributeName,
...
//-----------------------------------------------------------------------------
bool CPetDoc::GetElementChoiceList(const char *pChoiceListType, CDmElement *pElement, const char *pAttributeName,
