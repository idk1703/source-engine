...
#ifdef _WIN32
#define _PS_EXTERN_CONST(Name, Val) const __declspec(align(16)) float _ps_##Name[4] = {Val, Val, Val, Val}

#define _PS_EXTERN_CONST_TYPE(Name, Type, Val) const __declspec(align(16)) Type _ps_##Name[4] = {Val, Val, Val, Val};

#define _EPI32_CONST(Name, Val) static const __declspec(align(16)) __int32 _epi32_##Name[4] = {Val, Val, Val, Val}

#define _PS_CONST(Name, Val) static const __declspec(align(16)) float _ps_##Name[4] = {Val, Val, Val, Val}
#elif POSIX
#define _PS_EXTERN_CONST(Name, Val) const float _ps_##Name[4] __attribute__((aligned(16))) = {Val, Val, Val, Val}

#define _PS_EXTERN_CONST_TYPE(Name, Type, Val) \
	const Type _ps_##Name[4] __attribute__((aligned(16))) = {Val, Val, Val, Val};

#define _EPI32_CONST(Name, Val) static const int32 _epi32_##Name[4] __attribute__((aligned(16))) = {Val, Val, Val, Val}

#define _PS_CONST(Name, Val) static const float _ps_##Name[4] __attribute__((aligned(16))) = {Val, Val, Val, Val}
#endif
