...
class CReplayDemoPlayer : public CDemoPlayer, public IReplayDemoPlayer
{
public:
...
private:
	...
	{
	public:
		CInStartPlaybackGuard(bool &bState) : m_bState(bState)
		{
			m_bState = true;
		}
		~CInStartPlaybackGuard()
		{
			m_bState = false;
		}
		bool &m_bState;
	...
	{
		PlaybackInfo_t() : m_hReplay(REPLAY_HANDLE_INVALID), m_iPerformance(-1), m_nStartTick(-1), m_nEndTick(-1) {}
