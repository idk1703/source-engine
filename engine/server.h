...
public:
	...
	{
		return m_bIsLevelMainMenuBackground;
	}
...
public:
	...
	INetworkStringTable *GetDynamicModelsTable(void) const
	{
		return m_pDynamicModelsTable;
	}
...
private:
	...
	bool m_bHibernating; // Are we hibernating.  Hibernation makes server process consume approx 0 CPU when no clients
						 // are connected
};
...
extern int g_iServerGameClientsVersion; // This matches the number at the end of the interface name (so for
