...
typedef CBaseActionEditDialog *(*DEMOACTIONEDIT_FUNC)(CDemoEditorPanel *parent, CBaseDemoAction *action,
													  bool newaction);
...
public:
	...
	static CBaseActionEditDialog *CreateActionEditor(DEMOACTION actionType, CDemoEditorPanel * parent,
...
#define DECLARE_DEMOACTIONEDIT(type, classname)                                                                \
	static CBaseActionEditDialog *FnCreateEditor##classname(CDemoEditorPanel *parent, CBaseDemoAction *action, \
															bool newaction)                                    \
	{                                                                                                          \
