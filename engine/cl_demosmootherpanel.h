...
protected:
	...
	void DrawSmoothingSample(bool original, bool processed, int samplenumber, demosmoothing_t *sample,
	...
	void AddSamplePoints(bool usetarget, bool includeboundaries, CUtlVector<demosmoothing_t *> &points, int start,
						 int end);
