...
INetChannel *NET_CreateNetChannel(int socketnumber, netadr_t *adr, const char *name, INetChannelHandler *handler,
								  bool bForceNew = false, int nProtocolVersion = PROTOCOL_VERSION);
