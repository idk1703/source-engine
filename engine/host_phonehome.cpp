...
public:
	...
	virtual void Init()
	{
		...
		if(Q_strlen(build_identifier) >= 1 && Q_strnicmp(build_identifier, "VLV_INTERNAL", Q_strlen("VLV_INTERNAL")))
		{
...
private:
	...
	bool IsExternalBuild()
	{
		...
		if(!CommandLine()->FindParm("-internalbuild") && !CommandLine()->CheckParm("-dev"))
		{
			return true;
		}
