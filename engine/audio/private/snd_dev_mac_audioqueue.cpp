...
void CAudioDeviceAudioQueue::UpdateListener(const Vector &position, const Vector &forward, const Vector &right,
											const Vector &up)
{
}
...
void CAudioDeviceAudioQueue::Mix8Mono(channel_t *pChannel, char *pData, int outputOffset, int inputOffset,
...
void CAudioDeviceAudioQueue::Mix8Stereo(channel_t *pChannel, char *pData, int outputOffset, int inputOffset,
										fixedint rateScaleFix, int outCount, int timecompress)
{
	int volume[CCHANVOLUMES];
	paintbuffer_t *ppaint = MIX_GetCurrentPaintbufferPtr();
...
void CAudioDeviceAudioQueue::Mix16Mono(channel_t *pChannel, short *pData, int outputOffset, int inputOffset,
									   fixedint rateScaleFix, int outCount, int timecompress)
{
	int volume[CCHANVOLUMES];
	paintbuffer_t *ppaint = MIX_GetCurrentPaintbufferPtr();
...
void CAudioDeviceAudioQueue::Mix16Stereo(channel_t *pChannel, short *pData, int outputOffset, int inputOffset,
										 fixedint rateScaleFix, int outCount, int timecompress)
{
	int volume[CCHANVOLUMES];
	paintbuffer_t *ppaint = MIX_GetCurrentPaintbufferPtr();
...
void CAudioDeviceAudioQueue::SpatializeChannel(int volume[CCHANVOLUMES / 2], int master_vol, const Vector &sourceDir,
...
void CAudioDeviceAudioQueue::ApplyDSPEffects(int idsp, portable_samplepair_t *pbuffront,
											 portable_samplepair_t *pbufrear, portable_samplepair_t *pbufcenter,
											 int samplecount)
{
