...
public:
	...
	virtual bool IsLooped(void)
	{
		return false;
	}
	virtual bool IsStereoWav(void)
	{
		return false;
	}
	...
	virtual void SetPlayOnce(bool isPlayOnce)
	{
		m_bIsPlayOnce = isPlayOnce;
	}
	virtual bool IsPlayOnce()
	{
		return m_bIsPlayOnce;
	}

	virtual void SetSentenceWord(bool bIsWord)
	{
		m_bIsSentenceWord = bIsWord;
	}
	virtual bool IsSentenceWord()
	{
		return m_bIsSentenceWord;
	}
...
protected:
	...
	inline byte *GetCachedDataPointer()
	{
		...
		CAudioSourceCachedInfo *info = m_AudioCacheHandle.Get(CAudioSource::AUDIO_SOURCE_MP3,
