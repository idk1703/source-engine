...
void CHLTVDemoRecorder::StartAutoRecording()
{
	...
	Q_snprintf(fileName, sizeof(fileName), "auto-%04i%02i%02i-%02i%02i-%s.dem", 1900 + today.tm_year, today.tm_mon + 1,
			   today.tm_mday, today.tm_hour, today.tm_min, hltv->GetMapName());
