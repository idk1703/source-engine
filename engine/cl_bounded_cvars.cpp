...
public:
	CBoundedCvar_CmdRate()
		: ConVar_ServerBounded("cl_cmdrate", "30", FCVAR_ARCHIVE | FCVAR_USERINFO,
							   "Max number of command packets sent to server per second", true, MIN_CMD_RATE, true,
							   MAX_CMD_RATE)
	{
	}
...
public:
	CBoundedCvar_UpdateRate()
		: ConVar_ServerBounded("cl_updaterate", "20", FCVAR_ARCHIVE | FCVAR_USERINFO | FCVAR_NOT_CONNECTED,
