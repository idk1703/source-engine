...
public:
	...
	int GetPluginInterfaceVersion() const
	{
		return m_iPluginInterfaceVersion;
	}
...
public:
	...
	virtual void LevelInit(char const *pMapName, char const *pMapEntities, char const *pOldLevel,
