...
static ConVar tv_relaypassword("tv_relaypassword", "", FCVAR_NOTIFY | FCVAR_PROTECTED | FCVAR_DONTRECORD,
...
bool CHLTVClient::ExecuteStringCommand(const char *pCommandString)
{
	...
	if(!Q_stricmp(cmd, "spec_next") || !Q_stricmp(cmd, "spec_prev") || !Q_stricmp(cmd, "spec_mode"))
	{
