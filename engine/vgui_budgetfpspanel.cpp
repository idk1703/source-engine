...
static ConVar budget_peaks_window("budget_peaks_window", "30", FCVAR_ARCHIVE,
								  "number of frames to look at when figuring out peak frametimes");
static ConVar budget_averages_window("budget_averages_window", "30", FCVAR_ARCHIVE,
...
static ConVar budget_show_averages("budget_show_averages", "0", FCVAR_ARCHIVE,
...
void CBudgetFPSPanel::DrawInstantaneous()
{
	...
	for(i = 0; i < nGroups; i++)
	{
		DrawBarAtIndex(i, (pBudgetGroupTimes[nSamplesPerGroup * i + nSampleOffset] - m_fRangeMin) /
