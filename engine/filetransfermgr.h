...
public:
	...
	FileTransferID_t StartSending(INetChannel * pDest, const void *pUserData, int userDataLength, const char *pFileData,
...
public:
	...
	virtual void OnFinishedSending(INetChannel * pDest, const void *pUserData, int userDataLen,
