...
bool RecvTable_CreateDecoders(const CStandardSendProxies *pSendProxies, bool bAllowMismatches,
							  bool *pAnyMismatches = NULL);
...
bool RecvTable_Decode(RecvTable *pTable, void *pStruct, bf_read *pIn, int objectID, bool updateDTI = true);
...
void RecvTable_CopyEncoding(RecvTable *pRecvTable, bf_read *pIn, bf_write *pOut, int objectID);
