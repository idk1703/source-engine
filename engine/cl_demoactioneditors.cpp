...
//			newaction -
//-----------------------------------------------------------------------------
CBaseActionWithTargetDialog::CBaseActionWithTargetDialog(CDemoEditorPanel *parent, CBaseDemoAction *action,
														 bool newaction)
...
CBaseActionSkipAheadDialog::CBaseActionSkipAheadDialog(CDemoEditorPanel *parent, CBaseDemoAction *action,
													   bool newaction)
	: CBaseActionEditDialog(parent, action, newaction)
{
...
void CBaseActionTextMessageStartDialog::FillInFonts()
{
	...
	{
		// Iterate fonts
		for(KeyValues *kv = schemeFile->FindKey("Fonts", true)->GetFirstSubKey(); kv != NULL; kv = kv->GetNextKey())
		{
...
CBaseActionPlayCommandsDialog::CBaseActionPlayCommandsDialog(CDemoEditorPanel *parent, CBaseDemoAction *action,
															 bool newaction)
	: CBaseActionEditDialog(parent, action, newaction)
{
...
CBaseActionCDTrackStartDialog::CBaseActionCDTrackStartDialog(CDemoEditorPanel *parent, CBaseDemoAction *action,
															 bool newaction)
	: CBaseActionEditDialog(parent, action, newaction)
{
...
CBaseActionPlaySoundStartDialog::CBaseActionPlaySoundStartDialog(CDemoEditorPanel *parent, CBaseDemoAction *action,
																 bool newaction)
	: CBaseActionEditDialog(parent, action, newaction)
{
...
CBaseActionWithStopTimeDialog::CBaseActionWithStopTimeDialog(CDemoEditorPanel *parent, CBaseDemoAction *action,
															 bool newaction)
	: CBaseActionEditDialog(parent, action, newaction)
{
...
CBaseActionChangePlaybackRateDialog::CBaseActionChangePlaybackRateDialog(CDemoEditorPanel *parent,
