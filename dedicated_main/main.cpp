...
int main(int argc, char *argv[])
{
	...
	void *tier0 = dlopen(LIB_PREFIX_STR "tier0" LIB_EXT_STR, RTLD_NOW);
	void *vstdlib = dlopen(LIB_PREFIX_STR "vstdlib" LIB_EXT_STR, RTLD_NOW);

	const char *pBinaryName = LIB_PREFIX_STR "dedicated" LIB_EXT_STR;
