...
static const char *GetModuleFromCPULevel(CPULevel_t level)
{
	...
	{
		case CPU_HAS_AVX2:
			return LIB_PREFIX_STR "vphysics_jolt_avx2" LIB_EXT_STR;
		case CPU_HAS_SSE42:
			return LIB_PREFIX_STR "vphysics_jolt_sse42" LIB_EXT_STR;
		default:
			return LIB_PREFIX_STR "vphysics_jolt_sse2" LIB_EXT_STR;
	}
}
...
bool PhysicsWrapper::InitWrapper()
{
	...
	if(!Sys_LoadInterface(pModuleName, VPHYSICS_INTERFACE_VERSION, &m_pActualPhysicsModule,
						  (void **)&m_pActualPhysicsInterface))
		return false;
