...
public:
	...
	static JoltPhysicsMaterialIndexSaveOps &GetInstance()
	{
		return s_Instance;
	}
...
public:
	...
	void GetPhysicsProperties(int surfaceDataIndex, float *density, float *thickness, float *friction,
							  float *elasticity) const override;
...
public:
	static JoltPhysicsSurfaceProps &GetInstance()
	{
