...
public:
	...
	void DrawGeometry(JPH::Mat44Arg inModelMatrix, const JPH::AABox &inWorldSpaceBounds, float inLODScaleSq,
...
private:
	...
	{
	public:
		BatchImpl(IMesh *pMesh) : m_pMesh(pMesh) {}
		...
		{
			JPH::RefTarget<BatchImpl>::Release();
		}
