...
JoltPhysicsShadowController::JoltPhysicsShadowController(JoltPhysicsObject *pObject, bool allowTranslation,
														 bool allowRotation)
...
void JoltPhysicsShadowController::OnPreSimulate(float flDeltaTime)
{
	...
	{
		bodyInterface.SetPositionAndRotation(m_pObject->GetBodyID(), m_targetPosition, m_targetRotation,
