...
class JoltPhysicsFluidController final : public IPhysicsFluidController,
										 public IJoltObjectDestroyedListener,
										 public IJoltPhysicsController
{
public:
	JoltPhysicsFluidController(JPH::PhysicsSystem *pPhysicsSystem, JoltPhysicsObject *pFluidObject,
							   const fluidparams_t *pParams);
