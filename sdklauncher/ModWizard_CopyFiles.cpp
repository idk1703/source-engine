...
bool CModWizardSubPanel_CopyFiles::BuildCopyFiles_R(const char *pSourceDir, const char *pMask,
													const char *pOutputDirName)
{
	char mask[512];
...
bool CModWizardSubPanel_CopyFiles_Source2006::BuildCopyFilesForMod_HL2()
{
	...
	retVal = CopyWithReplacements("CreateModFiles\\hl2\\gameinfo_ep1.txt", replacements, ARRAYSIZE(replacements),
								  "%s%s", m_OutModGamedirName, "gameinfo.txt");

	if(retVal && BuildCopyFilesForMappings(sources_mappings, ARRAYSIZE(sources_mappings)) &&
...
bool CModWizardSubPanel_CopyFiles_Source2009::BuildCopyFilesForMod_HL2()
{
	...
	char *content_mappings[] = {
		...
		"detail.vbsp",
		outputGamedirNameNoSlash,
		"CreateModFiles\\source2009\\singleplayer\\scripts",
		"*.*",
		outputScriptsDir,
		"CreateModFiles\\source2009\\singleplayer\\cfg",
		"*.*",
		outputCFGDir,
		"CreateModFiles\\source2009\\singleplayer\\resource",
		"clientscheme.res",
		outputResourceDir,
		"CreateModFiles\\source2009\\singleplayer\\resource",
		"HL2EP2.ttf",
	...
	retVal = CopyWithReplacements("CreateModFiles\\source2009\\gameinfo_sp.txt", replacements, ARRAYSIZE(replacements),
								  "%s%s", m_OutModGamedirName, "gameinfo.txt");
...
bool CModWizardSubPanel_CopyFiles_Source2007::BuildCopyFilesForMod_HL2()
{
	...
	char *content_mappings[] = {
		...
		"detail.vbsp",
		outputGamedirNameNoSlash,
		"CreateModFiles\\orangebox\\singleplayer\\scripts",
		"*.*",
		outputScriptsDir,
		"CreateModFiles\\orangebox\\singleplayer\\cfg",
		"*.*",
		outputCFGDir,
		"CreateModFiles\\orangebox\\singleplayer\\resource",
		"clientscheme.res",
		outputResourceDir,
		"CreateModFiles\\orangebox\\singleplayer\\resource",
		"HL2EP2.ttf",
	...
	retVal = CopyWithReplacements("CreateModFiles\\orangebox\\gameinfo_sp.txt", replacements, ARRAYSIZE(replacements),
								  "%s%s", m_OutModGamedirName, "gameinfo.txt");
...
bool CModWizardSubPanel_CopyFiles_Source2006::BuildCopyFilesForMod_FromScratch()
{
	...
	retVal = CopyWithReplacements("CreateModFiles\\base\\gameinfo_ep1.txt", replacements, ARRAYSIZE(replacements),
								  "%s%s", m_OutModGamedirName, "gameinfo.txt");
...
bool CModWizardSubPanel_CopyFiles_Source2009::BuildCopyFilesForMod_FromScratch()
{
	...
	char *content_mappings[] = {
		"CreateModFiles\\source2009\\template",
		"*.*",
		m_OutModGamedirName,
	};
	...
	retVal = CopyWithReplacements("CreateModFiles\\source2009\\gameinfo_template.txt", replacements,
								  ARRAYSIZE(replacements), "%s%s", m_OutModGamedirName, "gameinfo.txt");
...
bool CModWizardSubPanel_CopyFiles_Source2007::BuildCopyFilesForMod_FromScratch()
{
	...
	char *content_mappings[] = {
		"CreateModFiles\\orangebox\\template",
		"*.*",
		m_OutModGamedirName,
	};
	...
	retVal = CopyWithReplacements("CreateModFiles\\orangebox\\gameinfo_template.txt", replacements,
								  ARRAYSIZE(replacements), "%s%s", m_OutModGamedirName, "gameinfo.txt");
...
bool CModWizardSubPanel_CopyFiles_Source2006::BuildCopyFilesForMod_HL2MP()
{
	...
	retVal = CopyWithReplacements("CreateModFiles\\hl2mp\\gameinfo_ep1.txt", replacements, ARRAYSIZE(replacements),
								  "%s%s", m_OutModGamedirName, "gameinfo.txt");
...
bool CModWizardSubPanel_CopyFiles_Source2009::BuildCopyFilesForMod_HL2MP()
{
	...
	retVal = CopyWithReplacements("CreateModFiles\\source2009\\gameinfo_mp.txt", replacements, ARRAYSIZE(replacements),
								  "%s%s", m_OutModGamedirName, "gameinfo.txt");
...
bool CModWizardSubPanel_CopyFiles_Source2007::BuildCopyFilesForMod_HL2MP()
{
	...
	retVal = CopyWithReplacements("CreateModFiles\\orangebox\\gameinfo_mp.txt", replacements, ARRAYSIZE(replacements),
								  "%s%s", m_OutModGamedirName, "gameinfo.txt");
...
void CModWizardSubPanel_CopyFiles::OnTick()
{
	if(m_iCurCopyFile == -1)
	{
		...
		CModWizardSubPanel_Intro *pIntro =
			dynamic_cast<CModWizardSubPanel_Intro *>(GetWizardPanel()->FindChildByName("CModWizardSubPanel_Intro"));
		if(pIntro)
		...
		if(m_ModType != ModType_SourceCodeOnly)
		{
			...
			if(IsGameSubscribed(GetAppSteamAppId(k_App_DODS)) && !IsGameSubscribed(GetAppSteamAppId(k_App_HL2)) &&
			...
			const char *filenames[] = {"run_mod.bat", "run_hlmv.bat", "run_studiomdl.bat", "run_hammer.bat"};
			for(int iFilename = 0; iFilename < ARRAYSIZE(filenames); iFilename++)
			{
				...
				if(!CopyWithReplacements(srcFilename, replacements, ARRAYSIZE(replacements), "%s%s", m_OutputDirName,
										 filenames[iFilename]))
				{
					vgui::ivgui()->RemoveTickSignal(GetVPanel());
					GetWizardPanel()->SetCancelButtonEnabled(true);
	...
	else
	{
		...
		while(nCopied < 10)
		{
			if(m_iCurCopyFile >= m_FileCopyInfos.Count())
			{
				...
				CModWizardSubPanel_Finished *pNextPanel = dynamic_cast<CModWizardSubPanel_Finished *>(
...
bool CModWizardSubPanel_CopyFiles_Source2009::HandleReplacements_GameProjectFiles(CFileCopyInfo *pInfo,
																				  bool &bErrorStatus)
{
	...
	const char *replacements[] = {"..\\..\\game\\template\\",
								  replaceWith,
								  "..\\..\\game\\sdksample\\",
								  replaceWith,
								  "..\\..\\game\\hl2\\",
	...
	if(Q_stricmp(pInfo->m_InFilename, "src_mod\\source2009\\materialsystem\\stdshaders\\stdshader_dx9-2005.vcproj") ==
	   0)
	{
		bErrorStatus = true;
		Q_snprintf(replaceWith, sizeof(replaceWith), "%s", m_OutModGamedirName);
		bErrorStatus = CopyWithReplacements(pInfo->m_InFilename, replacements, ARRAYSIZE(replacements), "%s",
											pInfo->m_OutFilename);
...
bool CModWizardSubPanel_CopyFiles_Source2007::HandleReplacements_GameProjectFiles(CFileCopyInfo *pInfo,
																				  bool &bErrorStatus)
{
	// Speed up the copy process a bit, if it's not a vcproj, get out.
	if(!IsVCProjFile(pInfo->m_InFilename))
...
bool CModWizardSubPanel_CopyFiles_Source2006::HandleReplacements_GameProjectFiles(CFileCopyInfo *pInfo,
																				  bool &bErrorStatus)
{
	// Speed up the copy process a bit, if it's not a vcproj, get out.
	if(!IsVCProjFile(pInfo->m_InFilename))
	...
	char replaceWith[MAX_PATH] = {0};
	const char *replacements[] = {"..\\..\\game\\sdksample\\", replaceWith, "..\\..\\game\\hl2\\", replaceWith,
								  "..\\..\\game\\hl2mp\\",	   replaceWith, "..\\game\\bin",	   "..\\bin"};
...
bool CModWizardSubPanel_CopyFiles::HandleReplacements_GenericVCProj(CFileCopyInfo *pInfo, bool &bErrorStatus)
{
	if(IsVCProjFile(pInfo->m_InFilename))
	{
		...
		bErrorStatus = CopyWithReplacements(pInfo->m_InFilename, vcprojReplacements, ARRAYSIZE(vcprojReplacements),
											"%s", pInfo->m_OutFilename);
		return true;
	}
...
bool CModWizardSubPanel_CopyFiles_Source2009::HandleReplacements_TemplateOptions(CFileCopyInfo *pInfo,
																				 bool &bErrorStatus)
{
	...
	if(Q_stricmp(pInfo->m_InFilename, "src_mod\\source2009\\game\\shared\\sdk\\sdk_shareddefs.h") == 0)
	{
		...
		CModWizardSubPanel_TemplateOptions *pTemplate = dynamic_cast<CModWizardSubPanel_TemplateOptions *>(
			GetWizardPanel()->FindChildByName("CModWizardSubPanel_TemplateOptions"));
		if(!pTemplate)
			return false;

		const char *replacements[] = {"%TemplateOptionTeams%",
									  pTemplate->GetOption(TPOPTION_TEAMS),
									  "%TemplateOptionClasses%",
									  pTemplate->GetOption(TPOPTION_CLASSES),
									  "%TemplateOptionStamina%",
									  pTemplate->GetOption(TPOPTION_STAMINA),
									  "%TemplateOptionSprinting%",
									  pTemplate->GetOption(TPOPTION_SPRINTING),
									  "%TemplateOptionProne%",
									  pTemplate->GetOption(TPOPTION_PRONE),
									  "%TemplateOptionShootWhileSprinting%",
									  pTemplate->GetOption(TPOPTION_SHOOTSPRINTING),
									  "%TemplateOptionShootOnLadders%",
									  pTemplate->GetOption(TPOPTION_SHOOTLADDERS),
									  "%TemplateOptionShootWhileJumping%",
									  pTemplate->GetOption(TPOPTION_SHOOTJUMPING)};
...
bool CModWizardSubPanel_CopyFiles_Source2007::HandleReplacements_TemplateOptions(CFileCopyInfo *pInfo,
																				 bool &bErrorStatus)
{
	// Copy over the sdk_shareddefs.h with replacements for the defines.
...
CModWizardSubPanel_CopyFiles_Source2006::CModWizardSubPanel_CopyFiles_Source2006(Panel *parent, const char *panelName)
	: CModWizardSubPanel_CopyFiles(parent, panelName)
{
}

CModWizardSubPanel_CopyFiles_Source2007::CModWizardSubPanel_CopyFiles_Source2007(Panel *parent, const char *panelName)
	: CModWizardSubPanel_CopyFiles(parent, panelName)
{
}

CModWizardSubPanel_CopyFiles_Source2009::CModWizardSubPanel_CopyFiles_Source2009(Panel *parent, const char *panelName)
	: CModWizardSubPanel_CopyFiles(parent, panelName)
{
}