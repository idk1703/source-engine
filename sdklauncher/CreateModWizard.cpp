...
void SetModWizardStatusCode(unsigned long inputCode)
{
	...
	if(RegCreateKeyEx(HKEY_CURRENT_USER, "Software\\Valve\\SourceSDK", 0, 0, 0, KEY_ALL_ACCESS, NULL, &hKey, NULL) ==
	   ERROR_SUCCESS)
	{
...
public:
	...
	CFinalStatusWindow(vgui::Panel *parent, const char *pName, const char *pOutputDirName,
...
CCreateModWizard::CCreateModWizard(vgui::Panel *parent, const char *name, KeyValues *pKeyValues,
								   bool bRunFromCommandLine)
