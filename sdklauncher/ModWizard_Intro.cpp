...
CModWizardSubPanel_Intro::CModWizardSubPanel_Intro(Panel *parent, const char *panelName) : BaseClass(parent, panelName)
{
...
bool CModWizardSubPanel_Intro::OnNextButton()
{
	...
	CModWizardSubPanel_GetModInfo *pNextPanel = dynamic_cast<CModWizardSubPanel_GetModInfo *>(
		GetWizardPanel()->FindChildByName("CModWizardSubPanel_GetModInfo"));
	if(pNextPanel)
	{
