...
template<class T>
void RunSingleSetAttributeUndoTest(CDmElement *pTest, CDmElement *pOriginal, CDmElement *pElement,
								   const char *attribute, const T &newVal)
{
	{
...
void RunSingleSetAttributeUndoTestBinary(CDmElement *pTest, CDmElement *pOriginal, CDmElement *pElement,
										 const char *attribute, const void *data, size_t size)
{
	{
		CUndoScopeGuard guard(attribute, attribute);
...
template<class T>
void RunSingleSetAttributeUndoTestArray(CDmElement *pTest, CDmElement *pOriginal, CDmElement *pElement,
										const char *attribute, int slot, const T &newVal)
{
	{
		CUndoScopeGuard guard(attribute, attribute);
...
template<>
void RunSingleSetAttributeUndoTestArray<DmElementHandle_t>(CDmElement *pTest, CDmElement *pOriginal,
														   CDmElement *pElement, const char *attribute, int slot,
														   const DmElementHandle_t &newVal)
{
	{
		CUndoScopeGuard guard(attribute, attribute);
...
template<class T>
void RunSingleAttributeUndoTestArrayAddToHead(CDmElement *pTest, CDmElement *pOriginal, CDmElement *pElement,
											  const char *attribute, const T &newVal)
{
	{
		CUndoScopeGuard guard(attribute, attribute);
...
template<class T>
void RunSingleAttributeUndoTestArrayAddToTail(CDmElement *pTest, CDmElement *pOriginal, CDmElement *pElement,
											  const char *attribute, const T &newVal)
{
	{
		CUndoScopeGuard guard(attribute, attribute);
...
template<class T>
void RunSingleAttributeUndoTestArrayInsertBefore(CDmElement *pTest, CDmElement *pOriginal, CDmElement *pElement,
												 const char *attribute, int slot, const T &newVal)
{
	{
		CUndoScopeGuard guard(attribute, attribute);
...
template<class T>
void RunSingleAttributeUndoTestArrayFastRemove(CDmElement *pTest, CDmElement *pOriginal, CDmElement *pElement,
											   const char *attribute, int slot, T typeDeducer)
{
	{
		CUndoScopeGuard guard(attribute, attribute);
		CDmrArray<T> array(pElement, attribute);
...
void RunSingleAttributeUndoTestElementArrayRemove(CDmElement *pTest, CDmElement *pOriginal, CDmElement *pElement,
												  const char *attribute, int slot)
{
	{
		CUndoScopeGuard guard(attribute, attribute);
		CDmrElementArray<> array(pElement, attribute);
...
template<class T>
void RunSingleAttributeUndoTestArrayRemove(CDmElement *pTest, CDmElement *pOriginal, CDmElement *pElement,
										   const char *attribute, int slot, T typeDeducer)
{
	{
		CUndoScopeGuard guard(attribute, attribute);
...
template<class T>
void RunSingleAttributeUndoTestArrayRemoveMultiple(CDmElement *pTest, CDmElement *pOriginal, CDmElement *pElement,
												   const char *attribute, int slot, int count, T typeDeducer)
{
	{
		CUndoScopeGuard guard(attribute, attribute);
		CDmrArray<T> array(pElement, attribute);
...
template<class T>
void RunSingleAttributeUndoTestArrayRemoveAll(CDmElement *pTest, CDmElement *pOriginal, CDmElement *pElement,
											  const char *attribute, bool purge)
{
	{
		CUndoScopeGuard guard(attribute, attribute);
		CDmrArray<T> array(pElement, attribute);
...
template<class T>
void RunSingleAttributeUndoTestArrayCopyFrom(CDmElement *pTest, CDmElement *pOriginal, CDmElement *pElement,
											 const char *attribute, const CUtlVector<T> &list)
{
	{
		CUndoScopeGuard guard(attribute, attribute);
		CDmrArray<T> array(pElement, attribute);
...
void RunSingleSetAttributeUndoTestArrayBinary(CDmElement *pTest, CDmElement *pOriginal, CDmElement *pElement,
											  const char *attribute, int slot, const void *data, size_t size)
{
	{
		CUndoScopeGuard guard(attribute, attribute);
...
template<class T>
void RunSingleSetAttributeUndoTestArrayWhole(CDmElement *pTest, CDmElement *pOriginal, CDmElement *pElement,
											 const char *attribute, CUtlVector<T> &newVal)
{
	{
		CUndoScopeGuard guard(attribute, attribute);
...
template<class T>
void RunSingleAddAttributeUndoTest(CDmElement *pTest, CDmElement *pOriginal, CDmElement *pElement,
								   const char *attribute, const T &newVal)
{
	{
		CUndoScopeGuard guard(attribute, attribute);
...
void RunSingleRemoveAttributeUndoTest(CDmElement *pTest, CDmElement *pOriginal, CDmElement *pElement,
...
void RunUndoTestsArray(CUtlVector<DmElementHandle_t> &handles, CDmElement *pTest, CDmElement *pOriginal)
{
	...
	RunSingleSetAttributeUndoTestArray(pTest, pOriginal, pElement3, "vector3d_array_test", 0,
									   Vector(55.0f, -55.0f, 55.0f));

	RunSingleSetAttributeUndoTestArray(pTest, pOriginal, pElement4, "vector4d_array_test", 0,
									   Vector4D(55.0f, -55.0f, 55.0f, 55.0f));
	RunSingleSetAttributeUndoTestArray(pTest, pOriginal, pElement4, "qangle_array_test", 0,
									   QAngle(55.0f, 55.0f, -55.0f));
	RunSingleSetAttributeUndoTestArray(pTest, pOriginal, pElement4, "quat_array_test", 0,
									   Quaternion(1.0f, -1.0f, 0.0f, 55.0f));
...

	{
		...
		RunSingleSetAttributeUndoTestArray(pTest, pOriginal, pElement3, "color_array_test", 0, Color(55, 55, 55, 55));
		RunSingleSetAttributeUndoTestArray(pTest, pOriginal, pElement3, "vector2d_array_test", 0,
										   Vector2D(55.0f, -55.0f));
		RunSingleSetAttributeUndoTestArray(pTest, pOriginal, pElement3, "vector3d_array_test", 0,
										   Vector(55.0f, -55.0f, 55.0f));
		...
		//		RunSingleSetAttributeUndoTestArray( pTest, pOriginal, pElement6, "elementid_array_test", 0, id );
		RunSingleSetAttributeUndoTestArray(pTest, pOriginal, pElement6, "element_array_test", 0,
										   pElement2->GetHandle());

		RunSingleSetAttributeUndoTestArray(pTest, pOriginal, pElement7, "element_array_test", 0,
										   pElement5->GetHandle());
	}
...
DEFINE_TESTCASE_NOSUITE(DmxReferenceCountingTest)
{
	...
	CDmeHandle<CDmElement> hGrandChild1, hGrandChild2, hGrandChild3, hGrandChild4, hGrandChild5, hGrandChild6,
		hGrandChild7;
