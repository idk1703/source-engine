...
void CImportSFMV9::FixupElement(CDmElement *pElement)
{
	...
	if(!V_stricmp(pType, "DmeLight") || !V_stricmp(pType, "DmeDirectionalLight") ||
	   !V_stricmp(pType, "DmeProjectedLight") || !V_stricmp(pType, "DmePointLight") ||
	   !V_stricmp(pType, "DmeSpotLight") || !V_stricmp(pType, "DmeAmbientLight"))
	{
