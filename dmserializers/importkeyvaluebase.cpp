...
void CImportKeyValueBase::PrintStringAttribute(CDmElement *pElement, CUtlBuffer &outBuf, const char *pKeyName,
											   bool bSkipEmptryStrings, bool bPrintValueOnly)
{
	if(pElement->HasAttribute(pKeyName))
	{
		CDmAttribute *pAttribute = pElement->GetAttribute(pKeyName);
...
//-----------------------------------------------------------------------------
bool CImportKeyValueBase::AddBoolAttribute(CDmElement *pElement, KeyValues *pKeyValues, const char *pKeyName,
										   bool *pDefault)
{
...
// Used to add typed attributes from keyvalues
//-----------------------------------------------------------------------------
bool CImportKeyValueBase::AddIntAttribute(CDmElement *pElement, KeyValues *pKeyValues, const char *pKeyName,
										  int *pDefault)
{
	KeyValues *pKey = pKeyValues->FindKey(pKeyName);
	int nValue;
...
bool CImportKeyValueBase::AddFloatAttribute(CDmElement *pElement, KeyValues *pKeyValues, const char *pKeyName,
											float *pDefault)
{
	KeyValues *pKey = pKeyValues->FindKey(pKeyName);
	float flValue;
...
bool CImportKeyValueBase::AddStringAttribute(CDmElement *pElement, KeyValues *pKeyValues, const char *pKeyName,
											 const char *pDefault)
{
	KeyValues *pKey = pKeyValues->FindKey(pKeyName);
	const char *pValue = "";
...
// Used to add typed attributes from keyvalues
//-----------------------------------------------------------------------------
bool CImportKeyValueBase::AddBoolAttributeFlags(CDmElement *pElement, KeyValues *pKeyValue, const char *pKeyName,
...
bool CImportKeyValueBase::AddIntAttributeFlags(CDmElement *pElement, KeyValues *pKeyValue, const char *pKeyName,
											   int nFlags, int *pDefault)
{
...
bool CImportKeyValueBase::AddFloatAttributeFlags(CDmElement *pElement, KeyValues *pKeyValue, const char *pKeyName,
...
bool CImportKeyValueBase::AddStringAttributeFlags(CDmElement *pElement, KeyValues *pKeyValue, const char *pKeyName,
												  int nFlags, const char *pDefault)
{
