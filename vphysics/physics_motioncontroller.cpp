...
BEGIN_SIMPLE_DATADESC(vphysics_save_motioncontroller_t)
	DEFINE_VPHYSPTR_UTLVECTOR(m_objectList), DEFINE_FIELD(m_nPriority, FIELD_INTEGER),
END_DATADESC()
...
{
	CPhysicsMotionController *pControllerImp =
		new CPhysicsMotionController(NULL, static_cast<CPhysicsEnvironment *>(params.pEnvironment));
