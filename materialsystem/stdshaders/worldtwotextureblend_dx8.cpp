...
BEGIN_VS_SHADER(WorldTwoTextureBlend_DX8, "Help for WorldTwoTextureBlend_DX8")
	...
	SHADER_DRAW
	{
		...
		if(hasFlashlight)
		{
			DrawFlashlight_dx80(params, pShaderAPI, pShaderShadow, false, -1, -1, -1, FLASHLIGHTTEXTURE,
