...
BEGIN_SHADER(VertexLitGeneric_DX7, "Help for VertexLitGeneric_DX7")
	...
	void DrawBaseTimesVertexColor(IMaterialVar * *params, IShaderDynamicAPI * pShaderAPI, IShaderShadow * pShaderShadow)
	{
		SHADOW_STATE
		{
			...
			pShaderShadow->CustomTextureOperation(SHADER_TEXTURE_STAGE0, SHADER_TEXCHANNEL_COLOR,
												  SHADER_TEXOP_MODULATE2X, SHADER_TEXARG_TEXTURE,
			...
			else
			{
				...
				{
					pShaderShadow->CustomTextureOperation(SHADER_TEXTURE_STAGE0, SHADER_TEXCHANNEL_ALPHA,
														  SHADER_TEXOP_SELECTARG1, SHADER_TEXARG_ONE,
														  SHADER_TEXARG_NONE);
				}
			}
			...
			if(IsAlphaModulating() || IsColorModulating())
			{
				...
				{
					pShaderShadow->CustomTextureOperation(SHADER_TEXTURE_STAGE1, SHADER_TEXCHANNEL_COLOR,
														  SHADER_TEXOP_MODULATE, SHADER_TEXARG_PREVIOUSSTAGE,
														  SHADER_TEXARG_CONSTANTCOLOR);
				}
				else
				{
					pShaderShadow->CustomTextureOperation(SHADER_TEXTURE_STAGE1, SHADER_TEXCHANNEL_COLOR,
														  SHADER_TEXOP_SELECTARG1, SHADER_TEXARG_PREVIOUSSTAGE,
														  SHADER_TEXARG_NONE);
				}
				...
				{
					pShaderShadow->CustomTextureOperation(SHADER_TEXTURE_STAGE1, SHADER_TEXCHANNEL_ALPHA,
														  SHADER_TEXOP_MODULATE, SHADER_TEXARG_PREVIOUSSTAGE,
														  SHADER_TEXARG_CONSTANTCOLOR);
				}
				else
	...
	void DrawVertexColorNoBase(IMaterialVar * *params, IShaderDynamicAPI * pShaderAPI, IShaderShadow * pShaderShadow)
	{
		SHADOW_STATE
		{
			...
			pShaderShadow->CustomTextureOperation(SHADER_TEXTURE_STAGE0, SHADER_TEXCHANNEL_COLOR,
												  SHADER_TEXOP_MODULATE2X, SHADER_TEXARG_ONE,
												  SHADER_TEXARG_VERTEXCOLOR);
	...
	void DrawBaseTimesBakedVertexLighting(IMaterialVar * *params, IShaderDynamicAPI * pShaderAPI,
										  IShaderShadow * pShaderShadow)
	{
		SHADOW_STATE
		{
			...
			pShaderShadow->CustomTextureOperation(SHADER_TEXTURE_STAGE0, SHADER_TEXCHANNEL_COLOR,
												  SHADER_TEXOP_MODULATE2X, SHADER_TEXARG_SPECULARCOLOR,
	...
	void DrawBakedVertexLightingNoBase(IMaterialVar * *params, IShaderDynamicAPI * pShaderAPI,
									   IShaderShadow * pShaderShadow)
	{
		SHADOW_STATE
		{
