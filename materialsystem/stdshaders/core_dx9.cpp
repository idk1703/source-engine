...
BEGIN_VS_SHADER(Core_DX90, "Help for Core")
	...
	inline void DrawPass(IMaterialVar * *params, IShaderShadow * pShaderShadow, IShaderDynamicAPI * pShaderAPI,
						 int nPass, VertexCompressionType_t vertexCompression)
	{
		...
		DYNAMIC_STATE
		{
			...
			float c5[4] = {params[REFRACTAMOUNT]->GetFloatValue(), params[REFRACTAMOUNT]->GetFloatValue(), 0.0f, 0.0f};
