...
#define SHADER_USE_CONSTANT_COLOR 2
	...
	void SetSpriteCommonShadowState(unsigned int shaderFlags)
	{
		...
		// Only enabling this on OSX() - it causes GL mode's light glow sprites to be much darker vs. D3D9 under
		// Linux/Win GL.
		...
		if(g_pHardwareConfig->SupportsPixelShaders_2_b() ||
		   g_pHardwareConfig->ShouldAlwaysUseShaderModel2bShaders()) // Always send GL down this path
		{
