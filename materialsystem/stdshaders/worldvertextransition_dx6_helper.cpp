...
static void DrawFlashlightPass(CBaseShader *pShader, IMaterialVar **params, IShaderDynamicAPI *pShaderAPI,
							   IShaderShadow *pShaderShadow, int nPass, WorldVertexTransition_DX6_Vars_t &info)
{
	SHADOW_STATE
	{
		...
		pShaderShadow->CustomTextureOperation(SHADER_TEXTURE_STAGE0, SHADER_TEXCHANNEL_ALPHA, SHADER_TEXOP_MODULATE,
...
void DrawWorldVertexTransition_DX6(CBaseShader *pShader, IMaterialVar **params, IShaderDynamicAPI *pShaderAPI,
								   IShaderShadow *pShaderShadow, WorldVertexTransition_DX6_Vars_t &info)
{
	...
	SHADOW_STATE
	{
		...
		pShaderShadow->DrawFlags(SHADER_DRAW_COLOR | SHADER_DRAW_POSITION | SHADER_DRAW_TEXCOORD1 |
	...
	SHADOW_STATE
	{
		...
		pShaderShadow->CustomTextureOperation(SHADER_TEXTURE_STAGE0, SHADER_TEXCHANNEL_COLOR, SHADER_TEXOP_SELECTARG1,
											  SHADER_TEXARG_TEXTURE, SHADER_TEXARG_TEXTURE);
		...
		pShaderShadow->CustomTextureOperation(SHADER_TEXTURE_STAGE1, SHADER_TEXCHANNEL_COLOR, SHADER_TEXOP_MODULATE2X,
