...
static void SetDepthFlashlightParams(CBaseVSShader *pShader, IShaderDynamicAPI *pShaderAPI,
									 const VMatrix &worldToTexture, const FlashlightState_t &flashlightState)
{
								  ...
								  Eyes_DX8_DX9_Vars_t &info, VertexCompressionType_t vertexCompression)
{
	...
	DYNAMIC_STATE
	{
		...
		if(bDX9)
		{
			...
			{
				pShader->SetHWMorphVertexShaderState(VERTEX_SHADER_SHADER_SPECIFIC_CONST_7,
...
static void DrawEyes_DX8_DX9_Internal(bool bDX9, CBaseVSShader *pShader, IMaterialVar **params,
									  IShaderDynamicAPI *pShaderAPI, IShaderShadow *pShaderShadow, bool bHasFlashlight,
									  Eyes_DX8_DX9_Vars_t &info, VertexCompressionType_t vertexCompression)
{
	if(!bHasFlashlight)
	{
					  ...
					  VertexCompressionType_t vertexCompression)
{
	...
	DrawEyes_DX8_DX9_Internal(bDX9, pShader, params, pShaderAPI, pShaderShadow, bHasFlashlight, info,
							  vertexCompression);
}