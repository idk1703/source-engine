...
BEGIN_SHADER(WorldTwoTextureBlend_DX6, "Help for WorldTwoTextureBlend")
	...
	BEGIN_SHADER_PARAMS
		SHADER_PARAM_OVERRIDE(BASETEXTURE, SHADER_PARAM_TYPE_TEXTURE, "shadertest/WorldTwoTextureBlend", "iris texture",
							  0)
	...
	void NormalModePass1(IShaderShadow * pShaderShadow, IShaderDynamicAPI * pShaderAPI)
	{
		SHADOW_STATE
		{
	...
	void NormalModePass2(IShaderShadow * pShaderShadow, IShaderDynamicAPI * pShaderAPI, IMaterialVar * *params,
						 float detailScale)
	{
		SHADOW_STATE
		{
	...
	void NormalModePass3(IShaderShadow * pShaderShadow, IShaderDynamicAPI * pShaderAPI, IMaterialVar * *params,
						 float detailScale)
	{
		SHADOW_STATE
		{
	...
	void DetailAlphaMaskPass1(IShaderShadow * pShaderShadow, IShaderDynamicAPI * pShaderAPI, IMaterialVar * *params,
							  float detailScale)
	{
	...
	void DetailAlphaMaskPass2(IShaderShadow * pShaderShadow, IShaderDynamicAPI * pShaderAPI, float detailScale)
	{
		SHADOW_STATE
		{
			...
			// Make sure the texgen transform is applied to the texture coordinates and not to an auto-generated
			// reflection vector or whatever.
