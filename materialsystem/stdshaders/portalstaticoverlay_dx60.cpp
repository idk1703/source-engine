...
BEGIN_VS_SHADER(PortalStaticOverlay_DX60, "Help for PortalStaticOverlay_DX60 shader")
	...
	SHADER_DRAW
	{
		SHADOW_STATE
		{
			...
			// pShaderShadow->EnablePolyOffset( SHADER_POLYOFFSET_DECAL ); //a portal is effectively a decal on top of a
			// wall
