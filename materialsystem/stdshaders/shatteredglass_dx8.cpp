...
BEGIN_VS_SHADER(ShatteredGlass_DX8, "Help for ShatteredGlass_DX8")
	...
	BEGIN_SHADER_PARAMS
		...
		SHADER_PARAM(DETAILTRANSFORM, SHADER_PARAM_TYPE_MATRIX, "center .5 .5 scale 1 1 rotate 0 translate 0 0",
					 "detail scale")
	...
	SHADER_DRAW
	{
		...
		DYNAMIC_STATE
		{
			...
			flUnlitFactor[0] = flUnlitFactor[1] = flUnlitFactor[2] = flUnlitFactor[3] =
				params[UNLITFACTOR]->GetFloatValue();
