...
abstract_class IMatRenderContextInternal : public IMatRenderContext
{
	...
	void *QueryInterface(const char *pszInterface)
	{
		return NULL;
	}
	InitReturnVal_t Init(void)
	{
		return INIT_OK;
	}
	void Shutdown(void) {}
...
public:
	...
	virtual void AsyncCopyRenderTargetToStagingTexture(
		ITexture * pDst, ITexture * pSrc, IAsyncTextureOperationReceiver * pRecipient, void *pExtraArgs) = 0;
