...
protected:
	...
	void ReacquireResourcesInternal(bool bResetState = false, bool bForceReacquire = false,
...
#ifdef _X360
	CON_COMMAND_MEMBER_F(CShaderDeviceDx8, "360vidinfo", SpewVideoInfo360,
						 "Get information on the video mode on the 360", 0);
#endif
