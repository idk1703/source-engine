...
public:
	...
	ShadowState_t &BoardState()
	{
		return m_BoardState;
	}
	ShadowShaderState_t &BoardShaderState()
	{
		return m_BoardShaderState;
	}
#endif
...
private:
	...
	unsigned int FindIdenticalTransitionList(unsigned int firstElem, unsigned short numOps,
