...
#pragma warning( \
	disable : 4805) // VS 2013 warning: warning C4805: '==' : unsafe mix of type 'INT' and type 'bool' in operation
...
uint64 GetVidMemBytes(void)
{
	...
	while(pEnumerator)
	{
		...
		{
			nBytes =
				vtProp.ulVal; // Video RAM in bytes, AdatperRam is returned as the I4 type so we read it out as unsigned
							  // int, see http://msdn.microsoft.com/en-us/library/windows/desktop/aa394512(v=vs.85).aspx
		}
