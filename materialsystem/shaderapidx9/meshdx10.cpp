...
//-----------------------------------------------------------------------------
CVertexBufferDx10::CVertexBufferDx10(ShaderBufferType_t type, VertexFormat_t fmt, int nVertexCount,
...
// constructor, destructor
//-----------------------------------------------------------------------------
CIndexBufferDx10::CIndexBufferDx10(ShaderBufferType_t type, MaterialIndexFormat_t fmt, int nIndexCount,
								   const char *pBudgetGroupName)
	: BaseClass(pBudgetGroupName)
{
...
void CMeshDx10::ModifyBeginEx(bool bReadOnly, int firstVertex, int numVerts, int firstIndex, int numIndices,
							  MeshDesc_t &desc)
{
	// Who cares about the data?
	desc.m_pPosition = (float *)m_pVertexMemory;
...
void CMeshDx10::CopyToMeshBuilder(int iStartVert, // Which vertices to copy.
								  int nVerts,
