...
public:
	...
	virtual bool UseFastZReject() const
	{
		return false;
	}
	...
	virtual bool SupportsHDRMode(HDRType_t nMode) const
	{
		return 0;
	}
...
public:
	...
	virtual CreateInterfaceFn Init(char const *pShaderDLL, IMaterialProxyFactory *pMaterialProxyFactory,
	...
	{
		if(m_pRealMaterialSystem)
			return m_pRealMaterialSystem->FindMaterialEx(pMaterialName, pTextureGroupName, nContext, complain,
														 pComplainPrefix);
		return &g_DummyMaterial;
	}
	...
	*/
	...
	virtual IMesh *GetDynamicMesh(bool bBuffered = true, IMesh *pVertexOverride = 0, IMesh *pIndexOverride = 0,
	...
	virtual ICallQueue *GetCallQueue()
	{
		return NULL;
	}
	...
	virtual bool SupportsBorderColor()
	{
		return false;
	}

	virtual IMaterial *GetCurrentMaterial()
	{
		return NULL;
	}
	...
	virtual ITextureCompositor *NewTextureCompositor(int w, int h, const char *pCompositeName, int nTeamNum,
													 ...
													 uint texCompositeCreateFlags) OVERRIDE
	{
		return NULL;
	}
	...
	virtual bool AddTextureCompositorTemplate(const char *pName, KeyValues *pTmplDesc,
											  int nTexCompositeTemplateFlags) OVERRIDE
	{
		return false;
	}
...
EXPOSE_SINGLE_INTERFACE_GLOBALVAR(CDummyMaterialSystem, IMaterialSystemStub, MATERIAL_SYSTEM_STUB_INTERFACE_VERSION,
