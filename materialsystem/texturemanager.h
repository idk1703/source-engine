...
public:
	...
	// Some render targets are managed by code outside of the materialsystem but are used by the materialsystem all the
	// time.
	...
	virtual ITextureInternal *FindOrLoadTexture(const char *pTextureName, const char *pTextureGroupName,
