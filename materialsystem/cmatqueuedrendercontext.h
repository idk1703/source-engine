...
#define DEFINE_QUEUED_CALL_0(FuncName, ClassName, pObject)                                                           \
	void FuncName()                                                                                                  \
	{                                                                                                                \
		(*(const_cast<CMatCallQueue *>(&m_queue))).QueueCall(pObject, (void(ClassName::*)()) & ClassName::FuncName); \
	}
#define DEFINE_QUEUED_CALL_1(FuncName, ArgType1, ClassName, pObject)                       \
	void FuncName(ArgType1 a1)                                                             \
	{                                                                                      \
		(*(const_cast<CMatCallQueue *>(&m_queue)))                                         \
			.QueueCall(pObject, (void(ClassName::*)(ArgType1)) & ClassName::FuncName, a1); \
	}
#define DEFINE_QUEUED_CALL_2(FuncName, ArgType1, ArgType2, ClassName, pObject)                           \
	void FuncName(ArgType1 a1, ArgType2 a2)                                                              \
	{                                                                                                    \
		(*(const_cast<CMatCallQueue *>(&m_queue)))                                                       \
			.QueueCall(pObject, (void(ClassName::*)(ArgType1, ArgType2)) & ClassName::FuncName, a1, a2); \
	}
#define DEFINE_QUEUED_CALL_3(FuncName, ArgType1, ArgType2, ArgType3, ClassName, pObject)                               \
	void FuncName(ArgType1 a1, ArgType2 a2, ArgType3 a3)                                                               \
	{                                                                                                                  \
		(*(const_cast<CMatCallQueue *>(&m_queue)))                                                                     \
			.QueueCall(pObject, (void(ClassName::*)(ArgType1, ArgType2, ArgType3)) & ClassName::FuncName, a1, a2, a3); \
	}
#define DEFINE_QUEUED_CALL_4(FuncName, ArgType1, ArgType2, ArgType3, ArgType4, ClassName, pObject)                  \
	void FuncName(ArgType1 a1, ArgType2 a2, ArgType3 a3, ArgType4 a4)                                               \
	{                                                                                                               \
		(*(const_cast<CMatCallQueue *>(&m_queue)))                                                                  \
			.QueueCall(pObject, (void(ClassName::*)(ArgType1, ArgType2, ArgType3, ArgType4)) & ClassName::FuncName, \
					   a1, a2, a3, a4);                                                                             \
	}
#define DEFINE_QUEUED_CALL_5(FuncName, ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ClassName, pObject)         \
	void FuncName(ArgType1 a1, ArgType2 a2, ArgType3 a3, ArgType4 a4, ArgType5 a5)                                   \
	{                                                                                                                \
		(*(const_cast<CMatCallQueue *>(&m_queue)))                                                                   \
			.QueueCall(pObject,                                                                                      \
					   (void(ClassName::*)(ArgType1, ArgType2, ArgType3, ArgType4, ArgType5)) & ClassName::FuncName, \
					   a1, a2, a3, a4, a5);                                                                          \
	}
#define DEFINE_QUEUED_CALL_6(FuncName, ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ArgType6, ClassName, pObject) \
	void FuncName(ArgType1 a1, ArgType2 a2, ArgType3 a3, ArgType4 a4, ArgType5 a5, ArgType6 a6)                        \
	{                                                                                                                  \
		(*(const_cast<CMatCallQueue *>(&m_queue)))                                                                     \
			.QueueCall(pObject,                                                                                        \
					   (void(ClassName::*)(ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ArgType6)) &              \
						   ClassName::FuncName,                                                                        \
					   a1, a2, a3, a4, a5, a6);                                                                        \
	}
#define DEFINE_QUEUED_CALL_7(FuncName, ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ArgType6, ArgType7,        \
							 ClassName, pObject)                                                                    \
	void FuncName(ArgType1 a1, ArgType2 a2, ArgType3 a3, ArgType4 a4, ArgType5 a5, ArgType6 a6, ArgType7 a7)        \
	{                                                                                                               \
		(*(const_cast<CMatCallQueue *>(&m_queue)))                                                                  \
			.QueueCall(pObject,                                                                                     \
					   (void(ClassName::*)(ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ArgType6, ArgType7)) & \
						   ClassName::FuncName,                                                                     \
					   a1, a2, a3, a4, a5, a6, a7);                                                                 \
	}
#define DEFINE_QUEUED_CALL_8(FuncName, ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ArgType6, ArgType7, ArgType8, \
							 ClassName, pObject)                                                                       \
	void FuncName(ArgType1 a1, ArgType2 a2, ArgType3 a3, ArgType4 a4, ArgType5 a5, ArgType6 a6, ArgType7 a7,           \
				  ArgType8 a8)                                                                                         \
	{                                                                                                                  \
		(*(const_cast<CMatCallQueue *>(&m_queue)))                                                                     \
			.QueueCall(                                                                                                \
				pObject,                                                                                               \
				(void(ClassName::*)(ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ArgType6, ArgType7, ArgType8)) & \
					ClassName::FuncName,                                                                               \
				a1, a2, a3, a4, a5, a6, a7, a8);                                                                       \
	}
#define DEFINE_QUEUED_CALL_9(FuncName, ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ArgType6, ArgType7, ArgType8, \
							 ArgType9, ClassName, pObject)                                                             \
	void FuncName(ArgType1 a1, ArgType2 a2, ArgType3 a3, ArgType4 a4, ArgType5 a5, ArgType6 a6, ArgType7 a7,           \
				  ArgType8 a8, ArgType9 a9)                                                                            \
	{                                                                                                                  \
		(*(const_cast<CMatCallQueue *>(&m_queue)))                                                                     \
			.QueueCall(pObject,                                                                                        \
					   (void(ClassName::*)(ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ArgType6, ArgType7,       \
...
#define DEFINE_QUEUED_CALL_11(FuncName, ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ArgType6, ArgType7,    \
							  ArgType8, ArgType9, ArgType10, ArgType11, ClassName, pObject)                      \
	void FuncName(ArgType1 a1, ArgType2 a2, ArgType3 a3, ArgType4 a4, ArgType5 a5, ArgType6 a6, ArgType7 a7,     \
				  ArgType8 a8, ArgType9 a9, ArgType10 a10, ArgType11 a11)                                        \
	{                                                                                                            \
		(*(const_cast<CMatCallQueue *>(&m_queue)))                                                               \
			.QueueCall(pObject,                                                                                  \
					   (void(ClassName::*)(ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ArgType6, ArgType7, \
...
#define DEFINE_QUEUED_CALL_12(FuncName, ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ArgType6, ArgType7,    \
							  ArgType8, ArgType9, ArgType10, ArgType11, ArgType12, ClassName, pObject)           \
	void FuncName(ArgType1 a1, ArgType2 a2, ArgType3 a3, ArgType4 a4, ArgType5 a5, ArgType6 a6, ArgType7 a7,     \
				  ArgType8 a8, ArgType9 a9, ArgType10 a10, ArgType11 a11, ArgType12 a12)                         \
	{                                                                                                            \
		(*(const_cast<CMatCallQueue *>(&m_queue)))                                                               \
			.QueueCall(pObject,                                                                                  \
					   (void(ClassName::*)(ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ArgType6, ArgType7, \
...
#define DEFINE_QUEUED_CALL_1C(FuncName, ArgType1, ClassName, pObject)                         \
	...
	{                                                                                         \
		(*(const_cast<CMatCallQueue *>(&m_queue)))                                            \
			.QueueCall(pObject, (void(ClassName::*)(ArgType1) const)ClassName::FuncName, a1); \
	}
#define DEFINE_QUEUED_CALL_2C(FuncName, ArgType1, ArgType2, ClassName, pObject)                             \
	void FuncName(ArgType1 a1, ArgType2 a2) const                                                           \
	{                                                                                                       \
		(*(const_cast<CMatCallQueue *>(&m_queue)))                                                          \
			.QueueCall(pObject, (void(ClassName::*)(ArgType1, ArgType2) const)ClassName::FuncName, a1, a2); \
	}
#define DEFINE_QUEUED_CALL_3C(FuncName, ArgType1, ArgType2, ArgType3, ClassName, pObject)                            \
	void FuncName(ArgType1 a1, ArgType2 a2, ArgType3 a3) const                                                       \
	{                                                                                                                \
		(*(const_cast<CMatCallQueue *>(&m_queue)))                                                                   \
			.QueueCall(pObject, (void(ClassName::*)(ArgType1, ArgType2, ArgType3) const)ClassName::FuncName, a1, a2, \
					   a3);                                                                                          \
	}
#define DEFINE_QUEUED_CALL_4C(FuncName, ArgType1, ArgType2, ArgType3, ArgType4, ClassName, pObject)                    \
	void FuncName(ArgType1 a1, ArgType2 a2, ArgType3 a3, ArgType4 a4) const                                            \
	{                                                                                                                  \
		(*(const_cast<CMatCallQueue *>(&m_queue)))                                                                     \
			.QueueCall(pObject, (void(ClassName::*)(ArgType1, ArgType2, ArgType3, ArgType4) const)ClassName::FuncName, \
					   a1, a2, a3, a4);                                                                                \
	}
#define DEFINE_QUEUED_CALL_5C(FuncName, ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ClassName, pObject)        \
	void FuncName(ArgType1 a1, ArgType2 a2, ArgType3 a3, ArgType4 a4, ArgType5 a5) const                             \
	{                                                                                                                \
		(*(const_cast<CMatCallQueue *>(&m_queue)))                                                                   \
			.QueueCall(                                                                                              \
				pObject,                                                                                             \
				(void(ClassName::*)(ArgType1, ArgType2, ArgType3, ArgType4, ArgType5) const)ClassName::FuncName, a1, \
				a2, a3, a4, a5);                                                                                     \
	}
#define DEFINE_QUEUED_CALL_6C(FuncName, ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ArgType6, ClassName, \
							  pObject)                                                                         \
...
#define DEFINE_QUEUED_CALL_7C(FuncName, ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ArgType6, ArgType7,      \
							  ClassName, pObject)                                                                  \
...
#define DEFINE_QUEUED_CALL_8C(FuncName, ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ArgType6, ArgType7,    \
	...
	{                                                                                                            \
		(*(const_cast<CMatCallQueue *>(&m_queue)))                                                               \
			.QueueCall(pObject,                                                                                  \
					   (void(ClassName::*)(ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ArgType6, ArgType7, \
										   ArgType8) const)ClassName::FuncName,                                  \
					   a1, a2, a3, a4, a5, a6, a7, a8);                                                          \
	}
#define DEFINE_QUEUED_CALL_9C(FuncName, ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ArgType6, ArgType7,    \
							  ArgType8, ArgType9, ClassName, pObject)                                            \
	void FuncName(ArgType1 a1, ArgType2 a2, ArgType3 a3, ArgType4 a4, ArgType5 a5, ArgType6 a6, ArgType7 a7,     \
				  ArgType8 a8, ArgType9 a9) const                                                                \
	{                                                                                                            \
		(*(const_cast<CMatCallQueue *>(&m_queue)))                                                               \
			.QueueCall(pObject,                                                                                  \
					   (void(ClassName::*)(ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ArgType6, ArgType7, \
										   ArgType8, ArgType9) const)ClassName::FuncName,                        \
					   a1, a2, a3, a4, a5, a6, a7, a8, a9);                                                      \
	}
...
#define DEFINE_QUEUED_CALL_AFTER_BASE_1(FuncName, ArgType1, ClassName, pObject)            \
	void FuncName(ArgType1 a1)                                                             \
	{                                                                                      \
...
#define DEFINE_QUEUED_CALL_AFTER_BASE_2(FuncName, ArgType1, ArgType2, ClassName, pObject)                \
	void FuncName(ArgType1 a1, ArgType2 a2)                                                              \
	{                                                                                                    \
...
#define DEFINE_QUEUED_CALL_AFTER_BASE_3(FuncName, ArgType1, ArgType2, ArgType3, ClassName, pObject)                    \
	void FuncName(ArgType1 a1, ArgType2 a2, ArgType3 a3)                                                               \
	{                                                                                                                  \
...
#define DEFINE_QUEUED_CALL_AFTER_BASE_4(FuncName, ArgType1, ArgType2, ArgType3, ArgType4, ClassName, pObject)       \
	void FuncName(ArgType1 a1, ArgType2 a2, ArgType3 a3, ArgType4 a4)                                               \
	{                                                                                                               \
...
#define DEFINE_QUEUED_CALL_AFTER_BASE_5(FuncName, ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ClassName,       \
										pObject)                                                                     \
	void FuncName(ArgType1 a1, ArgType2 a2, ArgType3 a3, ArgType4 a4, ArgType5 a5)                                   \
	{                                                                                                                \
...
#define DEFINE_QUEUED_CALL_AFTER_BASE_6(FuncName, ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ArgType6, \
										ClassName, pObject)                                                   \
	void FuncName(ArgType1 a1, ArgType2 a2, ArgType3 a3, ArgType4 a4, ArgType5 a5, ArgType6 a6)               \
	{                                                                                                         \
...
#define DEFINE_QUEUED_CALL_AFTER_BASE_7(FuncName, ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ArgType6,       \
...
#define DEFINE_QUEUED_CALL_AFTER_BASE_8(FuncName, ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ArgType6,          \
...
#define DEFINE_QUEUED_CALL_AFTER_BASE_9(FuncName, ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ArgType6,    \
...
#define DEFINE_QUEUED_CALL_AFTER_BASE_1C(FuncName, ArgType1, ClassName, pObject)           \
	void FuncName(ArgType1 a1) const                                                       \
	{                                                                                      \
		BaseClass::FuncName(a1);                                                           \
		(*(const_cast<CMatCallQueue *>(&m_queue)))                                         \
...
#define DEFINE_QUEUED_CALL_AFTER_BASE_2C(FuncName, ArgType1, ArgType2, ClassName, pObject)               \
	void FuncName(ArgType1 a1, ArgType2 a2) const                                                        \
	{                                                                                                    \
		BaseClass::FuncName(a1, a2);                                                                     \
		(*(const_cast<CMatCallQueue *>(&m_queue)))                                                       \
...
#define DEFINE_QUEUED_CALL_AFTER_BASE_3C(FuncName, ArgType1, ArgType2, ArgType3, ClassName, pObject)                   \
	void FuncName(ArgType1 a1, ArgType2 a2, ArgType3 a3) const                                                         \
	{                                                                                                                  \
		BaseClass::FuncName(a1, a2, a3);                                                                               \
		(*(const_cast<CMatCallQueue *>(&m_queue)))                                                                     \
...
#define DEFINE_QUEUED_CALL_AFTER_BASE_4C(FuncName, ArgType1, ArgType2, ArgType3, ArgType4, ClassName, pObject)      \
	void FuncName(ArgType1 a1, ArgType2 a2, ArgType3 a3, ArgType4 a4) const                                         \
	{                                                                                                               \
		BaseClass::FuncName(a1, a2, a3, a4);                                                                        \
		(*(const_cast<CMatCallQueue *>(&m_queue)))                                                                  \
...
#define DEFINE_QUEUED_CALL_AFTER_BASE_5C(FuncName, ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ClassName,      \
										 pObject)                                                                    \
	void FuncName(ArgType1 a1, ArgType2 a2, ArgType3 a3, ArgType4 a4, ArgType5 a5) const                             \
	{                                                                                                                \
		BaseClass::FuncName(a1, a2, a3, a4, a5);                                                                     \
...
#define DEFINE_QUEUED_CALL_AFTER_BASE_6C(FuncName, ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ArgType6, \
										 ClassName, pObject)                                                   \
	void FuncName(ArgType1 a1, ArgType2 a2, ArgType3 a3, ArgType4 a4, ArgType5 a5, ArgType6 a6) const          \
	{                                                                                                          \
		BaseClass::FuncName(a1, a2, a3, a4, a5, a6);                                                           \
...
#define DEFINE_QUEUED_CALL_AFTER_BASE_7C(FuncName, ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ArgType6,      \
										 ArgType7, ClassName, pObject)                                              \
	void FuncName(ArgType1 a1, ArgType2 a2, ArgType3 a3, ArgType4 a4, ArgType5 a5, ArgType6 a6, ArgType7 a7) const  \
	{                                                                                                               \
		BaseClass::FuncName(a1, a2, a3, a4, a5, a6, a7);                                                            \
...
#define DEFINE_QUEUED_CALL_AFTER_BASE_8C(FuncName, ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ArgType6,         \
										 ArgType7, ArgType8, ClassName, pObject)                                       \
	void FuncName(ArgType1 a1, ArgType2 a2, ArgType3 a3, ArgType4 a4, ArgType5 a5, ArgType6 a6, ArgType7 a7,           \
				  ArgType8 a8) const                                                                                   \
	{                                                                                                                  \
...
#define DEFINE_QUEUED_CALL_AFTER_BASE_9C(FuncName, ArgType1, ArgType2, ArgType3, ArgType4, ArgType5, ArgType6,   \
										 ArgType7, ArgType8, ArgType9, ClassName, pObject)                       \
	void FuncName(ArgType1 a1, ArgType2 a2, ArgType3 a3, ArgType4 a4, ArgType5 a5, ArgType6 a6, ArgType7 a7,     \
				  ArgType8 a8, ArgType9 a9) const                                                                \
	{                                                                                                            \
...
public:
	...
	{
		return (m_pHardwareContext != NULL);
	}
	...
	CMatCallQueue *GetCallQueueInternal()
	{
		return &m_queue;
	}
	...
	DELEGATE_TO_OBJECT_3(IVertexBuffer *, CreateStaticVertexBuffer, VertexFormat_t, int, const char *,
						 m_pHardwareContext);
	DELEGATE_TO_OBJECT_3(IIndexBuffer *, CreateStaticIndexBuffer, MaterialIndexFormat_t, int, const char *,
						 m_pHardwareContext);
	...
	DELEGATE_TO_OBJECT_7V(BindVertexBuffer, int, IVertexBuffer *, int, int, int, VertexFormat_t, int,
						  m_pHardwareContext);
	...
	DEFINE_QUEUED_CALL_3(ClearColor3ub, unsigned char, unsigned char, unsigned char, IMatRenderContext,
						 m_pHardwareContext);
	DEFINE_QUEUED_CALL_4(ClearColor4ub, unsigned char, unsigned char, unsigned char, unsigned char, IMatRenderContext,
						 m_pHardwareContext);
	...
	DEFINE_QUEUED_CALL_1(DestroyOcclusionQueryObject, OcclusionQueryObjectHandle_t, IMatRenderContext,
						 m_pHardwareContext);
	DEFINE_QUEUED_CALL_1(BeginOcclusionQueryDrawing, OcclusionQueryObjectHandle_t, IMatRenderContext,
						 m_pHardwareContext);
	DEFINE_QUEUED_CALL_1(EndOcclusionQueryDrawing, OcclusionQueryObjectHandle_t, IMatRenderContext, m_pHardwareContext);
	DEFINE_QUEUED_CALL_1(ResetOcclusionQueryObject, OcclusionQueryObjectHandle_t, IMatRenderContext,
						 m_pHardwareContext);
	...
	void ReadPixelsAndStretch(Rect_t *pSrcRect, Rect_t *pDstRect, unsigned char *pBuffer, ImageFormat dstFormat,
							  int nDstStride);

	void GetWindowSize(int &width, int &height) const;

	void DrawScreenSpaceRectangle(IMaterial *pMaterial, int destx, int desty, int width, int height,
	...
	DEFINE_QUEUED_CALL_AFTER_BASE_5(PushRenderTargetAndViewport, ITexture *, int, int, int, int, IMatRenderContext,
									m_pHardwareContext);
	DEFINE_QUEUED_CALL_AFTER_BASE_6(PushRenderTargetAndViewport, ITexture *, ITexture *, int, int, int, int,
	...
	{
		m_queue.QueueCall(m_pHardwareContext, &IMatRenderContext::SetScissorRect, nLeft, nTop, nRight, nBottom,
						  bEnableScissor);
	}
	...
	virtual void AsyncCreateTextureFromRenderTarget(ITexture *pSrcRt, const char *pDstName, ImageFormat dstFmt,
													...
													void *pExtraArgs) OVERRIDE
	{
		OnAsyncCreateTextureFromRenderTarget(pSrcRt, &pDstName, pRecipient);

		m_queue.QueueCall(m_pHardwareContext, &IMatRenderContext::AsyncCreateTextureFromRenderTarget, pSrcRt, pDstName,
						  dstFmt, bGenMips, nAdditionalCreationFlags, pRecipient, pExtraArgs);
	}

	virtual void AsyncMap(ITextureInternal *pTexToMap, IAsyncTextureOperationReceiver *pRecipient,
						  void *pExtraArgs) OVERRIDE
	{
	...
	virtual void AsyncCopyRenderTargetToStagingTexture(ITexture *pDst, ITexture *pSrc,
													   IAsyncTextureOperationReceiver *pRecipient,
													   void *pExtraArgs) OVERRIDE
	{
		OnAsyncCopyRenderTargetToStagingTexture(pDst, pSrc, pRecipient);

		m_queue.QueueCall(m_pHardwareContext, &IMatRenderContextInternal::AsyncCopyRenderTargetToStagingTexture, pDst,
						  pSrc, pRecipient, pExtraArgs);
	}
	...
	{
		m_queue.QueueCall(m_pHardwareContext, &IMatRenderContext::BeginPIXEvent, color,
						  CUtlEnvelope<const char *>(pszName));
	}
	...
	{
		m_queue.QueueCall(m_pHardwareContext, &IMatRenderContext::SetPIXMarker, color,
						  CUtlEnvelope<const char *>(pszName));
	}
	...
	DEFINE_QUEUED_CALL_AFTER_BASE_1(SetCurrentMaterialInternal, IMaterialInternal *, IMatRenderContextInternal,
									m_pHardwareContext);
	...
	DEFINE_QUEUED_CALL_2(SetLookupWeight, ColorCorrectionHandle_t, float, IColorCorrectionSystem,
	...
	DEFINE_QUEUED_CALL_4(SetNonInteractivePacifierTexture, ITexture *, float, float, float, IMatRenderContext,
						 m_pHardwareContext);
	DEFINE_QUEUED_CALL_2(SetNonInteractiveTempFullscreenBuffer, ITexture *, MaterialNonInteractiveMode_t,
						 IMatRenderContext, m_pHardwareContext);
