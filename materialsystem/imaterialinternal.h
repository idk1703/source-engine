...
public:
	...
	static IMaterialInternal *CreateMaterial(char const *pMaterialName, const char *pTextureGroupName,
	...
	virtual bool PrecacheVars(KeyValues *pKeyValues = NULL, KeyValues *pPatchKeyValues = NULL,
							  ...
							  int nFindContext = MATERIAL_FINDCONTEXT_NONE) = 0;
	...
	// These are used when a new whitelist is passed in. First materials to be reloaded are flagged, then they are
	// reloaded.
...
extern bool LoadVMTFile(KeyValues &vmtKeyValues, KeyValues &patchKeyValues, const char *pMaterialName,
						bool bUsesUNCFilename, CUtlVector<FileNameHandle_t> *pIncludes);
