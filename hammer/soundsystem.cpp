...
//-----------------------------------------------------------------------------
void CSoundSystem::AddSoundToList(SoundType_t type, const char *pSoundName, const char *pActualFile,
...
bool CSoundSystem::BuildGameSoundList()
{
	...
	{
		if(!Q_stricmp(sub->GetName(), "precache_file") || !Q_stricmp(sub->GetName(), "declare_file") ||
