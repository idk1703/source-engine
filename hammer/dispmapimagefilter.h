...
private:
	...
	static ChunkFileResult_t LoadFilterKeyCallback(const char *szKey, const char *szValue,
...
private:
	...
	bool GetImageFieldValues(CDispMapImageFilter *pFilter, CMapDisp *pDisp, int ndxHgt, int ndxWid, int ndxImg,
							 int imgCount, Vector &vNormal, float &dist);
	...
	inline void GetImageFlatSubdivValue(CMapDisp *pDisp, CDispMapImageFilter *pFilter, int ndxDisp,
										Vector &vPaintValue);
	inline void GetImageFieldData(CMapDisp *pDisp, CDispMapImageFilter *pFilter, int ndxDisp, Vector &vNormal,
								  float &dist);
	...
	void MainImageValue(CDispMapImageFilter *pFilter, CMapDisp *pDisp, int ndxHgt, int ndxWid, bool bSet,
						Vector &value);
	...
	CMapDisp *GetImage(CDispMapImageFilter *pFilter, CMapDisp *pDisp, int ndxHgt, int ndxWid, int ndxImg, int imgCount,
					   int &orient);
	...
	//
	bool GetFilterVector(CDispMapImageFilter *pFilter, CMapDisp *pDisp, int ndxHgt, int ndxWid, int ndxImg,
						 int imgCount, int ndxFilter, Vector &vFilterDir);
