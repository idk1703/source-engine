...
{
public:
	CModelBrowserPanel(CModelBrowser *pBrowser, const char *panelName) : vgui::EditablePanel(NULL, panelName)
	{
		m_pBrowser = pBrowser;
	}
...
CModelBrowser::CModelBrowser(CWnd *pParent /*=NULL*/) : CDialog(CModelBrowser::IDD, pParent)
{
