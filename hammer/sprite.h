...
public:
	...
	inline void SetTextureExtent(Vector2D TexUL, Vector2D TexLR)
	{
		m_TexUL = TexUL;
		m_TexLR = TexLR;
	}
	inline void SetExtent(Vector2D UL, Vector2D LR)
	{
		m_UL = UL;
		m_LR = LR;
	}
...
protected:
	void GetSpriteAxes(QAngle &Angles, int type, Vector &forward, Vector &right, Vector &up, Vector &ViewUp,
