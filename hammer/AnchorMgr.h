...
public:
	...
	CAnchorDef(int dlgItemID, EAnchorHorz eLeftSide = k_eAnchorLeft, EAnchorVert eTopSide = k_eAnchorTop,
			   EAnchorHorz eRightSide = k_eAnchorRight, EAnchorVert eBottomSide = k_eAnchorBottom);
	CAnchorDef(HWND hWnd, EAnchorHorz eLeftSide = k_eAnchorLeft, EAnchorVert eTopSide = k_eAnchorTop,
			   EAnchorHorz eRightSide = k_eAnchorRight, EAnchorVert eBottomSide = k_eAnchorBottom);

	// Only one of hWnd or dlgItemID should be set.
	void Init(HWND hWnd, int dlgItemID, ESimpleAnchor eSimpleAnchor);
	void Init(HWND hWnd, int dlgItemID, EAnchorHorz eLeftSide, EAnchorVert eTopSide, EAnchorHorz eRightSide,
