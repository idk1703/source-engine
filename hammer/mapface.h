...
#define CREATE_FACE_PRESERVE_PLANE \
	0x0001 // Hack to prevent plane from being recalculated while building a solid from its planes.
...
public:
	...
	static void AddFaceToQueue(CMapFace *pMapFace, IEditorTexture *pTexture, EditorRenderMode_t renderMode,
	...
	bool TraceLineInside(Vector &HitPos, Vector &HitNormal, Vector const &Start, Vector const &End,
						 bool bNoDisp = false);
...
protected:
	...
	void AddFaceVertices(CMeshBuilder &builder, CRender3D *pRender, bool bRenderSelected,
	...
	static void RenderFacesBatch(CMeshBuilder &MeshBuilder, IMesh *pMesh, CRender3D *pRender, MapFaceRender_t **ppFaces,
	...
	void RenderFace3D(CRender3D *pRender, EditorRenderMode_t renderMode, bool renderSelected,
					  SelectionState_t faceSelectionState);
