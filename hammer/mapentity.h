...
public:
	...
	static inline void ShowEntityNames(bool bShow)
	{
		s_bShowEntityNames = bShow;
	}
	static inline bool GetShowEntityNames(void)
	{
		return s_bShowEntityNames;
	}

	static inline void ShowEntityConnections(bool bShow)
	{
		s_bShowEntityConnections = bShow;
	}
	static inline bool GetShowEntityConnections(void)
	{
		return s_bShowEntityConnections;
	}

	static inline void ShowUnconnectedEntities(bool bShow)
	{
		s_bShowUnconnectedEntities = bShow;
	}
	static inline bool GetShowUnconnectedEntities(void)
	{
		return s_bShowUnconnectedEntities;
	}
	...
	inline void SetClass(GDclass *pClass)
	{
		CEditGameClass::SetClass(pClass);
	} // Works around a namespace issue.
	...
	virtual void OnPaste(CMapClass *pCopyObject, CMapWorld *pSourceWorld, CMapWorld *pDestWorld,
						 const CMapObjectList &OriginalList, CMapObjectList &NewList);
	...
	virtual CMapEntity *FindChildByKeyValue(LPCSTR key, LPCSTR value, bool *bIsInInstance = NULL,
	...
	BOOL IsAnimationController(void)
	{
		return IsMoveClass();
	}
