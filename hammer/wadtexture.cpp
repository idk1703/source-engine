...
void CWADTexture::Draw(CDC *pDC, RECT &rect, int iFontHeight, int iIconHeight, DrawTexData_t &DrawTexData)
{
	...
	if(StretchDIBits(pDC->m_hDC, rect.left, rect.top, dest_width, dest_height, 0, 0, m_datawidth, m_dataheight, m_pData,
					 (BITMAPINFO *)&bmi, DIB_PAL_COLORS, SRCCOPY) == GDI_ERROR)
	{
