...
public:
	...
	CManifestMap *GetManifestMap(void)
	{
		return m_pManifestMap;
	}
...
public:
	...
	static ChunkFileResult_t LoadKeyPrefsCallback(const char *szKey, const char *szValue,
	...
	CManifestMap *GetPrimaryMap(void)
	{
	...
	CMapWorld *GetManifestWorld(void)
	{
		return m_ManifestWorld;
	}
