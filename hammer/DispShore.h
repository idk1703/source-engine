...
struct Shoreline_t
{
	...
	Shoreline_t();
	~Shoreline_t();
	void AddSegment(Vector &vecPoint0, Vector &vecPoint1, Vector &vecNormal, float flWaterZ, CMapFace *pWaterFace,
					EditDispHandle_t hDisp);
};
...
public:
	...
	virtual void BuildShoreline(int nShorelineId, CUtlVector<CMapFace *> &aFaces,
								CUtlVector<CMapFace *> &aWaterFaces) = 0;
