...
public:
	...
	static CUtlSymbolTable &GetSymbolTable()
	{
		return m_ErrorSymbolTable;
	}
...
public:
	...
	DmxElementDictHandle_t FirstElement()
	{
		return 0;
	}
...
void CDmxElementDictionary::HookUpElementArrayAttributes()
{
	...
	for(int i = 0; i < n; ++i)
	{
		...
		{
			// search id->handle table (both loaded and unloaded) for id, and if not found, create a new handle, map it
			// to the id and return it
...
private:
	...
	bool UnserializeElementAttribute(CUtlBuffer &buf, DmxElementDictHandle_t hElement, const char *pAttributeName,
	...
	bool UnserializeArrayAttribute(CUtlBuffer &buf, DmxElementDictHandle_t hElement, const char *pAttributeName,
								   DmAttributeType_t nAttrType);
	bool UnserializeAttribute(CUtlBuffer &buf, DmxElementDictHandle_t hElement, const char *pAttributeName,
							  DmAttributeType_t nAttrType);
	...
	bool SaveElement(CUtlBuffer &buf, CDmxSerializationDictionary &dict, CDmxElement *pElement,
...
//-----------------------------------------------------------------------------
void CDmxSerializerKeyValues2::SerializeElementAttribute(CUtlBuffer &buf, CDmxSerializationDictionary &dict,
...
//-----------------------------------------------------------------------------
void CDmxSerializerKeyValues2::SerializeElementArrayAttribute(CUtlBuffer &buf, CDmxSerializationDictionary &dict,
															  CDmxAttribute *pAttribute)
{
...
bool CDmxSerializerKeyValues2::SerializeAttributes(CUtlBuffer &buf, CDmxSerializationDictionary &dict,
...
bool CDmxSerializerKeyValues2::SaveElement(CUtlBuffer &buf, CDmxSerializationDictionary &dict, CDmxElement *pElement,
...
//-----------------------------------------------------------------------------
bool CDmxSerializerKeyValues2::UnserializeElementAttribute(CUtlBuffer &buf, DmxElementDictHandle_t hElement,
...
//-----------------------------------------------------------------------------
bool CDmxSerializerKeyValues2::UnserializeElementArrayAttribute(CUtlBuffer &buf, DmxElementDictHandle_t hElement,
...
//-----------------------------------------------------------------------------
bool CDmxSerializerKeyValues2::UnserializeAttributeValueFromToken(CDmxAttribute *pAttribute, DmAttributeType_t type,
																  CUtlBuffer &tokenBuf)
{
...
// Reads an attribute for an element array
//-----------------------------------------------------------------------------
bool CDmxSerializerKeyValues2::UnserializeArrayAttribute(CUtlBuffer &buf, DmxElementDictHandle_t hElement,
														 const char *pAttributeName, DmAttributeType_t nAttrType)
{
	CDmxElement *pElement = m_ElementDict.GetElement(hElement);
	if(pElement->HasAttribute(pAttributeName))
	{
		g_KeyValues2ErrorStack.ReportError("Encountered duplicate attribute definition for attribute \"%s\"!",
										   pAttributeName);
		return false;
	}
...
// Reads an attribute for an element
//-----------------------------------------------------------------------------
bool CDmxSerializerKeyValues2::UnserializeAttribute(CUtlBuffer &buf, DmxElementDictHandle_t hElement,
													const char *pAttributeName, DmAttributeType_t nAttrType)
{
...
//-----------------------------------------------------------------------------
bool CDmxSerializerKeyValues2::UnserializeElement(CUtlBuffer &buf, const char *pElementType,
