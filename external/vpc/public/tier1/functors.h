...
#define FUNC_VALIDATION_STRING_2 \
	V_snprintf(pString, nBufLen, "method( %s, %s )", typeid(ARG_TYPE_1).name(), typeid(ARG_TYPE_2).name());
...
#define FUNC_VALIDATION_STRING_3                                                                               \
	V_snprintf(pString, nBufLen, "method( %s, %s, %s )", typeid(ARG_TYPE_1).name(), typeid(ARG_TYPE_2).name(), \
			   typeid(ARG_TYPE_3).name());
#define FUNC_SEPARATOR_3 ,

#define FUNC_SOLO_TEMPLATE_ARG_PARAMS_4 \
	typename ARG_TYPE_1, typename ARG_TYPE_2, typename ARG_TYPE_3, typename ARG_TYPE_4
...
#define FUNC_ARG_FORMAL_PARAMS_4 \
	, const ARG_TYPE_1 &arg1, const ARG_TYPE_2 &arg2, const ARG_TYPE_3 &arg3, const ARG_TYPE_4 &arg4
...
#define FUNC_TEMPLATE_FUNC_PARAMS_4 \
	, typename FUNC_ARG_TYPE_1, typename FUNC_ARG_TYPE_2, typename FUNC_ARG_TYPE_3, typename FUNC_ARG_TYPE_4
...
#define FUNC_VALIDATION_STRING_4                                                                                   \
	V_snprintf(pString, nBufLen, "method( %s, %s, %s, %s )", typeid(ARG_TYPE_1).name(), typeid(ARG_TYPE_2).name(), \
			   typeid(ARG_TYPE_3).name(), typeid(ARG_TYPE_4).name());
#define FUNC_SEPARATOR_4 ,

#define FUNC_SOLO_TEMPLATE_ARG_PARAMS_5 \
	typename ARG_TYPE_1, typename ARG_TYPE_2, typename ARG_TYPE_3, typename ARG_TYPE_4, typename ARG_TYPE_5
...
#define FUNC_BASE_TEMPLATE_FUNC_PARAMS_5 \
	FUNC_ARG_TYPE_1, FUNC_ARG_TYPE_2, FUNC_ARG_TYPE_3, FUNC_ARG_TYPE_4, FUNC_ARG_TYPE_5
#define FUNC_VALIDATION_STRING_5                                                                                       \
	V_snprintf(pString, nBufLen, "method( %s, %s, %s, %s, %s )", typeid(ARG_TYPE_1).name(), typeid(ARG_TYPE_2).name(), \
			   typeid(ARG_TYPE_3).name(), typeid(ARG_TYPE_4).name(), typeid(ARG_TYPE_5).name());
...
#define FUNC_ARG_FORMAL_PARAMS_6                                                                      \
	, const ARG_TYPE_1 &arg1, const ARG_TYPE_2 &arg2, const ARG_TYPE_3 &arg3, const ARG_TYPE_4 &arg4, \
		const ARG_TYPE_5 &arg5, const ARG_TYPE_6 &arg6
...
#define FUNC_BASE_TEMPLATE_FUNC_PARAMS_6 \
	FUNC_ARG_TYPE_1, FUNC_ARG_TYPE_2, FUNC_ARG_TYPE_3, FUNC_ARG_TYPE_4, FUNC_ARG_TYPE_5, FUNC_ARG_TYPE_6
#define FUNC_VALIDATION_STRING_6                                                                \
	V_snprintf(pString, nBufLen, "method( %s, %s, %s, %s, %s, %s )", typeid(ARG_TYPE_1).name(), \
			   typeid(ARG_TYPE_2).name(), typeid(ARG_TYPE_3).name(), typeid(ARG_TYPE_4).name(), \
			   typeid(ARG_TYPE_5).name(), typeid(ARG_TYPE_6).name());
#define FUNC_SEPARATOR_6 ,

#define FUNC_SOLO_TEMPLATE_ARG_PARAMS_7                                                                      \
	typename ARG_TYPE_1, typename ARG_TYPE_2, typename ARG_TYPE_3, typename ARG_TYPE_4, typename ARG_TYPE_5, \
		typename ARG_TYPE_6, typename ARG_TYPE_7
#define FUNC_TEMPLATE_ARG_PARAMS_7                                                                             \
	, typename ARG_TYPE_1, typename ARG_TYPE_2, typename ARG_TYPE_3, typename ARG_TYPE_4, typename ARG_TYPE_5, \
		typename ARG_TYPE_6, typename ARG_TYPE_7
#define FUNC_BASE_TEMPLATE_ARG_PARAMS_7 \
	, ARG_TYPE_1, ARG_TYPE_2, ARG_TYPE_3, ARG_TYPE_4, ARG_TYPE_5, ARG_TYPE_6, ARG_TYPE_7
...
#define FUNC_ARG_FORMAL_PARAMS_7                                                                      \
	, const ARG_TYPE_1 &arg1, const ARG_TYPE_2 &arg2, const ARG_TYPE_3 &arg3, const ARG_TYPE_4 &arg4, \
		const ARG_TYPE_5 &arg5, const ARG_TYPE_6 &arg6, const ARG_TYPE_7 &arg7
...
#define FUNC_CALL_DATA_ARGS_7(_var) \
	_var->m_arg1, _var->m_arg2, _var->m_arg3, _var->m_arg4, _var->m_arg5, _var->m_arg6, _var->m_arg7
#define FUNC_FUNCTOR_CALL_ARGS_7 , arg1, arg2, arg3, arg4, arg5, arg6, arg7
#define FUNC_TEMPLATE_FUNC_PARAMS_7                                                                           \
	, typename FUNC_ARG_TYPE_1, typename FUNC_ARG_TYPE_2, typename FUNC_ARG_TYPE_3, typename FUNC_ARG_TYPE_4, \
		typename FUNC_ARG_TYPE_5, typename FUNC_ARG_TYPE_6, typename FUNC_ARG_TYPE_7
#define FUNC_BASE_TEMPLATE_FUNC_PARAMS_7                                                                  \
	FUNC_ARG_TYPE_1, FUNC_ARG_TYPE_2, FUNC_ARG_TYPE_3, FUNC_ARG_TYPE_4, FUNC_ARG_TYPE_5, FUNC_ARG_TYPE_6, \
		FUNC_ARG_TYPE_7
#define FUNC_VALIDATION_STRING_7                                                                    \
	V_snprintf(pString, nBufLen, "method( %s, %s, %s, %s, %s, %s, %s )", typeid(ARG_TYPE_1).name(), \
			   typeid(ARG_TYPE_2).name(), typeid(ARG_TYPE_3).name(), typeid(ARG_TYPE_4).name(),     \
			   typeid(ARG_TYPE_5).name(), typeid(ARG_TYPE_6).name(), typeid(ARG_TYPE_7).name());
#define FUNC_SEPARATOR_7 ,

#define FUNC_SOLO_TEMPLATE_ARG_PARAMS_8                                                                      \
	typename ARG_TYPE_1, typename ARG_TYPE_2, typename ARG_TYPE_3, typename ARG_TYPE_4, typename ARG_TYPE_5, \
		typename ARG_TYPE_6, typename ARG_TYPE_7, typename ARG_TYPE_8
#define FUNC_TEMPLATE_ARG_PARAMS_8                                                                             \
	, typename ARG_TYPE_1, typename ARG_TYPE_2, typename ARG_TYPE_3, typename ARG_TYPE_4, typename ARG_TYPE_5, \
		typename ARG_TYPE_6, typename ARG_TYPE_7, typename ARG_TYPE_8
#define FUNC_BASE_TEMPLATE_ARG_PARAMS_8 \
	, ARG_TYPE_1, ARG_TYPE_2, ARG_TYPE_3, ARG_TYPE_4, ARG_TYPE_5, ARG_TYPE_6, ARG_TYPE_7, ARG_TYPE_8
...
#define FUNC_ARG_FORMAL_PARAMS_8                                                                      \
	, const ARG_TYPE_1 &arg1, const ARG_TYPE_2 &arg2, const ARG_TYPE_3 &arg3, const ARG_TYPE_4 &arg4, \
		const ARG_TYPE_5 &arg5, const ARG_TYPE_6 &arg6, const ARG_TYPE_7 &arg7, const ARG_TYPE_8 &arg8
#define FUNC_PROXY_ARG_FORMAL_PARAMS_8                                                              \
	const ARG_TYPE_1 &arg1, const ARG_TYPE_2 &arg2, const ARG_TYPE_3 &arg3, const ARG_TYPE_4 &arg4, \
		const ARG_TYPE_5 &arg5, const ARG_TYPE_6 &arg6, const ARG_TYPE_7 &arg7, const ARG_TYPE_8 &arg8
#define FUNC_CALL_ARGS_INIT_8 \
	, m_arg1(arg1), m_arg2(arg2), m_arg3(arg3), m_arg4(arg4), m_arg5(arg5), m_arg6(arg6), m_arg7(arg7), m_arg8(arg8)
...
#define FUNC_CALL_DATA_ARGS_8(_var) \
	_var->m_arg1, _var->m_arg2, _var->m_arg3, _var->m_arg4, _var->m_arg5, _var->m_arg6, _var->m_arg7, _var->m_arg8
#define FUNC_FUNCTOR_CALL_ARGS_8 , arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8
#define FUNC_TEMPLATE_FUNC_PARAMS_8                                                                           \
	, typename FUNC_ARG_TYPE_1, typename FUNC_ARG_TYPE_2, typename FUNC_ARG_TYPE_3, typename FUNC_ARG_TYPE_4, \
		typename FUNC_ARG_TYPE_5, typename FUNC_ARG_TYPE_6, typename FUNC_ARG_TYPE_7, typename FUNC_ARG_TYPE_8
#define FUNC_BASE_TEMPLATE_FUNC_PARAMS_8                                                                  \
	FUNC_ARG_TYPE_1, FUNC_ARG_TYPE_2, FUNC_ARG_TYPE_3, FUNC_ARG_TYPE_4, FUNC_ARG_TYPE_5, FUNC_ARG_TYPE_6, \
		FUNC_ARG_TYPE_7, FUNC_ARG_TYPE_8
#define FUNC_VALIDATION_STRING_8                                                                        \
	V_snprintf(pString, nBufLen, "method( %s, %s, %s, %s, %s, %s, %s, %s )", typeid(ARG_TYPE_1).name(), \
			   typeid(ARG_TYPE_2).name(), typeid(ARG_TYPE_3).name(), typeid(ARG_TYPE_4).name(),         \
			   typeid(ARG_TYPE_5).name(), typeid(ARG_TYPE_6).name(), typeid(ARG_TYPE_7).name(),         \
			   typeid(ARG_TYPE_8).name());
#define FUNC_SEPARATOR_8 ,

#define FUNC_SOLO_TEMPLATE_ARG_PARAMS_9                                                                      \
	typename ARG_TYPE_1, typename ARG_TYPE_2, typename ARG_TYPE_3, typename ARG_TYPE_4, typename ARG_TYPE_5, \
		typename ARG_TYPE_6, typename ARG_TYPE_7, typename ARG_TYPE_8, typename ARG_TYPE_9
#define FUNC_TEMPLATE_ARG_PARAMS_9                                                                             \
	, typename ARG_TYPE_1, typename ARG_TYPE_2, typename ARG_TYPE_3, typename ARG_TYPE_4, typename ARG_TYPE_5, \
		typename ARG_TYPE_6, typename ARG_TYPE_7, typename ARG_TYPE_8, typename ARG_TYPE_9
#define FUNC_BASE_TEMPLATE_ARG_PARAMS_9 \
	, ARG_TYPE_1, ARG_TYPE_2, ARG_TYPE_3, ARG_TYPE_4, ARG_TYPE_5, ARG_TYPE_6, ARG_TYPE_7, ARG_TYPE_8, ARG_TYPE_9
...
#define FUNC_BASE_TEMPLATE_FUNC_PARAMS_9                                                                  \
	FUNC_ARG_TYPE_1, FUNC_ARG_TYPE_2, FUNC_ARG_TYPE_3, FUNC_ARG_TYPE_4, FUNC_ARG_TYPE_5, FUNC_ARG_TYPE_6, \
		FUNC_ARG_TYPE_7, FUNC_ARG_TYPE_8, FUNC_ARG_TYPE_9
#define FUNC_VALIDATION_STRING_9                                                                            \
	V_snprintf(pString, nBufLen, "method( %s, %s, %s, %s, %s, %s, %s, %s, %s )", typeid(ARG_TYPE_1).name(), \
			   typeid(ARG_TYPE_2).name(), typeid(ARG_TYPE_3).name(), typeid(ARG_TYPE_4).name(),             \
			   typeid(ARG_TYPE_5).name(), typeid(ARG_TYPE_6).name(), typeid(ARG_TYPE_7).name(),             \
			   typeid(ARG_TYPE_8).name(), typeid(ARG_TYPE_9).name());
#define FUNC_SEPARATOR_9 ,

#define FUNC_SOLO_TEMPLATE_ARG_PARAMS_10                                                                     \
	typename ARG_TYPE_1, typename ARG_TYPE_2, typename ARG_TYPE_3, typename ARG_TYPE_4, typename ARG_TYPE_5, \
		typename ARG_TYPE_6, typename ARG_TYPE_7, typename ARG_TYPE_8, typename ARG_TYPE_9, typename ARG_TYPE_10
...
#define FUNC_ARG_FORMAL_PARAMS_10                                                                       \
	, const ARG_TYPE_1 &arg1, const ARG_TYPE_2 &arg2, const ARG_TYPE_3 &arg3, const ARG_TYPE_4 &arg4,   \
		const ARG_TYPE_5 &arg5, const ARG_TYPE_6 &arg6, const ARG_TYPE_7 &arg7, const ARG_TYPE_8 &arg8, \
		const ARG_TYPE_9 &arg9, const ARG_TYPE_10 &arg10
...
#define FUNC_BASE_TEMPLATE_FUNC_PARAMS_10                                                                 \
	FUNC_ARG_TYPE_1, FUNC_ARG_TYPE_2, FUNC_ARG_TYPE_3, FUNC_ARG_TYPE_4, FUNC_ARG_TYPE_5, FUNC_ARG_TYPE_6, \
		FUNC_ARG_TYPE_7, FUNC_ARG_TYPE_8, FUNC_ARG_TYPE_9, FUNC_ARG_TYPE_10
#define FUNC_VALIDATION_STRING_10                                                                               \
	V_snprintf(pString, nBufLen, "method( %s, %s, %s, %s, %s, %s, %s, %s, %s, %s )", typeid(ARG_TYPE_1).name(), \
			   typeid(ARG_TYPE_2).name(), typeid(ARG_TYPE_3).name(), typeid(ARG_TYPE_4).name(),                 \
			   typeid(ARG_TYPE_5).name(), typeid(ARG_TYPE_6).name(), typeid(ARG_TYPE_7).name(),                 \
...
#define FUNC_ARG_FORMAL_PARAMS_11                                                                       \
	, const ARG_TYPE_1 &arg1, const ARG_TYPE_2 &arg2, const ARG_TYPE_3 &arg3, const ARG_TYPE_4 &arg4,   \
		const ARG_TYPE_5 &arg5, const ARG_TYPE_6 &arg6, const ARG_TYPE_7 &arg7, const ARG_TYPE_8 &arg8, \
		const ARG_TYPE_9 &arg9, const ARG_TYPE_10 &arg10, const ARG_TYPE_11 &arg11
...
#define FUNC_CALL_ARGS_INIT_11                                                                                        \
	, m_arg1(arg1), m_arg2(arg2), m_arg3(arg3), m_arg4(arg4), m_arg5(arg5), m_arg6(arg6), m_arg7(arg7), m_arg8(arg8), \
		m_arg9(arg9), m_arg10(arg10), m_arg11(arg11)
...
#define FUNC_CALL_MEMBER_ARGS_11 \
	m_arg1, m_arg2, m_arg3, m_arg4, m_arg5, m_arg6, m_arg7, m_arg8, m_arg9, m_arg10, m_arg11
#define FUNC_CALL_ARGS_11 arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11
#define FUNC_CALL_DATA_ARGS_11(_var)                                                                                \
	_var->m_arg1, _var->m_arg2, _var->m_arg3, _var->m_arg4, _var->m_arg5, _var->m_arg6, _var->m_arg7, _var->m_arg8, \
		_var->m_arg9, _var->m_arg10, _var->m_arg11
...
#define FUNC_TEMPLATE_FUNC_PARAMS_11                                                                            \
	, typename FUNC_ARG_TYPE_1, typename FUNC_ARG_TYPE_2, typename FUNC_ARG_TYPE_3, typename FUNC_ARG_TYPE_4,   \
		typename FUNC_ARG_TYPE_5, typename FUNC_ARG_TYPE_6, typename FUNC_ARG_TYPE_7, typename FUNC_ARG_TYPE_8, \
		typename FUNC_ARG_TYPE_9, typename FUNC_ARG_TYPE_10, typename FUNC_ARG_TYPE_11
#define FUNC_BASE_TEMPLATE_FUNC_PARAMS_11                                                                 \
	FUNC_ARG_TYPE_1, FUNC_ARG_TYPE_2, FUNC_ARG_TYPE_3, FUNC_ARG_TYPE_4, FUNC_ARG_TYPE_5, FUNC_ARG_TYPE_6, \
		FUNC_ARG_TYPE_7, FUNC_ARG_TYPE_8, FUNC_ARG_TYPE_9, FUNC_ARG_TYPE_10, FUNC_ARG_TYPE_11
#define FUNC_VALIDATION_STRING_11                                                                                   \
	V_snprintf(pString, nBufLen, "method( %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s )", typeid(ARG_TYPE_1).name(), \
			   typeid(ARG_TYPE_2).name(), typeid(ARG_TYPE_3).name(), typeid(ARG_TYPE_4).name(),                     \
			   typeid(ARG_TYPE_5).name(), typeid(ARG_TYPE_6).name(), typeid(ARG_TYPE_7).name(),                     \
			   typeid(ARG_TYPE_8).name(), typeid(ARG_TYPE_9).name(), typeid(ARG_TYPE_10).name(),                    \
...
#define FUNC_SOLO_TEMPLATE_ARG_PARAMS_12                                                                          \
	typename ARG_TYPE_1, typename ARG_TYPE_2, typename ARG_TYPE_3, typename ARG_TYPE_4, typename ARG_TYPE_5,      \
		typename ARG_TYPE_6, typename ARG_TYPE_7, typename ARG_TYPE_8, typename ARG_TYPE_9, typename ARG_TYPE_10, \
		typename ARG_TYPE_11, typename ARG_TYPE_12
...
#define FUNC_BASE_TEMPLATE_ARG_PARAMS_12                                                                          \
	, ARG_TYPE_1, ARG_TYPE_2, ARG_TYPE_3, ARG_TYPE_4, ARG_TYPE_5, ARG_TYPE_6, ARG_TYPE_7, ARG_TYPE_8, ARG_TYPE_9, \
		ARG_TYPE_10, ARG_TYPE_11, ARG_TYPE_12
...
#define FUNC_ARG_FORMAL_PARAMS_12                                                                       \
	, const ARG_TYPE_1 &arg1, const ARG_TYPE_2 &arg2, const ARG_TYPE_3 &arg3, const ARG_TYPE_4 &arg4,   \
		const ARG_TYPE_5 &arg5, const ARG_TYPE_6 &arg6, const ARG_TYPE_7 &arg7, const ARG_TYPE_8 &arg8, \
		const ARG_TYPE_9 &arg9, const ARG_TYPE_10 &arg10, const ARG_TYPE_11 &arg11, const ARG_TYPE_12 &arg12
...
#define FUNC_CALL_ARGS_INIT_12                                                                                        \
	, m_arg1(arg1), m_arg2(arg2), m_arg3(arg3), m_arg4(arg4), m_arg5(arg5), m_arg6(arg6), m_arg7(arg7), m_arg8(arg8), \
		m_arg9(arg9), m_arg10(arg10), m_arg11(arg11), m_arg12(arg12)
...
#define FUNC_CALL_MEMBER_ARGS_12 \
	m_arg1, m_arg2, m_arg3, m_arg4, m_arg5, m_arg6, m_arg7, m_arg8, m_arg9, m_arg10, m_arg11, m_arg12
...
#define FUNC_CALL_DATA_ARGS_12(_var)                                                                                \
	_var->m_arg1, _var->m_arg2, _var->m_arg3, _var->m_arg4, _var->m_arg5, _var->m_arg6, _var->m_arg7, _var->m_arg8, \
		_var->m_arg9, _var->m_arg10, _var->m_arg11, _var->m_arg12
...
#define FUNC_TEMPLATE_FUNC_PARAMS_12                                                                            \
	, typename FUNC_ARG_TYPE_1, typename FUNC_ARG_TYPE_2, typename FUNC_ARG_TYPE_3, typename FUNC_ARG_TYPE_4,   \
		typename FUNC_ARG_TYPE_5, typename FUNC_ARG_TYPE_6, typename FUNC_ARG_TYPE_7, typename FUNC_ARG_TYPE_8, \
		typename FUNC_ARG_TYPE_9, typename FUNC_ARG_TYPE_10, typename FUNC_ARG_TYPE_11, typename FUNC_ARG_TYPE_12
#define FUNC_BASE_TEMPLATE_FUNC_PARAMS_12                                                                 \
	FUNC_ARG_TYPE_1, FUNC_ARG_TYPE_2, FUNC_ARG_TYPE_3, FUNC_ARG_TYPE_4, FUNC_ARG_TYPE_5, FUNC_ARG_TYPE_6, \
		FUNC_ARG_TYPE_7, FUNC_ARG_TYPE_8, FUNC_ARG_TYPE_9, FUNC_ARG_TYPE_10, FUNC_ARG_TYPE_11, FUNC_ARG_TYPE_12
#define FUNC_VALIDATION_STRING_12                                                               \
	V_snprintf(pString, nBufLen, "method( %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s )",    \
			   typeid(ARG_TYPE_1).name(), typeid(ARG_TYPE_2).name(), typeid(ARG_TYPE_3).name(), \
			   typeid(ARG_TYPE_4).name(), typeid(ARG_TYPE_5).name(), typeid(ARG_TYPE_6).name(), \
			   typeid(ARG_TYPE_7).name(), typeid(ARG_TYPE_8).name(), typeid(ARG_TYPE_9).name(), \
			   typeid(ARG_TYPE_10).name(), typeid(ARG_TYPE_11).name(), typeid(ARG_TYPE_12).name());
#define FUNC_SEPARATOR_12 ,

#define FUNC_SOLO_TEMPLATE_ARG_PARAMS_13                                                                          \
	typename ARG_TYPE_1, typename ARG_TYPE_2, typename ARG_TYPE_3, typename ARG_TYPE_4, typename ARG_TYPE_5,      \
		typename ARG_TYPE_6, typename ARG_TYPE_7, typename ARG_TYPE_8, typename ARG_TYPE_9, typename ARG_TYPE_10, \
		typename ARG_TYPE_11, typename ARG_TYPE_12, typename ARG_TYPE_13
...
#define FUNC_BASE_TEMPLATE_ARG_PARAMS_13                                                                          \
	, ARG_TYPE_1, ARG_TYPE_2, ARG_TYPE_3, ARG_TYPE_4, ARG_TYPE_5, ARG_TYPE_6, ARG_TYPE_7, ARG_TYPE_8, ARG_TYPE_9, \
		ARG_TYPE_10, ARG_TYPE_11, ARG_TYPE_12, ARG_TYPE_13
...
#define FUNC_CALL_ARGS_INIT_13                                                                                        \
	, m_arg1(arg1), m_arg2(arg2), m_arg3(arg3), m_arg4(arg4), m_arg5(arg5), m_arg6(arg6), m_arg7(arg7), m_arg8(arg8), \
		m_arg9(arg9), m_arg10(arg10), m_arg11(arg11), m_arg12(arg12), m_arg13(arg13)
...
#define FUNC_CALL_MEMBER_ARGS_13 \
	m_arg1, m_arg2, m_arg3, m_arg4, m_arg5, m_arg6, m_arg7, m_arg8, m_arg9, m_arg10, m_arg11, m_arg12, m_arg13
...
#define FUNC_CALL_DATA_ARGS_13(_var)                                                                                \
	_var->m_arg1, _var->m_arg2, _var->m_arg3, _var->m_arg4, _var->m_arg5, _var->m_arg6, _var->m_arg7, _var->m_arg8, \
		_var->m_arg9, _var->m_arg10, _var->m_arg11, _var->m_arg12, _var->m_arg13
...
#define FUNC_VALIDATION_STRING_13                                                                  \
	V_snprintf(pString, nBufLen, "method( %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s )",   \
			   typeid(ARG_TYPE_1).name(), typeid(ARG_TYPE_2).name(), typeid(ARG_TYPE_3).name(),    \
			   typeid(ARG_TYPE_4).name(), typeid(ARG_TYPE_5).name(), typeid(ARG_TYPE_6).name(),    \
			   typeid(ARG_TYPE_7).name(), typeid(ARG_TYPE_8).name(), typeid(ARG_TYPE_9).name(),    \
			   typeid(ARG_TYPE_10).name(), typeid(ARG_TYPE_11).name(), typeid(ARG_TYPE_12).name(), \
...
#define FUNC_SOLO_TEMPLATE_ARG_PARAMS_14                                                                          \
	typename ARG_TYPE_1, typename ARG_TYPE_2, typename ARG_TYPE_3, typename ARG_TYPE_4, typename ARG_TYPE_5,      \
		typename ARG_TYPE_6, typename ARG_TYPE_7, typename ARG_TYPE_8, typename ARG_TYPE_9, typename ARG_TYPE_10, \
		typename ARG_TYPE_11, typename ARG_TYPE_12, typename ARG_TYPE_13, typename ARG_TYPE_14
...
#define FUNC_BASE_TEMPLATE_ARG_PARAMS_14                                                                          \
	, ARG_TYPE_1, ARG_TYPE_2, ARG_TYPE_3, ARG_TYPE_4, ARG_TYPE_5, ARG_TYPE_6, ARG_TYPE_7, ARG_TYPE_8, ARG_TYPE_9, \
		ARG_TYPE_10, ARG_TYPE_11, ARG_TYPE_12, ARG_TYPE_13, ARG_TYPE_14
...
#define FUNC_ARG_FORMAL_PARAMS_14                                                                             \
	, const ARG_TYPE_1 &arg1, const ARG_TYPE_2 &arg2, const ARG_TYPE_3 &arg3, const ARG_TYPE_4 &arg4,         \
		const ARG_TYPE_5 &arg5, const ARG_TYPE_6 &arg6, const ARG_TYPE_7 &arg7, const ARG_TYPE_8 &arg8,       \
		const ARG_TYPE_9 &arg9, const ARG_TYPE_10 &arg10, const ARG_TYPE_11 &arg11, const ARG_TYPE_12 &arg12, \
		const ARG_TYPE_13 &arg13, const ARG_TYPE_14 &arg14
...
#define FUNC_CALL_ARGS_INIT_14                                                                                        \
	, m_arg1(arg1), m_arg2(arg2), m_arg3(arg3), m_arg4(arg4), m_arg5(arg5), m_arg6(arg6), m_arg7(arg7), m_arg8(arg8), \
		m_arg9(arg9), m_arg10(arg10), m_arg11(arg11), m_arg12(arg12), m_arg13(arg13), m_arg14(arg14)
...
#define FUNC_CALL_MEMBER_ARGS_14 \
	m_arg1, m_arg2, m_arg3, m_arg4, m_arg5, m_arg6, m_arg7, m_arg8, m_arg9, m_arg10, m_arg11, m_arg12, m_arg13, m_arg14
...
#define FUNC_CALL_DATA_ARGS_14(_var)                                                                                \
	_var->m_arg1, _var->m_arg2, _var->m_arg3, _var->m_arg4, _var->m_arg5, _var->m_arg6, _var->m_arg7, _var->m_arg8, \
		_var->m_arg9, _var->m_arg10, _var->m_arg11, _var->m_arg12, _var->m_arg13, _var->m_arg14
...
#define FUNC_VALIDATION_STRING_14                                                                    \
	V_snprintf(pString, nBufLen, "method( %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s )", \
			   typeid(ARG_TYPE_1).name(), typeid(ARG_TYPE_2).name(), typeid(ARG_TYPE_3).name(),      \
			   typeid(ARG_TYPE_4).name(), typeid(ARG_TYPE_5).name(), typeid(ARG_TYPE_6).name(),      \
			   typeid(ARG_TYPE_7).name(), typeid(ARG_TYPE_8).name(), typeid(ARG_TYPE_9).name(),      \
			   typeid(ARG_TYPE_10).name(), typeid(ARG_TYPE_11).name(), typeid(ARG_TYPE_12).name(),   \
...
#define DEFINE_MEMBER_FUNC_PROXY(N)                                                                     \
	template<class OBJECT_TYPE_PTR, typename FUNCTION_TYPE FUNC_TEMPLATE_ARG_PARAMS_##N,                \
...
#define DEFINE_MEMBER_FUNCTOR(N)                                                                                   \
	template<class OBJECT_TYPE_PTR, typename FUNCTION_TYPE FUNC_TEMPLATE_ARG_PARAMS_##N,                           \
			 class FUNCTOR_BASE = CFunctorBase, class MEM_POLICY = CFuncMemPolicyNone>                             \
	class CMemberFunctor##N : public FUNCTOR_BASE                                                                  \
	{                                                                                                              \
	public:                                                                                                        \
		CMemberFunctor##N(OBJECT_TYPE_PTR pObject, FUNCTION_TYPE pfnProxied FUNC_ARG_FORMAL_PARAMS_##N)            \
...
#define DEFINE_FUNCTOR_DATA_TEMPLATE(N)                                                                               \
	...
	public:                                                                                                           \
		...
		virtual void ComputeValidationString(char *pString,                                                           \
											 size_t nBufLen) const {FUNC_VALIDATION_STRING_##N} FUNC_ARG_MEMBERS_##N; \
	}
	...
	public:                                                                                               \
		...
		{                                                                                                 \
			...
			CFunctorData##N<FUNC_SOLO_BASE_TEMPLATE_ARG_PARAMS_##N> *pFunctorData =                       \
				static_cast<CFunctorData##N<FUNC_SOLO_BASE_TEMPLATE_ARG_PARAMS_##N> *>(pFunctorDataBase); \
		...
		{                                                                                                 \
			return !V_stricmp(GetImplClassName(), pSrc->GetImplClassName()) &&                            \
				   (m_pfnProxied == static_cast<CFunctorCallback##N *>(pSrc)->m_pfnProxied);              \
		}                                                                                                 \
		virtual void ComputeValidationString(char *pString, size_t nBufLen) const                         \
		{                                                                                                 \
...
public:
	...
	virtual const char *GetImplClassName() const
	{
		return "CFunctorCallback0";
	}
	virtual const void *GetTarget() const
	{
		return (void *)m_pfnProxied;
	}
...
#define DEFINE_MEMBER_FUNCTOR_CALLBACK_TEMPLATE(N)                                                                     \
	...
	public:                                                                                                            \
		...
		{                                                                                                              \
			return !V_stricmp(GetImplClassName(), pSrc->GetImplClassName()) &&                                         \
				   (m_Proxy == static_cast<CMemberFunctorCallback##N *>(pSrc)->m_Proxy);                               \
		}                                                                                                              \
		virtual const char *GetImplClassName() const                                                                   \
		{                                                                                                              \
...
#define DEFINE_NONMEMBER_FUNCTOR_FACTORY(N)                                                                      \
	...
	inline CFunctor *CreateFunctor(FUNCTION_RETTYPE (*pfnProxied)(FUNC_BASE_TEMPLATE_FUNC_PARAMS_##N)            \
...
#define DEFINE_MEMBER_FUNCTOR_FACTORY(N)                                                                              \
	template<typename OBJECT_TYPE_PTR, typename FUNCTION_CLASS,                                                       \
			 typename FUNCTION_RETTYPE FUNC_TEMPLATE_FUNC_PARAMS_##N FUNC_TEMPLATE_ARG_PARAMS_##N>                    \
	inline CFunctor *CreateFunctor(OBJECT_TYPE_PTR pObject,                                                           \
								   FUNCTION_RETTYPE (FUNCTION_CLASS::*pfnProxied)(FUNC_BASE_TEMPLATE_FUNC_PARAMS_##N) \
									   FUNC_ARG_FORMAL_PARAMS_##N)                                                    \
	{                                                                                                                 \
		return new CMemberFunctor##N<OBJECT_TYPE_PTR,                                                                 \
									 FUNCTION_RETTYPE (FUNCTION_CLASS::*)(FUNC_BASE_TEMPLATE_FUNC_PARAMS_##N)         \
										 FUNC_BASE_TEMPLATE_ARG_PARAMS_##N>(pObject,                                  \
...
#define DEFINE_REF_COUNTING_MEMBER_FUNCTOR_FACTORY(N)                                                                  \
	...
	inline CFunctor *CreateRefCountingFunctor(                                                                         \
		...
		FUNCTION_RETTYPE (FUNCTION_CLASS::*pfnProxied)(FUNC_BASE_TEMPLATE_FUNC_PARAMS_##N) FUNC_ARG_FORMAL_PARAMS_##N) \
	{                                                                                                                  \
		return new CMemberFunctor##N<OBJECT_TYPE_PTR,                                                                  \
									 FUNCTION_RETTYPE (FUNCTION_CLASS::*)(FUNC_BASE_TEMPLATE_FUNC_PARAMS_##N)          \
										 FUNC_BASE_TEMPLATE_ARG_PARAMS_##N,                                            \
									 CFuncMemPolicyRefCount<OBJECT_TYPE_PTR>>(pObject,                                 \
																			  pfnProxied FUNC_FUNCTOR_CALL_ARGS_##N);  \
	}
...
#define DEFINE_REF_COUNTING_CONST_MEMBER_FUNCTOR_FACTORY(N)                                                           \
	template<typename OBJECT_TYPE_PTR, typename FUNCTION_CLASS,                                                       \
			 typename FUNCTION_RETTYPE FUNC_TEMPLATE_FUNC_PARAMS_##N FUNC_TEMPLATE_ARG_PARAMS_##N>                    \
	inline CFunctor *CreateRefCountingFunctor(                                                                        \
		OBJECT_TYPE_PTR pObject, FUNCTION_RETTYPE (FUNCTION_CLASS::*pfnProxied)(FUNC_BASE_TEMPLATE_FUNC_PARAMS_##N)   \
									 const FUNC_ARG_FORMAL_PARAMS_##N)                                                \
	{                                                                                                                 \
		return new CMemberFunctor##N<OBJECT_TYPE_PTR,                                                                 \
									 FUNCTION_RETTYPE (FUNCTION_CLASS::*)(FUNC_BASE_TEMPLATE_FUNC_PARAMS_##N)         \
...
#define DEFINE_MEMBER_FUNCTOR_CALLBACK_FACTORY(N)                                                                    \
	...
	inline CFunctorCallback *CreateFunctorCallback(                                                                  \
		FUNCTION_CLASS *pObject, void (FUNCTION_CLASS::*pfnProxied)(FUNC_PROXY_ARG_FORMAL_PARAMS_##N))               \
	{                                                                                                                \
...
#define DEFINE_NONMEMBER_FUNCTOR_DIRECT(N)                                                           \
	template<typename FUNCTION_RETTYPE FUNC_TEMPLATE_FUNC_PARAMS_##N FUNC_TEMPLATE_ARG_PARAMS_##N>   \
	inline void FunctorDirectCall(FUNCTION_RETTYPE (*pfnProxied)(FUNC_BASE_TEMPLATE_FUNC_PARAMS_##N) \
									  FUNC_ARG_FORMAL_PARAMS_##N)                                    \
	{                                                                                                \
...
#define DEFINE_MEMBER_FUNCTOR_DIRECT(N)                                                                              \
	template<typename OBJECT_TYPE_PTR, typename FUNCTION_CLASS,                                                      \
			 typename FUNCTION_RETTYPE FUNC_TEMPLATE_FUNC_PARAMS_##N FUNC_TEMPLATE_ARG_PARAMS_##N>                   \
	inline void FunctorDirectCall(OBJECT_TYPE_PTR pObject,                                                           \
								  FUNCTION_RETTYPE (FUNCTION_CLASS::*pfnProxied)(FUNC_BASE_TEMPLATE_FUNC_PARAMS_##N) \
									  FUNC_ARG_FORMAL_PARAMS_##N)                                                    \
	{                                                                                                                \
...
#define DEFINE_NONMEMBER_FUNCTOR_FACTORY_CUSTOM(N)                                                                  \
	...
	{                                                                                                               \
		typedef FUNCTION_RETTYPE (*Func_t)(FUNC_BASE_TEMPLATE_FUNC_PARAMS_##N);                                     \
		return new(                                                                                                 \
			m_pAllocator->Alloc(sizeof(CFunctor##N<Func_t FUNC_BASE_TEMPLATE_ARG_PARAMS_##N, CCustomFunctorBase>))) \
			CFunctor##N<Func_t FUNC_BASE_TEMPLATE_ARG_PARAMS_##N, CCustomFunctorBase>(                              \
				pfnProxied FUNC_FUNCTOR_CALL_ARGS_##N);                                                             \
	}
	...
	{                                                                                                                 \
		return new(m_pAllocator->Alloc(                                                                               \
			...
			CMemberFunctor##N<OBJECT_TYPE_PTR,                                                                        \
							  FUNCTION_RETTYPE (FUNCTION_CLASS::*)(FUNC_BASE_TEMPLATE_FUNC_PARAMS_##N)                \
								  FUNC_BASE_TEMPLATE_ARG_PARAMS_##N,                                                  \
							  CCustomFunctorBase>(pObject, pfnProxied FUNC_FUNCTOR_CALL_ARGS_##N);                    \
	}
	...
	{                                                                                                                  \
		return new(m_pAllocator->Alloc(                                                                                \
			sizeof(CMemberFunctor##N<OBJECT_TYPE_PTR,                                                                  \
									 FUNCTION_RETTYPE (FUNCTION_CLASS::*)(FUNC_BASE_TEMPLATE_FUNC_PARAMS_##N)          \
										 FUNC_BASE_TEMPLATE_ARG_PARAMS_##N,                                            \
									 CCustomFunctorBase, CFuncMemPolicyRefCount<OBJECT_TYPE_PTR>>)))                   \
			CMemberFunctor##N<OBJECT_TYPE_PTR,                                                                         \
							  FUNCTION_RETTYPE (FUNCTION_CLASS::*)(FUNC_BASE_TEMPLATE_FUNC_PARAMS_##N)                 \
								  FUNC_BASE_TEMPLATE_ARG_PARAMS_##N,                                                   \
							  CCustomFunctorBase, CFuncMemPolicyRefCount<OBJECT_TYPE_PTR>>(                            \
