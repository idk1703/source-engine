...
public:
	...
	bool IsShowDependencies()
	{
		return m_bShowDeps;
	}
	bool IsForceGenerate()
	{
		return m_bForceGenerate;
	}
	bool IsPosixPCHDisabled()
	{
		return m_bNoPosixPCH;
	}
	bool IsForceIterate()
	{
		return m_bForceIterate;
	}
	bool IsDecorateProject()
	{
		return m_bDecorateProject;
	}
	const char *GetDecorateString()
	{
		return m_strDecorate.String();
	}
	bool IsCheckFiles()
	{
		return m_bCheckFiles;
	}
	bool Is2010()
	{
	...
	} // When this returns true so does Is2010() because of the file format similarities
	bool Is2013()
	{
	...
	bool BUse2008()
	{
		return m_eVSVersion == k_EVSVersion_2008;
	}
	bool IsDedicatedBuild()
	{
		return m_bDedicatedBuild;
	}
	bool IsUnity()
	{
		return m_bUseUnity;
	}
	bool IsShowCaseIssues()
	{
		return m_bShowCaseIssues;
	}
	bool UseValveBinDir()
	{
		return m_bUseValveBinDir;
	}
	bool IsVerboseMakefile()
	{
		return m_bVerboseMakefile;
	}
	bool BUseP4SCC()
	{
		return m_bP4SCC;
	...
	bool BUse32BitTools()
	{
		return m_b32BitTools;
	}

	void DecorateProjectName(char *pchProjectName);

	int GetMissingFilesCount() const
	{
		return m_FilesMissing;
	}
	void IncrementFileMissing()
	{
		++m_FilesMissing;
	}
	void ResetMissingFilesCount()
	{
		m_FilesMissing = 0;
	}
	...
	{
		return m_bIgnoreRedundancyWarning;
	}
	...
	const char *GetCRCString()
	{
		return m_SupplementalCRCString.Get();
	}
	...
	const char *GetLoadAddressName()
	{
		return m_LoadAddressName.Get();
	}
	...
	const char *GetOutputMirrorPath()
	{
		return m_OutputMirrorString.Get();
	}
	...
	IBaseProjectGenerator *GetProjectGenerator()
	{
		return m_pProjectGenerator;
	}
...
private:
	...
	void CreateOutputFilename(project_t *pProject, const char *pchPlatform, const char *pchPhase, const char *pGameName,
	...
	bool BuildTargetProject(IProjectIterator *pIterator, projectIndex_t projectIndex, script_t *pProjectScript,
...
struct folderConfig_t
{
	...
	bool BHasConfig()
	{
		return vecConfigurationNames.Count() > 0;
	}
	void Clear()
	{
		vecConfigurationNames.RemoveAll();
	}
};
