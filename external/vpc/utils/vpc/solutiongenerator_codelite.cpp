...
public:
	...
	virtual void GenerateSolutionFile(const char *pSolutionFilename, CUtlVector<CDependency_Project *> &projects)
	{
		...
		for(int i = 0; i < projects.Count(); i++)
		{
			...
			V_StripExtension(pCurProject->m_ProjectFilename.String(), szProjectFileBaseName,
							 sizeof(szProjectFileBaseName));
	...
	void WriteBuildOrderProject(const char *pszSolutionFileBaseName, CUtlVector<CDependency_Project *> &projects)
	{
		...
		Write("<CodeLite_Project Name=\"all\" InternalType=\"\">\n");
		{
			...
			Write("<Settings Type=\"Static Library\">\n");
			{
				...
				Write("<Configuration Name=\"Debug\" CompilerType=\"gnu g++\" DebuggerType=\"GNU gdb debugger\" "
					  "Type=\"Executable\" BuildCmpWithGlobalSettings=\"append\" BuildLnkWithGlobalSettings=\"append\" "
				...
				Write("<Configuration Name=\"Release\" CompilerType=\"gnu g++\" DebuggerType=\"GNU gdb debugger\" "
					  "Type=\"Executable\" BuildCmpWithGlobalSettings=\"append\" BuildLnkWithGlobalSettings=\"append\" "
					  "BuildResWithGlobalSettings=\"append\">\n");
#if 0
				++m_nIndent;
	...
	void TraverseFrom(CUtlVector<CDependency_Project *> &projects, CUtlGraph<int, int> &dependencyGraph,
					  CUtlVector<int> &visitedList, int root)
	{
		...
		while(visitor.Advance())
		{
			...
			// visitor.CurrentNode(), projects[ visitor.CurrentNode() ]->m_ProjectName.String() );
