...
private:
	...
	bool WriteProperty(const PropertyState_t *pPropertyState, bool bEmitConfiguration = false,
					   const char *pConfigurationName = NULL, const char *pOutputName = NULL,
	...
	bool WriteFolderContentsToSecondaryXML(CProjectFolder *pFolder, const char *pParentPath, const char *pFileTypeName,
										   int nDepth);
