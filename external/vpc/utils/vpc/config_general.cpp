...
bool VPC_Config_General_ConfigurationType(const char *pPropertyName)
{
	...
	SET_LIST_PROPERTY(pPropertyName, g_spConfig, get_ConfigurationType, put_ConfigurationType, ConfigurationTypes,
					  option);
}
...
{
	SET_BOOL_PROPERTY(pPropertyName, g_spConfig, get_ATLMinimizesCRunTimeLibraryUsage,
					  put_ATLMinimizesCRunTimeLibraryUsage);
}
...
bool VPC_Config_General_WholeProgramOptimization(const char *pPropertyName)
{
	...
	SET_LIST_PROPERTY(pPropertyName, g_spConfig, get_WholeProgramOptimization, put_WholeProgramOptimization,
					  WholeProgramOptimizationTypes, option);
}
