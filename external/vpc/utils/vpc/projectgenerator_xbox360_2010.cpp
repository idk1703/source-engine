...
bool CProjectGenerator_Xbox360_2010::WritePropertyGroupTool(CProjectTool *pProjectTool,
...
bool CProjectGenerator_Xbox360_2010::WriteConfiguration(CProjectConfiguration *pConfig)
{
	if(!pConfig->m_bIsFileConfig)
	{
		m_XMLWriter.PushNode(
			"PropertyGroup",
			CFmtStr("Condition=\"'$(Configuration)|$(Platform)'=='%s|Xbox 360'\" Label=\"Configuration\"",
					pConfig->m_Name.Get()));
...
{
	m_XMLWriter.PushNode("ItemDefinitionGroup",
						 CFmtStr("Condition=\"'$(Configuration)|$(Platform)'=='%s|Xbox 360'\"", pConfig->m_Name.Get()));
...
bool CProjectGenerator_Xbox360_2010::WritePrimaryXML(const char *pOutputFilename)
{
	...
	for(int i = 0; i < configurationNames.Count(); i++)
	{
		m_XMLWriter.PushNode(
			"ImportGroup",
			CFmtStr("Condition=\"'$(Configuration)|$(Platform)'=='%s|Xbox 360'\" Label=\"PropertySheets\"",
...
bool CProjectGenerator_Xbox360_2010::WriteFileToSecondaryXML(CProjectFile *pFile, const char *pParentPath,
...
bool CProjectGenerator_Xbox360_2010::WriteFolderContentsToSecondaryXML(CProjectFolder *pFolder, const char *pParentPath,
...
bool CProjectGenerator_Xbox360_2010::WriteTool(const char *pToolName, const CProjectTool *pProjectTool,
...
bool CProjectGenerator_Xbox360_2010::WriteProperty(const PropertyState_t *pPropertyState, bool bEmitConfiguration,
