...
enum EventType
{
	...
	EYEBALL_STUN, // "Aque0us<174><STEAM_0:0:212532><Red>" eyeball_stunned with "NoWeapon" (attacker_position "-1033 872
				  // 143")
	...
	EYEBALL_KILLER,	   // "Spaghetti Western<192><STEAM_0:1:41812531><Red>" eyeball_killer with "liberty_launcher"
					   // (attacker_position "-1629 -293 213")
...
#define USE_COLUMNS
		...
		{
			fprintf(fp, "%d, %d, %d, %d\n", bossLifetime[i], bossEscapeLifetime[i], bossDeathLifetime[i],
					bossStunCount[i]);
