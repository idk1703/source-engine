...
void ScratchPad_DrawWinding(IScratchPad3D *pPad, int nPoints, Vector *pPoints, Vector vColor, Vector vOffset)
{
...
void ScratchPad_DrawFace(IScratchPad3D *pPad, dface_t *f, int iFaceNumber, const CSPColor &faceColor,
						 const Vector &vOffset)
{
	...
	{
		pPad->DrawLine(CSPVert(points[iEdge] + vOffset, faceColor),
