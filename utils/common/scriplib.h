...
//	nIncludeLineNumber		is the number of the line in the parent file with $include statement or 0 in case of
//"LoadScriptFile"
typedef void (*SCRIPT_LOADED_CALLBACK)(char const *pFilenameLoaded, char const *pIncludedFromFileName,
