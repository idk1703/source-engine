...
CUtlHash<SampleData_t> g_SampleHashTable(SAMPLEHASH_NUM_BUCKETS, SAMPLEHASH_GROW_SIZE, SAMPLEHASH_INIT_SIZE,
...
CUtlHash<PatchSampleData_t> g_PatchSampleHashTable(SAMPLEHASH_NUM_BUCKETS, SAMPLEHASH_GROW_SIZE, SAMPLEHASH_INIT_SIZE,
...
void PatchSampleData_AddSample(CPatch *pPatch, int ndxPatch)
{
	...
	Assert(patchSampleMins[0] <= patchSampleMaxs[0] && patchSampleMins[1] <= patchSampleMaxs[1] &&
