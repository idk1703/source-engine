...
// Proxied routines
HRESULT WINAPI Proxy_D3DXCompileShaderFromFile(LPCSTR pSrcFile, CONST D3DXMACRO *pDefines, LPD3DXINCLUDE pInclude,
...
#pragma comment( \
	linker,      \
	"/EXPORT:Proxy_D3DXCompileShaderFromFile=?Proxy_D3DXCompileShaderFromFile@@YGJPBDPBU_D3DXMACRO@@PAUID3DXInclude@@00KPAPAUID3DXBuffer@@3PAPAUID3DXConstantTable@@@Z")
	hr = D3DXCompileShader(pShaderData, numBytes, pDefines, pInclude, pFunctionName, pProfile, Flags, ppShader,
...
#pragma comment( \
	linker,      \
	"/EXPORT:Proxy_D3DXCompileShaderFromFile=?Proxy_D3DXCompileShaderFromFile@@YGJPBDPBU_D3D10_SHADER_MACRO@@PAUID3D10Include@@00KPAPAUID3D10Blob@@3PAPAX@Z")
	hr = D3DX10CompileFromMemory(pShaderData, numBytes, pSrcFile, pDefines, pInclude, pFunctionName, pProfile, Flags, 0,
