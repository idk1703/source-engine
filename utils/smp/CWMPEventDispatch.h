...
class CWMPEventDispatch : public CComObjectRootEx<CComSingleThreadModel>, public IWMPEvents, public _WMPOCXEvents
{
public:
	...
	STDMETHOD(Invoke)
	(DISPID dispIdMember, REFIID riid, LCID lcid, WORD wFlags, DISPPARAMS FAR *pDispParams, VARIANT FAR *pVarResult,
	...
	void STDMETHODCALLTYPE MediaCollectionAttributeStringChanged(BSTR bstrAttribName, BSTR bstrOldAttribVal,
