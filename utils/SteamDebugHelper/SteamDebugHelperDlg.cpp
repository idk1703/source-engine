...
CSteamDebugHelperDlg::CSteamDebugHelperDlg(CWnd *pParent /*=NULL*/) : CDialog(CSteamDebugHelperDlg::IDD, pParent)
{
...
void CSteamDebugHelperDlg::OnSetupForDebugging()
{
	...
	// pKV->deleteThis();	// note: leak the memory here knowingly to avoid warnings from the stupid way keyvalues
	// overload memory allocation
}
...
{
	CFileDialog dlg(true, "cfg", NULL, 0, "CFG Files (*.cfg)|*.cfg||", this);
