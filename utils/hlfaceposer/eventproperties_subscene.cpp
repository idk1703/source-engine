...
int EventProperties_SubScene(CEventParams *params)
{
	...
	int retval = DialogBox((HINSTANCE)GetModuleHandle(0), MAKEINTRESOURCE(IDD_EVENTPROPERTIES_SUBSCENE),
						   (HWND)g_MDLViewer->getHandle(), (DLGPROC)EventPropertiesSubSceneDialogProc);
