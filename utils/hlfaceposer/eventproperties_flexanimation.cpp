...
int EventProperties_FlexAnimation(CEventParams *params)
{
	...
	int retval = DialogBox((HINSTANCE)GetModuleHandle(0), MAKEINTRESOURCE(IDD_EVENTPROPERTIES_FLEXANIMATION),
						   (HWND)g_MDLViewer->getHandle(), (DLGPROC)EventPropertiesFlexAnimationDialogProc);
