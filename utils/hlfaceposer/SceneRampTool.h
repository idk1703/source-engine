...
public:
	...
	void DrawSamplesSimple(CChoreoWidgetDrawHelper &drawHelper, CChoreoScene *scene, bool clearbackground,
...
private:
	...
	void DrawRelativeTagsForEvent(CChoreoWidgetDrawHelper &drawHelper, RECT &rc, CChoreoEvent *event, float starttime,
								  float endtime);
	void DrawAbsoluteTagsForEvent(CChoreoWidgetDrawHelper &drawHelper, RECT &rc, CChoreoEvent *event, float starttime,
								  float endtime);
