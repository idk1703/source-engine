...
int EventProperties_Interrupt(CEventParams *params)
{
	...
	int retval = DialogBox((HINSTANCE)GetModuleHandle(0), MAKEINTRESOURCE(IDD_EVENTPROPERTIES_INTERRUPT),
						   (HWND)g_MDLViewer->getHandle(), (DLGPROC)EventPropertiesInterruptDialogProc);
