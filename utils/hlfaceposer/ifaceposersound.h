...
public:
	...
	virtual void PlayPartialSound(StudioModel *model, float volume, const char *wavfile, CAudioMixer **ppMixer,
								  int startSample, int endSample) = 0;
	...
	virtual void RenderWavToDC(HDC dc, RECT &outrect, COLORREF clr, float starttime, float endtime, CAudioSource *pWave,
