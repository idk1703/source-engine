...
int EventProperties_PermitResponses(CEventParams *params)
{
	...
	int retval = DialogBox((HINSTANCE)GetModuleHandle(0), MAKEINTRESOURCE(IDD_EVENTPROPERTIES_PERMITRESPONSES),
						   (HWND)g_MDLViewer->getHandle(), (DLGPROC)EventPropertiesPermitResponsesDialogProc);
