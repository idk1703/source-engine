...
{
	Init(widget, bounds.left, bounds.top, bounds.right - bounds.left, bounds.bottom - bounds.top,
		 COLOR_CHOREO_BACKGROUND, false);
}
...
{
	Init(widget, bounds.left, bounds.top, bounds.right - bounds.left, bounds.bottom - bounds.top,
		 COLOR_CHOREO_BACKGROUND, noPageFlip);
}
...
//			... -
//-----------------------------------------------------------------------------
void CChoreoWidgetDrawHelper::CalcTextRect(const char *font, int pointsize, int weight, int maxwidth, RECT &rcText,
										   const char *fmt, ...)
{
	va_list args;
	...
	HFONT fnt = CreateFont(-pointsize, 0, 0, 0, weight, FALSE, FALSE, FALSE, ANSI_CHARSET, OUT_TT_PRECIS,
						   CLIP_DEFAULT_PRECIS, ANTIALIASED_QUALITY, DEFAULT_PITCH, font);
...
//			... -
//-----------------------------------------------------------------------------
void CChoreoWidgetDrawHelper::DrawColoredText(const char *font, int pointsize, int weight, COLORREF clr, RECT &rcText,
											  const char *fmt, ...)
{
	va_list args;
	static char output[1024];
...
//			... -
//-----------------------------------------------------------------------------
void CChoreoWidgetDrawHelper::DrawColoredTextW(const char *font, int pointsize, int weight, COLORREF clr, RECT &rcText,
											   const wchar_t *fmt, ...)
{
	va_list args;
	static wchar_t output[1024];
...
void CChoreoWidgetDrawHelper::DrawColoredText(HFONT font, COLORREF clr, RECT &rcText, const char *fmt, ...)
{
	...
	DrawText(m_dcMemory, output, -1, &rcTextOffset,
			 DT_LEFT | DT_NOPREFIX | DT_VCENTER | DT_SINGLELINE | DT_WORD_ELLIPSIS);
...
void CChoreoWidgetDrawHelper::DrawColoredTextW(HFONT font, COLORREF clr, RECT &rcText, const wchar_t *fmt, ...)
{
	...
	DrawTextW(m_dcMemory, output, -1, &rcTextOffset,
			  DT_LEFT | DT_NOPREFIX | DT_VCENTER | DT_SINGLELINE | DT_WORD_ELLIPSIS);
...
//			... -
//-----------------------------------------------------------------------------
void CChoreoWidgetDrawHelper::DrawColoredTextCharset(const char *font, int pointsize, int weight, DWORD charset,
													 COLORREF clr, RECT &rcText, const char *fmt, ...)
{
	va_list args;
	static char output[1024];
	...
	HFONT fnt = CreateFont(-pointsize, 0, 0, 0, weight, FALSE, FALSE, FALSE, charset, OUT_TT_PRECIS,
						   CLIP_DEFAULT_PRECIS, ANTIALIASED_QUALITY, DEFAULT_PITCH, font);
...
void CChoreoWidgetDrawHelper::DrawColoredTextCharsetW(const char *font, int pointsize, int weight, DWORD charset,
													  COLORREF clr, RECT &rcText, const wchar_t *fmt, ...)
{
	va_list args;
	static wchar_t output[1024];
...
//			... -
//-----------------------------------------------------------------------------
void CChoreoWidgetDrawHelper::DrawColoredTextMultiline(const char *font, int pointsize, int weight, COLORREF clr,
													   RECT &rcText, const char *fmt, ...)
{
	va_list args;
	static char output[1024];
	...
	DrawText(m_dcMemory, output, -1, &rcTextOffset,
			 DT_LEFT | DT_NOPREFIX | DT_VCENTER | DT_WORDBREAK | DT_WORD_ELLIPSIS);
...
//			y2 -
//-----------------------------------------------------------------------------
POINTL CChoreoWidgetDrawHelper::DrawColoredRamp(COLORREF clr, int style, int width, int x1, int y1, int x2, int y2,
												float rate, float sustain)
{
	HPEN pen = CreatePen(style, width, clr);
	HPEN oldPen = (HPEN)SelectObject(m_dcMemory, pen);
	MoveToEx(m_dcMemory, x1 - m_x, y1 - m_y, NULL);
...
void CChoreoWidgetDrawHelper::DrawCircle(COLORREF clr, int x, int y, int radius, bool filled /*= true*/)
{
	...
	{
		Arc(m_dcMemory, rc.left, rc.top, rc.right, rc.bottom, rc.left, rc.top, rc.left, rc.top);
	}
...
void CChoreoWidgetDrawHelper::DrawGradientFilledRect(RECT &rc, COLORREF clr1, COLORREF clr2, bool vertical)
{
	...
	GradientFill(m_dcMemory, vert, 2, &gradient_rect, 1, vertical ? GRADIENT_FILL_RECT_V : GRADIENT_FILL_RECT_H);
}