...
public:
	...
	// If the user changes the association of .mdls to actors, then the gender could change and we could need to access
	// a different .wav file Call this to reconcile things
	void RecomputeWave();
