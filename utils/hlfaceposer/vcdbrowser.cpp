...
{
public:
	CVCDList(mxWindow *parent, int id = 0) : mxListView(parent, 0, 0, 0, 0, id)
	{
		// Add column headers
...
{
public:
	CUtlSymbolTree(mxWindow *parent, int id = 0) : mxTreeView(parent, 0, 0, 0, 0, id), m_Paths(0, 0, FileTreeLessFunc)
	{
	}
...
// Input  : *parent -
//-----------------------------------------------------------------------------
CVCDBrowser::CVCDBrowser(mxWindow *parent) : IFacePoserToolWindow("VCDBrowser", "VCDs"), mxWindow(parent, 0, 0, 0, 0)
{
...
HIMAGELIST CVCDBrowser::CreateImageList()
{
	...
	list = ImageList_Create(CX_ICON, CY_ICON, FALSE, VCD_NUM_IMAGES, 0);
...
//-----------------------------------------------------------------------------
bool CVCDBrowser::LoadVCDsFilesInDirectory(CUtlSortVector<FileNameHandle_t, CNameLessFunc> &soundlist,
...
bool CVCDBrowser::InitDirectoryRecursive(CUtlSortVector<FileNameHandle_t, CNameLessFunc> &soundlist,
