...
public:
	...
	CHTMLFile(const char *filenm, const char *title, bool fPrintBody = true, const char *bgimage = NULL,
			  int leftmarg = 0, int topmarg = 20);
	...
	void img(const char *i)
	{
		write("<img src=%s>\n", i);
	}

	void div(const char *cls)
	{
		write("<div class=%s>\n", cls);
	}
	void div()
