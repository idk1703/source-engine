...
public:
	...
	long GetFileTime(const char *pFileName, const char *pPathID = 0)
	{
		return 0;
	}
	bool ReadFile(const char *pFileName, const char *pPath, CUtlBuffer &buf, int nMaxBytes = 0, int nStartingByte = 0,
	...
	bool UnzipFile(const char *, const char *, const char *)
	{
		return false;
	}
};
