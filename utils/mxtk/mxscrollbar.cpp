...
mxScrollbar::mxScrollbar(mxWindow *parent, int x, int y, int w, int h, int id, int style) : mxWidget(parent, x, y, w, h)
{
	if(!parent)
		return;
	...
	void *handle = (void *)CreateWindowEx(0, "SCROLLBAR", "", dwStyle, x, y, w, h, hwndParent, (HMENU)id,
