...
mxListView::mxListView(mxWindow *parent, int x, int y, int w, int h, int id) : mxWidget(parent, x, y, w, h)
{
	if(!parent)
		return;
	...
	d_this->d_hwnd = CreateWindowEx(WS_EX_CLIENTEDGE, WC_LISTVIEW, "", dwStyle, x, y, w, h, hwndParent, (HMENU)id,
