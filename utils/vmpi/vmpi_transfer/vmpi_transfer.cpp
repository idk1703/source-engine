...
// Sample: vmpi_transfer -PatchHost -mpi_PatchDirectory \\fileserver\vmpi\patch1 -mpi_PatchWorkers <count> <ip1>
// <ip2>... Then it'll tell those workers to connect and it'll send them the files in the specified directory.
