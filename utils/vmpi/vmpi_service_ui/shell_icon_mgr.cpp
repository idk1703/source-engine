...
bool CShellIconMgr::Init(IShellIconMgrHelper *pHelper, const char *pToolTip, int iCallbackMessage, int iIconResourceID)
{
	Term();
	...
	// Create the window.
	m_hWnd = CreateWindow(SHELLICONMGR_CLASSNAME, SHELLICONMGR_CLASSNAME,
...
LRESULT CShellIconMgr::StaticWindowProc(HWND hwnd,	   // handle to window
