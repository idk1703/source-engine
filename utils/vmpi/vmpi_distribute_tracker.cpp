...
static COLORREF g_StateColors[] = {RGB(50, 50, 50), RGB(100, 0, 0), RGB(150, 0, 0), RGB(0, 155, 0),
...
static DWORD WINAPI ThreadProc(LPVOID lpParameter)
{
	...
	// Create the window.
	g_hWnd = CreateWindow(pClassName, "VMPI Tracker", WS_OVERLAPPEDWINDOW, 0, 0, g_LastSizeX, g_LastSizeY, NULL, NULL,
