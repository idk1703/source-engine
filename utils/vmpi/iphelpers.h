...
public:
	...
	virtual bool SendChunksTo(const CIPAddr *pAddr, void const *const *pChunks, const int *pChunkLengths,
							  int nChunks) = 0;
...
ISocket *CreateMulticastListenSocket(const CIPAddr &addr, const CIPAddr &localInterface = CIPAddr());
