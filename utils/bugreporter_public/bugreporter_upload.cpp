...
bool UploadBugReport(const netadr_t &cserIP, const CSteamID &userid, int build, char const *title, char const *body,
					 char const *exename, char const *pchGamedir, char const *mapname, char const *reporttype,
...
{
public:
	explicit CWin32UploadBugReport(const netadr_t &harvester, const TBugReportParameters &rBugReportParameters,
								   u32 contextid);
...
CWin32UploadBugReport::CWin32UploadBugReport(const netadr_t &harvester,
...
EBugReportUploadStatus Win32UploadBugReportBlocking(const TBugReportParameters &rBugReportParameters)
{
