	...
	: BaseClass(pParent, pszName, pszNextName)
{
	...
	{
		m_pExploreMaterialContentButton = new vgui::Button(
			this, "exploreMaterialContentButton", "#exploreMaterialContentButton", this, "ExploreMaterialContent");
		m_pExploreMaterialContentLabel =
			new vgui::Label(this, "exploreMaterialContentLabel", "#exploreMaterialContentLabel");

		m_pPanelListPanel->AddItem(m_pExploreMaterialContentButton, m_pExploreMaterialContentLabel);
	}

	{
		m_pExploreModelContentButton = new vgui::Button(this, "exploreModelContentButton", "#exploreModelContentButton",
														this, "ExploreModelContent");
	...
	{
		m_pExploreMaterialGameButton = new vgui::Button(this, "exploreMaterialGameButton", "#exploreMaterialGameButton",
														this, "ExploreMaterialGame");
	...
	{
		m_pExploreModelGameButton =
			new vgui::Button(this, "exploreModelGameButton", "#exploreModelGameButton", this, "ExploreModelGame");
