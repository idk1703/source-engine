...
public:
	...
	bool IsSteamControllerConnected(void)
	{
		return m_bSteamController;
	}
	...
	bool m_bSteamController; // true if the Steam Controller system has been initialized successfully (this doesn't mean
							 // one is actually connected necessarily)
	bool m_bSteamControllerActionsInitialized; // true if our action sets and handles were successfully initialized
											   // (this doesn't mean a controller is necessarily connected, or that
											   // in-game client actions were initialized)
	bool m_bSteamControllerActive; // true if our action sets and handles were successfully initialized *and* that at
								   // least one controller is actually connected and switched on.
