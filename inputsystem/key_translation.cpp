...
#define SCONTROLLERBUTTONS_BUTTONS(x)                                                                                \
	"SC_A", "SC_B", "SC_X", "SC_Y", "SC_DPAD_UP", "SC_DPAD_RIGHT", "SC_DPAD_DOWN", "SC_DPAD_LEFT", "SC_LEFT_BUMPER", \
		"SC_RIGHT_BUMPER", "SC_LEFT_TRIGGER", "SC_RIGHT_TRIGGER", "SC_LEFT_GRIP", "SC_RIGHT_GRIP",                   \
		"SC_LEFT_PAD_TOUCH", "SC_RIGHT_PAD_TOUCH", "SC_LEFT_PAD_CLICK", "SC_RIGHT_PAD_CLICK", "SC_LPAD_UP",          \
		"SC_LPAD_RIGHT", "SC_LPAD_DOWN", "SC_LPAD_LEFT", "SC_RPAD_UP", "SC_RPAD_RIGHT", "SC_RPAD_DOWN",              \
		"SC_RPAD_LEFT", "SC_SELECT", "SC_START", "SC_STEAM", "SC_NULL"

#define SCONTROLLERBUTTONS_AXIS(x)                                                                              \
	"SC_LPAD_AXIS_RIGHT", "SC_LPAD_AXIS_LEFT", "SC_LPAD_AXIS_DOWN", "SC_LPAD_AXIS_UP", "SC_AXIS_L_TRIGGER",     \
		"SC_AXIS_R_TRIGGER", "SC_RPAD_AXIS_RIGHT", "SC_RPAD_AXIS_LEFT", "SC_RPAD_AXIS_DOWN", "SC_RPAD_AXIS_UP", \
		"SC_GYRO_AXIS_PITCH_POSITIVE", "SC_GYRO_AXIS_PITCH_NEGATIVE", "SC_GYRO_AXIS_ROLL_POSITIVE",             \
		"SC_GYRO_AXIS_ROLL_NEGATIVE", "SC_GYRO_AXIS_YAW_POSITIVE", "SC_GYRO_AXIS_YAW_NEGATIVE"

#define SCONTROLLERBUTTONS_VBUTTONS(x) \
	"SC_F1", "SC_F2", "SC_F3", "SC_F4", "SC_F5", "SC_F6", "SC_F7", "SC_F8", "SC_F9", "SC_F10", "SC_F11", "SC_F12"
...
static const char *s_pXControllerButtonCodeNames[] = {
	"A_BUTTON", // JOYSTICK_FIRST_BUTTON
	"B_BUTTON",	  "X_BUTTON",	"Y_BUTTON", "L_SHOULDER", "R_SHOULDER", "BACK",		"START",   "STICK1",
	"STICK2",	  "JOY11",		"JOY12",	"JOY13",	  "JOY14",		"JOY15",	"JOY16",   "JOY17",
	"JOY18",	  "JOY19",		"JOY20",	"JOY21",	  "JOY22",		"JOY23",	"JOY24",   "JOY25",
	"JOY26",	  "JOY27",		"JOY28",	"JOY29",	  "JOY30",		"JOY31",
	"JOY32", // JOYSTICK_LAST_BUTTON
	...
	"S1_RIGHT", // JOYSTICK_FIRST_AXIS_BUTTON
	"S1_LEFT",	  "S1_DOWN",	"S1_UP",	"L_TRIGGER",  "R_TRIGGER",	"S2_RIGHT", "S2_LEFT", "S2_DOWN",
	"S2_UP", // JOYSTICK_LAST_AXIS_BUTTON
...
void ButtonCode_InitKeyTranslationTable()
{
	...
	// These are fake ("virtual") steam controller buttons that don't physically exist, but we can manufacture to make
	// internal routing to old school UI (which is expecting button code rather than actions) without clashing with
	// other butt
