...
public:
	CBrowserItem(CDialogMenu *pParent, const char *pHost, const char *pPlayers, const char *pScenario,
				 const char *pPing);
...
public:
	CAchievementItem(CDialogMenu *pParent, const wchar_t *pName, const wchar_t *pDesc, uint points, bool bUnlocked,
...
public:
	...
	CAchievementItem *AddAchievementItem(const wchar_t *pName, const wchar_t *pDesc, uint cred, bool bUnlocked,
										 IAchievement *pSourceAchievement);
