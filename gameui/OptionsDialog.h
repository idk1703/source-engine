...
public:
	...
	vgui::PropertyPage *GetOptionsSubMultiplayer(void)
	{
		return m_pOptionsSubMultiplayer;
	}
...
private:
	...
	int GetSelectionLabel(void)
	{
		return m_iSelection - m_iScroll;
	}
	...
	void UpdateBind(OptionData_t *pOption, int iLabel, ButtonCode_t codeIgnore = BUTTON_CODE_INVALID,
