...
public:
	...
	CSPVertList(Vector const &vert1, CSPColor const &color1, Vector const &vert2, CSPColor const &color2,
...
public:
	...
	virtual void SetMapping(Vector const &vInputMin, Vector const &vInputMax, Vector const &vOutputMin,
...
public:
	...
	virtual void DrawImageBW(unsigned char const *pData, int width, int height, int pitchInBytes,
							 bool bOutlinePixels = true, bool bOutlineImage = false, Vector *vCorners = NULL) = 0;

	// Draw an RGBA image.
	// Corners are in this order: bottom-left, top-left, top-right, bottom-right.
	virtual void DrawImageRGBA(SPRGBA * pData, int width, int height, int pitchInBytes, bool bOutlinePixels = true,
							   bool bOutlineImage = false, Vector *vCorners = NULL) = 0;
};
...
inline CSPVertList::CSPVertList(Vector const &vert1, CSPColor const &color1, Vector const &vert2,
								CSPColor const &color2, Vector const &vert3, CSPColor const &color3)
{
