...
public:
	...
	FORCEINLINE unsigned char GetPixelSize() RESTRICT
	{
		return m_Size;
	}

	FORCEINLINE bool IsUsingFloatFormat() const RESTRICT;
...
FORCEINLINE_PIXEL bool CPixelWriter::IsUsingFloatFormat() const RESTRICT
{
...
FORCEINLINE_PIXEL void CPixelWriter::WritePixelNoAdvance(int r, int g, int b, int a) RESTRICT
{
	...
	{
		AssertMsg(!IsX360(),
				  "Unsupported lightmap format used in WritePixelNoAdvance(). This is a severe performance fault.\n");
...
FORCEINLINE_PIXEL void CPixelWriter::WritePixelNoAdvance(FLTX4 rgba) RESTRICT
{
	...
	switch(m_Size)
	{
		...
		case 4:
		{
			AssertMsg((reinterpret_cast<unsigned int>(m_pBits) & 0x03) == 0,
					  "Unaligned m_pBits in WritePixelNoAdvance!");
			switch(m_Format)
			{
...
FORCEINLINE void CPixelWriter::WritePixelNoAdvance_BGRA8888(FLTX4 rgba, void *RESTRICT pBits) RESTRICT
{
	...
	static CONST XMVECTOR PackScale = {(1.0f / (FLOAT)(1 << 22)), (1.0f / (FLOAT)(1 << 22)), (1.0f / (FLOAT)(1 << 22)),
