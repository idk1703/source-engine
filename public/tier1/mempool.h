...
public:
	...
	CUtlMemoryPool(int blockSize, int numElements, int growMode = UTLMEMORYPOOL_GROW_FAST,
...
{
public:
	CMemoryPoolMT(int blockSize, int numElements, int growMode = UTLMEMORYPOOL_GROW_FAST,
