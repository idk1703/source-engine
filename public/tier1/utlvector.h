...
private:
	CUtlStringList(const CUtlStringList &other); // copying directly will cause double-release of the same strings;
												 // maybe we need to do a deep copy, but unless and until such need
												 // arises, this will guard against double-release
};
