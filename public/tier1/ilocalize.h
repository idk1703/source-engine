...
const unsigned int INVALID_LOCALIZE_STRING_INDEX = (StringIndex_t)-1;
...
public:
	...
	template<typename T>
	static void ConstructString(OUT_Z_BYTECAP(unicodeBufferSizeInBytes) T * unicodeOuput, int unicodeBufferSizeInBytes,
								const T *formatString, int numFormatParameters, ...)
	{
		va_list argList;
	...
	template<typename T>
	static void ConstructString(OUT_Z_BYTECAP(unicodeBufferSizeInBytes) T * unicodeOutput, int unicodeBufferSizeInBytes,
								const T *formatString, KeyValues *localizationVariables)
	{
	...
	static void ConstructString_safe(OUT_Z_ARRAY T(&pDest)[maxLenInChars], const T *formatString,
	...
	template<size_t maxLenInChars, typename T>
	void ConstructString_safe(OUT_Z_ARRAY T(&pDest)[maxLenInChars], const char *formatString,
							  KeyValues *localizationVariables)
	{
...
public:
	...
	CLocalizedStringArg(float fValue)
		: CLocalizedStringArgPrintfImpl<float>(
			  fValue, fabsf(fValue) <= FLT_EPSILON || fabsf(fValue) >= 1.0f ? LOCCHAR("%.0f") : LOCCHAR("%.1f"))
	{
		//
	}
};
...
public:
	...
	CConstructLocalizedString(const locchar_t *loc_Format, T arg0)
	{
		...
		if(loc_Format)
		{
			::ILocalize::ConstructString(m_loc_Buffer, sizeof(m_loc_Buffer), loc_Format, 1,
	...
	CConstructLocalizedString(const locchar_t *loc_Format, T arg0, U arg1)
	{
		...
		if(loc_Format)
		{
			::ILocalize::ConstructString(m_loc_Buffer, sizeof(m_loc_Buffer), loc_Format, 2,
										 CLocalizedStringArg<T>(arg0).GetLocArg(),
	...
	CConstructLocalizedString(const locchar_t *loc_Format, T arg0, U arg1, V arg2)
	{
		...
		if(loc_Format)
		{
			::ILocalize::ConstructString(
				m_loc_Buffer, sizeof(m_loc_Buffer), loc_Format, 3, CLocalizedStringArg<T>(arg0).GetLocArg(),
				CLocalizedStringArg<U>(arg1).GetLocArg(), CLocalizedStringArg<V>(arg2).GetLocArg());
		}
	}
	...
	CConstructLocalizedString(const locchar_t *loc_Format, T arg0, U arg1, V arg2, W arg3)
	{
		...
		{
			::ILocalize::ConstructString(
				m_loc_Buffer, sizeof(m_loc_Buffer), loc_Format, 4, CLocalizedStringArg<T>(arg0).GetLocArg(),
				CLocalizedStringArg<U>(arg1).GetLocArg(), CLocalizedStringArg<V>(arg2).GetLocArg(),
	...
	CConstructLocalizedString(const locchar_t *loc_Format, T arg0, U arg1, V arg2, W arg3, X arg4)
	{
		...
		{
			::ILocalize::ConstructString(
				m_loc_Buffer, sizeof(m_loc_Buffer), loc_Format, 5, CLocalizedStringArg<T>(arg0).GetLocArg(),
				CLocalizedStringArg<U>(arg1).GetLocArg(), CLocalizedStringArg<V>(arg2).GetLocArg(),
				CLocalizedStringArg<W>(arg3).GetLocArg(), CLocalizedStringArg<X>(arg4).GetLocArg());
		}
	}
	...
	CConstructLocalizedString(const locchar_t *loc_Format, T arg0, U arg1, V arg2, W arg3, X arg4, Y arg5)
	{
		...
		{
			::ILocalize::ConstructString(
				m_loc_Buffer, sizeof(m_loc_Buffer), loc_Format, 6, CLocalizedStringArg<T>(arg0).GetLocArg(),
				CLocalizedStringArg<U>(arg1).GetLocArg(), CLocalizedStringArg<V>(arg2).GetLocArg(),
				CLocalizedStringArg<W>(arg3).GetLocArg(), CLocalizedStringArg<X>(arg4).GetLocArg(),
	...
	CConstructLocalizedString(const locchar_t *loc_Format, T arg0, U arg1, V arg2, W arg3, X arg4, Y arg5, Z arg6)
	{
		...
		{
			::ILocalize::ConstructString(
				m_loc_Buffer, sizeof(m_loc_Buffer), loc_Format, 7, CLocalizedStringArg<T>(arg0).GetLocArg(),
				CLocalizedStringArg<U>(arg1).GetLocArg(), CLocalizedStringArg<V>(arg2).GetLocArg(),
				CLocalizedStringArg<W>(arg3).GetLocArg(), CLocalizedStringArg<X>(arg4).GetLocArg(),
				CLocalizedStringArg<Y>(arg5).GetLocArg(), CLocalizedStringArg<Z>(arg6).GetLocArg());
		}
	}
