	...
	struct SimplifyMemFunc<SINGLE_MEMFUNCPTR_SIZE + 3 * sizeof(int)>
	{
		...
		inline static GenericClass *Convert(X *pthis, XFuncType function_to_bind, GenericMemFuncType &bound_func)
		{
			...
			{ // Virtual inheritance is used
				...
				virtual_delta = u.s.vtordisp + *reinterpret_cast<const int *>(reinterpret_cast<const char *>(vtable) +
																			  u.s.vtable_index);
			}
...
namespace detail
{
	...
	public:
		...
		{
			m_pthis = SimplifyMemFunc<sizeof(function_to_bind)>::Convert(const_cast<X *>(pthis), function_to_bind,
																		 m_pFunction);
#if !defined(FASTDELEGATE_USESTATICFUNCTIONHACK)
			m_pStaticFunction = 0;
#endif
...
public:
	...
	template<class X, class Y>
	CUtlDelegate(Y *pthis, R (X::*function_to_bind)()) : BaseType(pthis, function_to_bind)
	{
	}

	template<class X, class Y>
	CUtlDelegate(const Y *pthis, R (X::*function_to_bind)() const) : BaseType(pthis, function_to_bind)
	{
	}
...
public:
	...
	template<class X, class Y>
	CUtlDelegate(Y *pthis, R (X::*function_to_bind)(Param1 p1)) : BaseType(pthis, function_to_bind)
	{
	}

	template<class X, class Y>
	CUtlDelegate(const Y *pthis, R (X::*function_to_bind)(Param1 p1) const) : BaseType(pthis, function_to_bind)
	{
	}

	CUtlDelegate(R (*function_to_bind)(Param1 p1)) : BaseType(function_to_bind) {}
...
public:
	...
	template<class X, class Y>
	CUtlDelegate(Y *pthis, R (X::*function_to_bind)(Param1 p1, Param2 p2)) : BaseType(pthis, function_to_bind)
	{
	}
	...
	CUtlDelegate(R (*function_to_bind)(Param1 p1, Param2 p2)) : BaseType(function_to_bind) {}
...
public:
	...
	CUtlDelegate(R (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3)) : BaseType(function_to_bind) {}
...
public:
	...
	CUtlDelegate(R (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4)) : BaseType(function_to_bind) {}
...
public:
	...
	template<class X, class Y>
	CUtlDelegate(const Y *pthis, R (X::*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5,
...
CUtlDelegate<FASTDLGT_RETTYPE(Param1, Param2, Param3)> UtlMakeDelegate(Y *x, RetType (X::*func)(Param1 p1, Param2 p2,
																								Param3 p3))
{
...
CUtlDelegate<FASTDLGT_RETTYPE(Param1, Param2, Param3, Param4)> UtlMakeDelegate(Y *x,
...
template<class X, class Y, class Param1, class Param2, class Param3, class Param4, class RetType>
CUtlDelegate<FASTDLGT_RETTYPE(Param1, Param2, Param3, Param4)> UtlMakeDelegate(
...
CUtlDelegate<FASTDLGT_RETTYPE(Param1, Param2, Param3, Param4)> UtlMakeDelegate(RetType (*func)(Param1 p1, Param2 p2,
																							   Param3 p3, Param4 p4))
{
...
CUtlDelegate<FASTDLGT_RETTYPE(Param1, Param2, Param3, Param4, Param5)> UtlMakeDelegate(
...
CUtlDelegate<FASTDLGT_RETTYPE(Param1, Param2, Param3, Param4, Param5)> UtlMakeDelegate(
	RetType (*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5))
{
...
template<class X, class Y, class Param1, class Param2, class Param3, class Param4, class Param5, class Param6,
		 class RetType>
CUtlDelegate<FASTDLGT_RETTYPE(Param1, Param2, Param3, Param4, Param5, Param6)> UtlMakeDelegate(
...
CUtlDelegate<FASTDLGT_RETTYPE(Param1, Param2, Param3, Param4, Param5, Param6)> UtlMakeDelegate(
	RetType (*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6))
{
...
CUtlDelegate<FASTDLGT_RETTYPE(Param1, Param2, Param3, Param4, Param5, Param6, Param7)> UtlMakeDelegate(
...
template<class Param1, class Param2, class Param3, class Param4, class Param5, class Param6, class Param7,
		 class RetType>
CUtlDelegate<FASTDLGT_RETTYPE(Param1, Param2, Param3, Param4, Param5, Param6, Param7)> UtlMakeDelegate(
	RetType (*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7))
{
