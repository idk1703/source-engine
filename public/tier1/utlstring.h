...
public:
	...
	bool MatchesPattern(const CUtlString &Pattern,
						int nFlags = 0) const; // case SENSITIVE, use * for wildcard in pattern string
...
inline CUtlString::CUtlString(const char *pString, int length) : m_pString(NULL)
{
