...
protected:
	...
	void OpenFile(const char *pOpenFileType, const char *pSaveFileName = NULL, const char *pSaveFileType = NULL,
				  int nFlags = 0, KeyValues *pKeyValues = NULL);
	void OpenFile(const char *pOpenFileName, const char *pOpenFileType, const char *pSaveFileName = NULL,
				  const char *pSaveFileType = NULL, int nFlags = 0, KeyValues *pKeyValues = NULL);
	...
	KEYBINDING_FUNC_NODECLARE(editkeybindings, KEY_E,
							  vgui::MODIFIER_SHIFT | vgui::MODIFIER_CONTROL | vgui::MODIFIER_ALT, OnEditKeyBindings,
							  "#editkeybindings_help", 0);
	...
	void ShowKeyBindingsHelp(vgui::Panel *panel, vgui::KeyBindingContextHandle_t handle, vgui::KeyCode boundKey,
							 int modifiers);
