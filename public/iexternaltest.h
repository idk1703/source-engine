...
public:
	...
	virtual void GetServerDetails(AppId_t *pnAppIdServed, uint32 *punIPGameServer, uint16 *pusPortGameServer,
								  bool *pbSecure) = 0;
	...
	virtual bool BYieldingGetAPICallResult(SteamAPICall_t hSteamAPICall, void *pCallback, uint32 unCallbackSize,
										   int nCallback, bool *pbAPICallFailed) = 0;
...
public:
	...
	virtual bool BYieldingCreateUserClientBatch(IExternalTestClient **prClients, int cClients,
	...
	virtual bool BYieldingCreateGameserverClientBatch(IExternalTestClient **prClients, int cClients,
													  EExternalTestConnectionPriority eConnectionPriority) = 0;
	...
	virtual ExternalTestBuffer_t YieldingSimulateWGRequest(const CSteamID &actorID, const void *pvRequestKV,
	...
	virtual void YieldingVerifySupportEventRecord(const CSteamID &victimID, const CSteamID &actorID,
												  ESupportEvent eAction, GID_t gidTxn, const char *pchNote) = 0;
	...
	virtual bool BYieldingHTTPRequest(int nWebMethod, bool bUseSSL, const char *pchURL, const KeyValues *pkvPostParams,
									  const char *pchAPIKey, const CSteamID &steamID, ExternalTestBuffer_t *punBuffer,
									  int *pnResultCode) = 0;
