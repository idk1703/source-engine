...
struct vehicle_steeringparams_t
{
	...
	float steeringRestRateSlow;	   // this is the speed at which the wheels move toward their resting state (straight
								   // ahead) at slow speed
	float steeringRestRateFast;	   // this is the speed at which the wheels move toward their resting state (straight
								   // ahead) at fast speed
	...
	float steeringExponent; // this makes the steering response non-linear.  The steering function is linear, then
