...
inline void BuildObjectRelativeXform(IPhysicsObject *pOutputSpace, IPhysicsObject *pInputSpace,
...
struct constraint_lengthparams_t
{
	...
	void InitWorldspace(IPhysicsObject *pRef, IPhysicsObject *pAttached, const Vector &refPosition,
...
public:
	...
	virtual void UpdateRagdollTransforms(const matrix3x4_t &constraintToReference,
										 const matrix3x4_t &constraintToAttached) = 0;
	virtual bool GetConstraintTransform(matrix3x4_t *pConstraintToReference,
