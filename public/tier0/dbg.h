...
DBG_INTERFACE SpewRetval_t _DSpewMessage(const tchar *pGroupName, int level, PRINTF_FORMAT_STRING const tchar *pMsg,
										 ...) FMTFUNCTION(3, 4);
DBG_INTERFACE SpewRetval_t ColorSpewMessage(SpewType_t type, const Color *pColor,
...
#define AssertFatalMsg(_exp, _msg, ...) \
	_AssertMsg(_exp, (const tchar *)CDbgFmtMsg(_msg, ##__VA_ARGS__), ((void)0), true)
...
DBG_INTERFACE void DMsg(const tchar *pGroupName, int level, PRINTF_FORMAT_STRING const tchar *pMsg, ...)
	FMTFUNCTION(3, 4);
...
DBG_INTERFACE void DWarning(const tchar *pGroupName, int level, PRINTF_FORMAT_STRING const tchar *pMsg, ...)
	FMTFUNCTION(3, 4);
...
DBG_INTERFACE void DLog(const tchar *pGroupName, int level, PRINTF_FORMAT_STRING const tchar *pMsg, ...)
	FMTFUNCTION(3, 4);
...
DBG_INTERFACE void ConColorMsg(int level, const Color &clr, PRINTF_FORMAT_STRING const tchar *pMsg, ...)
	FMTFUNCTION(3, 4);
