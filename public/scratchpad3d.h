...
public:
	...
	void AutoFlush();
	void DrawRectGeneric(int iPlane, int otherDim1, int otherDim2, float planeDist, Vector2D const &vMin,
...
public:
	...
	virtual void DrawImageBW(unsigned char const *pData, int width, int height, int pitchInBytes,
							 bool bOutlinePixels = true, bool bOutlineImage = false, Vector *vCorners = NULL);
