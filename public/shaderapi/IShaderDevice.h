...
public:
	...
	virtual IVertexBuffer *GetDynamicVertexBuffer(int nStreamID, VertexFormat_t vertexFormat,
...
inline VertexShaderHandle_t IShaderDevice::CreateVertexShader(const char *pProgram, size_t nBufLen,
...
inline GeometryShaderHandle_t IShaderDevice::CreateGeometryShader(const char *pProgram, size_t nBufLen,
																  const char *pShaderVersion)
{
...
inline PixelShaderHandle_t IShaderDevice::CreatePixelShader(const char *pProgram, size_t nBufLen,
															const char *pShaderVersion)
{
