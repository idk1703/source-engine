...
enum ShaderDrawBitField_t
{
	...
	SHADER_TEXCOORD_MASK =
		SHADER_DRAW_TEXCOORD0 | SHADER_DRAW_TEXCOORD1 | SHADER_DRAW_TEXCOORD2 | SHADER_DRAW_TEXCOORD3,

	SHADER_LIGHTMAP_TEXCOORD_MASK = SHADER_DRAW_LIGHTMAP_TEXCOORD0 | SHADER_DRAW_LIGHTMAP_TEXCOORD1 |
									SHADER_DRAW_LIGHTMAP_TEXCOORD2 | SHADER_DRAW_LIGHTMAP_TEXCOORD3,

	SHADER_SECONDARY_TEXCOORD_MASK = SHADER_DRAW_SECONDARY_TEXCOORD0 | SHADER_DRAW_SECONDARY_TEXCOORD1 |
...
public:
	...
	virtual void CustomTextureOperation(TextureStage_t stage, ShaderTexChannel_t channel, ShaderTexOp_t op,
	...
	virtual void DisableFogGammaCorrection(
		bool bDisable) = 0; // some blending modes won't work properly with corrected fog
