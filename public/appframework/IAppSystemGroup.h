...
//		pbBubbleDirectories		should contain "true" on return to bubble the directories up searching for game info
//file.
// Return values:
...
//
typedef bool (*SuggestGameInfoDirFn_t)(CFSSteamSetupInfo const *pFsSteamSetupInfo, char *pchPathBuffer,
