...
typedef void (*QueuedLoaderCallback_t)(void *pContext, void *pContext2, const void *pData, int nSize,
...
public:
	...
	virtual bool ClaimAnonymousJob(const char *pFilename, QueuedLoaderCallback_t pCallback, void *pContext,
								   void *pContext2 = NULL) = 0;
	// provides data if loaded, caller owns data
	virtual bool ClaimAnonymousJob(const char *pFilename, void **pData, int *pDataSize,
