...
#define DECLARE_KEYBINDINGMAP(className)                                                                               \
	static void KB_AddToMap(char const *bindingname, vgui::KeyCode defaultcode, int default_modifiers,                 \
							vgui::MessageFunc_t function, char const *helpstring, char const *docstring, bool passive) \
	{                                                                                                                  \
	...
	{                                                                                                                  \
		...
		{                                                                                                              \
			map->baseMap = vgui::FindOrAddPanelKeyBindingMap(GetPanelBaseClassName());                                 \
                                                                                                                       ...
                                                                                                                       \
	static void KB_AddBoundKey(char const *bindingname, int keycode, int modifiers)                                    \
	{                                                                                                                  \
		vgui::PanelKeyBindingMap *map = vgui::FindOrAddPanelKeyBindingMap(GetPanelClassName());                        \
		vgui::BoundKey_t kb;                                                                                           \
		kb.isbuiltin = true;                                                                                           \
...
#define KEYBINDING_FUNC_NODECLARE(name, keycode, modifiers, function, help, doc) \
	_KBMapFuncCommonFunc(name, keycode, modifiers, function, help, doc, false);
#define KEYBINDING_FUNC_PASSIVE(name, keycode, modifiers, function, help, doc) \
	...
	virtual void function()
#define KEYBINDING_FUNC_PASSIVE_NODECLARE(name, keycode, modifiers, function, help, doc) \
	_KBMapFuncCommonFunc(name, keycode, modifiers, function, help, doc, true);
...
#define KEYBINDING_ADDBINDING_MULTIPLE(name, keycode, modifiers, _classname) \
	_KBBindKeyCommon(name, keycode, modifiers, _classname);
