...
namespace vgui
{
	...
	public:
		...
		virtual bool OnReadFileFromDisk(const char *pFileName, const char *pFileFormat,
										KeyValues *pContextKeyValues) = 0;
	...
	public:
		...
		void OpenFile(const char *pOpenFileType, KeyValues *pContextKeyValues, const char *pSaveFileName = NULL,
					  const char *pSaveFileType = NULL, int nFlags = 0);

		// Version of OpenFile that skips browsing for a particular file to open
		void OpenFile(const char *pOpenFileName, const char *pOpenFileType, KeyValues *pContextKeyValues,
					  const char *pSaveFileName = NULL, const char *pSaveFileType = NULL, int nFlags = 0);
		...
		void SaveFile(KeyValues *pContextKeyValues, const char *pFileName, const char *pFileType,
