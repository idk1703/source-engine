...
public:
	...
	virtual bool Init(int nWidth, int nHeight, int nDepth, ImageFormat fmt, int nFlags, int iFrameCount,
					  int nForceMipCount = -1) = 0;
	...
	virtual bool UnserializeEx(CUtlBuffer &buf, bool bHeaderOnly = false, int nForceFlags = 0,
