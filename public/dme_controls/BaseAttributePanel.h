...
template<class T>
inline const T &GetArrayAttributeValue(CDmElement *pElement, const char *pAttribute, int nArrayIndex)
{
...
template<>
inline const DmElementHandle_t &GetArrayAttributeValue<DmElementHandle_t>(CDmElement *pElement, const char *pAttribute,
																		  int nArrayIndex)
{
...
template<class T>
inline void SetArrayAttributeValue(CDmElement *pElement, const char *pAttribute, int nArrayIndex, const T &value)
{
...
template<>
inline void SetArrayAttributeValue<DmElementHandle_t>(CDmElement *pElement, const char *pAttribute, int nArrayIndex,
