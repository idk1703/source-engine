...
private:
	...
	static bool CreateDmePanel(vgui::Panel *pParent, const char *pPanelName, CDmElement *pElement,
							   const char *pEditorName, EditorPanelMap_t *pMap);
...
protected:
	...
	CBaseDmePanelFactory(const char *pElementType, const char *pEditorName, const char *pEditorDisplayName,
						 bool bIsDefault, bool bIsOverride);
...
public:
	// Constructor
	CDmePanelFactory(const char *pElementType, const char *pEditorName, const char *pEditorDisplayName, bool bIsDefault,
					 bool bIsOverride)
...
public:
	// Constructor
	CDmePanelConverterFactory(const char *pElementType, const char *pDisplayType, const char *pEditorName,
...
#define IMPLEMENT_DMEPANEL_FACTORY(_panelClassName, _dmeLookupName, _editorName, _editorDisplayName, _isDefault) \
	CDmePanelFactory<_panelClassName, C##_dmeLookupName> g_##_panelClassName##_##_dmeLookupName##_Factory(       \
		#_dmeLookupName, _editorName, _editorDisplayName, _isDefault, false);                                    \
	_panelClassName *g_##_panelClassName##_##_dmeLookupName##LinkerHack = NULL;

#define IMPLEMENT_DMEPANEL_FACTORY_OVERRIDE(_panelClassName, _dmeLookupName, _editorName, _editorDisplayName, \
											_isDefault)                                                       \
	CDmePanelFactory<_panelClassName, C##_dmeLookupName> g_##_panelClassName##_##_dmeLookupName##_Factory(    \
...
// DmePanels implemented in libraries
//-----------------------------------------------------------------------------
#define IMPLEMENT_DMEPANEL_CONVERSION_FACTORY(_panelClassName, _dmeLookupName, _dmeDisplayName, _editorName, \
											  _editorDisplayName, _isDefault)                                \
	CDmePanelConverterFactory<_panelClassName, C##_dmeLookupName, C##_dmeDisplayName>                        \
		g_##_panelClassName##_##_dmeLookupName##_Factory(#_dmeLookupName, #_dmeDisplayName, _editorName,     \
														 _editorDisplayName, _isDefault, false);             \
	_panelClassName *g_##_panelClassName##_##_dmeLookupName##LinkerHack = NULL;

#define IMPLEMENT_DMEPANEL_CONVERSION_FACTORY_OVERRIDE(_panelClassName, _dmeLookupName, _dmeDisplayName, _editorName, \
													   _editorDisplayName, _isDefault)                                \
	CDmePanelConverterFactory<_panelClassName, C##_dmeLookupName, C##_dmeDisplayName>                                 \
		g_##_panelClassName##_##_dmeLookupName##_Factory(#_dmeLookupName, #_dmeDisplayName, _editorName,              \
														 _editorDisplayName, _isDefault, true);                       \
	_panelClassName *g_##_panelClassName##_##_dmeLookupName##LinkerHack = NULL;
...
// Dme Panel factory methods
//-----------------------------------------------------------------------------
vgui::EditablePanel *CreateDmePanel(vgui::Panel *pParent, const char *pPanelName, CDmElement *pElement,
