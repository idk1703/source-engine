...
// if we move from control to control in the preset or here, we need to be able to decay into/out of the various
// individual sliders
...
public:
	...
	void SetPreview(const AttributeValue_t &value, const AttributeValue_t &full, bool instantaneous,
