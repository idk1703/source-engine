...
public:
	...
	void BeginRead(IMesh *pMesh, int firstVertex = 0, int numVertices = 0, int firstIndex = 0, int numIndices = 0);
...
inline void CBaseMeshReader::BeginRead(IMesh *pMesh, int firstVertex, int numVertices, int firstIndex, int numIndices)
{
