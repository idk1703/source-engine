...
public:
	...
	CDmeGlobalFlexControllerOperator *GetGlobalFlexController(
		int localIndex); // localIndex is in order of calls to AddGlobalFlexController
...
public:
	...
	void SetState(bool bVisible, float nFrame, int nRenderMode, int nRenderFX, float flRenderScale, float flProxyRadius,
