...
public:
	...
	void CreateJointWeightsAndIndices(int nJointCount, FieldIndex_t *pJointWeightsField,
	...
	// Sets vertex data
	void SetVertexData(FieldIndex_t nFieldIndex, int nFirstVertex, int nCount, DmAttributeType_t valueType,
					   const void *pData);
