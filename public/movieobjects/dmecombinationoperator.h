...
public:
	...
	void SetControlValue(ControlIndex_t nControlIndex, float flLevel, float flBalance,
						 CombinationControlType_t type = COMBO_CONTROL_NORMAL);
	...
	void SetMultiControlLevel(ControlIndex_t nControlIndex, float flLevel,
							  CombinationControlType_t type = COMBO_CONTROL_NORMAL);
	float GetMultiControlLevel(ControlIndex_t nControlIndex,
	...
	const Vector2D &GetStereoControlValue(ControlIndex_t nControlIndex,
										  CombinationControlType_t type = COMBO_CONTROL_NORMAL) const;
	...
	void AttachChannelToControlValue(ControlIndex_t nControlIndex, CombinationControlType_t type,
	...
	CDmeCombinationDominationRule *AddDominationRule(int nDominatorCount, const char **ppDominatorOutputControlNames,
													 int nSuppressedCount, const char **ppSuppressedOutputControlNames);
	CDmeCombinationDominationRule *AddDominationRule(const CUtlVector<const char *> dominators,
...
private:
	...
	void ComputeInternalControlValue(RawControlIndex_t nRawControlIndex, CombinationControlType_t type,
									 Vector2D &value);
