...
public:
	...
	public:
		...
		{
			return m_pVert0 == pEdge->m_pVert0 || m_pVert0 == pEdge->m_pVert1 || m_pVert1 == pEdge->m_pVert0 ||
	...
	CFace *CreateFace(const CUtlVector<CVert *> &verts, const CUtlVector<CEdge *> &edges,
