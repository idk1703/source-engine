...
public:
	...
	enum
	{
		...
		ACCEL_VIRTKEY = (1 << 3), // The key member specifies a virtual-key code. If this flag is not specified, key is
								  // assumed to specify a character code.
	};
	...
	struct Accel_t
	{
		...
		unsigned short
			key; // Specifies the accelerator key. This member can be either a virtual-key code or a character code.
		unsigned short
			command; // Specifies the accelerator identifier. This value is placed in the low-order word of the wParam
