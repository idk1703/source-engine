...
#define DECLARE_ATTRIBUTE_TYPE_INTERNAL(_className, _storageType, _attributeType, _attributeName, \
...
DECLARE_ATTRIBUTE_TYPE_INTERNAL(DmElementHandle_t, DmElementAttribute_t, AT_ELEMENT, "element",
