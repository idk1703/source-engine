...
namespace MatrixMath
{
	...
	/// this tranpose returns a wrapper around it's argument, allowing things like AddMatrixToMatrix( Transpose( matA ),
	/// &matB ) without an extra copy
	...
	void ConjugateGradient(ATYPE const &matA, APRIMETYPE const &matAPrime, BTYPE const &vecB, XTYPE &vecX,
