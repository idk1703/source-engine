...
public:
	...
	//	"level" - (int) the priority of this message (closer to 0 is higher), only 1 message can be outstanding at a
	//time 	"time" - (int) the time in seconds this message should stay active in the GameUI (min 10 sec, max 200 sec)
	//
	...
	//
	virtual void CreateMessage(edict_t * pEntity, DIALOG_TYPE type, KeyValues * data,
