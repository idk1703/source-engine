...
//
//=============================================================================
CDmMeshComp::CDmMeshComp(CDmeMesh *pMesh, CDmeVertexData *pPassedBase) : m_pMesh(pMesh), m_pBase(NULL)
{
	...
	for(int i = 0; i < nVertices; ++i)
	{
		const CUtlVector<int> &vertexIndices =
			m_pBase->FindVertexIndicesFromDataIndex(CDmeVertexData::FIELD_POSITION, i);
...
CDmMeshComp::CVert::CVert(int nPositionIndex, const CUtlVector<int> *pVertexIndices, const Vector *pPosition)
	: m_positionIndex(nPositionIndex), m_pVertexIndices(pVertexIndices), m_pPosition(pPosition), m_edges(8, 8)
{
}
...
//
//-----------------------------------------------------------------------------
CDmMeshComp::CEdge::CEdge() : m_pVert0(NULL), m_pVert1(NULL), m_faceCount(0) {}
...
{
	return ((*m_pVert0 == *rhs.m_pVert0 && *m_pVert1 == *rhs.m_pVert1) ||
...
//
//-----------------------------------------------------------------------------
CDmMeshComp::CFace *CDmMeshComp::CreateFace(const CUtlVector<CVert *> &verts, const CUtlVector<CEdge *> &edges,
											const CUtlVector<bool> &edgeReverseMap)
{
