...
// Builds a unique list of controls found in the presets
//-----------------------------------------------------------------------------
static int BuildExportedControlList(CDmeAnimationSet *pAnimationSet, const CDmePresetGroup *pPresetGroup,
...
//-----------------------------------------------------------------------------
bool CDmePresetGroup::ExportToTXT(const char *pFileName, CDmeAnimationSet *pAnimationSet /* = NULL */,
...
//-----------------------------------------------------------------------------
bool CDmePresetGroup::ExportToVFE(const char *pFileName, CDmeAnimationSet *pAnimationSet /* = NULL */,
								  CDmeCombinationOperator *pComboOp /* = NULL */) const
{
	const CDmePresetGroup *pPresetGroup = this;
...
static PPType_t g_PresetNames[NUM_PROCEDURAL_PRESET_TYPES] = {
	{PROCEDURAL_PRESET_NOT, "NotProcedural!!!"}, {PROCEDURAL_PRESET_IN_CROSSFADE, "In"},
	{PROCEDURAL_PRESET_OUT_CROSSFADE, "Out"},	 {PROCEDURAL_PRESET_REVEAL, "Reveal"},
	{PROCEDURAL_PRESET_PASTE, "Paste"},			 {PROCEDURAL_PRESET_JITTER, "Jitter"},
	{PROCEDURAL_PRESET_SMOOTH, "Smooth"},		 {PROCEDURAL_PRESET_SHARPEN, "Sharpen"},
	{PROCEDURAL_PRESET_SOFTEN, "Soften"},		 {PROCEDURAL_PRESET_STAGGER, "Stagger"},
};
