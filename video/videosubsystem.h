...
public:
	...
	virtual VideoResult_t VideoSoundDeviceCMD(VideoSoundDeviceOperation_t operation, void *pDevice,
											  void *pData = nullptr) = 0;
	...
	virtual VideoResult_t PlayVideoFileFullScreen(const char *filename, void *mainWindow, int windowWidth,
												  ...
												  float forcedMinTime, VideoPlaybackFlags_t playbackFlags) = 0;
