...
{
	if((m_hModule == NULL) && (m_hModule = ::LoadLibrary("dx_proxy.dll")) != NULL)
	{
...
inline HRESULT DxProxyModule::D3DXCompileShaderFromFile(LPCSTR pSrcFile, CONST D3DXMACRO *pDefines,
														...
														LPD3DXCONSTANTTABLE *ppConstantTable)
{
	...
	return (*(HRESULT(WINAPI *)(LPCSTR, CONST D3DXMACRO *, LPD3DXINCLUDE, LPCSTR, LPCSTR, DWORD, LPD3DXBUFFER *,
								LPD3DXBUFFER *, LPD3DXCONSTANTTABLE *))m_arrFuncs[fnD3DXCompileShaderFromFile])(
