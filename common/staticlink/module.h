...
// subsystems don't define _MODULE for "pure" stateless shared modules which prevents the module from having a "state"
// symbol and causing linkage collision errors
#if defined(_MODULE)
