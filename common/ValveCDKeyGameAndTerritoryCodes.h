...
enum EGameCode
{
	...
	// a reasonable display length (26 bits, i.e. eMaskLargestAcceptableLocalUserId above, which is about 8 decimal
	// digits).
...
enum ESalesTerritory
{
	...
	// CyberCafe specific territories. If a CDKey has this game code OR a CyberCafe SalesTerritory then it is a
	// 'cybercafe CDkey'. CyberCafeBundle	first batch		 15,000 keys	**Next free 'StartUniqueSerialNumber' =
	// 15000
	eCyberCafeEurope = 12,
	...
	// This a Vivendi code meaning "Belgium, Luxembourg, French speaking territories of Africa, French overseas
	// departments, Netherlands, Quebec" ConditionZero	first batch		 40,700 keys	**Next free
	// 'StartUniqueSerialNumber' = 40700
	eExportFrance = 21,

	// This a Vivendi code meaning "Austria, Switzerland, Bulgaria, Czech Republic, Hungary, Lithuania, Poland, Romania,
	// Russian Federation, Slovenia, Slovakia" ConditionZero	first batch		 16,500 keys	**Next free
