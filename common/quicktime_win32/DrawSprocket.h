...
#define InvokeDSpEventUPP(inEvent, userUPP) (*userUPP)(inEvent)
	 ...
	 */
	EXTERN_API_C(Boolean)
	InvokeDSpCallbackUPP(DSpContextReference inContext, void *inRefCon, DSpCallbackUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeDSpCallbackUPP(inContext, inRefCon, userUPP) (*userUPP)(inContext, inRefCon)
	...
	*/
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpGetNextContext(DSpContextReference inCurrentContext, DSpContextReference *outContext);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpGetCurrentContext(DisplayIDType inDisplayID, DSpContextReference *outContext);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpFindBestContext(DSpContextAttributesPtr inDesiredAttributes, DSpContextReference *outContext);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpFindBestContextOnDisplayID(DSpContextAttributesPtr inDesiredAttributes, DSpContextReference *outContext,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpCanUserSelectContext(DSpContextAttributesPtr inDesiredAttributes, Boolean *outUserCanSelectContext);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpUserSelectContext(DSpContextAttributesPtr inDesiredAttributes, DisplayIDType inDialogDisplayLocation,
...
*/
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpAltBuffer_New(DSpContextReference inContext, Boolean inVRAMBuffer, DSpAltBufferAttributes *inAttributes,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpAltBuffer_InvalRect(DSpAltBufferReference inAltBuffer, const Rect *inInvalidRect);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpAltBuffer_GetCGrafPtr(DSpAltBufferReference inAltBuffer, DSpBufferKind inBufferKind, CGrafPtr *outCGrafPtr,
							 GDHandle *outGDevice);
...
/* general */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpContext_GetAttributes(DSpContextReferenceConst inContext, DSpContextAttributesPtr outAttributes);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpContext_Reserve(DSpContextReference inContext, DSpContextAttributesPtr inDesiredAttributes);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpContext_Queue(DSpContextReference inParentContext, DSpContextReference inChildContext,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpContext_Switch(DSpContextReference inOldContext, DSpContextReference inNewContext);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpContext_GetDisplayID(DSpContextReferenceConst inContext, DisplayIDType *outDisplayID);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpContext_SetVBLProc(DSpContextReference inContext, DSpCallbackUPP inProcPtr, void *inRefCon);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpContext_GetFlattenedSize(DSpContextReference inContext, UInt32 *outFlatContextSize);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpContext_Restore(void *inFlatContext, DSpContextReference *outRestoredContext);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpContext_GetMonitorFrequency(DSpContextReferenceConst inContext, Fixed *outFrequency);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpContext_GetMaxFrameRate(DSpContextReferenceConst inContext, UInt32 *outMaxFPS);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpContext_GetState(DSpContextReferenceConst inContext, DSpContextState *outState);
...
/* dirty rectangles */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpContext_SetDirtyRectGridSize(DSpContextReference inContext, UInt32 inCellPixelWidth, UInt32 inCellPixelHeight);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpContext_GetDirtyRectGridSize(DSpContextReferenceConst inContext, UInt32 *outCellPixelWidth,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpContext_GetDirtyRectGridUnits(DSpContextReferenceConst inContext, UInt32 *outCellPixelWidth,
									 UInt32 *outCellPixelHeight);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpContext_InvalBackBufferRect(DSpContextReference inContext, const Rect *inRect);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpContext_SetUnderlayAltBuffer(DSpContextReference inContext, DSpAltBufferReference inNewUnderlay);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpContext_GetUnderlayAltBuffer(DSpContextReferenceConst inContext, DSpAltBufferReference *outUnderlay);
...
/* gamma */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpContext_FadeGammaOut(DSpContextReference inContext, RGBColor *inZeroIntensityColor);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpContext_FadeGammaIn(DSpContextReference inContext, RGBColor *inZeroIntensityColor);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpContext_FadeGamma(DSpContextReference inContext, SInt32 inPercentOfOriginalIntensity,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpContext_SwapBuffers(DSpContextReference inContext, DSpCallbackUPP inBusyProc, void *inUserRefCon);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpContext_GetBackBuffer(DSpContextReference inContext, DSpBufferKind inBufferKind, CGrafPtr *outBackBuffer);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpContext_GetFrontBuffer(DSpContextReferenceConst inContext, CGrafPtr *outFrontBuffer);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpContext_SetCLUTEntries(DSpContextReference inContext, const ColorSpec *inEntries, UInt16 inStartingEntry,
							  UInt16 inLastEntry);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DSpContext_GetCLUTEntries(DSpContextReferenceConst inContext, ColorSpec *outEntries, UInt16 inStartingEntry,
							  UInt16 inLastEntry);
