...
#pragma pack(2)
	...
	*/
	...
	typedef CALLBACK_API(OSStatus, UnicodeToTextFallbackProcPtr)(UniChar *iSrcUniStr, ByteCount iSrcUniStrLen,
	...
	{
		return (UnicodeToTextFallbackUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppUnicodeToTextFallbackProcInfo,
															  GetCurrentArchitecture());
	}
#else
#define NewUnicodeToTextFallbackUPP(userRoutine) \
	(UnicodeToTextFallbackUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppUnicodeToTextFallbackProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeUnicodeToTextFallbackUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	...
	InvokeUnicodeToTextFallbackUPP(UniChar *iSrcUniStr, ByteCount iSrcUniStrLen, ByteCount *oSrcConvLen,
	...
	inline DEFINE_API_C(OSStatus)
		InvokeUnicodeToTextFallbackUPP(UniChar *iSrcUniStr, ByteCount iSrcUniStrLen, ByteCount *oSrcConvLen,
									   ...
									   UnicodeToTextFallbackUPP userUPP)
	{
		return (OSStatus)CALL_EIGHT_PARAMETER_UPP(userUPP, uppUnicodeToTextFallbackProcInfo, iSrcUniStr, iSrcUniStrLen,
												  oSrcConvLen, oDestStr, iDestStrLen, oDestConvLen, iInfoPtr,
												  iUnicodeMappingPtr);
	}
#else
#define InvokeUnicodeToTextFallbackUPP(iSrcUniStr, iSrcUniStrLen, oSrcConvLen, oDestStr, iDestStrLen, oDestConvLen, \
									   iInfoPtr, iUnicodeMappingPtr, userUPP)                                       \
	(OSStatus) CALL_EIGHT_PARAMETER_UPP((userUPP), uppUnicodeToTextFallbackProcInfo, (iSrcUniStr), (iSrcUniStrLen), \
										(oSrcConvLen), (oDestStr), (iDestStrLen), (oDestConvLen), (iInfoPtr),       \
										(iUnicodeMappingPtr))
#endif
#endif
...
#define CallUnicodeToTextFallbackProc(userRoutine, iSrcUniStr, iSrcUniStrLen, oSrcConvLen, oDestStr, iDestStrLen, \
									  oDestConvLen, iInfoPtr, iUnicodeMappingPtr)                                 \
	InvokeUnicodeToTextFallbackUPP(iSrcUniStr, iSrcUniStrLen, oSrcConvLen, oDestStr, iDestStrLen, oDestConvLen,   \
...
/* Note: the old names (InitializeUnicode, TerminateUnicode) for the above are still exported.*/
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateUnicodeToTextRunInfo(ItemCount iNumberOfMappings, const UnicodeMapping iUnicodeMappings[],
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateUnicodeToTextRunInfoByEncoding(ItemCount iNumberOfEncodings, const TextEncoding iEncodings[],
										 UnicodeToTextRunInfo *oUnicodeToTextInfo);
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateUnicodeToTextRunInfoByScriptCode(ItemCount iNumberOfScriptCodes, const ScriptCode iScripts[],
										   UnicodeToTextRunInfo *oUnicodeToTextInfo);
	 ...
	 */
	EXTERN_API(OSStatus)
	ChangeTextToUnicodeInfo(TextToUnicodeInfo ioTextToUnicodeInfo, ConstUnicodeMappingPtr iUnicodeMapping);
	 ...
	 */
	EXTERN_API(OSStatus)
	ChangeUnicodeToTextInfo(UnicodeToTextInfo ioUnicodeToTextInfo, ConstUnicodeMappingPtr iUnicodeMapping);
	...
	ConvertFromTextToUnicode(TextToUnicodeInfo iTextToUnicodeInfo, ByteCount iSourceLen, ConstLogicalAddress iSourceStr,
							 ...
							 ByteCount iOutputBufLen, ByteCount *oSourceRead, ByteCount *oUnicodeLen,
							 UniChar oUnicodeStr[]);
	 ...
	 */
	EXTERN_API(OSStatus)
	ConvertFromUnicodeToTextRun(UnicodeToTextRunInfo iUnicodeToTextInfo, ByteCount iUnicodeLen,
								const UniChar iUnicodeStr[], OptionBits iControlFlags, ItemCount iOffsetCount,
								ByteOffset iOffsetArray[], /* can be NULL */
								ItemCount *oOffsetCount,   /* can be NULL */
								ByteOffset oOffsetArray[], /* can be NULL */
								ByteCount iOutputBufLen, ByteCount *oInputRead, ByteCount *oOutputLen,
								LogicalAddress oOutputStr, ItemCount iEncodingRunBufLen, ItemCount *oEncodingRunOutLen,
	 ...
	 */
	EXTERN_API(OSStatus)
	TruncateForTextToUnicode(ConstTextToUnicodeInfo iTextToUnicodeInfo, ByteCount iSourceLen,
							 ConstLogicalAddress iSourceStr, ByteCount iMaxLen, ByteCount *oTruncatedLen);
	 ...
	 */
	EXTERN_API(OSStatus)
	TruncateForUnicodeToText(ConstUnicodeToTextInfo iUnicodeToTextInfo, ByteCount iSourceLen,
							 const UniChar iSourceStr[], OptionBits iControlFlags, ByteCount iMaxLen,
	 ...
	 */
	EXTERN_API(OSStatus)
	ConvertFromPStringToUnicode(TextToUnicodeInfo iTextToUnicodeInfo, ConstStr255Param iPascalStr,
								ByteCount iOutputBufLen, ByteCount *oUnicodeLen, UniChar oUnicodeStr[]);
	 ...
	 */
	EXTERN_API(OSStatus)
	ConvertFromUnicodeToPString(UnicodeToTextInfo iUnicodeToTextInfo, ByteCount iUnicodeLen,
								const UniChar iUnicodeStr[], Str255 oPascalStr);
	 ...
	 */
	EXTERN_API(OSStatus)
	CountUnicodeMappings(OptionBits iFilter, ConstUnicodeMappingPtr iFindMapping, ItemCount *oActualCount);
	 ...
	 */
	EXTERN_API(OSStatus)
	QueryUnicodeMappings(OptionBits iFilter, ConstUnicodeMappingPtr iFindMapping, ItemCount iMaxCount,
						 ItemCount *oActualCount, UnicodeMapping oReturnedMappings[]);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetFallbackUnicodeToText(UnicodeToTextInfo iUnicodeToTextInfo, UnicodeToTextFallbackUPP iFallback,
	 ...
	 */
	EXTERN_API(OSStatus)
	SetFallbackUnicodeToTextRun(UnicodeToTextRunInfo iUnicodeToTextRunInfo, UnicodeToTextFallbackUPP iFallback,
								OptionBits iControlFlags, LogicalAddress iInfoPtr);
