...
#define _HIObjectRegisterSubclass HIObjectRegisterSubclass
	...
	HIObjectRegisterSubclass(CFStringRef inClassID, CFStringRef inBaseClassID, OptionBits inOptions,
							 EventHandlerUPP inConstructProc, UInt32 inNumEvents, const EventTypeSpec *inEventList,
							 void *inConstructData, HIObjectClassRef *outClassRef); /* can be NULL */
...
#define _HIObjectCreate HIObjectCreate
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIObjectCreate(CFStringRef inClassID, EventRef inConstructData, HIObjectRef *outObject);
...
#define _HIObjectIsOfClass HIObjectIsOfClass
	...
	HIObjectIsOfClass(HIObjectRef inObject, CFStringRef inObjectClassID);
...
#define _HIObjectDynamicCast HIObjectDynamicCast
	 ...
	 */
	EXTERN_API_C(void *)
	HIObjectDynamicCast(HIObjectRef inObject, CFStringRef inClassID);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIObjectCreateFromBundle(CFBundleRef inBundle, HIObjectRef *outObject);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIObjectSetAccessibilityIgnored(HIObjectRef inObject, Boolean inIgnored);
	 ...
	 */
	EXTERN_API_C(Boolean)
	_HIObjectIsEqual(HIObjectRef inObject, HIObjectRef inOtherObject);
