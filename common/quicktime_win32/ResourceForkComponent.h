...
#pragma pack(2)
	...
	ResourceForkPathNameMap(ComponentInstance rfi, char *inDataPath, char *outRsrcPath, unsigned long maxLen)
	 ...
	 */
	EXTERN_API(ComponentResult)
	ResourceForkOffsetAndLength(ComponentInstance rfi, char *accessPath, long queryFlags, long *dataOffset,
	 ...
	 */
	EXTERN_API(ComponentResult)
	ResourceForkGetMethodInfo(ComponentInstance rfi, long queryFlags, long queryType, long *answer)
	 ...
	 */
	EXTERN_API(ComponentResult)
	ResourceForkFileLength(ComponentInstance rfi, char *accessPath, long queryFlags, long *fileLength)
	 ...
	 */
	EXTERN_API(ComponentResult)
	ResourceForkOffsetAndLength64(ComponentInstance rfi, char *accessPath, long queryFlags, wide *dataOffset,
	 ...
	 */
	EXTERN_API(ComponentResult)
	ResourceForkFileLength64(ComponentInstance rfi, char *accessPath, long queryFlags, wide *fileLength)
