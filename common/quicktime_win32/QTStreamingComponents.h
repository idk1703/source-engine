...
#pragma pack(2)
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSNewSourcer(void *params, const QTSSourcerInitParams *inInitParams, SInt32 inFlags,
	...
	enum
	{
		...
		kQTSInfo_CroppedInputRect =
			FOUR_CHAR_CODE('crpr'), /* Rect* - defined relative to kQTSInfo_FullInputRect below */
	...
	QTSSourcerInitialize(QTSSourcer inSourcer, const QTSSourcerInitParams *inInitParams)
	 ...
	 */
	EXTERN_API(ComponentResult)
	QTSSourcerIdle(QTSSourcer inSourcer, const TimeValue64 *inTime, SInt32 inFlags, SInt32 *outFlags)
	 ...
	 */
	EXTERN_API(ComponentResult)
	QTSSourcerGetEnable(QTSSourcer inSourcer, Boolean *outEnableMode, SInt32 inFlags)
	...
	*/
	...
	enum
	{
		...
		kRTPPayloadLossRecoveryTag =
			FOUR_CHAR_CODE('loss'), /* 0-255, 0 can't handle any loss, 128 can handle 50% packet loss*/
	...
	*/
	struct RTPPayloadSortRequest
	{
		...
		RTPPayloadCharacteristic
			characteristic[1]; /* tag is key to sort on, value is + for ascending, - for descending*/
	};
...
#define RTPReassemblerInfoToPayloadInfo(_rsmi) \
	((RTPPayloadInfoPtr)(&((_rsmi)->characteristic[(_rsmi)->characteristicCount])))
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSFindReassemblerForPayloadID(UInt8 inPayloadID, RTPPayloadSortRequest *inSortInfo,
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSFindReassemblerForPayloadName(const char *inPayloadName, RTPPayloadSortRequest *inSortInfo,
									 QTAtomContainer *outReassemblerList);
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPRssmHandleNewPacket(RTPReassembler rtpr, QTSStreamBuffer *inStreamBuffer, SInt32 inNumWraparounds)
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPRssmComputeChunkSize(RTPReassembler rtpr, RTPRssmPacket *inPacketListHead, SInt32 inFlags,
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPRssmAdjustPacketParams(RTPReassembler rtpr, RTPRssmPacket *inPacket, SInt32 inFlags)
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPRssmCopyDataToChunk(RTPReassembler rtpr, RTPRssmPacket *inPacketListHead, UInt32 inMaxChunkDataSize,
	...
	RTPRssmSendPacketList(RTPReassembler rtpr, RTPRssmPacket *inPacketListHead,
						  const TimeValue64 *inLastChunkPresentationTime, SInt32 inFlags)
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPRssmGetTimeScaleFromPacket(RTPReassembler rtpr, QTSStreamBuffer *inStreamBuffer, TimeScale *outTimeScale)
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPRssmHasCharacteristic(RTPReassembler rtpr, OSType inCharacteristic, Boolean *outHasIt)
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPRssmReset(RTPReassembler rtpr, SInt32 inFlags) FIVEWORDINLINE(0x2F3C, 0x0004, 0x050C, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPRssmGetPayloadHeaderLength(RTPReassembler rtpr, UInt32 *outPayloadHeaderLength)
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPRssmNewStreamHandler(RTPReassembler rtpr, OSType inSHType, SampleDescriptionHandle inSampleDescription,
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPRssmGetStreamHandler(RTPReassembler rtpr, ComponentInstance *outStreamHandler)
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPRssmSetSampleDescription(RTPReassembler rtpr, SampleDescriptionHandle inSampleDescription)
	...
	RTPRssmGetChunkAndIncrRefCount(RTPReassembler rtpr, UInt32 inChunkDataSize,
								   const TimeValue64 *inChunkPresentationTime, SHChunkRecord **outChunk)
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPRssmGetExtChunkAndIncrRefCount(RTPReassembler rtpr, UInt32 inChunkDataSize,
									  const TimeValue64 *inChunkPresentationTime, SInt32 inFlags,
									  SHExtendedChunkRecord **outChunk)
		FIVEWORDINLINE(0x2F3C, 0x0010, 0x0117, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPRssmSendLostChunk(RTPReassembler rtpr, const TimeValue64 *inChunkPresentationTime)
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPRssmSendStreamBufferRange(RTPReassembler rtpr, RTPSendStreamBufferRangeParams *inParams)
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPRssmFillPacketListParams(RTPReassembler rtpr, RTPRssmPacket *inPacketListHead, SInt32 inNumWraparounds,
...
#define MediaPacketizerInfoToPayloadInfo(_mpi) \
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSFindMediaPacketizer(MediaPacketizerRequirementsPtr inPacketizerinfo, SampleDescriptionHandle inSampleDescription,
						   RTPPayloadSortRequestPtr inSortInfo, QTAtomContainer *outPacketizerList);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSFindMediaPacketizerForTrack(Track inTrack, long inSampleDescriptionIndex, RTPPayloadSortRequestPtr inSortInfo,
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSFindMediaPacketizerForPayloadID(long payloadID, RTPPayloadSortRequestPtr inSortInfo,
									   QTAtomContainer *outPacketizerList);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSFindMediaPacketizerForPayloadName(const char *payloadName, RTPPayloadSortRequestPtr inSortInfo,
										 QTAtomContainer *outPacketizerList);
	...
	struct RTPMPPayloadTypeParams
	{
		...
		short nameLength;  /* in: size of payloadName buffer (counting null terminator) -- this will be reset to needed
							  length and paramErr returned if too small */
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPMPInitialize(RTPMediaPacketizer rtpm, SInt32 inFlags) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0500, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPMPPreflightMedia(RTPMediaPacketizer rtpm, OSType inMediaType, SampleDescriptionHandle inSampleDescription)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x0501, 0x7000, 0xA82A);
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPMPSetSampleData(RTPMediaPacketizer rtpm, const RTPMPSampleDataParams *inSampleData, SInt32 *outFlags)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x0503, 0x7000, 0xA82A);
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPMPReset(RTPMediaPacketizer rtpm, SInt32 inFlags) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0505, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPMPHasCharacteristic(RTPMediaPacketizer rtpm, OSType inSelector, Boolean *outHasIt)
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPMPSetPacketBuilder(RTPMediaPacketizer rtpm, ComponentInstance inPacketBuilder)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x050E, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPMPGetPacketBuilder(RTPMediaPacketizer rtpm, ComponentInstance *outPacketBuilder)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x050F, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPMPDoUserDialog(RTPMediaPacketizer rtpm, ModalFilterUPP inFilterUPP, Boolean *canceled)
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPMPSetSettingsFromAtomContainerAtAtom(RTPMediaPacketizer rtpm, QTAtomContainer inContainer, QTAtom inParentAtom)
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPMPGetSettingsIntoAtomContainerAtAtom(RTPMediaPacketizer rtpm, QTAtomContainer inOutContainer,
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPMPGetSettings(RTPMediaPacketizer rtpm, QTAtomContainer *outSettings, SInt32 inFlags)
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPMPSetSettings(RTPMediaPacketizer rtpm, QTAtomSpecPtr inSettings, SInt32 inFlags)
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPPBBeginPacketGroup(RTPPacketBuilder rtpb, SInt32 inFlags, UInt32 inTimeStamp, RTPPacketGroupRef *outPacketGroup)
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPPBEndPacketGroup(RTPPacketBuilder rtpb, SInt32 inFlags, RTPPacketGroupRef inPacketGroup)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x0501, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPPBBeginPacket(RTPPacketBuilder rtpb, SInt32 inFlags, RTPPacketGroupRef inPacketGroup,
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPPBEndPacket(RTPPacketBuilder rtpb, SInt32 inFlags, RTPPacketGroupRef inPacketGroup, RTPPacketRef inPacket,
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPPBAddPacketLiteralData(RTPPacketBuilder rtpb, SInt32 inFlags, RTPPacketGroupRef inPacketGroup,
							  RTPPacketRef inPacket, UInt8 *inData, UInt32 inDataLength,
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPPBAddPacketSampleData(RTPPacketBuilder rtpb, SInt32 inFlags, RTPPacketGroupRef inPacketGroup,
							 RTPPacketRef inPacket, RTPMPSampleDataParams *inSampleDataParams, UInt32 inSampleOffset,
							 UInt32 inSampleDataLength, RTPPacketRepeatedDataRef *outDataRef)
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPPBAddPacketSampleData64(RTPPacketBuilder rtpb, SInt32 inFlags, RTPPacketGroupRef inPacketGroup,
							   RTPPacketRef inPacket, RTPMPSampleDataParams *inSampleDataParams,
							   const UInt64 *inSampleOffset, UInt32 inSampleDataLength,
							   RTPPacketRepeatedDataRef *outDataRef)
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPPBAddPacketRepeatedData(RTPPacketBuilder rtpb, SInt32 inFlags, RTPPacketGroupRef inPacketGroup,
							   RTPPacketRef inPacket, RTPPacketRepeatedDataRef inDataRef)
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPPBReleaseRepeatedData(RTPPacketBuilder rtpb, RTPPacketRepeatedDataRef inDataRef)
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPPBSetPacketSequenceNumber(RTPPacketBuilder rtpb, SInt32 inFlags, RTPPacketGroupRef inPacketGroup,
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPPBGetPacketSequenceNumber(RTPPacketBuilder rtpb, SInt32 inFlags, RTPPacketGroupRef inPacketGroup,
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPPBSetPacketTimeStampOffset(RTPPacketBuilder rtpb, SInt32 inFlags, RTPPacketGroupRef inPacketGroup,
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPPBGetPacketTimeStampOffset(RTPPacketBuilder rtpb, SInt32 inFlags, RTPPacketGroupRef inPacketGroup,
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPPBAddRepeatPacket(RTPPacketBuilder rtpb, SInt32 inFlags, RTPPacketGroupRef inPacketGroup, RTPPacketRef inPacket,
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPPBSetCallback(RTPPacketBuilder rtpb, RTPPBCallbackUPP inCallback, void *inRefCon)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x050A, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPPBGetCallback(RTPPacketBuilder rtpb, RTPPBCallbackUPP *outCallback, void **outRefCon)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x050B, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	RTPPBGetSampleData(RTPPacketBuilder rtpb, RTPMPSampleDataParams *inParams, const UInt64 *inStartOffset,
					   UInt8 *outDataBuffer, UInt32 inBytesToRead, UInt32 *outBytesRead, SInt32 *outFlags)
	...
	{
		return (RTPMPDataReleaseUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppRTPMPDataReleaseProcInfo,
														 GetCurrentArchitecture());
	}
#else
#define NewRTPMPDataReleaseUPP(userRoutine) \
	(RTPMPDataReleaseUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppRTPMPDataReleaseProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (RTPPBCallbackUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppRTPPBCallbackProcInfo,
													  GetCurrentArchitecture());
	}
#else
#define NewRTPPBCallbackUPP(userRoutine) \
	(RTPPBCallbackUPP) NewRoutineDescriptor((ProcPtr)(userRoutine), uppRTPPBCallbackProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeRTPPBCallbackUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(void)
	InvokeRTPMPDataReleaseUPP(UInt8 *inData, void *inRefCon, RTPMPDataReleaseUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeRTPMPDataReleaseUPP(inData, inRefCon, userUPP) \
	 ...
	 */
	EXTERN_API_C(void)
	InvokeRTPPBCallbackUPP(OSType inSelector, void *ioParams, void *inRefCon, RTPPBCallbackUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
