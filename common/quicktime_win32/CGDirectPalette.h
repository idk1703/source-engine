...
#pragma pack(2)
	 ...
	 */
	EXTERN_API_C(CGDirectPaletteRef)
	CGPaletteCreateWithSamples(CGDeviceColor *sampleTable, CGTableCount sampleCount);
	 ...
	 */
	EXTERN_API_C(CGDirectPaletteRef)
	CGPaletteCreateWithByteSamples(CGDeviceByteColor *sampleTable, CGTableCount sampleCount);
	 ...
	 */
	EXTERN_API_C(void)
	CGPaletteSetColorAtIndex(CGDirectPaletteRef palette, CGDeviceColor color, CGTableCount index);
	...
	CGPaletteIsEqualToPalette(CGDirectPaletteRef palette1, CGDirectPaletteRef palette2);
	 ...
	 */
	EXTERN_API_C(CGDirectPaletteRef)
	CGPaletteCreateFromPaletteBlendedWithColor(CGDirectPaletteRef palette, CGPaletteBlendFraction fraction,
											   CGDeviceColor color);
