...
#pragma import on
	...
	enum
	{
		...
		errJavaEmbeddingIntializationFailed =
			-9962, /* previously errClassConstructorNotFound, errClassNotFound, and errMethodNotFound*/
	...
	MoveAndClipJavaControl(JNIEnv *env, ControlRef theControl, int posX, int posY, int clipX, int clipY, int clipWidth,
						   int clipHeight);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	SizeJavaControl(JNIEnv *env, ControlRef theControl, int width, int height);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ShowHideJavaControl(JNIEnv *env, ControlRef theControl, Boolean visible);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	StopJavaControlAsyncDrawing(JNIEnv *env, ControlRef theControl);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	RestartJavaControlAsyncDrawing(JNIEnv *env, ControlRef theControl);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	DrawJavaControl(JNIEnv *env, ControlRef theControl);
	...
	*/
	 ...
	 */
	EXTERN_API_C(OSStatus)
	GetJavaWindowFromWindow(JNIEnv *env, WindowRef inMacWindow, jobject *outJavaWindow);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	GetWindowFromJavaWindow(JNIEnv *env, jobject inJavaWindow, WindowRef *outMacWindow);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	GetJavaFrameFromControl(JNIEnv *env, ControlRef inMacControl, jobject *outJavaFrame);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	GetControlFromJavaFrame(JNIEnv *env, jobject inJavaFrame, ControlRef *outMacControl);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	CreateJavaControl(JNIEnv *env, WindowRef inNativeWindow, const Rect *inBounds, jobject inAppletFrame,
					  Boolean inVisible, ControlRef *outControl);
