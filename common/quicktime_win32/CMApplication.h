...
enum
{
	...
	{
		return (CMProfileIterateUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppCMProfileIterateProcInfo,
														 GetCurrentArchitecture());
	}
#else
#define NewCMProfileIterateUPP(userRoutine) \
	(CMProfileIterateUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppCMProfileIterateProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (CMMIterateUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppCMMIterateProcInfo,
												   GetCurrentArchitecture());
	}
#else
#define NewCMMIterateUPP(userRoutine) \
	(CMMIterateUPP) NewRoutineDescriptor((ProcPtr)(userRoutine), uppCMMIterateProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeCMMIterateUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeCMProfileIterateUPP(CMProfileIterateData *iterateData, void *refCon, CMProfileIterateUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeCMProfileIterateUPP(iterateData, refCon, userUPP) \
	(OSErr) CALL_TWO_PARAMETER_UPP((userUPP), uppCMProfileIterateProcInfo, (iterateData), (refCon))
#endif
#endif
...
#define InvokeCMMIterateUPP(iterateData, refCon, userUPP) \
	(OSErr) CALL_TWO_PARAMETER_UPP((userUPP), uppCMMIterateProcInfo, (iterateData), (refCon))
#endif
#endif
...
#define kCMPrefsChangedNotification CFSTR("AppleColorSyncPreferencesChangedNotification")
	 ...
	 */
	EXTERN_API(CMError)
	CMCopyProfile(CMProfileRef *targetProf, const CMProfileLocation *targetLocation, CMProfileRef srcProf)
	 ...
	 */
	EXTERN_API(CMError)
	CMValidateProfile(CMProfileRef prof, Boolean *valid, Boolean *preferredCMMnotfound)
	 ...
	 */
	EXTERN_API(CMError)
	NCMGetProfileLocation(CMProfileRef prof, CMProfileLocation *theProfile, UInt32 *locationSize)
	 ...
	 */
	EXTERN_API(CMError)
	CMFlattenProfile(CMProfileRef prof, UInt32 flags, CMFlattenUPP proc, void *refCon, Boolean *preferredCMMnotfound)
	 ...
	 */
	EXTERN_API(CMError)
	CMUnflattenProfile(FSSpec *resultFileSpec, CMFlattenUPP proc, void *refCon, Boolean *preferredCMMnotfound)
	 ...
	 */
	EXTERN_API(CMError)
	CMGetProfileHeader(CMProfileRef prof, CMAppleProfileHeader *header) FOURWORDINLINE(0x203C, 0x0008, 0x0039, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CMCountProfileElements(CMProfileRef prof, UInt32 *elementCount) FOURWORDINLINE(0x203C, 0x0008, 0x001F, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CMGetProfileElement(CMProfileRef prof, OSType tag, UInt32 *elementSize, void *elementData)
	 ...
	 */
	EXTERN_API(CMError)
	CMSetProfileElement(CMProfileRef prof, OSType tag, UInt32 elementSize, const void *elementData)
	 ...
	 */
	EXTERN_API(CMError)
	CMSetProfileElementReference(CMProfileRef prof, OSType elementTag, OSType referenceTag)
	 ...
	 */
	EXTERN_API(CMError)
	CMGetPartialProfileElement(CMProfileRef prof, OSType tag, UInt32 offset, UInt32 *byteCount, void *elementData)
	 ...
	 */
	EXTERN_API(CMError)
	CMSetPartialProfileElement(CMProfileRef prof, OSType tag, UInt32 offset, UInt32 byteCount, const void *elementData)
	 ...
	 */
	EXTERN_API(CMError)
	CMGetIndProfileElementInfo(CMProfileRef prof, UInt32 index, OSType *tag, UInt32 *elementSize, Boolean *refs)
	 ...
	 */
	EXTERN_API(CMError)
	CMGetIndProfileElement(CMProfileRef prof, UInt32 index, UInt32 *elementSize, void *elementData)
	 ...
	 */
	EXTERN_API(CMError)
	CMRemoveProfileElement(CMProfileRef prof, OSType tag) FOURWORDINLINE(0x203C, 0x0008, 0x0024, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CMGetProfileDescriptions(CMProfileRef prof, char *aName, UInt32 *aCount, Str255 mName, ScriptCode *mCode,
							 UniChar *uName, UniCharCount *uCount) FOURWORDINLINE(0x203C, 0x001A, 0x0067, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CMSetProfileDescriptions(CMProfileRef prof, const char *aName, UInt32 aCount, ConstStr255Param mName,
							 ScriptCode mCode, const UniChar *uName, UniCharCount uCount)
	 ...
	 */
	EXTERN_API(CMError)
	CMCopyProfileLocalizedStringDictionary(CMProfileRef prof, OSType tag, CFDictionaryRef *theDict);
	 ...
	 */
	EXTERN_API(CMError)
	CMSetProfileLocalizedStringDictionary(CMProfileRef prof, OSType tag, CFDictionaryRef theDict);
	 ...
	 */
	EXTERN_API(CMError)
	CMCopyProfileLocalizedString(CMProfileRef prof, OSType tag, CFStringRef reqLocale, CFStringRef *locale,
								 CFStringRef *str);
	 ...
	 */
	EXTERN_API(CMError)
	CMGetProfileRefCount(CMProfileRef prof, long *count) FOURWORDINLINE(0x203C, 0x0008, 0x0043, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CMProfileModified(CMProfileRef prof, Boolean *modified) FOURWORDINLINE(0x203C, 0x0008, 0x0044, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CMGetNamedColorInfo(CMProfileRef prof, UInt32 *deviceChannels, OSType *deviceColorSpace, OSType *PCSColorSpace,
	 ...
	 */
	EXTERN_API(CMError)
	CMGetNamedColorValue(CMProfileRef prof, StringPtr name, CMColor *deviceColor, CMColor *PCSColor)
	 ...
	 */
	EXTERN_API(CMError)
	CMGetNamedColorName(CMProfileRef prof, UInt32 index, StringPtr name) FOURWORDINLINE(0x203C, 0x000C, 0x004A, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	NCWNewColorWorld(CMWorldRef *cw, CMProfileRef src, CMProfileRef dst) FOURWORDINLINE(0x203C, 0x000C, 0x0014, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CWConcatColorWorld(CMWorldRef *cw, CMConcatProfileSet *profileSet) FOURWORDINLINE(0x203C, 0x0008, 0x0015, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CWNewLinkProfile(CMProfileRef *prof, const CMProfileLocation *targetLocation, CMConcatProfileSet *profileSet)
	 ...
	 */
	EXTERN_API(CMError)
	NCWConcatColorWorld(CMWorldRef *cw, NCMConcatProfileSet *profileSet, CMConcatCallBackUPP proc, void *refCon)
	 ...
	 */
	EXTERN_API(CMError)
	NCWNewLinkProfile(CMProfileRef *prof, const CMProfileLocation *targetLocation, NCMConcatProfileSet *profileSet,
					  CMConcatCallBackUPP proc, void *refCon) FOURWORDINLINE(0x203C, 0x000C, 0x0062, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CWMatchColors(CMWorldRef cw, CMColor *myColors, UInt32 count) FOURWORDINLINE(0x203C, 0x000C, 0x0002, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CWMatchBitmap(CMWorldRef cw, CMBitmap *bitmap, CMBitmapCallBackUPP progressProc, void *refCon,
	 ...
	 */
	EXTERN_API(CMError)
	CWCheckBitmap(CMWorldRef cw, const CMBitmap *bitmap, CMBitmapCallBackUPP progressProc, void *refCon,
...
/* Quickdraw-specific matching */
	 ...
	 */
	EXTERN_API(CMError)
	CWMatchPixMap(CMWorldRef cw, PixMap *myPixMap, CMBitmapCallBackUPP progressProc, void *refCon)
	 ...
	 */
	EXTERN_API(CMError)
	CWCheckPixMap(CMWorldRef cw, PixMap *myPixMap, CMBitmapCallBackUPP progressProc, void *refCon, BitMap *resultBitMap)
	 ...
	 */
	EXTERN_API(CMError)
	NCMUseProfileComment(CMProfileRef prof, UInt32 flags) FOURWORDINLINE(0x203C, 0x0008, 0x003B, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CWMatchHBITMAP(CMWorldRef cw, void *hBitmap, CMBitmapCallBackUPP progressProc, void *refCon);
	 ...
	 */
	EXTERN_API(CMError)
	CMCreateProfileIdentifier(CMProfileRef prof, CMProfileIdentifierPtr ident, UInt32 *size)
	 ...
	 */
	EXTERN_API(CMError)
	CMSetDefaultProfileBySpace(OSType dataColorSpace, CMProfileRef prof) FOURWORDINLINE(0x203C, 0x0008, 0x005B, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CMGetProfileByAVID(CMDisplayIDType theID, CMProfileRef *prof) FOURWORDINLINE(0x203C, 0x0008, 0x005C, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CMSetProfileByAVID(CMDisplayIDType theID, CMProfileRef prof) FOURWORDINLINE(0x203C, 0x0008, 0x005D, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CMGetDefaultProfileByUse(OSType use, CMProfileRef *prof) FOURWORDINLINE(0x203C, 0x0008, 0x0069, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CMSetDefaultProfileByUse(OSType use, CMProfileRef prof) FOURWORDINLINE(0x203C, 0x0008, 0x0079, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CMNewProfileSearch(CMSearchRecord *searchSpec, void *refCon, UInt32 *count, CMProfileSearchRef *searchResult)
	 ...
	 */
	EXTERN_API(CMError)
	CMSearchGetIndProfile(CMProfileSearchRef search, UInt32 index, CMProfileRef *prof)
	 ...
	 */
	EXTERN_API(CMError)
	CMSearchGetIndProfileFileSpec(CMProfileSearchRef search, UInt32 index, FSSpec *profileFile)
	 ...
	 */
	EXTERN_API(CMError)
	CMProfileIdentifierFolderSearch(CMProfileIdentifierPtr ident, UInt32 *matchedCount,
	 ...
	 */
	EXTERN_API(CMError)
	CMProfileIdentifierListSearch(CMProfileIdentifierPtr ident, CMProfileRef *profileList, UInt32 listSize,
	 ...
	 */
	EXTERN_API(CMError)
	CMIterateColorSyncFolder(CMProfileIterateUPP proc, UInt32 *seed, UInt32 *count, void *refCon)
	 ...
	 */
	EXTERN_API(CMError)
	NCMUnflattenProfile(CMProfileLocation *targetLocation, CMFlattenUPP proc, void *refCon,
...
/* Utilities */
	 ...
	 */
	EXTERN_API(CMError)
	CMGetColorSyncFolderSpec(short vRefNum, Boolean createFolder, short *foundVRefNum, long *foundDirID)
	 ...
	 */
	EXTERN_API(CMError)
	CMGetCWInfo(CMWorldRef cw, CMCWInfoRecord *info) FOURWORDINLINE(0x203C, 0x0008, 0x001A, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CMConvertProfile2to1(CMProfileRef profv2, CMProfileHandle *profv1) FOURWORDINLINE(0x203C, 0x0008, 0x0045, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CMGetPreferredCMM(OSType *cmmType, Boolean *preferredCMMnotfound) FOURWORDINLINE(0x203C, 0x0008, 0x005E, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CMIterateCMMInfo(CMMIterateUPP proc, UInt32 *count, void *refCon) FOURWORDINLINE(0x203C, 0x000C, 0x0063, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CMConvertXYZToLab(const CMColor *src, const CMXYZColor *white, CMColor *dst, UInt32 count)
		FOURWORDINLINE(0x203C, 0x0010, 0x004B, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CMConvertLabToXYZ(const CMColor *src, const CMXYZColor *white, CMColor *dst, UInt32 count)
		FOURWORDINLINE(0x203C, 0x0010, 0x004C, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CMConvertXYZToLuv(const CMColor *src, const CMXYZColor *white, CMColor *dst, UInt32 count)
		FOURWORDINLINE(0x203C, 0x0010, 0x004D, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CMConvertLuvToXYZ(const CMColor *src, const CMXYZColor *white, CMColor *dst, UInt32 count)
		FOURWORDINLINE(0x203C, 0x0010, 0x004E, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CMConvertXYZToYxy(const CMColor *src, CMColor *dst, UInt32 count) FOURWORDINLINE(0x203C, 0x000C, 0x004F, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CMConvertYxyToXYZ(const CMColor *src, CMColor *dst, UInt32 count) FOURWORDINLINE(0x203C, 0x000C, 0x0050, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CMConvertRGBToHLS(const CMColor *src, CMColor *dst, UInt32 count) FOURWORDINLINE(0x203C, 0x000C, 0x0051, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CMConvertHLSToRGB(const CMColor *src, CMColor *dst, UInt32 count) FOURWORDINLINE(0x203C, 0x000C, 0x0052, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CMConvertRGBToHSV(const CMColor *src, CMColor *dst, UInt32 count) FOURWORDINLINE(0x203C, 0x000C, 0x0053, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CMConvertHSVToRGB(const CMColor *src, CMColor *dst, UInt32 count) FOURWORDINLINE(0x203C, 0x000C, 0x0054, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CMConvertRGBToGray(const CMColor *src, CMColor *dst, UInt32 count) FOURWORDINLINE(0x203C, 0x000C, 0x0055, 0xABEE);
	 ...
	 */
	EXTERN_API(CMError)
	CMConvertXYZToFixedXYZ(const CMXYZColor *src, CMFixedXYZColor *dst, UInt32 count)
	 ...
	 */
	EXTERN_API(CMError)
	CMConvertFixedXYZToXYZ(const CMFixedXYZColor *src, CMXYZColor *dst, UInt32 count)
	 ...
	 */
	EXTERN_API(CMError)
	CMConvertXYZToXYZ(const CMColor *src, const CMXYZColor *srcIlluminant, CMColor *dst,
					  const CMXYZColor *dstIlluminant, CMChromaticAdaptation method, UInt32 count);
	 ...
	 */
	EXTERN_API(CMError)
	CMGetPS2ColorSpace(CMProfileRef srcProf, UInt32 flags, CMFlattenUPP proc, void *refCon,
	 ...
	 */
	EXTERN_API(CMError)
	CMGetPS2ColorRenderingIntent(CMProfileRef srcProf, UInt32 flags, CMFlattenUPP proc, void *refCon,
	 ...
	 */
	EXTERN_API(CMError)
	CMGetPS2ColorRendering(CMProfileRef srcProf, CMProfileRef dstProf, UInt32 flags, CMFlattenUPP proc, void *refCon,
	 ...
	 */
	EXTERN_API(CMError)
	CMGetPS2ColorRenderingVMSize(CMProfileRef srcProf, CMProfileRef dstProf, UInt32 *vmSize,
...
/* ColorSync 1.0 functions which have parallel 2.0 counterparts */
	 ...
	 */
	EXTERN_API(CMError)
	ConcatenateProfiles(CMProfileHandle thru, CMProfileHandle dst, CMProfileHandle *newDst)
...
/* ProfileResponder functions */
	 ...
	 */
	EXTERN_API(CMError)
	GetProfile(OSType deviceType, long refNum, CMProfileHandle aProfile, CMProfileHandle *returnedProfile)
	 ...
	 */
	EXTERN_API(CMError)
	SetProfileDescription(OSType deviceType, long refNum, long deviceData, CMProfileHandle hProfile)
	 ...
	 */
	EXTERN_API(CMError)
	GetIndexedProfile(OSType deviceType, long refNum, CMProfileSearchRecordHandle search,
					  CMProfileHandle *returnProfile, long *index) FOURWORDINLINE(0x203C, 0x0014, 0x0012, 0xABEE);
...
#define GetColorSyncFolderSpec(vRefNum, createFolder, foundVRefNum, foundDirID) \
