...
typedef int pid_t;
	...
	enum
	{
		...
		bSupportsMultiScriptNames =
			6, /* volume supports file/directory/volume names with characters from multiple script systems */
	...
	struct IOParam
	{
		...
		Ptr ioMisc; /*Rename: new name (GetEOF,SetEOF: logical end of file) (Open: optional ptr to buffer) (SetFileType:
					   new type)*/
	...
	*/
	...
	enum
	{
		...
		kAFPTagTypeDNS =
			0x04 /* DNS name in  address:port format   (total length variable up to 254 chars of dns name)          */
	};
	...
	{
		return (IOCompletionUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppIOCompletionProcInfo,
...
#endif
	EXTERN_API_C(void)
	InvokeIOCompletionUPP(ParmBlkPtr paramBlock, IOCompletionUPP userUPP) ONEWORDINLINE(0x4E91);
...
#pragma parameter __D0 PBCatSearchAsync(__A0)
	 ...
	 */
	EXTERN_API(OSErr)
	Create(ConstStr255Param fileName, short vRefNum, OSType creator, OSType fileType);
...
#pragma parameter __D0 PBMakeFSSpecAsync(__A0)
	 ...
	 */
	EXTERN_API(OSErr)
	HOpen(short vRefNum, long dirID, ConstStr255Param fileName, SInt8 permission, short *refNum);
	 ...
	 */
	EXTERN_API(OSErr)
	HOpenDF(short vRefNum, long dirID, ConstStr255Param fileName, SInt8 permission, short *refNum);
	 ...
	 */
	EXTERN_API(OSErr)
	HOpenRF(short vRefNum, long dirID, ConstStr255Param fileName, SInt8 permission, short *refNum);
	 ...
	 */
	EXTERN_API(OSErr)
	HCreate(short vRefNum, long dirID, ConstStr255Param fileName, OSType creator, OSType fileType);
	 ...
	 */
	EXTERN_API(OSErr)
	DirCreate(short vRefNum, long parentDirID, ConstStr255Param directoryName, long *createdDirID);
	 ...
	 */
	EXTERN_API(OSErr)
	HGetFInfo(short vRefNum, long dirID, ConstStr255Param fileName, FInfo *fndrInfo);
	 ...
	 */
	EXTERN_API(OSErr)
	HSetFInfo(short vRefNum, long dirID, ConstStr255Param fileName, const FInfo *fndrInfo);
	 ...
	 */
	EXTERN_API(OSErr)
	HRename(short vRefNum, long dirID, ConstStr255Param oldName, ConstStr255Param newName);
	 ...
	 */
	EXTERN_API(OSErr)
	CatMove(short vRefNum, long dirID, ConstStr255Param oldName, long newDirID, ConstStr255Param newName);
...
#pragma parameter __D0 PBVolumeMount(__A0)
	 ...
	 */
	EXTERN_API(OSErr)
	FSMakeFSSpec(short vRefNum, long dirID, ConstStr255Param fileName, FSSpec *spec) TWOWORDINLINE(0x7001, 0xAA52);
	 ...
	 */
	EXTERN_API(OSErr)
	FSpOpenDF(const FSSpec *spec, SInt8 permission, short *refNum) TWOWORDINLINE(0x7002, 0xAA52);
	 ...
	 */
	EXTERN_API(OSErr)
	FSpOpenRF(const FSSpec *spec, SInt8 permission, short *refNum) TWOWORDINLINE(0x7003, 0xAA52);
	 ...
	 */
	EXTERN_API(OSErr)
	FSpCreate(const FSSpec *spec, OSType creator, OSType fileType, ScriptCode scriptTag) TWOWORDINLINE(0x7004, 0xAA52);
	 ...
	 */
	EXTERN_API(OSErr)
	FSpDirCreate(const FSSpec *spec, ScriptCode scriptTag, long *createdDirID) TWOWORDINLINE(0x7005, 0xAA52);
	 ...
	 */
	EXTERN_API(OSErr)
	FSpSetFInfo(const FSSpec *spec, const FInfo *fndrInfo) TWOWORDINLINE(0x7008, 0xAA52);
	 ...
	 */
	EXTERN_API(OSErr)
	FSpRename(const FSSpec *spec, ConstStr255Param newName) TWOWORDINLINE(0x700B, 0xAA52);
	 ...
	 */
	EXTERN_API(OSErr)
	FSpCatMove(const FSSpec *source, const FSSpec *dest) TWOWORDINLINE(0x700C, 0xAA52);
	 ...
	 */
	EXTERN_API(OSErr)
	FSpExchangeFiles(const FSSpec *source, const FSSpec *dest) TWOWORDINLINE(0x700F, 0xAA52);
...
typedef struct FSRef FSRef;
	...
	struct FSVolumeInfo
	{
		...
		UInt32 nextCatalogID;  /* next unused catalog node ID ooo OYG ooo need to make HFSVolumes.h work Should be
								  HFSCatalogNodeID*/
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	FSpMakeFSRef(const FSSpec *source, FSRef *newRef) THREEWORDINLINE(0x303C, 0x041A, 0xAA52);
...
#pragma parameter PBMakeFSRefAsync(__A0)
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	FSMakeFSRefUnicode(const FSRef *parentRef, UniCharCount nameLength, const UniChar *name,
					   TextEncoding textEncodingHint, FSRef *newRef) THREEWORDINLINE(0x303C, 0x0A1B, 0xAA52);
...
#pragma parameter PBMakeFSRefUnicodeAsync(__A0)
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	FSCompareFSRefs(const FSRef *ref1, const FSRef *ref2) THREEWORDINLINE(0x303C, 0x0435, 0xAA52);
...
#pragma parameter PBCompareFSRefsAsync(__A0)
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	FSCreateFileUnicode(const FSRef *parentRef, UniCharCount nameLength, const UniChar *name,
						FSCatalogInfoBitmap whichInfo, const FSCatalogInfo *catalogInfo, /* can be NULL */
...
#pragma parameter PBMoveObjectAsync(__A0)
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	FSExchangeObjects(const FSRef *ref, const FSRef *destRef) THREEWORDINLINE(0x303C, 0x0421, 0xAA52);
...
#pragma parameter PBRenameUnicodeAsync(__A0)
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	FSGetCatalogInfo(const FSRef *ref, FSCatalogInfoBitmap whichInfo, FSCatalogInfo *catalogInfo, /* can be NULL */
...
#pragma parameter PBSetCatalogInfoAsync(__A0)
	...
	*/
	...
	FSOpenIterator(const FSRef *container, FSIteratorFlags iteratorFlags, FSIterator *iterator)
		THREEWORDINLINE(0x303C, 0x0624, 0xAA52);
...
#pragma parameter PBCloseIteratorAsync(__A0)
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	FSGetCatalogInfoBulk(FSIterator iterator, ItemCount maximumObjects, ItemCount *actualObjects,
						 Boolean *containerChanged,									 /* can be NULL */
						 FSCatalogInfoBitmap whichInfo, FSCatalogInfo *catalogInfos, /* can be NULL */
...
#pragma parameter PBGetCatalogInfoBulkAsync(__A0)
	...
	/*
			...
			->  searchParams    The criteria that controls the matching, including timeout, a bitmap
													controlling the fields to compare, and the (Unicode) name to
	   compare. Note: The catalogInfo, refs, specs, and names are all optional outputs; if you don't want that
	   particular output, set its pointer to NULL.
	*/
	/*
	 *  FSCatalogSearch()
	 *
	 ...
	 */
	EXTERN_API(OSErr)
	FSCatalogSearch(FSIterator iterator, const FSSearchParams *searchCriteria, ItemCount maximumObjects,
					ItemCount *actualObjects, Boolean *containerChanged,		/* can be NULL */
					FSCatalogInfoBitmap whichInfo, FSCatalogInfo *catalogInfos, /* can be NULL */
					FSRef *refs,												/* can be NULL */
					FSSpec *specs,												/* can be NULL */
...
#pragma parameter PBDeleteForkAsync(__A0)
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	FSIterateForks(const FSRef *ref, CatPositionRec *forkIterator, HFSUniStr255 *forkName, /* can be NULL */
...
#pragma parameter PBIterateForksAsync(__A0)
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	FSOpenFork(const FSRef *ref, UniCharCount forkNameLength, const UniChar *forkName, /* can be NULL */
			   SInt8 permissions, SInt16 *forkRefNum) THREEWORDINLINE(0x303C, 0x0928, 0xAA52);
...
#pragma parameter PBOpenForkAsync(__A0)
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	FSReadFork(SInt16 forkRefNum, UInt16 positionMode, SInt64 positionOffset, ByteCount requestCount, void *buffer,
...
#pragma parameter PBReadForkAsync(__A0)
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	FSWriteFork(SInt16 forkRefNum, UInt16 positionMode, SInt64 positionOffset, ByteCount requestCount,
				const void *buffer, ByteCount *actualCount) /* can be NULL */ THREEWORDINLINE(0x303C, 0x0A2A, 0xAA52);
...
#pragma parameter PBWriteForkAsync(__A0)
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	FSGetForkPosition(SInt16 forkRefNum, SInt64 *position) THREEWORDINLINE(0x303C, 0x032B, 0xAA52);
...
#pragma parameter PBSetForkPositionAsync(__A0)
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	FSGetForkSize(SInt16 forkRefNum, SInt64 *forkSize) THREEWORDINLINE(0x303C, 0x032D, 0xAA52);
...
#pragma parameter PBSetForkSizeAsync(__A0)
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	FSAllocateFork(SInt16 forkRefNum, FSAllocationFlags flags, UInt16 positionMode, SInt64 positionOffset,
				   UInt64 requestCount, UInt64 *actualCount) /* can be NULL */ THREEWORDINLINE(0x303C, 0x092F, 0xAA52);
...
#pragma parameter PBCloseForkAsync(__A0)
	...
	/*
			...
			->  volumeRefNum    Used when desiredRefNum is zero on input.  Set to 0 to iterate over all
													volumes, or set to a FSVolumeRefNum to limit iteration to that
	   volume.
			<>  iterator        Used when desiredRefNum is zero on input.  Set to 0 before iterating.
													Pass the iterator returned by the previous call to continue
	   iterating.
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	FSGetForkCBInfo(SInt16 desiredRefNum, FSVolumeRefNum volume, SInt16 *iterator, /* can be NULL */
...
#pragma parameter PBGetForkCBInfoAsync(__A0)
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	FSGetVolumeInfo(FSVolumeRefNum volume, ItemCount volumeIndex, FSVolumeRefNum *actualVolume, /* can be NULL */
					FSVolumeInfoBitmap whichInfo, FSVolumeInfo *info,							/* can be NULL */
...
#pragma parameter PBGetVolumeInfoAsync(__A0)
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	FSSetVolumeInfo(FSVolumeRefNum volume, FSVolumeInfoBitmap whichInfo, const FSVolumeInfo *info)
...
#pragma parameter PBSetVolumeInfoAsync(__A0)
	...
	*/
	 ...
	 */
	EXTERN_API(OSStatus)
	FSPathMakeRef(const UInt8 *path, FSRef *ref, Boolean *isDirectory); /* can be NULL */
	 ...
	 */
	typedef CALLBACK_API_C(void, FNSubscriptionProcPtr)(FNMessage message, OptionBits flags, void *refcon,
...
#define DisposeFNSubscriptionUPP(userUPP)
	 ...
	 */
	EXTERN_API_C(void)
	InvokeFNSubscriptionUPP(FNMessage message, OptionBits flags, void *refcon, FNSubscriptionRef subscription,
							FNSubscriptionUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void) InvokeFNSubscriptionUPP(FNMessage message, OptionBits flags, void *refcon,
													  FNSubscriptionRef subscription, FNSubscriptionUPP userUPP)
	{
...
#define InvokeFNSubscriptionUPP(message, flags, refcon, subscription, userUPP) \
	 ...
	 */
	EXTERN_API_C(OSStatus)
	FSEjectVolumeSync(FSVolumeRefNum vRefNum, OptionBits flags, pid_t *dissenter); /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	FSGetAsyncEjectStatus(FSVolumeOperation volumeOp, FSEjectStatus *status, OSStatus *volumeOpStatus, /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	FSCopyDiskIDForVolume(FSVolumeRefNum vRefNum, CFStringRef *diskID);
