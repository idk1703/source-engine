...
#define AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER_BUT_DEPRECATED_IN_MAC_OS_X_VERSION_10_5 \
	...
	enum
	{
		...
		k4444YpCbCrA8RCodecType = FOUR_CHAR_CODE(
	...
	enum
	{
		...
		k4444YpCbCrA8RPixelFormat = FOUR_CHAR_CODE('r408') /* Component Y'CbCrA 8-bit 4:4:4:4, rendering format. full
															  range alpha, zero biased yuv, ordered A Y' Cb Cr */
	};

	/* Supported by QTNewGWorld in QuickTime 6.0 and later */
	enum
	{
		kYUV420PixelFormat = FOUR_CHAR_CODE('y420') /* Planar Component Y'CbCr 8-bit 4:2:0.  PixMap baseAddr points to a
													   big-endian PlanarPixmapInfoYUV420 struct; see ImageCodec.i. */
	};
	...
	enum
	{
		...
		codecInfoHasEffectParameterList =
			(1L << 18), /* codec implements get effects parameter list call, once was codecInfoDoesSkew */
...
#define bestCompressionCodec ((CodecComponent)-3)
	...
	enum
	{
		...
		codecCompletionDecoded = (1 << 10), /* codec has decoded this frame; if it is cancelled and rescheduled, set
											   icmFrameAlreadyDecoded in ICMFrameTimeRecord.flags */
		codecCompletionNotDisplayable =
			(1 << 11), /* the frame may still be scheduled for decode, but will not be able to be displayed because the
						  buffer containing it will need to be recycled to display earlier frames. */
		codecCompletionNotDrawn =
			(1 << 12) /* set in conjunction with codecCompletionDest to indicate that the frame was not drawn */
	};
	...
	typedef CALLBACK_API(void, StdPixProcPtr)(PixMap *src, Rect *srcRect, MatrixRecord *matrix, short mode,
											  RgnHandle mask, PixMap *matte, Rect *matteRect, short flags);
	typedef CALLBACK_API(void, QDPixProcPtr)(PixMap *src, Rect *srcRect, MatrixRecord *matrix, short mode,
											 RgnHandle mask, PixMap *matte, Rect *matteRect, short flags);
	...
	typedef CALLBACK_API(OSErr, ICMConvertDataFormatProcPtr)(void *refCon, long flags, Handle desiredFormat,
															 Handle sourceDataFormat, void *srcData, long srcDataSize,
...
#define NewICMFlushUPP(userRoutine) \
	...
	{
		return (ICMCompletionUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppICMCompletionProcInfo,
...
#define NewQDPixUPP(userRoutine) \
	(QDPixUPP) NewRoutineDescriptor((ProcPtr)(userRoutine), uppQDPixProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (ICMAlignmentUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppICMAlignmentProcInfo,
													 GetCurrentArchitecture());
	}
#else
#define NewICMAlignmentUPP(userRoutine) \
	...
	{
		return (ICMCursorShieldedUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppICMCursorShieldedProcInfo,
														  GetCurrentArchitecture());
	}
#else
#define NewICMCursorShieldedUPP(userRoutine) \
	(ICMCursorShieldedUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppICMCursorShieldedProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (ICMMemoryDisposedUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppICMMemoryDisposedProcInfo,
														  GetCurrentArchitecture());
	}
#else
#define NewICMMemoryDisposedUPP(userRoutine) \
	(ICMMemoryDisposedUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppICMMemoryDisposedProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (ICMConvertDataFormatUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppICMConvertDataFormatProcInfo,
															 GetCurrentArchitecture());
	}
#else
#define NewICMConvertDataFormatUPP(userRoutine) \
	(ICMConvertDataFormatUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppICMConvertDataFormatProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define InvokeICMDataUPP(dataP, bytesNeeded, refcon, userUPP) \
	(OSErr) CALL_THREE_PARAMETER_UPP((userUPP), uppICMDataProcInfo, (dataP), (bytesNeeded), (refcon))
#endif
#endif
...
#define InvokeICMFlushUPP(data, bytesAdded, refcon, userUPP) \
	(OSErr) CALL_THREE_PARAMETER_UPP((userUPP), uppICMFlushProcInfo, (data), (bytesAdded), (refcon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(void)
	InvokeICMCompletionUPP(OSErr result, short flags, long refcon, ICMCompletionUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeICMCompletionUPP(result, flags, refcon, userUPP) \
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeICMProgressUPP(short message, Fixed completeness, long refcon, ICMProgressUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeICMProgressUPP(message, completeness, refcon, userUPP) \
	(OSErr) CALL_THREE_PARAMETER_UPP((userUPP), uppICMProgressProcInfo, (message), (completeness), (refcon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(void)
	InvokeStdPixUPP(PixMap *src, Rect *srcRect, MatrixRecord *matrix, short mode, RgnHandle mask, PixMap *matte,
...
#define InvokeStdPixUPP(src, srcRect, matrix, mode, mask, matte, matteRect, flags, userUPP)                     \
	CALL_EIGHT_PARAMETER_UPP((userUPP), uppStdPixProcInfo, (src), (srcRect), (matrix), (mode), (mask), (matte), \
							 (matteRect), (flags))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(void)
	InvokeQDPixUPP(PixMap *src, Rect *srcRect, MatrixRecord *matrix, short mode, RgnHandle mask, PixMap *matte,
...
#define InvokeQDPixUPP(src, srcRect, matrix, mode, mask, matte, matteRect, flags, userUPP)                     \
	CALL_EIGHT_PARAMETER_UPP((userUPP), uppQDPixProcInfo, (src), (srcRect), (matrix), (mode), (mask), (matte), \
							 (matteRect), (flags))
#endif
#endif
...
#define InvokeICMAlignmentUPP(rp, refcon, userUPP) \
	 ...
	 */
	EXTERN_API_C(void)
	InvokeICMCursorShieldedUPP(const Rect *r, void *refcon, long flags, ICMCursorShieldedUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void)
		InvokeICMCursorShieldedUPP(const Rect *r, void *refcon, long flags, ICMCursorShieldedUPP userUPP)
...
#define InvokeICMCursorShieldedUPP(r, refcon, flags, userUPP) \
	 ...
	 */
	EXTERN_API_C(void)
	InvokeICMMemoryDisposedUPP(Ptr memoryBlock, void *refcon, ICMMemoryDisposedUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeICMMemoryDisposedUPP(memoryBlock, refcon, userUPP) \
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeICMConvertDataFormatUPP(void *refCon, long flags, Handle desiredFormat, Handle sourceDataFormat,
	...
	inline DEFINE_API_C(OSErr)
		InvokeICMConvertDataFormatUPP(void *refCon, long flags, Handle desiredFormat, Handle sourceDataFormat,
									  ...
									  ICMConvertDataFormatUPP userUPP)
	{
		return (OSErr)CALL_EIGHT_PARAMETER_UPP(userUPP, uppICMConvertDataFormatProcInfo, refCon, flags, desiredFormat,
											   sourceDataFormat, srcData, srcDataSize, dstData, dstDataSize);
	}
#else
#define InvokeICMConvertDataFormatUPP(refCon, flags, desiredFormat, sourceDataFormat, srcData, srcDataSize, dstData, \
									  dstDataSize, userUPP)                                                          \
	(OSErr) CALL_EIGHT_PARAMETER_UPP((userUPP), uppICMConvertDataFormatProcInfo, (refCon), (flags), (desiredFormat), \
									 (sourceDataFormat), (srcData), (srcDataSize), (dstData), (dstDataSize))
#endif
#endif
...
#define CallStdPixProc(userRoutine, src, srcRect, matrix, mode, mask, matte, matteRect, flags) \
	InvokeStdPixUPP(src, srcRect, matrix, mode, mask, matte, matteRect, flags, userRoutine)
#define CallQDPixProc(userRoutine, src, srcRect, matrix, mode, mask, matte, matteRect, flags) \
	InvokeQDPixUPP(src, srcRect, matrix, mode, mask, matte, matteRect, flags, userRoutine)
...
#define CallICMConvertDataFormatProc(userRoutine, refCon, flags, desiredFormat, sourceDataFormat, srcData,       \
									 srcDataSize, dstData, dstDataSize)                                          \
	InvokeICMConvertDataFormatUPP(refCon, flags, desiredFormat, sourceDataFormat, srcData, srcDataSize, dstData, \
								  dstDataSize, userRoutine)
	 ...
	 */
	EXTERN_API(OSErr)
	GetMaxCompressionSize(PixMapHandle src, const Rect *srcRect, short colorDepth, CodecQ quality, CodecType cType,
	 ...
	 */
	EXTERN_API(OSErr)
	GetCSequenceMaxCompressionSize(ImageSequence seqID, PixMapHandle src, long *size);
	 ...
	 */
	EXTERN_API(OSErr)
	GetCompressionTime(PixMapHandle src, const Rect *srcRect, short colorDepth, CodecType cType,
	 ...
	 */
	EXTERN_API(OSErr)
	CompressImage(PixMapHandle src, const Rect *srcRect, CodecQ quality, CodecType cType, ImageDescriptionHandle desc,
				  Ptr data);
	 ...
	 */
	EXTERN_API(OSErr)
	FCompressImage(PixMapHandle src, const Rect *srcRect, short colorDepth, CodecQ quality, CodecType cType,
				   CompressorComponent codec, CTabHandle ctable, CodecFlags flags, long bufferSize,
				   ICMFlushProcRecordPtr flushProc, ICMProgressProcRecordPtr progressProc, ImageDescriptionHandle desc,
				   Ptr data);
	 ...
	 */
	EXTERN_API(OSErr)
	DecompressImage(Ptr data, ImageDescriptionHandle desc, PixMapHandle dst, const Rect *srcRect, const Rect *dstRect,
	...
	FDecompressImage(Ptr data, ImageDescriptionHandle desc, PixMapHandle dst, const Rect *srcRect,
					 MatrixRecordPtr matrix, short mode, RgnHandle mask, PixMapHandle matte, const Rect *matteRect,
					 CodecQ accuracy, DecompressorComponent codec, long bufferSize, ICMDataProcRecordPtr dataProc,
	 ...
	 */
	EXTERN_API(OSErr)
	CompressSequenceBegin(ImageSequence *seqID, PixMapHandle src, PixMapHandle prev, const Rect *srcRect,
						  const Rect *prevRect, short colorDepth, CodecType cType, CompressorComponent codec,
						  CodecQ spatialQuality, CodecQ temporalQuality, long keyFrameRate, CTabHandle ctable,
	 ...
	 */
	EXTERN_API(OSErr)
	CompressSequenceFrame(ImageSequence seqID, PixMapHandle src, const Rect *srcRect, CodecFlags flags, Ptr data,
						  long *dataSize, UInt8 *similarity, ICMCompletionProcRecordPtr asyncCompletionProc);
	 ...
	 */
	EXTERN_API(OSErr)
	DecompressSequenceBegin(ImageSequence *seqID, ImageDescriptionHandle desc, CGrafPtr port, GDHandle gdh,
							const Rect *srcRect, MatrixRecordPtr matrix, short mode, RgnHandle mask, CodecFlags flags,
							CodecQ accuracy, DecompressorComponent codec);

	/* For video decompression, consider using ICMDecompressionSessionCreate etc. instead of DecompressSequenceBeginS
	 * etc. */
	/*
	 ...
	 */
	EXTERN_API(OSErr)
	DecompressSequenceBeginS(ImageSequence *seqID, ImageDescriptionHandle desc, Ptr data, long dataSize, CGrafPtr port,
							 GDHandle gdh, const Rect *srcRect, MatrixRecordPtr matrix, short mode, RgnHandle mask,
							 CodecFlags flags, CodecQ accuracy, DecompressorComponent codec);
	 ...
	 */
	EXTERN_API(OSErr)
	DecompressSequenceFrame(ImageSequence seqID, Ptr data, CodecFlags inFlags, CodecFlags *outFlags,
	 ...
	 */
	EXTERN_API(OSErr)
	DecompressSequenceFrameS(ImageSequence seqID, Ptr data, long dataSize, CodecFlags inFlags, CodecFlags *outFlags,
							 ICMCompletionProcRecordPtr asyncCompletionProc);
	 ...
	 */
	EXTERN_API(OSErr)
	DecompressSequenceFrameWhen(ImageSequence seqID, Ptr data, long dataSize, CodecFlags inFlags, CodecFlags *outFlags,
								ICMCompletionProcRecordPtr asyncCompletionProc, const ICMFrameTimeRecord *frameTime);
	 ...
	 */
	EXTERN_API(OSErr)
	SetDSequenceDataProc(ImageSequence seqID, ICMDataProcRecordPtr dataProc, long bufferSize);
	 ...
	 */
	EXTERN_API(OSErr)
	SetCSequenceFlushProc(ImageSequence seqID, ICMFlushProcRecordPtr flushProc, long bufferSize);
	 ...
	 */
	EXTERN_API(OSErr)
	CDSequenceEquivalentImageDescription(ImageSequence seqID, ImageDescriptionHandle newDesc, Boolean *equivalent);
	 ...
	 */
	EXTERN_API(OSErr)
	CDSequenceEquivalentImageDescriptionS(ImageSequence seqID, ImageDescriptionHandle newDesc, Boolean *equivalent,
										  Boolean *canSwitch);
	 ...
	 */
	EXTERN_API(OSErr)
	ReplaceDSequenceImageDescription(ImageSequence seqID, ImageDescriptionHandle newDesc);
	 ...
	 */
	EXTERN_API(OSErr)
	GetCompressedImageSize(ImageDescriptionHandle desc, Ptr data, long bufferSize, ICMDataProcRecordPtr dataProc,
						   long *dataSize);
	...
	enum
	{
		kImageDescriptionSampleFormat =
			FOUR_CHAR_CODE('idfm'), /* image description extension describing sample format*/
		kImageDescriptionClassicAtomFormat =
			FOUR_CHAR_CODE('atom'), /* sample contains classic atom structure (ie, GX codec and Curve codec)*/
		...
		kImageDescriptionAlternateCodec =
			FOUR_CHAR_CODE('subs'), /* image description extension containing the OSType of a substitute codec should
									   the main codec not be available*/
		kImageDescriptionColorSpace =
			FOUR_CHAR_CODE('cspc') /* image description extension containing an OSType naming the native pixel format of
									  an image (only used for pixel formats not supported by classic Color QuickDraw)*/
	};
	 ...
	 */
	EXTERN_API(OSErr)
	GetImageDescriptionExtension(ImageDescriptionHandle desc, Handle *extension, long idType, long index);
	 ...
	 */
	EXTERN_API(OSErr)
	AddImageDescriptionExtension(ImageDescriptionHandle desc, Handle extension, long idType);
	 ...
	 */
	EXTERN_API(OSErr)
	RemoveImageDescriptionExtension(ImageDescriptionHandle desc, long idType, long index);
	 ...
	 */
	EXTERN_API(OSErr)
	CountImageDescriptionExtensionType(ImageDescriptionHandle desc, long idType, long *count);
	 ...
	 */
	EXTERN_API(OSErr)
	FindCodec(CodecType cType, CodecComponent specCodec, CompressorComponent *compressor,
	 ...
	 */
	EXTERN_API(OSErr)
	FCompressPicture(PicHandle srcPicture, PicHandle dstPicture, short colorDepth, CTabHandle ctable, CodecQ quality,
					 short doDither, short compressAgain, ICMProgressProcRecordPtr progressProc, CodecType cType,
	 ...
	 */
	EXTERN_API(OSErr)
	FCompressPictureFile(short srcRefNum, short dstRefNum, short colorDepth, CTabHandle ctable, CodecQ quality,
						 short doDither, short compressAgain, ICMProgressProcRecordPtr progressProc, CodecType cType,
						 CompressorComponent codec);
	 ...
	 */
	EXTERN_API(OSErr)
	DrawPictureFile(short refNum, const Rect *frame, ICMProgressProcRecordPtr progressProc);
	 ...
	 */
	EXTERN_API(OSErr)
	TrimImage(ImageDescriptionHandle desc, Ptr inData, long inBufferSize, ICMDataProcRecordPtr dataProc, Ptr outData,
			  long outBufferSize, ICMFlushProcRecordPtr flushProc, Rect *trimRect,
			  ICMProgressProcRecordPtr progressProc);
	 ...
	 */
	EXTERN_API(OSErr)
	ConvertImage(ImageDescriptionHandle srcDD, Ptr srcData, short colorDepth, CTabHandle ctable, CodecQ accuracy,
				 CodecQ quality, CodecType cType, CodecComponent codec, ImageDescriptionHandle dstDD, Ptr dstData);
	...
	GetCompressedPixMapInfo(PixMapPtr pix, ImageDescriptionHandle *desc, Ptr *data, long *bufferSize,
							ICMDataProcRecord *dataProc, ICMProgressProcRecord *progressProc);
	...
	SetCompressedPixMapInfo(PixMapPtr pix, ImageDescriptionHandle desc, Ptr data, long bufferSize,
							ICMDataProcRecordPtr dataProc, ICMProgressProcRecordPtr progressProc);
	 ...
	 */
	EXTERN_API(void)
	StdPix(PixMapPtr src, const Rect *srcRect, MatrixRecordPtr matrix, short mode, RgnHandle mask, PixMapPtr matte,
...
***********/
	 ...
	 */
	EXTERN_API(void)
	SFGetFilePreview(Point where, ConstStr255Param prompt, FileFilterUPP fileFilter, short numTypes,
					 ConstSFTypeListPtr typeList, DlgHookUPP dlgHook, SFReply *reply);
	 ...
	 */
	EXTERN_API(void)
	SFPGetFilePreview(Point where, ConstStr255Param prompt, FileFilterUPP fileFilter, short numTypes,
					  ConstSFTypeListPtr typeList, DlgHookUPP dlgHook, SFReply *reply, short dlgID,
	 ...
	 */
	EXTERN_API(void)
	StandardGetFilePreview(FileFilterUPP fileFilter, short numTypes, ConstSFTypeListPtr typeList,
	 ...
	 */
	EXTERN_API(void)
	CustomGetFilePreview(FileFilterYDUPP fileFilter, short numTypes, ConstSFTypeListPtr typeList,
						 StandardFileReply *reply, short dlgID, Point where, DlgHookYDUPP dlgHook,
						 ModalFilterYDUPP filterProc, ActivationOrderListPtr activeList, ActivateYDUPP activateProc,
						 void *yourDataPtr);
	 ...
	 */
	EXTERN_API(void)
	AlignWindow(WindowRef wp, Boolean front, const Rect *alignmentRect, ICMAlignmentProcRecordPtr alignmentProc);
	 ...
	 */
	EXTERN_API(void)
	DragAlignedWindow(WindowRef wp, Point startPt, Rect *boundsRect, Rect *alignmentRect,
	 ...
	 */
	EXTERN_API(long)
	DragAlignedGrayRgn(RgnHandle theRgn, Point startPt, Rect *boundsRect, Rect *slopRect, short axis,
					   UniversalProcPtr actionProc, Rect *alignmentRect, ICMAlignmentProcRecordPtr alignmentProc);
	 ...
	 */
	EXTERN_API(OSErr)
	SetCSequencePreferredPacketSize(ImageSequence seqID, long preferredPacketSizeInBytes);
	 ...
	 */
	EXTERN_API(OSErr)
	SetSequenceProgressProc(ImageSequence seqID, ICMProgressProcRecord *progressProc);
	 ...
	 */
	EXTERN_API(void)
	ICMDecompressComplete(ImageSequence seqID, OSErr err, short flag, ICMCompletionProcRecordPtr completionRtn);
	 ...
	 */
	EXTERN_API(OSErr)
	ICMDecompressCompleteS(ImageSequence seqID, OSErr err, short flag, ICMCompletionProcRecordPtr completionRtn);
	...
	enum
	{
		kICMPixelFormatIsPlanarMask =
			0x0F, /* these bits in formatFlags indicate how many planes there are; they're 0 if chunky*/
	 ...
	 */
	EXTERN_API(OSErr)
	ICMSequenceGetChainMember(ImageSequence seqID, ImageSequence *retSeqID, long flags);
	 ...
	 */
	EXTERN_API(OSErr)
	SetDSequenceTimeCode(ImageSequence seqID, void *timeCodeFormat, void *timeCodeTime);
	 ...
	 */
	EXTERN_API(OSErr)
	CDSequenceNewDataSource(ImageSequence seqID, ImageSequenceDataSource *sourceID, OSType sourceType,
							long sourceInputNumber, Handle dataDescription, ICMConvertDataFormatUPP transferProc,
							void *refCon);
	 ...
	 */
	EXTERN_API(OSErr)
	CDSequenceSetSourceData(ImageSequenceDataSource sourceID, void *data, long dataSize);
	 ...
	 */
	EXTERN_API(OSErr)
	CDSequenceSetSourceDataQueue(ImageSequenceDataSource sourceID, QHdrPtr dataQueue);
	 ...
	 */
	EXTERN_API(OSErr)
	CDSequenceGetDataSource(ImageSequence seqID, ImageSequenceDataSource *sourceID, OSType sourceType,
	 ...
	 */
	EXTERN_API(OSErr)
	PtInDSequenceData(ImageSequence seqID, void *data, Size dataSize, Point where, Boolean *hit);
	 ...
	 */
	EXTERN_API(OSErr)
	HitTestDSequenceData(ImageSequence seqID, void *data, Size dataSize, Point where, long *hit, long hitFlags);
	 ...
	 */
	EXTERN_API(OSErr)
	SetDSequenceNonScheduledDisplayTime(ImageSequence sequence, TimeValue64 displayTime, TimeScale displayTimeScale,
										UInt32 flags);
	 ...
	 */
	EXTERN_API(OSErr)
	GetDSequenceNonScheduledDisplayTime(ImageSequence sequence, TimeValue64 *displayTime, TimeScale *displayTimeScale);
	 ...
	 */
	EXTERN_API(OSErr)
	SetDSequenceNonScheduledDisplayDirection(ImageSequence sequence, Fixed rate);
	 ...
	 */
	EXTERN_API(OSErr)
	GetDSequenceNonScheduledDisplayDirection(ImageSequence sequence, Fixed *rate);
	 ...
	 */
	EXTERN_API(OSErr)
	GetGraphicsImporterForDataRef(Handle dataRef, OSType dataRefType, ComponentInstance *gi);
	 ...
	 */
	EXTERN_API(OSErr)
	GetGraphicsImporterForFileWithFlags(const FSSpec *theFile, ComponentInstance *gi, long flags);
	 ...
	 */
	EXTERN_API(OSErr)
	GetGraphicsImporterForDataRefWithFlags(Handle dataRef, OSType dataRefType, ComponentInstance *gi, long flags);
	 ...
	 */
	EXTERN_API(OSErr)
	QTGetFileNameExtension(ConstStrFileNameParam fileName, OSType fileType, OSType *extension);
	 ...
	 */
	EXTERN_API(OSErr)
	ImageTranscodeSequenceBegin(ImageTranscodeSequence *its, ImageDescriptionHandle srcDesc, OSType destType,
								ImageDescriptionHandle *dstDesc, void *data, long dataSize);
	 ...
	 */
	EXTERN_API(OSErr)
	ImageTranscodeFrame(ImageTranscodeSequence its, void *srcData, long srcDataSize, void **dstData, long *dstDataSize);
	 ...
	 */
	EXTERN_API(OSErr)
	ImageFieldSequenceBegin(ImageFieldSequence *ifs, ImageDescriptionHandle desc1, ImageDescriptionHandle desc2,
	 ...
	 */
	EXTERN_API(OSErr)
	ImageFieldSequenceExtractCombine(ImageFieldSequence ifs, long fieldFlags, void *data1, long dataSize1, void *data2,
									 long dataSize2, void *outputData, long *outDataSize);
	 ...
	 */
	EXTERN_API(OSErr)
	QTNewGWorld(GWorldPtr *offscreenGWorld, OSType PixelFormat, const Rect *boundsRect, CTabHandle cTable,
	 ...
	 */
	EXTERN_API(OSErr)
	QTNewGWorldFromPtr(GWorldPtr *gw, OSType pixelFormat, const Rect *boundsRect, CTabHandle cTable, GDHandle aGDevice,
	...
	QTUpdateGWorld(GWorldPtr *offscreenGWorld, OSType PixelFormat, const Rect *boundsRect, CTabHandle cTable,
				   GDHandle aGDevice, GWorldFlags flags);
	...
	enum
	{
		kQTUsePlatformDefaultGammaLevel =
			0, /* When decompressing into this PixMap, gamma-correct to the platform's standard gamma. */
	 ...
	 */
	EXTERN_API(void)
	ScaleMatrix(MatrixRecord *m, Fixed scaleX, Fixed scaleY, Fixed aboutX, Fixed aboutY);
	 ...
	 */
	EXTERN_API(void)
	SkewMatrix(MatrixRecord *m, Fixed skewX, Fixed skewY, Fixed aboutX, Fixed aboutY);
	...
	enum
	{
		...
		kGraphicsImporterDontUseColorMatching =
			1L << 3 /* set this flag (*before* calling GraphicsImportGetColorSyncProfile) if you do matching yourself */
	};
	...
	enum
	{
		...
		kQTIndexedImageIsMultiResolution = FOUR_CHAR_CODE(
			'n=rs') /* The image at this index is one of several identical images at different resolutions. */
	};
	...
	enum
	{
		kQTTIFFUserDataPrefix =
			0x74690000, /* Added to some tag values in TIFF IFDs to generate user data codes.  (0x7469 is 'ti'.) */
						/* For example, YCbCrPositioning is tag 0x0213, so its user data code is 0x74690213. */
		kQTTIFFExifUserDataPrefix =
			0x65780000, /* Added to tag values in Exif IFDs to generate user data codes.  (0x6578 is 'ex'.) */
						/* For example, DateTimeOriginal is tag 0x9003, so its user data code is 0x65789003. */
		kQTTIFFExifGPSUserDataPrefix =
			0x67700000, /* Added to tag values in Exif GPS IFDs to generate user data codes.  (0x6770 is 'gp'.) */
		...
		kQTAlphaModePreMulColor =
			FOUR_CHAR_CODE('almp'), /* RGBColor; used if kQTAlphaMode is graphicsModePreMulColorAlpha */
	...
	GraphicsImportSetDataReference(GraphicsImportComponent ci, Handle dataRef, OSType dataReType)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportGetDataReference(GraphicsImportComponent ci, Handle *dataRef, OSType *dataReType)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportGetImageDescription(GraphicsImportComponent ci, ImageDescriptionHandle *desc)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportGetDataOffsetAndSize(GraphicsImportComponent ci, unsigned long *offset, unsigned long *size)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportReadData(GraphicsImportComponent ci, void *dataPtr, unsigned long dataOffset, unsigned long dataSize)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportGetGWorld(GraphicsImportComponent ci, CGrafPtr *port, GDHandle *gd)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportSaveAsPicture(GraphicsImportComponent ci, const FSSpec *fss, ScriptCode scriptTag)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportSetGraphicsMode(GraphicsImportComponent ci, long graphicsMode, const RGBColor *opColor)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportGetGraphicsMode(GraphicsImportComponent ci, long *graphicsMode, RGBColor *opColor)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportSaveAsQuickTimeImageFile(GraphicsImportComponent ci, const FSSpec *fss, ScriptCode scriptTag)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportSetDataReferenceOffsetAndLimit(GraphicsImportComponent ci, unsigned long offset, unsigned long limit)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportGetDataReferenceOffsetAndLimit(GraphicsImportComponent ci, unsigned long *offset,
												 unsigned long *limit)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportGetAliasedDataReference(GraphicsImportComponent ci, Handle *dataRef, OSType *dataRefType)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportGetMIMETypeList(GraphicsImportComponent ci, void *qtAtomContainerPtr)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportDoesDrawAllPixels(GraphicsImportComponent ci, short *drawsAllPixels)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportExportImageFile(GraphicsImportComponent ci, OSType fileType, OSType fileCreator, const FSSpec *fss,
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportGetExportImageTypeList(GraphicsImportComponent ci, void *qtAtomContainerPtr)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportDoExportImageFileDialog(GraphicsImportComponent ci, const FSSpec *inDefaultSpec, StringPtr prompt,
										  ModalFilterYDUPP filterProc, OSType *outExportedType, FSSpec *outExportedSpec,
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportGetExportSettingsAsAtomContainer(GraphicsImportComponent ci, void *qtAtomContainerPtr)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportSetExportSettingsFromAtomContainer(GraphicsImportComponent ci, void *qtAtomContainer)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportSetProgressProc(GraphicsImportComponent ci, ICMProgressProcRecordPtr progressProc)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportGetProgressProc(GraphicsImportComponent ci, ICMProgressProcRecordPtr progressProc)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportGetImageCount(GraphicsImportComponent ci, unsigned long *imageCount)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportSetImageIndex(GraphicsImportComponent ci, unsigned long imageIndex)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportGetImageIndex(GraphicsImportComponent ci, unsigned long *imageIndex)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportGetDataOffsetAndSize64(GraphicsImportComponent ci, wide *offset, wide *size)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportReadData64(GraphicsImportComponent ci, void *dataPtr, const wide *dataOffset, unsigned long dataSize)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportSetDataReferenceOffsetAndLimit64(GraphicsImportComponent ci, const wide *offset, const wide *limit)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportGetDataReferenceOffsetAndLimit64(GraphicsImportComponent ci, wide *offset, wide *limit)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportGetDefaultMatrix(GraphicsImportComponent ci, MatrixRecord *defaultMatrix)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportGetDefaultGraphicsMode(GraphicsImportComponent ci, long *defaultGraphicsMode,
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportGetDefaultSourceRect(GraphicsImportComponent ci, Rect *defaultSourceRect)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportGetBaseDataOffsetAndSize64(GraphicsImportComponent ci, wide *offset, wide *size)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportSetImageIndexToThumbnail(GraphicsImportComponent ci)
		FIVEWORDINLINE(0x2F3C, 0x0000, 0x003E, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportCreateCGImage(GraphicsImportComponent ci, CGImageRef *imageRefOut, UInt32 flags)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportSaveAsPictureToDataRef(GraphicsImportComponent ci, Handle dataRef, OSType dataRefType)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x0040, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportSaveAsQuickTimeImageFileToDataRef(GraphicsImportComponent ci, Handle dataRef, OSType dataRefType)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x0041, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportExportImageFileToDataRef(GraphicsImportComponent ci, OSType fileType, OSType fileCreator,
										   Handle dataRef, OSType dataRefType)
		FIVEWORDINLINE(0x2F3C, 0x0010, 0x0042, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportDoExportImageFileToDataRefDialog(GraphicsImportComponent ci, Handle inDataRef, OSType inDataRefType,
												   CFStringRef prompt, ModalFilterYDUPP filterProc,
												   OSType *outExportedType, Handle *outDataRef, OSType *outDataRefType)
		FIVEWORDINLINE(0x2F3C, 0x001C, 0x0043, 0x7000, 0xA82A);

#if TARGET_API_MAC_OSX
	/* NOTE: If the source override ColorSync profile is NULL, then the image's ColorSync profile may be used if
	 * available, otherwise a generic ColorSync profile may be used. */
	/*
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportSetOverrideSourceColorSyncProfileRef(GraphicsImportComponent ci,
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportGetOverrideSourceColorSyncProfileRef(GraphicsImportComponent ci,
													   CMProfileRef *outOverrideSourceProfileRef)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x0045, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportSetDestinationColorSyncProfileRef(GraphicsImportComponent ci, CMProfileRef newDestinationProfileRef)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x0046, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportWillUseColorMatching(GraphicsImportComponent ci, Boolean *outWillMatch)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportGetGenericColorSyncProfile(GraphicsImportComponent ci, OSType pixelFormat, void *reservedSetToNULL,
											 UInt32 flags, Handle *genericColorSyncProfileOut)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportSetReturnGenericColorSyncProfile(GraphicsImportComponent ci,
												   Boolean returnGenericProfilesUnlessDontMatchFlagSet)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImportGetReturnGenericColorSyncProfile(GraphicsImportComponent ci,
												   Boolean *returnGenericProfilesUnlessDontMatchFlagSet)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportDoExport(GraphicsExportComponent ci, unsigned long *actualSizeWritten)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportCanUseCompressor(GraphicsExportComponent ci, Boolean *canUseCompressor,
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportDoUseCompressor(GraphicsExportComponent ci, void *codecSettingsAtomContainer,
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportGetDefaultFileTypeAndCreator(GraphicsExportComponent ci, OSType *fileType, OSType *fileCreator)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportGetDefaultFileNameExtension(GraphicsExportComponent ci, OSType *fileNameExtension)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportGetMIMETypeList(GraphicsExportComponent ci, void *qtAtomContainerPtr)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportRequestSettings(GraphicsExportComponent ci, ModalFilterYDUPP filterProc, void *yourDataProc)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportSetSettingsFromAtomContainer(GraphicsExportComponent ci, void *qtAtomContainer)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x000C, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportGetSettingsAsAtomContainer(GraphicsExportComponent ci, void *qtAtomContainerPtr)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x000D, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportSetDontRecompress(GraphicsExportComponent ci, Boolean dontRecompress)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportGetDontRecompress(GraphicsExportComponent ci, Boolean *dontRecompress)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportSetInterlaceStyle(GraphicsExportComponent ci, unsigned long interlaceStyle)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportGetInterlaceStyle(GraphicsExportComponent ci, unsigned long *interlaceStyle)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x0012, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportSetTargetDataSize(GraphicsExportComponent ci, unsigned long targetDataSize)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x0015, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportGetTargetDataSize(GraphicsExportComponent ci, unsigned long *targetDataSize)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportSetCompressionMethod(GraphicsExportComponent ci, long compressionMethod)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportGetCompressionMethod(GraphicsExportComponent ci, long *compressionMethod)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportSetCompressionQuality(GraphicsExportComponent ci, CodecQ spatialQuality)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x0019, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportGetCompressionQuality(GraphicsExportComponent ci, CodecQ *spatialQuality)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x001A, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportSetResolution(GraphicsExportComponent ci, Fixed horizontalResolution, Fixed verticalResolution)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportGetResolution(GraphicsExportComponent ci, Fixed *horizontalResolution, Fixed *verticalResolution)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x001C, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportSetColorSyncProfile(GraphicsExportComponent ci, Handle colorSyncProfile)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x0021, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportGetColorSyncProfile(GraphicsExportComponent ci, Handle *colorSyncProfile)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x0022, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportSetProgressProc(GraphicsExportComponent ci, ICMProgressProcRecordPtr progressProc)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x0023, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportGetProgressProc(GraphicsExportComponent ci, ICMProgressProcRecordPtr progressProc)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportSetInputDataReference(GraphicsExportComponent ci, Handle dataRef, OSType dataRefType,
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportGetInputDataReference(GraphicsExportComponent ci, Handle *dataRef, OSType *dataRefType)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportSetInputFile(GraphicsExportComponent ci, const FSSpec *theFile, ImageDescriptionHandle desc)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportSetInputHandle(GraphicsExportComponent ci, Handle h, ImageDescriptionHandle desc)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportSetInputPtr(GraphicsExportComponent ci, Ptr p, unsigned long size, ImageDescriptionHandle desc)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportGetInputPtr(GraphicsExportComponent ci, Ptr *p, unsigned long *size)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportSetInputGraphicsImporter(GraphicsExportComponent ci, GraphicsImportComponent grip)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x002D, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportGetInputGraphicsImporter(GraphicsExportComponent ci, GraphicsImportComponent *grip)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportSetInputOffsetAndLimit(GraphicsExportComponent ci, unsigned long offset, unsigned long limit)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportGetInputOffsetAndLimit(GraphicsExportComponent ci, unsigned long *offset, unsigned long *limit)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportMayExporterReadInputData(GraphicsExportComponent ci, Boolean *mayReadInputData)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x0037, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportReadInputData(GraphicsExportComponent ci, void *dataPtr, unsigned long dataOffset,
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportGetInputImageDescription(GraphicsExportComponent ci, ImageDescriptionHandle *desc)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x003A, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportGetInputImageDimensions(GraphicsExportComponent ci, Rect *dimensions)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportDrawInputImage(GraphicsExportComponent ci, CGrafPtr gw, GDHandle gd, const Rect *srcRect,
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportSetOutputDataReference(GraphicsExportComponent ci, Handle dataRef, OSType dataRefType)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportGetOutputDataReference(GraphicsExportComponent ci, Handle *dataRef, OSType *dataRefType)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x003F, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportSetOutputOffsetAndMaxSize(GraphicsExportComponent ci, unsigned long offset, unsigned long maxSize,
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportGetOutputOffsetAndMaxSize(GraphicsExportComponent ci, unsigned long *offset, unsigned long *maxSize,
											Boolean *truncateFile)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportSetOutputFileTypeAndCreator(GraphicsExportComponent ci, OSType fileType, OSType fileCreator)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportGetOutputFileTypeAndCreator(GraphicsExportComponent ci, OSType *fileType, OSType *fileCreator)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportWriteOutputData(GraphicsExportComponent ci, const void *dataPtr, unsigned long dataSize)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportReadOutputData(GraphicsExportComponent ci, void *dataPtr, unsigned long dataOffset,
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportSetThumbnailEnabled(GraphicsExportComponent ci, Boolean enableThumbnail, long maxThumbnailWidth,
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportGetThumbnailEnabled(GraphicsExportComponent ci, Boolean *thumbnailEnabled, long *maxThumbnailWidth,
									  long *maxThumbnailHeight) FIVEWORDINLINE(0x2F3C, 0x000C, 0x004D, 0x7000, 0xA82A);

	/* Allows export of Exif files, if supported.  This disables Exif-incompatible settings such as grayscale JPEG and
	 * compressed TIFF, and enables export of Exif metadata. */
	/*
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportSetInputCGImage(GraphicsExportComponent ci, CGImageRef imageRef)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x0050, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportGetInputCGImage(GraphicsExportComponent ci, CGImageRef *imageRefOut)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportSetInputCGBitmapContext(GraphicsExportComponent ci, CGContextRef bitmapContextRef)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x0052, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportGetInputCGBitmapContext(GraphicsExportComponent ci, CGContextRef *bitmapContextRefOut)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x0053, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportSetFlags(GraphicsExportComponent ci, UInt32 flags)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsExportGetFlags(GraphicsExportComponent ci, UInt32 *flagsOut)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x0055, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	ImageTranscoderBeginSequence(ImageTranscoderComponent itc, ImageDescriptionHandle srcDesc,
								 ImageDescriptionHandle *dstDesc, void *data, long dataSize)
	 ...
	 */
	EXTERN_API(ComponentResult)
	ImageTranscoderConvert(ImageTranscoderComponent itc, void *srcData, long srcDataSize, void **dstData,
	...
	!defined(kComponentPropertyListenerCollectionContextVersion)
	...
	enum
	{
		...
		kComponentPropertyInfoList =
			FOUR_CHAR_CODE('list'), /* array of ComponentPropertyInfo (CFData), one for each property */
	...
	enum
	{
		kComponentPropertyCacheFlagNotPersistent =
			(1L << 0),									 /* property metadata should not be saved in persistent cache*/
	...
	typedef CALLBACK_API(void, QTComponentPropertyListenerProcPtr)(ComponentInstance inComponent,
	 ...
	 */
	EXTERN_API(ComponentResult)
	QTGetComponentPropertyInfo(ComponentInstance inComponent, ComponentPropertyClass inPropClass,
							   ComponentPropertyID inPropID, ComponentValueType *outPropType, /* can be NULL */
							   ByteCount *outPropValueSize,									  /* can be NULL */
							   UInt32 *outPropertyFlags) /* can be NULL */ FIVEWORDINLINE(0x2F3C, 0x0014, 0xFFF5,
																						  0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	QTGetComponentProperty(ComponentInstance inComponent, ComponentPropertyClass inPropClass,
						   ComponentPropertyID inPropID, ByteCount inPropValueSize,
						   ComponentValuePtr outPropValueAddress,
						   ByteCount *outPropValueSizeUsed) /* can be NULL */ FIVEWORDINLINE(0x2F3C, 0x0014, 0xFFF4,
																							 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	QTSetComponentProperty(ComponentInstance inComponent, ComponentPropertyClass inPropClass,
						   ComponentPropertyID inPropID, ByteCount inPropValueSize,
						   ConstComponentValuePtr inPropValueAddress)
		FIVEWORDINLINE(0x2F3C, 0x0010, 0xFFF3, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	QTAddComponentPropertyListener(ComponentInstance inComponent, ComponentPropertyClass inPropClass,
								   ComponentPropertyID inPropID, QTComponentPropertyListenerUPP inDispatchProc,
								   void *inUserData) /* can be NULL */ FIVEWORDINLINE(0x2F3C, 0x0010, 0xFFF2, 0x7000,
																					  0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	QTRemoveComponentPropertyListener(ComponentInstance inComponent, ComponentPropertyClass inPropClass,
									  ComponentPropertyID inPropID, QTComponentPropertyListenerUPP inDispatchProc,
									  void *inUserData) /* can be NULL */ FIVEWORDINLINE(0x2F3C, 0x0010, 0xFFF1, 0x7000,
																						 0xA82A);
	...
	typedef CALLBACK_API(Boolean, QTComponentPropertyListenerFilterProcPtr)(
		QTComponentPropertyListenersRef inCollection,
		const QTComponentPropertyListenerCollectionContext *inCollectionContext, ComponentInstance inNotifier,
		ComponentPropertyClass inPropClass, ComponentPropertyID inPropID,
		QTComponentPropertyListenerUPP inListenerCallbackProc, const void *inListenerProcRefCon,
...
#define kQTComponentPropertyListenerCollectionContextVersion 1
	...
	enum
	{
		uppQTComponentPropertyListenerProcInfo = 0x00003FC0
	}; /* pascal no_return_value Func(4_bytes, 4_bytes, 4_bytes, 4_bytes) */
#ifdef __cplusplus
	inline DEFINE_API_C(QTComponentPropertyListenerUPP)
		NewQTComponentPropertyListenerUPP(QTComponentPropertyListenerProcPtr userRoutine)
	{
		return (QTComponentPropertyListenerUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppQTComponentPropertyListenerProcInfo, GetCurrentArchitecture());
	}
#else
#define NewQTComponentPropertyListenerUPP(userRoutine) \
	(QTComponentPropertyListenerUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppQTComponentPropertyListenerProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	enum
	{
		uppQTComponentPropertyListenerFilterProcInfo = 0x003FFFD0
	}; /* pascal 1_byte Func(4_bytes, 4_bytes, 4_bytes, 4_bytes, 4_bytes, 4_bytes, 4_bytes, 4_bytes) */
#ifdef __cplusplus
	inline DEFINE_API_C(QTComponentPropertyListenerFilterUPP)
		NewQTComponentPropertyListenerFilterUPP(QTComponentPropertyListenerFilterProcPtr userRoutine)
	{
		return (QTComponentPropertyListenerFilterUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppQTComponentPropertyListenerFilterProcInfo, GetCurrentArchitecture());
	}
#else
#define NewQTComponentPropertyListenerFilterUPP(userRoutine)     \
	(QTComponentPropertyListenerFilterUPP) NewRoutineDescriptor( \
		(ProcPtr)(userRoutine), uppQTComponentPropertyListenerFilterProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeQTComponentPropertyListenerFilterUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(void)
	InvokeQTComponentPropertyListenerUPP(ComponentInstance inComponent, ComponentPropertyClass inPropClass,
										 ComponentPropertyID inPropID, void *inUserData,
	...
	inline DEFINE_API_C(void)
		InvokeQTComponentPropertyListenerUPP(ComponentInstance inComponent, ComponentPropertyClass inPropClass,
											 ...
											 QTComponentPropertyListenerUPP userUPP)
	{
		CALL_FOUR_PARAMETER_UPP(userUPP, uppQTComponentPropertyListenerProcInfo, inComponent, inPropClass, inPropID,
								inUserData);
	}
#else
#define InvokeQTComponentPropertyListenerUPP(inComponent, inPropClass, inPropID, inUserData, userUPP)        \
	CALL_FOUR_PARAMETER_UPP((userUPP), uppQTComponentPropertyListenerProcInfo, (inComponent), (inPropClass), \
							(inPropID), (inUserData))
#endif
#endif
	...
	InvokeQTComponentPropertyListenerFilterUPP(QTComponentPropertyListenersRef inCollection,
											   const QTComponentPropertyListenerCollectionContext *inCollectionContext,
											   ComponentInstance inNotifier, ComponentPropertyClass inPropClass,
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(Boolean) InvokeQTComponentPropertyListenerFilterUPP(
		QTComponentPropertyListenersRef inCollection,
		const QTComponentPropertyListenerCollectionContext *inCollectionContext, ComponentInstance inNotifier,
		ComponentPropertyClass inPropClass, ComponentPropertyID inPropID,
		QTComponentPropertyListenerUPP inListenerCallbackProc, const void *inListenerProcRefCon,
		const void *inFilterProcRefCon, QTComponentPropertyListenerFilterUPP userUPP)
	{
		return (Boolean)CALL_EIGHT_PARAMETER_UPP(userUPP, uppQTComponentPropertyListenerFilterProcInfo, inCollection,
												 inCollectionContext, inNotifier, inPropClass, inPropID,
												 inListenerCallbackProc, inListenerProcRefCon, inFilterProcRefCon);
	}
#else
#define InvokeQTComponentPropertyListenerFilterUPP(inCollection, inCollectionContext, inNotifier, inPropClass,  \
												   inPropID, inListenerCallbackProc, inListenerProcRefCon,      \
												   inFilterProcRefCon, userUPP)                                 \
	(Boolean) CALL_EIGHT_PARAMETER_UPP((userUPP), uppQTComponentPropertyListenerFilterProcInfo, (inCollection), \
									   (inCollectionContext), (inNotifier), (inPropClass), (inPropID),          \
									   (inListenerCallbackProc), (inListenerProcRefCon), (inFilterProcRefCon))
#endif
#endif
...
#define CallQTComponentPropertyListenerProc(userRoutine, inComponent, inPropClass, inPropID, inUserData) \
	InvokeQTComponentPropertyListenerUPP(inComponent, inPropClass, inPropID, inUserData, userRoutine)
#define CallQTComponentPropertyListenerFilterProc(userRoutine, inCollection, inCollectionContext, inNotifier,          \
												  inPropClass, inPropID, inListenerCallbackProc, inListenerProcRefCon, \
												  inFilterProcRefCon)                                                  \
	InvokeQTComponentPropertyListenerFilterUPP(inCollection, inCollectionContext, inNotifier, inPropClass, inPropID,   \
											   inListenerCallbackProc, inListenerProcRefCon, inFilterProcRefCon,       \
											   userRoutine)
#endif /* CALL_NOT_IN_CARBON */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	QTComponentPropertyListenerCollectionAddListener(QTComponentPropertyListenersRef inCollection,
													 ComponentPropertyClass inPropClass, ComponentPropertyID inPropID,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	QTComponentPropertyListenerCollectionRemoveListener(QTComponentPropertyListenersRef inCollection,
														ComponentPropertyClass inPropClass,
														ComponentPropertyID inPropID,
														QTComponentPropertyListenerUPP inListenerProc,
														const void *inListenerProcRefCon);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	QTComponentPropertyListenerCollectionNotifyListeners(QTComponentPropertyListenersRef inCollection,
	 ...
	 */
	EXTERN_API_C(Boolean)
	QTComponentPropertyListenerCollectionHasListenersForProperty(QTComponentPropertyListenersRef inCollection,
																 ComponentPropertyClass inPropClass,
																 ComponentPropertyID inPropID);
	...
	enum
	{
		...
		kICMImageDescriptionPropertyID_CleanAperture =
			FOUR_CHAR_CODE('clap'), /* Native-endian CleanApertureImageDescriptionExtension, Read/Write */
		...
		kICMImageDescriptionPropertyID_PixelAspectRatio =
			FOUR_CHAR_CODE('pasp'), /* Native-endian PixelAspectRatioImageDescriptionExtension, Read/Write */
		...
		kICMImageDescriptionPropertyID_ProductionApertureDisplayDimensions =
			FOUR_CHAR_CODE('prdi'), /* FixedPoint, Read */
		...
		kICMImageDescriptionPropertyID_NCLCColorInfo =
			FOUR_CHAR_CODE('nclc'), /* Native-endian NCLCColorInfoImageDescriptionExtension, Read/Write */
		...
		kICMImageDescriptionPropertyID_CGColorSpace =
			FOUR_CHAR_CODE('cgcs'), /* CGColorSpaceRef, Read -- caller of GetProperty must call CGColorSpaceRelease */
		...
		kICMImageDescriptionPropertyID_ICCProfile =
			FOUR_CHAR_CODE('iccp'), /* CFDataRef, Read/Write -- caller of GetProperty must call CFRelease */
		...
		kICMImageDescriptionPropertyID_FieldInfo =
			FOUR_CHAR_CODE('fiel'), /* FieldInfoImageDescriptionExtension2, Read/Write */
		...
		kICMImageDescriptionPropertyID_StepDuration =
			FOUR_CHAR_CODE('step'), /* TimeRecord (base ignored), Read/Write */
		...
		kICMImageDescriptionPropertyID_SummaryString =
			FOUR_CHAR_CODE('isum') /* CFStringRef, Read - caller of GetProperty must call CFRelease*/
	};
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMImageDescriptionGetPropertyInfo(ImageDescriptionHandle inDesc, ComponentPropertyClass inPropClass,
									   ComponentPropertyID inPropID, ComponentValueType *outPropType, /* can be NULL */
									   ByteCount *outPropValueSize,									  /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMImageDescriptionGetProperty(ImageDescriptionHandle inDesc, ComponentPropertyClass inPropClass,
								   ComponentPropertyID inPropID, ByteCount inPropValueSize,
								   ComponentValuePtr outPropValueAddress,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMImageDescriptionSetProperty(ImageDescriptionHandle inDesc, ComponentPropertyClass inPropClass,
								   ComponentPropertyID inPropID, ByteCount inPropValueSize,
								   ConstComponentValuePtr inPropValueAddress);
	 ...
	 */
	typedef CALLBACK_API_C(void, ICMDecompressionTrackingCallback)(
		void *decompressionTrackingRefCon, OSStatus result, ICMDecompressionTrackingFlags decompressionTrackingFlags,
		CVPixelBufferRef pixelBuffer, TimeValue64 displayTime, TimeValue64 displayDuration,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMDecompressionSessionCreate(CFAllocatorRef allocator, /* can be NULL */
								  ImageDescriptionHandle desc,
	...
	ICMDecompressionSessionCreateForVisualContext(
		...
		ImageDescriptionHandle desc, ICMDecompressionSessionOptionsRef decompressionOptions, /* can be NULL */
		QTVisualContextRef visualContext, ICMDecompressionTrackingCallbackRecord *trackingCallback,
		ICMDecompressionSessionRef *decompressionSessionOut);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMDecompressionSessionDecodeFrame(ICMDecompressionSessionRef session, const UInt8 *data, ByteCount dataSize,
									   ICMDecompressionFrameOptionsRef frameOptions, /* can be NULL */
									   const ICMFrameTimeRecord *frameTime, void *sourceFrameRefCon);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMDecompressionSessionGetPropertyInfo(ICMDecompressionSessionRef session, ComponentPropertyClass inPropClass,
										   ComponentPropertyID inPropID,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMDecompressionSessionGetProperty(ICMDecompressionSessionRef session, ComponentPropertyClass inPropClass,
									   ComponentPropertyID inPropID, ByteCount inPropValueSize,
									   ComponentValuePtr outPropValueAddress,
									   ByteCount *outPropValueSizeUsed); /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMDecompressionSessionSetProperty(ICMDecompressionSessionRef session, ComponentPropertyClass inPropClass,
									   ComponentPropertyID inPropID, ByteCount inPropValueSize,
									   ConstComponentValuePtr inPropValueAddress);
	...
	enum
	{
		...
		kICMDecompressionSessionPropertyID_NonScheduledDisplayTime =
			FOUR_CHAR_CODE('nsti'), /* ICMNonScheduledDisplayTime, Read/Write */
		...
		kICMDecompressionSessionPropertyID_NonScheduledDisplayDirection =
			FOUR_CHAR_CODE('nsdu'), /* Fixed, Read/Write */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMDecompressionSessionSetNonScheduledDisplayTime(ICMDecompressionSessionRef session, TimeValue64 displayTime,
													  TimeScale displayTimeScale, UInt32 flags);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMDecompressionSessionSetNonScheduledDisplayDirection(ICMDecompressionSessionRef session, Fixed rate);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMDecompressionSessionOptionsCreate(CFAllocatorRef allocator, /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMDecompressionSessionOptionsCreateCopy(CFAllocatorRef allocator, /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMDecompressionSessionOptionsGetPropertyInfo(ICMDecompressionSessionOptionsRef options,
												  ComponentPropertyClass inPropClass, ComponentPropertyID inPropID,
												  ComponentValueType *outPropType, /* can be NULL */
												  ByteCount *outPropValueSize,	   /* can be NULL */
												  UInt32 *outPropertyFlags);	   /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMDecompressionSessionOptionsGetProperty(ICMDecompressionSessionOptionsRef options,
											  ComponentPropertyClass inPropClass, ComponentPropertyID inPropID,
											  ByteCount inPropValueSize, ComponentValuePtr outPropValueAddress,
											  ByteCount *outPropValueSizeUsed); /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMDecompressionSessionOptionsSetProperty(ICMDecompressionSessionOptionsRef options,
											  ComponentPropertyClass inPropClass, ComponentPropertyID inPropID,
											  ByteCount inPropValueSize, ConstComponentValuePtr inPropValueAddress);
	...
	enum
	{
		...
		kICMDecompressionSessionOptionsPropertyID_DisplayOrderRequired =
			FOUR_CHAR_CODE('dorq'), /* Boolean, Read/Write */
		...
		kICMDecompressionSessionOptionsPropertyID_DecompressorComponent =
			FOUR_CHAR_CODE('imdc'), /* DecompressorComponent, Read/Write */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMDecompressionFrameOptionsCreate(CFAllocatorRef allocator, /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMDecompressionFrameOptionsCreateCopy(CFAllocatorRef allocator, /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMDecompressionFrameOptionsGetPropertyInfo(ICMDecompressionFrameOptionsRef options,
												ComponentPropertyClass inPropClass, ComponentPropertyID inPropID,
												ComponentValueType *outPropType, /* can be NULL */
												ByteCount *outPropValueSize,	 /* can be NULL */
												UInt32 *outPropertyFlags);		 /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMDecompressionFrameOptionsGetProperty(ICMDecompressionFrameOptionsRef options, ComponentPropertyClass inPropClass,
											ComponentPropertyID inPropID, ByteCount inPropValueSize,
											ComponentValuePtr outPropValueAddress,
											ByteCount *outPropValueSizeUsed); /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMDecompressionFrameOptionsSetProperty(ICMDecompressionFrameOptionsRef options, ComponentPropertyClass inPropClass,
											ComponentPropertyID inPropID, ByteCount inPropValueSize,
											ConstComponentValuePtr inPropValueAddress);
	...
	enum
	{
		...
		kICMDecompressionFrameOptionsPropertyID_DestinationPixelBuffer =
			FOUR_CHAR_CODE('cvpb') /* CVPixelBufferRef, Read/Write */
	};
	 ...
	 */
	typedef CALLBACK_API_C(OSStatus, ICMEncodedFrameOutputCallback)(void *encodedFrameOutputRefCon,
																	ICMCompressionSessionRef session, OSStatus error,
																	ICMEncodedFrameRef frame, void *reserved);
	 ...
	 *      Reserved for future use.  Ignore the value of this parameter.
	 */
	typedef CALLBACK_API_C(void, ICMSourceTrackingCallback)(void *sourceTrackingRefCon,
															ICMSourceTrackingFlags sourceTrackingFlags,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMCompressionSessionCreate(CFAllocatorRef allocator, /* can be NULL */
								int width, int height, CodecType cType, TimeScale timescale,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMCompressionSessionGetPropertyInfo(ICMCompressionSessionRef session, ComponentPropertyClass inPropClass,
										 ComponentPropertyID inPropID,
										 ComponentValueType *outPropType, /* can be NULL */
										 ByteCount *outPropValueSize,	  /* can be NULL */
										 UInt32 *outPropertyFlags);		  /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMCompressionSessionGetProperty(ICMCompressionSessionRef session, ComponentPropertyClass inPropClass,
									 ComponentPropertyID inPropID, ByteCount inPropValueSize,
									 ComponentValuePtr outPropValueAddress,
									 ByteCount *outPropValueSizeUsed); /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMCompressionSessionSetProperty(ICMCompressionSessionRef session, ComponentPropertyClass inPropClass,
									 ComponentPropertyID inPropID, ByteCount inPropValueSize,
									 ConstComponentValuePtr inPropValueAddress);
	...
	enum
	{
		...
		kICMCompressionSessionPropertyID_CompressorPixelBufferAttributes =
			FOUR_CHAR_CODE('batt'), /* CFDictionaryRef, Read */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMCompressionSessionGetImageDescription(ICMCompressionSessionRef session, ImageDescriptionHandle *imageDescOut);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMCompressionSessionEncodeFrame(ICMCompressionSessionRef session, CVPixelBufferRef pixelBuffer,
									 TimeValue64 displayTimeStamp, TimeValue64 displayDuration,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMCompressionSessionCompleteFrames(ICMCompressionSessionRef session, Boolean completeAllFrames,
										TimeValue64 completeUntilDisplayTimeStamp, TimeValue64 nextDisplayTimeStamp);
	...
	EXTERN_API_C(Boolean)
	ICMCompressionSessionSupportsMultiPassEncoding(
		ICMCompressionSessionRef session, UInt32 multiPassStyleFlags,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMCompressionSessionBeginPass(ICMCompressionSessionRef session, ICMCompressionPassModeFlags passModeFlags,
								   UInt32 flags);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMCompressionSessionProcessBetweenPasses(ICMCompressionSessionRef session, UInt32 flags,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMCompressionSessionOptionsCreate(CFAllocatorRef allocator, /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMCompressionSessionOptionsCreateCopy(CFAllocatorRef allocator, /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMCompressionSessionOptionsGetPropertyInfo(ICMCompressionSessionOptionsRef options,
												ComponentPropertyClass inPropClass, ComponentPropertyID inPropID,
												ComponentValueType *outPropType, /* can be NULL */
												ByteCount *outPropValueSize,	 /* can be NULL */
												UInt32 *outPropertyFlags);		 /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMCompressionSessionOptionsGetProperty(ICMCompressionSessionOptionsRef options, ComponentPropertyClass inPropClass,
											ComponentPropertyID inPropID, ByteCount inPropValueSize,
											ComponentValuePtr outPropValueAddress,
											ByteCount *outPropValueSizeUsed); /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMCompressionSessionOptionsSetProperty(ICMCompressionSessionOptionsRef options, ComponentPropertyClass inPropClass,
											ComponentPropertyID inPropID, ByteCount inPropValueSize,
											ConstComponentValuePtr inPropValueAddress);
	...
	enum
	{
		...
		kICMCompressionSessionOptionsPropertyID_AllowTemporalCompression =
			FOUR_CHAR_CODE('p ok'), /* Boolean, Read/Write */
		...
		kICMCompressionSessionOptionsPropertyID_MaxPartialSyncFrameInterval =
			FOUR_CHAR_CODE('psfr'), /* SInt32, Read/Write */
		...
		kICMCompressionSessionOptionsPropertyID_AllowFrameTimeChanges =
			FOUR_CHAR_CODE('+ ok'), /* Boolean, Read/Write */
		...
		kICMCompressionSessionOptionsPropertyID_MaxFrameDelayTime =
			FOUR_CHAR_CODE('cwit'), /* TimeValue64, Read/Write */
		...
		kICMCompressionSessionOptionsPropertyID_CompressorComponent =
			FOUR_CHAR_CODE('imco'), /* CompressorComponent, Read/Write */
		...
		kICMCompressionSessionOptionsPropertyID_DataRateLimits =
			FOUR_CHAR_CODE('hard'), /* C array of ICMDataRateLimit struct, Read/Write */
		...
		kICMCompressionSessionOptionsPropertyID_MultiPassStorage =
			FOUR_CHAR_CODE('imps'), /* ICMMultiPassStorageRef, Read/Write */
		 ...
		 * concatenated with other compressed frames to form a longer series.
		 */
		kICMCompressionSessionOptionsPropertyID_SimpleBoundaryConditions =
			FOUR_CHAR_CODE('ends'), /* ICMSimpleBoundaryConditions struct, Read/Write */
		...
		kICMCompressionSessionOptionsPropertyID_ExtraAspectRatioStretchFactor =
			FOUR_CHAR_CODE('exsf') /* Fixed, Default fixed1, Read/Write */
	};
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMCompressionSessionOptionsSetAllowTemporalCompression(ICMCompressionSessionOptionsRef options,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMCompressionSessionOptionsSetAllowFrameReordering(ICMCompressionSessionOptionsRef options,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMCompressionSessionOptionsSetDurationsNeeded(ICMCompressionSessionOptionsRef options,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMCompressionSessionOptionsSetMaxKeyFrameInterval(ICMCompressionSessionOptionsRef options,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMCompressionSessionOptionsSetAllowFrameTimeChanges(ICMCompressionSessionOptionsRef options,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMMultiPassStorageCreateWithTemporaryFile(CFAllocatorRef allocator, /* can be NULL */
	 ...
	 */
	typedef CALLBACK_API_C(OSStatus, ICMMultiPassSetDataAtTimeStampCallback)(void *storageRefCon, TimeValue64 timeStamp,
																			 long index, CFDataRef data);
	 ...
	 */
	typedef CALLBACK_API_C(OSStatus, ICMMultiPassGetTimeStampCallback)(void *storageRefCon, TimeValue64 fromTimeStamp,
	 ...
	 */
	typedef CALLBACK_API_C(OSStatus, ICMMultiPassCopyDataAtTimeStampCallback)(void *storageRefCon,
																			  TimeValue64 timeStamp, long index,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMMultiPassStorageCreateWithCallbacks(CFAllocatorRef allocator, /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMCompressionFrameOptionsCreate(CFAllocatorRef allocator, /* can be NULL */
									 ICMCompressionSessionRef session, ICMCompressionFrameOptionsRef *options);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMCompressionFrameOptionsCreateCopy(CFAllocatorRef allocator, /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMCompressionFrameOptionsGetPropertyInfo(ICMCompressionFrameOptionsRef options, ComponentPropertyClass inPropClass,
											  ComponentPropertyID inPropID,
											  ComponentValueType *outPropType, /* can be NULL */
											  ByteCount *outPropValueSize,	   /* can be NULL */
											  UInt32 *outPropertyFlags);	   /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMCompressionFrameOptionsGetProperty(ICMCompressionFrameOptionsRef options, ComponentPropertyClass inPropClass,
										  ComponentPropertyID inPropID, ByteCount inPropValueSize,
										  ComponentValuePtr outPropValueAddress,
										  ByteCount *outPropValueSizeUsed); /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMCompressionFrameOptionsSetProperty(ICMCompressionFrameOptionsRef options, ComponentPropertyClass inPropClass,
										  ComponentPropertyID inPropID, ByteCount inPropValueSize,
										  ConstComponentValuePtr inPropValueAddress);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMCompressionFrameOptionsSetForceKeyFrame(ICMCompressionFrameOptionsRef options, Boolean forceKeyFrame);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMCompressionFrameOptionsSetFrameType(ICMCompressionFrameOptionsRef options, ICMFrameType frameType);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMEncodedFrameSetDataSize(ICMMutableEncodedFrameRef frame, ByteCount dataSize);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMEncodedFrameGetImageDescription(ICMEncodedFrameRef frame, ImageDescriptionHandle *imageDescOut);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMEncodedFrameSetValidTimeFlags(ICMMutableEncodedFrameRef frame, ICMValidTimeFlags validTimeFlags);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMEncodedFrameSetDecodeTimeStamp(ICMMutableEncodedFrameRef frame, TimeValue64 decodeTimeStamp);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMEncodedFrameSetDisplayTimeStamp(ICMMutableEncodedFrameRef frame, TimeValue64 displayTimeStamp);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMEncodedFrameSetDecodeDuration(ICMMutableEncodedFrameRef frame, TimeValue64 decodeDuration);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMEncodedFrameSetDisplayDuration(ICMMutableEncodedFrameRef frame, TimeValue64 displayDuration);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMEncodedFrameSetMediaSampleFlags(ICMMutableEncodedFrameRef frame, MediaSampleFlags mediaSampleFlags);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMEncodedFrameSetFrameType(ICMMutableEncodedFrameRef frame, ICMFrameType frameType);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMEncodedFrameSetSimilarity(ICMMutableEncodedFrameRef frame, Float32 similarity);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMCompressorSourceFrameGetDisplayTimeStampAndDuration(ICMCompressorSourceFrameRef sourceFrame,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMCompressorSessionDropFrame(ICMCompressorSessionRef session, ICMCompressorSourceFrameRef sourceFrame);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMCompressorSessionEmitEncodedFrame(ICMCompressorSessionRef session, ICMMutableEncodedFrameRef encodedFrame,
										 long numberOfSourceFrames, ICMCompressorSourceFrameRef sourceFrames[]);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMEncodedFrameCreateMutable(ICMCompressorSessionRef session, ICMCompressorSourceFrameRef sourceFrame,
								 ByteCount bufferSize, ICMMutableEncodedFrameRef *frameOut);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMMultiPassStorageSetDataAtTimeStamp(ICMMultiPassStorageRef multiPassStorage, TimeValue64 timeStamp, long index,
										  CFDataRef data);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMMultiPassStorageGetTimeStamp(ICMMultiPassStorageRef multiPassStorage, TimeValue64 fromTimeStamp,
									ICMMultiPassStorageStep step, TimeValue64 *timeStampOut);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ICMMultiPassStorageCopyDataAtTimeStamp(ICMMultiPassStorageRef multiPassStorage, TimeValue64 timeStamp, long index,
										   CFMutableDataRef *dataOut);
...
#define kQTVisualContextTargetDimensions_HeightKey CFSTR("Height")
	 ...
	 */
	EXTERN_API_C(OSStatus)
	QTVisualContextSetAttribute(QTVisualContextRef visualContext, CFStringRef attributeKey,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	QTVisualContextGetAttribute(QTVisualContextRef visualContext, CFStringRef attributeKey,
	 ...
	 */
	typedef CALLBACK_API_C(void, QTVisualContextImageAvailableCallback)(QTVisualContextRef visualContext,
	 ...
	 */
	EXTERN_API_C(Boolean)
	QTVisualContextIsNewImageAvailable(QTVisualContextRef visualContext,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	QTVisualContextCopyImageForTime(QTVisualContextRef visualContext, CFAllocatorRef allocator, /* can be NULL */
									const CVTimeStamp *timeStamp,								/* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	QTOpenGLTextureContextCreate(CFAllocatorRef allocator, /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	QTPixelBufferContextCreate(CFAllocatorRef allocator,   /* can be NULL */
							   CFDictionaryRef attributes, /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	QTDirect3DTextureContextCreate(CFAllocatorRef allocator,										   /* can be NULL */
								   void *d3dDevice, UInt32 d3dPixelFormat, CFDictionaryRef attributes, /* can be NULL */
								   QTVisualContextRef *newTextureContext);
