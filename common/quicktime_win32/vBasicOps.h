...
#pragma pack(2)
	...
	*/
	...
	vU8Divide(vector unsigned char vN, vector unsigned char vD, vector unsigned char *vRemainder);
	...
	vS8Divide(vector signed char vN, vector signed char vD, vector signed char *vRemainder);
	...
	vU16Divide(vector unsigned short vN, vector unsigned short vD, vector unsigned short *vRemainder);
	...
	vS16Divide(vector signed short vN, vector signed short vD, vector signed short *vRemainder);
	...
	vU32Divide(vector unsigned int vN, vector unsigned int vD, vector unsigned int *vRemainder);
	...
	vS32Divide(vector signed int vN, vector signed int vD, vector signed int *vRemainder);
	 ...
	 */
	EXTERN_API_C(vector unsigned int)
	vU64Divide(vector unsigned int vN, vector unsigned int vD, vector unsigned int *vRemainder);
	 ...
	 */
	EXTERN_API_C(vector signed int)
	vS64Divide(vector signed int vN, vector signed int vD, vector signed int *vRemainder);
	 ...
	 */
	EXTERN_API_C(vector unsigned int)
	vU128Divide(vector unsigned int vN, vector unsigned int vD, vector unsigned int *vRemainder);
	 ...
	 */
	EXTERN_API_C(vector signed int)
	vS128Divide(vector signed int vN, vector signed int vD, vector signed int *vRemainder);
