...
#pragma pack(2)
	...
	*/
	...
	typedef CALLBACK_API(Boolean, ModalFilterProcPtr)(DialogRef theDialog, EventRecord *theEvent,
													  DialogItemIndex *itemHit);
	/* ModalFilterYDProcPtr was previously in StandardFile.h */
	typedef CALLBACK_API(Boolean, ModalFilterYDProcPtr)(DialogRef theDialog, EventRecord *theEvent, short *itemHit,
														void *yourDataPtr);
...
#define NewSoundUPP(userRoutine) \
	...
	{
		return (ModalFilterUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppModalFilterProcInfo,
...
#define NewModalFilterUPP(userRoutine) \
	...
	{
		return (ModalFilterYDUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppModalFilterYDProcInfo,
													  GetCurrentArchitecture());
	}
#else
...
#define InvokeSoundUPP(soundNumber, userUPP) CALL_ONE_PARAMETER_UPP((userUPP), uppSoundProcInfo, (soundNumber))
	...
	InvokeModalFilterUPP(DialogRef theDialog, EventRecord *theEvent, DialogItemIndex *itemHit, ModalFilterUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(Boolean) InvokeModalFilterUPP(DialogRef theDialog, EventRecord *theEvent,
...
#define InvokeModalFilterUPP(theDialog, theEvent, itemHit, userUPP) \
	(Boolean) CALL_THREE_PARAMETER_UPP((userUPP), uppModalFilterProcInfo, (theDialog), (theEvent), (itemHit))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(Boolean)
	InvokeModalFilterYDUPP(DialogRef theDialog, EventRecord *theEvent, short *itemHit, void *yourDataPtr,
						   ModalFilterYDUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(Boolean) InvokeModalFilterYDUPP(DialogRef theDialog, EventRecord *theEvent, short *itemHit,
														void *yourDataPtr, ModalFilterYDUPP userUPP)
	{
		return (Boolean)CALL_FOUR_PARAMETER_UPP(userUPP, uppModalFilterYDProcInfo, theDialog, theEvent, itemHit,
												yourDataPtr);
	}
#else
#define InvokeModalFilterYDUPP(theDialog, theEvent, itemHit, yourDataPtr, userUPP)                             \
	(Boolean) CALL_FOUR_PARAMETER_UPP((userUPP), uppModalFilterYDProcInfo, (theDialog), (theEvent), (itemHit), \
									  (yourDataPtr))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(void)
	InvokeUserItemUPP(DialogRef theDialog, DialogItemIndex itemNo, UserItemUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define CallUserItemProc(userRoutine, theDialog, itemNo) InvokeUserItemUPP(theDialog, itemNo, userRoutine)
...
#if !TARGET_OS_MAC
	/* QuickTime 3.0 */
	typedef CALLBACK_API_C(void, QTModelessCallbackProcPtr)(EventRecord *theEvent, DialogRef theDialog,
															DialogItemIndex itemHit);
#if CALL_NOT_IN_CARBON
	/*
	 ...
	 */
	EXTERN_API(void)
	SetModelessDialogCallbackProc(DialogRef theDialog, QTModelessCallbackProcPtr callbackProc);
...
*/
	...
	NewDialog(void *dStorage, const Rect *boundsRect, ConstStr255Param title, Boolean visible, SInt16 procID,
			  WindowRef behind, Boolean goAwayFlag, SInt32 refCon, Handle items) ONEWORDINLINE(0xA97D);
	 ...
	 */
	EXTERN_API(DialogRef)
	GetNewDialog(SInt16 dialogID, void *dStorage, WindowRef behind) ONEWORDINLINE(0xA97C);
	 ...
	 */
	EXTERN_API(DialogRef)
	NewColorDialog(void *dStorage, const Rect *boundsRect, ConstStr255Param title, Boolean visible, SInt16 procID,
				   WindowRef behind, Boolean goAwayFlag, SInt32 refCon, Handle items) ONEWORDINLINE(0xAA4B);
	 ...
	 */
	EXTERN_API(void)
	ModalDialog(ModalFilterUPP modalFilter, DialogItemIndex *itemHit) ONEWORDINLINE(0xA991);
	 ...
	 */
	EXTERN_API(Boolean)
	DialogSelect(const EventRecord *theEvent, DialogRef *theDialog, DialogItemIndex *itemHit) ONEWORDINLINE(0xA980);
	 ...
	 */
	EXTERN_API(void)
	HideDialogItem(DialogRef theDialog, DialogItemIndex itemNo) ONEWORDINLINE(0xA827);
	 ...
	 */
	EXTERN_API(void)
	ShowDialogItem(DialogRef theDialog, DialogItemIndex itemNo) ONEWORDINLINE(0xA828);
	 ...
	 */
	EXTERN_API(void)
	GetDialogItem(DialogRef theDialog, DialogItemIndex itemNo, DialogItemType *itemType, Handle *item, Rect *box)
	 ...
	 */
	EXTERN_API(void)
	SetDialogItem(DialogRef theDialog, DialogItemIndex itemNo, DialogItemType itemType, Handle item, const Rect *box)
	 ...
	 */
	EXTERN_API(void)
	ParamText(ConstStr255Param param0, ConstStr255Param param1, ConstStr255Param param2, ConstStr255Param param3)
	 ...
	 */
	EXTERN_API(void)
	SelectDialogItemText(DialogRef theDialog, DialogItemIndex itemNo, SInt16 strtSel, SInt16 endSel)
	 ...
	 */
	EXTERN_API(void)
	GetParamText(StringPtr param0, StringPtr param1, StringPtr param2, StringPtr param3);
	...
	newdialog(void *dStorage, const Rect *boundsRect, const char *title, Boolean visible, SInt16 procID,
			  WindowRef behind, Boolean goAwayFlag, SInt32 refCon, Handle items);
	 ...
	 */
	EXTERN_API_C(DialogRef)
	newcolordialog(void *dStorage, const Rect *boundsRect, const char *title, Boolean visible, SInt16 procID,
				   WindowRef behind, Boolean goAwayFlag, SInt32 refCon, Handle items);
	 ...
	 */
	EXTERN_API(OSStatus)
	InsertDialogItem(DialogRef theDialog, DialogItemIndex afterItem, DialogItemType itemType, Handle itemHandle,
					 const Rect *box);
	 ...
	 */
	EXTERN_API(OSStatus)
	RemoveDialogItems(DialogRef theDialog, DialogItemIndex itemNo, DialogItemIndex amountToRemove,
	 ...
	 */
	EXTERN_API(Boolean)
	StdFilterProc(DialogRef theDialog, EventRecord *event, DialogItemIndex *itemHit);
	 ...
	 */
	EXTERN_API(OSErr)
	SetDialogDefaultItem(DialogRef theDialog, DialogItemIndex newItem) THREEWORDINLINE(0x303C, 0x0304, 0xAA68);
	 ...
	 */
	EXTERN_API(OSErr)
	SetDialogCancelItem(DialogRef theDialog, DialogItemIndex newItem) THREEWORDINLINE(0x303C, 0x0305, 0xAA68);
	 ...
	 */
	EXTERN_API(OSErr)
	SetDialogTracksCursor(DialogRef theDialog, Boolean tracks) THREEWORDINLINE(0x303C, 0x0306, 0xAA68);
	...
	*/
	 ...
	 */
	EXTERN_API(DialogRef)
	NewFeaturesDialog(void *inStorage, const Rect *inBoundsRect, ConstStr255Param inTitle, Boolean inIsVisible,
					  SInt16 inProcID, WindowRef inBehind, Boolean inGoAwayFlag, SInt32 inRefCon,
					  Handle inItemListHandle, UInt32 inFlags) THREEWORDINLINE(0x303C, 0x110C, 0xAA68);
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	StandardAlert(AlertType inAlertType, ConstStr255Param inError, ConstStr255Param inExplanation,
	 ...
	 */
	EXTERN_API(OSStatus)
	GetStandardAlertDefaultParams(AlertStdCFStringAlertParamPtr param, UInt32 version);
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateStandardAlert(AlertType alertType, CFStringRef error, CFStringRef explanation, /* can be NULL */
	 ...
	 */
	EXTERN_API(OSStatus)
	RunStandardAlert(DialogRef inAlert, ModalFilterUPP filterProc, /* can be NULL */
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateStandardSheet(AlertType alertType, CFStringRef error, CFStringRef explanation, /* can be NULL */
						const AlertStdCFStringAlertParamRec *param,						 /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	GetDialogItemAsControl(DialogRef inDialog, SInt16 inItemNo, ControlRef *outControl)
	 ...
	 */
	EXTERN_API(OSErr)
	MoveDialogItem(DialogRef inDialog, SInt16 inItemNo, SInt16 inHoriz, SInt16 inVert)
		THREEWORDINLINE(0x303C, 0x0510, 0xAA68);
	 ...
	 */
	EXTERN_API(OSErr)
	SizeDialogItem(DialogRef inDialog, SInt16 inItemNo, SInt16 inWidth, SInt16 inHeight)
		THREEWORDINLINE(0x303C, 0x0511, 0xAA68);
	 ...
	 */
	EXTERN_API(OSErr)
	AppendDialogItemList(DialogRef dialog, SInt16 ditlID, DITLMethod method) THREEWORDINLINE(0x303C, 0x0412, 0xAA68);
	...
	*/
	 ...
	 */
	EXTERN_API(OSStatus)
	SetDialogTimeout(DialogRef inDialog, SInt16 inButtonToPress, UInt32 inSecondsToWait);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDialogTimeout(DialogRef inDialog, SInt16 *outButtonToPress, /* can be NULL */
...
#define GetDialogKeyboardFocusItem(dialog) \
	(((DialogPeek)dialog)->editField < 0 ? (short)(-1) : (short)(((DialogPeek)dialog)->editField + 1))
#endif
#endif
