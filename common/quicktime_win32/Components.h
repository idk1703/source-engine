...
#pragma pack(2)
	...
	enum
	{
		...
		kComponentExecuteWiredActionSelect = -9, /* QTAtomContainer actionContainer, QTAtom actionAtom,
	...
	typedef CALLBACK_API(ComponentResult,
						 ComponentMPWorkFunctionProcPtr)(void *globalRefCon,
	...
	typedef CALLBACK_API(OSErr, GetMissingComponentResourceProcPtr)(Component c, OSType resType, short resID,
	...
	*/
	...
	{
		return (ComponentFunctionUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), (ProcInfoType)procInfo,
														  GetCurrentArchitecture());
	}
#else
#define NewComponentFunctionUPP(userRoutine, procInfo)                                          \
	((ComponentFunctionUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), (ProcInfoType)procInfo, \
												GetCurrentArchitecture()))
#endif
#endif
...
#define ComponentCallNow(callNumber, paramSize) FIVEWORDINLINE(0x2F3C, paramSize, callNumber, 0x7000, 0xA82A)
	...
	RegisterComponent(ComponentDescription *cd, ComponentRoutineUPP componentEntryPoint, short global,
					  Handle componentName, Handle componentInfo, Handle componentIcon) TWOWORDINLINE(0x7001, 0xA82A);
	 ...
	 */
	EXTERN_API(Component)
	RegisterComponentResource(ComponentResourceHandle cr, short global) TWOWORDINLINE(0x7012, 0xA82A);
	 ...
	 */
	EXTERN_API(Component)
	FindNextComponent(Component aComponent, ComponentDescription *looking) TWOWORDINLINE(0x7004, 0xA82A);
	 ...
	 */
	EXTERN_API(OSErr)
	GetComponentInfo(Component aComponent, ComponentDescription *cd, Handle componentName, Handle componentInfo,
	 ...
	 */
	EXTERN_API(OSErr)
	OpenAComponent(Component aComponent, ComponentInstance *ci) TWOWORDINLINE(0x702D, 0xA82A);
	 ...
	 ********************************************************/
	/* Note: GetComponentPublicResource returns a Handle, not a resource.  The caller must dispose it with
	 * DisposeHandle. */
	/*
	 ...
	 */
	EXTERN_API(OSErr)
	GetComponentPublicResource(Component aComponent, OSType resourceType, short resourceID, Handle *theResource)
	 ...
	 */
	EXTERN_API(OSErr)
	GetComponentPublicResourceList(OSType resourceType, short resourceID, long flags, ComponentDescription *cd,
								   GetMissingComponentResourceUPP missingProc, void *refCon, void *atomContainerPtr)
	 ...
	 */
	EXTERN_API(OSErr)
	GetComponentPublicIndString(Component aComponent, Str255 theString, short strListID, short index)
	 ...
	 */
	EXTERN_API(void)
	SetComponentInstanceError(ComponentInstance aComponentInstance, OSErr theError) TWOWORDINLINE(0x700B, 0xA82A);
	 ...
	 */
	EXTERN_API(void)
	SetComponentRefcon(Component aComponent, long theRefcon) TWOWORDINLINE(0x7011, 0xA82A);
	 ...
	 */
	EXTERN_API(OSErr)
	OpenAComponentResFile(Component aComponent, short *resRef) TWOWORDINLINE(0x702F, 0xA82A);
	 ...
	 */
	EXTERN_API(OSErr)
	GetComponentResource(Component aComponent, OSType resType, short resID, Handle *theResource)
		TWOWORDINLINE(0x7035, 0xA82A);
	 ...
	 */
	EXTERN_API(OSErr)
	GetComponentIndString(Component aComponent, Str255 theString, short strListID, short index)
		TWOWORDINLINE(0x7036, 0xA82A);
	 ...
	 */
	EXTERN_API(void)
	SetComponentInstanceStorage(ComponentInstance aComponentInstance, Handle theStorage) TWOWORDINLINE(0x700D, 0xA82A);
	 ...
	 */
	EXTERN_API(void)
	SetComponentInstanceA5(ComponentInstance aComponentInstance, long theA5) TWOWORDINLINE(0x700F, 0xA82A);
	 ...
	 */
	EXTERN_API(long)
	CallComponentFunction(ComponentParameters *params, ComponentFunctionUPP func) TWOWORDINLINE(0x70FF, 0xA82A);
	 ...
	 */
	EXTERN_API(long)
	CallComponentFunctionWithStorage(Handle storage, ComponentParameters *params, ComponentFunctionUPP func)
	 ...
	 */
	EXTERN_API(long)
	CallComponentFunctionWithStorageProcInfo(Handle storage, ComponentParameters *params, ProcPtr func,
											 ProcInfoType funcProcInfo);

#else
#define CallComponentFunctionWithStorageProcInfo(storage, params, func, funcProcInfo) \
	 ...
	 */
	EXTERN_API(OSErr)
	SetDefaultComponent(Component aComponent, short flags) TWOWORDINLINE(0x701E, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentInstance)
	OpenDefaultComponent(OSType componentType, OSType componentSubType) TWOWORDINLINE(0x7021, 0xA82A);
	 ...
	 */
	EXTERN_API(OSErr)
	OpenADefaultComponent(OSType componentType, OSType componentSubType, ComponentInstance *ci)
	 ...
	 */
	EXTERN_API(Component)
	CaptureComponent(Component capturedComponent, Component capturingComponent) TWOWORDINLINE(0x701C, 0xA82A);
	 ...
	 */
	EXTERN_API(OSErr)
	GetComponentIconSuite(Component aComponent, Handle *iconSuite) TWOWORDINLINE(0x7029, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	CallComponentCanDo(ComponentInstance ci, short ftnNumber) FIVEWORDINLINE(0x2F3C, 0x0002, 0xFFFD, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	CallComponentGetMPWorkFunction(ComponentInstance ci, ComponentMPWorkFunctionUPP *workFunction, void **refCon)
	 ...
	 */
	EXTERN_API(ComponentResult)
	CallComponentGetPublicResource(ComponentInstance ci, OSType resourceType, short resourceID, Handle *resource)
...
#ifdef __cplusplus
	inline DEFINE_API_C(ComponentMPWorkFunctionUPP)
		NewComponentMPWorkFunctionUPP(ComponentMPWorkFunctionProcPtr userRoutine)
	{
		return (ComponentMPWorkFunctionUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppComponentMPWorkFunctionProcInfo, GetCurrentArchitecture());
	}
#else
#define NewComponentMPWorkFunctionUPP(userRoutine) \
	(ComponentMPWorkFunctionUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppComponentMPWorkFunctionProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (ComponentRoutineUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppComponentRoutineProcInfo,
														 GetCurrentArchitecture());
	}
#else
#define NewComponentRoutineUPP(userRoutine) \
	(ComponentRoutineUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppComponentRoutineProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#ifdef __cplusplus
	inline DEFINE_API_C(GetMissingComponentResourceUPP)
		NewGetMissingComponentResourceUPP(GetMissingComponentResourceProcPtr userRoutine)
	{
		return (GetMissingComponentResourceUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppGetMissingComponentResourceProcInfo, GetCurrentArchitecture());
	}
#else
#define NewGetMissingComponentResourceUPP(userRoutine) \
	(GetMissingComponentResourceUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppGetMissingComponentResourceProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeGetMissingComponentResourceUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	...
	InvokeComponentMPWorkFunctionUPP(void *globalRefCon, ComponentMPWorkFunctionHeaderRecordPtr header,
	...
	inline DEFINE_API_C(ComponentResult)
		InvokeComponentMPWorkFunctionUPP(void *globalRefCon, ComponentMPWorkFunctionHeaderRecordPtr header,
										 ComponentMPWorkFunctionUPP userUPP)
	{
		return (ComponentResult)CALL_TWO_PARAMETER_UPP(userUPP, uppComponentMPWorkFunctionProcInfo, globalRefCon,
													   header);
	}
#else
#define InvokeComponentMPWorkFunctionUPP(globalRefCon, header, userUPP) \
	(ComponentResult) CALL_TWO_PARAMETER_UPP((userUPP), uppComponentMPWorkFunctionProcInfo, (globalRefCon), (header))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(ComponentResult)
	InvokeComponentRoutineUPP(ComponentParameters *cp, Handle componentStorage, ComponentRoutineUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(ComponentResult)
		InvokeComponentRoutineUPP(ComponentParameters *cp, Handle componentStorage, ComponentRoutineUPP userUPP)
...
#define InvokeComponentRoutineUPP(cp, componentStorage, userUPP) \
	(ComponentResult) CALL_TWO_PARAMETER_UPP((userUPP), uppComponentRoutineProcInfo, (cp), (componentStorage))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeGetMissingComponentResourceUPP(Component c, OSType resType, short resID, void *refCon, Handle *resource,
	...
	inline DEFINE_API_C(OSErr)
		InvokeGetMissingComponentResourceUPP(Component c, OSType resType, short resID, void *refCon, Handle *resource,
											 GetMissingComponentResourceUPP userUPP)
	{
		return (OSErr)CALL_FIVE_PARAMETER_UPP(userUPP, uppGetMissingComponentResourceProcInfo, c, resType, resID,
											  refCon, resource);
	}
#else
#define InvokeGetMissingComponentResourceUPP(c, resType, resID, refCon, resource, userUPP)                      \
	(OSErr) CALL_FIVE_PARAMETER_UPP((userUPP), uppGetMissingComponentResourceProcInfo, (c), (resType), (resID), \
									(refCon), (resource))
#endif
#endif
...
#define CallGetMissingComponentResourceProc(userRoutine, c, resType, resID, refCon, resource) \
	InvokeGetMissingComponentResourceUPP(c, resType, resID, refCon, resource, userRoutine)
#endif /* CALL_NOT_IN_CARBON */
