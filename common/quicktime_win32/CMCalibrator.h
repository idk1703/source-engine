...
#pragma pack(2)
	...
	{
		return (CalibrateEventUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppCalibrateEventProcInfo,
													   GetCurrentArchitecture());
	}
#else
#define NewCalibrateEventUPP(userRoutine) \
	(CalibrateEventUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppCalibrateEventProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (CanCalibrateUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppCanCalibrateProcInfo,
													 GetCurrentArchitecture());
	}
#else
#define NewCanCalibrateUPP(userRoutine) \
	(CanCalibrateUPP) NewRoutineDescriptor((ProcPtr)(userRoutine), uppCanCalibrateProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (CalibrateUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppCalibrateProcInfo,
												  GetCurrentArchitecture());
	}
#else
#define NewCalibrateUPP(userRoutine) \
	(CalibrateUPP) NewRoutineDescriptor((ProcPtr)(userRoutine), uppCalibrateProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define InvokeCalibrateEventUPP(event, userUPP) CALL_ONE_PARAMETER_UPP((userUPP), uppCalibrateEventProcInfo, (event))
	...
	InvokeCanCalibrateUPP(CMDisplayIDType displayID, Str255 errMessage, CanCalibrateUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeCanCalibrateUPP(displayID, errMessage, userUPP) \
	(Boolean) CALL_TWO_PARAMETER_UPP((userUPP), uppCanCalibrateProcInfo, (displayID), (errMessage))
#endif
#endif
...
#define CallCalibrateProc(userRoutine, theInfo) InvokeCalibrateUPP(theInfo, userRoutine)
	...
	{
		return (OldCanCalibrateUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppOldCanCalibrateProcInfo,
														GetCurrentArchitecture());
	}
#else
#define NewOldCanCalibrateUPP(userRoutine) \
	(OldCanCalibrateUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppOldCanCalibrateProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (OldCalibrateUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppOldCalibrateProcInfo,
													 GetCurrentArchitecture());
	}
#else
#define NewOldCalibrateUPP(userRoutine) \
	(OldCalibrateUPP) NewRoutineDescriptor((ProcPtr)(userRoutine), uppOldCalibrateProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define InvokeOldCanCalibrateUPP(displayID, userUPP) \
	(Boolean) CALL_ONE_PARAMETER_UPP((userUPP), uppOldCanCalibrateProcInfo, (displayID))
#endif
#endif
