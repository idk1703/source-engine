...
#pragma import on
	...
	typedef CALLBACK_API(void, PMSheetDoneProcPtr)(PMPrintSession printSession, WindowRef documentWindow,
												   Boolean accepted);
	 ...
	 */
	EXTERN_API_C(void)
	InvokePMPrintDialogInitUPP(PMPrintSettings printSettings, PMDialog *theDialog, PMPrintDialogInitUPP userUPP);
	 ...
	 */
	EXTERN_API_C(void)
	InvokePMPageSetupDialogInitUPP(PMPageFormat pageFormat, PMDialog *theDialog, PMPageSetupDialogInitUPP userUPP);
	 ...
	 */
	EXTERN_API_C(void)
	InvokePMSheetDoneUPP(PMPrintSession printSession, WindowRef documentWindow, Boolean accepted,
 ...
 */
EXTERN_API(OSStatus)
PMBeginDocument(PMPrintSettings printSettings, PMPageFormat pageFormat, PMPrintContext *printContext);
 ...
 */
EXTERN_API(OSStatus)
PMPrintDialog(PMPrintSettings printSettings, PMPageFormat constPageFormat, Boolean *accepted);
 ...
 */
EXTERN_API(OSStatus)
PMPrintDialogInitWithPageFormat(PMPrintSettings printSettings, PMPageFormat constPageFormat, PMDialog *newDialog);
 ...
 */
EXTERN_API(OSStatus)
PMPrintDialogMain(PMPrintSettings printSettings, PMPageFormat constPageFormat, Boolean *accepted,
 ...
 */
EXTERN_API(OSStatus)
PMPageSetupDialogMain(PMPageFormat pageFormat, Boolean *accepted, PMPageSetupDialogInitUPP myInitProc);
...
#define PMGetDialogRef PMGetDialogPtr
	 ...
	 */
	EXTERN_API(OSStatus)
	PMSessionEnablePrinterPresets(PMPrintSession session, CFStringRef graphicsType);
