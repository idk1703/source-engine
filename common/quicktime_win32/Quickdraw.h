...
typedef struct OpaqueRgnHandle *RgnHandle;
	...
	typedef CALLBACK_API(void, QDBitsProcPtr)(const BitMap *srcBits, const Rect *srcRect, const Rect *dstRect,
											  short mode, RgnHandle maskRgn);
	typedef CALLBACK_API(void, QDCommentProcPtr)(short kind, short dataSize, Handle dataHandle);
	typedef CALLBACK_API(short, QDTxMeasProcPtr)(short byteCount, const void *textAddr, Point *numer, Point *denom,
												 FontInfo *info);
	...
	typedef CALLBACK_API(void, QDOpcodeProcPtr)(const Rect *fromRect, const Rect *toRect, UInt16 opcode,
												SInt16 version);
...
#define NewQDBitsUPP(userRoutine) \
	...
	{
		return (QDCommentUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppQDCommentProcInfo,
...
#define NewQDOpcodeUPP(userRoutine) \
	...
	{
		return (QDStdGlyphsUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppQDStdGlyphsProcInfo,
													GetCurrentArchitecture());
	}
#else
#define NewQDStdGlyphsUPP(userRoutine) \
	(QDStdGlyphsUPP) NewRoutineDescriptor((ProcPtr)(userRoutine), uppQDStdGlyphsProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (QDJShieldCursorUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppQDJShieldCursorProcInfo,
														GetCurrentArchitecture());
	}
#else
#define NewQDJShieldCursorUPP(userRoutine) \
	(QDJShieldCursorUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppQDJShieldCursorProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeQDJShieldCursorUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(void)
	InvokeQDTextUPP(short byteCount, const void *textBuf, Point numer, Point denom, QDTextUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeQDRectUPP(verb, r, userUPP) CALL_TWO_PARAMETER_UPP((userUPP), uppQDRectProcInfo, (verb), (r))
	 ...
	 */
	EXTERN_API_C(void)
	InvokeQDRRectUPP(GrafVerb verb, const Rect *r, short ovalWidth, short ovalHeight, QDRRectUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void)
		InvokeQDRRectUPP(GrafVerb verb, const Rect *r, short ovalWidth, short ovalHeight, QDRRectUPP userUPP)
...
#define InvokeQDOvalUPP(verb, r, userUPP) CALL_TWO_PARAMETER_UPP((userUPP), uppQDOvalProcInfo, (verb), (r))
	 ...
	 */
	EXTERN_API_C(void)
	InvokeQDArcUPP(GrafVerb verb, const Rect *r, short startAngle, short arcAngle, QDArcUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void)
		InvokeQDArcUPP(GrafVerb verb, const Rect *r, short startAngle, short arcAngle, QDArcUPP userUPP)
...
#define InvokeQDRgnUPP(verb, rgn, userUPP) CALL_TWO_PARAMETER_UPP((userUPP), uppQDRgnProcInfo, (verb), (rgn))
	 ...
	 */
	EXTERN_API_C(void)
	InvokeQDBitsUPP(const BitMap *srcBits, const Rect *srcRect, const Rect *dstRect, short mode, RgnHandle maskRgn,
					QDBitsUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void) InvokeQDBitsUPP(const BitMap *srcBits, const Rect *srcRect, const Rect *dstRect,
...
#define InvokeQDBitsUPP(srcBits, srcRect, dstRect, mode, maskRgn, userUPP) \
	 ...
	 */
	EXTERN_API_C(void)
	InvokeQDCommentUPP(short kind, short dataSize, Handle dataHandle, QDCommentUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeQDCommentUPP(kind, dataSize, dataHandle, userUPP) \
	 ...
	 */
	EXTERN_API_C(short)
	InvokeQDTxMeasUPP(short byteCount, const void *textAddr, Point *numer, Point *denom, FontInfo *info,
					  QDTxMeasUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(short) InvokeQDTxMeasUPP(short byteCount, const void *textAddr, Point *numer, Point *denom,
												 FontInfo *info, QDTxMeasUPP userUPP)
	{
...
#define InvokeQDTxMeasUPP(byteCount, textAddr, numer, denom, info, userUPP) \
	(short)CALL_FIVE_PARAMETER_UPP((userUPP), uppQDTxMeasProcInfo, (byteCount), (textAddr), (numer), (denom), (info))
#endif
#endif
...
#define InvokeQDPutPicUPP(dataPtr, byteCount, userUPP) \
	 ...
	 */
	EXTERN_API_C(void)
	InvokeQDOpcodeUPP(const Rect *fromRect, const Rect *toRect, UInt16 opcode, SInt16 version, QDOpcodeUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void)
		InvokeQDOpcodeUPP(const Rect *fromRect, const Rect *toRect, UInt16 opcode, SInt16 version, QDOpcodeUPP userUPP)
...
#define InvokeQDStdGlyphsUPP(dataStream, size, userUPP) \
	(OSStatus) CALL_TWO_PARAMETER_UPP((userUPP), uppQDStdGlyphsProcInfo, (dataStream), (size))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(void)
	InvokeQDJShieldCursorUPP(short left, short top, short right, short bottom, QDJShieldCursorUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void)
		InvokeQDJShieldCursorUPP(short left, short top, short right, short bottom, QDJShieldCursorUPP userUPP)
...
typedef struct OpaqueGrafPtr *GrafPtr;
	...
	{
		return (DragGrayRgnUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppDragGrayRgnProcInfo,
													GetCurrentArchitecture());
	}
#else
#define NewDragGrayRgnUPP(userRoutine) \
	...
	{
		return (ColorSearchUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppColorSearchProcInfo,
													GetCurrentArchitecture());
	}
#else
#define NewColorSearchUPP(userRoutine) \
	...
	{
		return (ColorComplementUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppColorComplementProcInfo,
														GetCurrentArchitecture());
	}
#else
#define NewColorComplementUPP(userRoutine) \
	(ColorComplementUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppColorComplementProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define InvokeColorSearchUPP(rgb, position, userUPP) \
	(Boolean) CALL_TWO_PARAMETER_UPP((userUPP), uppColorSearchProcInfo, (rgb), (position))
#endif
#endif
...
typedef GrafPtr CGrafPtr;
	...
	typedef CALLBACK_API_C(OSStatus, QDPrinterStatusProcPtr)(PrinterStatusOpcode opcode, CGrafPtr currentPort,
															 void *printerStatus);
	...
	struct CQDProcs
	{
		...
		QDPrinterStatusUPP printerStatusProc; /* was newProc3;  now used to communicate status between Printing code and
												 System imaging code */
...
typedef CGrafPtr CWindowPtr;
	...
	typedef CALLBACK_API(void, DeviceLoopDrawingProcPtr)(short depth, short deviceFlags, GDHandle targetDevice,
														 long userData);
	...
	{
		return (QDPrinterStatusUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppQDPrinterStatusProcInfo,
														GetCurrentArchitecture());
	}
#else
#define NewQDPrinterStatusUPP(userRoutine) \
	(QDPrinterStatusUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppQDPrinterStatusProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (DeviceLoopDrawingUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppDeviceLoopDrawingProcInfo,
														  GetCurrentArchitecture());
	}
#else
#define NewDeviceLoopDrawingUPP(userRoutine) \
	(DeviceLoopDrawingUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppDeviceLoopDrawingProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeDeviceLoopDrawingUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(OSStatus)
	InvokeQDPrinterStatusUPP(PrinterStatusOpcode opcode, CGrafPtr currentPort, void *printerStatus,
							 QDPrinterStatusUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSStatus) InvokeQDPrinterStatusUPP(PrinterStatusOpcode opcode, CGrafPtr currentPort,
														   void *printerStatus, QDPrinterStatusUPP userUPP)
	{
		return (OSStatus)CALL_THREE_PARAMETER_UPP(userUPP, uppQDPrinterStatusProcInfo, opcode, currentPort,
												  printerStatus);
	}
#else
#define InvokeQDPrinterStatusUPP(opcode, currentPort, printerStatus, userUPP) \
	(OSStatus) CALL_THREE_PARAMETER_UPP((userUPP), uppQDPrinterStatusProcInfo, (opcode), (currentPort), (printerStatus))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(void)
	InvokeDeviceLoopDrawingUPP(short depth, short deviceFlags, GDHandle targetDevice, long userData,
							   DeviceLoopDrawingUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void) InvokeDeviceLoopDrawingUPP(short depth, short deviceFlags, GDHandle targetDevice,
														 long userData, DeviceLoopDrawingUPP userUPP)
	{
...
#define CallQDPrinterStatusProc(userRoutine, opcode, currentPort, printerStatus) \
...
#define CallDeviceLoopDrawingProc(userRoutine, depth, deviceFlags, targetDevice, userData) \
	InvokeDeviceLoopDrawingUPP(depth, deviceFlags, targetDevice, userData, userRoutine)
#endif /* CALL_NOT_IN_CARBON */
...
*/
	...
	typedef CALLBACK_API_C(OSStatus, RegionToRectsProcPtr)(UInt16 message, RgnHandle rgn, const Rect *rect,
														   void *refCon);
	...
	{
		return (RegionToRectsUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppRegionToRectsProcInfo,
													  GetCurrentArchitecture());
	}
#else
#define NewRegionToRectsUPP(userRoutine) \
	(RegionToRectsUPP) NewRoutineDescriptor((ProcPtr)(userRoutine), uppRegionToRectsProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeRegionToRectsUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(OSStatus)
	InvokeRegionToRectsUPP(UInt16 message, RgnHandle rgn, const Rect *rect, void *refCon, RegionToRectsUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define CallRegionToRectsProc(userRoutine, message, rgn, rect, refCon) \
	 ...
	 */
	EXTERN_API_C(OSStatus)
	QDRegionToRects(RgnHandle rgn, QDRegionParseDirection dir, RegionToRectsUPP proc, void *userData);
...
#define GetHWNDPort(theHWND) GetNativeWindowPort(theHWND)
	 ...
	 */
	EXTERN_API(OSErr)
	QTMLGetBackbufferHDC(GrafPtr port, void *backbufferHDC);
	 ...
	 */
	EXTERN_API(OSErr)
	QTMLReleaseBackbufferHDC(GrafPtr port, void *backbufferHDC);
...
#endif
	EXTERN_API(void)
	MacSetRect(Rect *r, short left, short top, short right, short bottom) ONEWORDINLINE(0xA8A7);
...
#define MacInsetRect InsetRect
	 ...
	 */
	EXTERN_API(Boolean)
	SectRect(const Rect *src1, const Rect *src2, Rect *dstRect) ONEWORDINLINE(0xA8AA);
...
#endif
	EXTERN_API(void)
	MacUnionRect(const Rect *src1, const Rect *src2, Rect *dstRect) ONEWORDINLINE(0xA8AB);
...
#define MacFillRect FillRect
	 ...
	 */
	EXTERN_API(void)
	FrameRoundRect(const Rect *r, short ovalWidth, short ovalHeight) ONEWORDINLINE(0xA8B0);
	 ...
	 */
	EXTERN_API(void)
	PaintRoundRect(const Rect *r, short ovalWidth, short ovalHeight) ONEWORDINLINE(0xA8B1);
	 ...
	 */
	EXTERN_API(void)
	EraseRoundRect(const Rect *r, short ovalWidth, short ovalHeight) ONEWORDINLINE(0xA8B2);
	 ...
	 */
	EXTERN_API(void)
	InvertRoundRect(const Rect *r, short ovalWidth, short ovalHeight) ONEWORDINLINE(0xA8B3);
	 ...
	 */
	EXTERN_API(void)
	FillRoundRect(const Rect *r, short ovalWidth, short ovalHeight, const Pattern *pat) ONEWORDINLINE(0xA8B4);
	 ...
	 */
	EXTERN_API(void)
	InvertArc(const Rect *r, short startAngle, short arcAngle) ONEWORDINLINE(0xA8C1);
	 ...
	 */
	EXTERN_API(void)
	FillArc(const Rect *r, short startAngle, short arcAngle, const Pattern *pat) ONEWORDINLINE(0xA8C2);
...
#endif
	EXTERN_API(void)
	MacSetRectRgn(RgnHandle rgn, short left, short top, short right, short bottom) ONEWORDINLINE(0xA8DE);
...
#define MacOffsetRgn OffsetRgn
	 ...
	 */
	EXTERN_API(void)
	SectRgn(RgnHandle srcRgnA, RgnHandle srcRgnB, RgnHandle dstRgn) ONEWORDINLINE(0xA8E4);
...
#define MacUnionRgn UnionRgn
#endif
	EXTERN_API(void)
	MacUnionRgn(RgnHandle srcRgnA, RgnHandle srcRgnB, RgnHandle dstRgn) ONEWORDINLINE(0xA8E5);
	 ...
	 */
	EXTERN_API(void)
	DiffRgn(RgnHandle srcRgnA, RgnHandle srcRgnB, RgnHandle dstRgn) ONEWORDINLINE(0xA8E6);
...
#endif
	EXTERN_API(void)
	MacXorRgn(RgnHandle srcRgnA, RgnHandle srcRgnB, RgnHandle dstRgn) ONEWORDINLINE(0xA8E7);
...
#define MacFillRgn FillRgn
	 ...
	 */
	EXTERN_API(void)
	ScrollRect(const Rect *r, short dh, short dv, RgnHandle updateRgn) ONEWORDINLINE(0xA8EF);
	 ...
	 */
	EXTERN_API(void)
	CopyBits(const BitMap *srcBits, const BitMap *dstBits, const Rect *srcRect, const Rect *dstRect, short mode,
	 ...
	 */
	EXTERN_API(void)
	SeedFill(const void *srcPtr, void *dstPtr, short srcRow, short dstRow, short height, short words, short seedH,
	 ...
	 */
	EXTERN_API(void)
	CalcMask(const void *srcPtr, void *dstPtr, short srcRow, short dstRow, short height, short words)
	 ...
	 */
	EXTERN_API(void)
	CopyMask(const BitMap *srcBits, const BitMap *maskBits, const BitMap *dstBits, const Rect *srcRect,
			 const Rect *maskRect, const Rect *dstRect) ONEWORDINLINE(0xA817);
...
#define MacGetPixel GetPixel
	 ...
	 */
	EXTERN_API(void)
	ScalePt(Point *pt, const Rect *srcRect, const Rect *dstRect) ONEWORDINLINE(0xA8F8);
	 ...
	 */
	EXTERN_API(void)
	MapPt(Point *pt, const Rect *srcRect, const Rect *dstRect) ONEWORDINLINE(0xA8F9);
	 ...
	 */
	EXTERN_API(void)
	MapRect(Rect *r, const Rect *srcRect, const Rect *dstRect) ONEWORDINLINE(0xA8FA);
	 ...
	 */
	EXTERN_API(void)
	MapRgn(RgnHandle rgn, const Rect *srcRect, const Rect *dstRect) ONEWORDINLINE(0xA8FB);
	 ...
	 */
	EXTERN_API(void)
	MapPoly(PolyHandle poly, const Rect *srcRect, const Rect *dstRect) ONEWORDINLINE(0xA8FC);
	 ...
	 */
	EXTERN_API(void)
	StdRRect(GrafVerb verb, const Rect *r, short ovalWidth, short ovalHeight) ONEWORDINLINE(0xA8AF);
	 ...
	 */
	EXTERN_API(void)
	StdArc(GrafVerb verb, const Rect *r, short startAngle, short arcAngle) ONEWORDINLINE(0xA8BD);
	 ...
	 */
	EXTERN_API(void)
	StdBits(const BitMap *srcBits, const Rect *srcRect, const Rect *dstRect, short mode, RgnHandle maskRgn)
	 ...
	 */
	EXTERN_API(void)
	StdOpcode(const Rect *fromRect, const Rect *toRect, UInt16 opcode, SInt16 version) ONEWORDINLINE(0xABF8);
...
#define MacPtInRect PtInRect
	 ...
	 */
	EXTERN_API(void)
	FillCRoundRect(const Rect *r, short ovalWidth, short ovalHeight, PixPatHandle pp) ONEWORDINLINE(0xAA10);
	 ...
	 */
	EXTERN_API(void)
	FillCArc(const Rect *r, short startAngle, short arcAngle, PixPatHandle pp) ONEWORDINLINE(0xAA11);
	 ...
	 */
	EXTERN_API(void)
	SeedCFill(const BitMap *srcBits, const BitMap *dstBits, const Rect *srcRect, const Rect *dstRect, short seedH,
			  short seedV, ColorSearchUPP matchProc, long matchData) ONEWORDINLINE(0xAA50);
	 ...
	 */
	EXTERN_API(void)
	CalcCMask(const BitMap *srcBits, const BitMap *dstBits, const Rect *srcRect, const Rect *dstRect,
			  const RGBColor *seedRGB, ColorSearchUPP matchProc, long matchData) ONEWORDINLINE(0xAA4F);
	 ...
	 */
	EXTERN_API(void)
	SetDeviceAttribute(GDHandle gdh, short attribute, Boolean value) ONEWORDINLINE(0xAA2D);
	 ...
	 */
	EXTERN_API(void)
	GetSubTable(CTabHandle myColors, short iTabRes, CTabHandle targetTbl) ONEWORDINLINE(0xAA37);
	 ...
	 */
	EXTERN_API(void)
	SaveEntries(CTabHandle srcTable, CTabHandle resultTable, ReqListRec *selection) ONEWORDINLINE(0xAA49);
	 ...
	 */
	EXTERN_API(void)
	RestoreEntries(CTabHandle srcTable, CTabHandle dstTable, ReqListRec *selection) ONEWORDINLINE(0xAA4A);
	 ...
	 */
	EXTERN_API(void)
	CopyDeepMask(const BitMap *srcBits, const BitMap *maskBits, const BitMap *dstBits, const Rect *srcRect,
	 ...
	 */
	EXTERN_API(void)
	DeviceLoop(RgnHandle drawingRgn, DeviceLoopDrawingUPP drawingProc, long userData, DeviceLoopFlags flags)
...
#define MacGetCursor GetCursor
	 ...
	 */
	EXTERN_API(void)
	ScreenRes(short *scrnHRes, short *scrnVRes) SIXWORDINLINE(0x225F, 0x32B8, 0x0102, 0x225F, 0x32B8, 0x0104);
...
#define DisposGDevice(gdh)	 DisposeGDevice(gdh)
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	GetPortCustomXFerProc(CGrafPtr port, CustomXFerProcPtr *proc, UInt32 *flags, UInt32 *refCon)
	 ...
	 */
	EXTERN_API(OSErr)
	SetPortCustomXFerProc(CGrafPtr port, CustomXFerProcPtr proc, UInt32 flags, UInt32 refCon)
	 ...
	 */
	EXTERN_API(OSErr)
	OpenCursorComponent(Component c, ComponentInstance *ci) FOURWORDINLINE(0x203C, 0x0008, 0x000B, 0xABE0);
	 ...
	 */
	EXTERN_API(OSErr)
	CursorComponentSetData(ComponentInstance ci, long data) FOURWORDINLINE(0x203C, 0x0008, 0x000F, 0xABE0);
	 ...
	 */
	EXTERN_API(Handle)
	SwapPortPolySaveHandle(CGrafPtr port, Handle inPolySaveHdl);
	 ...
	 */
	EXTERN_API(Handle)
	SwapPortRegionSaveHandle(CGrafPtr port, Handle inRegionSaveHdl);
	 ...
	 */
	EXTERN_API(Point *)
	QDLocalToGlobalPoint(CGrafPtr port, Point *point);
	 ...
	 */
	EXTERN_API(Point *)
	QDGlobalToLocalPoint(CGrafPtr port, Point *point);
	 ...
	 */
	EXTERN_API(Rect *)
	QDLocalToGlobalRect(CGrafPtr port, Rect *bounds);
	 ...
	 */
	EXTERN_API(Rect *)
	QDGlobalToLocalRect(CGrafPtr port, Rect *bounds);
	 ...
	 */
	EXTERN_API(RgnHandle)
	QDLocalToGlobalRegion(CGrafPtr port, RgnHandle region);
	 ...
	 */
	EXTERN_API(RgnHandle)
	QDGlobalToLocalRegion(CGrafPtr port, RgnHandle region);
	...
	*/
	 ...
	 */
	EXTERN_API_C(OSStatus)
	QDRegisterNamedPixMapCursor(PixMapHandle crsrData, PixMapHandle crsrMask, Point hotSpot, const char name[128]);
	 ...
	 */
	EXTERN_API_C(UInt32)
	QDSwapPortTextFlags(CGrafPtr port, UInt32 newFlags);
