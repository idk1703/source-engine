...
#ifdef __cplusplus
	inline DEFINE_API_C(DebuggerThreadSchedulerUPP)
		NewDebuggerThreadSchedulerUPP(DebuggerThreadSchedulerProcPtr userRoutine)
	{
		return userRoutine;
	}
...
#define InvokeThreadEntryUPP(threadParam, userUPP) (*userUPP)(threadParam)
	...
	InvokeThreadSchedulerUPP(SchedulerInfoRecPtr schedulerInfo, ThreadSchedulerUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(ThreadID)
		InvokeThreadSchedulerUPP(SchedulerInfoRecPtr schedulerInfo, ThreadSchedulerUPP userUPP)
	{
...
#define InvokeThreadSchedulerUPP(schedulerInfo, userUPP) (*userUPP)(schedulerInfo)
	 ...
	 */
	EXTERN_API_C(void)
	InvokeThreadSwitchUPP(ThreadID threadBeingSwitched, void *switchProcParam, ThreadSwitchUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeThreadSwitchUPP(threadBeingSwitched, switchProcParam, userUPP) \
	 ...
	 */
	EXTERN_API_C(void)
	InvokeThreadTerminationUPP(ThreadID threadTerminated, void *terminationProcParam, ThreadTerminationUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void)
		InvokeThreadTerminationUPP(ThreadID threadTerminated, void *terminationProcParam, ThreadTerminationUPP userUPP)
...
#else
#define InvokeThreadTerminationUPP(threadTerminated, terminationProcParam, userUPP) \
	(*userUPP)(threadTerminated, terminationProcParam)
#endif
#endif
	 ...
	 */
	EXTERN_API_C(void)
	InvokeDebuggerNewThreadUPP(ThreadID threadCreated, DebuggerNewThreadUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeDebuggerNewThreadUPP(threadCreated, userUPP) (*userUPP)(threadCreated)
	 ...
	 */
	EXTERN_API_C(void)
	InvokeDebuggerDisposeThreadUPP(ThreadID threadDeleted, DebuggerDisposeThreadUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeDebuggerDisposeThreadUPP(threadDeleted, userUPP) (*userUPP)(threadDeleted)
	 ...
	 */
	EXTERN_API_C(ThreadID)
	InvokeDebuggerThreadSchedulerUPP(SchedulerInfoRecPtr schedulerInfo, DebuggerThreadSchedulerUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(ThreadID)
		InvokeDebuggerThreadSchedulerUPP(SchedulerInfoRecPtr schedulerInfo, DebuggerThreadSchedulerUPP userUPP)
...
typedef DebuggerThreadSchedulerUPP DebuggerThreadSchedulerTPP;
	 ...
	 */
	EXTERN_API(OSErr)
	NewThread(ThreadStyle threadStyle, ThreadEntryTPP threadEntry, void *threadParam, Size stackSize,
			  ThreadOptions options, void **threadResult, /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	SetThreadSwitcher(ThreadID thread, ThreadSwitchTPP threadSwitcher, void *switchProcParam, Boolean inOrOut)
	 ...
	 */
	EXTERN_API(OSErr)
	SetThreadTerminator(ThreadID thread, ThreadTerminationTPP threadTerminator, void *terminationProcParam)
	 ...
	 */
	EXTERN_API(OSErr)
	SetDebuggerNotificationProcs(DebuggerNewThreadTPP notifyNewThread, DebuggerDisposeThreadTPP notifyDisposeThread,
	 ...
	 */
	EXTERN_API(OSErr)
	GetFreeThreadCount(ThreadStyle threadStyle, SInt16 *freeCount) THREEWORDINLINE(0x303C, 0x0402, 0xABF2);
	 ...
	 */
	EXTERN_API(OSErr)
	GetSpecificFreeThreadCount(ThreadStyle threadStyle, Size stackSize, SInt16 *freeCount)
	 ...
	 */
	EXTERN_API(OSErr)
	GetDefaultThreadStackSize(ThreadStyle threadStyle, Size *stackSize) THREEWORDINLINE(0x303C, 0x0413, 0xABF2);
	 ...
	 */
	EXTERN_API(OSErr)
	ThreadCurrentStackSpace(ThreadID thread, UInt32 *freeStack) THREEWORDINLINE(0x303C, 0x0414, 0xABF2);
...
#define MacGetCurrentThread GetCurrentThread
	 ...
	 */
	EXTERN_API(OSErr)
	GetThreadState(ThreadID threadToGet, ThreadState *threadState) THREEWORDINLINE(0x303C, 0x0407, 0xABF2);
	 ...
	 */
	EXTERN_API(OSErr)
	SetThreadState(ThreadID threadToSet, ThreadState newState, ThreadID suggestedThread)
	 ...
	 */
	EXTERN_API(OSErr)
	SetThreadStateEndCritical(ThreadID threadToSet, ThreadState newState, ThreadID suggestedThread)
	 ...
	 */
	EXTERN_API(OSErr)
	GetThreadStateGivenTaskRef(ThreadTaskRef threadTRef, ThreadID threadToGet, ThreadState *threadState)
	 ...
	 */
	EXTERN_API(OSErr)
	SetThreadReadyGivenTaskRef(ThreadTaskRef threadTRef, ThreadID threadToSet) THREEWORDINLINE(0x303C, 0x0410, 0xABF2);
