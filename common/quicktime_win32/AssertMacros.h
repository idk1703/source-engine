...
#define debug_string(message)                                                                            \
	do                                                                                                   \
	{                                                                                                    \
		DEBUG_ASSERT_MESSAGE(DEBUG_ASSERT_COMPONENT_NAME_STRING, "", 0, message, __FILE__, __LINE__, 0); \
	} while(0)
#endif
...
#define check(assertion)                                                                                       \
	...
	{                                                                                                          \
		if(!(assertion))                                                                                       \
		{                                                                                                      \
			DEBUG_ASSERT_MESSAGE(DEBUG_ASSERT_COMPONENT_NAME_STRING, #assertion, 0, 0, __FILE__, __LINE__, 0); \
		}                                                                                                      \
	} while(0)
#endif
...
#define check_string(assertion, message)                                                                             \
	...
	{                                                                                                                \
		if(!(assertion))                                                                                             \
		{                                                                                                            \
			DEBUG_ASSERT_MESSAGE(DEBUG_ASSERT_COMPONENT_NAME_STRING, #assertion, 0, message, __FILE__, __LINE__, 0); \
		}                                                                                                            \
	} while(0)
#endif
...
#define check_noerr(errorCode)                                                                                      \
	...
	{                                                                                                               \
		...
		{                                                                                                           \
			DEBUG_ASSERT_MESSAGE(DEBUG_ASSERT_COMPONENT_NAME_STRING, #errorCode " == 0 ", 0, 0, __FILE__, __LINE__, \
								 evalOnceErrorCode);                                                                \
		}                                                                                                           \
	} while(0)
#endif
...
#define check_noerr_string(errorCode, message)                                                                  \
	...
	{                                                                                                           \
		...
		if(0 != evalOnceErrorCode)                                                                              \
		{                                                                                                       \
			DEBUG_ASSERT_MESSAGE(DEBUG_ASSERT_COMPONENT_NAME_STRING, #errorCode " == 0 ", 0, message, __FILE__, \
...
#define require(assertion, exceptionLabel)                                                                     \
	...
	{                                                                                                          \
		if(!(assertion))                                                                                       \
		{                                                                                                      \
			DEBUG_ASSERT_MESSAGE(DEBUG_ASSERT_COMPONENT_NAME_STRING, #assertion, #exceptionLabel, 0, __FILE__, \
								 __LINE__, 0);                                                                 \
			goto exceptionLabel;                                                                               \
		}                                                                                                      \
	} while(0)
...
#define require_string(assertion, exceptionLabel, message)                                                           \
	...
	{                                                                                                                \
		if(!(assertion))                                                                                             \
		{                                                                                                            \
			DEBUG_ASSERT_MESSAGE(DEBUG_ASSERT_COMPONENT_NAME_STRING, #assertion, #exceptionLabel, message, __FILE__, \
								 __LINE__, 0);                                                                       \
			goto exceptionLabel;                                                                                     \
		}                                                                                                            \
	} while(0)
...
#define require_noerr(errorCode, exceptionLabel)                                                              \
	...
	{                                                                                                         \
		...
		if(0 != evalOnceErrorCode)                                                                            \
		{                                                                                                     \
			DEBUG_ASSERT_MESSAGE(DEBUG_ASSERT_COMPONENT_NAME_STRING, #errorCode " == 0 ", #exceptionLabel, 0, \
...
#define require_noerr_string(errorCode, exceptionLabel, message)                                                    \
	...
	{                                                                                                               \
		...
		if(0 != evalOnceErrorCode)                                                                                  \
		{                                                                                                           \
			DEBUG_ASSERT_MESSAGE(DEBUG_ASSERT_COMPONENT_NAME_STRING, #errorCode " == 0 ", #exceptionLabel, message, \
								 __FILE__, __LINE__, evalOnceErrorCode);                                            \
			goto exceptionLabel;                                                                                    \
		}                                                                                                           \
	} while(0)
