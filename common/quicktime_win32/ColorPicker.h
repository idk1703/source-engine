...
#pragma pack(2)
	 ...
	 */
	EXTERN_API(void)
	CMY2RGB(const CMYColor *cColor, RGBColor *rColor) THREEWORDINLINE(0x3F3C, 0x0003, 0xA82E);
	 ...
	 */
	EXTERN_API(void)
	RGB2CMY(const RGBColor *rColor, CMYColor *cColor) THREEWORDINLINE(0x3F3C, 0x0004, 0xA82E);
	 ...
	 */
	EXTERN_API(void)
	HSL2RGB(const HSLColor *hColor, RGBColor *rColor) THREEWORDINLINE(0x3F3C, 0x0005, 0xA82E);
	 ...
	 */
	EXTERN_API(void)
	RGB2HSL(const RGBColor *rColor, HSLColor *hColor) THREEWORDINLINE(0x3F3C, 0x0006, 0xA82E);
	 ...
	 */
	EXTERN_API(void)
	HSV2RGB(const HSVColor *hColor, RGBColor *rColor) THREEWORDINLINE(0x3F3C, 0x0007, 0xA82E);
	 ...
	 */
	EXTERN_API(void)
	RGB2HSV(const RGBColor *rColor, HSVColor *hColor) THREEWORDINLINE(0x3F3C, 0x0008, 0xA82E);
	 ...
	 */
	EXTERN_API(Boolean)
	GetColor(Point where, ConstStr255Param prompt, const RGBColor *inColor, RGBColor *outColor)
	...
	{
		return (ColorChangedUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppColorChangedProcInfo,
...
#define NewColorChangedUPP(userRoutine) \
	...
	{
		return (NColorChangedUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppNColorChangedProcInfo,
													  GetCurrentArchitecture());
	}
#else
#define NewNColorChangedUPP(userRoutine) \
	(NColorChangedUPP) NewRoutineDescriptor((ProcPtr)(userRoutine), uppNColorChangedProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (UserEventUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppUserEventProcInfo,
												  GetCurrentArchitecture());
	}
#else
...
#define DisposeUserEventUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(void)
	InvokeColorChangedUPP(long userData, PMColor *newColor, ColorChangedUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeColorChangedUPP(userData, newColor, userUPP) \
	 ...
	 */
	EXTERN_API_C(void)
	InvokeNColorChangedUPP(long userData, NPMColor *newColor, NColorChangedUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
