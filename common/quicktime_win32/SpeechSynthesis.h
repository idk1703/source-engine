...
#pragma pack(2)
	...
	typedef CALLBACK_API(void, SpeechTextDoneProcPtr)(SpeechChannel chan, long refCon, const void **nextBuf,
	...
	typedef CALLBACK_API(void, SpeechWordProcPtr)(SpeechChannel chan, long refCon, unsigned long wordPos,
	...
	{
		return (SpeechTextDoneUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppSpeechTextDoneProcInfo,
													   GetCurrentArchitecture());
	}
#else
#define NewSpeechTextDoneUPP(userRoutine) \
	(SpeechTextDoneUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppSpeechTextDoneProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (SpeechDoneUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppSpeechDoneProcInfo,
												   GetCurrentArchitecture());
	}
#else
#define NewSpeechDoneUPP(userRoutine) \
	...
	{
		return (SpeechSyncUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppSpeechSyncProcInfo,
												   GetCurrentArchitecture());
	}
#else
#define NewSpeechSyncUPP(userRoutine) \
	...
	{
		return (SpeechErrorUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppSpeechErrorProcInfo,
													GetCurrentArchitecture());
	}
#else
#define NewSpeechErrorUPP(userRoutine) \
	...
	{
		return (SpeechPhonemeUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppSpeechPhonemeProcInfo,
													  GetCurrentArchitecture());
	}
#else
#define NewSpeechPhonemeUPP(userRoutine) \
	...
	{
		return (SpeechWordUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppSpeechWordProcInfo,
												   GetCurrentArchitecture());
	}
#else
...
#define DisposeSpeechWordUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(void)
	InvokeSpeechTextDoneUPP(SpeechChannel chan, long refCon, const void **nextBuf, unsigned long *byteLen,
							long *controlFlags, SpeechTextDoneUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#else
#define InvokeSpeechTextDoneUPP(chan, refCon, nextBuf, byteLen, controlFlags, userUPP)                    \
	CALL_FIVE_PARAMETER_UPP((userUPP), uppSpeechTextDoneProcInfo, (chan), (refCon), (nextBuf), (byteLen), \
							(controlFlags))
#endif
#endif
...
#define InvokeSpeechDoneUPP(chan, refCon, userUPP) \
	 ...
	 */
	EXTERN_API_C(void)
	InvokeSpeechSyncUPP(SpeechChannel chan, long refCon, OSType syncMessage, SpeechSyncUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void)
		InvokeSpeechSyncUPP(SpeechChannel chan, long refCon, OSType syncMessage, SpeechSyncUPP userUPP)
...
#define InvokeSpeechSyncUPP(chan, refCon, syncMessage, userUPP) \
	 ...
	 */
	EXTERN_API_C(void)
	InvokeSpeechErrorUPP(SpeechChannel chan, long refCon, OSErr theError, long bytePos, SpeechErrorUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void)
		InvokeSpeechErrorUPP(SpeechChannel chan, long refCon, OSErr theError, long bytePos, SpeechErrorUPP userUPP)
...
#define InvokeSpeechErrorUPP(chan, refCon, theError, bytePos, userUPP) \
	 ...
	 */
	EXTERN_API_C(void)
	InvokeSpeechPhonemeUPP(SpeechChannel chan, long refCon, short phonemeOpcode, SpeechPhonemeUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void)
		InvokeSpeechPhonemeUPP(SpeechChannel chan, long refCon, short phonemeOpcode, SpeechPhonemeUPP userUPP)
...
#define InvokeSpeechPhonemeUPP(chan, refCon, phonemeOpcode, userUPP) \
	 ...
	 */
	EXTERN_API_C(void)
	InvokeSpeechWordUPP(SpeechChannel chan, long refCon, unsigned long wordPos, unsigned short wordLen,
						SpeechWordUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void) InvokeSpeechWordUPP(SpeechChannel chan, long refCon, unsigned long wordPos,
...
#define CallSpeechTextDoneProc(userRoutine, chan, refCon, nextBuf, byteLen, controlFlags) \
	InvokeSpeechTextDoneUPP(chan, refCon, nextBuf, byteLen, controlFlags, userRoutine)
...
#define CallSpeechWordProc(userRoutine, chan, refCon, wordPos, wordLen) \
	 ...
	 */
	EXTERN_API(OSErr)
	MakeVoiceSpec(OSType creator, OSType id, VoiceSpec *voice) FOURWORDINLINE(0x203C, 0x0604, 0x000C, 0xA800);
	 ...
	 */
	EXTERN_API(OSErr)
	GetIndVoice(short index, VoiceSpec *voice) FOURWORDINLINE(0x203C, 0x030C, 0x000C, 0xA800);
	 ...
	 */
	EXTERN_API(OSErr)
	GetVoiceDescription(const VoiceSpec *voice, VoiceDescription *info, long infoLength)
	 ...
	 */
	EXTERN_API(OSErr)
	SpeakBuffer(SpeechChannel chan, const void *textBuf, unsigned long textBytes, long controlFlags)
	 ...
	 */
	EXTERN_API(OSErr)
	StopSpeechAt(SpeechChannel chan, long whereToStop) FOURWORDINLINE(0x203C, 0x0430, 0x000C, 0xA800);
	 ...
	 */
	EXTERN_API(OSErr)
	PauseSpeechAt(SpeechChannel chan, long whereToPause) FOURWORDINLINE(0x203C, 0x0434, 0x000C, 0xA800);
	 ...
	 */
	EXTERN_API(OSErr)
	SetSpeechRate(SpeechChannel chan, Fixed rate) FOURWORDINLINE(0x203C, 0x0444, 0x000C, 0xA800);
	 ...
	 */
	EXTERN_API(OSErr)
	GetSpeechRate(SpeechChannel chan, Fixed *rate) FOURWORDINLINE(0x203C, 0x0448, 0x000C, 0xA800);
	 ...
	 */
	EXTERN_API(OSErr)
	SetSpeechPitch(SpeechChannel chan, Fixed pitch) FOURWORDINLINE(0x203C, 0x044C, 0x000C, 0xA800);
	 ...
	 */
	EXTERN_API(OSErr)
	GetSpeechPitch(SpeechChannel chan, Fixed *pitch) FOURWORDINLINE(0x203C, 0x0450, 0x000C, 0xA800);
	 ...
	 */
	EXTERN_API(OSErr)
	GetSpeechInfo(SpeechChannel chan, OSType selector, void *speechInfo) FOURWORDINLINE(0x203C, 0x0658, 0x000C, 0xA800);
	 ...
	 */
	EXTERN_API(OSErr)
	TextToPhonemes(SpeechChannel chan, const void *textBuf, unsigned long textBytes, Handle phonemeBuf,
	 ...
	 */
	EXTERN_API(OSErr)
	UseDictionary(SpeechChannel chan, Handle dictionary) FOURWORDINLINE(0x203C, 0x0460, 0x000C, 0xA800);
