...
#define kQ3MethodTypeObjectReadData \
	Q3_METHOD_TYPE('r', 'd', 'd', 't') /* Read info from file into buffer or, attach read data to parent */
...
#define kQ3MethodTypeElementDelete		  Q3_METHOD_TYPE('e', 'd', 'e', 'l')
	...
	typedef CALLBACK_API_C(TQ3Status, TQ3ElementCopyReplaceMethod)(const void *fromAPIElement,
	...
	typedef CALLBACK_API_C(TQ3Status, TQ3ElementCopyDuplicateMethod)(const void *fromInternalElement,
	...
	Q3ElementClass_Register(TQ3ElementType elementType, const char *name, unsigned long sizeOfElement,
 ...
 */
	 ...
	 */
	EXTERN_API_C(TQ3Status)
	Q3Pick_GetHitData(TQ3PickObject pick, unsigned long index, TQ3HitData *hitData);
	 ...
	 */
	EXTERN_API_C(TQ3Status)
	Q3Renderer_Sync(TQ3RendererObject renderer, TQ3ViewObject view);
 ...
 */
	 ...
	 */
	EXTERN_API_C(TQ3Status)
	Q3View_SubmitWriteData(TQ3ViewObject view, TQ3Size size, void *data, TQ3DataDeleteMethod deleteData);
