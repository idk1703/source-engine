...
#pragma pack(2)
	...
	**************************************************************************/
	...
	typedef CALLBACK_API(Boolean, AEFilterProcPtr)(EventRecord *theEvent, long returnID, long transactionID,
	...
	**************************************************************************/
	 ...
	 */
	EXTERN_API(OSErr)
	AESend(const AppleEvent *theAppleEvent, AppleEvent *reply, AESendMode sendMode, AESendPriority sendPriority,
		   long timeOutInTicks, AEIdleUPP idleProc, /* can be NULL */
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	AEResumeTheCurrentEvent(const AppleEvent *theAppleEvent, const AppleEvent *reply,
...
#define DisposeAEFilterUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	...
	InvokeAEIdleUPP(EventRecord *theEvent, long *sleepTime, RgnHandle *mouseRgn, AEIdleUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeAEIdleUPP(theEvent, sleepTime, mouseRgn, userUPP) \
	(Boolean) CALL_THREE_PARAMETER_UPP((userUPP), uppAEIdleProcInfo, (theEvent), (sleepTime), (mouseRgn))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(Boolean)
	InvokeAEFilterUPP(EventRecord *theEvent, long returnID, long transactionID, const AEAddressDesc *sender,
					  AEFilterUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(Boolean) InvokeAEFilterUPP(EventRecord *theEvent, long returnID, long transactionID,
												   const AEAddressDesc *sender, AEFilterUPP userUPP)
	{
		return (Boolean)CALL_FOUR_PARAMETER_UPP(userUPP, uppAEFilterProcInfo, theEvent, returnID, transactionID,
												sender);
	}
#else
#define InvokeAEFilterUPP(theEvent, returnID, transactionID, sender, userUPP) \
	(Boolean) CALL_FOUR_PARAMETER_UPP((userUPP), uppAEFilterProcInfo, (theEvent), (returnID), (transactionID), (sender))
#endif
#endif
