...
typedef Ptr AEDataStorageType;
	...
	**************************************************************************/
	...
	enum
	{
		...
		kAEProcessNonReplyEvents =
			0x00008000 /* allow processing of non-reply events while awaiting synchronous AppleEvent reply */
	};
	...
	**************************************************************************/
	typedef CALLBACK_API(OSErr, AECoerceDescProcPtr)(const AEDesc *fromDesc, DescType toType, long handlerRefcon,
													 AEDesc *toDesc);
	typedef CALLBACK_API(OSErr, AECoercePtrProcPtr)(DescType typeCode, const void *dataPtr, Size dataSize,
	...
	{
		return (AECoerceDescUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppAECoerceDescProcInfo,
...
#define NewAECoerceDescUPP(userRoutine) \
	...
	{
		return (AECoercePtrUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppAECoercePtrProcInfo,
													GetCurrentArchitecture());
	}
#else
...
#define DisposeAECoercePtrUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeAECoerceDescUPP(const AEDesc *fromDesc, DescType toType, long handlerRefcon, AEDesc *toDesc,
						  AECoerceDescUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSErr) InvokeAECoerceDescUPP(const AEDesc *fromDesc, DescType toType, long handlerRefcon,
													 AEDesc *toDesc, AECoerceDescUPP userUPP)
	{
		return (OSErr)CALL_FOUR_PARAMETER_UPP(userUPP, uppAECoerceDescProcInfo, fromDesc, toType, handlerRefcon,
											  toDesc);
	}
#else
#define InvokeAECoerceDescUPP(fromDesc, toType, handlerRefcon, toDesc, userUPP) \
	(OSErr) CALL_FOUR_PARAMETER_UPP((userUPP), uppAECoerceDescProcInfo, (fromDesc), (toType), (handlerRefcon), (toDesc))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeAECoercePtrUPP(DescType typeCode, const void *dataPtr, Size dataSize, DescType toType, long handlerRefcon,
						 AEDesc *result, AECoercePtrUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSErr)
		InvokeAECoercePtrUPP(DescType typeCode, const void *dataPtr, Size dataSize, DescType toType, long handlerRefcon,
							 AEDesc *result, AECoercePtrUPP userUPP)
	{
		return (OSErr)CALL_SIX_PARAMETER_UPP(userUPP, uppAECoercePtrProcInfo, typeCode, dataPtr, dataSize, toType,
											 handlerRefcon, result);
	}
#else
#define InvokeAECoercePtrUPP(typeCode, dataPtr, dataSize, toType, handlerRefcon, result, userUPP)                  \
	(OSErr) CALL_SIX_PARAMETER_UPP((userUPP), uppAECoercePtrProcInfo, (typeCode), (dataPtr), (dataSize), (toType), \
								   (handlerRefcon), (result))
#endif
#endif
...
#define CallAECoercePtrProc(userRoutine, typeCode, dataPtr, dataSize, toType, handlerRefcon, result) \
	InvokeAECoercePtrUPP(typeCode, dataPtr, dataSize, toType, handlerRefcon, result, userRoutine)
#endif /* CALL_NOT_IN_CARBON */
	 ...
	 */
	EXTERN_API(OSErr)
	AEInstallCoercionHandler(DescType fromType, DescType toType, AECoercionHandlerUPP handler, long handlerRefcon,
							 Boolean fromTypeIsDesc, Boolean isSysHandler) THREEWORDINLINE(0x303C, 0x0A22, 0xA816);
	 ...
	 */
	EXTERN_API(OSErr)
	AEGetCoercionHandler(DescType fromType, DescType toType, AECoercionHandlerUPP *handler, long *handlerRefcon,
						 Boolean *fromTypeIsDesc, Boolean isSysHandler) THREEWORDINLINE(0x303C, 0x0B24, 0xA816);
	...
	**************************************************************************/
	 ...
	 */
	EXTERN_API(OSErr)
	AECoerceDesc(const AEDesc *theAEDesc, DescType toType, AEDesc *result) THREEWORDINLINE(0x303C, 0x0603, 0xA816);
...
#define AEInitializeDescInline(__d)   \
	 ...
	 */
	EXTERN_API(OSErr)
	AEDuplicateDesc(const AEDesc *theAEDesc, AEDesc *result) THREEWORDINLINE(0x303C, 0x0405, 0xA816);
	...
	AECreateDescFromExternalPtr(OSType descriptorType, const void *dataPtr, Size dataLength,
								AEDisposeExternalUPP disposeCallback, long disposeRefcon, AEDesc *theDesc);
	...
	**************************************************************************/
	 ...
	 */
	EXTERN_API(OSErr)
	AECountItems(const AEDescList *theAEDescList, long *theCount) THREEWORDINLINE(0x303C, 0x0407, 0xA816);
	 ...
	 */
	EXTERN_API(OSErr)
	AEPutDesc(AEDescList *theAEDescList, long index, const AEDesc *theAEDesc) THREEWORDINLINE(0x303C, 0x0609, 0xA816);
	 ...
	 */
	EXTERN_API(OSErr)
	AEGetNthDesc(const AEDescList *theAEDescList, long index, DescType desiredType, AEKeyword *theAEKeyword,
	...
	AEGetArray(const AEDescList *theAEDescList, AEArrayType arrayType, AEArrayDataPointer arrayPtr, Size maximumSize,
			   DescType *itemType, Size *itemSize, long *itemCount) THREEWORDINLINE(0x303C, 0x0D0C, 0xA816);
	...
	AEPutArray(AEDescList *theAEDescList, AEArrayType arrayType, const AEArrayData *arrayPtr, DescType itemType,
			   Size itemSize, long itemCount) THREEWORDINLINE(0x303C, 0x0B0D, 0xA816);
	 ...
	 */
	EXTERN_API(OSErr)
	AEDeleteItem(AEDescList *theAEDescList, long index) THREEWORDINLINE(0x303C, 0x040E, 0xA816);
...
#define AEDeleteKeyDesc(theAERecord, theAEKeyword) AEDeleteParam((theAERecord), (theAEKeyword))
	...
	**************************************************************************/
	 ...
	 */
	EXTERN_API(OSErr)
	AEPutParamPtr(AppleEvent *theAppleEvent, AEKeyword theAEKeyword, DescType typeCode, const void *dataPtr,
	 ...
	 */
	EXTERN_API(OSErr)
	AEGetParamPtr(const AppleEvent *theAppleEvent, AEKeyword theAEKeyword, DescType desiredType, DescType *typeCode,
				  void *dataPtr, Size maximumSize, Size *actualSize) THREEWORDINLINE(0x303C, 0x0E11, 0xA816);
	 ...
	 */
	EXTERN_API(OSErr)
	AEDeleteParam(AppleEvent *theAppleEvent, AEKeyword theAEKeyword) THREEWORDINLINE(0x303C, 0x0413, 0xA816);
	...
	**************************************************************************/
	...
	AEGetAttributePtr(const AppleEvent *theAppleEvent, AEKeyword theAEKeyword, DescType desiredType, DescType *typeCode,
					  void *dataPtr, Size maximumSize, Size *actualSize) THREEWORDINLINE(0x303C, 0x0E15, 0xA816);
	...
	*/
	 ...
	 */
	EXTERN_API_C(OSStatus)
	AEFlattenDesc(const AEDesc *theAEDesc, Ptr buffer, Size bufferSize, Size *actualSize);
...
**************************************************************************/
	...
	**************************************************************************/
	typedef CALLBACK_API(OSErr, AEEventHandlerProcPtr)(const AppleEvent *theAppleEvent, AppleEvent *reply,
													   long handlerRefcon);
	...
	enum
	{
		uppAEDisposeExternalProcInfo = 0x00000FC0
	...
	{
		return (AEDisposeExternalUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppAEDisposeExternalProcInfo,
														  GetCurrentArchitecture());
	}
#else
#define NewAEDisposeExternalUPP(userRoutine) \
	(AEDisposeExternalUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppAEDisposeExternalProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (AEEventHandlerUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppAEEventHandlerProcInfo,
													   GetCurrentArchitecture());
	}
#else
#define NewAEEventHandlerUPP(userRoutine) \
	(AEEventHandlerUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppAEEventHandlerProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeAEEventHandlerUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(void)
	InvokeAEDisposeExternalUPP(const void *dataPtr, Size dataLength, long refcon, AEDisposeExternalUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#else
#define InvokeAEDisposeExternalUPP(dataPtr, dataLength, refcon, userUPP) \
	CALL_THREE_PARAMETER_UPP((userUPP), uppAEDisposeExternalProcInfo, (dataPtr), (dataLength), (refcon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeAEEventHandlerUPP(const AppleEvent *theAppleEvent, AppleEvent *reply, long handlerRefcon,
							AEEventHandlerUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSErr) InvokeAEEventHandlerUPP(const AppleEvent *theAppleEvent, AppleEvent *reply,
...
#define InvokeAEEventHandlerUPP(theAppleEvent, reply, handlerRefcon, userUPP) \
	(OSErr) CALL_THREE_PARAMETER_UPP((userUPP), uppAEEventHandlerProcInfo, (theAppleEvent), (reply), (handlerRefcon))
#endif
#endif
...
#define CallAEDisposeExternalProc(userRoutine, dataPtr, dataLength, refcon) \
	InvokeAEDisposeExternalUPP(dataPtr, dataLength, refcon, userRoutine)
