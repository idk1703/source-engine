...
#define kDCMInvalidObjectRef ((DCMObjectRef)kInvalidID)
	...
	*/
	...
	/*
			Callback routines
	*/
	typedef CALLBACK_API(Boolean, DCMProgressFilterProcPtr)(Boolean determinateProcess, UInt16 percentageComplete,
															UInt32 callbackUD);
	...
	{
		return (DCMProgressFilterUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppDCMProgressFilterProcInfo,
														  GetCurrentArchitecture());
	}
#else
#define NewDCMProgressFilterUPP(userRoutine) \
	(DCMProgressFilterUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppDCMProgressFilterProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeDCMProgressFilterUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	...
	InvokeDCMProgressFilterUPP(Boolean determinateProcess, UInt16 percentageComplete, UInt32 callbackUD,
							   DCMProgressFilterUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(Boolean) InvokeDCMProgressFilterUPP(Boolean determinateProcess, UInt16 percentageComplete,
															UInt32 callbackUD, DCMProgressFilterUPP userUPP)
	{
		return (Boolean)CALL_THREE_PARAMETER_UPP(userUPP, uppDCMProgressFilterProcInfo, determinateProcess,
												 percentageComplete, callbackUD);
	}
#else
#define InvokeDCMProgressFilterUPP(determinateProcess, percentageComplete, callbackUD, userUPP)       \
	(Boolean) CALL_THREE_PARAMETER_UPP((userUPP), uppDCMProgressFilterProcInfo, (determinateProcess), \
									   (percentageComplete), (callbackUD))
#endif
#endif
...
#define CallDCMProgressFilterProc(userRoutine, determinateProcess, percentageComplete, callbackUD) \
	InvokeDCMProgressFilterUPP(determinateProcess, percentageComplete, callbackUD, userRoutine)
#endif /* CALL_NOT_IN_CARBON */
	...
	*/
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMNewDictionary(DCMAccessMethodID accessMethodID, const FSSpec *newDictionaryFile, ScriptCode scriptTag,
					 const AEDesc *listOfFieldInfoRecords, Boolean invisible, ItemCount recordCapacity,
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMDeriveNewDictionary(DCMDictionaryID srcDictionary, const FSSpec *newDictionaryFile, ScriptCode scriptTag,
						   Boolean invisible, ItemCount recordCapacity, DCMDictionaryID *newDictionary);
	...
	*/
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMRegisterDictionaryFile(const FSSpec *dictionaryFile, DCMDictionaryID *dictionaryID);
	...
	*/
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMOpenDictionary(DCMDictionaryID dictionaryID, ByteCount protectKeySize, ConstLogicalAddress protectKey,
	...
	*/
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMGetDictionaryWriteAccess(DCMDictionaryRef dictionaryRef, Duration timeOutDuration);
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMReleaseDictionaryWriteAccess(DCMDictionaryRef dictionaryRef, Boolean commitTransaction);
	...
	*/
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMFindRecords(DCMDictionaryRef dictionaryRef, DCMFieldTag keyFieldTag, ByteCount keySize,
				   ConstLogicalAddress keyData, DCMFindMethod findMethod, ItemCount preFetchedDataNum,
				   DCMFieldTag preFetchedData[], ItemCount skipCount, ItemCount maxRecordCount,
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMIterateFoundRecord(DCMFoundRecordIterator recordIterator, ByteCount maxKeySize, ByteCount *actualKeySize,
						  LogicalAddress keyData, DCMUniqueID *uniqueID, AEDesc *dataList);
	...
	*/
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMGetRecordSequenceNumber(DCMDictionaryRef dictionaryRef, DCMFieldTag keyFieldTag, ByteCount keySize,
							   ConstLogicalAddress keyData, DCMUniqueID uniqueID, ItemCount *sequenceNum);
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMGetNthRecord(DCMDictionaryRef dictionaryRef, DCMFieldTag keyFieldTag, ItemCount serialNum, ByteCount maxKeySize,
					ByteCount *keySize, LogicalAddress keyData, DCMUniqueID *uniqueID);
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMGetNextRecord(DCMDictionaryRef dictionaryRef, DCMFieldTag keyFieldTag, ByteCount keySize,
					 ConstLogicalAddress keyData, DCMUniqueID uniqueID, ByteCount maxKeySize, ByteCount *nextKeySize,
					 LogicalAddress nextKeyData, DCMUniqueID *nextUniqueID);
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMGetPrevRecord(DCMDictionaryRef dictionaryRef, DCMFieldTag keyFieldTag, ByteCount keySize,
					 ConstLogicalAddress keyData, DCMUniqueID uniqueID, ByteCount maxKeySize, ByteCount *prevKeySize,
					 LogicalAddress prevKeyData, DCMUniqueID *prevUniqueID);
	...
	*/
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMGetFieldData(DCMDictionaryRef dictionaryRef, DCMFieldTag keyFieldTag, ByteCount keySize,
					ConstLogicalAddress keyData, DCMUniqueID uniqueID, ItemCount numOfData, const DCMFieldTag dataTag[],
					AEDesc *dataList);
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMSetFieldData(DCMDictionaryRef dictionaryRef, DCMFieldTag keyFieldTag, ByteCount keySize,
					ConstLogicalAddress keyData, DCMUniqueID uniqueID, const AEDesc *dataList);
	...
	*/
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMAddRecord(DCMDictionaryRef dictionaryRef, DCMFieldTag keyFieldTag, ByteCount keySize,
				 ConstLogicalAddress keyData, Boolean checkOnly, const AEDesc *dataList, DCMUniqueID *newUniqueID);
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMDeleteRecord(DCMDictionaryRef dictionaryRef, DCMFieldTag keyFieldTag, ByteCount keySize,
	...
	*/
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMReorganizeDictionary(DCMDictionaryID dictionaryID, ItemCount extraCapacity, DCMProgressFilterUPP progressProc,
							UInt32 userData);
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMCompactDictionary(DCMDictionaryID dictionaryID, DCMProgressFilterUPP progressProc, UInt32 userData);
	...
	*/
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMGetDictionaryIDFromFile(const FSSpec *fileRef, DCMDictionaryID *dictionaryID);
	...
	*/
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMGetDictionaryFieldInfo(DCMDictionaryID dictionaryID, DCMFieldTag fieldTag, AEDesc *fieldInfoRecord);
	...
	*/
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMGetDictionaryProperty(DCMDictionaryID dictionaryID, DCMFieldTag propertyTag, ByteCount maxPropertySize,
							 ByteCount *actualSize, LogicalAddress propertyValue);
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMSetDictionaryProperty(DCMDictionaryID dictionaryID, DCMFieldTag propertyTag, ByteCount propertySize,
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMGetDictionaryPropertyList(DCMDictionaryID dictionaryID, ItemCount maxPropertyNum, ItemCount *numProperties,
	...
	*/
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMGetAccessMethodIDFromName(ConstStr63Param accessMethodName, DCMAccessMethodID *accessMethodID);
	...
	*/
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMCreateFieldInfoRecord(DescType fieldTag, DescType fieldType, ByteCount maxRecordSize,
							 DCMFieldAttributes fieldAttributes, AEDesc *fieldDefaultData,
							 ItemCount numberOfFindMethods, DCMFindMethod findMethods[], AEDesc *fieldInfoRecord);
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMGetFieldTagAndType(const AEDesc *fieldInfoRecord, DCMFieldTag *fieldTag, DCMFieldType *fieldType);
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMGetFieldMaxRecordSize(const AEDesc *fieldInfoRecord, ByteCount *maxRecordSize);
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMGetFieldAttributes(const AEDesc *fieldInfoRecord, DCMFieldAttributes *attributes);
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMGetFieldDefaultData(const AEDesc *fieldInfoRecord, DescType desiredType, AEDesc *fieldDefaultData);
	 ...
	 */
	EXTERN_API(OSStatus)
	DCMGetFieldFindMethods(const AEDesc *fieldInfoRecord, ItemCount findMethodsArrayMaxSize,
						   DCMFindMethod findMethods[], ItemCount *actualNumberOfFindMethods);
...
#pragma options align = mac68k
	...
	enum
	{
		...
		kInsertOrReplace = 2 /* Insert the entry if there is nothing in the dictionary which matches the key, otherwise
								replaces the existing matched entries with the input entry. */
	};
	 ...
	 */
	EXTERN_API(OSErr)
	InitializeDictionary(const FSSpec *theFsspecPtr, SInt16 maximumKeyLength, SInt8 keyAttributes, ScriptCode script)
	 ...
	 */
	EXTERN_API(OSErr)
	OpenDictionary(const FSSpec *theFsspecPtr, SInt8 accessPermission, SInt32 *dictionaryReference)
	 ...
	 */
	EXTERN_API(OSErr)
	InsertRecordToDictionary(SInt32 dictionaryReference, ConstStr255Param key, Handle recordDataHandle,
	 ...
	 */
	EXTERN_API(OSErr)
	FindRecordInDictionary(SInt32 dictionaryReference, ConstStr255Param key,
						   DictionaryAttributeTablePtr requestedAttributeTablePointer, Handle recordDataHandle)
	 ...
	 */
	EXTERN_API(OSErr)
	FindRecordByIndexInDictionary(SInt32 dictionaryReference, SInt32 recordIndex,
								  DictionaryAttributeTablePtr requestedAttributeTablePointer, Str255 recordKey,
	 ...
	 */
	EXTERN_API(OSErr)
	GetDictionaryInformation(SInt32 dictionaryReference, DictionaryInformation *theDictionaryInformation)
