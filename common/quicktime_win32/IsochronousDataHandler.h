...
#pragma pack(2)
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	IDHSetDeviceConfiguration(ComponentInstance idh, const QTAtomSpec *configurationID)
	 ...
	 */
	EXTERN_API(ComponentResult)
	IDHGetDeviceStatus(ComponentInstance idh, const QTAtomSpec *configurationID, IDHDeviceStatus *status)
	 ...
	 */
	EXTERN_API(ComponentResult)
	IDHGetDeviceClock(ComponentInstance idh, Component *clock) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0005, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	IDHOpenDevice(ComponentInstance idh, UInt32 permissions) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0006, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	IDHRead(ComponentInstance idh, IDHParameterBlock *pb) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0008, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	IDHWrite(ComponentInstance idh, IDHParameterBlock *pb) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0009, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	IDHNewNotification(ComponentInstance idh, IDHDeviceID deviceID, IDHNotificationUPP notificationProc, void *userData,
	 ...
	 */
	EXTERN_API(ComponentResult)
	IDHNotifyMeWhen(ComponentInstance idh, IDHNotificationID notificationID, IDHEvent events)
	 ...
	 */
	EXTERN_API(ComponentResult)
	IDHSetFormat(ComponentInstance idh, UInt32 format) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0013, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	IDHGetFormat(ComponentInstance idh, UInt32 *format) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0014, 0x7000, 0xA82A);
...
#define DisposeIDHNotificationUPP(userUPP)
	...
	InvokeIDHNotificationUPP(IDHGenericEvent *event, void *userData, IDHNotificationUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
