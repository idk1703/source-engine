...
#define ATPaKillQEl		KILL.aKillQEl
	...
	*/
	...
	typedef CALLBACK_API_REGISTER68K(Boolean, MPPProtocolHandlerProcPtr,
									 (Ptr SCCAddr1, Ptr SCCAddr2, Ptr MPPLocalVars, Ptr nextFreeByteInRHA,
									  Ptr ReadPacketAndReadRestPtr, short numBytesLeftToReadInPacket));
	...
	*/
	...
	struct AFPLoginPrm
	{
		...
		UInt8 ccbFill[144]; /*CCB memory allocated for driver  Login needs only 150 bytes BUT CCB really starts in the
	...
	{
		return (ATalkTransitionEventUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppATalkTransitionEventProcInfo,
															 GetCurrentArchitecture());
	}
#else
#define NewATalkTransitionEventUPP(userRoutine) \
	(ATalkTransitionEventUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppATalkTransitionEventProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (MPPCompletionUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppMPPCompletionProcInfo,
													  GetCurrentArchitecture());
	}
#else
#define NewMPPCompletionUPP(userRoutine) \
	...
	{
		return (ATPCompletionUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppATPCompletionProcInfo,
													  GetCurrentArchitecture());
	}
#else
#define NewATPCompletionUPP(userRoutine) \
	...
	{
		return (XPPCompletionUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppXPPCompletionProcInfo,
													  GetCurrentArchitecture());
	}
#else
#define NewXPPCompletionUPP(userRoutine) \
	...
	{
		return (AttnRoutineUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppAttnRoutineProcInfo,
													GetCurrentArchitecture());
	}
#else
#define NewAttnRoutineUPP(userRoutine) \
	...
	{
		return (MPPProtocolHandlerUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppMPPProtocolHandlerProcInfo,
														   GetCurrentArchitecture());
	}
#else
#define NewMPPProtocolHandlerUPP(userRoutine) \
	(MPPProtocolHandlerUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppMPPProtocolHandlerProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (DDPSocketListenerUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppDDPSocketListenerProcInfo,
														  GetCurrentArchitecture());
	}
#else
#define NewDDPSocketListenerUPP(userRoutine) \
	(DDPSocketListenerUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppDDPSocketListenerProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeDDPSocketListenerUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(long)
	InvokeATalkTransitionEventUPP(long eventCode, ATQEntryPtr qElem, void *eventParameter,
								  ATalkTransitionEventUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(long) InvokeATalkTransitionEventUPP(long eventCode, ATQEntryPtr qElem, void *eventParameter,
															ATalkTransitionEventUPP userUPP)
	{
		return (long)CALL_THREE_PARAMETER_UPP(userUPP, uppATalkTransitionEventProcInfo, eventCode, qElem,
											  eventParameter);
	}
#else
#define InvokeATalkTransitionEventUPP(eventCode, qElem, eventParameter, userUPP) \
	(long)CALL_THREE_PARAMETER_UPP((userUPP), uppATalkTransitionEventProcInfo, (eventCode), (qElem), (eventParameter))
#endif
#endif
...
#endif
	EXTERN_API_C(void)
	InvokeMPPCompletionUPP(MPPPBPtr thePBptr, MPPCompletionUPP userUPP) ONEWORDINLINE(0x4E91);
...
#endif
	EXTERN_API_C(void)
	InvokeATPCompletionUPP(ATPPBPtr thePBptr, ATPCompletionUPP userUPP) ONEWORDINLINE(0x4E91);
#if !OPAQUE_UPP_TYPES && (!TARGET_OS_MAC || !TARGET_CPU_68K || TARGET_RT_MAC_CFM)
#ifdef __cplusplus
...
#endif
	EXTERN_API_C(void)
	InvokeXPPCompletionUPP(XPPParmBlkPtr thePBptr, XPPCompletionUPP userUPP) ONEWORDINLINE(0x4E91);
#if !OPAQUE_UPP_TYPES && (!TARGET_OS_MAC || !TARGET_CPU_68K || TARGET_RT_MAC_CFM)
#ifdef __cplusplus
...
#endif
	EXTERN_API_C(void)
	InvokeAttnRoutineUPP(short sessRefnum, short attnBytes, AttnRoutineUPP userUPP) ONEWORDINLINE(0x4E90);
#if !OPAQUE_UPP_TYPES && (!TARGET_OS_MAC || !TARGET_CPU_68K || TARGET_RT_MAC_CFM)
#ifdef __cplusplus
...
#define InvokeAttnRoutineUPP(sessRefnum, attnBytes, userUPP) \
	...
	InvokeMPPProtocolHandlerUPP(Ptr SCCAddr1, Ptr SCCAddr2, Ptr MPPLocalVars, Ptr nextFreeByteInRHA,
								Ptr ReadPacketAndReadRestPtr, short numBytesLeftToReadInPacket,
	...
	inline DEFINE_API_C(Boolean)
		InvokeMPPProtocolHandlerUPP(Ptr SCCAddr1, Ptr SCCAddr2, Ptr MPPLocalVars, Ptr nextFreeByteInRHA,
									...
									MPPProtocolHandlerUPP userUPP)
	{
		return (Boolean)CALL_SIX_PARAMETER_UPP(userUPP, uppMPPProtocolHandlerProcInfo, SCCAddr1, SCCAddr2, MPPLocalVars,
											   nextFreeByteInRHA, ReadPacketAndReadRestPtr, numBytesLeftToReadInPacket);
	}
#else
#define InvokeMPPProtocolHandlerUPP(SCCAddr1, SCCAddr2, MPPLocalVars, nextFreeByteInRHA, ReadPacketAndReadRestPtr,     \
									numBytesLeftToReadInPacket, userUPP)                                               \
	(Boolean) CALL_SIX_PARAMETER_UPP((userUPP), uppMPPProtocolHandlerProcInfo, (SCCAddr1), (SCCAddr2), (MPPLocalVars), \
									 (nextFreeByteInRHA), (ReadPacketAndReadRestPtr), (numBytesLeftToReadInPacket))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(Boolean)
	InvokeDDPSocketListenerUPP(Ptr SCCAddr1, Ptr SCCAddr2, Ptr MPPLocalVars, Ptr nextFreeByteInRHA,
							   Ptr ReadPacketAndReadRestPtr, UInt8 packetDestinationNumber,
	...
	inline DEFINE_API_C(Boolean)
		InvokeDDPSocketListenerUPP(Ptr SCCAddr1, Ptr SCCAddr2, Ptr MPPLocalVars, Ptr nextFreeByteInRHA,
								   ...
								   short numBytesLeftToReadInPacket, DDPSocketListenerUPP userUPP)
	{
		return (Boolean)CALL_SEVEN_PARAMETER_UPP(userUPP, uppDDPSocketListenerProcInfo, SCCAddr1, SCCAddr2,
												 MPPLocalVars, nextFreeByteInRHA, ReadPacketAndReadRestPtr,
												 packetDestinationNumber, numBytesLeftToReadInPacket);
	}
#else
#define InvokeDDPSocketListenerUPP(SCCAddr1, SCCAddr2, MPPLocalVars, nextFreeByteInRHA, ReadPacketAndReadRestPtr, \
								   packetDestinationNumber, numBytesLeftToReadInPacket, userUPP)                  \
	(Boolean) CALL_SEVEN_PARAMETER_UPP((userUPP), uppDDPSocketListenerProcInfo, (SCCAddr1), (SCCAddr2),           \
									   (MPPLocalVars), (nextFreeByteInRHA), (ReadPacketAndReadRestPtr),           \
									   (packetDestinationNumber), (numBytesLeftToReadInPacket))
#endif
#endif
...
#define CallMPPProtocolHandlerProc(userRoutine, SCCAddr1, SCCAddr2, MPPLocalVars, nextFreeByteInRHA,           \
								   ReadPacketAndReadRestPtr, numBytesLeftToReadInPacket)                       \
	InvokeMPPProtocolHandlerUPP(SCCAddr1, SCCAddr2, MPPLocalVars, nextFreeByteInRHA, ReadPacketAndReadRestPtr, \
								numBytesLeftToReadInPacket, userRoutine)
#define CallDDPSocketListenerProc(userRoutine, SCCAddr1, SCCAddr2, MPPLocalVars, nextFreeByteInRHA,              \
								  ReadPacketAndReadRestPtr, packetDestinationNumber, numBytesLeftToReadInPacket) \
	InvokeDDPSocketListenerUPP(SCCAddr1, SCCAddr2, MPPLocalVars, nextFreeByteInRHA, ReadPacketAndReadRestPtr,    \
							   packetDestinationNumber, numBytesLeftToReadInPacket, userRoutine)
#endif /* CALL_NOT_IN_CARBON */
...
#define PLookupNameSync(paramBlock) PLookupName((paramBlock), false)
	 ...
	 */
	EXTERN_API(void)
	BuildLAPwds(Ptr wdsPtr, Ptr dataPtr, short destHost, short prototype, short frameLen);
	 ...
	 */
	EXTERN_API(void)
	BuildDDPwds(Ptr wdsPtr, Ptr headerPtr, Ptr dataPtr, AddrBlock netAddr, short ddpType, short dataLen);
	 ...
	 */
	EXTERN_API(void)
	NBPSetEntity(Ptr buffer, ConstStr32Param nbpObject, ConstStr32Param nbpType, ConstStr32Param nbpZone);
	 ...
	 */
	EXTERN_API(void)
	NBPSetNTE(Ptr ntePtr, ConstStr32Param nbpObject, ConstStr32Param nbpType, ConstStr32Param nbpZone, short socket);
	 ...
	 */
	EXTERN_API(OSErr)
	NBPExtract(Ptr theBuffer, short numInBuf, short whichOne, EntityName *abEntity, AddrBlock *address);
