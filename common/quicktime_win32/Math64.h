...
#define S64Mod(dividend, divisor) ((SInt64)(dividend) % (SInt64)(divisor))
	 ...
	 */
	EXTERN_API_C(SInt64)
	S64Divide(SInt64 dividend, SInt64 divisor, SInt64 *remainder); /* can be NULL */
#if TYPE_LONGLONG
#ifdef __cplusplus
	inline DEFINE_API_C(SInt64) S64Divide(SInt64 dividend, SInt64 divisor, SInt64 *remainder)
	{
		return ((void)((remainder) && (*((SInt64 *)(remainder)) = ((SInt64)(dividend) % (SInt64)(divisor)))),
				((SInt64)(dividend) / (SInt64)(divisor)));
	}
#else
#define S64Divide(dividend, divisor, remainder)                                                     \
	(((void)((remainder) && (*((SInt64 *)(remainder)) = ((SInt64)(dividend) % (SInt64)(divisor)))), \
	  ((SInt64)(dividend) / (SInt64)(divisor))))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(SInt64)
	S64Div(SInt64 dividend, SInt64 divisor);
#if TYPE_LONGLONG
#ifdef __cplusplus
...
#define U64Mod(dividend, divisor) ((UInt64)(dividend) % (UInt64)(divisor))
	 ...
	 */
	EXTERN_API_C(UInt64)
	U64Divide(UInt64 dividend, UInt64 divisor, UInt64 *remainder); /* can be NULL */
#if TYPE_LONGLONG
#ifdef __cplusplus
	inline DEFINE_API_C(UInt64) U64Divide(UInt64 dividend, UInt64 divisor, UInt64 *remainder)
	{
		return ((void)((remainder) && (*((UInt64 *)(remainder)) = ((UInt64)(dividend) % (UInt64)(divisor)))),
				((UInt64)(dividend) / (UInt64)(divisor)));
	}
#else
#define U64Divide(dividend, divisor, remainder)                                                     \
	(((void)((remainder) && (*((UInt64 *)(remainder)) = ((UInt64)(dividend) % (UInt64)(divisor)))), \
	  ((UInt64)(dividend) / (UInt64)(divisor))))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(UInt64)
	U64Div(UInt64 dividend, UInt64 divisor);
#if TYPE_LONGLONG
#ifdef __cplusplus
