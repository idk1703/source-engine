...
#define kThemeAppearanceAquaGraphite CFSTR("com.apple.theme.appearance.aqua.graphite")
	...
	enum
	{
		kThemeBrushMovableModalBackground =
			49, /* use with kMovableModalWindowClass; available in Mac OS X, and CarbonLib 1.3 and later */
		kThemeBrushSheetBackgroundOpaque = 50, /* use with kSheetWindowClass and kSheetAlertWindowClass; available in
												  Mac OS X, and CarbonLib 1.3 and later */
		kThemeBrushDrawerBackground =
			51, /* use with kDrawerWindowClass; available in Mac OS X, and CarbonLib 1.3 and later */
		kThemeBrushToolbarBackground =
			52, /* use with kToolbarWindowClass; available in Mac OS X, and CarbonLib 1.6 and later */
		kThemeBrushSheetBackgroundTransparent = 53, /* use with kSheetWindowClass and kSheetAlertWindowClass; available
													   in Mac OS X 10.1 and CarbonLib 1.6, and later */
	...
	enum
	{
		...
		kThemeUserDefinedTag =
			FOUR_CHAR_CODE('user'), /* Boolean (this should _always_ be true if present - used by Control Panel).*/
	...
	enum
	{
		...
		kUseBestGuess =
			5 /* heuristically determines the best way to display the picture based on picture and monitor sizes*/
	};
	...
	enum
	{
		...
		kThemeWindowHasFullZoom =
			kThemeWindowHasHorizontalZoom + kThemeWindowHasVerticalZoom, /* window zooms in all directions */
	...
	enum
	{
		...
		kThemeAdornmentHeaderButtonLeftNeighborSelected =
			(1 << 6), /* if set, draw the left border of the button as selected ( list header button only ) */
		kThemeAdornmentHeaderButtonRightNeighborSelected =
			(1 << 7), /* if set, draw the right border of the button ( list header button only ) */
		kThemeAdornmentHeaderButtonSortUp =
			(1 << 8), /* if set, draw the sort indicator pointing upward ( list header button only ) */
		kThemeAdornmentHeaderMenuButton =
			(1 << 9), /* if set, draw as a header menu button ( list header button only ) */
		kThemeAdornmentHeaderButtonNoShadow =
			(1 << 10), /* if set, draw the non-shadow area of the button ( list header button only ) */
		kThemeAdornmentHeaderButtonShadowOnly =
			(1 << 11), /* if set, draw the only the shadow area of the button ( list header button only ) */
	...
	/* Callback procs                                                                           */
	/*------------------------------------------------------------------------------------------*/
	typedef CALLBACK_API(void, ThemeTabTitleDrawProcPtr)(const Rect *bounds, ThemeTabStyle style,
														 ThemeTabDirection direction, SInt16 depth, Boolean isColorDev,
														 UInt32 userData);
	typedef CALLBACK_API(void, ThemeEraseProcPtr)(const Rect *bounds, UInt32 eraseData, SInt16 depth,
												  Boolean isColorDev);
	typedef CALLBACK_API(void, ThemeButtonDrawProcPtr)(const Rect *bounds, ThemeButtonKind kind,
													   const ThemeButtonDrawInfo *info, UInt32 userData, SInt16 depth,
													   Boolean isColorDev);
	typedef CALLBACK_API(void, WindowTitleDrawingProcPtr)(const Rect *bounds, SInt16 depth, Boolean colorDevice,
														  UInt32 userData);
	typedef CALLBACK_API(Boolean, ThemeIteratorProcPtr)(ConstStr255Param inFileName, SInt16 resID,
	...
	}; /* pascal no_return_value Func(4_bytes, 2_bytes, 2_bytes, 2_bytes, 1_byte, 4_bytes) */
#ifdef __cplusplus
	inline DEFINE_API_C(ThemeTabTitleDrawUPP) NewThemeTabTitleDrawUPP(ThemeTabTitleDrawProcPtr userRoutine)
	{
		return (ThemeTabTitleDrawUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppThemeTabTitleDrawProcInfo,
...
#define NewThemeTabTitleDrawUPP(userRoutine) \
	...
	{
		return (ThemeEraseUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppThemeEraseProcInfo,
												   GetCurrentArchitecture());
	}
#else
#define NewThemeEraseUPP(userRoutine) \
	(ThemeEraseUPP) NewRoutineDescriptor((ProcPtr)(userRoutine), uppThemeEraseProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	}; /* pascal no_return_value Func(4_bytes, 2_bytes, 4_bytes, 4_bytes, 2_bytes, 1_byte) */
#ifdef __cplusplus
	inline DEFINE_API_C(ThemeButtonDrawUPP) NewThemeButtonDrawUPP(ThemeButtonDrawProcPtr userRoutine)
	{
		return (ThemeButtonDrawUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppThemeButtonDrawProcInfo,
														GetCurrentArchitecture());
	}
#else
#define NewThemeButtonDrawUPP(userRoutine) \
	...
	{
		return (WindowTitleDrawingUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppWindowTitleDrawingProcInfo,
														   GetCurrentArchitecture());
	}
#else
#define NewWindowTitleDrawingUPP(userRoutine) \
	(WindowTitleDrawingUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppWindowTitleDrawingProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (ThemeIteratorUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppThemeIteratorProcInfo,
													  GetCurrentArchitecture());
	}
#else
#define NewThemeIteratorUPP(userRoutine) \
	(ThemeIteratorUPP) NewRoutineDescriptor((ProcPtr)(userRoutine), uppThemeIteratorProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeThemeIteratorUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(void)
	InvokeThemeTabTitleDrawUPP(const Rect *bounds, ThemeTabStyle style, ThemeTabDirection direction, SInt16 depth,
							   Boolean isColorDev, UInt32 userData, ThemeTabTitleDrawUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void)
		InvokeThemeTabTitleDrawUPP(const Rect *bounds, ThemeTabStyle style, ThemeTabDirection direction, SInt16 depth,
								   Boolean isColorDev, UInt32 userData, ThemeTabTitleDrawUPP userUPP)
	{
		CALL_SIX_PARAMETER_UPP(userUPP, uppThemeTabTitleDrawProcInfo, bounds, style, direction, depth, isColorDev,
							   userData);
	}
#else
#define InvokeThemeTabTitleDrawUPP(bounds, style, direction, depth, isColorDev, userData, userUPP)           \
	CALL_SIX_PARAMETER_UPP((userUPP), uppThemeTabTitleDrawProcInfo, (bounds), (style), (direction), (depth), \
						   (isColorDev), (userData))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(void)
	InvokeThemeEraseUPP(const Rect *bounds, UInt32 eraseData, SInt16 depth, Boolean isColorDev, ThemeEraseUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void) InvokeThemeEraseUPP(const Rect *bounds, UInt32 eraseData, SInt16 depth,
...
#define InvokeThemeEraseUPP(bounds, eraseData, depth, isColorDev, userUPP) \
	 ...
	 */
	EXTERN_API_C(void)
	InvokeThemeButtonDrawUPP(const Rect *bounds, ThemeButtonKind kind, const ThemeButtonDrawInfo *info, UInt32 userData,
							 SInt16 depth, Boolean isColorDev, ThemeButtonDrawUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void)
		InvokeThemeButtonDrawUPP(const Rect *bounds, ThemeButtonKind kind, const ThemeButtonDrawInfo *info,
								 UInt32 userData, SInt16 depth, Boolean isColorDev, ThemeButtonDrawUPP userUPP)
	{
...
#define InvokeThemeButtonDrawUPP(bounds, kind, info, userData, depth, isColorDev, userUPP)                       \
	CALL_SIX_PARAMETER_UPP((userUPP), uppThemeButtonDrawProcInfo, (bounds), (kind), (info), (userData), (depth), \
						   (isColorDev))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(void)
	InvokeWindowTitleDrawingUPP(const Rect *bounds, SInt16 depth, Boolean colorDevice, UInt32 userData,
								WindowTitleDrawingUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void) InvokeWindowTitleDrawingUPP(const Rect *bounds, SInt16 depth, Boolean colorDevice,
														  UInt32 userData, WindowTitleDrawingUPP userUPP)
	{
...
#define InvokeWindowTitleDrawingUPP(bounds, depth, colorDevice, userData, userUPP) \
	...
	InvokeThemeIteratorUPP(ConstStr255Param inFileName, SInt16 resID, Collection inThemeSettings, void *inUserData,
	...
	inline DEFINE_API_C(Boolean)
		InvokeThemeIteratorUPP(ConstStr255Param inFileName, SInt16 resID, Collection inThemeSettings, void *inUserData,
							   ThemeIteratorUPP userUPP)
	{
		return (Boolean)CALL_FOUR_PARAMETER_UPP(userUPP, uppThemeIteratorProcInfo, inFileName, resID, inThemeSettings,
												inUserData);
	}
#else
#define InvokeThemeIteratorUPP(inFileName, resID, inThemeSettings, inUserData, userUPP)                              \
	(Boolean) CALL_FOUR_PARAMETER_UPP((userUPP), uppThemeIteratorProcInfo, (inFileName), (resID), (inThemeSettings), \
									  (inUserData))
#endif
#endif
...
#define CallThemeTabTitleDrawProc(userRoutine, bounds, style, direction, depth, isColorDev, userData) \
	InvokeThemeTabTitleDrawUPP(bounds, style, direction, depth, isColorDev, userData, userRoutine)
...
#define CallThemeButtonDrawProc(userRoutine, bounds, kind, info, userData, depth, isColorDev) \
	InvokeThemeButtonDrawUPP(bounds, kind, info, userData, depth, isColorDev, userRoutine)
#define CallWindowTitleDrawingProc(userRoutine, bounds, depth, colorDevice, userData) \
...
#define CallThemeIteratorProc(userRoutine, inFileName, resID, inThemeSettings, inUserData) \
	InvokeThemeIteratorUPP(inFileName, resID, inThemeSettings, inUserData, userRoutine)
#endif /* CALL_NOT_IN_CARBON */

	/*----------------------------------------------------------------------------------*/
	/* Menu Drawing callbacks                                                           */
	/*----------------------------------------------------------------------------------*/
	typedef CALLBACK_API(void, MenuTitleDrawingProcPtr)(const Rect *inBounds, SInt16 inDepth, Boolean inIsColorDevice,
														SInt32 inUserData);
	typedef CALLBACK_API(void, MenuItemDrawingProcPtr)(const Rect *inBounds, SInt16 inDepth, Boolean inIsColorDevice,
													   SInt32 inUserData);
	...
	{
		return (MenuTitleDrawingUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppMenuTitleDrawingProcInfo,
														 GetCurrentArchitecture());
	}
#else
#define NewMenuTitleDrawingUPP(userRoutine) \
	(MenuTitleDrawingUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppMenuTitleDrawingProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (MenuItemDrawingUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppMenuItemDrawingProcInfo,
														GetCurrentArchitecture());
	}
#else
#define NewMenuItemDrawingUPP(userRoutine) \
	(MenuItemDrawingUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppMenuItemDrawingProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeMenuItemDrawingUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(void)
	InvokeMenuTitleDrawingUPP(const Rect *inBounds, SInt16 inDepth, Boolean inIsColorDevice, SInt32 inUserData,
							  MenuTitleDrawingUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void) InvokeMenuTitleDrawingUPP(const Rect *inBounds, SInt16 inDepth, Boolean inIsColorDevice,
														SInt32 inUserData, MenuTitleDrawingUPP userUPP)
	{
...
#define InvokeMenuTitleDrawingUPP(inBounds, inDepth, inIsColorDevice, inUserData, userUPP)                    \
	CALL_FOUR_PARAMETER_UPP((userUPP), uppMenuTitleDrawingProcInfo, (inBounds), (inDepth), (inIsColorDevice), \
							(inUserData))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(void)
	InvokeMenuItemDrawingUPP(const Rect *inBounds, SInt16 inDepth, Boolean inIsColorDevice, SInt32 inUserData,
							 MenuItemDrawingUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void) InvokeMenuItemDrawingUPP(const Rect *inBounds, SInt16 inDepth, Boolean inIsColorDevice,
													   SInt32 inUserData, MenuItemDrawingUPP userUPP)
	{
...
#define InvokeMenuItemDrawingUPP(inBounds, inDepth, inIsColorDevice, inUserData, userUPP)                    \
	CALL_FOUR_PARAMETER_UPP((userUPP), uppMenuItemDrawingProcInfo, (inBounds), (inDepth), (inIsColorDevice), \
							(inUserData))
#endif
#endif
...
#define CallMenuTitleDrawingProc(userRoutine, inBounds, inDepth, inIsColorDevice, inUserData) \
	InvokeMenuTitleDrawingUPP(inBounds, inDepth, inIsColorDevice, inUserData, userRoutine)
#define CallMenuItemDrawingProc(userRoutine, inBounds, inDepth, inIsColorDevice, inUserData) \
	InvokeMenuItemDrawingUPP(inBounds, inDepth, inIsColorDevice, inUserData, userRoutine)
#endif /* CALL_NOT_IN_CARBON */
	...
	*****************************************************************************/
	 ...
	 */
	EXTERN_API(OSStatus)
	SetThemePen(ThemeBrush inBrush, SInt16 inDepth, Boolean inIsColorDevice) THREEWORDINLINE(0x303C, 0x0001, 0xAA74);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetThemeTextColor(ThemeTextColor inColor, SInt16 inDepth, Boolean inIsColorDevice)
	 ...
	 */
	EXTERN_API(OSStatus)
	SetThemeWindowBackground(WindowRef inWindow, ThemeBrush inBrush, Boolean inUpdate)
	 ...
	 */
	EXTERN_API(OSStatus)
	DrawThemeWindowHeader(const Rect *inRect, ThemeDrawState inState) THREEWORDINLINE(0x303C, 0x0005, 0xAA74);
	 ...
	 */
	EXTERN_API(OSStatus)
	DrawThemeWindowListViewHeader(const Rect *inRect, ThemeDrawState inState) THREEWORDINLINE(0x303C, 0x0006, 0xAA74);
	 ...
	 */
	EXTERN_API(OSStatus)
	DrawThemePlacard(const Rect *inRect, ThemeDrawState inState) THREEWORDINLINE(0x303C, 0x0007, 0xAA74);
	 ...
	 */
	EXTERN_API(OSStatus)
	DrawThemeEditTextFrame(const Rect *inRect, ThemeDrawState inState) THREEWORDINLINE(0x303C, 0x0009, 0xAA74);
	 ...
	 */
	EXTERN_API(OSStatus)
	DrawThemeListBoxFrame(const Rect *inRect, ThemeDrawState inState) THREEWORDINLINE(0x303C, 0x000A, 0xAA74);
	 ...
	 */
	EXTERN_API(OSStatus)
	DrawThemeFocusRect(const Rect *inRect, Boolean inHasFocus) THREEWORDINLINE(0x303C, 0x000B, 0xAA74);
	 ...
	 */
	EXTERN_API(OSStatus)
	DrawThemePrimaryGroup(const Rect *inRect, ThemeDrawState inState) THREEWORDINLINE(0x303C, 0x000C, 0xAA74);
	 ...
	 */
	EXTERN_API(OSStatus)
	DrawThemeSecondaryGroup(const Rect *inRect, ThemeDrawState inState) THREEWORDINLINE(0x303C, 0x000D, 0xAA74);
	 ...
	 */
	EXTERN_API(OSStatus)
	DrawThemeSeparator(const Rect *inRect, ThemeDrawState inState) THREEWORDINLINE(0x303C, 0x000E, 0xAA74);
	 ...
	 */
	EXTERN_API(OSStatus)
	DrawThemeModelessDialogFrame(const Rect *inRect, ThemeDrawState inState) THREEWORDINLINE(0x303C, 0x0008, 0xAA74);
	 ...
	 */
	EXTERN_API(OSStatus)
	DrawThemeGenericWell(const Rect *inRect, ThemeDrawState inState, Boolean inFillCenter)
	 ...
	 */
	EXTERN_API(OSStatus)
	DrawThemeFocusRegion(RgnHandle inRegion, Boolean inHasFocus) THREEWORDINLINE(0x303C, 0x0023, 0xAA74);
	 ...
	 */
	EXTERN_API(Boolean)
	IsThemeInColor(SInt16 inDepth, Boolean inIsColorDevice) THREEWORDINLINE(0x303C, 0x0024, 0xAA74);
	 ...
	 */
	EXTERN_API(OSStatus)
	DrawThemeMenuBarBackground(const Rect *inBounds, ThemeMenuBarState inState, UInt32 inAttributes)
	 ...
	 */
	EXTERN_API(OSStatus)
	DrawThemeMenuTitle(const Rect *inMenuBarRect, const Rect *inTitleRect, ThemeMenuState inState, UInt32 inAttributes,
	 ...
	 */
	EXTERN_API(OSStatus)
	DrawThemeMenuBackground(const Rect *inMenuRect, ThemeMenuType inMenuType) THREEWORDINLINE(0x303C, 0x001B, 0xAA74);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetThemeMenuBackgroundRegion(const Rect *inMenuRect, ThemeMenuType menuType, RgnHandle region)
	 ...
	 */
	EXTERN_API(OSStatus)
	DrawThemeMenuItem(const Rect *inMenuRect, const Rect *inItemRect, SInt16 inVirtualMenuTop,
					  SInt16 inVirtualMenuBottom, ThemeMenuState inState, ThemeMenuItemType inItemType,
	 ...
	 */
	EXTERN_API(OSStatus)
	GetThemeMenuItemExtra(ThemeMenuItemType inItemType, SInt16 *outHeight, SInt16 *outWidth)
		THREEWORDINLINE(0x303C, 0x0020, 0xAA74);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetThemeMenuTitleExtra(SInt16 *outWidth, Boolean inIsSquished) THREEWORDINLINE(0x303C, 0x0021, 0xAA74);
	 ...
	 */
	EXTERN_API(OSStatus)
	DrawThemeTab(const Rect *inRect, ThemeTabStyle inStyle, ThemeTabDirection inDirection,
	 ...
	 */
	EXTERN_API(OSStatus)
	GetThemeTabRegion(const Rect *inRect, ThemeTabStyle inStyle, ThemeTabDirection inDirection, RgnHandle ioRgn);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetThemeFont(ThemeFontID inFontID, ScriptCode inScript, Str255 outFontName, /* can be NULL */
	 ...
	 */
	EXTERN_API(OSStatus)
	DrawThemeTextBox(CFStringRef inString, ThemeFontID inFontID, ThemeDrawState inState, Boolean inWrapToWidth,
	 ...
	 */
	EXTERN_API(OSStatus)
	TruncateThemeText(CFMutableStringRef inString, ThemeFontID inFontID, ThemeDrawState inState,
					  SInt16 inPixelWidthLimit, TruncCode inTruncWhere, Boolean *outTruncated); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSStatus)
	GetThemeTextDimensions(CFStringRef inString, ThemeFontID inFontID, ThemeDrawState inState, Boolean inWrapToWidth,
	 ...
	 */
	EXTERN_API(OSStatus)
	GetThemeTextShadowOutset(ThemeFontID inFontID, ThemeDrawState inState, Rect *outOutset);
	 ...
	 */
	EXTERN_API(OSStatus)
	DrawThemeTrack(const ThemeTrackDrawInfo *drawInfo, RgnHandle rgnGhost, /* can be NULL */
	 ...
	 */
	EXTERN_API(Boolean)
	HitTestThemeTrack(const ThemeTrackDrawInfo *drawInfo, Point mousePoint, ControlPartCode *partHit);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetThemeTrackThumbPositionFromOffset(const ThemeTrackDrawInfo *drawInfo, Point thumbOffset,
	 ...
	 */
	EXTERN_API(OSStatus)
	GetThemeTrackThumbPositionFromRegion(const ThemeTrackDrawInfo *drawInfo, RgnHandle thumbRgn,
										 SInt32 *relativePosition);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetThemeTrackLiveValue(const ThemeTrackDrawInfo *drawInfo, SInt32 relativePosition, SInt32 *value);
	 ...
	 */
	EXTERN_API(OSStatus)
	DrawThemeScrollBarArrows(const Rect *bounds, ThemeTrackEnableState enableState, ThemeTrackPressState pressState,
							 Boolean isHoriz, Rect *trackBounds);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetThemeScrollBarTrackRect(const Rect *bounds, ThemeTrackEnableState enableState, ThemeTrackPressState pressState,
							   Boolean isHoriz, Rect *trackBounds);
	 ...
	 */
	EXTERN_API(Boolean)
	HitTestThemeScrollBarArrows(const Rect *scrollBarBounds, ThemeTrackEnableState enableState,
								ThemeTrackPressState pressState, Boolean isHoriz, Point ptHit, Rect *trackBounds,
	 ...
	 */
	EXTERN_API(OSStatus)
	GetThemeWindowRegion(ThemeWindowType flavor, const Rect *contRect, ThemeDrawState state,
						 const ThemeWindowMetrics *metrics, ThemeWindowAttributes attributes,
	 ...
	 */
	EXTERN_API(OSStatus)
	DrawThemeWindowFrame(ThemeWindowType flavor, const Rect *contRect, ThemeDrawState state,
						 const ThemeWindowMetrics *metrics, ThemeWindowAttributes attributes,
	 ...
	 */
	EXTERN_API(OSStatus)
	DrawThemeTitleBarWidget(ThemeWindowType flavor, const Rect *contRect, ThemeDrawState state,
							const ThemeWindowMetrics *metrics, ThemeWindowAttributes attributes,
	 ...
	 */
	EXTERN_API(Boolean)
	GetThemeWindowRegionHit(ThemeWindowType flavor, const Rect *inContRect, ThemeDrawState state,
							const ThemeWindowMetrics *metrics, ThemeWindowAttributes inAttributes, Point inPoint,
	 ...
	 */
	EXTERN_API(OSStatus)
	DrawThemeScrollBarDelimiters(ThemeWindowType flavor, const Rect *inContRect, ThemeDrawState state,
	 ...
	 */
	EXTERN_API(OSStatus)
	DrawThemeButton(const Rect *inBounds, ThemeButtonKind inKind, const ThemeButtonDrawInfo *inNewInfo,
	 ...
	 */
	EXTERN_API(OSStatus)
	GetThemeButtonRegion(const Rect *inBounds, ThemeButtonKind inKind, const ThemeButtonDrawInfo *inNewInfo,
						 RgnHandle outRegion);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetThemeButtonContentBounds(const Rect *inBounds, ThemeButtonKind inKind, const ThemeButtonDrawInfo *inDrawInfo,
								Rect *outBounds);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetThemeButtonBackgroundBounds(const Rect *inBounds, ThemeButtonKind inKind, const ThemeButtonDrawInfo *inDrawInfo,
								   Rect *outBounds);
	 ...
	 */
	EXTERN_API(OSStatus)
	DrawThemePopupArrow(const Rect *bounds, ThemeArrowOrientation orientation, ThemePopupArrowSize size,
						ThemeDrawState state, ThemeEraseUPP eraseProc, /* can be NULL */
						UInt32 eraseData);
	 ...
	 */
	EXTERN_API(OSStatus)
	DrawThemeStandaloneGrowBox(Point origin, ThemeGrowDirection growDirection, Boolean isSmall, ThemeDrawState state);
	 ...
	 */
	EXTERN_API(OSStatus)
	DrawThemeStandaloneNoGrowBox(Point origin, ThemeGrowDirection growDirection, Boolean isSmall, ThemeDrawState state);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetThemeStandaloneGrowBoxBounds(Point origin, ThemeGrowDirection growDirection, Boolean isSmall, Rect *bounds);
	 ...
	 */
	EXTERN_API(OSStatus)
	ApplyThemeBackground(ThemeBackgroundKind inKind, const Rect *bounds, ThemeDrawState inState, SInt16 inDepth,
						 Boolean inColorDev);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetThemeTextColorForWindow(WindowRef inWindow, Boolean inActive, SInt16 inDepth, Boolean inColorDev);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetThemeBrushAsColor(ThemeBrush inBrush, SInt16 inDepth, Boolean inColorDev, RGBColor *outColor);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetThemeTextColor(ThemeTextColor inColor, SInt16 inDepth, Boolean inColorDev, RGBColor *outColor);
