...
#pragma import on
	...
	*/
	 ...
	 */
	EXTERN_API(OSAError)
	OSAGetScriptingComponent(ComponentInstance genericScriptingComponent, ScriptingComponentSelector scriptingSubType,
	 ...
	 */
	EXTERN_API(OSAError)
	OSAGetScriptingComponentFromStored(ComponentInstance genericScriptingComponent, const AEDesc *scriptData,
									   ScriptingComponentSelector *scriptingSubType)
	 ...
	 */
	EXTERN_API(OSAError)
	OSAGenericToRealID(ComponentInstance genericScriptingComponent, OSAID *theScriptID,
	 ...
	 */
	EXTERN_API(OSAError)
	OSARealToGenericID(ComponentInstance genericScriptingComponent, OSAID *theScriptID,
