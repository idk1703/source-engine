...
#pragma pack(2)
	...
	typedef CALLBACK_API(OSErr, RecordColorsProcPtr)(UInt32 dataRef, RGBColor *colorsArray, SInt32 colorCount,
													 SInt32 *uniqueColors);
	typedef CALLBACK_API(OSErr, CalcColorTableProcPtr)(UInt32 dataRef, SInt16 colorsRequested, void *colorBankPtr,
	...
	{
		return (InitPickMethodUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppInitPickMethodProcInfo,
													   GetCurrentArchitecture());
	}
#else
#define NewInitPickMethodUPP(userRoutine) \
	(InitPickMethodUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppInitPickMethodProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (RecordColorsUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppRecordColorsProcInfo,
													 GetCurrentArchitecture());
	}
#else
#define NewRecordColorsUPP(userRoutine) \
	(RecordColorsUPP) NewRoutineDescriptor((ProcPtr)(userRoutine), uppRecordColorsProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (CalcColorTableUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppCalcColorTableProcInfo,
													   GetCurrentArchitecture());
	}
#else
#define NewCalcColorTableUPP(userRoutine) \
	(CalcColorTableUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppCalcColorTableProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#ifdef __cplusplus
	inline DEFINE_API_C(DisposeColorPickMethodUPP)
		NewDisposeColorPickMethodUPP(DisposeColorPickMethodProcPtr userRoutine)
	{
		return (DisposeColorPickMethodUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppDisposeColorPickMethodProcInfo, GetCurrentArchitecture());
	}
#else
#define NewDisposeColorPickMethodUPP(userRoutine) \
	(DisposeColorPickMethodUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppDisposeColorPickMethodProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeDisposeColorPickMethodUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeInitPickMethodUPP(SInt16 colorsRequested, UInt32 *dataRef, SInt16 *colorBankType, InitPickMethodUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSErr) InvokeInitPickMethodUPP(SInt16 colorsRequested, UInt32 *dataRef, SInt16 *colorBankType,
													   InitPickMethodUPP userUPP)
	{
		return (OSErr)CALL_THREE_PARAMETER_UPP(userUPP, uppInitPickMethodProcInfo, colorsRequested, dataRef,
											   colorBankType);
	}
#else
#define InvokeInitPickMethodUPP(colorsRequested, dataRef, colorBankType, userUPP) \
	(OSErr)                                                                       \
		CALL_THREE_PARAMETER_UPP((userUPP), uppInitPickMethodProcInfo, (colorsRequested), (dataRef), (colorBankType))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeRecordColorsUPP(UInt32 dataRef, RGBColor *colorsArray, SInt32 colorCount, SInt32 *uniqueColors,
						  RecordColorsUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSErr) InvokeRecordColorsUPP(UInt32 dataRef, RGBColor *colorsArray, SInt32 colorCount,
													 SInt32 *uniqueColors, RecordColorsUPP userUPP)
	{
		return (OSErr)CALL_FOUR_PARAMETER_UPP(userUPP, uppRecordColorsProcInfo, dataRef, colorsArray, colorCount,
											  uniqueColors);
	}
#else
#define InvokeRecordColorsUPP(dataRef, colorsArray, colorCount, uniqueColors, userUPP)                          \
	(OSErr) CALL_FOUR_PARAMETER_UPP((userUPP), uppRecordColorsProcInfo, (dataRef), (colorsArray), (colorCount), \
									(uniqueColors))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeCalcColorTableUPP(UInt32 dataRef, SInt16 colorsRequested, void *colorBankPtr, CSpecArray resultPtr,
							CalcColorTableUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSErr) InvokeCalcColorTableUPP(UInt32 dataRef, SInt16 colorsRequested, void *colorBankPtr,
													   CSpecArray resultPtr, CalcColorTableUPP userUPP)
	{
		return (OSErr)CALL_FOUR_PARAMETER_UPP(userUPP, uppCalcColorTableProcInfo, dataRef, colorsRequested,
											  colorBankPtr, resultPtr);
	}
#else
#define InvokeCalcColorTableUPP(dataRef, colorsRequested, colorBankPtr, resultPtr, userUPP)             \
	(OSErr) CALL_FOUR_PARAMETER_UPP((userUPP), uppCalcColorTableProcInfo, (dataRef), (colorsRequested), \
									(colorBankPtr), (resultPtr))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeDisposeColorPickMethodUPP(UInt32 dataRef, DisposeColorPickMethodUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeDisposeColorPickMethodUPP(dataRef, userUPP) \
	(OSErr) CALL_ONE_PARAMETER_UPP((userUPP), uppDisposeColorPickMethodProcInfo, (dataRef))
#endif
#endif
...
#define CallInitPickMethodProc(userRoutine, colorsRequested, dataRef, colorBankType) \
...
#define CallRecordColorsProc(userRoutine, dataRef, colorsArray, colorCount, uniqueColors) \
	InvokeRecordColorsUPP(dataRef, colorsArray, colorCount, uniqueColors, userRoutine)
#define CallCalcColorTableProc(userRoutine, dataRef, colorsRequested, colorBankPtr, resultPtr) \
	InvokeCalcColorTableUPP(dataRef, colorsRequested, colorBankPtr, resultPtr, userRoutine)
#define CallDisposeColorPickMethodProc(userRoutine, dataRef) InvokeDisposeColorPickMethodUPP(dataRef, userRoutine)
	 ...
	 */
	EXTERN_API(OSErr)
	GetPictInfo(PicHandle thePictHandle, PictInfo *thePictInfo, short verb, short colorsRequested,
				short colorPickMethod, short version) THREEWORDINLINE(0x303C, 0x0800, 0xA831);
	 ...
	 */
	EXTERN_API(OSErr)
	GetPixMapInfo(PixMapHandle thePixMapHandle, PictInfo *thePictInfo, short verb, short colorsRequested,
				  short colorPickMethod, short version) THREEWORDINLINE(0x303C, 0x0801, 0xA831);
	 ...
	 */
	EXTERN_API(OSErr)
	NewPictInfo(PictInfoID *thePictInfoID, short verb, short colorsRequested, short colorPickMethod, short version)
	 ...
	 */
	EXTERN_API(OSErr)
	RecordPictInfo(PictInfoID thePictInfoID, PicHandle thePictHandle) THREEWORDINLINE(0x303C, 0x0403, 0xA831);
	 ...
	 */
	EXTERN_API(OSErr)
	RecordPixMapInfo(PictInfoID thePictInfoID, PixMapHandle thePixMapHandle) THREEWORDINLINE(0x303C, 0x0404, 0xA831);
	 ...
	 */
	EXTERN_API(OSErr)
	RetrievePictInfo(PictInfoID thePictInfoID, PictInfo *thePictInfo, short colorsRequested)
