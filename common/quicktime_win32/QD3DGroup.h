 ...
 */
	...
	typedef CALLBACK_API_C(TQ3GroupPosition, TQ3XGroupAddObjectBeforeMethod)(TQ3GroupObject group,
	...
	typedef CALLBACK_API_C(TQ3GroupPosition, TQ3XGroupAddObjectAfterMethod)(TQ3GroupObject group,
																			TQ3GroupPosition position,
																			TQ3Object object);
	enum
	{
	...
	typedef CALLBACK_API_C(TQ3Status, TQ3XGroupSetPositionObjectMethod)(TQ3GroupObject group, TQ3GroupPosition gPos,
																		TQ3Object obj);
	enum
	{
	...
	typedef CALLBACK_API_C(TQ3Status, TQ3XGroupGetFirstPositionOfTypeMethod)(TQ3GroupObject group, TQ3ObjectType isType,
	...
	typedef CALLBACK_API_C(TQ3Status, TQ3XGroupGetLastPositionOfTypeMethod)(TQ3GroupObject group, TQ3ObjectType isType,
																			TQ3GroupPosition *gPos);
	enum
	{
	...
	typedef CALLBACK_API_C(TQ3Status, TQ3XGroupGetNextPositionOfTypeMethod)(TQ3GroupObject group, TQ3ObjectType isType,
																			TQ3GroupPosition *gPos);
	enum
	{
	...
	typedef CALLBACK_API_C(TQ3Status, TQ3XGroupGetPrevPositionOfTypeMethod)(TQ3GroupObject group, TQ3ObjectType isType,
																			TQ3GroupPosition *gPos);
	enum
	{
	...
	typedef CALLBACK_API_C(TQ3Status, TQ3XGroupCountObjectsOfTypeMethod)(TQ3GroupObject group, TQ3ObjectType isType,
	...
	typedef CALLBACK_API_C(TQ3Status, TQ3XGroupGetFirstObjectPositionMethod)(TQ3GroupObject group, TQ3Object object,
																			 TQ3GroupPosition *gPos);
	enum
	{
	...
	typedef CALLBACK_API_C(TQ3Status, TQ3XGroupGetLastObjectPositionMethod)(TQ3GroupObject group, TQ3Object object,
																			TQ3GroupPosition *gPos);
	enum
	{
	...
	typedef CALLBACK_API_C(TQ3Status, TQ3XGroupGetNextObjectPositionMethod)(TQ3GroupObject group, TQ3Object object,
																			TQ3GroupPosition *gPos);
	enum
	{
	...
	typedef CALLBACK_API_C(TQ3Status, TQ3XGroupGetPrevObjectPositionMethod)(TQ3GroupObject group, TQ3Object object,
																			TQ3GroupPosition *gPos);
	...
	typedef CALLBACK_API_C(TQ3Status, TQ3XGroupStartIterateMethod)(TQ3GroupObject group, TQ3GroupPosition *iterator,
																   TQ3Object *object, TQ3ViewObject view);
	enum
	{
		kQ3XMethodType_GroupEndIterate = FOUR_CHAR_CODE('gitd')
	};

	typedef CALLBACK_API_C(TQ3Status, TQ3XGroupEndIterateMethod)(TQ3GroupObject group, TQ3GroupPosition *iterator,
																 TQ3Object *object, TQ3ViewObject view);
