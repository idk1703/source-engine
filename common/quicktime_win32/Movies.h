...
#include <CoreAudioTypes.h>
	...
	/* This sets the user defined exportset name i.e. fw_QuickTime_XManchego, available on 10.5 or later, and comment
	 * [4486184] */
	...
	*/
	 ...
	 */
	EXTERN_API(OSStatus)
	QTSoundDescriptionCreate(AudioStreamBasicDescription *inASBD, AudioChannelLayout *inLayout, ByteCount inLayoutSize,
							 void *inMagicCookie, ByteCount inMagicCookieSize, QTSoundDescriptionKind inRequestedKind,
	 ...
	 */
	EXTERN_API(OSStatus)
	QTSoundDescriptionConvert(QTSoundDescriptionKind fromKind, SoundDescriptionHandle fromDescription,
							  QTSoundDescriptionKind toKind, SoundDescriptionHandle *toDescription);
	 ...
	 */
	EXTERN_API(OSStatus)
	QTSoundDescriptionGetPropertyInfo(SoundDescriptionHandle inDesc, QTPropertyClass inPropClass, QTPropertyID inPropID,
									  QTPropertyValueType *outPropType, ByteCount *outPropValueSize,
	 ...
	 */
	EXTERN_API(OSStatus)
	QTSoundDescriptionGetProperty(SoundDescriptionHandle inDesc, QTPropertyClass inPropClass, QTPropertyID inPropID,
								  ByteCount inPropValueSize, QTPropertyValuePtr outPropValueAddress,
	 ...
	 */
	EXTERN_API(OSStatus)
	QTSoundDescriptionSetProperty(SoundDescriptionHandle inDesc, QTPropertyClass inPropClass, QTPropertyID inPropID,
								  ByteCount inPropValueSize, ConstQTPropertyValuePtr inPropValueAddress);
	 ...
	 */
	EXTERN_API(OSErr)
	AddSoundDescriptionExtension(SoundDescriptionHandle desc, Handle extension, OSType idType);
	 ...
	 */
	EXTERN_API(OSErr)
	GetSoundDescriptionExtension(SoundDescriptionHandle desc, Handle *extension, OSType idType);
	...
	enum
	{
		...
		dfReverseScroll =
			1 << 8, /* vert: scroll down rather than up; horiz: scroll backwards (justfication dependent)*/
	...
	*****/
	...
	enum
	{
		...
		kActionSpriteStretch =
			3083, /* (Fixed p1x, Fixed p1y, Fixed p2x, Fixed p2y, Fixed p3x, Fixed p3y, Fixed p4x, Fixed p4y) */
		...
		kActionMusicPlayNote =
			5120, /* (long sampleDescIndex, long partNumber, long delay, long pitch, long velocity, long duration) */
		kActionMusicSetController =
			5121,			   /* (long sampleDescIndex, long partNumber, long delay, long controller, long value) */
		...
		kActionAddChannelSubscription =
			6155, /* (Str255 channelName, C string channelsURL, C string channelsPictureURL) */
		...
		kActionDoCompressedActions = 6159,		 /* (compressed QTAtomContainer prefixed with eight bytes: long
		...
		kActionSpriteTrackNewSprite =
			7169, /* (QTAtomID spriteID, short imageIndex, MatrixRecord *matrix, short visible, short layer,
					 ModifierTrackGraphicsModeRecord *graphicsMode, QTAtomID actionHandlingSpriteID) */
		...
		kActionSpriteTrackConcatVariables =
			7172, /* (QTAtomID firstVariableID, QTAtomID secondVariableID, QTAtomID resultVariableID ) */
		...
		kActionFlashTrackSetFlashVariable =
			10245, /* (C string path, C string name, C string value, Boolean updateFocus) */
		...
		kActionTextTrackSetHilite =
			12300, /* (long startHighlight, long endHighlight, ModifierTrackGraphicsModeRecord highlightColor ) */
		...
		kActionTextTrackFindText =
			12305, /* (long flags, Str255 theText, ModifierTrackGraphicsModeRecord highlightColor ) */
	...
	enum
	{
		...
		kOperandStringCompare =
			10241, /* (C string aText, C string bText, Boolean caseSensitive, Boolan diacSensitive) */
	...
	enum
	{
		...
		kQTEventKey =
			FOUR_CHAR_CODE('key '), /* qtevent.param1 = key, qtevent.param2 = modifiers, qtEvent.param3 = scanCode */
		...
		kQTEventKeyUp =
			FOUR_CHAR_CODE('keyU') /* qtevent.param1 = key, qtevent.param2 = modifiers, qtEvent.param3 = scanCode */
	};
	...
	typedef CALLBACK_API(OSErr, MovieProgressProcPtr)(Movie theMovie, short message, short whatOperation,
	...
	typedef CALLBACK_API(OSErr, ActionsProcPtr)(void *refcon, Track targetTrack, long targetRefCon,
	...
	typedef CALLBACK_API(OSErr, MovieExecuteWiredActionsProcPtr)(Movie theMovie, void *refcon, long flags,
	...
	typedef CALLBACK_API(void, QTNextTaskNeededSoonerCallbackProcPtr)(TimeValue duration, unsigned long flags,
																	  void *refcon);
	...
	enum
	{
		...
		mediaSampleDroppable =
			1 << 27, /* sample is not required to be decoded for later samples to be decoded properly */
		...
		mediaSampleEarlierDisplayTimesAllowed = 1
												<< 30 /* samples later in decode order may have earlier display times */
	};
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	PrePrerollMovie(Movie m, TimeValue time, Fixed rate, MoviePrePrerollCompleteUPP proc, void *refcon);
	 ...
	 */
	EXTERN_API(OSErr)
	QTIdleManagerGetNextIdleTime(IdleManager im, TimeRecord *nextIdle);
	 ...
	 */
	EXTERN_API(OSErr)
	QTIdleManagerSetParent(IdleManager im, IdleManager parent);
	 ...
	 */
	EXTERN_API(OSErr)
	QTIdleManagerNeedsAnIdle(IdleManager im, Boolean *needsOne);
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	CreateMovieControl(WindowRef theWindow, Rect *localRect, Movie theMovie, UInt32 options,
	 ...
	 */
	EXTERN_API(void)
	PlayMoviePreview(Movie theMovie, MoviePreviewCallOutUPP callOutProc, long refcon);
	 ...
	 */
	EXTERN_API(void)
	SetMovieMasterClock(Movie theMovie, Component clockMeister, const TimeRecord *slaveZero);
	 ...
	 */
	EXTERN_API(void)
	ChooseMovieClock(Movie m, long flags);
	 ...
	 */
	EXTERN_API(void)
	SetMovieDrawingCompleteProc(Movie theMovie, long flags, MovieDrawingCompleteUPP proc, long refCon);
	 ...
	 */
	EXTERN_API(void)
	SetTrackGWorld(Track theTrack, CGrafPtr port, GDHandle gdh, TrackTransferUPP proc, long refCon);
	...
	*/
	...
	QTAudioContextCreateForAudioDevice(CFAllocatorRef allocator, CFStringRef audioDeviceUID, CFDictionaryRef options,
		...
		Theory of operations:
			...
			To register for a Track Audio Context Insert during playback:
					Set the kQTAudioPropertyID_RegisterAudioContextInsert property on the track,
							providing the same registry info structure that is used for the
	   QTAudioContextRegisterInsert() call. To unregister a Track Audio Context Insert: Set the
	   kQTAudioPropertyID_RegisterAudioContextInsert property on the track, with a NULL processDataCallback
	*/
	 ...
	 */
	typedef CALLBACK_API(OSStatus, AudioContextInsertProcessDataCallback)(
		void *inUserData, AudioUnitRenderActionFlags *ioRenderFlags, const AudioTimeStamp *inTimeStamp,
		UInt32 inNumberFrames, AudioBufferList *inInputData, AudioBufferList *outOutputData);
	 ...
	 *      time, in seconds.
	 */
	typedef CALLBACK_API(OSStatus, AudioContextInsertResetCallback)(void *inUserData, Float64 inSampleRate,
																	UInt32 inMaxFrames, Float64 *outLatency,
																	Float64 *outTailTime);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	QTAudioContextRegisterInsert(QTAudioContextRef inAudioContext, UInt32 inRegistryInfoSize,
	...
	enum
	{
		 ...
		 */
		kQTAudioPropertyID_RegisterAudioContextInsert =
			FOUR_CHAR_CODE('regt') /* value is QTAudioContextInsertRegistryInfoRef. Get/Set.*/
	};
	 ...
	 */
	EXTERN_API(OSStatus)
	SetMovieVisualContext(Movie movie, QTVisualContextRef visualContext);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetMovieVisualContext(Movie movie, QTVisualContextRef *visualContext);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetMovieAudioContext(Movie movie, QTAudioContextRef audioContext);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetMovieAudioContext(Movie movie, QTAudioContextRef *audioContext);
	...
	enum
	{
		...
		kQTDataLocationPropertyID_QTDataHandler =
			FOUR_CHAR_CODE('qtdh'), /* for semantics of NewMovieFromStorageOffset*/
		kQTDataLocationPropertyID_Scrap = FOUR_CHAR_CODE('scrp'),
		kQTDataLocationPropertyID_LegacyMovieResourceHandle =
			FOUR_CHAR_CODE('rezh'), /* QTNewMovieUserProcInfo * (for semantics of NewMovieFromHandle)*/
	 ...
	 */
	EXTERN_API(OSStatus)
	NewMovieFromProperties(ItemCount inputPropertyCount, QTNewMoviePropertyElement *inputProperties,
						   ItemCount outputPropertyCount, QTNewMoviePropertyElement *outputProperties, Movie *theMovie);
	 ...
	 */
	EXTERN_API(OSErr)
	PutMovieIntoDataFork64(Movie theMovie, long fRefNum, const wide *offset, unsigned long maxSize);
	 ...
	 */
	EXTERN_API(OSErr)
	PutMovieIntoStorage(Movie theMovie, DataHandler dh, const wide *offset, unsigned long maxSize);
	 ...
	 */
	EXTERN_API(OSErr)
	PutMovieForDataRefIntoHandle(Movie theMovie, Handle dataRef, OSType dataRefType, Handle publicMovie);
	 ...
	 */
	EXTERN_API(void)
	GetMoviePreviewTime(Movie theMovie, TimeValue *previewTime, TimeValue *previewDuration);
	 ...
	 */
	EXTERN_API(void)
	SetMoviePreviewTime(Movie theMovie, TimeValue previewTime, TimeValue previewDuration);
	 ...
	 */
	EXTERN_API(void)
	GetMovieSelection(Movie theMovie, TimeValue *selectionTime, TimeValue *selectionDuration);
	 ...
	 */
	EXTERN_API(void)
	SetMovieSelection(Movie theMovie, TimeValue selectionTime, TimeValue selectionDuration);
	 ...
	 */
	EXTERN_API(OSErr)
	QTGetTimeUntilNextTask(long *duration, long scale);
	 ...
	 */
	EXTERN_API(OSErr)
	QTInstallNextTaskNeededSoonerCallback(QTNextTaskNeededSoonerCallbackUPP callbackProc, TimeScale scale,
	 ...
	 */
	EXTERN_API(OSErr)
	QTUninstallNextTaskNeededSoonerCallback(QTNextTaskNeededSoonerCallbackUPP callbackProc, void *refcon);
	 ...
	 */
	EXTERN_API(OSErr)
	GetMovieRateChangeConstraints(Movie theMovie, TimeRecord *minimumDelay, TimeRecord *maximumDelay);
	 ...
	 */
	EXTERN_API(Media)
	NewTrackMedia(Track theTrack, OSType mediaType, TimeScale timeScale, Handle dataRef, OSType dataRefType);
	 ...
	 */
	EXTERN_API(void)
	GetMediaHandlerDescription(Media theMedia, OSType *mediaType, Str255 creatorName, OSType *creatorManufacturer);
	 ...
	 */
	EXTERN_API(void)
	GetMediaDataHandlerDescription(Media theMedia, short index, OSType *dhType, Str255 creatorName,
	 ...
	 */
	EXTERN_API(OSErr)
	SetMediaDataHandler(Media theMedia, short index, DataHandlerComponent dataHandler);
	 ...
	 */
	EXTERN_API(OSErr)
	OpenADataHandler(Handle dataRef, OSType dataHandlerSubType, Handle anchorDataRef, OSType anchorDataRefType,
					 TimeBase tb, long flags, ComponentInstance *dh);
	 ...
	 */
	EXTERN_API(void)
	GetMediaSampleDescription(Media theMedia, long index, SampleDescriptionHandle descH);
	 ...
	 */
	EXTERN_API(OSErr)
	SetMediaSampleDescription(Media theMedia, long index, SampleDescriptionHandle descH);
	 ...
	 */
	EXTERN_API(void)
	SampleNumToMediaDecodeTime(Media theMedia, SInt64 logicalSampleNum, TimeValue64 *sampleDecodeTime,
	 ...
	 */
	EXTERN_API(void)
	MediaDecodeTimeToSampleNum(Media theMedia, TimeValue64 decodeTime, SInt64 *sampleNum, TimeValue64 *sampleDecodeTime,
							   TimeValue64 *sampleDecodeDuration);
	 ...
	 */
	EXTERN_API(void)
	SampleNumToMediaDisplayTime(Media theMedia, SInt64 logicalSampleNum, TimeValue64 *sampleDisplayTime,
	 ...
	 */
	EXTERN_API(void)
	MediaDisplayTimeToSampleNum(Media theMedia, TimeValue64 displayTime, SInt64 *sampleNum,
								TimeValue64 *sampleDisplayTime, TimeValue64 *sampleDisplayDuration);
	 ...
	 */
	EXTERN_API(void)
	SampleNumToMediaTime(Media theMedia, long logicalSampleNum, TimeValue *sampleTime, TimeValue *sampleDuration);
	 ...
	 */
	EXTERN_API(void)
	MediaTimeToSampleNum(Media theMedia, TimeValue time, long *sampleNum, TimeValue *sampleTime,
	 ...
	 */
	EXTERN_API(OSErr)
	AddMediaSample2(Media theMedia, const UInt8 *dataIn, ByteCount size, TimeValue64 decodeDurationPerSample,
					TimeValue64 displayOffset, SampleDescriptionHandle sampleDescriptionH, ItemCount numberOfSamples,
					MediaSampleFlags sampleFlags, TimeValue64 *sampleDecodeTimeOut); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	AddMediaSampleFromEncodedFrame(Media theMedia, ICMEncodedFrameRef encodedFrame,
	 ...
	 */
	EXTERN_API(OSErr)
	AddSampleTableToMedia(Media theMedia, QTSampleTableRef sampleTable, SInt64 startSampleNum, SInt64 numberOfSamples,
						  TimeValue64 *sampleDecodeTimeOut); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	AddMediaSample(Media theMedia, Handle dataIn, long inOffset, unsigned long size, TimeValue durationPerSample,
				   SampleDescriptionHandle sampleDescriptionH, long numberOfSamples, short sampleFlags,
	 ...
	 */
	EXTERN_API(OSErr)
	AddMediaSampleReference(Media theMedia, long dataOffset, unsigned long size, TimeValue durationPerSample,
							SampleDescriptionHandle sampleDescriptionH, long numberOfSamples, short sampleFlags,
							TimeValue *sampleTime);
	 ...
	 */
	EXTERN_API(OSErr)
	AddMediaSampleReferences(Media theMedia, SampleDescriptionHandle sampleDescriptionH, long numberOfSamples,
							 SampleReferencePtr sampleRefs, TimeValue *sampleTime);
	 ...
	 */
	EXTERN_API(OSErr)
	AddMediaSampleReferences64(Media theMedia, SampleDescriptionHandle sampleDescriptionH, long numberOfSamples,
							   SampleReference64Ptr sampleRefs, TimeValue *sampleTime);
	 ...
	 */
	EXTERN_API(OSErr)
	ExtendMediaDecodeDurationToDisplayEndTime(Media theMedia, Boolean *mediaChanged);
	 ...
	 */
	EXTERN_API(OSErr)
	GetMediaSample2(Media theMedia, UInt8 *dataOut, ByteCount maxDataSize, ByteCount *size, TimeValue64 decodeTime,
					TimeValue64 *sampleDecodeTime, TimeValue64 *decodeDurationPerSample, TimeValue64 *displayOffset,
					SampleDescriptionHandle sampleDescriptionH, ItemCount *sampleDescriptionIndex,
	 ...
	 */
	EXTERN_API(OSErr)
	GetMediaSample(Media theMedia, Handle dataOut, long maxSizeToGrow, long *size, TimeValue time,
				   TimeValue *sampleTime, TimeValue *durationPerSample, SampleDescriptionHandle sampleDescriptionH,
				   long *sampleDescriptionIndex, long maxNumberOfSample, long *numberOfSamples, short *sampleFlags);
	 ...
	 */
	EXTERN_API(OSErr)
	CopyMediaMutableSampleTable(Media theMedia, TimeValue64 startDecodeTime, TimeValue64 *sampleStartDecodeTime,
								SInt64 maxNumberOfSamples, TimeValue64 maxDecodeDuration,
	 ...
	 */
	EXTERN_API(OSErr)
	GetMediaSampleReference(Media theMedia, long *dataOffset, long *size, TimeValue time, TimeValue *sampleTime,
	...
	GetMediaSampleReferences(Media theMedia, TimeValue time, TimeValue *sampleTime,
							 ...
							 long maxNumberOfEntries, long *actualNumberofEntries, SampleReferencePtr sampleRefs);
	 ...
	 */
	EXTERN_API(OSErr)
	GetMediaSampleReferences64(Media theMedia, TimeValue time, TimeValue *sampleTime,
							   SampleDescriptionHandle sampleDescriptionH, long *sampleDescriptionIndex,
							   long maxNumberOfEntries, long *actualNumberofEntries, SampleReference64Ptr sampleRefs);
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	InsertMediaIntoTrack(Track theTrack, TimeValue trackStart, TimeValue mediaTime, TimeValue mediaDuration,
						 Fixed mediaRate);
	 ...
	 */
	EXTERN_API(OSErr)
	InsertTrackSegment(Track srcTrack, Track dstTrack, TimeValue srcIn, TimeValue srcDuration, TimeValue dstIn);
	 ...
	 */
	EXTERN_API(OSErr)
	InsertMovieSegment(Movie srcMovie, Movie dstMovie, TimeValue srcIn, TimeValue srcDuration, TimeValue dstIn);
	 ...
	 */
	EXTERN_API(OSErr)
	ScaleTrackSegment(Track theTrack, TimeValue startTime, TimeValue oldDuration, TimeValue newDuration);
	 ...
	 */
	EXTERN_API(OSErr)
	ScaleMovieSegment(Movie theMovie, TimeValue startTime, TimeValue oldDuration, TimeValue newDuration);
	 ...
	 */
	EXTERN_API(OSErr)
	PasteHandleIntoMovie(Handle h, OSType handleType, Movie theMovie, long flags, ComponentInstance userComp);
	 ...
	 */
	EXTERN_API(OSErr)
	PutMovieIntoTypedHandle(Movie theMovie, Track targetTrack, OSType handleType, Handle publicMovie, TimeValue start,
							TimeValue dur, long flags, ComponentInstance userComp);
	 ...
	 */
	EXTERN_API(OSErr)
	AddEmptyTrackToMovie(Track srcTrack, Movie dstMovie, Handle dataRef, OSType dataRefType, Track *dstTrack);
	 ...
	 */
	EXTERN_API(OSErr)
	AddClonedTrackToMovie(Track srcTrack, Movie dstMovie, long flags, Track *dstTrack);
	 ...
	 */
	EXTERN_API(OSErr)
	AddTrackReference(Track theTrack, Track refTrack, OSType refType, long *addedIndex);
	 ...
	 */
	EXTERN_API(OSErr)
	ConvertFileToMovieFile(const FSSpec *inputFile, const FSSpec *outputFile, OSType creator, ScriptCode scriptTag,
						   short *resID, long flags, ComponentInstance userComp, MovieProgressUPP proc, long refCon);
	 ...
	 */
	EXTERN_API(OSErr)
	ConvertMovieToFile(Movie theMovie, Track onlyTrack, FSSpec *outputFile, OSType fileType, OSType creator,
					   ScriptCode scriptTag, short *resID, long flags, ComponentInstance userComp);
	 ...
	 */
	EXTERN_API(OSErr)
	ConvertMovieToDataRef(Movie m, Track onlyTrack, Handle dataRef, OSType dataRefType, OSType fileType, OSType creator,
	 ...
	 */
	EXTERN_API(OSErr)
	ConvertDataRefToMovieDataRef(Handle inputDataRef, OSType inputDataRefType, Handle outputDataRef,
								 OSType outputDataRefType, OSType creator, long flags, ComponentInstance userComp,
	...
	enum
	{
		...
		kGetMovieImporterAutoImportOnly =
			1L << 10 /* reject aggressive movie importers which have dontAutoFileMovieImport set*/
	};
	 ...
	 */
	EXTERN_API(OSErr)
	GetMovieImporterForDataRef(OSType dataRefType, Handle dataRef, long flags, Component *importer);
	 ...
	 */
	EXTERN_API(OSErr)
	QTGetMIMETypeInfo(const char *mimeStringStart, short mimeStringLength, OSType infoSelector, void *infoDataPtr,
					  long *infoDataSize);
	 ...
	 */
	EXTERN_API(TimeValue64)
	TrackTimeToMediaDisplayTime(TimeValue64 value, Track theTrack);
	 ...
	 */
	EXTERN_API(Fixed)
	GetTrackEditRate64(Track theTrack, TimeValue64 atTime);
	 ...
	 */
	EXTERN_API(OSErr)
	GetMovieDataSize64(Movie theMovie, TimeValue startTime, TimeValue duration, wide *dataSize);
	 ...
	 */
	EXTERN_API(OSErr)
	GetTrackDataSize64(Track theTrack, TimeValue startTime, TimeValue duration, wide *dataSize);
	 ...
	 */
	EXTERN_API(OSErr)
	GetMediaDataSizeTime64(Media theMedia, TimeValue64 startDisplayTime, TimeValue64 displayDuration, SInt64 *dataSize);
	 ...
	 */
	EXTERN_API(OSErr)
	GetMediaDataSize64(Media theMedia, TimeValue startTime, TimeValue duration, wide *dataSize);
	 ...
	 */
	EXTERN_API(OSErr)
	GetUserDataItem(UserData theUserData, void *data, long size, OSType udType, long index);
	 ...
	 */
	EXTERN_API(OSErr)
	SetUserDataItem(UserData theUserData, void *data, long size, OSType udType, long index);
	 ...
	 */
	EXTERN_API(OSErr)
	AddUserDataText(UserData theUserData, Handle data, OSType udType, long index, short itlRegionTag);
	 ...
	 */
	EXTERN_API(OSErr)
	GetUserDataText(UserData theUserData, Handle data, OSType udType, long index, short itlRegionTag);
	 ...
	 */
	EXTERN_API(OSErr)
	RemoveUserDataText(UserData theUserData, OSType udType, long index, short itlRegionTag);
	...
	enum
	{
		kQTCopyUserDataReplace =
			FOUR_CHAR_CODE('rplc'), /* Delete all destination user data items and then add source user data items */
	 ...
	 */
	EXTERN_API(OSErr)
	CopyMovieUserData(Movie srcMovie, Movie dstMovie, OSType copyRule);
	 ...
	 */
	EXTERN_API(OSErr)
	CopyTrackUserData(Track srcTrack, Track dstTrack, OSType copyRule);
	 ...
	 */
	EXTERN_API(OSErr)
	CopyMediaUserData(Media srcMedia, Media dstMedia, OSType copyRule);
	 ...
	 */
	EXTERN_API(OSErr)
	CopyUserData(UserData srcUserData, UserData dstUserData, OSType copyRule);
	 ...
	 */
	EXTERN_API(void)
	GetMediaNextInterestingDecodeTime(Media theMedia, short interestingTimeFlags, TimeValue64 decodeTime, Fixed rate,
									  TimeValue64 *interestingDecodeTime, TimeValue64 *interestingDecodeDuration);
	 ...
	 */
	EXTERN_API(void)
	GetMediaNextInterestingDisplayTime(Media theMedia, short interestingTimeFlags, TimeValue64 displayTime, Fixed rate,
									   TimeValue64 *interestingDisplayTime, TimeValue64 *interestingDisplayDuration);
	 ...
	 */
	EXTERN_API(void)
	GetMediaNextInterestingTime(Media theMedia, short interestingTimeFlags, TimeValue time, Fixed rate,
	 ...
	 */
	EXTERN_API(void)
	GetTrackNextInterestingTime(Track theTrack, short interestingTimeFlags, TimeValue time, Fixed rate,
								TimeValue *interestingTime, TimeValue *interestingDuration);
	 ...
	 */
	EXTERN_API(void)
	GetMovieNextInterestingTime(Movie theMovie, short interestingTimeFlags, short numMediaTypes,
								const OSType *whichMediaTypes, TimeValue time, Fixed rate, TimeValue *interestingTime,
	 ...
	 */
	EXTERN_API(OSErr)
	CreateMovieFile(const FSSpec *fileSpec, OSType creator, ScriptCode scriptTag, long createMovieFileFlags,
	 ...
	 */
	EXTERN_API(OSErr)
	NewMovieFromFile(Movie *theMovie, short resRefNum, short *resId,					  /* can be NULL */
					 StringPtr resName, short newMovieFlags, Boolean *dataRefWasChanged); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	NewMovieFromHandle(Movie *theMovie, Handle h, short newMovieFlags, Boolean *dataRefWasChanged);
	 ...
	 */
	EXTERN_API(OSErr)
	NewMovieFromDataFork(Movie *theMovie, short fRefNum, long fileOffset, short newMovieFlags,
	 ...
	 */
	EXTERN_API(OSErr)
	NewMovieFromDataFork64(Movie *theMovie, long fRefNum, const wide *fileOffset, short newMovieFlags,
						   Boolean *dataRefWasChanged);
	 ...
	 */
	EXTERN_API(OSErr)
	NewMovieFromUserProc(Movie *m, short flags, Boolean *dataRefWasChanged, GetMovieUPP getProc, void *refCon,
						 Handle defaultDataRef, OSType dataRefType);
	 ...
	 */
	EXTERN_API(OSErr)
	NewMovieFromDataRef(Movie *m, short flags, short *id, Handle dataRef, OSType dataRefType);
	 ...
	 */
	EXTERN_API(OSErr)
	NewMovieFromStorageOffset(Movie *theMovie, DataHandler dh, const wide *fileOffset, short newMovieFlags,
							  Boolean *dataRefWasChanged);
	 ...
	 */
	EXTERN_API(OSErr)
	NewMovieForDataRefFromHandle(Movie *theMovie, Handle h, short newMovieFlags, Boolean *dataRefWasChanged,
	 ...
	 */
	EXTERN_API(OSErr)
	AddMovieResource(Movie theMovie, short resRefNum, short *resId, ConstStr255Param resName);
	 ...
	 */
	EXTERN_API(OSErr)
	UpdateMovieResource(Movie theMovie, short resRefNum, short resId, ConstStr255Param resName);
	 ...
	 */
	EXTERN_API(OSErr)
	CreateMovieStorage(Handle dataRef, OSType dataRefType, OSType creator, ScriptCode scriptTag,
					   long createMovieFileFlags, DataHandler *outDataHandler, Movie *newmovie);
	 ...
	 */
	EXTERN_API(OSErr)
	GetMovieAnchorDataRef(Movie theMovie, Handle *dataRef, OSType *dataRefType, long *outFlags);
	 ...
	 */
	EXTERN_API(void)
	FlattenMovie(Movie theMovie, long movieFlattenFlags, const FSSpec *theFile, OSType creator, ScriptCode scriptTag,
				 long createMovieFileFlags, short *resId, ConstStr255Param resName);
	 ...
	 */
	EXTERN_API(Movie)
	FlattenMovieData(Movie theMovie, long movieFlattenFlags, const FSSpec *theFile, OSType creator,
	 ...
	 */
	EXTERN_API(Movie)
	FlattenMovieDataToDataRef(Movie theMovie, long movieFlattenFlags, Handle dataRef, OSType dataRefType,
	 ...
	 */
	EXTERN_API(OSErr)
	CreateShortcutMovieFile(const FSSpec *fileSpec, OSType creator, ScriptCode scriptTag, long createMovieFileFlags,
	 ...
	 */
	EXTERN_API(OSErr)
	MovieSearchText(Movie theMovie, Ptr text, long size, long searchFlags, Track *searchTrack, TimeValue *searchTime,
					long *searchOffset);
	 ...
	 */
	EXTERN_API(RgnHandle)
	GetMovieSegmentDisplayBoundsRgn(Movie theMovie, TimeValue time, TimeValue duration);
	 ...
	 */
	EXTERN_API(RgnHandle)
	GetTrackSegmentDisplayBoundsRgn(Track theTrack, TimeValue time, TimeValue duration);
	 ...
	 */
	EXTERN_API(void)
	SetMovieCoverProcs(Movie theMovie, MovieRgnCoverUPP uncoverProc, MovieRgnCoverUPP coverProc, long refcon);
	 ...
	 */
	EXTERN_API(OSErr)
	GetMovieCoverProcs(Movie theMovie, MovieRgnCoverUPP *uncoverProc, MovieRgnCoverUPP *coverProc, long *refcon);
	...
	****/
	 ...
	 */
	EXTERN_API(OSErr)
	GetMovieThreadAttachState(Movie m, Boolean *outAttachedToCurrentThread, Boolean *outAttachedToAnyThread);
	...
	****/
	 ...
	 */
	EXTERN_API(OSErr)
	CanQuickTimeOpenFile(FSSpecPtr fileSpec, OSType fileType, OSType fileNameExtension,
						 Boolean *outCanOpenWithGraphicsImporter, Boolean *outCanOpenAsMovie,
	 ...
	 */
	EXTERN_API(OSErr)
	CanQuickTimeOpenDataRef(Handle dataRef, OSType dataRefType, Boolean *outCanOpenWithGraphicsImporter,
							Boolean *outCanOpenAsMovie, Boolean *outPreferGraphicsImporter, UInt32 inFlags);
	...
	****/
	 ...
	 */
	EXTERN_API(OSErr)
	QTNewDataReferenceFromFSRef(const FSRef *fileRef, UInt32 flags, Handle *outDataRef, OSType *outDataRefType);
	 ...
	 */
	EXTERN_API(OSErr)
	QTNewDataReferenceFromFSRefCFString(const FSRef *directoryRef, CFStringRef fileName, UInt32 flags,
	 ...
	 */
	EXTERN_API(OSErr)
	QTNewDataReferenceFromFSSpec(const FSSpec *fsspec, UInt32 flags, Handle *outDataRef, OSType *outDataRefType);
	 ...
	 */
	EXTERN_API(OSErr)
	QTNewDataReferenceWithDirectoryCFString(Handle inDataRef, OSType inDataRefType, CFStringRef targetName,
											UInt32 flags, Handle *outDataRef, OSType *outDataRefType);
	 ...
	 */
	EXTERN_API(OSErr)
	QTNewDataReferenceFromFullPathCFString(CFStringRef filePath, QTPathStyle pathStyle, UInt32 flags,
										   Handle *outDataRef, OSType *outDataRefType);
	 ...
	 */
	EXTERN_API(OSErr)
	QTNewDataReferenceFromCFURL(CFURLRef url, UInt32 flags, Handle *outDataRef, OSType *outDataRefType);
	 ...
	 */
	EXTERN_API(OSErr)
	QTNewDataReferenceFromURLCFString(CFStringRef urlString, UInt32 flags, Handle *outDataRef, OSType *outDataRefType);
	 ...
	 */
	EXTERN_API(OSErr)
	QTGetDataReferenceDirectoryDataReference(Handle dataRef, OSType dataRefType, UInt32 flags, Handle *outDataRef,
	 ...
	 */
	EXTERN_API(OSErr)
	QTGetDataReferenceTargetNameCFString(Handle dataRef, OSType dataRefType, CFStringRef *name);
	 ...
	 */
	EXTERN_API(OSErr)
	QTGetDataReferenceFullPathCFString(Handle dataRef, OSType dataRefType, QTPathStyle style, CFStringRef *outPath);
	 ...
	 */
	EXTERN_API(OSErr)
	QTGetDataHandlerDirectoryDataReference(DataHandler dh, UInt32 flags, Handle *outDataRef, OSType *outDataRefType);
	 ...
	 */
	EXTERN_API(OSErr)
	QTGetDataHandlerTargetNameCFString(DataHandler dh, CFStringRef *fileName);
	 ...
	 */
	EXTERN_API(OSErr)
	QTGetDataHandlerFullPathCFString(DataHandler dh, QTPathStyle style, CFStringRef *outPath);
	...
	*****/
	 ...
	 */
	EXTERN_API(OSErr)
	GetMediaDataRef(Media theMedia, short index, Handle *dataRef, OSType *dataRefType, long *dataRefAttributes);
	 ...
	 */
	EXTERN_API(OSErr)
	AddMediaDataRef(Media theMedia, short *index, Handle dataRef, OSType dataRefType);
	...
	*****/
	 ...
	 */
	EXTERN_API(void)
	SetTrackLoadSettings(Track theTrack, TimeValue preloadTime, TimeValue preloadDuration, long preloadFlags,
						 long defaultHints);
	 ...
	 */
	EXTERN_API(void)
	GetTrackLoadSettings(Track theTrack, TimeValue *preloadTime, TimeValue *preloadDuration, long *preloadFlags,
						 long *defaultHints);
	...
	*****/
	 ...
	 */
	EXTERN_API(OSErr)
	BeginFullScreen(Ptr *restoreState, GDHandle whichGD, short *desiredWidth, short *desiredHeight,
					WindowRef *newWindow, RGBColor *eraseColor, long flags);
	...
	*****/
	 ...
	 */
	EXTERN_API(OSErr)
	AddMovieExecuteWiredActionsProc(Movie theMovie, MovieExecuteWiredActionsUPP proc, void *refCon);
	 ...
	 */
	EXTERN_API(OSErr)
	RemoveMovieExecuteWiredActionsProc(Movie theMovie, MovieExecuteWiredActionsUPP proc, void *refCon);
	...
	*****/
	 ...
	 */
	EXTERN_API(OSErr)
	NewSpriteWorld(SpriteWorld *newSpriteWorld, GWorldPtr destination, GWorldPtr spriteLayer, RGBColor *backgroundColor,
	 ...
	 */
	EXTERN_API(OSErr)
	SetSpriteWorldGraphicsMode(SpriteWorld theSpriteWorld, long mode, const RGBColor *opColor);
	 ...
	 */
	EXTERN_API(OSErr)
	SpriteWorldHitTest(SpriteWorld theSpriteWorld, long flags, Point loc, Sprite *spriteHit);
	 ...
	 */
	EXTERN_API(OSErr)
	NewSprite(Sprite *newSprite, SpriteWorld itsSpriteWorld, ImageDescriptionHandle idh, Ptr imageDataPtr,
			  MatrixRecord *matrix, Boolean visible, short layer);
	...
	*****/
	...
	QTGetNextChildType(QTAtomContainer container, QTAtom parentAtom, QTAtomType currentChildType);
	 ...
	 */
	EXTERN_API(short)
	QTCountChildrenOfType(QTAtomContainer container, QTAtom parentAtom, QTAtomType childType);
	 ...
	 */
	EXTERN_API(QTAtom)
	QTFindChildByIndex(QTAtomContainer container, QTAtom parentAtom, QTAtomType atomType, short index, QTAtomID *id);
	 ...
	 */
	EXTERN_API(QTAtom)
	QTFindChildByID(QTAtomContainer container, QTAtom parentAtom, QTAtomType atomType, QTAtomID id, short *index);
	 ...
	 */
	EXTERN_API(OSErr)
	QTNextChildAnyType(QTAtomContainer container, QTAtom parentAtom, QTAtom currentChild, QTAtom *nextChild);
	 ...
	 */
	EXTERN_API(OSErr)
	QTSetAtomData(QTAtomContainer container, QTAtom atom, long dataSize, void *atomData);
	 ...
	 */
	EXTERN_API(OSErr)
	QTCopyAtomDataToHandle(QTAtomContainer container, QTAtom atom, Handle targetHandle);
	 ...
	 */
	EXTERN_API(OSErr)
	QTCopyAtomDataToPtr(QTAtomContainer container, QTAtom atom, Boolean sizeOrLessOK, long size, void *targetPtr,
						long *actualSize);
	 ...
	 */
	EXTERN_API(OSErr)
	QTGetAtomTypeAndID(QTAtomContainer container, QTAtom atom, QTAtomType *atomType, QTAtomID *id);
	 ...
	 */
	EXTERN_API(OSErr)
	QTCopyAtom(QTAtomContainer container, QTAtom atom, QTAtomContainer *targetContainer);
	 ...
	 */
	EXTERN_API(OSErr)
	QTGetAtomDataPtr(QTAtomContainer container, QTAtom atom, long *dataSize, Ptr *atomData);
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	QTInsertChild(QTAtomContainer container, QTAtom parentAtom, QTAtomType atomType, QTAtomID id, short index,
				  long dataSize, void *data, QTAtom *newAtom);
	 ...
	 */
	EXTERN_API(OSErr)
	QTInsertChildren(QTAtomContainer container, QTAtom parentAtom, QTAtomContainer childrenContainer);
	 ...
	 */
	EXTERN_API(OSErr)
	QTReplaceAtom(QTAtomContainer targetContainer, QTAtom targetAtom, QTAtomContainer replacementContainer,
	...
	*****/
	...
	typedef CALLBACK_API(ComponentResult, TweenerDataProcPtr)(TweenRecord *tr, void *tweenData, long tweenDataSize,
	 ...
	 */
	EXTERN_API(OSErr)
	QTNewTween(QTTweener *tween, QTAtomContainer container, QTAtom tweenAtom, TimeValue maxTime);
	 ...
	 */
	EXTERN_API(OSErr)
	QTDoTween(QTTweener tween, TimeValue atTime, Handle result, long *resultSize, TweenerDataUPP tweenDataProc,
			  void *tweenDataRefCon);

	/*
			QTDoTweenPtr is an interrupt-safe version of QTDoTween.  It has the following limitations:
			- not all tween types support this call (those which must allocated memory), in which case they return
	   codecUnimpErr.
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	QTDoTweenPtr(QTTweener tween, TimeValue atTime, Ptr result, long resultSize);
	...
	*****/
	...
	enum
	{
		...
		pdActionGetNextSample =
			16, /* param is QTAtomContainer with effect sample to change - createdDialog may be NIL */
		pdActionGetPreviousSample =
			17, /* param is QTAtomContainer with effect sample to change - createdDialog may be NIL */
		pdActionCompactSample =
			18, /* param is QTAtomContainer with effect sample to compact, - createdDialog may be NIL */
		...
		pdActionGetSubPanelMenuValue =
			22,						   /* param is long and returns current sub-panel value selected by the effect */
		...
		pdActionConvertSettingsToXML =
			37, /* param is QTAtomContainer* inbound, Handle* outbound contains the XML - createdDialog may be NIL */
		pdActionConvertSettingsToXMLWithComments = 38, /* param is QTAtomContainer* inbound, Handle* outbound contains
														  the XML with comments - createdDialog may be NIL */
		pdActionConvertSettingsToText = 39, /* param is QTAtomContainer* inbound, Handle* outbound contains human
											   readable text - createdDialog may be NIL */
		pdActionConvertXMLToSettings =
			40, /* param is Handle* inbound, QTAtomContainer* outbound contains parameters - createdDialog may be NIL */
	...
	{
		MoviePreviewCallOutUPP calloutProc; /* called when user makes editing changes to dialog.  May be NIL.  You
											   should return true from your function. */
	...
	/*
			...
			This is to allow applications that do not wish to use the custom control for the effect to set values
	   themselves.
			...
			for the effect.  Effects may choose to implement multiple custom controls which combine with standard
	   controls to present the total user interface.  For effects which have very complex user interfaces not well
	   suited for inclusion within a single window, it is recommended to use kParameterImageIsPreset -- which allows the
	   effect to have an external editing application for parameters which may then be set within the standard UI via
	   the open file dialog or drag and drop.  The Lens Flare effect's "Flare Type" is an example of such a preset.
	...
	*/
	...
	/*
			...
			When pdActionCustomDisposeControl is called any allocation done by the control should be disposed. In
	   addition, pdActionCustomDisposeControl is the last chance the control has to commit any user changes into the
	   sample. Controls which implement type in fields typically need to commit any final user edits at this time.
	*/
	...
	/*
			pdActionCustomPositionControl is called by the application to position the control within a window or
	   dialog.

			The control should determine if it will fit in the alloted area and position itself there.  It should also
			return the space taken up by the control.   Note you are free to implement controls which are variable in
	   size depending upon which parameter you are editing.  You need not scale your control to the requested size.  If
	   the area presented to your control is too small, set didFit to false.  You should still return in used the size
	   you would have liked to use for the control.   The application will then try again with a new size.  Note that
	   all controls must be able to fit within a minimum of 300 by 250 pixels.
			...
			in order to enable your control.  You should not draw your control in response to
	...
	*/
	...
	/*
			pdActionCustomSetFocus is called in order to set or advance the current focus of the user interface,
	   typically because the user has pressed the tab or shift-tab keys, or because the user clicked within the area
	   defined by your control.

			Your control will be called with pdActionFocusFirst,  pdActionFocusLast, or pdActionFocusOff to set or clear
	   focus on your control.  Your control will be called with pdActionFocusForward or pdActionFocusBackward to cycle
	...
	*/
	...
	/*
			...
			If your control has editing boxes, this is useful in order to allow the user to perform cut/copy/paste
	   operations when focus is on one of these boxes.
	*/
	...
	*/
	...
	/*
			...
			by standard pop up or enumerated type controls), you need to supply a value that can be use for greater
	   than/less than types of comparisons.
	*/
	...
	*/
	...
	/*
			...
			that you prefer.
	*/
	typedef CALLBACK_API(Boolean, QTEffectListFilterProcPtr)(Component effect, long effectMinSource,
															 long effectMaxSource, OSType majorClass, OSType minorClass,
															 void *refcon);
	 ...
	 */
	EXTERN_API(OSErr)
	QTGetEffectsList(QTAtomContainer *returnedList, long minSources, long maxSources, QTEffectListOptions getOptions);
	 ...
	 */
	EXTERN_API(OSErr)
	QTGetEffectsListExtended(QTAtomContainer *returnedList, long minSources, long maxSources,
							 QTEffectListOptions getOptions, OSType majorClass, OSType minorClass,
							 QTEffectListFilterUPP filterProc, void *filterRefCon);
	 ...
	 */
	EXTERN_API(OSErr)
	QTCreateStandardParameterDialog(QTAtomContainer effectList, QTAtomContainer parameters,
									QTParameterDialogOptions dialogOptions, QTParameterDialog *createdDialog);
	 ...
	 */
	EXTERN_API(OSErr)
	QTIsStandardParameterDialogEvent(EventRecord *pEvent, QTParameterDialog createdDialog);
	 ...
	 */
	EXTERN_API(OSErr)
	QTStandardParameterDialogDoAction(QTParameterDialog createdDialog, long action, void *params);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetMovieAudioGain(Movie m, Float32 gain, UInt32 flags);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetMovieAudioGain(Movie m, Float32 *gain, UInt32 flags);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetTrackAudioGain(Track t, Float32 gain, UInt32 flags);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetTrackAudioGain(Track t, Float32 *gain, UInt32 flags);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetMovieAudioBalance(Movie m, Float32 leftRight, UInt32 flags);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetMovieAudioBalance(Movie m, Float32 *leftRight, UInt32 flags);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetMovieAudioMute(Movie m, Boolean muted, UInt32 flags);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetMovieAudioMute(Movie m, Boolean *muted, UInt32 flags);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetTrackAudioMute(Track t, Boolean muted, UInt32 flags);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetTrackAudioMute(Track t, Boolean *muted, UInt32 flags);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetMovieAudioVolumeMeteringEnabled(Movie m, FourCharCode whatMixToMeter, Boolean enabled);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetMovieAudioVolumeMeteringEnabled(Movie m, FourCharCode whatMixToMeter, Boolean *enabled);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetMovieAudioVolumeLevels(Movie m, FourCharCode whatMixToMeter, QTAudioVolumeLevels *pAveragePowerLevels,
	...
	*/
	 ...
	 */
	EXTERN_API(OSStatus)
	SetTrackAudioVolumeMeteringEnabled(Track t, Boolean enabled);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetTrackAudioVolumeMeteringEnabled(Track t, Boolean *enabled);
	...
	*/
	 ...
	 */
	EXTERN_API(OSStatus)
	GetTrackAudioVolumeLevels(Track t, QTAudioVolumeLevels *pAveragePowerLevels, QTAudioVolumeLevels *pPeakHoldLevels);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetMovieAudioFrequencyMeteringNumBands(Movie m, FourCharCode whatMixToMeter, UInt32 *ioNumBands);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetMovieAudioFrequencyMeteringNumBands(Movie m, FourCharCode whatMixToMeter, UInt32 *outNumBands);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetMovieAudioFrequencyMeteringBandFrequencies(Movie m, FourCharCode whatMixToMeter, UInt32 numBands,
	 ...
	 */
	EXTERN_API(OSStatus)
	GetMovieAudioFrequencyLevels(Movie m, FourCharCode whatMixToMeter, QTAudioFrequencyLevels *pAveragePowerLevels);
	 ...
	 */
	EXTERN_API(OSStatus)
	MovieAudioExtractionBegin(Movie m, UInt32 flags, MovieAudioExtractionRef *outSession);
	...
	enum
	{
		...
		kQTMovieAudioExtractionMoviePropertyID_AllChannelsDiscrete =
			FOUR_CHAR_CODE('disc'), /* value is Boolean. Get/Set.*/
	...
	enum
	{
		...
		kQTMovieAudioExtractionAudioPropertyID_AudioStreamBasicDescription =
			FOUR_CHAR_CODE('asbd'), /* value is AudioStreamBasicDescription. Get/Set.*/
		...
		kQTMovieAudioExtractionAudioPropertyID_AudioChannelLayout =
			FOUR_CHAR_CODE('clay'), /* value is AudioChannelLayout. Get/Set.*/
		 ...
		 */
		kQTMovieAudioExtractionAudioPropertyID_RemainingAudioDuration =
			FOUR_CHAR_CODE('dura') /* value is TimeRecord. Get only.*/
	};
	 ...
	 */
	EXTERN_API(OSStatus)
	MovieAudioExtractionGetPropertyInfo(MovieAudioExtractionRef session, QTPropertyClass inPropClass,
										QTPropertyID inPropID, QTPropertyValueType *outPropType,
										ByteCount *outPropValueSize, UInt32 *outPropertyFlags);
	 ...
	 */
	EXTERN_API(OSStatus)
	MovieAudioExtractionGetProperty(MovieAudioExtractionRef session, QTPropertyClass inPropClass, QTPropertyID inPropID,
									ByteCount inPropValueSize, QTPropertyValuePtr outPropValueAddress,
									ByteCount *outPropValueSizeUsed);
	 ...
	 */
	EXTERN_API(OSStatus)
	MovieAudioExtractionSetProperty(MovieAudioExtractionRef session, QTPropertyClass inPropClass, QTPropertyID inPropID,
									ByteCount inPropValueSize, ConstQTPropertyValuePtr inPropValueAddress);
	 ...
	 */
	EXTERN_API(OSStatus)
	MovieAudioExtractionFillBuffer(MovieAudioExtractionRef session, UInt32 *ioNumFrames, AudioBufferList *ioData,
								   UInt32 *outFlags);
	...
	*/
	...
	enum
	{
		 ...
		 */
		kQTMovieAudioExtractionAudioPropertyID_RegisterMovieInsert =
			FOUR_CHAR_CODE('regm'), /* value is QTAudioContextInsertRegistryInfoRef. Get/Set.*/
		...
		kQTMovieAudioExtractionAudioPropertyID_RegisterTrackInsert =
			FOUR_CHAR_CODE('regt') /* value is QTAudioTrackInsertRegistryInfoRef. Get/Set.*/
	};

#define kQTMovieAudioExtractionMoviePropertyID_RegisterInsert \
	Use kQTPropertyClass_MovieAudioExtraction_Audio /         \
		kQTMovieAudioExtractionAudioPropertyID_RegisterMovieInsert instead !
	 ...
	 */
	EXTERN_API_C(OSStatus)
	SetMovieVisualHue(Movie movie, Float32 hue, UInt32 flags);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	GetMovieVisualHue(Movie movie, Float32 *hueOut, UInt32 flags);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	SetMovieVisualSaturation(Movie movie, Float32 saturation, UInt32 flags);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	GetMovieVisualSaturation(Movie movie, Float32 *saturationOut, UInt32 flags);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	SetMovieVisualBrightness(Movie movie, Float32 brightness, UInt32 flags);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	GetMovieVisualBrightness(Movie movie, Float32 *brightnessOut, UInt32 flags);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	SetMovieVisualContrast(Movie movie, Float32 contrast, UInt32 flags);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	GetMovieVisualContrast(Movie movie, Float32 *contrastOut, UInt32 flags);
	 ...
	 */
	EXTERN_API_C(OSErr)
	SetTrackApertureModeDimensionsUsingSampleDescription(Track track,
	...
	*****/
	...
	/*
			...
			QTAddMovieError(Movie       addTo,                          // in: movie to add error to
											Component   adder,                          // in: component which is adding
	   the error long        errorCode,                      // in: error code being added QTErrorReplacementPtr
	   stringReplacements);// in: list of strings to subsitute (in order) for "^1", "^2", etc
	*/
	/*
	 *  QTAddMovieError()
	 *
	 ...
	 */
	EXTERN_API(OSErr)
	QTAddMovieError(Movie movieH, Component c, long errorCode, QTErrorReplacementPtr stringReplacements);
	...
	*****/
	 ...
	 */
	EXTERN_API(OSErr)
	QTGetMovieRestrictions(Movie theMovie, QTRestrictionSet *outRestrictionSet, UInt32 *outSeed);
	 ...
	 */
	EXTERN_API(OSErr)
	QTRestrictionsGetInfo(QTRestrictionSet inRestrictionSet, long *outRestrictionClassCount, long *outSeed);
	 ...
	 */
	EXTERN_API(OSErr)
	QTRestrictionsGetIndClass(QTRestrictionSet inRestrictionSet, long inIndex, OSType *outClass);
	 ...
	 */
	EXTERN_API(OSErr)
	QTRestrictionsGetItem(QTRestrictionSet inRestrictionSet, OSType inRestrictionClass, UInt32 *outRestrictions);
	 ...
	 */
	EXTERN_API(OSErr)
	QTCreateUUID(QTUUID *outUUID, long creationFlags);
	 ...
	 */
	EXTERN_API(Boolean)
	QTEqualUUIDs(const QTUUID *uuid1, const QTUUID *uuid2);
	...
	*****/
	 ...
	 */
	EXTERN_API(OSErr)
	MakeTrackTimeTable(Track trackH, long **offsets, TimeValue startTime, TimeValue endTime, TimeValue timeIncrement,
					   short firstDataRefIndex, short lastDataRefIndex, long *retdataRefSkew);
	 ...
	 */
	EXTERN_API(OSErr)
	MakeMediaTimeTable(Media theMedia, long **offsets, TimeValue startTime, TimeValue endTime, TimeValue timeIncrement,
					   short firstDataRefIndex, short lastDataRefIndex, long *retdataRefSkew);
	 ...
	 */
	EXTERN_API(OSErr)
	QTGetDataRefMaxFileOffset(Movie movieH, OSType dataRefType, Handle dataRef, long *offset);
	...
	{
		return (QTCallBackUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppQTCallBackProcInfo,
...
#define NewQTCallBackUPP(userRoutine) \
	...
	{
		return (QTSyncTaskUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppQTSyncTaskProcInfo,
												   GetCurrentArchitecture());
	}
#else
#define NewQTSyncTaskUPP(userRoutine) \
	...
	{
		return (MovieRgnCoverUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppMovieRgnCoverProcInfo,
													  GetCurrentArchitecture());
	}
#else
#define NewMovieRgnCoverUPP(userRoutine) \
	...
	{
		return (MovieProgressUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppMovieProgressProcInfo,
													  GetCurrentArchitecture());
	}
#else
#define NewMovieProgressUPP(userRoutine) \
	...
	{
		return (MovieDrawingCompleteUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppMovieDrawingCompleteProcInfo,
															 GetCurrentArchitecture());
	}
#else
#define NewMovieDrawingCompleteUPP(userRoutine) \
	(MovieDrawingCompleteUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppMovieDrawingCompleteProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (TrackTransferUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppTrackTransferProcInfo,
													  GetCurrentArchitecture());
	}
#else
...
#define NewGetMovieUPP(userRoutine) \
	...
	{
		return (MoviePreviewCallOutUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppMoviePreviewCallOutProcInfo,
															GetCurrentArchitecture());
	}
#else
#define NewMoviePreviewCallOutUPP(userRoutine) \
	(MoviePreviewCallOutUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppMoviePreviewCallOutProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (TextMediaUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppTextMediaProcInfo,
												  GetCurrentArchitecture());
	}
#else
...
#define NewActionsUPP(userRoutine) \
	(ActionsUPP) NewRoutineDescriptor((ProcPtr)(userRoutine), uppActionsProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (DoMCActionUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppDoMCActionProcInfo,
												   GetCurrentArchitecture());
	}
#else
#define NewDoMCActionUPP(userRoutine) \
	(DoMCActionUPP) NewRoutineDescriptor((ProcPtr)(userRoutine), uppDoMCActionProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#ifdef __cplusplus
	inline DEFINE_API_C(MovieExecuteWiredActionsUPP)
		NewMovieExecuteWiredActionsUPP(MovieExecuteWiredActionsProcPtr userRoutine)
	{
		return (MovieExecuteWiredActionsUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppMovieExecuteWiredActionsProcInfo, GetCurrentArchitecture());
	}
#else
#define NewMovieExecuteWiredActionsUPP(userRoutine) \
	(MovieExecuteWiredActionsUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppMovieExecuteWiredActionsProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#ifdef __cplusplus
	inline DEFINE_API_C(MoviePrePrerollCompleteUPP)
		NewMoviePrePrerollCompleteUPP(MoviePrePrerollCompleteProcPtr userRoutine)
	{
		return (MoviePrePrerollCompleteUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppMoviePrePrerollCompleteProcInfo, GetCurrentArchitecture());
	}
#else
#define NewMoviePrePrerollCompleteUPP(userRoutine) \
	(MoviePrePrerollCompleteUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppMoviePrePrerollCompleteProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	enum
	{
		uppQTNextTaskNeededSoonerCallbackProcInfo = 0x00000FC0
	}; /* pascal no_return_value Func(4_bytes, 4_bytes, 4_bytes) */
#ifdef __cplusplus
	inline DEFINE_API_C(QTNextTaskNeededSoonerCallbackUPP)
		NewQTNextTaskNeededSoonerCallbackUPP(QTNextTaskNeededSoonerCallbackProcPtr userRoutine)
	{
		return (QTNextTaskNeededSoonerCallbackUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppQTNextTaskNeededSoonerCallbackProcInfo, GetCurrentArchitecture());
	}
#else
#define NewQTNextTaskNeededSoonerCallbackUPP(userRoutine)     \
	(QTNextTaskNeededSoonerCallbackUPP) NewRoutineDescriptor( \
		(ProcPtr)(userRoutine), uppQTNextTaskNeededSoonerCallbackProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (MoviesErrorUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppMoviesErrorProcInfo,
													GetCurrentArchitecture());
	}
#else
#define NewMoviesErrorUPP(userRoutine) \
	...
	{
		return (TweenerDataUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppTweenerDataProcInfo,
													GetCurrentArchitecture());
	}
#else
#define NewTweenerDataUPP(userRoutine) \
	...
	enum
	{
		uppQTEffectListFilterProcInfo = 0x0003FFD0
	}; /* pascal 1_byte Func(4_bytes, 4_bytes, 4_bytes, 4_bytes, 4_bytes, 4_bytes) */
#ifdef __cplusplus
	inline DEFINE_API_C(QTEffectListFilterUPP) NewQTEffectListFilterUPP(QTEffectListFilterProcPtr userRoutine)
	{
		return (QTEffectListFilterUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppQTEffectListFilterProcInfo,
														   GetCurrentArchitecture());
	}
#else
#define NewQTEffectListFilterUPP(userRoutine) \
	(QTEffectListFilterUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppQTEffectListFilterProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define InvokeQTSyncTaskUPP(task, userUPP) CALL_ONE_PARAMETER_UPP((userUPP), uppQTSyncTaskProcInfo, (task))
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeMovieRgnCoverUPP(Movie theMovie, RgnHandle changedRgn, long refcon, MovieRgnCoverUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeMovieRgnCoverUPP(theMovie, changedRgn, refcon, userUPP) \
	(OSErr) CALL_THREE_PARAMETER_UPP((userUPP), uppMovieRgnCoverProcInfo, (theMovie), (changedRgn), (refcon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeMovieProgressUPP(Movie theMovie, short message, short whatOperation, Fixed percentDone, long refcon,
						   MovieProgressUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSErr) InvokeMovieProgressUPP(Movie theMovie, short message, short whatOperation,
													  Fixed percentDone, long refcon, MovieProgressUPP userUPP)
	{
		return (OSErr)CALL_FIVE_PARAMETER_UPP(userUPP, uppMovieProgressProcInfo, theMovie, message, whatOperation,
											  percentDone, refcon);
	}
#else
#define InvokeMovieProgressUPP(theMovie, message, whatOperation, percentDone, refcon, userUPP)                   \
	(OSErr) CALL_FIVE_PARAMETER_UPP((userUPP), uppMovieProgressProcInfo, (theMovie), (message), (whatOperation), \
									(percentDone), (refcon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeMovieDrawingCompleteUPP(Movie theMovie, long refCon, MovieDrawingCompleteUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSErr)
		InvokeMovieDrawingCompleteUPP(Movie theMovie, long refCon, MovieDrawingCompleteUPP userUPP)
...
#define InvokeMovieDrawingCompleteUPP(theMovie, refCon, userUPP) \
	(OSErr) CALL_TWO_PARAMETER_UPP((userUPP), uppMovieDrawingCompleteProcInfo, (theMovie), (refCon))
#endif
#endif
...
#define InvokeTrackTransferUPP(t, refCon, userUPP) \
	(OSErr) CALL_TWO_PARAMETER_UPP((userUPP), uppTrackTransferProcInfo, (t), (refCon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeGetMovieUPP(long offset, long size, void *dataPtr, void *refCon, GetMovieUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSErr)
		InvokeGetMovieUPP(long offset, long size, void *dataPtr, void *refCon, GetMovieUPP userUPP)
...
#define InvokeGetMovieUPP(offset, size, dataPtr, refCon, userUPP) \
	(OSErr) CALL_FOUR_PARAMETER_UPP((userUPP), uppGetMovieProcInfo, (offset), (size), (dataPtr), (refCon))
#endif
#endif
...
#define InvokeMoviePreviewCallOutUPP(refcon, userUPP) \
	(Boolean) CALL_ONE_PARAMETER_UPP((userUPP), uppMoviePreviewCallOutProcInfo, (refcon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeTextMediaUPP(Handle theText, Movie theMovie, short *displayFlag, long refcon, TextMediaUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSErr)
		InvokeTextMediaUPP(Handle theText, Movie theMovie, short *displayFlag, long refcon, TextMediaUPP userUPP)
...
#define InvokeTextMediaUPP(theText, theMovie, displayFlag, refcon, userUPP) \
	(OSErr) CALL_FOUR_PARAMETER_UPP((userUPP), uppTextMediaProcInfo, (theText), (theMovie), (displayFlag), (refcon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeActionsUPP(void *refcon, Track targetTrack, long targetRefCon, QTEventRecordPtr theEvent, ActionsUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSErr) InvokeActionsUPP(void *refcon, Track targetTrack, long targetRefCon,
...
#define InvokeActionsUPP(refcon, targetTrack, targetRefCon, theEvent, userUPP) \
	(OSErr) CALL_FOUR_PARAMETER_UPP((userUPP), uppActionsProcInfo, (refcon), (targetTrack), (targetRefCon), (theEvent))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeDoMCActionUPP(void *refcon, short action, void *params, Boolean *handled, DoMCActionUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSErr)
		InvokeDoMCActionUPP(void *refcon, short action, void *params, Boolean *handled, DoMCActionUPP userUPP)
...
#define InvokeDoMCActionUPP(refcon, action, params, handled, userUPP) \
	(OSErr) CALL_FOUR_PARAMETER_UPP((userUPP), uppDoMCActionProcInfo, (refcon), (action), (params), (handled))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeMovieExecuteWiredActionsUPP(Movie theMovie, void *refcon, long flags, QTAtomContainer wiredActions,
	...
	inline DEFINE_API_C(OSErr)
		InvokeMovieExecuteWiredActionsUPP(Movie theMovie, void *refcon, long flags, QTAtomContainer wiredActions,
										  MovieExecuteWiredActionsUPP userUPP)
	{
		return (OSErr)CALL_FOUR_PARAMETER_UPP(userUPP, uppMovieExecuteWiredActionsProcInfo, theMovie, refcon, flags,
											  wiredActions);
	}
#else
#define InvokeMovieExecuteWiredActionsUPP(theMovie, refcon, flags, wiredActions, userUPP)                          \
	(OSErr) CALL_FOUR_PARAMETER_UPP((userUPP), uppMovieExecuteWiredActionsProcInfo, (theMovie), (refcon), (flags), \
									(wiredActions))
#endif
#endif
...
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void) InvokeMoviePrePrerollCompleteUPP(Movie theMovie, OSErr prerollErr, void *refcon,
															   MoviePrePrerollCompleteUPP userUPP)
	{
...
#define InvokeMoviePrePrerollCompleteUPP(theMovie, prerollErr, refcon, userUPP) \
	 ...
	 */
	EXTERN_API_C(void)
	InvokeQTNextTaskNeededSoonerCallbackUPP(TimeValue duration, unsigned long flags, void *refcon,
											QTNextTaskNeededSoonerCallbackUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void)
		InvokeQTNextTaskNeededSoonerCallbackUPP(TimeValue duration, unsigned long flags, void *refcon,
												QTNextTaskNeededSoonerCallbackUPP userUPP)
	{
...
#else
#define InvokeQTNextTaskNeededSoonerCallbackUPP(duration, flags, refcon, userUPP) \
	CALL_THREE_PARAMETER_UPP((userUPP), uppQTNextTaskNeededSoonerCallbackProcInfo, (duration), (flags), (refcon))
#endif
#endif
...
#define InvokeMoviesErrorUPP(theErr, refcon, userUPP) \
	...
	InvokeTweenerDataUPP(TweenRecord *tr, void *tweenData, long tweenDataSize, long dataDescriptionSeed,
						 Handle dataDescription, ICMCompletionProcRecordPtr asyncCompletionProc,
						 UniversalProcPtr transferProc, void *refCon, TweenerDataUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(ComponentResult)
		InvokeTweenerDataUPP(TweenRecord *tr, void *tweenData, long tweenDataSize, long dataDescriptionSeed,
							 ...
							 UniversalProcPtr transferProc, void *refCon, TweenerDataUPP userUPP)
	{
		return (ComponentResult)CALL_EIGHT_PARAMETER_UPP(userUPP, uppTweenerDataProcInfo, tr, tweenData, tweenDataSize,
...
#define InvokeTweenerDataUPP(tr, tweenData, tweenDataSize, dataDescriptionSeed, dataDescription, asyncCompletionProc, \
	...
	(ComponentResult) CALL_EIGHT_PARAMETER_UPP((userUPP), uppTweenerDataProcInfo, (tr), (tweenData), (tweenDataSize), \
											   (dataDescriptionSeed), (dataDescription), (asyncCompletionProc),       \
											   (transferProc), (refCon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(Boolean)
	InvokeQTEffectListFilterUPP(Component effect, long effectMinSource, long effectMaxSource, OSType majorClass,
								OSType minorClass, void *refcon, QTEffectListFilterUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(Boolean)
		InvokeQTEffectListFilterUPP(Component effect, long effectMinSource, long effectMaxSource, OSType majorClass,
									OSType minorClass, void *refcon, QTEffectListFilterUPP userUPP)
	{
		return (Boolean)CALL_SIX_PARAMETER_UPP(userUPP, uppQTEffectListFilterProcInfo, effect, effectMinSource,
											   effectMaxSource, majorClass, minorClass, refcon);
	}
#else
#define InvokeQTEffectListFilterUPP(effect, effectMinSource, effectMaxSource, majorClass, minorClass, refcon, userUPP) \
	(Boolean) CALL_SIX_PARAMETER_UPP((userUPP), uppQTEffectListFilterProcInfo, (effect), (effectMinSource),            \
									 (effectMaxSource), (majorClass), (minorClass), (refcon))
#endif
#endif
...
#define CallMovieProgressProc(userRoutine, theMovie, message, whatOperation, percentDone, refcon) \
	InvokeMovieProgressUPP(theMovie, message, whatOperation, percentDone, refcon, userRoutine)
...
#define CallActionsProc(userRoutine, refcon, targetTrack, targetRefCon, theEvent) \
...
#define CallMovieExecuteWiredActionsProc(userRoutine, theMovie, refcon, flags, wiredActions) \
	InvokeMovieExecuteWiredActionsUPP(theMovie, refcon, flags, wiredActions, userRoutine)
#define CallMoviePrePrerollCompleteProc(userRoutine, theMovie, prerollErr, refcon) \
	InvokeMoviePrePrerollCompleteUPP(theMovie, prerollErr, refcon, userRoutine)
#define CallQTNextTaskNeededSoonerCallbackProc(userRoutine, duration, flags, refcon) \
	InvokeQTNextTaskNeededSoonerCallbackUPP(duration, flags, refcon, userRoutine)
#define CallMoviesErrorProc(userRoutine, theErr, refcon) InvokeMoviesErrorUPP(theErr, refcon, userRoutine)
#define CallTweenerDataProc(userRoutine, tr, tweenData, tweenDataSize, dataDescriptionSeed, dataDescription,      \
	...
	InvokeTweenerDataUPP(tr, tweenData, tweenDataSize, dataDescriptionSeed, dataDescription, asyncCompletionProc, \
						 transferProc, refCon, userRoutine)
#define CallQTEffectListFilterProc(userRoutine, effect, effectMinSource, effectMaxSource, majorClass, minorClass, \
								   refcon)                                                                        \
	InvokeQTEffectListFilterUPP(effect, effectMinSource, effectMaxSource, majorClass, minorClass, refcon, userRoutine)
	...
	*****/
	 ...
	 */
	EXTERN_API(OSErr)
	ITextAddString(QTAtomContainer container, QTAtom parentAtom, RegionCode theRegionCode, ConstStr255Param theString);
	 ...
	 */
	EXTERN_API(OSErr)
	ITextRemoveString(QTAtomContainer container, QTAtom parentAtom, RegionCode theRegionCode, long flags);
	 ...
	 */
	EXTERN_API(OSErr)
	ITextGetString(QTAtomContainer container, QTAtom parentAtom, RegionCode requestedRegion, RegionCode *foundRegion,
				   StringPtr theString);
	...
	enum
	{
		...
		kQTParseTextHREFClickPoint = FOUR_CHAR_CODE(
			'clik'), /* Point; if present, QTParseTextHREF will expand URLs to support server-side image maps*/
		kQTParseTextHREFUseAltDelim =
			FOUR_CHAR_CODE('altd'),							/* boolean; if no kQTParseTextHREFDelimiter, delim is ':'*/
		kQTParseTextHREFDelimiter = FOUR_CHAR_CODE('delm'), /* character*/
		kQTParseTextHREFRecomposeHREF = FOUR_CHAR_CODE(
			'rhrf') /* Boolean; if true, QTParseTextHREF returns recomposed HREF with URL expanded as appropriate*/
	};
	...
	enum
	{
		...
		kQTParseTextHREFHREF = FOUR_CHAR_CODE(
			'href'), /* string; recomposed HREF with URL expanded as appropriate, suitable for mcActionLinkToURL*/
		kQTParseTextHREFEMBEDArgs =
			FOUR_CHAR_CODE('mbed') /* string; text between 'E<' and '>' to be used as new movie's embed tags*/
	};
	 ...
	 */
	EXTERN_API(OSErr)
	QTParseTextHREF(char *href, SInt32 hrefLen, QTAtomContainer inContainer, QTAtomContainer *outContainer);
...
#define GetDisplayedSampleNumber		  SpriteMediaGetDisplayedSampleNumber
	...
	*****/
	 ...
	 */
	EXTERN_API(ComponentResult)
	VideoMediaSetCodecParameter(MediaHandler mh, CodecType cType, OSType parameterID, long parameterChangeSeed,
								void *dataPtr, long dataSize) FIVEWORDINLINE(0x2F3C, 0x0014, 0x010F, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	VideoMediaGetCodecParameter(MediaHandler mh, CodecType cType, OSType parameterID, Handle outParameterData)
	 ...
	 */
	EXTERN_API(ComponentResult)
	TextMediaAddTextSample(MediaHandler mh, Ptr text, unsigned long size, short fontNumber, short fontSize,
						   Style textFace, RGBColor *textColor, RGBColor *backColor, short textJustification,
						   Rect *textBox, long displayFlags, TimeValue scrollDelay, short hiliteStart, short hiliteEnd,
	 ...
	 */
	EXTERN_API(ComponentResult)
	TextMediaAddTESample(MediaHandler mh, TEHandle hTE, RGBColor *backColor, short textJustification, Rect *textBox,
						 long displayFlags, TimeValue scrollDelay, short hiliteStart, short hiliteEnd,
						 RGBColor *rgbHiliteColor, TimeValue duration, TimeValue *sampleTime)
	 ...
	 */
	EXTERN_API(ComponentResult)
	TextMediaAddHiliteSample(MediaHandler mh, short hiliteStart, short hiliteEnd, RGBColor *rgbHiliteColor,
	 ...
	 */
	EXTERN_API(ComponentResult)
	TextMediaDrawRaw(MediaHandler mh, GWorldPtr gw, GDHandle gd, void *data, long dataSize, TextDescriptionHandle tdh)
	 ...
	 */
	EXTERN_API(ComponentResult)
	TextMediaSetTextProperty(MediaHandler mh, TimeValue atMediaTime, long propertyType, void *data, long dataSize)
	 ...
	 */
	EXTERN_API(ComponentResult)
	TextMediaRawSetup(MediaHandler mh, GWorldPtr gw, GDHandle gd, void *data, long dataSize, TextDescriptionHandle tdh,
	 ...
	 */
	EXTERN_API(ComponentResult)
	TextMediaRawIdle(MediaHandler mh, GWorldPtr gw, GDHandle gd, TimeValue sampleTime, long flagsIn, long *flagsOut)
	 ...
	 */
	EXTERN_API(ComponentResult)
	TextMediaGetTextProperty(MediaHandler mh, TimeValue atMediaTime, long propertyType, void *data, long dataSize)
	 ...
	 */
	EXTERN_API(ComponentResult)
	TextMediaFindNextText(MediaHandler mh, Ptr text, long size, short findFlags, TimeValue startTime,
						  TimeValue *foundTime, TimeValue *foundDuration, long *offset)
	 ...
	 */
	EXTERN_API(ComponentResult)
	TextMediaHiliteTextSample(MediaHandler mh, TimeValue sampleTime, short hiliteStart, short hiliteEnd,
	...
	enum
	{
		...
		spriteHitTestLocInDisplayCoordinates =
			1L << 4, /*    set if you want to pass a display coordiate point to SpriteHitTest*/
		spriteHitTestTreatAllSpritesAsHitTestable =
			1L << 5 /* set if you want to override each sprites hittestable property as true*/
	};
	...
	enum
	{
		...
		kSpriteUsesImageIDsAtomType =
			FOUR_CHAR_CODE('uses'), /* leaf data is an array of QTAtomID's, one per image used*/
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	SpriteMediaSetProperty(MediaHandler mh, short spriteIndex, long propertyType, void *propertyValue)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SpriteMediaGetProperty(MediaHandler mh, short spriteIndex, long propertyType, void *propertyValue)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SpriteMediaHitTestSprites(MediaHandler mh, long flags, Point loc, short *spriteHitIndex)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SpriteMediaCountSprites(MediaHandler mh, short *numSprites) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0104, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SpriteMediaCountImages(MediaHandler mh, short *numImages) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0105, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SpriteMediaGetIndImageDescription(MediaHandler mh, short imageIndex, ImageDescriptionHandle imageDescription)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SpriteMediaSetSpriteProperty(MediaHandler mh, QTAtomID spriteID, long propertyType, void *propertyValue)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SpriteMediaGetSpriteProperty(MediaHandler mh, QTAtomID spriteID, long propertyType, void *propertyValue)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SpriteMediaHitTestAllSprites(MediaHandler mh, long flags, Point loc, QTAtomID *spriteHitID)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SpriteMediaHitTestOneSprite(MediaHandler mh, QTAtomID spriteID, long flags, Point loc, Boolean *wasHit)
		FIVEWORDINLINE(0x2F3C, 0x0010, 0x010D, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SpriteMediaSpriteIndexToID(MediaHandler mh, short spriteIndex, QTAtomID *spriteID)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SpriteMediaSpriteIDToIndex(MediaHandler mh, QTAtomID spriteID, short *spriteIndex)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SpriteMediaGetSpriteActionsForQTEvent(MediaHandler mh, QTEventRecordPtr event, QTAtomID spriteID,
	 ...
	 */
	EXTERN_API(ComponentResult)
	SpriteMediaSetActionVariable(MediaHandler mh, QTAtomID variableID, const float *value)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SpriteMediaGetIndImageProperty(MediaHandler mh, short imageIndex, long imagePropertyType, void *imagePropertyValue)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SpriteMediaDisposeSprite(MediaHandler mh, QTAtomID spriteID) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0115, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SpriteMediaSetActionVariableToString(MediaHandler mh, QTAtomID variableID, Ptr theCString)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SpriteMediaGetActionVariableAsString(MediaHandler mh, QTAtomID variableID, Handle *theCString)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SpriteMediaNewImage(MediaHandler mh, Handle dataRef, OSType dataRefType, QTAtomID desiredID)
		FIVEWORDINLINE(0x2F3C, 0x000C, 0x011B, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SpriteMediaDisposeImage(MediaHandler mh, short imageIndex) FIVEWORDINLINE(0x2F3C, 0x0002, 0x011C, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SpriteMediaImageIndexToID(MediaHandler mh, short imageIndex, QTAtomID *imageID)
		FIVEWORDINLINE(0x2F3C, 0x0006, 0x011D, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SpriteMediaImageIDToIndex(MediaHandler mh, QTAtomID imageID, short *imageIndex)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x011E, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	FlashMediaSetZoom(MediaHandler mh, short factor) FIVEWORDINLINE(0x2F3C, 0x0002, 0x0102, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	FlashMediaSetZoomRect(MediaHandler mh, long left, long top, long right, long bottom)
	 ...
	 */
	EXTERN_API(ComponentResult)
	FlashMediaGetRefConBounds(MediaHandler mh, long refCon, long *left, long *top, long *right, long *bottom)
	 ...
	 */
	EXTERN_API(ComponentResult)
	FlashMediaFrameNumberToMovieTime(MediaHandler mh, long flashFrameNumber, TimeValue *movieTime)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x0108, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	FlashMediaFrameLabelToMovieTime(MediaHandler mh, Ptr theLabel, TimeValue *movieTime)
	 ...
	 */
	EXTERN_API(ComponentResult)
	FlashMediaGetFlashVariable(MediaHandler mh, char *path, char *name, Handle *theVariableCStringOut)
		FIVEWORDINLINE(0x2F3C, 0x000C, 0x010A, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	FlashMediaSetFlashVariable(MediaHandler mh, char *path, char *name, char *value, Boolean updateFocus)
	 ...
	 */
	EXTERN_API(ComponentResult)
	FlashMediaDoButtonActions(MediaHandler mh, char *path, long buttonID, long transition)
		FIVEWORDINLINE(0x2F3C, 0x000C, 0x010C, 0x7000, 0xA82A);
	...
	enum
	{
		...
		kMovieMediaUseMIMEType =
			FOUR_CHAR_CODE('mime'), /* string indicating the MIME type to use for the dataref (usually not required)*/
		...
		kMovieMediaSlaveTrackDuration =
			FOUR_CHAR_CODE('sltr'), /* Boolean indicating that media handler should adjust track and media based on
									   actual embedded movie duration*/
		kMovieMediaEnableFrameStepping =
			FOUR_CHAR_CODE('enfs'), /* boolean. if true stepping on external movie steps frames within embedded movie.*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieMediaGetChildDoMCActionCallback(MediaHandler mh, DoMCActionUPP *doMCActionCallbackProc, long *refcon)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieMediaGetDoMCActionCallback(MediaHandler mh, DoMCActionUPP *doMCActionCallbackProc, long *refcon)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieMediaGetCurrentMovieProperty(MediaHandler mh, OSType whichProperty, void *value)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieMediaGetCurrentTrackProperty(MediaHandler mh, long trackID, OSType whichProperty, void *value)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieMediaGetChildMovieDataReference(MediaHandler mh, QTAtomID dataRefID, short dataRefIndex, OSType *dataRefType,
										 Handle *dataRef, QTAtomID *dataRefIDOut, short *dataRefIndexOut)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieMediaSetChildMovieDataReference(MediaHandler mh, QTAtomID dataRefID, OSType dataRefType, Handle dataRef)
	 ...
	 */
	EXTERN_API(ComponentResult)
	Media3DGetCurrentGroup(MediaHandler mh, void *group) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0103, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	Media3DTranslateNamedObjectTo(MediaHandler mh, char *objectName, Fixed x, Fixed y, Fixed z)
		FIVEWORDINLINE(0x2F3C, 0x0010, 0x0104, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	Media3DScaleNamedObjectTo(MediaHandler mh, char *objectName, Fixed xScale, Fixed yScale, Fixed zScale)
	 ...
	 */
	EXTERN_API(ComponentResult)
	Media3DRotateNamedObjectTo(MediaHandler mh, char *objectName, Fixed xDegrees, Fixed yDegrees, Fixed zDegrees)
	 ...
	 */
	EXTERN_API(ComponentResult)
	Media3DSetCameraData(MediaHandler mh, void *cameraData) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0107, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	Media3DGetCameraData(MediaHandler mh, void *cameraData) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0108, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	Media3DSetCameraAngleAspect(MediaHandler mh, QTFloatSingle fov, QTFloatSingle aspectRatioXToY)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x0109, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	Media3DGetCameraAngleAspect(MediaHandler mh, QTFloatSingle *fov, QTFloatSingle *aspectRatioXToY)
	 ...
	 */
	EXTERN_API(ComponentResult)
	Media3DSetCameraRange(MediaHandler mh, void *tQ3CameraRange) FIVEWORDINLINE(0x2F3C, 0x0004, 0x010D, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	Media3DGetCameraRange(MediaHandler mh, void *tQ3CameraRange) FIVEWORDINLINE(0x2F3C, 0x0004, 0x010E, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	Media3DGetViewObject(MediaHandler mh, void *tq3viewObject) FIVEWORDINLINE(0x2F3C, 0x0004, 0x010F, 0x7000, 0xA82A);
	...
	enum
	{
		...
		mcActionSetControllerTimeLimits = 62,  /* param is pointer to 2 time values min/max. do no send this message to
												  controller. used internally only.*/
		...
		mcActionUseTrackForTimeTable =
			66, /* param is pointer to {long trackID; Boolean useIt}. do not send this message to controller. */
		mcActionClickAndHoldPoint = 67,	 /* param is point (local coordinates). return true if point has click & hold
											action (e.g., VR object movie autorotate spot)*/
	...
	typedef CALLBACK_API(Boolean, MCActionFilterWithRefConProcPtr)(MovieController mc, short action, void *params,
																   long refCon);
	typedef CALLBACK_API(Boolean, MCActionNotificationProcPtr)(MovieController mc, short action, void *params,
															   UInt32 inFlags, UInt32 *outFlags, void *refCon);
	...
	*/
	...
	{
		OSType returnSignature;				  /* Set to zero when passed to movieController, set to 'noti' if
												 mcActionAddActionNotification is implemented*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	MCSetMovie(MovieController mc, Movie theMovie, WindowRef movieWindow, Point where)
	 ...
	 */
	EXTERN_API(Movie)
	MCGetIndMovie(MovieController mc, short index) FIVEWORDINLINE(0x2F3C, 0x0002, 0x0005, 0x7000, 0xA82A);
...
#define MCGetMovie(mc) MCGetIndMovie(mc, 0)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MCRemoveAMovie(MovieController mc, Movie m) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0003, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MCIsPlayerEvent(MovieController mc, const EventRecord *e) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0007, 0x7000, 0xA82A);
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	MCDoAction(MovieController mc, short action, void *params) FIVEWORDINLINE(0x2F3C, 0x0006, 0x0009, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MCSetControllerAttached(MovieController mc, Boolean attach) FIVEWORDINLINE(0x2F3C, 0x0002, 0x000A, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MCSetControllerPort(MovieController mc, CGrafPtr gp) FIVEWORDINLINE(0x2F3C, 0x0004, 0x000C, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MCSetVisible(MovieController mc, Boolean visible) FIVEWORDINLINE(0x2F3C, 0x0002, 0x000E, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MCGetControllerBoundsRect(MovieController mc, Rect *bounds) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0010, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(RgnHandle)
	MCGetWindowRgn(MovieController mc, WindowRef w) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0013, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MCMovieChanged(MovieController mc, Movie m) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0014, 0x7000, 0xA82A);
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	MCSetDuration(MovieController mc, TimeValue duration) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0015, 0x7000, 0xA82A);
	...
	*/
	 ...
	 */
	EXTERN_API(TimeValue)
	MCGetCurrentTime(MovieController mc, TimeScale *scale) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0016, 0x7000, 0xA82A);
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	MCNewAttachedController(MovieController mc, Movie theMovie, WindowRef w, Point where)
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	MCDraw(MovieController mc, WindowRef w) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0018, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MCKey(MovieController mc, SInt8 key, long modifiers) FIVEWORDINLINE(0x2F3C, 0x0006, 0x001B, 0x7000, 0xA82A);
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	MCEnableEditing(MovieController mc, Boolean enabled) FIVEWORDINLINE(0x2F3C, 0x0002, 0x001D, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MCPaste(MovieController mc, Movie srcMovie) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0021, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MCPositionController(MovieController mc, const Rect *movieRect, const Rect *controllerRect, long someFlags)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MCGetControllerInfo(MovieController mc, long *someFlags) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0025, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MCSetActionFilterWithRefCon(MovieController mc, MCActionFilterWithRefConUPP blob, long refCon)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MCGetInterfaceElement(MovieController mc, MCInterfaceElement whichElement, void *element)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MCGetDoActionsProc(MovieController mc, DoMCActionUPP *doMCActionProc, long *doMCActionRefCon)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MCSetIdleManager(MovieController mc, IdleManager im) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0035, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MCSetControllerCapabilities(MovieController mc, long flags, long flagsMask)
	 ...
	 */
	EXTERN_API(void)
	SetTimeBaseMasterTimeBase(TimeBase slave, TimeBase master, const TimeRecord *slaveZero);
	 ...
	 */
	EXTERN_API(void)
	SetTimeBaseMasterClock(TimeBase slave, Component clockMeister, const TimeRecord *slaveZero);
	 ...
	 */
	EXTERN_API(OSErr)
	GetTimeBaseRateChangeStatus(TimeBase tb, TimeScale scale, Fixed *ratedChangedTo, TimeBaseStatus *flags,
								TimeRecord *rateChangeTimeBaseTime, TimeRecord *rateChangeClockTime,
	 ...
	 */
	EXTERN_API(OSErr)
	SetTimeBaseOffsetTimeBase(TimeBase tb, TimeBase offsettb, const TimeRecord *offsetZero);
	 ...
	 */
	EXTERN_API(OSErr)
	GetTimeBaseThreadAttachState(TimeBase inTimeBase, Boolean *outAttachedToCurrentThread,
	 ...
	 */
	EXTERN_API(OSErr)
	CallMeWhen(QTCallBack cb, QTCallBackUPP callBackProc, long refCon, long param1, long param2, long param3);
	...
	typedef CALLBACK_API(void, QTMoviePropertyListenerProcPtr)(Movie inMovie, QTPropertyClass inPropClass,
															   QTPropertyID inPropID, void *inUserData);
	 ...
	 */
	EXTERN_API(OSErr)
	QTGetMoviePropertyInfo(Movie inMovie, QTPropertyClass inPropClass, QTPropertyID inPropID,
						   QTPropertyValueType *outPropType, ByteCount *outPropValueSize, UInt32 *outPropertyFlags);
	 ...
	 */
	EXTERN_API(OSErr)
	QTGetMovieProperty(Movie inMovie, QTPropertyClass inPropClass, QTPropertyID inPropID, ByteCount inPropValueSize,
					   QTPropertyValuePtr outPropValueAddress, ByteCount *outPropValueSizeUsed);
	 ...
	 */
	EXTERN_API(OSErr)
	QTSetMovieProperty(Movie inMovie, QTPropertyClass inPropClass, QTPropertyID inPropID, ByteCount inPropValueSize,
	 ...
	 */
	EXTERN_API(OSErr)
	QTAddMoviePropertyListener(Movie inMovie, QTPropertyClass inPropClass, QTPropertyID inPropID,
							   QTMoviePropertyListenerUPP inListenerProc, void *inUserData);
	 ...
	 */
	EXTERN_API(OSErr)
	QTRemoveMoviePropertyListener(Movie inMovie, QTPropertyClass inPropClass, QTPropertyID inPropID,
								  QTMoviePropertyListenerUPP inListenerProc, void *inUserData);
	...
	typedef CALLBACK_API(void, QTTrackPropertyListenerProcPtr)(Track inTrack, QTPropertyClass inPropClass,
															   QTPropertyID inPropID, void *inUserData);
	 ...
	 */
	EXTERN_API(OSErr)
	QTGetTrackPropertyInfo(Track inTrack, QTPropertyClass inPropClass, QTPropertyID inPropID,
						   QTPropertyValueType *outPropType, ByteCount *outPropValueSize, UInt32 *outPropertyFlags);
	 ...
	 */
	EXTERN_API(OSErr)
	QTGetTrackProperty(Track inTrack, QTPropertyClass inPropClass, QTPropertyID inPropID, ByteCount inPropValueSize,
					   QTPropertyValuePtr outPropValueAddress, ByteCount *outPropValueSizeUsed);
	 ...
	 */
	EXTERN_API(OSErr)
	QTSetTrackProperty(Track inTrack, QTPropertyClass inPropClass, QTPropertyID inPropID, ByteCount inPropValueSize,
					   ConstQTPropertyValuePtr inPropValueAddress);
	 ...
	 */
	EXTERN_API(OSErr)
	QTAddTrackPropertyListener(Track inTrack, QTPropertyClass inPropClass, QTPropertyID inPropID,
							   QTTrackPropertyListenerUPP inListenerProc, void *inUserData);
	 ...
	 */
	EXTERN_API(OSErr)
	QTRemoveTrackPropertyListener(Track inTrack, QTPropertyClass inPropClass, QTPropertyID inPropID,
								  QTTrackPropertyListenerUPP inListenerProc, void *inUserData);
	 ...
	 */
	EXTERN_API(OSStatus)
	QTSampleTableCreateMutable(CFAllocatorRef allocator, TimeScale timescale, void *hints,
	 ...
	 */
	EXTERN_API(OSStatus)
	QTSampleTableCreateMutableCopy(CFAllocatorRef allocator, QTSampleTableRef sampleTable, void *hints,
								   QTMutableSampleTableRef *newSampleTable);
	 ...
	 */
	EXTERN_API(OSStatus)
	QTSampleTableSetTimeScale(QTMutableSampleTableRef sampleTable, TimeScale newTimeScale);
	 ...
	 */
	EXTERN_API(OSStatus)
	QTSampleTableGetNextAttributeChange(QTSampleTableRef sampleTable, SInt64 startSampleNum,
										QTSampleTableAttribute attributeMask, SInt64 *sampleNumOut);
	 ...
	 */
	EXTERN_API(OSStatus)
	QTSampleTableAddSampleDescription(QTMutableSampleTableRef sampleTable, SampleDescriptionHandle sampleDescriptionH,
									  long mediaSampleDescriptionIndex, QTSampleDescriptionID *sampleDescriptionIDOut);
	 ...
	 */
	EXTERN_API(OSStatus)
	QTSampleTableCopySampleDescription(QTSampleTableRef sampleTable, QTSampleDescriptionID sampleDescriptionID,
	 ...
	 */
	EXTERN_API(OSStatus)
	QTSampleTableAddSampleReferences(QTMutableSampleTableRef sampleTable, SInt64 dataOffset,
									 ByteCount dataSizePerSample, TimeValue64 decodeDurationPerSample,
									 TimeValue64 displayOffset, SInt64 numberOfSamples, MediaSampleFlags sampleFlags,
									 QTSampleDescriptionID sampleDescriptionID, SInt64 *newSampleNumOut);
	 ...
	 */
	EXTERN_API(OSStatus)
	QTSampleTableReplaceRange(QTMutableSampleTableRef destSampleTable, SInt64 destStartingSampleNum,
							  SInt64 destSampleCount, QTSampleTableRef sourceSampleTable,
							  SInt64 sourceStartingSampleNum, SInt64 sourceSampleCount);
	 ...
	 */
	EXTERN_API(SInt64)
	QTSampleTableGetDataOffset(QTSampleTableRef sampleTable, SInt64 sampleNum);
	...
	QTSampleTableGetDataSizePerSample(QTSampleTableRef sampleTable, SInt64 sampleNum);
	 ...
	 */
	EXTERN_API(TimeValue64)
	QTSampleTableGetDecodeDuration(QTSampleTableRef sampleTable, SInt64 sampleNum);
	 ...
	 */
	EXTERN_API(TimeValue64)
	QTSampleTableGetDisplayOffset(QTSampleTableRef sampleTable, SInt64 sampleNum);
	...
	QTSampleTableGetSampleDescriptionID(QTSampleTableRef sampleTable, SInt64 sampleNum);
	...
	QTSampleTableGetSampleFlags(QTSampleTableRef sampleTable, SInt64 sampleNum);
	 ...
	 */
	EXTERN_API(OSStatus)
	QTSampleTableGetPropertyInfo(QTSampleTableRef sampleTable, QTPropertyClass inPropClass, QTPropertyID inPropID,
	 ...
	 */
	EXTERN_API(OSStatus)
	QTSampleTableGetProperty(QTSampleTableRef sampleTable, QTPropertyClass inPropClass, QTPropertyID inPropID,
							 ByteCount inPropValueSize, QTPropertyValuePtr outPropValueAddress,
	 ...
	 */
	EXTERN_API(OSStatus)
	QTSampleTableSetProperty(QTSampleTableRef sampleTable, QTPropertyClass inPropClass, QTPropertyID inPropID,
							 ByteCount inPropValueSize, ConstQTPropertyValuePtr inPropValueAddress);
	...
	*/
	 ...
	 */
	EXTERN_API(OSStatus)
	QTCopyMovieMetaData(Movie inMovie, QTMetaDataRef *outMetaData);
	 ...
	 */
	EXTERN_API(OSStatus)
	QTCopyTrackMetaData(Track inTrack, QTMetaDataRef *outMetaData);
	 ...
	 */
	EXTERN_API(OSStatus)
	QTCopyMediaMetaData(Media inMedia, QTMetaDataRef *outMetaData);
	 ...
	 */
	EXTERN_API(OSStatus)
	QTMetaDataCreateFromBuffer(const UInt8 *inBufferPtr, ByteCount inBufferSize, QTMetaDataRef *outMetaData);
	 ...
	 */
	EXTERN_API(OSStatus)
	QTMetaDataGetBytes(QTMetaDataRef inMetaData, ByteCount inBufferSize, UInt8 *inBufferPtr,
	 ...
	 */
	EXTERN_API(OSStatus)
	QTMetaDataGetPropertyInfo(QTMetaDataRef inMetaData, QTPropertyClass inPropClass, QTPropertyID inPropID,
							  QTPropertyValueType *outPropType, ByteCount *outPropValueSize, UInt32 *outPropFlags);
	 ...
	 */
	EXTERN_API(OSStatus)
	QTMetaDataGetProperty(QTMetaDataRef inMetaData, QTPropertyClass inPropClass, QTPropertyID inPropID,
						  ByteCount inPropValueSize, QTPropertyValuePtr outPropValueAddress,
						  ByteCount *outPropValueSizeUsed);
	 ...
	 */
	EXTERN_API(OSStatus)
	QTMetaDataSetProperty(QTMetaDataRef inMetaData, QTPropertyClass inPropClass, QTPropertyID inPropID,
						  ByteCount inPropValueSize, ConstQTPropertyValuePtr inPropValueAddress);
	 ...
	 */
	EXTERN_API(OSStatus)
	QTMetaDataGetItemValue(QTMetaDataRef inMetaData, QTMetaDataItem inItem, UInt8 *outValuePtr, ByteCount inValueSize,
	 ...
	 */
	EXTERN_API(OSStatus)
	QTMetaDataGetNextItem(QTMetaDataRef inMetaData, QTMetaDataStorageFormat inMetaDataFormat,
						  QTMetaDataItem inCurrentItem, QTMetaDataKeyFormat inKeyFormat, const UInt8 *inKeyPtr,
						  ByteCount inKeySize, QTMetaDataItem *outNextItem);
	 ...
	 */
	EXTERN_API(OSStatus)
	QTMetaDataGetItemPropertyInfo(QTMetaDataRef inMetaData, QTMetaDataItem inItem, QTPropertyClass inPropClass,
								  QTPropertyID inPropID, QTPropertyValueType *outPropType, ByteCount *outPropValueSize,
								  UInt32 *outPropFlags);
	 ...
	 */
	EXTERN_API(OSStatus)
	QTMetaDataGetItemProperty(QTMetaDataRef inMetaData, QTMetaDataItem inItem, QTPropertyClass inPropClass,
							  QTPropertyID inPropID, ByteCount inPropValueSize, QTPropertyValuePtr outPropValueAddress,
							  ByteCount *outPropValueSizeUsed);
	 ...
	 */
	EXTERN_API(OSStatus)
	QTMetaDataSetItemProperty(QTMetaDataRef inMetaData, QTMetaDataItem inItem, QTPropertyClass inPropClass,
							  QTPropertyID inPropID, ByteCount inPropValueSize,
							  ConstQTPropertyValuePtr inPropValueAddress);
	 ...
	 */
	EXTERN_API(OSStatus)
	QTMetaDataGetItemCountWithKey(QTMetaDataRef inMetaData, QTMetaDataStorageFormat inMetaDataFormat,
								  QTMetaDataKeyFormat inKeyFormat, const UInt8 *inKeyPtr, ByteCount inKeySize,
								  ItemCount *outCount);
	 ...
	 */
	EXTERN_API(OSStatus)
	QTMetaDataAddItem(QTMetaDataRef inMetaData, QTMetaDataStorageFormat inMetaDataFormat,
					  QTMetaDataKeyFormat inKeyFormat, const UInt8 *inKeyPtr, ByteCount inKeySize,
					  const UInt8 *inValuePtr, ByteCount inValueSize, UInt32 inDataType, QTMetaDataItem *outItem);
	 ...
	 */
	EXTERN_API(OSStatus)
	QTMetaDataSetItem(QTMetaDataRef inMetaData, QTMetaDataItem inItem, UInt8 *inValuePtr, ByteCount inValueSize,
					  UInt32 inDataType);
	 ...
	 */
	EXTERN_API(OSStatus)
	QTMetaDataRemoveItem(QTMetaDataRef inMetaData, QTMetaDataItem inItem);
	 ...
	 */
	EXTERN_API(OSStatus)
	QTMetaDataRemoveItemsWithKey(QTMetaDataRef inMetaData, QTMetaDataStorageFormat inMetaDataFormat,
								 QTMetaDataKeyFormat inKeyFormat, const UInt8 *inKeyPtr, ByteCount inKeySize);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MusicMediaGetIndexedTunePlayer(ComponentInstance ti, long sampleDescIndex, ComponentInstance *tp)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x0101, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSErr)
	QTBandwidthRequest(long priority, QTBandwidthNotificationUPP callback, const void *refcon,
					   QTBandwidthReference *bwRef, long flags);
	 ...
	 */
	EXTERN_API(OSErr)
	QTBandwidthRequestForTimeBase(TimeBase tb, long priority, QTBandwidthNotificationUPP callback, const void *refcon,
								  QTBandwidthReference *bwRef, long flags);
	 ...
	 */
	EXTERN_API(OSErr)
	QTScheduledBandwidthRequest(QTScheduledBandwidthPtr scheduleRec, QTBandwidthNotificationUPP notificationCallback,
								void *refcon, QTScheduledBandwidthReference *sbwRef, long flags);
	...
	{
		return (MCActionFilterUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppMCActionFilterProcInfo,
													   GetCurrentArchitecture());
	}
#else
#define NewMCActionFilterUPP(userRoutine) \
	(MCActionFilterUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppMCActionFilterProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#ifdef __cplusplus
	inline DEFINE_API_C(MCActionFilterWithRefConUPP)
		NewMCActionFilterWithRefConUPP(MCActionFilterWithRefConProcPtr userRoutine)
	{
		return (MCActionFilterWithRefConUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppMCActionFilterWithRefConProcInfo, GetCurrentArchitecture());
	}
#else
#define NewMCActionFilterWithRefConUPP(userRoutine) \
	(MCActionFilterWithRefConUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppMCActionFilterWithRefConProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	enum
	{
		uppMCActionNotificationProcInfo = 0x0003FED0
	}; /* pascal 1_byte Func(4_bytes, 2_bytes, 4_bytes, 4_bytes, 4_bytes, 4_bytes) */
#ifdef __cplusplus
	inline DEFINE_API_C(MCActionNotificationUPP) NewMCActionNotificationUPP(MCActionNotificationProcPtr userRoutine)
	{
		return (MCActionNotificationUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppMCActionNotificationProcInfo,
															 GetCurrentArchitecture());
	}
#else
#define NewMCActionNotificationUPP(userRoutine) \
	(MCActionNotificationUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppMCActionNotificationProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	enum
	{
		uppQTMoviePropertyListenerProcInfo = 0x00003FC0
	}; /* pascal no_return_value Func(4_bytes, 4_bytes, 4_bytes, 4_bytes) */
#ifdef __cplusplus
	inline DEFINE_API_C(QTMoviePropertyListenerUPP)
		NewQTMoviePropertyListenerUPP(QTMoviePropertyListenerProcPtr userRoutine)
	{
		return (QTMoviePropertyListenerUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppQTMoviePropertyListenerProcInfo, GetCurrentArchitecture());
	}
#else
#define NewQTMoviePropertyListenerUPP(userRoutine) \
	(QTMoviePropertyListenerUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppQTMoviePropertyListenerProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	enum
	{
		uppQTTrackPropertyListenerProcInfo = 0x00003FC0
	}; /* pascal no_return_value Func(4_bytes, 4_bytes, 4_bytes, 4_bytes) */
#ifdef __cplusplus
	inline DEFINE_API_C(QTTrackPropertyListenerUPP)
		NewQTTrackPropertyListenerUPP(QTTrackPropertyListenerProcPtr userRoutine)
	{
		return (QTTrackPropertyListenerUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppQTTrackPropertyListenerProcInfo, GetCurrentArchitecture());
	}
#else
#define NewQTTrackPropertyListenerUPP(userRoutine) \
	(QTTrackPropertyListenerUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppQTTrackPropertyListenerProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#ifdef __cplusplus
	inline DEFINE_API_C(QTBandwidthNotificationUPP)
		NewQTBandwidthNotificationUPP(QTBandwidthNotificationProcPtr userRoutine)
	{
		return (QTBandwidthNotificationUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppQTBandwidthNotificationProcInfo, GetCurrentArchitecture());
	}
#else
#define NewQTBandwidthNotificationUPP(userRoutine) \
	(QTBandwidthNotificationUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppQTBandwidthNotificationProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeQTBandwidthNotificationUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(Boolean)
	InvokeMCActionFilterUPP(MovieController mc, short *action, void *params, MCActionFilterUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(Boolean)
		InvokeMCActionFilterUPP(MovieController mc, short *action, void *params, MCActionFilterUPP userUPP)
...
#define InvokeMCActionFilterUPP(mc, action, params, userUPP) \
	(Boolean) CALL_THREE_PARAMETER_UPP((userUPP), uppMCActionFilterProcInfo, (mc), (action), (params))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(Boolean)
	InvokeMCActionFilterWithRefConUPP(MovieController mc, short action, void *params, long refCon,
									  MCActionFilterWithRefConUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(Boolean) InvokeMCActionFilterWithRefConUPP(MovieController mc, short action, void *params,
																   long refCon, MCActionFilterWithRefConUPP userUPP)
	{
		return (Boolean)CALL_FOUR_PARAMETER_UPP(userUPP, uppMCActionFilterWithRefConProcInfo, mc, action, params,
												refCon);
	}
#else
#define InvokeMCActionFilterWithRefConUPP(mc, action, params, refCon, userUPP) \
	(Boolean)                                                                  \
		CALL_FOUR_PARAMETER_UPP((userUPP), uppMCActionFilterWithRefConProcInfo, (mc), (action), (params), (refCon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(Boolean)
	InvokeMCActionNotificationUPP(MovieController mc, short action, void *params, UInt32 inFlags, UInt32 *outFlags,
								  void *refCon, MCActionNotificationUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(Boolean)
		InvokeMCActionNotificationUPP(MovieController mc, short action, void *params, UInt32 inFlags, UInt32 *outFlags,
									  void *refCon, MCActionNotificationUPP userUPP)
	{
		return (Boolean)CALL_SIX_PARAMETER_UPP(userUPP, uppMCActionNotificationProcInfo, mc, action, params, inFlags,
											   outFlags, refCon);
	}
#else
#define InvokeMCActionNotificationUPP(mc, action, params, inFlags, outFlags, refCon, userUPP)                         \
	(Boolean) CALL_SIX_PARAMETER_UPP((userUPP), uppMCActionNotificationProcInfo, (mc), (action), (params), (inFlags), \
									 (outFlags), (refCon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(void)
	InvokeQTMoviePropertyListenerUPP(Movie inMovie, QTPropertyClass inPropClass, QTPropertyID inPropID,
									 void *inUserData, QTMoviePropertyListenerUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void)
		InvokeQTMoviePropertyListenerUPP(Movie inMovie, QTPropertyClass inPropClass, QTPropertyID inPropID,
										 void *inUserData, QTMoviePropertyListenerUPP userUPP)
	{
		CALL_FOUR_PARAMETER_UPP(userUPP, uppQTMoviePropertyListenerProcInfo, inMovie, inPropClass, inPropID,
								inUserData);
	}
#else
#define InvokeQTMoviePropertyListenerUPP(inMovie, inPropClass, inPropID, inUserData, userUPP)                    \
	CALL_FOUR_PARAMETER_UPP((userUPP), uppQTMoviePropertyListenerProcInfo, (inMovie), (inPropClass), (inPropID), \
							(inUserData))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(void)
	InvokeQTTrackPropertyListenerUPP(Track inTrack, QTPropertyClass inPropClass, QTPropertyID inPropID,
									 void *inUserData, QTTrackPropertyListenerUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void)
		InvokeQTTrackPropertyListenerUPP(Track inTrack, QTPropertyClass inPropClass, QTPropertyID inPropID,
										 void *inUserData, QTTrackPropertyListenerUPP userUPP)
	{
		CALL_FOUR_PARAMETER_UPP(userUPP, uppQTTrackPropertyListenerProcInfo, inTrack, inPropClass, inPropID,
								inUserData);
	}
#else
#define InvokeQTTrackPropertyListenerUPP(inTrack, inPropClass, inPropID, inUserData, userUPP)                    \
	CALL_FOUR_PARAMETER_UPP((userUPP), uppQTTrackPropertyListenerProcInfo, (inTrack), (inPropClass), (inPropID), \
							(inUserData))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeQTBandwidthNotificationUPP(long flags, void *reserved, void *refcon, QTBandwidthNotificationUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSErr)
		InvokeQTBandwidthNotificationUPP(long flags, void *reserved, void *refcon, QTBandwidthNotificationUPP userUPP)
...
#define InvokeQTBandwidthNotificationUPP(flags, reserved, refcon, userUPP) \
	(OSErr) CALL_THREE_PARAMETER_UPP((userUPP), uppQTBandwidthNotificationProcInfo, (flags), (reserved), (refcon))
#endif
#endif
...
#define CallMCActionNotificationProc(userRoutine, mc, action, params, inFlags, outFlags, refCon) \
	InvokeMCActionNotificationUPP(mc, action, params, inFlags, outFlags, refCon, userRoutine)
#define CallQTMoviePropertyListenerProc(userRoutine, inMovie, inPropClass, inPropID, inUserData) \
	InvokeQTMoviePropertyListenerUPP(inMovie, inPropClass, inPropID, inUserData, userRoutine)
#define CallQTTrackPropertyListenerProc(userRoutine, inTrack, inPropClass, inPropID, inUserData) \
	InvokeQTTrackPropertyListenerUPP(inTrack, inPropClass, inPropID, inUserData, userRoutine)
