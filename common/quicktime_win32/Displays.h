...
#pragma pack(2)
	...
	enum
	{
		...
		kDependentNotifyClassShowCursor =
			FOUR_CHAR_CODE('shcr'), /* When display mgr shows a hidden cursor during an unmirror */
	...
	enum
	{
		...
		kModeNotResizeBit =
			4, /* Do not use this mode to resize display (for cards that mode drives a different connector). */
	...
	*/
	...
	enum
	{
		...
		kDMNotifyRequestConnectionProbe = 0, /* Like kDMNotifyRequestDisplayProbe only not for smart displays (used in
												wake before all busses are awake) */
	...
	enum
	{
		...
		kFullDependencyNotify =
			1 /* Only sends to those who want to know about interrelated functionality (used for updating UI) */
	};
	...
	{
		kDummyDeviceID =
			0x00FF, /* This is the ID of the dummy display, used when the last "real" display is disabled.*/
	...
	enum
	{
		...
		kDefaultManufacturerFidelity =
			1000 /* I'm just picking a number for Manufacturer's panels and engines (overrides apple defaults)*/
	};
	...
	enum
	{
		...
		kDisplayGestaltForbidI2CMask = (1 << 0), /* Some displays have firmware problems if they get I2C communication.
													If this bit is set, then I2C communication is forbidden*/
	...
	*/
	...
	struct DMComponentListEntryRec
	{
		...
		ComponentDescription
			itemDescription; /* We can always construct this if we use something beyond the compontent mgr.*/

		ResType itemClass; /* Class of group to put this panel (eg geometry/color/etc for panels, brightness/contrast
							  for engines, video out/sound/etc for devices)*/
		DMFidelityType itemFidelity; /* How good is this item for the specified search?*/
		ResType itemSubClass; /* Subclass of group to put this panel.  Can use to do sub-grouping (eg volume for volume
								 panel and mute panel)*/
		Point itemSort;		  /* Set to 0 - future to sort the items in a sub group.*/

		unsigned long itemFlags;   /* Set to 0 (future expansion)*/
		ResType itemReserved;	   /* What kind of code does the itemReference point to  (right now -
									  kPanelEntryTypeComponentMgr only)*/
	...
	enum
	{
		...
		kDMModeListIncludeAllModesMask =
			(1 << 0), /* Include all timing modes not _explicitly_ excluded (see other bits)*/
		kDMModeListIncludeOfflineModesMask = (1 << 1),
		kDMModeListExcludeDriverModesMask =
			(1 << 2), /* Exclude old-style timing modes (cscGetNextResolution/kDisplayModeIDFindFirstResolution modes)*/
		kDMModeListExcludeDisplayModesMask =
			(1 << 3), /* Exclude timing modes that come from the display (always arbritrary timing modes)*/
		kDMModeListExcludeCustomModesMask =
			(1 << 4), /* Exclude custom modes that came neither from the driver or display (need a better name)*/
		kDMModeListPreferStretchedModesMask = (1 << 5), /* Prefer modes that are stretched over modes that are
														   letterboxed when setting kDisplayModeListNotPreferredBit*/
		kDMModeListPreferSafeModesMask =
			(1
			 << 6) /* Prefer modes that are safe over modes that are not when setting kDisplayModeListNotPreferredBit*/
	};
	...
	typedef CALLBACK_API(void, DMComponentListIteratorProcPtr)(void *userData, DMListIndexType itemIndex,
															   DMComponentListEntryPtr componentInfo);
	typedef CALLBACK_API(void, DMDisplayModeListIteratorProcPtr)(void *userData, DMListIndexType itemIndex,
																 DMDisplayModeListEntryPtr displaymodeInfo);
	typedef CALLBACK_API(void, DMProfileListIteratorProcPtr)(void *userData, DMListIndexType itemIndex,
															 DMProfileListEntryPtr profileInfo);
	typedef CALLBACK_API(void, DMDisplayListIteratorProcPtr)(void *userData, DMListIndexType itemIndex,
	...
	{
		return (DMNotificationUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppDMNotificationProcInfo,
													   GetCurrentArchitecture());
	}
#else
#define NewDMNotificationUPP(userRoutine) \
	(DMNotificationUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppDMNotificationProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#ifdef __cplusplus
	inline DEFINE_API_C(DMExtendedNotificationUPP)
		NewDMExtendedNotificationUPP(DMExtendedNotificationProcPtr userRoutine)
	{
		return (DMExtendedNotificationUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppDMExtendedNotificationProcInfo, GetCurrentArchitecture());
	}
#else
#define NewDMExtendedNotificationUPP(userRoutine) \
	(DMExtendedNotificationUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppDMExtendedNotificationProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#ifdef __cplusplus
	inline DEFINE_API_C(DMComponentListIteratorUPP)
		NewDMComponentListIteratorUPP(DMComponentListIteratorProcPtr userRoutine)
	{
		return (DMComponentListIteratorUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppDMComponentListIteratorProcInfo, GetCurrentArchitecture());
	}
#else
#define NewDMComponentListIteratorUPP(userRoutine) \
	(DMComponentListIteratorUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppDMComponentListIteratorProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#ifdef __cplusplus
	inline DEFINE_API_C(DMDisplayModeListIteratorUPP)
		NewDMDisplayModeListIteratorUPP(DMDisplayModeListIteratorProcPtr userRoutine)
	{
		return (DMDisplayModeListIteratorUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppDMDisplayModeListIteratorProcInfo, GetCurrentArchitecture());
	}
#else
#define NewDMDisplayModeListIteratorUPP(userRoutine) \
	(DMDisplayModeListIteratorUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppDMDisplayModeListIteratorProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (DMProfileListIteratorUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppDMProfileListIteratorProcInfo,
															  GetCurrentArchitecture());
	}
#else
#define NewDMProfileListIteratorUPP(userRoutine) \
	(DMProfileListIteratorUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppDMProfileListIteratorProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (DMDisplayListIteratorUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppDMDisplayListIteratorProcInfo,
															  GetCurrentArchitecture());
	}
#else
#define NewDMDisplayListIteratorUPP(userRoutine) \
	(DMDisplayListIteratorUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppDMDisplayListIteratorProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define InvokeDMNotificationUPP(theEvent, userUPP) \
	 ...
	 */
	EXTERN_API_C(void)
	InvokeDMExtendedNotificationUPP(void *userData, short theMessage, void *notifyData,
									DMExtendedNotificationUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void) InvokeDMExtendedNotificationUPP(void *userData, short theMessage, void *notifyData,
															  DMExtendedNotificationUPP userUPP)
	{
...
#define InvokeDMExtendedNotificationUPP(userData, theMessage, notifyData, userUPP) \
	 ...
	 */
	EXTERN_API_C(void)
	InvokeDMComponentListIteratorUPP(void *userData, DMListIndexType itemIndex, DMComponentListEntryPtr componentInfo,
	...
	inline DEFINE_API_C(void)
		InvokeDMComponentListIteratorUPP(void *userData, DMListIndexType itemIndex,
										 DMComponentListEntryPtr componentInfo, DMComponentListIteratorUPP userUPP)
	{
...
#define InvokeDMComponentListIteratorUPP(userData, itemIndex, componentInfo, userUPP) \
	...
	InvokeDMDisplayModeListIteratorUPP(void *userData, DMListIndexType itemIndex,
									   DMDisplayModeListEntryPtr displaymodeInfo, DMDisplayModeListIteratorUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void) InvokeDMDisplayModeListIteratorUPP(void *userData, DMListIndexType itemIndex,
																 DMDisplayModeListEntryPtr displaymodeInfo,
...
#define InvokeDMDisplayModeListIteratorUPP(userData, itemIndex, displaymodeInfo, userUPP)              \
	CALL_THREE_PARAMETER_UPP((userUPP), uppDMDisplayModeListIteratorProcInfo, (userData), (itemIndex), \
							 (displaymodeInfo))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(void)
	InvokeDMProfileListIteratorUPP(void *userData, DMListIndexType itemIndex, DMProfileListEntryPtr profileInfo,
...
#define InvokeDMProfileListIteratorUPP(userData, itemIndex, profileInfo, userUPP) \
	 ...
	 */
	EXTERN_API_C(void)
	InvokeDMDisplayListIteratorUPP(void *userData, DMListIndexType itemIndex, DisplayListEntryPtr displaymodeInfo,
...
#define CallDMComponentListIteratorProc(userRoutine, userData, itemIndex, componentInfo) \
	InvokeDMComponentListIteratorUPP(userData, itemIndex, componentInfo, userRoutine)
#define CallDMDisplayModeListIteratorProc(userRoutine, userData, itemIndex, displaymodeInfo) \
	InvokeDMDisplayModeListIteratorUPP(userData, itemIndex, displaymodeInfo, userRoutine)
#define CallDMProfileListIteratorProc(userRoutine, userData, itemIndex, profileInfo) \
...
#define CallDMDisplayListIteratorProc(userRoutine, userData, itemIndex, displaymodeInfo) \
	InvokeDMDisplayListIteratorUPP(userData, itemIndex, displaymodeInfo, userRoutine)
	 ...
	 */
	EXTERN_API(OSErr)
	DMDisplayGestalt(DisplayIDType theDisplayID, ResType displayGestaltSelector, UInt32 *displayGestaltResponse)
	 ...
	 */
	EXTERN_API(OSErr)
	DMUseScreenPrefs(Boolean usePrefs, Handle displayState) THREEWORDINLINE(0x303C, 0x03EC, 0xABEB);
	 ...
	 */
	EXTERN_API(OSErr)
	DMSuspendConfigure(Handle displayState, unsigned long reserved1) THREEWORDINLINE(0x303C, 0x04E9, 0xABEB);
	 ...
	 */
	EXTERN_API(OSErr)
	DMResumeConfigure(Handle displayState, unsigned long reserved1) THREEWORDINLINE(0x303C, 0x04E8, 0xABEB);
	 ...
	 */
	EXTERN_API(OSErr)
	DMSetGammaByAVID(AVIDType gammaAVID, UInt32 setGammaFlags, GammaTblHandle theGamma)
	 ...
	 */
	EXTERN_API(OSErr)
	DMGetGammaByAVID(AVIDType gammaAVID, UInt32 getGammaFlags, GammaTblHandle *theGamma)
	 ...
	 */
	EXTERN_API(OSErr)
	DMNewDisplayList(UInt32 displayListIncludeFlags, UInt32 reserved1, UInt32 reserved2, DMListIndexType *theCount,
	 ...
	 */
	EXTERN_API(OSErr)
	DMGetIndexedDisplayFromList(DMListType theDisplayList, DMListIndexType itemIndex, UInt32 reserved,
								DMDisplayListIteratorUPP listIterator, void *userData)
	 ...
	 */
	EXTERN_API(OSErr)
	DMNewProfileListByAVID(AVIDType theAVID, UInt32 reserved, DMListIndexType *profileCount, DMListType *profileList)
	 ...
	 */
	EXTERN_API(OSErr)
	DMGetIndexedProfileFromList(DMListType profileList, DMListIndexType itemIndex, UInt32 reserved,
								DMProfileListIteratorUPP listIterator, void *userData)
	 ...
	 */
	EXTERN_API(GDHandle)
	DMGetNextScreenDevice(GDHandle theDevice, Boolean activeOnly) TWOWORDINLINE(0x7001, 0xABEB);
	 ...
	 */
	EXTERN_API(OSErr)
	DMAddDisplay(GDHandle newDevice, short driver, unsigned long mode, unsigned long reserved, unsigned long displayID,
				 Component displayComponent, Handle displayState) THREEWORDINLINE(0x303C, 0x0D08, 0xABEB);
	 ...
	 */
	EXTERN_API(OSErr)
	DMMoveDisplay(GDHandle moveDevice, short x, short y, Handle displayState) THREEWORDINLINE(0x303C, 0x0609, 0xABEB);
	 ...
	 */
	EXTERN_API(OSErr)
	DMDisableDisplay(GDHandle disableDevice, Handle displayState) THREEWORDINLINE(0x303C, 0x040A, 0xABEB);
	 ...
	 */
	EXTERN_API(OSErr)
	DMEnableDisplay(GDHandle enableDevice, Handle displayState) THREEWORDINLINE(0x303C, 0x040B, 0xABEB);
	 ...
	 */
	EXTERN_API(OSErr)
	DMRemoveDisplay(GDHandle removeDevice, Handle displayState) THREEWORDINLINE(0x303C, 0x040C, 0xABEB);
	 ...
	 */
	EXTERN_API(OSErr)
	DMSetMainDisplay(GDHandle newMainDevice, Handle displayState) THREEWORDINLINE(0x303C, 0x0410, 0xABEB);
	 ...
	 */
	EXTERN_API(OSErr)
	DMSetDisplayMode(GDHandle theDevice, unsigned long mode, unsigned long *depthMode, unsigned long reserved,
	 ...
	 */
	EXTERN_API(OSErr)
	DMCheckDisplayMode(GDHandle theDevice, unsigned long mode, unsigned long depthMode, unsigned long *switchFlags,
					   unsigned long reserved, Boolean *modeOk) THREEWORDINLINE(0x303C, 0x0C12, 0xABEB);
	 ...
	 */
	EXTERN_API(OSErr)
	DMRegisterNotifyProc(DMNotificationUPP notificationProc, DMProcessInfoPtr whichPSN)
	 ...
	 */
	EXTERN_API(OSErr)
	DMRemoveNotifyProc(DMNotificationUPP notificationProc, DMProcessInfoPtr whichPSN)
	 ...
	 */
	EXTERN_API(OSErr)
	DMMirrorDevices(GDHandle gD1, GDHandle gD2, Handle displayState) THREEWORDINLINE(0x303C, 0x0619, 0xABEB);
	 ...
	 */
	EXTERN_API(OSErr)
	DMUnmirrorDevice(GDHandle gDevice, Handle displayState) THREEWORDINLINE(0x303C, 0x041A, 0xABEB);
	 ...
	 */
	EXTERN_API(OSErr)
	DMGetNextMirroredDevice(GDHandle gDevice, GDHandle *mirroredDevice) THREEWORDINLINE(0x303C, 0x041B, 0xABEB);
	 ...
	 */
	EXTERN_API(OSErr)
	DMGetDisplayIDByGDevice(GDHandle displayDevice, DisplayIDType *displayID, Boolean failToMain)
	 ...
	 */
	EXTERN_API(OSErr)
	DMGetGDeviceByDisplayID(DisplayIDType displayID, GDHandle *displayDevice, Boolean failToMain)
	 ...
	 */
	EXTERN_API(OSErr)
	DMSetDisplayComponent(GDHandle theDevice, Component displayComponent) THREEWORDINLINE(0x303C, 0x0421, 0xABEB);
	 ...
	 */
	EXTERN_API(OSErr)
	DMGetDisplayComponent(GDHandle theDevice, Component *displayComponent) THREEWORDINLINE(0x303C, 0x0422, 0xABEB);
	 ...
	 */
	EXTERN_API(OSErr)
	DMNewDisplay(GDHandle *newDevice, short driverRefNum, unsigned long mode, unsigned long reserved,
				 DisplayIDType displayID, Component displayComponent, Handle displayState)
	 ...
	 */
	EXTERN_API(OSErr)
	DMDisposeDisplay(GDHandle disposeDevice, Handle displayState) THREEWORDINLINE(0x303C, 0x0424, 0xABEB);
	 ...
	 */
	EXTERN_API(OSErr)
	DMRegisterExtendedNotifyProc(DMExtendedNotificationUPP notifyProc, void *notifyUserData,
								 unsigned short nofifyOnFlags, DMProcessInfoPtr whichPSN)
	 ...
	 */
	EXTERN_API(OSErr)
	DMRemoveExtendedNotifyProc(DMExtendedNotificationUPP notifyProc, void *notifyUserData, DMProcessInfoPtr whichPSN,
	 ...
	 */
	EXTERN_API(OSErr)
	DMNewAVPanelList(DisplayIDType displayID, ResType panelType, DMFidelityType minimumFidelity,
					 unsigned long panelListFlags, unsigned long reserved, DMListIndexType *thePanelCount,
	 ...
	 */
	EXTERN_API(OSErr)
	DMNewAVEngineList(DisplayIDType displayID, ResType engineType, DMFidelityType minimumFidelity,
					  unsigned long engineListFlags, unsigned long reserved, DMListIndexType *engineCount,
	 ...
	 */
	EXTERN_API(OSErr)
	DMNewAVDeviceList(ResType deviceType, unsigned long deviceListFlags, unsigned long reserved,
					  DMListIndexType *deviceCount, DMListType *deviceList) THREEWORDINLINE(0x303C, 0x0A29, 0xABEB);
	 ...
	 */
	EXTERN_API(OSErr)
	DMNewAVPortListByPortType(ResType subType, unsigned long portListFlags, unsigned long reserved,
							  DMListIndexType *devicePortCount, DMListType *theDevicePortList)
	 ...
	 */
	EXTERN_API(OSErr)
	DMGetIndexedComponentFromList(DMListType panelList, DMListIndexType itemIndex, unsigned long reserved,
								  DMComponentListIteratorUPP listIterator, void *userData)
	 ...
	 */
	EXTERN_API(OSErr)
	DMGetNameByAVID(AVIDType theID, unsigned long nameFlags, Str255 name) THREEWORDINLINE(0x303C, 0x062D, 0xABEB);
	 ...
	 */
	EXTERN_API(OSErr)
	DMNewAVIDByPortComponent(Component thePortComponent, ResType portKind, unsigned long reserved, AVIDType *newID)
	 ...
	 */
	EXTERN_API(OSErr)
	DMGetPortComponentByAVID(DisplayIDType thePortID, Component *thePortComponent, ComponentDescription *theDesciption,
	 ...
	 */
	EXTERN_API(OSErr)
	DMSendDependentNotification(ResType notifyType, ResType notifyClass, AVIDType displayID,
	 ...
	 */
	EXTERN_API(OSErr)
	DMSaveScreenPrefs(unsigned long reserved1, unsigned long saveFlags, unsigned long reserved2)
	 ...
	 */
	EXTERN_API(OSErr)
	DMNewAVIDByDeviceComponent(Component theDeviceComponent, ResType portKind, unsigned long reserved,
	 ...
	 */
	EXTERN_API(OSErr)
	DMNewAVPortListByDeviceAVID(AVIDType theID, DMFidelityType minimumFidelity, unsigned long portListFlags,
								unsigned long reserved, DMListIndexType *devicePortCount, DMListType *theDevicePortList)
	 ...
	 */
	EXTERN_API(OSErr)
	DMGetDeviceComponentByAVID(AVIDType theDeviceID, Component *theDeviceComponent, ComponentDescription *theDesciption,
	 ...
	 */
	EXTERN_API(OSErr)
	DMNewDisplayModeList(DisplayIDType displayID, unsigned long modeListFlags, unsigned long reserved,
						 DMListIndexType *thePanelCount, DMListType *thePanelList)
	 ...
	 */
	EXTERN_API(OSErr)
	DMGetIndexedDisplayModeFromList(DMListType panelList, DMListIndexType itemIndex, unsigned long reserved,
									DMDisplayModeListIteratorUPP listIterator, void *userData)
	 ...
	 */
	EXTERN_API(OSErr)
	DMGetGraphicInfoByAVID(AVIDType theID, PicHandle *theAVPcit, Handle *theAVIconSuite, AVLocationRec *theAVLocation)
	 ...
	 */
	EXTERN_API(OSErr)
	DMGetAVPowerState(AVIDType theID, AVPowerStatePtr getPowerState, unsigned long reserved1)
	 ...
	 */
	EXTERN_API(OSErr)
	DMSetAVPowerState(AVIDType theID, AVPowerStatePtr setPowerState, unsigned long powerFlags, Handle displayState)
	 ...
	 */
	EXTERN_API(OSErr)
	DMGetDeviceAVIDByPortAVID(AVIDType portAVID, AVIDType *deviceAVID) THREEWORDINLINE(0x303C, 0x043B, 0xABEB);
	 ...
	 */
	EXTERN_API(OSErr)
	DMGetEnableByAVID(AVIDType theAVID, Boolean *isAVIDEnabledNow, Boolean *canChangeEnableNow)
	 ...
	 */
	EXTERN_API(OSErr)
	DMSetEnableByAVID(AVIDType theAVID, Boolean doEnable, Handle displayState) THREEWORDINLINE(0x303C, 0x053D, 0xABEB);
	 ...
	 */
	EXTERN_API(OSErr)
	DMGetDisplayMode(GDHandle theDevice, VDSwitchInfoPtr switchInfo) THREEWORDINLINE(0x303C, 0x043E, 0xABEB);
	 ...
	 */
	EXTERN_API(OSErr)
	DMConfirmConfiguration(DMModalFilterUPP filterProc, UInt32 confirmFlags, UInt32 reserved, Handle displayState)
