...
#pragma pack(2)
	...
	enum
	{
		...
		kHMCFStringLocalizedContent =
			FOUR_CHAR_CODE('cfsl'), /* CFStringRef; name of a localized string. Supported by Jaguar and later.*/
	...
	/* Callback procs                                       */
	/*------------------------------------------------------------------------------------------ */
	typedef CALLBACK_API(OSStatus, HMControlContentProcPtr)(ControlRef inControl, Point inGlobalMouse,
															HMContentRequest inRequest,
															HMContentProvidedType *outContentProvided,
															HMHelpContentPtr ioHelpContent);
	typedef CALLBACK_API(OSStatus, HMWindowContentProcPtr)(WindowRef inWindow, Point inGlobalMouse,
														   HMContentRequest inRequest,
														   HMContentProvidedType *outContentProvided,
														   HMHelpContentPtr ioHelpContent);
	typedef CALLBACK_API(OSStatus, HMMenuTitleContentProcPtr)(MenuRef inMenu, HMContentRequest inRequest,
															  HMContentProvidedType *outContentProvided,
															  HMHelpContentPtr ioHelpContent);
	typedef CALLBACK_API(OSStatus, HMMenuItemContentProcPtr)(const MenuTrackingData *inTrackingData,
															 HMContentRequest inRequest,
															 HMContentProvidedType *outContentProvided,
															 HMHelpContentPtr ioHelpContent);
	...
	{
		return (HMControlContentUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppHMControlContentProcInfo,
														 GetCurrentArchitecture());
	}
#else
#define NewHMControlContentUPP(userRoutine) \
	(HMControlContentUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppHMControlContentProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (HMWindowContentUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppHMWindowContentProcInfo,
														GetCurrentArchitecture());
	}
#else
#define NewHMWindowContentUPP(userRoutine) \
	(HMWindowContentUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppHMWindowContentProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (HMMenuTitleContentUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppHMMenuTitleContentProcInfo,
														   GetCurrentArchitecture());
	}
#else
#define NewHMMenuTitleContentUPP(userRoutine) \
	(HMMenuTitleContentUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppHMMenuTitleContentProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (HMMenuItemContentUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppHMMenuItemContentProcInfo,
														  GetCurrentArchitecture());
	}
#else
#define NewHMMenuItemContentUPP(userRoutine) \
	(HMMenuItemContentUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppHMMenuItemContentProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeHMMenuItemContentUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	...
	InvokeHMControlContentUPP(ControlRef inControl, Point inGlobalMouse, HMContentRequest inRequest,
	...
	inline DEFINE_API_C(OSStatus)
		InvokeHMControlContentUPP(ControlRef inControl, Point inGlobalMouse, HMContentRequest inRequest,
								  ...
								  HMControlContentUPP userUPP)
	{
		return (OSStatus)CALL_FIVE_PARAMETER_UPP(userUPP, uppHMControlContentProcInfo, inControl, inGlobalMouse,
												 inRequest, outContentProvided, ioHelpContent);
	}
#else
#define InvokeHMControlContentUPP(inControl, inGlobalMouse, inRequest, outContentProvided, ioHelpContent, userUPP) \
	(OSStatus) CALL_FIVE_PARAMETER_UPP((userUPP), uppHMControlContentProcInfo, (inControl), (inGlobalMouse),       \
									   (inRequest), (outContentProvided), (ioHelpContent))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSStatus)
	InvokeHMWindowContentUPP(WindowRef inWindow, Point inGlobalMouse, HMContentRequest inRequest,
							 HMContentProvidedType *outContentProvided, HMHelpContentPtr ioHelpContent,
	...
	inline DEFINE_API_C(OSStatus)
		InvokeHMWindowContentUPP(WindowRef inWindow, Point inGlobalMouse, HMContentRequest inRequest,
								 ...
								 HMWindowContentUPP userUPP)
	{
		return (OSStatus)CALL_FIVE_PARAMETER_UPP(userUPP, uppHMWindowContentProcInfo, inWindow, inGlobalMouse,
												 inRequest, outContentProvided, ioHelpContent);
	}
#else
#define InvokeHMWindowContentUPP(inWindow, inGlobalMouse, inRequest, outContentProvided, ioHelpContent, userUPP) \
	(OSStatus) CALL_FIVE_PARAMETER_UPP((userUPP), uppHMWindowContentProcInfo, (inWindow), (inGlobalMouse),       \
									   (inRequest), (outContentProvided), (ioHelpContent))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSStatus)
	InvokeHMMenuTitleContentUPP(MenuRef inMenu, HMContentRequest inRequest, HMContentProvidedType *outContentProvided,
								HMHelpContentPtr ioHelpContent, HMMenuTitleContentUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSStatus)
	...
	{
		return (OSStatus)CALL_FOUR_PARAMETER_UPP(userUPP, uppHMMenuTitleContentProcInfo, inMenu, inRequest,
												 outContentProvided, ioHelpContent);
	}
#else
#define InvokeHMMenuTitleContentUPP(inMenu, inRequest, outContentProvided, ioHelpContent, userUPP)      \
	(OSStatus) CALL_FOUR_PARAMETER_UPP((userUPP), uppHMMenuTitleContentProcInfo, (inMenu), (inRequest), \
									   (outContentProvided), (ioHelpContent))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSStatus)
	InvokeHMMenuItemContentUPP(const MenuTrackingData *inTrackingData, HMContentRequest inRequest,
							   HMContentProvidedType *outContentProvided, HMHelpContentPtr ioHelpContent,
	...
	inline DEFINE_API_C(OSStatus)
		InvokeHMMenuItemContentUPP(const MenuTrackingData *inTrackingData, HMContentRequest inRequest,
								   ...
								   HMMenuItemContentUPP userUPP)
	{
		return (OSStatus)CALL_FOUR_PARAMETER_UPP(userUPP, uppHMMenuItemContentProcInfo, inTrackingData, inRequest,
												 outContentProvided, ioHelpContent);
	}
#else
#define InvokeHMMenuItemContentUPP(inTrackingData, inRequest, outContentProvided, ioHelpContent, userUPP)      \
	(OSStatus) CALL_FOUR_PARAMETER_UPP((userUPP), uppHMMenuItemContentProcInfo, (inTrackingData), (inRequest), \
									   (outContentProvided), (ioHelpContent))
#endif
#endif
...
#define CallHMControlContentProc(userRoutine, inControl, inGlobalMouse, inRequest, outContentProvided, ioHelpContent) \
	InvokeHMControlContentUPP(inControl, inGlobalMouse, inRequest, outContentProvided, ioHelpContent, userRoutine)
#define CallHMWindowContentProc(userRoutine, inWindow, inGlobalMouse, inRequest, outContentProvided, ioHelpContent) \
	InvokeHMWindowContentUPP(inWindow, inGlobalMouse, inRequest, outContentProvided, ioHelpContent, userRoutine)
#define CallHMMenuTitleContentProc(userRoutine, inMenu, inRequest, outContentProvided, ioHelpContent) \
	InvokeHMMenuTitleContentUPP(inMenu, inRequest, outContentProvided, ioHelpContent, userRoutine)
#define CallHMMenuItemContentProc(userRoutine, inTrackingData, inRequest, outContentProvided, ioHelpContent) \
	InvokeHMMenuItemContentUPP(inTrackingData, inRequest, outContentProvided, ioHelpContent, userRoutine)
	 ...
	 */
	EXTERN_API(OSStatus)
	HMGetHelpMenu(MenuRef *outHelpMenu, MenuItemIndex *outFirstCustomItemIndex); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSStatus)
	HMSetControlHelpContent(ControlRef inControl, const HMHelpContentRec *inContent);
	 ...
	 */
	EXTERN_API(OSStatus)
	HMSetMenuItemHelpContent(MenuRef inMenu, MenuItemIndex inItem, const HMHelpContentRec *inContent);
	 ...
	 */
	EXTERN_API(OSStatus)
	HMGetMenuItemHelpContent(MenuRef inMenu, MenuItemIndex inItem, HMHelpContentRec *outContent);
	 ...
	 */
	EXTERN_API(OSStatus)
	HMInstallControlContentCallback(ControlRef inControl, HMControlContentUPP inContentUPP);
	 ...
	 */
	EXTERN_API(OSStatus)
	HMInstallWindowContentCallback(WindowRef inWindow, HMWindowContentUPP inContentUPP);
	 ...
	 */
	EXTERN_API(OSStatus)
	HMInstallMenuTitleContentCallback(MenuRef inMenu, HMMenuTitleContentUPP inContentUPP);
	 ...
	 */
	EXTERN_API(OSStatus)
	HMInstallMenuItemContentCallback(MenuRef inMenu, HMMenuItemContentUPP inContentUPP);
	 ...
	 */
	EXTERN_API(OSStatus)
	HMGetControlContentCallback(ControlRef inControl, HMControlContentUPP *outContentUPP);
	 ...
	 */
	EXTERN_API(OSStatus)
	HMGetWindowContentCallback(WindowRef inWindow, HMWindowContentUPP *outContentUPP);
	 ...
	 */
	EXTERN_API(OSStatus)
	HMGetMenuTitleContentCallback(MenuRef inMenu, HMMenuTitleContentUPP *outContentUPP);
	 ...
	 */
	EXTERN_API(OSStatus)
	HMGetMenuItemContentCallback(MenuRef inMenu, HMMenuItemContentUPP *outContentUPP);
	 ...
	 */
	EXTERN_API(OSStatus)
	HMSetDialogHelpFromBalloonRsrc(DialogRef inDialog, SInt16 inHdlgRsrcID, SInt16 inItemStart);
