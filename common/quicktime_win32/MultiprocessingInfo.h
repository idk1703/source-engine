...
/* The page size in bytes.*/
	...
	*/
	 ...
	 */
	EXTERN_API_C(OSStatus)
	MPGetNextAddressSpaceID(MPProcessID owningProcessID, MPAddressSpaceID *addressSpaceID);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	MPGetNextCriticalRegionID(MPProcessID owningProcessID, MPCriticalRegionID *criticalRegionID);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	MPGetNextNotificationID(MPProcessID owningProcessID, MPNotificationID *notificationID);
	...
	*/
	 ...
	 */
	EXTERN_API_C(OSStatus)
	MPGetSemaphoreInfo(MPSemaphoreID id, PBVersion version, MPSemaphoreInfo *info_o);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	MPGetCriticalRegionInfo(MPCriticalRegionID id, PBVersion version, MPCriticalRegionInfo *info_o);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	MPGetNotificationInfo(MPNotificationID id, PBVersion version, MPNotificationInfo *info_o);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	MPGetAddressSpaceInfo(MPAddressSpaceID id, PBVersion version, MPAddressSpaceInfo *info_o);
