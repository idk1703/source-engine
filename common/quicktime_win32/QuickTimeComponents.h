...
#define GetClockTime(aClock, out) ClockGetTime(aClock, out)
	...
	ClockGetTime(ComponentInstance aClock, TimeRecord *out) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0001, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	ClockCallMeWhen(ComponentInstance aClock, QTCallBack cb, long param1, long param2, long param3)
	 ...
	 */
	EXTERN_API(ComponentResult)
	ClockCancelCallBack(ComponentInstance aClock, QTCallBack cb) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0005, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	ClockRateChanged(ComponentInstance aClock, QTCallBack cb) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0006, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	ClockTimeChanged(ComponentInstance aClock, QTCallBack cb) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0007, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	ClockSetTimeBase(ComponentInstance aClock, TimeBase tb) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0008, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	ClockStartStopChanged(ComponentInstance aClock, QTCallBack cb, Boolean startChanged, Boolean stopChanged)
	 ...
	 */
	EXTERN_API(ComponentResult)
	ClockGetRate(ComponentInstance aClock, Fixed *rate) FIVEWORDINLINE(0x2F3C, 0x0004, 0x000A, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	ClockGetTimesForRateChange(ComponentInstance aClock, Fixed fromRate, Fixed toRate, TimeRecord *currentTime,
							   TimeRecord *preferredTime, TimeRecord *safeIncrementForPreferredTime)
		FIVEWORDINLINE(0x2F3C, 0x0014, 0x000B, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	ClockGetRateChangeConstraints(ComponentInstance aClock, TimeRecord *minimumDelay, TimeRecord *maximumDelay)
	...
	*/
	...
	typedef CALLBACK_API(Boolean, SCModalFilterProcPtr)(DialogRef theDialog, EventRecord *theEvent, short *itemHit,
														long refcon);
	...
	{
		kQTSettingsVideo =
			FOUR_CHAR_CODE('vide'), /* Container for video/image compression related atoms (Get/SetInfo selectors)*/
		kQTSettingsSound =
			FOUR_CHAR_CODE('soun'), /* Container for sound compression related atoms (Get/SetInfo selectors)*/
		kQTSettingsComponentVersion =
			FOUR_CHAR_CODE('vers') /* . Version of component that wrote settings (QTSettingsVersionAtomRecord)*/
	};
	...
	enum
	{
		 ...
		 */
		scVideoMultiPassEncodingSettingsType =
			FOUR_CHAR_CODE('mpes') /* pointer to SCVideoMultiPassEncodingSettings struct*/
	};
	...
	*/
	...
	enum
	{
		 ...
		 */
		kQTSCAudioPropertyID_ClientRestrictedCompressionFormatList =
			FOUR_CHAR_CODE('crf#'), /* C-style array of OSType's, Read/Write/Listen*/
		...
		kQTSCAudioPropertyID_AvailableCompressionFormatList =
			FOUR_CHAR_CODE('acf#'), /* C-style array of OSType's, Read/Listen */
		 ...
		 */
		kQTSCAudioPropertyID_AvailableCompressionFormatNamesList =
			FOUR_CHAR_CODE('cnm#'), /* CFArrayRef of CFStringRef's, Read/Write */
		...
		kQTSCAudioPropertyID_ClientRestrictedSampleRateList =
			FOUR_CHAR_CODE('crr#'), /* C-style array of AudioValueRange's, Read/Write/Listen */
		...
		kQTSCAudioPropertyID_AvailableSampleRateList =
			FOUR_CHAR_CODE('avr#'), /* C-style array of AudioValueRange's, Read/Listen*/
		...
		kQTSCAudioPropertyID_ApplicableSampleRateList =
			FOUR_CHAR_CODE('apr#'), /* C-style array of AudioValueRanges, Read/Listen*/
		 ...
		 */
		kQTSCAudioPropertyID_ClientRestrictedLPCMBitsPerChannelList =
			FOUR_CHAR_CODE('crb#'), /* C-style array of UInt32's, Read/Write/Listen */
		...
		kQTSCAudioPropertyID_AvailableLPCMBitsPerChannelList =
			FOUR_CHAR_CODE('avb#'), /* C-style array of UInt32's, Read/Listen */
		...
		kQTSCAudioPropertyID_ApplicableLPCMBitsPerChannelList =
			FOUR_CHAR_CODE('apb#'), /* C-style array of UInt32's, Read/Listen*/
		...
		kQTSCAudioPropertyID_InputChannelLayout =
			FOUR_CHAR_CODE('icly'), /* AudioChannelLayout (variable-size), Read/Write/Listen */
		...
		kQTSCAudioPropertyID_ChannelLayout =
			FOUR_CHAR_CODE('clay'), /* AudioChannelLayout (variable-size), Read/Write/Listen */
		 ...
		 */
		kQTSCAudioPropertyID_ClientRestrictedChannelLayoutTagList =
			FOUR_CHAR_CODE('crl#'), /* C-style array of AudioChannelLayoutTag's, Read/Write*/
		...
		kQTSCAudioPropertyID_AvailableChannelLayoutTagList =
			FOUR_CHAR_CODE('avl#'), /* C-style array of AudioChannelLayoutTag's, Read/Listen */
		...
		kQTSCAudioPropertyID_ApplicableChannelLayoutTagList =
			FOUR_CHAR_CODE('apl#'), /* C-style array of AudioChannelLayoutTag's, Read/Listen*/
		...
		kQTSCAudioPropertyID_ClientRestrictedLPCMFlags =
			FOUR_CHAR_CODE('crlp'), /* SCAudioFormatFlagsRestrictions (see below), Read/Write/Listen */
		...
		kQTSCAudioPropertyID_InputBasicDescription =
			FOUR_CHAR_CODE('isbd'), /* AudioStreamBasicDescription, Read/Write/Listen/DataProc */
		...
		kQTSCAudioPropertyID_BasicDescription =
			FOUR_CHAR_CODE('osbd'), /* AudioStreamBasicDescription, Read/Write/Listen/DataProc */
	...
	*/
	 ...
	 */
	typedef CALLBACK_API_C(ComponentResult,
						   SCAudioInputDataProc)(ComponentInstance ci, UInt32 *ioNumberDataPackets,
	 ...
	 */
	EXTERN_API(ComponentResult)
	SCAudioFillBuffer(ComponentInstance ci, SCAudioInputDataProc inInputDataProc, void *inInputDataProcRefCon,
					  UInt32 *ioOutputDataPacketSize, AudioBufferList *outOutputData,
					  AudioStreamPacketDescription *outPacketDescription)
		FIVEWORDINLINE(0x2F3C, 0x0014, 0x0082, 0x7000, 0xA82A);
...
#define SCGetCompression(ci, params, where) SCGetCompressionExtended(ci, params, where, 0, 0, 0, 0)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SCGetCompressionExtended(ComponentInstance ci, SCParams *params, Point where, SCModalFilterUPP filterProc,
							 SCModalHookUPP hookProc, long refcon, StringPtr customName)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SCPositionRect(ComponentInstance ci, Rect *rp, Point *where) FIVEWORDINLINE(0x2F3C, 0x0008, 0x0002, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SCGetBestDeviceRect(ComponentInstance ci, Rect *r) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0007, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SCCompressImage(ComponentInstance ci, PixMapHandle src, const Rect *srcRect, ImageDescriptionHandle *desc,
	 ...
	 */
	EXTERN_API(ComponentResult)
	SCCompressSequenceBegin(ComponentInstance ci, PixMapHandle src, const Rect *srcRect, ImageDescriptionHandle *desc)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SCCompressSequenceFrame(ComponentInstance ci, PixMapHandle src, const Rect *srcRect, Handle *data, long *dataSize,
	 ...
	 */
	EXTERN_API(ComponentResult)
	SCGetInfo(ComponentInstance ci, OSType infoType, void *info) FIVEWORDINLINE(0x2F3C, 0x0008, 0x0015, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SCSetInfo(ComponentInstance ci, OSType infoType, void *info) FIVEWORDINLINE(0x2F3C, 0x0008, 0x0016, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SCSetCompressFlags(ComponentInstance ci, long flags) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0018, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SCGetCompressFlags(ComponentInstance ci, long *flags) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0019, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SCGetSettingsAsText(ComponentInstance ci, Handle *text) FIVEWORDINLINE(0x2F3C, 0x0004, 0x001A, 0x7000, 0xA82A);
	...
	/* Note: if you're using SCCompressSequenceFrameAsync with a scForceKeyValue setting, you must call SCAsyncIdle
	 * occasionally at main task time. */
	/*
	 ...
	 */
	EXTERN_API(ComponentResult)
	SCCompressSequenceFrameAsync(ComponentInstance ci, PixMapHandle src, const Rect *srcRect, Handle *data,
								 long *dataSize, short *notSyncFlag, ICMCompletionProcRecordPtr asyncCompletionProc)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SCCopyCompressionSessionOptions(ComponentInstance ci, ICMCompressionSessionOptionsRef *outOptions)
	 ...
	 */
	EXTERN_API(ComponentResult)
	TweenerInitialize(TweenerComponent tc, QTAtomContainer container, QTAtom tweenAtom, QTAtom dataAtom)
	 ...
	 */
	EXTERN_API(ComponentResult)
	TweenerDoTween(TweenerComponent tc, TweenRecord *tr) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0002, 0x7000, 0xA82A);
	...
	TCGetCurrentTimeCode(MediaHandler mh, long *frameNum, TimeCodeDef *tcdef, TimeCodeRecord *tcrec, UserData *srcRefH)
	 ...
	 */
	EXTERN_API(HandlerError)
	TCGetTimeCodeAtTime(MediaHandler mh, TimeValue mediaTime, long *frameNum, TimeCodeDef *tcdef,
	 ...
	 */
	EXTERN_API(HandlerError)
	TCTimeCodeToString(MediaHandler mh, TimeCodeDef *tcdef, TimeCodeRecord *tcrec, StringPtr tcStr)
	 ...
	 */
	EXTERN_API(HandlerError)
	TCTimeCodeToFrameNumber(MediaHandler mh, TimeCodeDef *tcdef, TimeCodeRecord *tcrec, long *frameNumber)
	 ...
	 */
	EXTERN_API(HandlerError)
	TCFrameNumberToTimeCode(MediaHandler mh, long frameNumber, TimeCodeDef *tcdef, TimeCodeRecord *tcrec)
	 ...
	 */
	EXTERN_API(HandlerError)
	TCGetTimeCodeFlags(MediaHandler mh, long *flags) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0109, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(HandlerError)
	TCGetCurrentFrameAndTimeCodeDef(MediaHandler mh, SInt64 *outFrameNum, TimeCodeDef *outTCDef)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x010C, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(HandlerError)
	TCGetFrameAndTimeCodeDefAtTime(MediaHandler mh, const TimeValue64 *mediaTime, SInt64 *outFrameNum,
	 ...
	 */
	EXTERN_API(HandlerError)
	TCTimeCodeTimeToString(MediaHandler mh, const TimeCodeDef *tCDef, const SMPTETime *tCTime, CFStringRef *outTCStr)
		FIVEWORDINLINE(0x2F3C, 0x000C, 0x010E, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(HandlerError)
	TCTimeCodeCounterToString(MediaHandler mh, const TimeCodeDef *tCDef, const TimeCode64Counter *tCCounter,
	 ...
	 */
	EXTERN_API(HandlerError)
	TCTimeCodeTimeToFrameNumber(MediaHandler mh, const TimeCodeDef *tCDef, const SMPTETime *tCTime, SInt64 *outFrameNum)
	 ...
	 */
	EXTERN_API(HandlerError)
	TCTimeCodeCounterToFrameNumber(MediaHandler mh, const TimeCodeDef *tCDef, const TimeCode64Counter *tCCounter,
	 ...
	 */
	EXTERN_API(HandlerError)
	TCFrameNumberToTimeCodeTime(MediaHandler mh, const SInt64 *frameNumber, const TimeCodeDef *tCDef,
	 ...
	 */
	EXTERN_API(HandlerError)
	TCFrameNumberToTimeCodeCounter(MediaHandler mh, const SInt64 *frameNumber, const TimeCodeDef *tCDef,
	...
	enum
	{
		...
		kQTMediaFileInfoHasChanged =
			(1L << 2),						  /* the file extension(s) is(are) new or has changed since the last time*/
		...
		kQTMediaConfigAssociateByDefault =
			(1L << 27), /* Deprecated, use kQTMediaConfigTakeFileAssociationByDefault instead*/
		...
		kQTMediaConfigDefaultsShift =
			12, /* ((flags & kQTMediaConfigDefaultsMask) >> kQTMediaConfigDefaultsShift) to get default setting */
	...
	enum
	{
		...
		kQTSettingsGraphicsFileImportSequence =
			FOUR_CHAR_CODE('sequ'), /* Parent atom of graphic file movie import component*/
		kQTSettingsGraphicsFileImportSequenceEnabled =
			FOUR_CHAR_CODE('enab'), /* . If true, import numbered image sequence (Boolean)*/
		...
		kQTSettingsDVExportDVFormat =
			FOUR_CHAR_CODE('dvcf'),					   /* Exported DV Format, DV('dv  ') or DVCPRO('dvp '). (OSType)*/
		kQTSettingsVideoSize = FOUR_CHAR_CODE('isiz'), /* Video size related container*/
		kQTSettingsImageWidth =
			FOUR_CHAR_CODE('iwdt'), /* . Destination width. If this is zero, it means the source width. (SInt32)*/
		kQTSettingsImageHeight =
			FOUR_CHAR_CODE('ihgt'), /* . Destination height. If this is zero, it means the source height. (SInt32)*/
		kQTSettingsCleanAperture = FOUR_CHAR_CODE(
			'clap'), /* . Clean aperture for compression sessions. If this is all zeros, it means no clean aperture
						(i.e. full width and height). (CleanApertureImageDescriptionExtension)*/
		kQTSettingsPixelAspectRatio =
			FOUR_CHAR_CODE('pasp'), /* . Pixel aspect ratio for compression sessions. If this is all zeros, it means
									   square pixels (i.e. 1:1). (PixelAspectRatioImageDescriptionExtension)*/
		kQTSettingsScalingMode =
			FOUR_CHAR_CODE('scam'), /* . Scaling mode for compression sessions. If this is zero, it means scaling mode
									   based on the source aperture mode. (OSType)*/
		kQTSettingsUseCodecEnforcedDimensions = FOUR_CHAR_CODE(
			'uenf'), /* . If true, compressor's enforced dimension overrides the image size settings. (Boolean)*/
		kQTSettingsDeinterlaceSource =
			FOUR_CHAR_CODE('dint') /* . If true, deinterlacing is applied to source frames. (Boolean)*/
	};
	...
	typedef CALLBACK_API(OSErr, MovieExportGetPropertyProcPtr)(void *refcon, long trackID, OSType propertyType,
															   void *propertyValue);
	typedef CALLBACK_API(OSErr, MovieExportStageReachedCallbackProcPtr)(OSType inStage, Movie inMovie,
																		ComponentInstance inDataHandler,
																		Handle inDataRef, OSType inDataRefType,
																		void *refCon);
	enum
	{
	...
	{
		return (SCModalFilterUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppSCModalFilterProcInfo,
...
#define NewSCModalFilterUPP(userRoutine) \
	...
	{
		return (SCModalHookUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppSCModalHookProcInfo,
													GetCurrentArchitecture());
	}
#else
#define NewSCModalHookUPP(userRoutine) \
	...
	{
		return (MovieExportGetDataUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppMovieExportGetDataProcInfo,
														   GetCurrentArchitecture());
	}
#else
#define NewMovieExportGetDataUPP(userRoutine) \
	(MovieExportGetDataUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppMovieExportGetDataProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#ifdef __cplusplus
	inline DEFINE_API_C(MovieExportGetPropertyUPP)
		NewMovieExportGetPropertyUPP(MovieExportGetPropertyProcPtr userRoutine)
	{
...
#define NewMovieExportGetPropertyUPP(userRoutine) \
	(MovieExportGetPropertyUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppMovieExportGetPropertyProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	enum
	{
		uppMovieExportStageReachedCallbackProcInfo = 0x0003FFE0
	}; /* pascal 2_bytes Func(4_bytes, 4_bytes, 4_bytes, 4_bytes, 4_bytes, 4_bytes) */
#ifdef __cplusplus
	inline DEFINE_API_C(MovieExportStageReachedCallbackUPP)
		NewMovieExportStageReachedCallbackUPP(MovieExportStageReachedCallbackProcPtr userRoutine)
	{
		return (MovieExportStageReachedCallbackUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppMovieExportStageReachedCallbackProcInfo, GetCurrentArchitecture());
	}
#else
#define NewMovieExportStageReachedCallbackUPP(userRoutine)     \
	(MovieExportStageReachedCallbackUPP) NewRoutineDescriptor( \
		(ProcPtr)(userRoutine), uppMovieExportStageReachedCallbackProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeMovieExportStageReachedCallbackUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	...
	InvokeSCModalFilterUPP(DialogRef theDialog, EventRecord *theEvent, short *itemHit, long refcon,
						   SCModalFilterUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(Boolean) InvokeSCModalFilterUPP(DialogRef theDialog, EventRecord *theEvent, short *itemHit,
														long refcon, SCModalFilterUPP userUPP)
	{
		return (Boolean)CALL_FOUR_PARAMETER_UPP(userUPP, uppSCModalFilterProcInfo, theDialog, theEvent, itemHit,
												refcon);
	}
#else
#define InvokeSCModalFilterUPP(theDialog, theEvent, itemHit, refcon, userUPP) \
	(Boolean) CALL_FOUR_PARAMETER_UPP((userUPP), uppSCModalFilterProcInfo, (theDialog), (theEvent), (itemHit), (refcon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(short)
	InvokeSCModalHookUPP(DialogRef theDialog, short itemHit, void *params, long refcon, SCModalHookUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(short)
		InvokeSCModalHookUPP(DialogRef theDialog, short itemHit, void *params, long refcon, SCModalHookUPP userUPP)
	{
...
#define InvokeSCModalHookUPP(theDialog, itemHit, params, refcon, userUPP) \
	(short)CALL_FOUR_PARAMETER_UPP((userUPP), uppSCModalHookProcInfo, (theDialog), (itemHit), (params), (refcon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeMovieExportGetDataUPP(void *refCon, MovieExportGetDataParams *params, MovieExportGetDataUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSErr)
		InvokeMovieExportGetDataUPP(void *refCon, MovieExportGetDataParams *params, MovieExportGetDataUPP userUPP)
	{
...
#define InvokeMovieExportGetDataUPP(refCon, params, userUPP) \
	(OSErr) CALL_TWO_PARAMETER_UPP((userUPP), uppMovieExportGetDataProcInfo, (refCon), (params))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeMovieExportGetPropertyUPP(void *refcon, long trackID, OSType propertyType, void *propertyValue,
									MovieExportGetPropertyUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSErr) InvokeMovieExportGetPropertyUPP(void *refcon, long trackID, OSType propertyType,
															   void *propertyValue, MovieExportGetPropertyUPP userUPP)
	{
		return (OSErr)CALL_FOUR_PARAMETER_UPP(userUPP, uppMovieExportGetPropertyProcInfo, refcon, trackID, propertyType,
											  propertyValue);
	}
#else
#define InvokeMovieExportGetPropertyUPP(refcon, trackID, propertyType, propertyValue, userUPP)                         \
	(OSErr) CALL_FOUR_PARAMETER_UPP((userUPP), uppMovieExportGetPropertyProcInfo, (refcon), (trackID), (propertyType), \
									(propertyValue))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeMovieExportStageReachedCallbackUPP(OSType inStage, Movie inMovie, ComponentInstance inDataHandler,
											 Handle inDataRef, OSType inDataRefType, void *refCon,
	...
	inline DEFINE_API_C(OSErr)
		InvokeMovieExportStageReachedCallbackUPP(OSType inStage, Movie inMovie, ComponentInstance inDataHandler,
												 ...
												 MovieExportStageReachedCallbackUPP userUPP)
	{
		return (OSErr)CALL_SIX_PARAMETER_UPP(userUPP, uppMovieExportStageReachedCallbackProcInfo, inStage, inMovie,
											 inDataHandler, inDataRef, inDataRefType, refCon);
	}
#else
#define InvokeMovieExportStageReachedCallbackUPP(inStage, inMovie, inDataHandler, inDataRef, inDataRefType, refCon, \
												 userUPP)                                                           \
	(OSErr) CALL_SIX_PARAMETER_UPP((userUPP), uppMovieExportStageReachedCallbackProcInfo, (inStage), (inMovie),     \
								   (inDataHandler), (inDataRef), (inDataRefType), (refCon))
#endif
#endif
...
#define CallMovieExportGetPropertyProc(userRoutine, refcon, trackID, propertyType, propertyValue) \
	InvokeMovieExportGetPropertyUPP(refcon, trackID, propertyType, propertyValue, userRoutine)
#define CallMovieExportStageReachedCallbackProc(userRoutine, inStage, inMovie, inDataHandler, inDataRef,        \
												inDataRefType, refCon)                                          \
	InvokeMovieExportStageReachedCallbackUPP(inStage, inMovie, inDataHandler, inDataRef, inDataRefType, refCon, \
											 userRoutine)
#endif /* CALL_NOT_IN_CARBON */
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieImportHandle(MovieImportComponent ci, Handle dataH, Movie theMovie, Track targetTrack, Track *usedTrack,
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieImportFile(MovieImportComponent ci, const FSSpec *theFile, Movie theMovie, Track targetTrack, Track *usedTrack,
					TimeValue atTime, TimeValue *addedDuration, long inFlags, long *outFlags)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieImportSetSampleDuration(MovieImportComponent ci, TimeValue duration, TimeScale scale)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieImportSetSampleDescription(MovieImportComponent ci, SampleDescriptionHandle desc, OSType mediaType)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieImportSetProgressProc(MovieImportComponent ci, MovieProgressUPP proc, long refcon)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieImportSetAuxiliaryData(MovieImportComponent ci, Handle data, OSType handleType)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x0009, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieImportValidate(MovieImportComponent ci, const FSSpec *theFile, Handle theData, Boolean *valid)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieImportDataRef(MovieImportComponent ci, Handle dataRef, OSType dataRefType, Movie theMovie, Track targetTrack,
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieImportGetSampleDescription(MovieImportComponent ci, SampleDescriptionHandle *desc, OSType *mediaType)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieImportSetOffsetAndLimit(MovieImportComponent ci, unsigned long offset, unsigned long limit)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieImportGetSettingsAsAtomContainer(MovieImportComponent ci, QTAtomContainer *settings)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieImportSetSettingsFromAtomContainer(MovieImportComponent ci, QTAtomContainer settings)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieImportSetOffsetAndLimit64(MovieImportComponent ci, const wide *offset, const wide *limit)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieImportValidateDataRef(MovieImportComponent ci, Handle dataRef, OSType dataRefType, UInt8 *valid)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieImportSetNewMovieFlags(MovieImportComponent ci, long newMovieFlags)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x001F, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieImportGetDestinationMediaType(MovieImportComponent ci, OSType *mediaType)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieImportSetMediaDataRef(MovieImportComponent ci, Handle dataRef, OSType dataRefType)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieImportDoUserDialogDataRef(MovieImportComponent ci, Handle dataRef, OSType dataRefType, Boolean *canceled)
		FIVEWORDINLINE(0x2F3C, 0x000C, 0x0022, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieExportToHandle(MovieExportComponent ci, Handle dataH, Movie theMovie, Track onlyThisTrack, TimeValue startTime,
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieExportToFile(MovieExportComponent ci, const FSSpec *theFile, Movie theMovie, Track onlyThisTrack,
					  TimeValue startTime, TimeValue duration) FIVEWORDINLINE(0x2F3C, 0x0014, 0x0081, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieExportGetAuxiliaryData(MovieExportComponent ci, Handle dataH, OSType *handleType)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieExportSetProgressProc(MovieExportComponent ci, MovieProgressUPP proc, long refcon)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieExportSetSampleDescription(MovieExportComponent ci, SampleDescriptionHandle desc, OSType mediaType)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieExportDoUserDialog(MovieExportComponent ci, Movie theMovie, Track onlyThisTrack, TimeValue startTime,
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieExportToDataRef(MovieExportComponent ci, Handle dataRef, OSType dataRefType, Movie theMovie,
						 Track onlyThisTrack, TimeValue startTime, TimeValue duration)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieExportFromProceduresToDataRef(MovieExportComponent ci, Handle dataRef, OSType dataRefType)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieExportAddDataSource(MovieExportComponent ci, OSType trackType, TimeScale scale, long *trackID,
							 MovieExportGetPropertyUPP getPropertyProc, MovieExportGetDataUPP getDataProc, void *refCon)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieExportValidate(MovieExportComponent ci, Movie theMovie, Track onlyThisTrack, Boolean *valid)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieExportGetSettingsAsAtomContainer(MovieExportComponent ci, QTAtomContainer *settings)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieExportSetSettingsFromAtomContainer(MovieExportComponent ci, QTAtomContainer settings)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieExportSetGetMoviePropertyProc(MovieExportComponent ci, MovieExportGetPropertyUPP getPropertyProc, void *refCon)
	 ...
	 */
	EXTERN_API(ComponentResult)
	TextExportGetSettings(TextExportComponent ci, long *setting) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0103, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	TextExportSetSettings(TextExportComponent ci, long setting) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0104, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MIDIImportGetSettings(TextExportComponent ci, long *setting) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0100, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MIDIImportSetSettings(TextExportComponent ci, long setting) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0101, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieExportNewGetDataAndPropertiesProcs(MovieExportComponent ci, OSType trackType, TimeScale *scale, Movie theMovie,
	 ...
	 */
	EXTERN_API(ComponentResult)
	MovieExportDisposeGetDataAndPropertiesProcs(MovieExportComponent ci, MovieExportGetPropertyUPP getPropertyProc,
												MovieExportGetDataUPP getDataProc, void *refCon)
	...
	enum
	{
		...
		movieExportSourceApertureMode = FOUR_CHAR_CODE('srap') /* pointer to OSType. Source movie's aperture mode..Set
																  the aperture mode on the decompression session.*/
	};

	/* Component Properties specific to Movie Export components*/
	enum
	{
		kQTMovieExporterPropertyID_StageReachedCallback =
			FOUR_CHAR_CODE('stgr'), /* value is a MovieExportStageReachedCallbackProcRecord*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImageImportSetSequenceEnabled(GraphicImageMovieImportComponent ci, Boolean enable)
	 ...
	 */
	EXTERN_API(ComponentResult)
	GraphicsImageImportGetSequenceEnabled(GraphicImageMovieImportComponent ci, Boolean *enable)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x0101, 0x7000, 0xA82A);

	/*----------------------------'brws' o browser prefs configuration info ------------------------*/
	enum
	{
		kQTBrowserInfoCanUseSystemFolderPlugin =
			(1L << 0) /* Mac browser can use plug-in from System "Internet Plug-ins" folder */
	};
	...
	***************/
	 ...
	 */
	EXTERN_API(ComponentResult)
	PreviewShowData(pnotComponent p, OSType dataType, Handle data, const Rect *inHere)
		FIVEWORDINLINE(0x2F3C, 0x000C, 0x0001, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	PreviewMakePreview(pnotComponent p, OSType *previewType, Handle *previewResult, const FSSpec *sourceFile,
	 ...
	 */
	EXTERN_API(ComponentResult)
	PreviewMakePreviewReference(pnotComponent p, OSType *previewType, short *resID, const FSSpec *sourceFile)
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataCodecDecompress(DataCodecComponent dc, void *srcData, UInt32 srcSize, void *dstData, UInt32 dstBufferSize)
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataCodecGetCompressBufferSize(DataCodecComponent dc, UInt32 srcSize, UInt32 *dstSize)
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataCodecCompress(DataCodecComponent dc, void *srcData, UInt32 srcSize, void *dstData, UInt32 dstBufferSize,
					  UInt32 *actualDstSize, UInt32 *decompressSlop)
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataCodecDecompressPartial(DataCodecComponent dc, void **next_in, unsigned long *avail_in, unsigned long *total_in,
							   void **next_out, unsigned long *avail_out, unsigned long *total_out, Boolean *didFinish)
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataCodecCompressPartial(DataCodecComponent dc, void **next_in, unsigned long *avail_in, unsigned long *total_in,
							 void **next_out, unsigned long *avail_out, unsigned long *total_out, Boolean tryToFinish,
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHSetDataRef(DataHandler dh, Handle dataRef) FIVEWORDINLINE(0x2F3C, 0x0004, 0x000A, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHGetDataRef(DataHandler dh, Handle *dataRef) FIVEWORDINLINE(0x2F3C, 0x0004, 0x000B, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHScheduleData(DataHandler dh, Ptr PlaceToPutDataPtr, long FileOffset, long DataSize, long RefCon,
					  DataHSchedulePtr scheduleRec, DataHCompletionUPP CompletionRtn)
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHResolveDataRef(DataHandler dh, Handle theDataRef, Boolean *wasChanged, Boolean userInterfaceAllowed)
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHGetFileSize(DataHandler dh, long *fileSize) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0012, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHWrite(DataHandler dh, Ptr data, long offset, long size, DataHCompletionUPP completion, long refCon)
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHPreextend(DataHandler dh, unsigned long maxToAdd, unsigned long *spaceAdded)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x0016, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHSetFileSize(DataHandler dh, long fileSize) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0017, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHGetFreeSpace(DataHandler dh, unsigned long *freeSize) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0018, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHGetPreferredBlockSize(DataHandler dh, long *blockSize) FIVEWORDINLINE(0x2F3C, 0x0004, 0x001A, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHGetDeviceIndex(DataHandler dh, long *deviceIndex) FIVEWORDINLINE(0x2F3C, 0x0004, 0x001B, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHIsStreamingDataHandler(DataHandler dh, Boolean *yes) FIVEWORDINLINE(0x2F3C, 0x0004, 0x001C, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHGetScheduleAheadTime(DataHandler dh, long *millisecs) FIVEWORDINLINE(0x2F3C, 0x0004, 0x001E, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHSetCacheSizeLimit(DataHandler dh, Size cacheSizeLimit) FIVEWORDINLINE(0x2F3C, 0x0004, 0x001F, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHGetCacheSizeLimit(DataHandler dh, Size *cacheSizeLimit) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0020, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHGetMovie(DataHandler dh, Movie *theMovie, short *id) FIVEWORDINLINE(0x2F3C, 0x0008, 0x0021, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHAddMovie(DataHandler dh, Movie theMovie, short *id) FIVEWORDINLINE(0x2F3C, 0x0008, 0x0022, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHUpdateMovie(DataHandler dh, Movie theMovie, short id) FIVEWORDINLINE(0x2F3C, 0x0006, 0x0023, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHGetFileName(DataHandler dh, Str255 str) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0025, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHGetAvailableFileSize(DataHandler dh, long *fileSize) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0026, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHGetMacOSFileType(DataHandler dh, OSType *fileType) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0027, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHGetMIMEType(DataHandler dh, Str255 mimeType) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0028, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHSetDataRefWithAnchor(DataHandler dh, Handle anchorDataRef, OSType dataRefType, Handle dataRef)
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHGetDataRefWithAnchor(DataHandler dh, Handle anchorDataRef, OSType dataRefType, Handle *dataRef)
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHSetMacOSFileType(DataHandler dh, OSType fileType) FIVEWORDINLINE(0x2F3C, 0x0004, 0x002B, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHSetTimeBase(DataHandler dh, TimeBase tb) FIVEWORDINLINE(0x2F3C, 0x0004, 0x002C, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHGetInfoFlags(DataHandler dh, UInt32 *flags) FIVEWORDINLINE(0x2F3C, 0x0004, 0x002D, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHScheduleData64(DataHandler dh, Ptr PlaceToPutDataPtr, const wide *FileOffset, long DataSize, long RefCon,
						DataHSchedulePtr scheduleRec, DataHCompletionUPP CompletionRtn)
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHWrite64(DataHandler dh, Ptr data, const wide *offset, long size, DataHCompletionUPP completion, long refCon)
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHGetFileSize64(DataHandler dh, wide *fileSize) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0030, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHSetFileSize64(DataHandler dh, const wide *fileSize) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0032, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHGetFreeSpace64(DataHandler dh, wide *freeSize) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0033, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHReadAsync(DataHandler dh, void *dataPtr, UInt32 dataSize, const wide *dataOffset,
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHGetDataAvailability(DataHandler dh, long offset, long len, long *missing_offset, long *missing_len)
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHGetFileSizeAsync(DataHandler dh, wide *fileSize, DataHCompletionUPP completionRtn, long refCon)
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHGetFileTypeOrdering(DataHandler dh, DataHFileTypeOrderingHandle *orderingListHandle)
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHCreateFileWithFlags(DataHandler dh, OSType creator, Boolean deleteExisting, UInt32 flags)
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHGetMIMETypeAsync(DataHandler dh, Str255 mimeType, DataHCompletionUPP completionRtn, long refCon)
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHGetInfo(DataHandler dh, OSType what, void *info) FIVEWORDINLINE(0x2F3C, 0x0008, 0x0043, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHSetIdleManager(DataHandler dh, IdleManager im) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0044, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHSetMovieUsageFlags(DataHandler dh, long flags) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0046, 0x7000, 0xA82A);

	enum
	{
		kDataHTempUseSameDirectory =
			1L << 0, /* temp data ref should be in same directory as current data ref (vs. in temporary directory)*/
		kDataHTempUseSameVolume =
			1L << 1, /* temp data ref should be on same volume as current data ref (vs. find "best" volume)*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHUseTemporaryDataRef(DataHandler dh, long inFlags) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0047, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHGetTemporaryDataRefCapabilities(DataHandler dh, long *outUnderstoodFlags)
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHRenameFile(DataHandler dh, Handle newDataRef) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0049, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHGetAvailableFileSize64(DataHandler dh, wide *fileSize) FIVEWORDINLINE(0x2F3C, 0x0004, 0x004E, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHGetDataAvailability64(DataHandler dh, const wide *offset, long len, wide *missing_offset, long *missing_len)
		FIVEWORDINLINE(0x2F3C, 0x0010, 0x004F, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHPlaybackHints(DataHandler dh, long flags, unsigned long minFileOffset, unsigned long maxFileOffset,
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHPlaybackHints64(DataHandler dh, long flags, const wide *minFileOffset, const wide *maxFileOffset,
	...
	enum
	{
		kDataHSetTimeHintsSkipBandwidthRequest =
			1 << 0 /* set if this data handler should use the network without requesting bandwidth*/
	};
	 ...
	 */
	EXTERN_API(ComponentResult)
	DataHSetTimeHints(DataHandler dh, long flags, long bandwidthPriority, TimeScale scale, TimeValue minTime,
	...
	enum
	{
		...
		digiInSignalLock =
			1L << 31 /* digitizer detects input signal is locked, this bit = horiz lock || vertical lock */
	};
	...
	enum
	{
		...
		digiOutDoesCompressPartiallyVisible =
			1L << 30, /* digi doesn't need all bits visible on screen to do hardware compress */
		digiOutDoesNotNeedCopyOfCompressData =
			1L << 31 /* digi doesn't need any bufferization when providing compressed data */
	};
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDGetActiveSrcRect(VideoDigitizerComponent ci, short inputStd, Rect *activeSrcRect)
		FIVEWORDINLINE(0x2F3C, 0x0006, 0x0002, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDGetPlayThruDestination(VideoDigitizerComponent ci, PixMapHandle *dest, Rect *destRect, MatrixRecord *m,
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDSetInputGammaValue(VideoDigitizerComponent ci, Fixed channel1, Fixed channel2, Fixed channel3)
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDGetInputGammaValue(VideoDigitizerComponent ci, Fixed *channel1, Fixed *channel2, Fixed *channel3)
		FIVEWORDINLINE(0x2F3C, 0x000C, 0x000B, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDSetHue(VideoDigitizerComponent ci, unsigned short *hue) FIVEWORDINLINE(0x2F3C, 0x0004, 0x000F, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDGetHue(VideoDigitizerComponent ci, unsigned short *hue) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0013, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDGetCurrentFlags(VideoDigitizerComponent ci, long *inputCurrentFlag, long *outputCurrentFlag)
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDSetKeyColor(VideoDigitizerComponent ci, long index) FIVEWORDINLINE(0x2F3C, 0x0004, 0x001B, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDGetKeyColor(VideoDigitizerComponent ci, long *index) FIVEWORDINLINE(0x2F3C, 0x0004, 0x001C, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDAddKeyColor(VideoDigitizerComponent ci, long *index) FIVEWORDINLINE(0x2F3C, 0x0004, 0x001D, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDGetNextKeyColor(VideoDigitizerComponent ci, long index) FIVEWORDINLINE(0x2F3C, 0x0004, 0x001E, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDSetKeyColorRange(VideoDigitizerComponent ci, RGBColor *minRGB, RGBColor *maxRGB)
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDGetKeyColorRange(VideoDigitizerComponent ci, RGBColor *minRGB, RGBColor *maxRGB)
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDSetDigitizerUserInterrupt(VideoDigitizerComponent ci, long flags, VdigIntUPP userInterruptProc, long refcon)
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDSetClipState(VideoDigitizerComponent ci, short clipEnable) FIVEWORDINLINE(0x2F3C, 0x0002, 0x0024, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDGetMaskandValue(VideoDigitizerComponent ci, unsigned short blendLevel, long *mask, long *value)
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDSetPlayThruDestination(VideoDigitizerComponent ci, PixMapHandle dest, RectPtr destRect, MatrixRecordPtr m,
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDSetPlayThruOnOff(VideoDigitizerComponent ci, short state) FIVEWORDINLINE(0x2F3C, 0x0002, 0x002E, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDPreflightDestination(VideoDigitizerComponent ci, Rect *digitizerRect, PixMap **dest, RectPtr destRect,
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDPreflightGlobalRect(VideoDigitizerComponent ci, GrafPtr theWindow, Rect *globalRect)
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDSetPlayThruGlobalRect(VideoDigitizerComponent ci, GrafPtr theWindow, Rect *globalRect)
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDGetVideoDefaults(VideoDigitizerComponent ci, unsigned short *blackLevel, unsigned short *whiteLevel,
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDSetInput(VideoDigitizerComponent ci, short input) FIVEWORDINLINE(0x2F3C, 0x0002, 0x003E, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDGetInput(VideoDigitizerComponent ci, short *input) FIVEWORDINLINE(0x2F3C, 0x0004, 0x003F, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDDone(VideoDigitizerComponent ci, short buffer) FIVEWORDINLINE(0x2F3C, 0x0002, 0x0043, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDSetCompression(VideoDigitizerComponent ci, OSType compressType, short depth, Rect *bounds, CodecQ spatialQuality,
					 CodecQ temporalQuality, long keyFrameRate) FIVEWORDINLINE(0x2F3C, 0x0016, 0x0044, 0x7000, 0xA82A);
	...
	/*    Note that UInt8* queuedFrameCount replaces Boolean* done. 0(==false) still means no frames, and 1(==true) one,
			but if more than one are available the number should be returned here. The value 2 previously meant more
	   than one frame, so some VDIGs may return 2 even if more than 2 are available, and some will still return 1 as
	   they are using the original definition */
	/*
	 *  VDCompressDone()
	 *
	 *  Availability:
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDCompressDone(VideoDigitizerComponent ci, UInt8 *queuedFrameCount, Ptr *theData, long *dataSize, UInt8 *similarity,
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDSetTimeBase(VideoDigitizerComponent ci, TimeBase t) FIVEWORDINLINE(0x2F3C, 0x0004, 0x004C, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDGetDataRate(VideoDigitizerComponent ci, long *milliSecPerFrame, Fixed *framesPerSecond, long *bytesPerSecond)
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDGetDMADepths(VideoDigitizerComponent ci, long *depthArray, long *preferredDepth)
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDGetTimeCode(VideoDigitizerComponent ci, TimeRecord *atTime, void *timeCodeFormat, void *timeCodeTime)
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDGetSoundInputSource(VideoDigitizerComponent ci, long videoInput, long *soundInput)
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDGetCompressionTime(VideoDigitizerComponent ci, OSType compressionType, short depth, Rect *srcRect,
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDSetPreferredPacketSize(VideoDigitizerComponent ci, long preferredPacketSizeInBytes)
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDSetPreferredImageDimensions(VideoDigitizerComponent ci, long width, long height)
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDGetPreferredImageDimensions(VideoDigitizerComponent ci, long *width, long *height)
	...
	/*
		The following call is designed to give the VDIG a little more control over how it is presented to the User, to
	   clarify the distinction between Devices and Inputs. Historically, the assumption has been that there is one
	   component registered per device and the component name is displayed. This change lets a component choose its name
	   after registration. vdDeviceFlagShowInputsAsDevices is meant for components that register once and support
	   multiple devices The UI is clearer if these are presented as device rather than inputs, and this allows a VDIG to
	   present itself this way without huge restructuring vdDeviceFlagHideDevice is for the kind of VDIG that registers
	   itself, and then can register a further VDIG for each device. If no hardware is available, returning this flag
	   will omit it from the list. This call being made is also a good time to check for hardware and register further
	   VDIG components if needed, allowing for lazy initialization when the Application needs to find a VDIG rather than
	...
	*/
	...
	VDGetDeviceNameAndFlags(VideoDigitizerComponent ci, Str255 outName, UInt32 *outNameFlags)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x005E, 0x7000, 0xA82A);
	...
	enum
	{
		...
		vdFlagCaptureLowLatency =
			(1 << 4), /* Fresh frames are more important than delivering every frame - don't queue too much*/
		vdFlagCaptureAlwaysUseTimeBase =
			(1 << 5), /* Use the timebase for every frame; don't worry about making durations uniform*/
		vdFlagCaptureSetSettingsBegin = (1 << 6), /* A series of calls are about to be made to restore settings.*/
		vdFlagCaptureSetSettingsEnd =
			(1 << 7) /* Finished restoring settings; any set calls after this are from the app or UI*/
	};
	...
	VDCaptureStateChanging(VideoDigitizerComponent ci, UInt32 inStateFlags)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x005F, 0x7000, 0xA82A);
	...
	*/
	...
	VDGetUniqueIDs(VideoDigitizerComponent ci, UInt64 *outDeviceID, UInt64 *outInputID)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x0060, 0x7000, 0xA82A);
	...
	*/
	...
	VDSelectUniqueIDs(VideoDigitizerComponent ci, const UInt64 *inDeviceID, const UInt64 *inInputID)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x0061, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	VDCopyPreferredAudioDevice(ComponentInstance vdig, CFStringRef *outAudioDeviceUID)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x0063, 0x7000, 0xA82A);
	...
	*/
	...
	enum
	{
		...
		vdIIDCFeatureFocusPoint =
			FOUR_CHAR_CODE('fpnt'), /* Focus Point's settings handled by VDIIDCFocusPointSettings*/
	...
	*/
	...
	/*
		...
		Note that certain combinations of flags are valid for capabilities (i.e. vdIIDCFeatureFlagOn |
	   vdIIDCFeatureFlagOff) but are mutually exclusive for state.
	*/
	enum
	{
	...
	*/
	...
	/*
		...
		When indicating/setting state, the flag represents the current/desired state.
		Note that certain combinations of flags are valid for capabilities (i.e. vdIIDCTriggerFlagOn |
	   vdIIDCTriggerFlagOff) but are mutually exclusive for state.
	*/
	enum
	{
	...
	*/
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDIIDCGetFeatures(VideoDigitizerComponent ci, QTAtomContainer *container)
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDIIDCSetFeatures(VideoDigitizerComponent ci, QTAtomContainer container)
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDIIDCGetDefaultFeatures(VideoDigitizerComponent ci, QTAtomContainer *container)
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDIIDCGetCSRData(VideoDigitizerComponent ci, Boolean offsetFromUnitBase, UInt32 offset, UInt32 *data)
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDIIDCSetCSRData(VideoDigitizerComponent ci, Boolean offsetFromUnitBase, UInt32 offset, UInt32 data)
	 ...
	 */
	EXTERN_API(VideoDigitizerError)
	VDIIDCGetFeaturesForSpecifier(VideoDigitizerComponent ci, OSType specifier, QTAtomContainer *container)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x0205, 0x7000, 0xA82A);
	...
	enum
	{
		elementFlagAlwaysSelfContained = 1L << 0, /*    Element doesn't have contents or closing tag even if it doesn't
													 end with />, as in the HTML <img> tag*/
		elementFlagPreserveWhiteSpace = 1L << 1,  /*  Preserve whitespace in content, default is to remove it */
		xmlParseFlagAllowUppercase = 1L << 0, /*    Entities and attributes do not have to be lowercase (strict XML),
												 but can be upper or mixed case as in HTML*/
		xmlParseFlagAllowUnquotedAttributeValues =
			1L << 1, /*    Attributes values do not have to be enclosed in quotes (strict XML), but can be left unquoted
						if they contain no spaces*/
	...
	enum
	{
		...
		attributeValueKindEnum =
			1L << 5, /*    one of a number of strings; the enum strings are passed as a zero-separated,
						double-zero-terminated C string in the attributeKindValueInfo param*/
		attributeValueKindCaseSensEnum = 1L << 6, /*    one of a number of strings; the enum strings are passed as for
													 attributeValueKindEnum, but the values are case-sensitive*/
	...
	struct XMLAttribute
	{
		...
		long valueKind;			 /*    Type of parsed value, if the value was recognized and parsed; otherwise,
									attributeValueKindCharString*/
	...
	*/
	struct XMLElement
	{
		...
		XMLAttributePtr attributes; /*    Array of attributes, terminated with an attribute with identifier ==
									   xmlIdentifierInvalid*/
	...
	*/
	...
	typedef CALLBACK_API(ComponentResult, PreprocessInstructionHandler)(const char *name, const char *const atts[],
																		long refcon);
	 ...
	 */
	EXTERN_API(ComponentResult)
	XMLParseDataRef(ComponentInstance aParser, Handle dataRef, OSType dataRefType, long parseFlags, XMLDoc *document)
		FIVEWORDINLINE(0x2F3C, 0x0010, 0x0001, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	XMLParseFile(ComponentInstance aParser, ConstFSSpecPtr fileSpec, long parseFlags, XMLDoc *document)
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	XMLParseGetDetailedParseError(ComponentInstance aParser, long *errorLine, StringPtr errDesc)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x0004, 0x7000, 0xA82A);
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	XMLParseAddElement(ComponentInstance aParser, char *elementName, UInt32 nameSpaceID, UInt32 *elementID,
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	XMLParseAddAttribute(ComponentInstance aParser, UInt32 elementID, UInt32 nameSpaceID, char *attributeName,
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	XMLParseAddMultipleAttributes(ComponentInstance aParser, UInt32 elementID, UInt32 *nameSpaceIDs,
								  char *attributeNames, UInt32 *attributeIDs)
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	XMLParseAddAttributeAndValue(ComponentInstance aParser, UInt32 elementID, UInt32 nameSpaceID, char *attributeName,
								 UInt32 *attributeID, UInt32 attributeValueKind, void *attributeValueKindInfo)
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	XMLParseAddMultipleAttributesAndValues(ComponentInstance aParser, UInt32 elementID, UInt32 *nameSpaceIDs,
										   char *attributeNames, UInt32 *attributeIDs, UInt32 *attributeValueKinds,
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	XMLParseAddAttributeValueKind(ComponentInstance aParser, UInt32 elementID, UInt32 attributeID,
								  UInt32 attributeValueKind, void *attributeValueKindInfo)
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	XMLParseAddNameSpace(ComponentInstance aParser, char *nameSpaceURL, UInt32 *nameSpaceID)
	 ...
	 */
	EXTERN_API(ComponentResult)
	XMLParseSetOffsetAndLimit(ComponentInstance aParser, UInt32 offset, UInt32 limit)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x000C, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	XMLParseSetStartDocumentHandler(ComponentInstance aParser, StartDocumentHandlerUPP startDocument)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x000E, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	XMLParseSetEndDocumentHandler(ComponentInstance aParser, EndDocumentHandlerUPP endDocument)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x000F, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	XMLParseSetStartElementHandler(ComponentInstance aParser, StartElementHandlerUPP startElement)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x0010, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	XMLParseSetEndElementHandler(ComponentInstance aParser, EndElementHandlerUPP endElement)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x0011, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	XMLParseSetCharDataHandler(ComponentInstance aParser, CharDataHandlerUPP charData)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x0012, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	XMLParseSetCDataHandler(ComponentInstance aParser, CDataHandlerUPP cdata)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x0015, 0x7000, 0xA82A);
...
#define XML_ADD_ATTRIBUTE_AND_VALUE(attrName, valueKind, valueKindInfo) \
	XML_ADD_ATTRIBUTE_AND_VALUE_NS(attrName, valueKind, valueKindInfo, nameSpaceIDNone)
...
#define XML_ADD_COMPLEX_ATTRIBUTE_AND_VALUE(attrName, attrID, valueKind, valueKindInfo) \
	XML_ADD_COMPLEX_ATTRIBUTE_AND_VALUE_NS(attrName, attrID, valueKind, valueKindInfo, nameSpaceIDNone)
	...
	*/
	...
	enum
	{
		...
		seqGrabDontPreAllocateFileSize =
			512 /* Don't set the size of the file before capture unless the file has been pre-extended */
	};
	...
	enum
	{
		...
		seqGrabLowLatencyCapture = 8,  /* return the freshest frame possible, for live work (videoconferencing, live
										  broadcast, live image processing) */
		seqGrabAlwaysUseTimeBase = 16, /* Tell VDIGs to use TimebaseTime always, rather than creating uniform frame
										  durations, for more accurate live sync with audio */
		seqGrabRecordPreferQualityOverFrameRate = 32 /* quality is more important than frame rate: client rather drop
														frame instead of lower quality to achieve full frame rate */
	};
	...
	typedef CALLBACK_API(OSErr, SGDataProcPtr)(SGChannel c, Ptr p, long len, long *offset, long chRefCon,
	...
	typedef CALLBACK_API(Boolean, SGModalFilterProcPtr)(DialogRef theDialog, const EventRecord *theEvent,
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetGWorld(SeqGrabComponent s, CGrafPtr gp, GDHandle gd) FIVEWORDINLINE(0x2F3C, 0x0008, 0x0004, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetGWorld(SeqGrabComponent s, CGrafPtr *gp, GDHandle *gd) FIVEWORDINLINE(0x2F3C, 0x0008, 0x0005, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGDisposeChannel(SeqGrabComponent s, SGChannel c) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0007, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGPause(SeqGrabComponent s, Byte pause) FIVEWORDINLINE(0x2F3C, 0x0002, 0x0014, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGPrepare(SeqGrabComponent s, Boolean prepareForPreview, Boolean prepareForRecord)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x0015, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetTimeRemaining(SeqGrabComponent s, long *ticksLeft) FIVEWORDINLINE(0x2F3C, 0x0004, 0x001B, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGrabPict(SeqGrabComponent s, PicHandle *p, const Rect *bounds, short offscreenDepth, long grabPictFlags)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetLastMovieResID(SeqGrabComponent s, short *resID) FIVEWORDINLINE(0x2F3C, 0x0004, 0x001D, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetFlags(SeqGrabComponent s, long sgFlags) FIVEWORDINLINE(0x2F3C, 0x0004, 0x001E, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetFlags(SeqGrabComponent s, long *sgFlags) FIVEWORDINLINE(0x2F3C, 0x0004, 0x001F, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGNewChannelFromComponent(SeqGrabComponent s, SGChannel *newChannel, Component sgChannelComponent)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x0021, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGDisposeDeviceList(SeqGrabComponent s, SGDeviceList list) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0022, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetSettings(SeqGrabComponent s, UserData ud, long flags) FIVEWORDINLINE(0x2F3C, 0x0008, 0x0024, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetSettings(SeqGrabComponent s, UserData *ud, long flags) FIVEWORDINLINE(0x2F3C, 0x0008, 0x0025, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetIndChannel(SeqGrabComponent s, short index, SGChannel *ref, OSType *chanType)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGUpdate(SeqGrabComponent s, RgnHandle updateRgn) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0027, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetPause(SeqGrabComponent s, Byte *paused) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0028, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSettingsDialog(SeqGrabComponent s, SGChannel c, short numPanels, ConstComponentListPtr panelList, long flags,
					 SGModalFilterUPP proc, long procRefNum) FIVEWORDINLINE(0x2F3C, 0x0016, 0x0029, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetDataRef(SeqGrabComponent s, Handle dataRef, OSType dataRefType, long whereFlags)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetDataRef(SeqGrabComponent s, Handle *dataRef, OSType *dataRefType, long *whereFlags)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGNewOutput(SeqGrabComponent s, Handle dataRef, OSType dataRefType, long whereFlags, SGOutput *sgOut)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGDisposeOutput(SeqGrabComponent s, SGOutput sgOut) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0031, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetDataOutputStorageSpaceRemaining(SeqGrabComponent s, SGOutput sgOut, unsigned long *space)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x0034, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGHandleUpdateEvent(SeqGrabComponent s, const EventRecord *event, Boolean *handled)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetOutputMaximumOffset(SeqGrabComponent s, SGOutput sgOut, const wide *maxOffset)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetOutputDataReference(SeqGrabComponent s, SGOutput sgOut, Handle *dataRef, OSType *dataRefType)
		FIVEWORDINLINE(0x2F3C, 0x000C, 0x003A, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGWriteExtendedMovieData(SeqGrabComponent s, SGChannel c, Ptr p, long len, wide *offset, SGOutput *sgOut)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetDataOutputStorageSpaceRemaining64(SeqGrabComponent s, SGOutput sgOut, wide *space)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x003D, 0x7000, 0xA82A);
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetNextFrameReference(SeqGrabComponent s, SeqGrabFrameInfoPtr frameInfo, TimeValue *frameDuration,
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetTimeBase(SeqGrabComponent s, TimeBase *tb) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0103, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSortDeviceList(SeqGrabComponent s, SGDeviceList list) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0104, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGAddMovieData(SeqGrabComponent s, SGChannel c, Ptr p, long len, long *offset, long chRefCon, TimeValue time,
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGChangedSource(SeqGrabComponent s, SGChannel c) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0106, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGAddExtendedFrameReference(SeqGrabComponent s, SeqGrabExtendedFrameInfoPtr frameInfo)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetNextExtendedFrameReference(SeqGrabComponent s, SeqGrabExtendedFrameInfoPtr frameInfo, TimeValue *frameDuration,
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGAddExtendedMovieData(SeqGrabComponent s, SGChannel c, Ptr p, long len, wide *offset, long chRefCon,
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGAddOutputDataRefToMedia(SeqGrabComponent s, SGOutput sgOut, Media theMedia, SampleDescriptionHandle desc)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetSettingsSummary(SeqGrabComponent s, Handle summaryText) FIVEWORDINLINE(0x2F3C, 0x0004, 0x010B, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetChannelUsage(SGChannel c, long usage) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0080, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetChannelUsage(SGChannel c, long *usage) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0081, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetChannelBounds(SGChannel c, const Rect *bounds) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0082, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetChannelBounds(SGChannel c, Rect *bounds) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0083, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetChannelVolume(SGChannel c, short volume) FIVEWORDINLINE(0x2F3C, 0x0002, 0x0084, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetChannelVolume(SGChannel c, short *volume) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0085, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetChannelInfo(SGChannel c, long *channelInfo) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0086, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetChannelPlayFlags(SGChannel c, long playFlags) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0087, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetChannelPlayFlags(SGChannel c, long *playFlags) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0088, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetChannelMaxFrames(SGChannel c, long frameCount) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0089, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetChannelMaxFrames(SGChannel c, long *frameCount) FIVEWORDINLINE(0x2F3C, 0x0004, 0x008A, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetChannelRefCon(SGChannel c, long refCon) FIVEWORDINLINE(0x2F3C, 0x0004, 0x008B, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetChannelClip(SGChannel c, RgnHandle theClip) FIVEWORDINLINE(0x2F3C, 0x0004, 0x008C, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetChannelClip(SGChannel c, RgnHandle *theClip) FIVEWORDINLINE(0x2F3C, 0x0004, 0x008D, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetChannelDevice(SGChannel c, StringPtr name) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0090, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetChannelMatrix(SGChannel c, const MatrixRecord *m) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0091, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetChannelMatrix(SGChannel c, MatrixRecord *m) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0092, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetChannelTimeScale(SGChannel c, TimeScale *scale) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0093, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGChannelSetDataSourceName(SGChannel c, ConstStr255Param name, ScriptCode scriptTag)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGChannelSetCodecSettings(SGChannel c, Handle settings) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0099, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGChannelGetCodecSettings(SGChannel c, Handle *settings) FIVEWORDINLINE(0x2F3C, 0x0004, 0x009A, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetChannelTimeBase(SGChannel c, TimeBase *tb) FIVEWORDINLINE(0x2F3C, 0x0004, 0x009B, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetChannelRefCon(SGChannel c, long *refCon) FIVEWORDINLINE(0x2F3C, 0x0004, 0x009C, 0x7000, 0xA82A);

	/* A utility call to find out the current device and input names, instead of having to call GetDeviceList and walk
	 * it yourself */
	/*
	...
	SGGetChannelDeviceAndInputNames(SGChannel c, Str255 outDeviceName, Str255 outInputName, short *outInputNumber)
		FIVEWORDINLINE(0x2F3C, 0x000C, 0x009D, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetChannelDeviceInput(SGChannel c, short inInputNumber) FIVEWORDINLINE(0x2F3C, 0x0002, 0x009E, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetChannelSettingsStateChanging(SGChannel c, UInt32 inFlags)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x009F, 0x7000, 0xA82A);
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGInitChannel(SGChannel c, SeqGrabComponent owner) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0180, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGWriteSamples(SGChannel c, Movie m, AliasHandle theFile) FIVEWORDINLINE(0x2F3C, 0x0008, 0x0181, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetDataRate(SGChannel c, long *bytesPerSecond) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0182, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGAlignChannelRect(SGChannel c, Rect *r) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0183, 0x7000, 0xA82A);
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGPanelGetDitl(SeqGrabComponent s, Handle *ditl) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0200, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGPanelGetTitle(SeqGrabComponent s, Str255 title) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0201, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGPanelCanRun(SeqGrabComponent s, SGChannel c) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0202, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGPanelEvent(SeqGrabComponent s, SGChannel c, DialogRef d, short itemOffset, const EventRecord *theEvent,
				 short *itemHit, Boolean *handled) FIVEWORDINLINE(0x2F3C, 0x0016, 0x0204, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGPanelItem(SeqGrabComponent s, SGChannel c, DialogRef d, short itemOffset, short itemNum)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGPanelSetGrabber(SeqGrabComponent s, SeqGrabComponent sg) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0207, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGPanelSetResFile(SeqGrabComponent s, short resRef) FIVEWORDINLINE(0x2F3C, 0x0002, 0x0208, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGPanelValidateInput(SeqGrabComponent s, Boolean *ok) FIVEWORDINLINE(0x2F3C, 0x0004, 0x020B, 0x7000, 0xA82A);
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGPanelGetDITLForSize(SeqGrabComponent s, Handle *ditl, Point *requestedSize)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x020D, 0x7000, 0xA82A);
	...
	*/
	...
	typedef CALLBACK_API(ComponentResult, SGGrabCompleteBottleProcPtr)(SGChannel c, short bufferNum, Boolean *done,
																	   long refCon);
	typedef CALLBACK_API(ComponentResult, SGDisplayBottleProcPtr)(SGChannel c, short bufferNum, MatrixRecord *mp,
	...
	typedef CALLBACK_API(ComponentResult, SGCompressCompleteBottleProcPtr)(SGChannel c, short bufferNum, Boolean *done,
																		   SGCompressInfo *ci, long refCon);
	typedef CALLBACK_API(ComponentResult, SGAddFrameBottleProcPtr)(SGChannel c, short bufferNum, TimeValue atTime,
																   TimeScale scale, const SGCompressInfo *ci,
																   long refCon);
	typedef CALLBACK_API(ComponentResult, SGTransferFrameBottleProcPtr)(SGChannel c, short bufferNum, MatrixRecord *mp,
																		RgnHandle clipRgn, long refCon);
	/*    Note that UInt8 *queuedFrameCount replaces Boolean *done. 0(==false) still means no frames, and 1(==true) one,
			but if more than one are available the number should be returned here. The value 2 previously meant more
	   than one frame, so some VDIGs may return 2 even if more than 2 are available, and some will still return 1 as
	   they are using the original definition. */
	typedef CALLBACK_API(ComponentResult, SGGrabCompressCompleteBottleProcPtr)(SGChannel c, UInt8 *queuedFrameCount,
																			   SGCompressInfo *ci, TimeRecord *t,
																			   long refCon);
	typedef CALLBACK_API(ComponentResult, SGDisplayCompressBottleProcPtr)(SGChannel c, Ptr dataPtr,
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetSrcVideoBounds(SGChannel c, Rect *r) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0100, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetVideoRect(SGChannel c, const Rect *r) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0101, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetVideoRect(SGChannel c, Rect *r) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0102, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetVideoCompressorType(SGChannel c, OSType compressorType) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0104, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetVideoCompressor(SGChannel c, short depth, CompressorComponent compressor, CodecQ spatialQuality,
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetVideoCompressor(SGChannel c, short *depth, CompressorComponent *compressor, CodecQ *spatialQuality,
						 CodecQ *temporalQuality, long *keyFrameRate)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetVideoBottlenecks(SGChannel c, VideoBottles *vb) FIVEWORDINLINE(0x2F3C, 0x0004, 0x010A, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetVideoBottlenecks(SGChannel c, VideoBottles *vb) FIVEWORDINLINE(0x2F3C, 0x0004, 0x010B, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGrabFrame(SGChannel c, short bufferNum) FIVEWORDINLINE(0x2F3C, 0x0002, 0x010C, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGDisplayFrame(SGChannel c, short bufferNum, const MatrixRecord *mp, RgnHandle clipRgn)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGCompressFrame(SGChannel c, short bufferNum) FIVEWORDINLINE(0x2F3C, 0x0002, 0x010F, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGCompressFrameComplete(SGChannel c, short bufferNum, Boolean *done, SGCompressInfo *ci)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGAddFrame(SGChannel c, short bufferNum, TimeValue atTime, TimeScale scale, const SGCompressInfo *ci)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGTransferFrameForCompress(SGChannel c, short bufferNum, const MatrixRecord *mp, RgnHandle clipRgn)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetBufferInfo(SGChannel c, short bufferNum, PixMapHandle *bufferPM, Rect *bufferRect, GWorldPtr *compressBuffer,
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetUseScreenBuffer(SGChannel c, Boolean useScreenBuffer) FIVEWORDINLINE(0x2F3C, 0x0002, 0x0116, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetUseScreenBuffer(SGChannel c, Boolean *useScreenBuffer) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0117, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGDisplayCompress(SGChannel c, Ptr dataPtr, ImageDescriptionHandle desc, MatrixRecord *mp, RgnHandle clipRgn)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetFrameRate(SGChannel c, Fixed frameRate) FIVEWORDINLINE(0x2F3C, 0x0004, 0x011A, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetFrameRate(SGChannel c, Fixed *frameRate) FIVEWORDINLINE(0x2F3C, 0x0004, 0x011B, 0x7000, 0xA82A);
	...
	enum
	{
		...
		kQTSGAudioPropertyID_DeviceListWithAttributes =
			FOUR_CHAR_CODE('#dva'), /* Data: CFArrayRef, R/W/L: Read/Listen, Class(es): kQTPropertyClass_SGAudio  */
		...
		kQTSGAudioPropertyID_DeviceAttributes =
			FOUR_CHAR_CODE('deva'), /* Data: CFDictionaryRef, R/W/L: Read, Class(es):
									   kQTPropertyClass_SGAudioRecordDevice, kQTPropertyClass_SGAudioPreviewDevice */
		...
		kQTSGAudioPropertyID_DeviceUID =
			FOUR_CHAR_CODE('uid '), /* Data: CFStringRef, R/W/L: Read/Write, Class(es):
									   kQTPropertyClass_SGAudioRecordDevice, kQTPropertyClass_SGAudioPreviewDevice */
		...
		kQTSGAudioPropertyID_DeviceAlive =
			FOUR_CHAR_CODE('aliv'), /* Data: Boolean, R/W/L: Read/Listen, Class(es):
									   kQTPropertyClass_SGAudioRecordDevice, kQTPropertyClass_SGAudioPreviewDevice */
		...
		kQTSGAudioPropertyID_DeviceHogged =
			FOUR_CHAR_CODE('hogg'), /* Data: pid_t, R/W/L: Read/Write/Listen, Class(es):
									   kQTPropertyClass_SGAudioRecordDevice, kQTPropertyClass_SGAudioPreviewDevice */
		...
		kQTSGAudioPropertyID_DeviceInUse =
			FOUR_CHAR_CODE('used'), /* Data: Boolean, R/W/L: Read/Listen, Class(es):
									   kQTPropertyClass_SGAudioRecordDevice, kQTPropertyClass_SGAudioPreviewDevice */
		 ...
		 */
		kQTSGAudioPropertyID_HardwarePlaythruEnabled = FOUR_CHAR_CODE(
			'hard'), /* Data: Boolean, R/W/L: Read/Write, Class(es): kQTPropertyClass_SGAudioRecordDevice */
		...
		kQTSGAudioPropertyID_ChannelLayout =
			FOUR_CHAR_CODE('clay'), /* Data: AudioChannelLayout, R/W/L: Read/Write, Class(es): kQTPropertyClass_SGAudio,
									   kQTPropertyClass_SGAudioRecordDevice, kQTPropertyClass_SGAudioPreviewDevice */
		 ...
		 */
		kQTSGAudioPropertyID_ChannelMap = FOUR_CHAR_CODE('cmap'), /* Data: C-style array of SInt32's, R/W/L: Read/Write,
																	 Class(es): kQTPropertyClass_SGAudioRecordDevice */
		 ...
		 */
		kQTSGAudioPropertyID_CodecSpecificSettingsArray =
			FOUR_CHAR_CODE('cdst'), /* Data: CFArrayRef,  Read/Write, Class(es): kQTPropertyClass_SGAudio*/
		...
		kQTSGAudioPropertyID_MagicCookie =
			FOUR_CHAR_CODE('kuki'), /* Data: void * (opaque), R/W/L: Read/Write, Class(es): kQTPropertyClass_SGAudio */
		...
		kQTSGAudioPropertyID_StreamFormat =
			FOUR_CHAR_CODE('frmt'), /* Data: AudioStreamBasicDescription, R/W/L: Read/Write/Listen, Class(es):
									   kQTPropertyClass_SGAudio, kQTPropertyClass_SGAudioRecordDevice,
		 ...
		 */
		kQTSGAudioPropertyID_StreamFormatList = FOUR_CHAR_CODE(
			'#frm'), /* Data: C-style array of AudioStreamBasicDescription's, R/W/L: Read/Listen, Class(es):
						kQTPropertyClass_SGAudioRecordDevice, kQTPropertyClass_SGAudioPreviewDevice */
		 ...
		 * when done with it.
		 */
		kQTSGAudioPropertyID_SoundDescription = FOUR_CHAR_CODE(
			'snds'), /* Data: SoundDescriptionHandle, R/W/L: Read/Write, Class(es): kQTPropertyClass_SGAudio */
		 ...
		 * change).
		 */
		kQTSGAudioPropertyID_InputSelection = FOUR_CHAR_CODE(
			'inpt'), /* Data: OSType, R/W/L: Read/Write/Listen, Class(es): kQTPropertyClass_SGAudioRecordDevice */
		 ...
		 * returned array.
		 */
		kQTSGAudioPropertyID_InputListWithAttributes = FOUR_CHAR_CODE(
			'#inp'), /* Data: CFArrayRef, R/W/L: Read/Listen, Class(es): kQTPropertyClass_SGAudioRecordDevice */
		 ...
		 * may change).
		 */
		kQTSGAudioPropertyID_OutputSelection = FOUR_CHAR_CODE(
			'otpt'), /* Data: OSType, R/W/L: Read/Write/Listen, Class(es): kQTPropertyClass_SGAudioPreviewDevice */
		 ...
		 */
		kQTSGAudioPropertyID_OutputListWithAttributes = FOUR_CHAR_CODE(
			'#otp'), /* Data: CFArrayRef, R/W/L: Read/Listen, Class(es): kQTPropertyClass_SGAudioPreviewDevice */
		 ...
		 */
		kQTSGAudioPropertyID_LevelMetersEnabled = FOUR_CHAR_CODE(
			'lmet'), /* Data: Boolean, R/W/L: Read/Write, Class(es): kQTPropertyClass_SGAudioRecordDevice,
						kQTPropertyClass_SGAudioPreviewDevice, kQTPropertyClass_SGAudio */
		 ...
		 * will be equivalent.
		 */
		kQTSGAudioPropertyID_PeakHoldLevels = FOUR_CHAR_CODE(
			'phlv'), /* Data: C-style array of Float32's, R/W/L: Read, Class(es): kQTPropertyClass_SGAudioRecordDevice,
						kQTPropertyClass_SGAudioPreviewDevice, kQTPropertyClass_SGAudio */
		 ...
		 * will be equivalent.
		 */
		kQTSGAudioPropertyID_AveragePowerLevels = FOUR_CHAR_CODE(
			'aplv'), /* Data: C-style array of Float32's, R/W/L: Read, Class(es): kQTPropertyClass_SGAudioRecordDevice,
						kQTPropertyClass_SGAudioPreviewDevice, kQTPropertyClass_SGAudio */
		...
		kQTSGAudioPropertyID_MasterGain =
			FOUR_CHAR_CODE('mgan'), /* Data: Float32, R/W/L: Read/Write, Class(es): kQTPropertyClass_SGAudio,
									   kQTPropertyClass_SGAudioRecordDevice, kQTPropertyClass_SGAudioPreviewDevice */
		 ...
		 * -1., -1., -1. }.
		 */
		kQTSGAudioPropertyID_PerChannelGain = FOUR_CHAR_CODE(
			'cgan'), /* Data: C-style array of Float32's, R/W/L: Read/Write, Class(es): kQTPropertyClass_SGAudio,
						kQTPropertyClass_SGAudioRecordDevice, kQTPropertyClass_SGAudioPreviewDevice              */
		 ...
		 * later.
		 */
		kQTSGAudioPropertyID_GainScalarToDecibels =
			FOUR_CHAR_CODE('gsdb'), /* Data: Float32, R/W/L: Read, Class(es): kQTPropertyClass_SGAudio,
									   kQTPropertyClass_SGAudioRecordDevice, kQTPropertyClass_SGAudioPreviewDevice*/
		 ...
		 */
		kQTSGAudioPropertyID_MixerCoefficients = FOUR_CHAR_CODE(
			'mixc'), /* Data: C-style array of Float32's, R/W/L: Read/Write, Class(es): kQTPropertyClass_SGAudio*/
		...
		kQTSGAudioPropertyID_Settings =
			FOUR_CHAR_CODE('setu'), /* Data: UserData, R/W/L: Read/Write, Class(es): kQTPropertyClass_SGAudio */
		...
		kQTSGAudioPropertyID_ChunkSize =
			FOUR_CHAR_CODE('chnk'), /* Data: Float32, R/W/L: Read/Write, Class(es): kQTPropertyClass_SGAudio */
		 ...
		 * preview device.
		 */
		kQTSGAudioPropertyID_SoftPreviewLatency =
			FOUR_CHAR_CODE('slat'), /* Data: Float32, R/W/L: Read/Write, Class(es): kQTPropertyClass_SGAudio */
		 ...
		 */
		kQTSGAudioPropertyID_PreMixCallback = FOUR_CHAR_CODE(
			'_mxc'), /* Data: SGAudioCallbackStruct, R/W/L: Read/Write, Class(es): kQTPropertyClass_SGAudio */
		 ...
		 */
		kQTSGAudioPropertyID_PreMixCallbackFormat = FOUR_CHAR_CODE(
			'_mcf'), /* Data: AudioStreamBasicDescription, R/W/L: Read, Class(es): kQTPropertyClass_SGAudio*/
		 ...
		 * inputRefCon.
		 */
		kQTSGAudioPropertyID_PostMixCallback = FOUR_CHAR_CODE(
			'mx_c'), /* Data: SGAudioCallbackStruct, R/W/L: Read/Write, Class(es): kQTPropertyClass_SGAudio */
		 ...
		 * you've called SGPrepare().
		 */
		kQTSGAudioPropertyID_PostMixCallbackFormat = FOUR_CHAR_CODE(
			'm_cf'), /* Data: AudioStreamBasicDescription, R/W/L: Read, Class(es): kQTPropertyClass_SGAudio*/
		 ...
		 * inputRefCon.
		 */
		kQTSGAudioPropertyID_PreConversionCallback = FOUR_CHAR_CODE(
			'_cvc'), /* Data: SGAudioCallbackStruct, R/W/L: Read/Write, Class(es): kQTPropertyClass_SGAudio */
		 ...
		 * you've called SGPrepare().
		 */
		kQTSGAudioPropertyID_PreConversionCallbackFormat = FOUR_CHAR_CODE(
			'_ccf'), /* Data: AudioStreamBasicDescription, R/W/L: Read, Class(es): kQTPropertyClass_SGAudio*/
		 ...
		 * inputRefCon.
		 */
		kQTSGAudioPropertyID_PostConversionCallback = FOUR_CHAR_CODE(
			'cv_c'), /* Data: SGAudioCallbackStruct, R/W/L: Read/Write, Class(es): kQTPropertyClass_SGAudio */
		 ...
		 * you've called SGPrepare().
		 */
		kQTSGAudioPropertyID_PostConversionCallbackFormat = FOUR_CHAR_CODE(
			'c_cf') /* Data: AudioStreamBasicDescription, R/W/L: Read, Class(es): kQTPropertyClass_SGAudio*/
	};
	 ...
	 */
	typedef CALLBACK_API_C(OSStatus, SGAudioCallback)(SGChannel c, void *inRefCon, SGAudioCallbackFlags *ioFlags,
													  const AudioTimeStamp *inTimeStamp, const UInt32 *inNumberPackets,
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetSoundRecordChunkSize(SGChannel c, long seconds) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0103, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetSoundInputRate(SGChannel c, Fixed rate) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0105, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetSoundInputParameters(SGChannel c, short sampleSize, short numChannels, OSType compressionType)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x0107, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetSoundInputParameters(SGChannel c, short *sampleSize, short *numChannels, OSType *compressionType)
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetAdditionalSoundRates(SGChannel c, Handle rates) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0109, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetAdditionalSoundRates(SGChannel c, Handle *rates) FIVEWORDINLINE(0x2F3C, 0x0004, 0x010A, 0x7000, 0xA82A);
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetFontName(SGChannel c, StringPtr pstr) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0100, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetFontSize(SGChannel c, short fontSize) FIVEWORDINLINE(0x2F3C, 0x0002, 0x0101, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetTextForeColor(SGChannel c, RGBColor *theColor) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0102, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetTextBackColor(SGChannel c, RGBColor *theColor) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0103, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetJustification(SGChannel c, short just) FIVEWORDINLINE(0x2F3C, 0x0002, 0x0104, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetTextReturnToSpaceValue(SGChannel c, short *rettospace) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0105, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetTextReturnToSpaceValue(SGChannel c, short rettospace) FIVEWORDINLINE(0x2F3C, 0x0002, 0x0106, 0x7000, 0xA82A);
	...
	*/
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGGetInstrument(SGChannel c, ToneDescription *td) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0100, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	SGSetInstrument(SGChannel c, ToneDescription *td) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0101, 0x7000, 0xA82A);
	...
	enum
	{
		...
		kQTVOName =
			FOUR_CHAR_CODE('name'), /* atom contains string (no length byte) - name of mode for display to user*/
		...
		kQTVODecompressorContinuous =
			FOUR_CHAR_CODE('cont'), /* atom contains one Boolean - true if this type is displayed continuously*/
		kQTVODecompressorComponent =
			FOUR_CHAR_CODE('cmpt') /* atom contains one Component - component id of decompressor*/
	};
	 ...
	 */
	EXTERN_API(ComponentResult)
	QTVideoOutputGetDisplayModeList(QTVideoOutputComponent vo, QTAtomContainer *outputs)
	 ...
	 */
	EXTERN_API(ComponentResult)
	QTVideoOutputCustomConfigureDisplay(QTVideoOutputComponent vo, ModalFilterUPP filter)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x0009, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	QTVideoOutputGetGWorldParameters(QTVideoOutputComponent vo, Ptr *baseAddr, long *rowBytes, CTabHandle *colorTable)
	 ...
	 */
	EXTERN_API(ComponentResult)
	QTVideoOutputGetIndSoundOutput(QTVideoOutputComponent vo, long index, Component *outputComponent)
	 ...
	 */
	EXTERN_API(ComponentResult)
	QTVideoOutputGetIndImageDecompressor(QTVideoOutputComponent vo, long index, Component *codec)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x0011, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	QTVideoOutputBaseSetEchoPort(QTVideoOutputComponent vo, CGrafPtr echoPort)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x0012, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	QTVideoOutputCopyIndAudioOutputDeviceUID(QTVideoOutputComponent vo, long index, CFStringRef *audioDeviceUID)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x0016, 0x7000, 0xA82A);
	...
	{
		return (DataHCompletionUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppDataHCompletionProcInfo,
														GetCurrentArchitecture());
	}
#else
...
#define NewVdigIntUPP(userRoutine) \
	...
	{
		return (StartDocumentHandlerUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppStartDocumentHandlerProcInfo,
															 GetCurrentArchitecture());
	}
#else
#define NewStartDocumentHandlerUPP(userRoutine) \
	(StartDocumentHandlerUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppStartDocumentHandlerProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (EndDocumentHandlerUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppEndDocumentHandlerProcInfo,
														   GetCurrentArchitecture());
	}
#else
#define NewEndDocumentHandlerUPP(userRoutine) \
	(EndDocumentHandlerUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppEndDocumentHandlerProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (StartElementHandlerUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppStartElementHandlerProcInfo,
															GetCurrentArchitecture());
	}
#else
#define NewStartElementHandlerUPP(userRoutine) \
	(StartElementHandlerUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppStartElementHandlerProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (EndElementHandlerUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppEndElementHandlerProcInfo,
														  GetCurrentArchitecture());
	}
#else
#define NewEndElementHandlerUPP(userRoutine) \
	(EndElementHandlerUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppEndElementHandlerProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (CharDataHandlerUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppCharDataHandlerProcInfo,
														GetCurrentArchitecture());
	}
#else
#define NewCharDataHandlerUPP(userRoutine) \
	(CharDataHandlerUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppCharDataHandlerProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#ifdef __cplusplus
	inline DEFINE_API_C(PreprocessInstructionHandlerUPP)
		NewPreprocessInstructionHandlerUPP(PreprocessInstructionHandler userRoutine)
	{
		return (PreprocessInstructionHandlerUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppPreprocessInstructionHandlerProcInfo, GetCurrentArchitecture());
	}
#else
#define NewPreprocessInstructionHandlerUPP(userRoutine)     \
	...
	{
		return (CommentHandlerUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppCommentHandlerProcInfo,
													   GetCurrentArchitecture());
	}
#else
#define NewCommentHandlerUPP(userRoutine) \
	(CommentHandlerUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppCommentHandlerProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	enum
	{
		uppCDataHandlerProcInfo = 0x000003F0
	}; /* pascal 4_bytes Func(4_bytes, 4_bytes) */
#ifdef __cplusplus
	inline DEFINE_API_C(CDataHandlerUPP) NewCDataHandlerUPP(CDataHandler userRoutine)
	{
		return (CDataHandlerUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppCDataHandlerProcInfo,
													 GetCurrentArchitecture());
	}
#else
#define NewCDataHandlerUPP(userRoutine) \
	(CDataHandlerUPP) NewRoutineDescriptor((ProcPtr)(userRoutine), uppCDataHandlerProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define NewSGDataUPP(userRoutine) \
	...
	{
		return (SGModalFilterUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppSGModalFilterProcInfo,
													  GetCurrentArchitecture());
	}
#else
#define NewSGModalFilterUPP(userRoutine) \
	...
	{
		return (SGGrabBottleUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppSGGrabBottleProcInfo,
													 GetCurrentArchitecture());
	}
#else
#define NewSGGrabBottleUPP(userRoutine) \
	...
	{
		return (SGGrabCompleteBottleUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppSGGrabCompleteBottleProcInfo,
															 GetCurrentArchitecture());
	}
#else
#define NewSGGrabCompleteBottleUPP(userRoutine) \
	(SGGrabCompleteBottleUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppSGGrabCompleteBottleProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (SGDisplayBottleUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppSGDisplayBottleProcInfo,
														GetCurrentArchitecture());
	}
#else
#define NewSGDisplayBottleUPP(userRoutine) \
	(SGDisplayBottleUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppSGDisplayBottleProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (SGCompressBottleUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppSGCompressBottleProcInfo,
														 GetCurrentArchitecture());
	}
#else
#define NewSGCompressBottleUPP(userRoutine) \
	(SGCompressBottleUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppSGCompressBottleProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#ifdef __cplusplus
	inline DEFINE_API_C(SGCompressCompleteBottleUPP)
		NewSGCompressCompleteBottleUPP(SGCompressCompleteBottleProcPtr userRoutine)
	{
...
#define NewSGCompressCompleteBottleUPP(userRoutine) \
	(SGCompressCompleteBottleUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppSGCompressCompleteBottleProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (SGAddFrameBottleUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppSGAddFrameBottleProcInfo,
														 GetCurrentArchitecture());
	}
#else
#define NewSGAddFrameBottleUPP(userRoutine) \
	(SGAddFrameBottleUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppSGAddFrameBottleProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (SGTransferFrameBottleUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppSGTransferFrameBottleProcInfo,
															  GetCurrentArchitecture());
	}
#else
...
#ifdef __cplusplus
	inline DEFINE_API_C(SGGrabCompressCompleteBottleUPP)
		NewSGGrabCompressCompleteBottleUPP(SGGrabCompressCompleteBottleProcPtr userRoutine)
	{
		return (SGGrabCompressCompleteBottleUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppSGGrabCompressCompleteBottleProcInfo, GetCurrentArchitecture());
	}
#else
...
#ifdef __cplusplus
	inline DEFINE_API_C(SGDisplayCompressBottleUPP)
		NewSGDisplayCompressBottleUPP(SGDisplayCompressBottleProcPtr userRoutine)
	{
		return (SGDisplayCompressBottleUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppSGDisplayCompressBottleProcInfo, GetCurrentArchitecture());
	}
#else
#define NewSGDisplayCompressBottleUPP(userRoutine) \
	(SGDisplayCompressBottleUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppSGDisplayCompressBottleProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeSGDisplayCompressBottleUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(void)
	InvokeDataHCompletionUPP(Ptr request, long refcon, OSErr err, DataHCompletionUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeStartDocumentHandlerUPP(refcon, userUPP) \
	(ComponentResult) CALL_ONE_PARAMETER_UPP((userUPP), uppStartDocumentHandlerProcInfo, (refcon))
#endif
#endif
...
#define InvokeEndDocumentHandlerUPP(refcon, userUPP) \
	(ComponentResult) CALL_ONE_PARAMETER_UPP((userUPP), uppEndDocumentHandlerProcInfo, (refcon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(ComponentResult)
	InvokeStartElementHandlerUPP(const char *name, const char **atts, long refcon, StartElementHandlerUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(ComponentResult)
		InvokeStartElementHandlerUPP(const char *name, const char **atts, long refcon, StartElementHandlerUPP userUPP)
	{
...
#define InvokeStartElementHandlerUPP(name, atts, refcon, userUPP) \
	(ComponentResult) CALL_THREE_PARAMETER_UPP((userUPP), uppStartElementHandlerProcInfo, (name), (atts), (refcon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(ComponentResult)
	InvokeEndElementHandlerUPP(const char *name, long refcon, EndElementHandlerUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(ComponentResult)
		InvokeEndElementHandlerUPP(const char *name, long refcon, EndElementHandlerUPP userUPP)
...
#define InvokeEndElementHandlerUPP(name, refcon, userUPP) \
	(ComponentResult) CALL_TWO_PARAMETER_UPP((userUPP), uppEndElementHandlerProcInfo, (name), (refcon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(ComponentResult)
	InvokeCharDataHandlerUPP(const char *charData, long refcon, CharDataHandlerUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(ComponentResult)
		InvokeCharDataHandlerUPP(const char *charData, long refcon, CharDataHandlerUPP userUPP)
...
#define InvokeCharDataHandlerUPP(charData, refcon, userUPP) \
	(ComponentResult) CALL_TWO_PARAMETER_UPP((userUPP), uppCharDataHandlerProcInfo, (charData), (refcon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(ComponentResult)
	InvokePreprocessInstructionHandlerUPP(const char *name, const char *const atts[], long refcon,
	...
	inline DEFINE_API_C(ComponentResult)
		InvokePreprocessInstructionHandlerUPP(const char *name, const char *const atts[], long refcon,
											  PreprocessInstructionHandlerUPP userUPP)
	{
		return (ComponentResult)CALL_THREE_PARAMETER_UPP(userUPP, uppPreprocessInstructionHandlerProcInfo, name, atts,
														 refcon);
	}
#else
#define InvokePreprocessInstructionHandlerUPP(name, atts, refcon, userUPP) \
	(ComponentResult)                                                      \
		CALL_THREE_PARAMETER_UPP((userUPP), uppPreprocessInstructionHandlerProcInfo, (name), (atts), (refcon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(ComponentResult)
	InvokeCommentHandlerUPP(const char *comment, long refcon, CommentHandlerUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(ComponentResult)
		InvokeCommentHandlerUPP(const char *comment, long refcon, CommentHandlerUPP userUPP)
...
#define InvokeCommentHandlerUPP(comment, refcon, userUPP) \
	(ComponentResult) CALL_TWO_PARAMETER_UPP((userUPP), uppCommentHandlerProcInfo, (comment), (refcon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(ComponentResult)
	InvokeCDataHandlerUPP(const char *cdata, long refcon, CDataHandlerUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#else
#define InvokeCDataHandlerUPP(cdata, refcon, userUPP) \
	(ComponentResult) CALL_TWO_PARAMETER_UPP((userUPP), uppCDataHandlerProcInfo, (cdata), (refcon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeSGDataUPP(SGChannel c, Ptr p, long len, long *offset, long chRefCon, TimeValue time, short writeType,
					long refCon, SGDataUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSErr) InvokeSGDataUPP(SGChannel c, Ptr p, long len, long *offset, long chRefCon,
											   TimeValue time, short writeType, long refCon, SGDataUPP userUPP)
	{
		return (OSErr)CALL_EIGHT_PARAMETER_UPP(userUPP, uppSGDataProcInfo, c, p, len, offset, chRefCon, time, writeType,
											   refCon);
	}
#else
#define InvokeSGDataUPP(c, p, len, offset, chRefCon, time, writeType, refCon, userUPP)                            \
	(OSErr) CALL_EIGHT_PARAMETER_UPP((userUPP), uppSGDataProcInfo, (c), (p), (len), (offset), (chRefCon), (time), \
									 (writeType), (refCon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(Boolean)
	InvokeSGModalFilterUPP(DialogRef theDialog, const EventRecord *theEvent, short *itemHit, long refCon,
						   SGModalFilterUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(Boolean) InvokeSGModalFilterUPP(DialogRef theDialog, const EventRecord *theEvent,
														short *itemHit, long refCon, SGModalFilterUPP userUPP)
	{
		return (Boolean)CALL_FOUR_PARAMETER_UPP(userUPP, uppSGModalFilterProcInfo, theDialog, theEvent, itemHit,
												refCon);
	}
#else
#define InvokeSGModalFilterUPP(theDialog, theEvent, itemHit, refCon, userUPP) \
	(Boolean) CALL_FOUR_PARAMETER_UPP((userUPP), uppSGModalFilterProcInfo, (theDialog), (theEvent), (itemHit), (refCon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(ComponentResult)
	InvokeSGGrabBottleUPP(SGChannel c, short bufferNum, long refCon, SGGrabBottleUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(ComponentResult)
		InvokeSGGrabBottleUPP(SGChannel c, short bufferNum, long refCon, SGGrabBottleUPP userUPP)
...
#define InvokeSGGrabBottleUPP(c, bufferNum, refCon, userUPP) \
	(ComponentResult) CALL_THREE_PARAMETER_UPP((userUPP), uppSGGrabBottleProcInfo, (c), (bufferNum), (refCon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(ComponentResult)
	InvokeSGGrabCompleteBottleUPP(SGChannel c, short bufferNum, Boolean *done, long refCon,
								  SGGrabCompleteBottleUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(ComponentResult) InvokeSGGrabCompleteBottleUPP(SGChannel c, short bufferNum, Boolean *done,
																	   long refCon, SGGrabCompleteBottleUPP userUPP)
	{
		return (ComponentResult)CALL_FOUR_PARAMETER_UPP(userUPP, uppSGGrabCompleteBottleProcInfo, c, bufferNum, done,
														refCon);
	}
#else
#define InvokeSGGrabCompleteBottleUPP(c, bufferNum, done, refCon, userUPP) \
	(ComponentResult)                                                      \
		CALL_FOUR_PARAMETER_UPP((userUPP), uppSGGrabCompleteBottleProcInfo, (c), (bufferNum), (done), (refCon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(ComponentResult)
	InvokeSGDisplayBottleUPP(SGChannel c, short bufferNum, MatrixRecord *mp, RgnHandle clipRgn, long refCon,
	...
	inline DEFINE_API_C(ComponentResult)
		InvokeSGDisplayBottleUPP(SGChannel c, short bufferNum, MatrixRecord *mp, RgnHandle clipRgn, long refCon,
								 SGDisplayBottleUPP userUPP)
	{
		return (ComponentResult)CALL_FIVE_PARAMETER_UPP(userUPP, uppSGDisplayBottleProcInfo, c, bufferNum, mp, clipRgn,
														refCon);
	}
#else
#define InvokeSGDisplayBottleUPP(c, bufferNum, mp, clipRgn, refCon, userUPP) \
	(ComponentResult)                                                        \
		CALL_FIVE_PARAMETER_UPP((userUPP), uppSGDisplayBottleProcInfo, (c), (bufferNum), (mp), (clipRgn), (refCon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(ComponentResult)
	InvokeSGCompressBottleUPP(SGChannel c, short bufferNum, long refCon, SGCompressBottleUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(ComponentResult)
		InvokeSGCompressBottleUPP(SGChannel c, short bufferNum, long refCon, SGCompressBottleUPP userUPP)
...
#define InvokeSGCompressBottleUPP(c, bufferNum, refCon, userUPP) \
	(ComponentResult) CALL_THREE_PARAMETER_UPP((userUPP), uppSGCompressBottleProcInfo, (c), (bufferNum), (refCon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(ComponentResult)
	InvokeSGCompressCompleteBottleUPP(SGChannel c, short bufferNum, Boolean *done, SGCompressInfo *ci, long refCon,
	...
	inline DEFINE_API_C(ComponentResult)
		InvokeSGCompressCompleteBottleUPP(SGChannel c, short bufferNum, Boolean *done, SGCompressInfo *ci, long refCon,
										  SGCompressCompleteBottleUPP userUPP)
	{
		return (ComponentResult)CALL_FIVE_PARAMETER_UPP(userUPP, uppSGCompressCompleteBottleProcInfo, c, bufferNum,
														done, ci, refCon);
	}
#else
#define InvokeSGCompressCompleteBottleUPP(c, bufferNum, done, ci, refCon, userUPP)                              \
	(ComponentResult) CALL_FIVE_PARAMETER_UPP((userUPP), uppSGCompressCompleteBottleProcInfo, (c), (bufferNum), \
											  (done), (ci), (refCon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(ComponentResult)
	InvokeSGAddFrameBottleUPP(SGChannel c, short bufferNum, TimeValue atTime, TimeScale scale, const SGCompressInfo *ci,
							  long refCon, SGAddFrameBottleUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(ComponentResult)
		InvokeSGAddFrameBottleUPP(SGChannel c, short bufferNum, TimeValue atTime, TimeScale scale,
								  const SGCompressInfo *ci, long refCon, SGAddFrameBottleUPP userUPP)
	{
		return (ComponentResult)CALL_SIX_PARAMETER_UPP(userUPP, uppSGAddFrameBottleProcInfo, c, bufferNum, atTime,
													   scale, ci, refCon);
	}
#else
#define InvokeSGAddFrameBottleUPP(c, bufferNum, atTime, scale, ci, refCon, userUPP)                              \
	(ComponentResult) CALL_SIX_PARAMETER_UPP((userUPP), uppSGAddFrameBottleProcInfo, (c), (bufferNum), (atTime), \
											 (scale), (ci), (refCon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(ComponentResult)
	InvokeSGTransferFrameBottleUPP(SGChannel c, short bufferNum, MatrixRecord *mp, RgnHandle clipRgn, long refCon,
	...
	inline DEFINE_API_C(ComponentResult)
		InvokeSGTransferFrameBottleUPP(SGChannel c, short bufferNum, MatrixRecord *mp, RgnHandle clipRgn, long refCon,
									   SGTransferFrameBottleUPP userUPP)
	{
		return (ComponentResult)CALL_FIVE_PARAMETER_UPP(userUPP, uppSGTransferFrameBottleProcInfo, c, bufferNum, mp,
														clipRgn, refCon);
	}
#else
#define InvokeSGTransferFrameBottleUPP(c, bufferNum, mp, clipRgn, refCon, userUPP)                                 \
	(ComponentResult) CALL_FIVE_PARAMETER_UPP((userUPP), uppSGTransferFrameBottleProcInfo, (c), (bufferNum), (mp), \
											  (clipRgn), (refCon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(ComponentResult)
	InvokeSGGrabCompressCompleteBottleUPP(SGChannel c, UInt8 *queuedFrameCount, SGCompressInfo *ci, TimeRecord *t,
										  long refCon, SGGrabCompressCompleteBottleUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(ComponentResult)
		InvokeSGGrabCompressCompleteBottleUPP(SGChannel c, UInt8 *queuedFrameCount, SGCompressInfo *ci, TimeRecord *t,
											  long refCon, SGGrabCompressCompleteBottleUPP userUPP)
	{
		return (ComponentResult)CALL_FIVE_PARAMETER_UPP(userUPP, uppSGGrabCompressCompleteBottleProcInfo, c,
														queuedFrameCount, ci, t, refCon);
	}
#else
#define InvokeSGGrabCompressCompleteBottleUPP(c, queuedFrameCount, ci, t, refCon, userUPP)             \
	(ComponentResult) CALL_FIVE_PARAMETER_UPP((userUPP), uppSGGrabCompressCompleteBottleProcInfo, (c), \
											  (queuedFrameCount), (ci), (t), (refCon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(ComponentResult)
	InvokeSGDisplayCompressBottleUPP(SGChannel c, Ptr dataPtr, ImageDescriptionHandle desc, MatrixRecord *mp,
	...
	inline DEFINE_API_C(ComponentResult)
		InvokeSGDisplayCompressBottleUPP(SGChannel c, Ptr dataPtr, ImageDescriptionHandle desc, MatrixRecord *mp,
										 RgnHandle clipRgn, long refCon, SGDisplayCompressBottleUPP userUPP)
	{
		return (ComponentResult)CALL_SIX_PARAMETER_UPP(userUPP, uppSGDisplayCompressBottleProcInfo, c, dataPtr, desc,
													   mp, clipRgn, refCon);
	}
#else
#define InvokeSGDisplayCompressBottleUPP(c, dataPtr, desc, mp, clipRgn, refCon, userUPP)                            \
	(ComponentResult) CALL_SIX_PARAMETER_UPP((userUPP), uppSGDisplayCompressBottleProcInfo, (c), (dataPtr), (desc), \
											 (mp), (clipRgn), (refCon))
#endif
#endif
...
#define CallSGDataProc(userRoutine, c, p, len, offset, chRefCon, time, writeType, refCon) \
	InvokeSGDataUPP(c, p, len, offset, chRefCon, time, writeType, refCon, userRoutine)
...
#define CallSGAddFrameBottleProc(userRoutine, c, bufferNum, atTime, scale, ci, refCon) \
	InvokeSGAddFrameBottleUPP(c, bufferNum, atTime, scale, ci, refCon, userRoutine)
...
#define CallSGGrabCompressCompleteBottleProc(userRoutine, c, queuedFrameCount, ci, t, refCon) \
	InvokeSGGrabCompressCompleteBottleUPP(c, queuedFrameCount, ci, t, refCon, userRoutine)
#define CallSGDisplayCompressBottleProc(userRoutine, c, dataPtr, desc, mp, clipRgn, refCon) \
	InvokeSGDisplayCompressBottleUPP(c, dataPtr, desc, mp, clipRgn, refCon, userRoutine)
#endif /* CALL_NOT_IN_CARBON */
