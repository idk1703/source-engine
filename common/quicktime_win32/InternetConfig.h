...
#pragma pack(2)
	...
	{
		kICAttrNoChange =
			(unsigned long)0xFFFFFFFF, /* pass this to ICSetPref to tell it not to change the attributes  */
...
typedef ICMapEntryPtr *ICMapEntryHandle;
	...
	enum
	{
		...
		kICServicesUDPMask =
			0x00000002 /* both bits can be set, which means the service is both TCP and UDP, eg daytime*/
	};
...
/* ***** Specifying a Configuration *****  */
	 ...
	 */
	EXTERN_API(OSStatus)
	ICFindUserConfigFile(ICInstance inst, ICDirSpec *where) FIVEWORDINLINE(0x2F3C, 0x0004, 0x000E, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICGeneralFindConfigFile(ICInstance inst, Boolean searchPrefs, Boolean canCreate, short count,
 ...
 */
	 ...
	 */
	EXTERN_API(OSStatus)
	ICGetConfigReference(ICInstance inst, ICConfigRefHandle ref) FIVEWORDINLINE(0x2F3C, 0x0004, 0x001F, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICSpecifyConfigFile(ICInstance inst, FSSpec *config) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0003, 0x7000, 0xA82A);
...
/* ***** Getting Information *****  */
	 ...
	 */
	EXTERN_API(OSStatus)
	ICGetSeed(ICInstance inst, long *seed) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0004, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICGetPerm(ICInstance inst, ICPerm *perm) FIVEWORDINLINE(0x2F3C, 0x0004, 0x000D, 0x7000, 0xA82A);
 ...
 */
	 ...
	 */
	EXTERN_API(OSStatus)
	ICDefaultFileName(ICInstance inst, Str63 name) FIVEWORDINLINE(0x2F3C, 0x0004, 0x000B, 0x7000, 0xA82A);
...
/* ***** Reading and Writing Preferences *****  */
	 ...
	 */
	EXTERN_API(OSStatus)
	ICBegin(ICInstance inst, ICPerm perm) FIVEWORDINLINE(0x2F3C, 0x0002, 0x0005, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICGetPref(ICInstance inst, ConstStr255Param key, ICAttr *attr, void *buf, long *size)
	 ...
	 */
	EXTERN_API(OSStatus)
	ICSetPref(ICInstance inst, ConstStr255Param key, ICAttr attr, const void *buf, long size)
	 ...
	 */
	EXTERN_API(OSStatus)
	ICFindPrefHandle(ICInstance inst, ConstStr255Param key, ICAttr *attr, Handle prefh)
	 ...
	 */
	EXTERN_API(OSStatus)
	ICGetPrefHandle(ICInstance inst, ConstStr255Param key, ICAttr *attr, Handle *prefh)
	 ...
	 */
	EXTERN_API(OSStatus)
	ICSetPrefHandle(ICInstance inst, ConstStr255Param key, ICAttr attr, Handle prefh)
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCountPref(ICInstance inst, long *count) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0008, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICGetIndPref(ICInstance inst, long index, Str255 key) FIVEWORDINLINE(0x2F3C, 0x0008, 0x0009, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICDeletePref(ICInstance inst, ConstStr255Param key) FIVEWORDINLINE(0x2F3C, 0x0004, 0x000C, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICEditPreferences(ICInstance inst, ConstStr255Param key) FIVEWORDINLINE(0x2F3C, 0x0004, 0x000F, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICLaunchURL(ICInstance inst, ConstStr255Param hint, const void *data, long len, long *selStart, long *selEnd)
	 ...
	 */
	EXTERN_API(OSStatus)
	ICParseURL(ICInstance inst, ConstStr255Param hint, const void *data, long len, long *selStart, long *selEnd,
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCreateGURLEvent(ICInstance inst, OSType helperCreator, Handle urlH, AppleEvent *theEvent)
	 ...
	 */
	EXTERN_API(OSStatus)
	ICSendGURLEvent(ICInstance inst, AppleEvent *theEvent) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0034, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICMapTypeCreator(ICInstance inst, OSType fType, OSType fCreator, ConstStr255Param filename, ICMapEntry *entry)
	 ...
	 */
	EXTERN_API(OSStatus)
	ICMapEntriesFilename(ICInstance inst, Handle entries, ConstStr255Param filename, ICMapEntry *entry)
	 ...
	 */
	EXTERN_API(OSStatus)
	ICMapEntriesTypeCreator(ICInstance inst, Handle entries, OSType fType, OSType fCreator, ConstStr255Param filename,
	 ...
	 */
	EXTERN_API(OSStatus)
	ICGetIndMapEntry(ICInstance inst, Handle entries, long index, long *pos, ICMapEntry *entry)
	 ...
	 */
	EXTERN_API(OSStatus)
	ICSetMapEntry(ICInstance inst, Handle entries, long pos, const ICMapEntry *entry)
	 ...
	 */
	EXTERN_API(OSStatus)
	ICDeleteMapEntry(ICInstance inst, Handle entries, long pos) FIVEWORDINLINE(0x2F3C, 0x0008, 0x0016, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICGetCurrentProfile(ICInstance inst, ICProfileID *currentID) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0025, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICSetCurrentProfile(ICInstance inst, ICProfileID newID) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0026, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCountProfiles(ICInstance inst, long *count) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0027, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICDeleteProfile(ICInstance inst, ICProfileID thisID) FIVEWORDINLINE(0x2F3C, 0x0004, 0x002C, 0x7000, 0xA82A);
...
/* ***** Interrupt Safe Routines *****  */
	 ...
	 */
	EXTERN_API(OSStatus)
	ICGetMappingInterruptSafe(ICInstance inst, Ptr *mappingPref, long *mappingPrefSize)
	 ...
	 */
	EXTERN_API(OSStatus)
	ICGetSeedInterruptSafe(ICInstance inst, long *seed) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0030, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCFindConfigFile(ComponentInstance inst, short count, ICDirSpecArrayPtr folders)
		FIVEWORDINLINE(0x2F3C, 0x0006, 0x0002, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCGeneralFindConfigFile(ComponentInstance inst, Boolean searchPrefs, Boolean canCreate, short count,
							 ICDirSpecArrayPtr folders) FIVEWORDINLINE(0x2F3C, 0x000A, 0x001E, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCSpecifyConfigFile(ComponentInstance inst, FSSpec *config) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0003, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCGetSeed(ComponentInstance inst, long *seed) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0004, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCGetPerm(ComponentInstance inst, ICPerm *perm) FIVEWORDINLINE(0x2F3C, 0x0004, 0x000D, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCDefaultFileName(ComponentInstance inst, Str63 name) FIVEWORDINLINE(0x2F3C, 0x0004, 0x000B, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCGetComponentInstance(ComponentInstance inst, ComponentInstance *componentInst);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCBegin(ComponentInstance inst, ICPerm perm) FIVEWORDINLINE(0x2F3C, 0x0002, 0x0005, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCGetPref(ComponentInstance inst, ConstStr255Param key, ICAttr *attr, Ptr buf, long *size)
		FIVEWORDINLINE(0x2F3C, 0x0010, 0x0006, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCSetPref(ComponentInstance inst, ConstStr255Param key, ICAttr attr, Ptr buf, long size)
		FIVEWORDINLINE(0x2F3C, 0x0010, 0x0007, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCFindPrefHandle(ComponentInstance inst, ConstStr255Param key, ICAttr *attr, Handle prefh)
		FIVEWORDINLINE(0x2F3C, 0x000C, 0x0024, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCGetPrefHandle(ComponentInstance inst, ConstStr255Param key, ICAttr *attr, Handle *prefh)
		FIVEWORDINLINE(0x2F3C, 0x000C, 0x001A, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCSetPrefHandle(ComponentInstance inst, ConstStr255Param key, ICAttr attr, Handle prefh)
		FIVEWORDINLINE(0x2F3C, 0x000C, 0x001B, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCCountPref(ComponentInstance inst, long *count) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0008, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCDeletePref(ComponentInstance inst, ConstStr255Param key) FIVEWORDINLINE(0x2F3C, 0x0004, 0x000C, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCLaunchURL(ComponentInstance inst, ConstStr255Param hint, Ptr data, long len, long *selStart, long *selEnd)
		FIVEWORDINLINE(0x2F3C, 0x0014, 0x0011, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCParseURL(ComponentInstance inst, ConstStr255Param hint, Ptr data, long len, long *selStart, long *selEnd,
				Handle url) FIVEWORDINLINE(0x2F3C, 0x0018, 0x0010, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCCreateGURLEvent(ComponentInstance inst, OSType helperCreator, Handle urlH, AppleEvent *theEvent)
		FIVEWORDINLINE(0x2F3C, 0x000C, 0x0033, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCMapFilename(ComponentInstance inst, ConstStr255Param filename, ICMapEntry *entry)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x0018, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCMapTypeCreator(ComponentInstance inst, OSType fType, OSType fCreator, ConstStr255Param filename,
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCMapEntriesFilename(ComponentInstance inst, Handle entries, ConstStr255Param filename, ICMapEntry *entry)
		FIVEWORDINLINE(0x2F3C, 0x000C, 0x001C, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCMapEntriesTypeCreator(ComponentInstance inst, Handle entries, OSType fType, OSType fCreator,
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCGetIndMapEntry(ComponentInstance inst, Handle entries, long index, long *pos, ICMapEntry *entry)
		FIVEWORDINLINE(0x2F3C, 0x0010, 0x0013, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCGetMapEntry(ComponentInstance inst, Handle entries, long pos, ICMapEntry *entry)
		FIVEWORDINLINE(0x2F3C, 0x000C, 0x0014, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCSetMapEntry(ComponentInstance inst, Handle entries, long pos, ICMapEntry *entry)
		FIVEWORDINLINE(0x2F3C, 0x000C, 0x0015, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCCountProfiles(ComponentInstance inst, long *count) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0027, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCSetProfileName(ComponentInstance inst, ICProfileID thisID, ConstStr255Param name)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x002A, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCAddProfile(ComponentInstance inst, ICProfileID prototypeID, ICProfileID *newID)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x002B, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCDeleteProfile(ComponentInstance inst, ICProfileID thisID) FIVEWORDINLINE(0x2F3C, 0x0004, 0x002C, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCGetMappingInterruptSafe(ComponentInstance inst, Ptr *mappingPref, long *mappingPrefSize)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x002E, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(OSStatus)
	ICCGetSeedInterruptSafe(ComponentInstance inst, long *seed) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0030, 0x7000, 0xA82A);
