...
#define kQTSAllStreams			(QTSStream)0L
	typedef CALLBACK_API(ComponentResult, QTSNotificationProcPtr)(ComponentResult inErr, OSType inNotificationType,
	...
	enum
	{
		...
		kQTSRemainingBufferTimeInfo =
			FOUR_CHAR_CODE('btms'), /* UInt32* remaining buffer time before playback, in microseconds */
	...
	typedef CALLBACK_API(Boolean, QTSModalFilterProcPtr)(DialogPtr inDialog, const EventRecord *inEvent,
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSNewPresentation(const QTSNewPresentationParams *inParams, QTSPresentation *outPresentation);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSNewPresentationFromData(OSType inDataType, const void *inData, const SInt64 *inDataLength,
							   const QTSPresParams *inPresParams, QTSPresentation *outPresentation);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSNewPresentationFromFile(const FSSpec *inFileSpec, const QTSPresParams *inPresParams,
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSNewPresentationFromDataRef(Handle inDataRef, OSType inDataRefType, const QTSPresParams *inPresParams,
								  QTSPresentation *outPresentation);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresExport(QTSPresentation inPresentation, QTSStream inStream, QTSExportParams *inExportParams);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresSetFlags(QTSPresentation inPresentation, SInt32 inFlags, SInt32 inFlagsMask);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresSetInfo(QTSPresentation inPresentation, QTSStream inStream, OSType inSelector, void *ioParam);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresGetInfo(QTSPresentation inPresentation, QTSStream inStream, OSType inSelector, void *ioParam);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresHasCharacteristic(QTSPresentation inPresentation, QTSStream inStream, OSType inCharacteristic,
							 Boolean *outHasIt);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresSetNotificationProc(QTSPresentation inPresentation, QTSNotificationUPP inNotificationProc, void *inRefCon);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresGetNotificationProc(QTSPresentation inPresentation, QTSNotificationUPP *outNotificationProc,
							   void **outRefCon);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresPreview(QTSPresentation inPresentation, QTSStream inStream, const TimeValue64 *inTimeValue, Fixed inRate,
				   SInt32 inFlags);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresPreroll(QTSPresentation inPresentation, QTSStream inStream, UInt32 inTimeValue, Fixed inRate,
				   SInt32 inFlags);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresPreroll64(QTSPresentation inPresentation, QTSStream inStream, const TimeValue64 *inPrerollTime, Fixed inRate,
					 SInt32 inFlags);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresStart(QTSPresentation inPresentation, QTSStream inStream, SInt32 inFlags);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresNewStream(QTSPresentation inPresentation, OSType inDataType, const void *inData, UInt32 inDataLength,
					 SInt32 inFlags, QTSStream *outStream);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresSetPreferredRate(QTSPresentation inPresentation, Fixed inRate, SInt32 inFlags);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresSetEnable(QTSPresentation inPresentation, QTSStream inStream, Boolean inEnableMode);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresGetEnable(QTSPresentation inPresentation, QTSStream inStream, Boolean *outEnableMode);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresSetPresenting(QTSPresentation inPresentation, QTSStream inStream, Boolean inPresentingMode);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresGetPresenting(QTSPresentation inPresentation, QTSStream inStream, Boolean *outPresentingMode);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresSetActiveSegment(QTSPresentation inPresentation, QTSStream inStream, const TimeValue64 *inStartTime,
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresGetActiveSegment(QTSPresentation inPresentation, QTSStream inStream, TimeValue64 *outStartTime,
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresSetPlayHints(QTSPresentation inPresentation, QTSStream inStream, SInt32 inFlags, SInt32 inFlagsMask);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresGetPlayHints(QTSPresentation inPresentation, QTSStream inStream, SInt32 *outFlags);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresSetGWorld(QTSPresentation inPresentation, QTSStream inStream, CGrafPtr inGWorld, GDHandle inGDHandle);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresGetGWorld(QTSPresentation inPresentation, QTSStream inStream, CGrafPtr *outGWorld, GDHandle *outGDHandle);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresSetClip(QTSPresentation inPresentation, QTSStream inStream, RgnHandle inClip);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresGetClip(QTSPresentation inPresentation, QTSStream inStream, RgnHandle *outClip);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresSetMatrix(QTSPresentation inPresentation, QTSStream inStream, const MatrixRecord *inMatrix);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresGetMatrix(QTSPresentation inPresentation, QTSStream inStream, MatrixRecord *outMatrix);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresSetDimensions(QTSPresentation inPresentation, QTSStream inStream, Fixed inWidth, Fixed inHeight);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresGetDimensions(QTSPresentation inPresentation, QTSStream inStream, Fixed *outWidth, Fixed *outHeight);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresSetGraphicsMode(QTSPresentation inPresentation, QTSStream inStream, short inMode, const RGBColor *inOpColor);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresGetGraphicsMode(QTSPresentation inPresentation, QTSStream inStream, short *outMode, RGBColor *outOpColor);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresGetPicture(QTSPresentation inPresentation, QTSStream inStream, PicHandle *outPicture);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresSetVolumes(QTSPresentation inPresentation, QTSStream inStream, short inLeftVolume, short inRightVolume);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresGetVolumes(QTSPresentation inPresentation, QTSStream inStream, short *outLeftVolume, short *outRightVolume);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresGetSettingsAsText(QTSPresentation inPresentation, QTSStream inStream, SInt32 inFlags, OSType inSettingsType,
							 Handle *outText, QTSPanelFilterUPP inPanelFilterProc, void *inPanelFilterProcRefCon);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresSettingsDialog(QTSPresentation inPresentation, QTSStream inStream, SInt32 inFlags,
						  QTSModalFilterUPP inFilterProc, void *inFilterProcRefCon);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresSettingsDialogWithFilters(QTSPresentation inPresentation, QTSStream inStream, SInt32 inFlags,
									 QTSModalFilterUPP inFilterProc, void *inFilterProcRefCon,
									 QTSPanelFilterUPP inPanelFilterProc, void *inPanelFilterProcRefCon);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresSetSettings(QTSPresentation inPresentation, QTSStream inStream, QTAtomSpecPtr inSettings, SInt32 inFlags);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresGetSettings(QTSPresentation inPresentation, QTSStream inStream, QTAtomContainer *outSettings,
					   SInt32 inFlags);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresAddSourcer(QTSPresentation inPresentation, QTSStream inStream, ComponentInstance inSourcer, SInt32 inFlags);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresRemoveSourcer(QTSPresentation inPresentation, QTSStream inStream, ComponentInstance inSourcer,
						 SInt32 inFlags);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPresGetIndSourcer(QTSPresentation inPresentation, QTSStream inStream, UInt32 inIndex,
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSNewStatHelper(QTSPresentation inPresentation, QTSStream inStream, OSType inStatType, SInt32 inFlags,
	...
	QTSStatHelperNext(QTSStatHelper inStatHelper, QTSStatHelperNextParams *ioParams);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSGetOrMakeStatAtomForStream(QTAtomContainer inContainer, QTSStream inStream, QTAtom *outParentAtom);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSInsertStatistic(QTAtomContainer inContainer, QTAtom inParentAtom, OSType inStatType, void *inStatData,
					   UInt32 inStatDataLength, OSType inStatDataFormat, SInt32 inFlags);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSInsertStatisticName(QTAtomContainer inContainer, QTAtom inParentAtom, OSType inStatType, const char *inStatName,
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSInsertStatisticUnits(QTAtomContainer inContainer, QTAtom inParentAtom, OSType inStatType, OSType inUnitsType,
	...
	enum
	{
		...
		/*    kQTSNotUsedForProxyPrefsType = 'nopr',     //        comma-delimited list of URLs that are never used for
		 * proxies*/
		kQTSConnectionMethodPrefsType =
			FOUR_CHAR_CODE('mthd'), /*      connection method (OSType that matches one of the following three)*/
		kQTSDirectConnectPrefsType =
			FOUR_CHAR_CODE('drct'), /*       used if direct connect (QTSDirectConnectPrefsRecord)*/
...
#define kQTSTransAndProxyPrefsVersNum 2 /* prefs atom format version */
	...
	enum
	{
		...
		kQTSConnectionAtomType =
			FOUR_CHAR_CODE('conn'),						/*     connection prefs atom type, one for each transport type*/
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPrefsAddProxySetting(OSType proxyType, SInt32 portID, UInt32 flags, UInt32 seed, Str255 srvrURL);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPrefsFindProxyByType(OSType proxyType, UInt32 flags, UInt32 flagsMask, QTSProxyPref **proxyHndl, SInt16 *count);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPrefsAddConnectionSetting(OSType protocol, SInt32 portID, UInt32 flags, UInt32 seed);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPrefsFindConnectionByType(OSType protocol, UInt32 flags, UInt32 flagsMask, QTSTransportPref **connectionHndl,
								 SInt16 *count);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPrefsAddProxyUserInfo(OSType proxyType, SInt32 flags, SInt32 flagsMask, StringPtr username, StringPtr password);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPrefsFindProxyUserInfoByType(OSType proxyType, SInt32 flags, SInt32 flagsMask, StringPtr username,
									StringPtr password);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPrefsGetInstantOnSettings(QTSInstantOnPref *outPref, SInt32 inFlags);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSPrefsSetInstantOnSettings(QTSInstantOnPref *inPref, SInt32 inFlags);
...
#define QTSNewHandleClear(_s) QTSNewHandle((_s), kQTSMemAllocClearMem, NULL)
	...
	*/
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSNewStreamBuffer(UInt32 inDataSize, SInt32 inFlags, QTSStreamBuffer **outStreamBuffer);
	...
	*/
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTSDuplicateMessage(QTSStreamBuffer *inMessage, SInt32 inFlags, QTSStreamBuffer **outDuplicatedMessage);
	 ...
	 */
	EXTERN_API_C(void)
	QTSStreamBufferDataInfo(QTSStreamBuffer *inStreamBuffer, unsigned char **outDataStart, UInt32 *outDataMaxLength);
	 ...
	 */
	EXTERN_API_C(Boolean)
	QTSGetErrorString(SInt32 inErrorCode, UInt32 inMaxErrorStringLength, char *outErrorString, SInt32 inFlags);
	...
	{
		return (QTSNotificationUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppQTSNotificationProcInfo,
														GetCurrentArchitecture());
	}
#else
#define NewQTSNotificationUPP(userRoutine) \
	(QTSNotificationUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppQTSNotificationProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (QTSPanelFilterUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppQTSPanelFilterProcInfo,
													   GetCurrentArchitecture());
	}
#else
#define NewQTSPanelFilterUPP(userRoutine) \
	(QTSPanelFilterUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppQTSPanelFilterProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (QTSModalFilterUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppQTSModalFilterProcInfo,
													   GetCurrentArchitecture());
	}
#else
#define NewQTSModalFilterUPP(userRoutine) \
	(QTSModalFilterUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppQTSModalFilterProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeQTSModalFilterUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	...
	InvokeQTSNotificationUPP(ComponentResult inErr, OSType inNotificationType, void *inNotificationParams,
							 void *inRefCon, QTSNotificationUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(ComponentResult)
		InvokeQTSNotificationUPP(ComponentResult inErr, OSType inNotificationType, void *inNotificationParams,
								 void *inRefCon, QTSNotificationUPP userUPP)
	{
		return (ComponentResult)CALL_FOUR_PARAMETER_UPP(userUPP, uppQTSNotificationProcInfo, inErr, inNotificationType,
...
#define InvokeQTSNotificationUPP(inErr, inNotificationType, inNotificationParams, inRefCon, userUPP)                \
	(ComponentResult) CALL_FOUR_PARAMETER_UPP((userUPP), uppQTSNotificationProcInfo, (inErr), (inNotificationType), \
											  (inNotificationParams), (inRefCon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(Boolean)
	InvokeQTSPanelFilterUPP(QTSPanelFilterParams *inParams, void *inRefCon, QTSPanelFilterUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeQTSPanelFilterUPP(inParams, inRefCon, userUPP) \
	(Boolean) CALL_TWO_PARAMETER_UPP((userUPP), uppQTSPanelFilterProcInfo, (inParams), (inRefCon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(Boolean)
	InvokeQTSModalFilterUPP(DialogPtr inDialog, const EventRecord *inEvent, SInt16 *ioItemHit, void *inRefCon,
							QTSModalFilterUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(Boolean) InvokeQTSModalFilterUPP(DialogPtr inDialog, const EventRecord *inEvent,
														 SInt16 *ioItemHit, void *inRefCon, QTSModalFilterUPP userUPP)
	{
		return (Boolean)CALL_FOUR_PARAMETER_UPP(userUPP, uppQTSModalFilterProcInfo, inDialog, inEvent, ioItemHit,
												inRefCon);
	}
#else
#define InvokeQTSModalFilterUPP(inDialog, inEvent, ioItemHit, inRefCon, userUPP) \
	(Boolean)                                                                    \
		CALL_FOUR_PARAMETER_UPP((userUPP), uppQTSModalFilterProcInfo, (inDialog), (inEvent), (ioItemHit), (inRefCon))
#endif
#endif
...
#define CallQTSNotificationProc(userRoutine, inErr, inNotificationType, inNotificationParams, inRefCon) \
	InvokeQTSNotificationUPP(inErr, inNotificationType, inNotificationParams, inRefCon, userRoutine)
#define CallQTSPanelFilterProc(userRoutine, inParams, inRefCon) InvokeQTSPanelFilterUPP(inParams, inRefCon, userRoutine)
#define CallQTSModalFilterProc(userRoutine, inDialog, inEvent, ioItemHit, inRefCon) \
