...
#define fpclassify(x)                                  \
	((sizeof(x) == sizeof(double))	? __fpclassifyd(x) \
	 : (sizeof(x) == sizeof(float)) ? __fpclassifyf(x) \
									: __fpclassify(x))
#define isnormal(x) \
	((sizeof(x) == sizeof(double)) ? __isnormald(x) : (sizeof(x) == sizeof(float)) ? __isnormalf(x) : __isnormal(x))
#define isfinite(x) \
	((sizeof(x) == sizeof(double)) ? __isfinited(x) : (sizeof(x) == sizeof(float)) ? __isfinitef(x) : __isfinite(x))
#define isnan(x) ((sizeof(x) == sizeof(double)) ? __isnand(x) : (sizeof(x) == sizeof(float)) ? __isnanf(x) : __isnan(x))
#define signbit(x) \
	((sizeof(x) == sizeof(double)) ? __signbitd(x) : (sizeof(x) == sizeof(float)) ? __signbitf(x) : __signbit(x))
