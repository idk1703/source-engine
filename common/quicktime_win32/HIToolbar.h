	...
	*/
	...
	enum
	{
		...
		kHIToolbarItemValidAttrs = kHIToolbarItemAllowDuplicates | kHIToolbarItemIsSeparator |
								   kHIToolbarItemCantBeRemoved | kHIToolbarItemAnchoredLeft |
...
#define _HIToolbarCreate HIToolbarCreate
	...
	HIToolbarCreate(CFStringRef inIdentifier, OptionBits inAttributes, HIToolbarRef *outToolbar);
...
#define _HIToolbarGetAttributes HIToolbarGetAttributes
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIToolbarGetAttributes(HIToolbarRef inToolbar, OptionBits *outAttributes);
...
#define _HIToolbarChangeAttributes HIToolbarChangeAttributes
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIToolbarChangeAttributes(HIToolbarRef inToolbar, OptionBits inAttrsToSet, OptionBits inAttrsToClear);
...
#define _HIToolbarGetDisplayMode HIToolbarGetDisplayMode
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIToolbarGetDisplayMode(HIToolbarRef inToolbar, HIToolbarDisplayMode *outDisplayMode);
...
#define _HIToolbarSetDisplayMode HIToolbarSetDisplayMode
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIToolbarSetDisplayMode(HIToolbarRef inToolbar, HIToolbarDisplayMode inDisplayMode);
...
#define _HIToolbarGetDisplaySize HIToolbarGetDisplaySize
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIToolbarGetDisplaySize(HIToolbarRef inToolbar, HIToolbarDisplaySize *outSize);
...
#define _HIToolbarSetDisplaySize HIToolbarSetDisplaySize
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIToolbarSetDisplaySize(HIToolbarRef inToolbar, HIToolbarDisplaySize inSize);
...
#define _HIToolbarCopyIdentifier HIToolbarCopyIdentifier
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIToolbarCopyIdentifier(HIToolbarRef inToolbar, CFStringRef *outIdentifier);
...
#define _HIToolbarCopyItems HIToolbarCopyItems
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIToolbarCopyItems(HIToolbarRef inToolbar, CFArrayRef *outItems);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIToolbarCreateItemWithIdentifier(HIToolbarRef inToolbar, CFStringRef inIdentifier,
...
#define _HIToolbarInsertItemAtIndex HIToolbarInsertItemAtIndex
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIToolbarInsertItemAtIndex(HIToolbarRef inToolbar, HIToolbarItemRef inItem, CFIndex inIndex);
...
#define _HIToolbarAppendItem HIToolbarAppendItem
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIToolbarAppendItem(HIToolbarRef inToolbar, HIToolbarItemRef inItem);
...
#define _HIToolbarRemoveItemAtIndex HIToolbarRemoveItemAtIndex
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIToolbarRemoveItemAtIndex(HIToolbarRef inToolbar, CFIndex inIndex);
...
#define _HIToolbarSetDelegate HIToolbarSetDelegate
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIToolbarSetDelegate(HIToolbarRef inToolbar, HIObjectRef inDelegate);
...
#define _HIToolbarItemCreate HIToolbarItemCreate
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIToolbarItemCreate(CFStringRef inIdentifier, OptionBits inOptions, HIToolbarItemRef *outItem);
...
#define _HIToolbarItemCopyIdentifier HIToolbarItemCopyIdentifier
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIToolbarItemCopyIdentifier(HIToolbarItemRef inItem, CFStringRef *outIdentifier);
...
#define _HIToolbarItemGetAttributes HIToolbarItemGetAttributes
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIToolbarItemGetAttributes(HIToolbarItemRef inItem, OptionBits *outAttributes);
...
#define _HIToolbarItemChangeAttributes HIToolbarItemChangeAttributes
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIToolbarItemChangeAttributes(HIToolbarItemRef inItem, OptionBits inAttrsToSet, OptionBits inAttrsToClear);
...
#define _HIToolbarItemSetLabel HIToolbarItemSetLabel
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIToolbarItemSetLabel(HIToolbarItemRef inItem, CFStringRef inLabel);
...
#define _HIToolbarItemCopyLabel HIToolbarItemCopyLabel
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIToolbarItemCopyLabel(HIToolbarItemRef inItem, CFStringRef *outLabel);
...
#define _HIToolbarItemSetHelpText HIToolbarItemSetHelpText
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIToolbarItemSetHelpText(HIToolbarItemRef inItem, CFStringRef inShortText,
...
#define _HIToolbarItemCopyHelpText HIToolbarItemCopyHelpText
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIToolbarItemCopyHelpText(HIToolbarItemRef inItem, CFStringRef *outShortText, /* can be NULL */
...
#define _HIToolbarItemSetCommandID HIToolbarItemSetCommandID
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIToolbarItemSetCommandID(HIToolbarItemRef inItem, MenuCommand inCommandID);
...
#define _HIToolbarItemGetCommandID HIToolbarItemGetCommandID
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIToolbarItemGetCommandID(HIToolbarItemRef inItem, MenuCommand *outCommandID);
...
#define _HIToolbarItemSetIconRef HIToolbarItemSetIconRef
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIToolbarItemSetIconRef(HIToolbarItemRef inItem, IconRef inIcon);
...
#define _HIToolbarItemSetImage HIToolbarItemSetImage
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIToolbarItemSetImage(HIToolbarItemRef inItem, CGImageRef inImage);
...
#define _HIToolbarItemCopyImage HIToolbarItemCopyImage
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIToolbarItemCopyImage(HIToolbarItemRef inItem, CGImageRef *outImage);
...
#define _HIToolbarItemSetMenu HIToolbarItemSetMenu
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIToolbarItemSetMenu(HIToolbarItemRef inItem, MenuRef inMenu);
...
#define _HIToolbarItemCopyMenu HIToolbarItemCopyMenu
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIToolbarItemCopyMenu(HIToolbarItemRef inItem, MenuRef *outMenu);
...
#define _HIToolbarItemGetToolbar HIToolbarItemGetToolbar
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIToolbarItemSetEnabled(HIToolbarItemRef inItem, Boolean inEnabled);
