...
typedef struct TQ3Int64 TQ3Int64;
	...
	enum
	{
		...
		kQ3XMethodTypeObjectReadData =
			FOUR_CHAR_CODE('rddt'), /* Read info from file into buffer or, attach read data to parent */
	 ...
	 */
	EXTERN_API_C(TQ3Status)
	Q3XView_SubmitSubObjectData(TQ3ViewObject view, TQ3XObjectClass objectClass, unsigned long size, void *data,
...
#define Q3FileVersion(majorVersion, minorVersion) \
	(TQ3FileVersion)((((TQ3Uns32)majorVersion & 0xFFFF) << 16) | ((TQ3Uns32)minorVersion & 0xFFFF))
