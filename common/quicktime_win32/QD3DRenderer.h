 ...
 */
	 ...
	 */
	EXTERN_API_C(TQ3Status)
	Q3Renderer_GetConfigurationData(TQ3RendererObject renderer, unsigned char *dataBuffer, unsigned long bufferSize,
...
#define kQ3SolidGeometryObjE	4
	 ...
	 */
	EXTERN_API_C(TQ3Status)
	Q3InteractiveRenderer_GetRAVEDrawContexts(TQ3RendererObject renderer, TQADrawContext **raveDrawContextList,
	...
	enum
	{
		...
		kQ3XAttributeMaskInterpolated =
			...
			kQ3XAttributeMaskAmbientCoefficient | kQ3XAttributeMaskDiffuseColor | kQ3XAttributeMaskSpecularColor |
			kQ3XAttributeMaskSpecularControl | kQ3XAttributeMaskTransparencyColor | kQ3XAttributeMaskSurfaceTangent
	};
 ...
 *****************************************************************************/
	 ...
	 */
	EXTERN_API_C(TQ3Status)
	Q3XDrawRegion_StartAccessToImageBuffer(TQ3XDrawRegion drawRegion, TQ3XDrawRegionServices services,
										   TQ3XDrawRegionDescriptor **descriptor, void **image);
	 ...
	 */
	EXTERN_API_C(TQ3Status)
	Q3XDrawRegion_SetRendererPrivate(TQ3XDrawRegion drawRegion, const void *rendererPrivate,
 ...
 */
	...
	typedef CALLBACK_API_C(TQ3Status, TQ3XRendererModalConfigureMethod)(TQ3RendererObject renderer,
	...
	typedef CALLBACK_API_C(TQ3Status, TQ3XRendererGetNickNameStringMethod)(unsigned char *dataBuffer,
	...
	typedef CALLBACK_API_C(TQ3Status, TQ3XRendererGetConfigurationDataMethod)(TQ3RendererObject renderer,
	...
	typedef CALLBACK_API_C(TQ3Status, TQ3XRendererSetConfigurationDataMethod)(TQ3RendererObject renderer,
																			  unsigned char *dataBuffer,
																			  unsigned long bufferSize,
																			  void *rendererPrivate);
	/******************************************************************************
	...
	typedef CALLBACK_API_C(TQ3Status, TQ3XRendererStartFrameMethod)(TQ3ViewObject view, void *rendererPrivate,
	...
	typedef CALLBACK_API_C(TQ3Status, TQ3XRendererStartPassMethod)(TQ3ViewObject view, void *rendererPrivate,
	...
	typedef CALLBACK_API_C(TQ3Status, TQ3XRendererFlushFrameMethod)(TQ3ViewObject view, void *rendererPrivate,
																	TQ3DrawContextObject drawContext);
	/*
	...
	typedef CALLBACK_API_C(TQ3Status, TQ3XRendererEndFrameMethod)(TQ3ViewObject view, void *rendererPrivate,
																  TQ3DrawContextObject drawContext);
	/*
	...
	typedef CALLBACK_API_C(TQ3Boolean, TQ3XRendererIsBoundingBoxVisibleMethod)(TQ3ViewObject view,
																			   void *rendererPrivate,
	...
	typedef CALLBACK_API_C(TQ3XFunctionPointer,
						   TQ3XRendererSubmitGeometryMetaHandlerMethod)(TQ3ObjectType geometryType);
	/*
	 ...
	 */
	typedef CALLBACK_API_C(TQ3Status, TQ3XRendererSubmitGeometryMethod)(TQ3ViewObject view, void *rendererPrivate,
	 ...
	 */
	typedef CALLBACK_API_C(TQ3Status, TQ3XRendererSubmitCameraMethod)(TQ3ViewObject view, void *rendererPrivate,
																	  TQ3CameraObject camera, const void *publicData);
	/*
	 *  Light MetaHandler
	 *
	 *  This metaHandler, if supplied, indicates that your renderer
	 ...
	 */
	typedef CALLBACK_API_C(TQ3Status, TQ3XRendererSubmitLightMethod)(TQ3ViewObject view, void *rendererPrivate,
																	 TQ3LightObject light, const void *publicData);
	/*
	 *
	 *  Update methods
	 *
	 ...
	 */
	typedef CALLBACK_API_C(TQ3Status, TQ3XRendererUpdateStyleMethod)(TQ3ViewObject view, void *rendererPrivate,
																	 const void *publicData);
	/*
	 *  Attributes
	 */
	...
	typedef CALLBACK_API_C(TQ3XFunctionPointer,
						   TQ3XRendererUpdateAttributeMetaHandlerMethod)(TQ3AttributeType attributeType);
	/*
	 *  The TQ3XRendererUpdateStyleMetaHandlerMethod switches on attributeType
	 *  of kQ3AttributeTypeFoo and returns methods of type:
	 */
	typedef CALLBACK_API_C(TQ3Status, TQ3XRendererUpdateAttributeMethod)(TQ3ViewObject view, void *rendererPrivate,
																		 const void *publicData);
	/*
	 *  Shaders
	 */
	 ...
	 */
	typedef CALLBACK_API_C(TQ3Status, TQ3XRendererUpdateShaderMethod)(TQ3ViewObject view, void *rendererPrivate,
	 ...
	 */
	typedef CALLBACK_API_C(TQ3Status, TQ3XRendererUpdateMatrixMethod)(TQ3ViewObject view, void *rendererPrivate,
