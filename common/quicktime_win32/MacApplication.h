...
#pragma import on
	...
	SetSystemUIMode(SystemUIMode inMode, SystemUIOptions inOptions);
	 ...
	 */
	EXTERN_API_C(void)
	GetSystemUIMode(SystemUIMode *outMode,		  /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	CreateCGImageFromPixMaps(PixMapHandle inImage, PixMapHandle inMask, CGImageRef *outImage);
