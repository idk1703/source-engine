...
enum
{
	cInternalFinderObject =
		FOUR_CHAR_CODE('obj ') /* cReference - used to distinguish objects used inside the Finder only*/
};
...
enum
{
	...
	cContentSpace =
		FOUR_CHAR_CODE('dwnd'), /*          cWindow                    = 'cwin',       // defined in AERegistry.r*/
...
enum
{
	...
	pIconBitmap =
		FOUR_CHAR_CODE('iimg'), /*    pID                           = 'ID  ',        // defined in AERegistry.r*/
...
enum
{
	...
	pPreviousView =
		FOUR_CHAR_CODE('svew'), /*    pSelection                    = 'sele',       // defined in AERegistry.r*/
...
enum
{
	...
	pPartitionSpaceUsed =
		FOUR_CHAR_CODE('pusd'), /*    pIsScriptable                 = 'isab',       // defined in AERegistry.r*/
								/*    pVisible                    = 'pvis'      // defined in AERegistry.r*/
...
enum
{
	...
	/*    pVersion                    = 'vers',       // defined in AERegistry.r*/
	pViewPreferences =
		FOUR_CHAR_CODE('pvwp'),			 /*    pVisible                    = 'pvis',       // defined in AERegistry.r*/
...
enum
{
	...
	errFinderCorruptOpenFolderList =
		-15290, /* was -15276 in Finder 8.6 and earlier, but that conflicted with General Controls*/
	errFinderNoInvisibleFiles =
		-15291, /* was -15277 in Finder 8.6 and earlier, but that conflicted with General Controls*/
