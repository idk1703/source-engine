...
#pragma parameter __D0 LaunchApplication(__A0)
	 ...
	 */
	EXTERN_API(OSErr)
	LaunchDeskAccessory(const FSSpec *pFileSpec, ConstStr255Param pDAName) THREEWORDINLINE(0x3F3C, 0x0036, 0xA88F);
...
*/
	 ...
	 */
	EXTERN_API(OSErr)
	ShowHideProcess(const ProcessSerialNumber *psn, Boolean visible) THREEWORDINLINE(0x3F3C, 0x0060, 0xA88F);
