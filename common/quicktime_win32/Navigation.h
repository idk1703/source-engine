...
#pragma pack(2)
	...
	typedef CALLBACK_API(void, NavEventProcPtr)(NavEventCallbackMessage callBackSelector, NavCBRecPtr callBackParms,
												void *callBackUD);
	/* for preview support: */
	typedef CALLBACK_API(Boolean, NavPreviewProcPtr)(NavCBRecPtr callBackParms, void *callBackUD);
	/* filtering callback information: */
	typedef CALLBACK_API(Boolean, NavObjectFilterProcPtr)(AEDesc *theItem, void *info, void *callBackUD,
...
#define NewNavEventUPP(userRoutine) \
	...
	{
		return (NavPreviewUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppNavPreviewProcInfo,
												   GetCurrentArchitecture());
	}
#else
#define NewNavPreviewUPP(userRoutine) \
	(NavPreviewUPP) NewRoutineDescriptor((ProcPtr)(userRoutine), uppNavPreviewProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (NavObjectFilterUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppNavObjectFilterProcInfo,
														GetCurrentArchitecture());
	}
#else
#define NewNavObjectFilterUPP(userRoutine) \
	(NavObjectFilterUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppNavObjectFilterProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeNavObjectFilterUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(void)
	InvokeNavEventUPP(NavEventCallbackMessage callBackSelector, NavCBRecPtr callBackParms, void *callBackUD,
					  NavEventUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void) InvokeNavEventUPP(NavEventCallbackMessage callBackSelector, NavCBRecPtr callBackParms,
												void *callBackUD, NavEventUPP userUPP)
	{
...
#define InvokeNavEventUPP(callBackSelector, callBackParms, callBackUD, userUPP) \
	...
	InvokeNavPreviewUPP(NavCBRecPtr callBackParms, void *callBackUD, NavPreviewUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeNavPreviewUPP(callBackParms, callBackUD, userUPP) \
	(Boolean) CALL_TWO_PARAMETER_UPP((userUPP), uppNavPreviewProcInfo, (callBackParms), (callBackUD))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(Boolean)
	InvokeNavObjectFilterUPP(AEDesc *theItem, void *info, void *callBackUD, NavFilterModes filterMode,
							 NavObjectFilterUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(Boolean) InvokeNavObjectFilterUPP(AEDesc *theItem, void *info, void *callBackUD,
														  NavFilterModes filterMode, NavObjectFilterUPP userUPP)
	{
		return (Boolean)CALL_FOUR_PARAMETER_UPP(userUPP, uppNavObjectFilterProcInfo, theItem, info, callBackUD,
												filterMode);
	}
#else
#define InvokeNavObjectFilterUPP(theItem, info, callBackUD, filterMode, userUPP) \
	(Boolean)                                                                    \
		CALL_FOUR_PARAMETER_UPP((userUPP), uppNavObjectFilterProcInfo, (theItem), (info), (callBackUD), (filterMode))
#endif
#endif
...
#define CallNavEventProc(userRoutine, callBackSelector, callBackParms, callBackUD) \
...
#define CallNavObjectFilterProc(userRoutine, theItem, info, callBackUD, filterMode) \
	...
	enum
	{
		...
		kNavCtlSelectEditFileName =
			25, /*    select save dlog file name parms->ControlEditTextSelectionRec*, v1.1 or greater */
	...
	enum
	{
		...
		kNavDontConfirmReplacement =
			0x00010000, /* don't show the "Replace File?" alert on save conflict, v3.0 or greater */
		kNavPreserveSaveFileExtension =
			0x00020000 /* extension in default file name is preserved and initially hidden, v3.1 or greater */
	};
	...
	NavGetFile(AEDesc *defaultLocation,								   /* can be NULL */
			   NavReplyRecord *reply, NavDialogOptions *dialogOptions, /* can be NULL */
	...
	NavPutFile(AEDesc *defaultLocation,								   /* can be NULL */
			   NavReplyRecord *reply, NavDialogOptions *dialogOptions, /* can be NULL */
			   NavEventUPP eventProc,								   /* can be NULL */
			   OSType fileType, OSType fileCreator, void *callBackUD); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	NavAskSaveChanges(NavDialogOptions *dialogOptions, NavAskSaveChangesAction action, NavAskSaveChangesResult *reply,
					  NavEventUPP eventProc, /* can be NULL */
					  void *callBackUD);	 /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	NavCustomAskSaveChanges(NavDialogOptions *dialogOptions, NavAskSaveChangesResult *reply,
							NavEventUPP eventProc, /* can be NULL */
							void *callBackUD);	   /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	NavAskDiscardChanges(NavDialogOptions *dialogOptions, NavAskDiscardChangesResult *reply,
						 NavEventUPP eventProc, /* can be NULL */
						 void *callBackUD);		/* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	NavCustomControl(NavDialogRef dialog, NavCustomControlMessage selector, void *parms);
	 ...
	 */
	EXTERN_API(OSErr)
	NavCreatePreview(AEDesc *theObject, OSType previewDataType, const void *previewData, Size previewDataSize);
