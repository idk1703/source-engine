...
/*  Tasks  */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	CreateSoftwareInterrupt(SoftwareInterruptHandler handler, TaskID task, void *p1, Boolean persistent,
...
/*  Secondary Interrupts  */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	CallSecondaryInterruptHandler2(SecondaryInterruptHandler2 theHandler, ExceptionHandler exceptionHandler, void *p1,
								   void *p2);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	QueueSecondaryInterruptHandler(SecondaryInterruptHandler2 theHandler, ExceptionHandler exceptionHandler, void *p1,
								   void *p2);
...
/*  Timers  */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	SetInterruptTimer(const AbsoluteTime *expirationTime, SecondaryInterruptHandler2 handler, void *p1,
					  TimerID *theTimer);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	SetPersistentTimer(Duration frequency, SecondaryInterruptHandler2 theHandler, void *p1, TimerID *theTimer);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	GetPageInformation(AddressSpaceID addressSpace, ConstLogicalAddress base, ByteCount length, PBVersion version,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	SetProcessorCacheMode(AddressSpaceID addressSpace, ConstLogicalAddress base, ByteCount length,
...
#define kAAPLDeviceLogicalAddress "AAPL,address"
	 ...
	 */
	EXTERN_API_C(OSErr)
	GetIOCommandInfo(IOCommandID theID, IOCommandContents *theContents, IOCommandCode *theCommand,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	FlushProcessorCache(AddressSpaceID spaceID, LogicalAddress base, ByteCount length);
	 ...
	 */
	EXTERN_API_C(void)
	GetTimeBaseInfo(UInt32 *minAbsoluteTimeDelta, UInt32 *theAbsoluteTimeToNanosecondNumerator,
					UInt32 *theAbsoluteTimeToNanosecondDenominator, UInt32 *theProcessorToAbsoluteTimeNumerator,
	 ...
	 */
	EXTERN_API_C(AbsoluteTime)
	SubAbsoluteFromAbsolute(AbsoluteTime leftAbsoluteTime, AbsoluteTime rightAbsoluteTime);
	 ...
	 */
	EXTERN_API_C(Nanoseconds)
	AbsoluteDeltaToNanoseconds(AbsoluteTime leftAbsoluteTime, AbsoluteTime rightAbsoluteTime);
	 ...
	 */
	EXTERN_API_C(Duration)
	AbsoluteDeltaToDuration(AbsoluteTime leftAbsoluteTime, AbsoluteTime rightAbsoluteTime);
...
#define kISTPropertyName "driver-ist"
	...
	typedef CALLBACK_API_C(InterruptMemberNumber, InterruptHandler)(InterruptSetMember ISTmember, void *refCon,
																	UInt32 theIntCount);
...
/*  Interrupt Services  */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	CreateInterruptSet(InterruptSetID parentSet, InterruptMemberNumber parentMember, InterruptMemberNumber setSize,
					   InterruptSetID *setID, InterruptSetOptions options);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	InstallInterruptFunctions(InterruptSetID setID, InterruptMemberNumber member, void *refCon,
							  InterruptHandler handlerFunction, InterruptEnabler enableFunction,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	GetInterruptFunctions(InterruptSetID setID, InterruptMemberNumber member, void **refCon,
						  InterruptHandler *handlerFunction, InterruptEnabler *enableFunction,
						  InterruptDisabler *disableFunction);
