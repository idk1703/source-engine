...
#ifdef __cplusplus
	inline DEFINE_API_C(CursorDeviceCustomButtonUPP)
		NewCursorDeviceCustomButtonUPP(CursorDeviceCustomButtonProcPtr userRoutine)
	{
		return (CursorDeviceCustomButtonUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppCursorDeviceCustomButtonProcInfo, GetCurrentArchitecture());
	}
#else
#define NewCursorDeviceCustomButtonUPP(userRoutine) \
	(CursorDeviceCustomButtonUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppCursorDeviceCustomButtonProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeCursorDeviceCustomButtonUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(void)
	InvokeCursorDeviceCustomButtonUPP(CursorDevicePtr ourDevice, short button, CursorDeviceCustomButtonUPP userUPP);
...
#define CallCursorDeviceCustomButtonProc(userRoutine, ourDevice, button) \
	 ...
	 */
	EXTERN_API(OSErr)
	CursorDeviceMove(CursorDevicePtr ourDevice, long deltaX, long deltaY) TWOWORDINLINE(0x7000, 0xAADB);
	 ...
	 */
	EXTERN_API(OSErr)
	CursorDeviceMoveTo(CursorDevicePtr ourDevice, long absX, long absY) TWOWORDINLINE(0x7001, 0xAADB);
	 ...
	 */
	EXTERN_API(OSErr)
	CursorDeviceButtons(CursorDevicePtr ourDevice, short buttons) TWOWORDINLINE(0x7003, 0xAADB);
	 ...
	 */
	EXTERN_API(OSErr)
	CursorDeviceButtonOp(CursorDevicePtr ourDevice, short buttonNumber, ButtonOpcode opcode, long data)
	 ...
	 */
	EXTERN_API(OSErr)
	CursorDeviceSetButtons(CursorDevicePtr ourDevice, short numberOfButtons) TWOWORDINLINE(0x7007, 0xAADB);
	 ...
	 */
	EXTERN_API(OSErr)
	CursorDeviceSetAcceleration(CursorDevicePtr ourDevice, Fixed acceleration) TWOWORDINLINE(0x7008, 0xAADB);
	 ...
	 */
	EXTERN_API(OSErr)
	CursorDeviceDoubleTime(CursorDevicePtr ourDevice, long durationTicks) TWOWORDINLINE(0x7009, 0xAADB);
	 ...
	 */
	EXTERN_API(OSErr)
	CursorDeviceUnitsPerInch(CursorDevicePtr ourDevice, Fixed resolution) TWOWORDINLINE(0x700A, 0xAADB);
...
*/
	 ...
	 */
	EXTERN_API(OSErr)
	CrsrDevMoveTo(CursorDevicePtr ourDevice, long absX, long absY) TWOWORDINLINE(0x7001, 0xAADB);
