...
#pragma pack(2)
	 ...
	 */
	EXTERN_API(ComponentResult)
	QTSMediaSetIndStreamInfo(MediaHandler mh, SInt32 inIndex, OSType inSelector, void *ioParams)
	 ...
	 */
	EXTERN_API(ComponentResult)
	QTSMediaGetIndStreamInfo(MediaHandler mh, SInt32 inIndex, OSType inSelector, void *ioParams)
