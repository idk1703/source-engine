	...
	**************************************************************************/
	...
	/*
		...
		declares default mode settings are used.
			*/
	typedef CALLBACK_API(OSErr, OSACreateAppleEventProcPtr)(AEEventClass theAEEventClass, AEEventID theAEEventID,
															const AEAddressDesc *target, short returnID,
															long transactionID, AppleEvent *result, long refCon);
	typedef CALLBACK_API(OSErr, OSASendProcPtr)(const AppleEvent *theAppleEvent, AppleEvent *reply, AESendMode sendMode,
												AESendPriority sendPriority, long timeOutInTicks, AEIdleUPP idleProc,
	...
	{
		return (OSACreateAppleEventUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppOSACreateAppleEventProcInfo,
...
#define DisposeOSASendUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeOSACreateAppleEventUPP(AEEventClass theAEEventClass, AEEventID theAEEventID, const AEAddressDesc *target,
								 short returnID, long transactionID, AppleEvent *result, long refCon,
	...
	inline DEFINE_API_C(OSErr)
		InvokeOSACreateAppleEventUPP(AEEventClass theAEEventClass, AEEventID theAEEventID, const AEAddressDesc *target,
									 ...
									 OSACreateAppleEventUPP userUPP)
	{
		return (OSErr)CALL_SEVEN_PARAMETER_UPP(userUPP, uppOSACreateAppleEventProcInfo, theAEEventClass, theAEEventID,
											   target, returnID, transactionID, result, refCon);
	}
#else
#define InvokeOSACreateAppleEventUPP(theAEEventClass, theAEEventID, target, returnID, transactionID, result, refCon, \
									 userUPP)                                                                        \
	(OSErr) CALL_SEVEN_PARAMETER_UPP((userUPP), uppOSACreateAppleEventProcInfo, (theAEEventClass), (theAEEventID),   \
									 (target), (returnID), (transactionID), (result), (refCon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeOSASendUPP(const AppleEvent *theAppleEvent, AppleEvent *reply, AESendMode sendMode,
					 AESendPriority sendPriority, long timeOutInTicks, AEIdleUPP idleProc, AEFilterUPP filterProc,
					 long refCon, OSASendUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSErr) InvokeOSASendUPP(const AppleEvent *theAppleEvent, AppleEvent *reply, AESendMode sendMode,
												AESendPriority sendPriority, long timeOutInTicks, AEIdleUPP idleProc,
												AEFilterUPP filterProc, long refCon, OSASendUPP userUPP)
	{
		return (OSErr)CALL_EIGHT_PARAMETER_UPP(userUPP, uppOSASendProcInfo, theAppleEvent, reply, sendMode,
											   sendPriority, timeOutInTicks, idleProc, filterProc, refCon);
	}
#else
#define InvokeOSASendUPP(theAppleEvent, reply, sendMode, sendPriority, timeOutInTicks, idleProc, filterProc, refCon, \
						 userUPP)                                                                                    \
	(OSErr) CALL_EIGHT_PARAMETER_UPP((userUPP), uppOSASendProcInfo, (theAppleEvent), (reply), (sendMode),            \
									 (sendPriority), (timeOutInTicks), (idleProc), (filterProc), (refCon))
#endif
#endif
...
#define CallOSACreateAppleEventProc(userRoutine, theAEEventClass, theAEEventID, target, returnID, transactionID, \
									result, refCon)                                                              \
	InvokeOSACreateAppleEventUPP(theAEEventClass, theAEEventID, target, returnID, transactionID, result, refCon, \
								 userRoutine)
#define CallOSASendProc(userRoutine, theAppleEvent, reply, sendMode, sendPriority, timeOutInTicks, idleProc,     \
						filterProc, refCon)                                                                      \
	InvokeOSASendUPP(theAppleEvent, reply, sendMode, sendPriority, timeOutInTicks, idleProc, filterProc, refCon, \
					 userRoutine)
	...
	*/
	 ...
	 */
	EXTERN_API(OSAError)
	OSALoad(ComponentInstance scriptingComponent, const AEDesc *scriptData, long modeFlags, OSAID *resultingScriptID)
	 ...
	 */
	EXTERN_API(OSAError)
	OSAStore(ComponentInstance scriptingComponent, OSAID scriptID, DescType desiredType, long modeFlags,
	 ...
	 */
	EXTERN_API(OSAError)
	OSAExecute(ComponentInstance scriptingComponent, OSAID compiledScriptID, OSAID contextID, long modeFlags,
	 ...
	 */
	EXTERN_API(OSAError)
	OSADisplay(ComponentInstance scriptingComponent, OSAID scriptValueID, DescType desiredType, long modeFlags,
	 ...
	 */
	EXTERN_API(OSAError)
	OSAScriptError(ComponentInstance scriptingComponent, OSType selector, DescType desiredType,
	 ...
	 */
	EXTERN_API(OSAError)
	OSASetScriptInfo(ComponentInstance scriptingComponent, OSAID scriptID, OSType selector, long value)
	 ...
	 */
	EXTERN_API(OSAError)
	OSAGetScriptInfo(ComponentInstance scriptingComponent, OSAID scriptID, OSType selector, long *result)
	...
	*/
	...
	{
		return (OSAActiveUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppOSAActiveProcInfo,
												  GetCurrentArchitecture());
	}
#else
...
#define CallOSAActiveProc(userRoutine, refCon) InvokeOSAActiveUPP(refCon, userRoutine)
	 ...
	 */
	EXTERN_API(OSAError)
	OSASetActiveProc(ComponentInstance scriptingComponent, OSAActiveUPP activeProc, long refCon)
	 ...
	 */
	EXTERN_API(OSAError)
	OSAGetActiveProc(ComponentInstance scriptingComponent, OSAActiveUPP *activeProc, long *refCon)
	...
	**************************************************************************/
	 ...
	 */
	EXTERN_API(OSAError)
	OSAScriptingComponentName(ComponentInstance scriptingComponent, AEDesc *resultingScriptingComponentName)
	 ...
	 */
	EXTERN_API(OSAError)
	OSACompile(ComponentInstance scriptingComponent, const AEDesc *sourceData, long modeFlags,
	...
	**************************************************************************/
	 ...
	 */
	EXTERN_API(OSAError)
	OSAGetSource(ComponentInstance scriptingComponent, OSAID scriptID, DescType desiredType,
	...
	**************************************************************************/
	 ...
	 */
	EXTERN_API(OSAError)
	OSACoerceFromDesc(ComponentInstance scriptingComponent, const AEDesc *scriptData, long modeFlags,
	 ...
	 */
	EXTERN_API(OSAError)
	OSACoerceToDesc(ComponentInstance scriptingComponent, OSAID scriptID, DescType desiredType, long modeFlags,
	...
	*/
	 ...
	 */
	EXTERN_API(OSAError)
	OSASetSendProc(ComponentInstance scriptingComponent, OSASendUPP sendProc, long refCon)
	 ...
	 */
	EXTERN_API(OSAError)
	OSAGetSendProc(ComponentInstance scriptingComponent, OSASendUPP *sendProc, long *refCon)
	 ...
	 */
	EXTERN_API(OSAError)
	OSASetCreateProc(ComponentInstance scriptingComponent, OSACreateAppleEventUPP createProc, long refCon)
	 ...
	 */
	EXTERN_API(OSAError)
	OSAGetCreateProc(ComponentInstance scriptingComponent, OSACreateAppleEventUPP *createProc, long *refCon)
	 ...
	 */
	EXTERN_API(OSAError)
	OSASetDefaultTarget(ComponentInstance scriptingComponent, const AEAddressDesc *target)
	...
	**************************************************************************/
	 ...
	 */
	EXTERN_API(OSAError)
	OSAStartRecording(ComponentInstance scriptingComponent, OSAID *compiledScriptToModifyID)
	...
	**************************************************************************/
	 ...
	 */
	EXTERN_API(OSAError)
	OSALoadExecute(ComponentInstance scriptingComponent, const AEDesc *scriptData, OSAID contextID, long modeFlags,
	 ...
	 */
	EXTERN_API(OSAError)
	OSACompileExecute(ComponentInstance scriptingComponent, const AEDesc *sourceData, OSAID contextID, long modeFlags,
	 ...
	 */
	EXTERN_API(OSAError)
	OSADoScript(ComponentInstance scriptingComponent, const AEDesc *sourceData, OSAID contextID, DescType desiredType,
				long modeFlags, AEDesc *resultingText) FIVEWORDINLINE(0x2F3C, 0x0014, 0x0603, 0x7000, 0xA82A);
	...
	*/
	 ...
	 */
	EXTERN_API(OSAError)
	OSAGetCurrentDialect(ComponentInstance scriptingComponent, short *resultingDialectCode)
	 ...
	 */
	EXTERN_API(OSAError)
	OSAAvailableDialects(ComponentInstance scriptingComponent, AEDesc *resultingDialectInfoList)
	 ...
	 */
	EXTERN_API(OSAError)
	OSAGetDialectInfo(ComponentInstance scriptingComponent, short dialectCode, OSType selector,
	 ...
	 */
	EXTERN_API(OSAError)
	OSAAvailableDialectCodeList(ComponentInstance scriptingComponent, AEDesc *resultingDialectCodeList)
	...
	**************************************************************************/
	 ...
	 */
	EXTERN_API(OSAError)
	OSASetResumeDispatchProc(ComponentInstance scriptingComponent, AEEventHandlerUPP resumeDispatchProc, long refCon)
	 ...
	 */
	EXTERN_API(OSAError)
	OSAGetResumeDispatchProc(ComponentInstance scriptingComponent, AEEventHandlerUPP *resumeDispatchProc, long *refCon)
	 ...
	 */
	EXTERN_API(OSAError)
	OSAExecuteEvent(ComponentInstance scriptingComponent, const AppleEvent *theAppleEvent, OSAID contextID,
	 ...
	 */
	EXTERN_API(OSAError)
	OSADoEvent(ComponentInstance scriptingComponent, const AppleEvent *theAppleEvent, OSAID contextID, long modeFlags,
	 ...
	 */
	EXTERN_API(OSAError)
	OSAMakeContext(ComponentInstance scriptingComponent, const AEDesc *contextName, OSAID parentContext,
