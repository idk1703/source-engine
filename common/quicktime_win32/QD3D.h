...
#error /*   NULL is undefined?  */
	...
	struct TQ3CompressedPixmap
	{
		...
		TQ3StorageObject imageDesc; /* storage obj containing image description created by Quicktime to store info about
									   compressed image */
...
#define kQ3XMethodTypeObjectIsDrawable \
	Q3_METHOD_TYPE('i', 's', 'd',      \
				   'r') /* return true from the metahandler if this object can be submitted in a rendering loop */
...
#define Q3_FOUR_CHARACTER_CONSTANT(a, b, c, d)                                                  \
	((const unsigned long)((const unsigned long)(a) << 24) | ((const unsigned long)(b) << 16) | \
	 ((const unsigned long)(c) << 8) | ((const unsigned long)(d)))
