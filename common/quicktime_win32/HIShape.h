...
#pragma import on
	 ...
	 */
	EXTERN_API_C(HIShapeRef)
	HIShapeCreateIntersection(HIShapeRef inShape1, HIShapeRef inShape2);
	 ...
	 */
	EXTERN_API_C(HIShapeRef)
	HIShapeCreateDifference(HIShapeRef inShape1, HIShapeRef inShape2);
	 ...
	 */
	EXTERN_API_C(HIShapeRef)
	HIShapeCreateUnion(HIShapeRef inShape1, HIShapeRef inShape2);
	 ...
	 */
	EXTERN_API_C(Boolean)
	HIShapeContainsPoint(HIShapeRef inShape, const HIPoint *inPoint);
	 ...
	 */
	EXTERN_API_C(HIRect *)
	HIShapeGetBounds(HIShapeRef inShape, HIRect *outRect);
	...
	HIShapeGetAsQDRgn(HIShapeRef inShape, RgnHandle outRgn);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIShapeReplacePathInCGContext(HIShapeRef inShape, CGContextRef inContext);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIShapeSetQDClip(HIShapeRef inShape, CGrafPtr inPort);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIShapeIntersect(HIShapeRef inShape1, HIShapeRef inShape2, HIMutableShapeRef outResult);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIShapeDifference(HIShapeRef inShape1, HIShapeRef inShape2, HIMutableShapeRef outResult);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIShapeUnion(HIShapeRef inShape1, HIShapeRef inShape2, HIMutableShapeRef outResult);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIShapeOffset(HIMutableShapeRef inShape, float inDX, float inDY);
