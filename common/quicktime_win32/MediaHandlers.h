...
#pragma pack(2)
	...
	CallComponentExecuteWiredAction(ComponentInstance ci, QTAtomContainer actionContainer, QTAtom actionAtom,
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaSetChunkManagementFlags(MediaHandler mh, UInt32 flags, UInt32 flagsMask)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x0415, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaGetChunkManagementFlags(MediaHandler mh, UInt32 *flags) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0416, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaSetPurgeableChunkMemoryAllowance(MediaHandler mh, Size allowance)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x0417, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaGetPurgeableChunkMemoryAllowance(MediaHandler mh, Size *allowance)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x0418, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaIdle(MediaHandler mh, TimeValue atMediaTime, long flagsIn, long *flagsOut, const TimeRecord *movieTime)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaGetMediaInfo(MediaHandler mh, Handle h) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0504, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaPutMediaInfo(MediaHandler mh, Handle h) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0505, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaSetActive(MediaHandler mh, Boolean enableMedia) FIVEWORDINLINE(0x2F3C, 0x0002, 0x0506, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaSetRate(MediaHandler mh, Fixed rate) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0507, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaGGetStatus(MediaHandler mh, ComponentResult *statusErr) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0508, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaSetClip(MediaHandler mh, RgnHandle theClip) FIVEWORDINLINE(0x2F3C, 0x0004, 0x050E, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaGetTrackOpaque(MediaHandler mh, Boolean *trackIsOpaque) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0510, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaGSetVolume(MediaHandler mh, short volume) FIVEWORDINLINE(0x2F3C, 0x0002, 0x0513, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaSetSoundBalance(MediaHandler mh, short balance) FIVEWORDINLINE(0x2F3C, 0x0002, 0x0514, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaGetSoundBalance(MediaHandler mh, short *balance) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0515, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaGetNextBoundsChange(MediaHandler mh, TimeValue *when) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0516, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaPreroll(MediaHandler mh, TimeValue time, Fixed rate) FIVEWORDINLINE(0x2F3C, 0x0008, 0x0518, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaSampleDescriptionChanged(MediaHandler mh, long index) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0519, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaGetOffscreenBufferSize(MediaHandler mh, Rect *bounds, short depth, CTabHandle ctab)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaSetHints(MediaHandler mh, long hints) FIVEWORDINLINE(0x2F3C, 0x0004, 0x051C, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaGetName(MediaHandler mh, Str255 name, long requestedLanguage, long *actualLanguage)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaForceUpdate(MediaHandler mh, long forceUpdateFlags) FIVEWORDINLINE(0x2F3C, 0x0004, 0x051E, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaGetDrawingRgn(MediaHandler mh, RgnHandle *partialRgn) FIVEWORDINLINE(0x2F3C, 0x0004, 0x051F, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaGSetActiveSegment(MediaHandler mh, TimeValue activeStart, TimeValue activeDuration)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaInvalidateRegion(MediaHandler mh, RgnHandle invalRgn) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0521, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaGetNextStepTime(MediaHandler mh, short flags, TimeValue mediaTimeIn, TimeValue *mediaTimeOut, Fixed rate)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaSetNonPrimarySourceData(MediaHandler mh, long inputIndex, long dataDescriptionSeed, Handle dataDescription,
								 void *data, long dataSize, ICMCompletionProcRecordPtr asyncCompletionProc,
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaGetSampleDataPointer(MediaHandler mh, long sampleNum, Ptr *dataPtr, long *dataSize, long *sampleDescIndex)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaCompare(MediaHandler mh, Boolean *isOK, Media srcMedia, ComponentInstance srcMediaComponent)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaGetClock(MediaHandler mh, ComponentInstance *clock) FIVEWORDINLINE(0x2F3C, 0x0004, 0x052E, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaSetSoundLocalizationData(MediaHandler mh, Handle data) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0531, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaGetInvalidRegion(MediaHandler mh, RgnHandle rgn) FIVEWORDINLINE(0x2F3C, 0x0004, 0x053C, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaSampleDescriptionB2N(MediaHandler mh, SampleDescriptionHandle sampleDescriptionH)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaSampleDescriptionN2B(MediaHandler mh, SampleDescriptionHandle sampleDescriptionH)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaQueueNonPrimarySourceData(MediaHandler mh, long inputIndex, long dataDescriptionSeed, Handle dataDescription,
								   void *data, long dataSize, ICMCompletionProcRecordPtr asyncCompletionProc,
								   const ICMFrameTimeRecord *frameTime, ICMConvertDataFormatUPP transferProc,
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaMakeMediaTimeTable(MediaHandler mh, long **offsets, TimeValue startTime, TimeValue endTime,
							TimeValue timeIncrement, short firstDataRefIndex, short lastDataRefIndex,
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaHitTestForTargetRefCon(MediaHandler mh, long flags, Point loc, long *targetRefCon)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaHitTestTargetRefCon(MediaHandler mh, long targetRefCon, long flags, Point loc, Boolean *wasHit)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaGetActionsForQTEvent(MediaHandler mh, QTEventRecordPtr event, long targetRefCon, QTAtomContainer *container,
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaDisposeTargetRefCon(MediaHandler mh, long targetRefCon) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0549, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaTargetRefConsEqual(MediaHandler mh, long firstRefCon, long secondRefCon, Boolean *equal)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaSetActionsCallback(MediaHandler mh, ActionsUPP actionsCallbackProc, void *refcon)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaPrePrerollBegin(MediaHandler mh, TimeValue time, Fixed rate, PrePrerollCompleteUPP completeProc, void *refcon)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaPrePrerollCancel(MediaHandler mh, void *refcon) FIVEWORDINLINE(0x2F3C, 0x0004, 0x054D, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaGetEffectiveVolume(MediaHandler mh, short *volume) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0551, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaResolveTargetRefCon(MediaHandler mh, QTAtomContainer container, QTAtom atom, long *targetRefCon)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaSetScreenLock(MediaHandler mh, Boolean lockIt) FIVEWORDINLINE(0x2F3C, 0x0002, 0x0557, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaSetDoMCActionCallback(MediaHandler mh, DoMCActionUPP doMCActionCallbackProc, void *refcon)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaGetErrorString(MediaHandler mh, ComponentResult theError, Str255 errorString)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaGetSoundEqualizerBands(MediaHandler mh, MediaEQSpectrumBandsRecordPtr spectrumInfo)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaSetSoundEqualizerBands(MediaHandler mh, MediaEQSpectrumBandsRecordPtr spectrumInfo)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaGetPublicInfo(MediaHandler mh, OSType infoSelector, void *infoDataPtr, Size *ioDataSize)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaSetPublicInfo(MediaHandler mh, OSType infoSelector, void *infoDataPtr, Size dataSize)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaGetUserPreferredCodecs(MediaHandler mh, CodecComponentHandle *userPreferredCodecs)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaSetUserPreferredCodecs(MediaHandler mh, CodecComponentHandle userPreferredCodecs)
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaRefConSetProperty(MediaHandler mh, long refCon, long propertyType, void *propertyValue)
		FIVEWORDINLINE(0x2F3C, 0x000C, 0x0569, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaRefConGetProperty(MediaHandler mh, long refCon, long propertyType, void *propertyValue)
		FIVEWORDINLINE(0x2F3C, 0x000C, 0x056A, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaNavigateTargetRefCon(MediaHandler mh, long navigation, long *refCon)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x056B, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaGGetIdleManager(MediaHandler mh, IdleManager *pim) FIVEWORDINLINE(0x2F3C, 0x0004, 0x056C, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaGSetIdleManager(MediaHandler mh, IdleManager im) FIVEWORDINLINE(0x2F3C, 0x0004, 0x056D, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaGGetLatency(MediaHandler mh, TimeRecord *latency) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0571, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaSetTrackApertureModeDimensionsUsingSampleDescription(MediaHandler mh, SampleDescriptionHandle sampleDesc)
		FIVEWORDINLINE(0x2F3C, 0x0004, 0x0579, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaGetApertureModeClipRectForSampleDescriptionIndex(MediaHandler mh, long sampleDescIndex,
														  FixedRect *clipFixedRectOut)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x057A, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	MediaGetApertureModeMatrixForSampleDescriptionIndex(MediaHandler mh, long sampleDescIndex, MatrixRecord *matrixOut)
		FIVEWORDINLINE(0x2F3C, 0x0008, 0x057B, 0x7000, 0xA82A);
	...
	{
		return (PrePrerollCompleteUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppPrePrerollCompleteProcInfo,
														   GetCurrentArchitecture());
	}
#else
#define NewPrePrerollCompleteUPP(userRoutine) \
	(PrePrerollCompleteUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppPrePrerollCompleteProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposePrePrerollCompleteUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(void)
	InvokePrePrerollCompleteUPP(MediaHandler mh, OSErr err, void *refcon, PrePrerollCompleteUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
