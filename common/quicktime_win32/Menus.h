...
#pragma pack(2)
	...
	/*
			...
			Menu Definition Messages
					...
					kMenuFindItemMsg
							...
							Menu definitions must use the ScrollMenuImage API, if available, to scroll the menu
	   contents. This API is available in CarbonLib 1.5 and later, and in Mac OS X 10.1 and later. ScrollMenuImage
							properly supports scrolling the alpha channel in the menu's image data. Use of QuickDraw's
							ScrollRect API to scroll the menu contents will result in the alpha channel being set to
	   0xFF (opaque) and the menu will no longer be transparent.
	...
	*/
	enum
	{
		...
		kMenuCalcItemMsg = 5,
		kMenuThemeSavvyMsg =
			7, /* is your MDEF theme-savvy?  If so, return kThemeSavvyMenuResponse in the whichItem parameter*/
		mDrawMsg = 0,
		mSizeMsg = 2,
	...
	*/
	...
	enum
	{
		...
		kMenuSystemIconSelectorType = 8, /* Type for an IconRef registered with Icon Services under kSystemIconsCreator
											(Mac OS X 10.1 and later only)*/
		kMenuIconResourceType = 9 /* Type for a CFStringRef naming a resource in the main bundle of the process (Mac OS
									 X 10.1 and later only)*/
	};
...
typedef MenuRef MenuHandle;
	...
	*/
	...
	/*--------------------------------------------------------------------------------------*/
	typedef CALLBACK_API(void, MenuDefProcPtr)(short message, MenuRef theMenu, Rect *menuRect, Point hitPt,
											   short *whichItem);
...
#define DisposeMenuDefUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(void)
	InvokeMenuDefUPP(short message, MenuRef theMenu, Rect *menuRect, Point hitPt, short *whichItem, MenuDefUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void) InvokeMenuDefUPP(short message, MenuRef theMenu, Rect *menuRect, Point hitPt,
...
#define CallMenuDefProc(userRoutine, message, theMenu, menuRect, hitPt, whichItem) \
	...
	{
		return (MenuBarDefUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppMenuBarDefProcInfo,
...
#define DisposeMBarHookUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(long)
	InvokeMenuBarDefUPP(short selector, short message, short parameter1, long parameter2, MenuBarDefUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeMenuBarDefUPP(selector, message, parameter1, parameter2, userUPP) \
	(long)CALL_FOUR_PARAMETER_UPP((userUPP), uppMenuBarDefProcInfo, (selector), (message), (parameter1), (parameter2))
#endif
#endif
...
#define CountMenuItems(theMenu) (CountMItems(theMenu))
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateCustomMenu(const MenuDefSpec *inDefSpec, MenuID inMenuID, MenuAttributes inMenuAttributes,
					 MenuRef *outMenuRef);
	...
	EraseMenuBackground(MenuRef inMenu, const Rect *inEraseRect, CGContextRef inContext); /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ScrollMenuImage(MenuRef inMenu, const Rect *inScrollRect, int inHScroll, int inVScroll,
...
#define MacAppendMenu AppendMenu
	 ...
	 */
	EXTERN_API(void)
	InsertResMenu(MenuRef theMenu, ResType theType, short afterItem) ONEWORDINLINE(0xA951);
...
#define MacInsertMenuItem InsertMenuItem
#endif
	EXTERN_API(void)
	MacInsertMenuItem(MenuRef theMenu, ConstStr255Param itemString, short afterItem) ONEWORDINLINE(0xA826);
	 ...
	 */
	EXTERN_API(void)
	InsertFontResMenu(MenuRef theMenu, short afterItem, short scriptFilter) THREEWORDINLINE(0x303C, 0x0400, 0xA825);
	 ...
	 */
	EXTERN_API(void)
	InsertIntlResMenu(MenuRef theMenu, ResType theType, short afterItem, short scriptFilter)
	 ...
	 */
	EXTERN_API(OSStatus)
	InsertMenuItemText(MenuRef menu, ConstStr255Param inString, MenuItemIndex afterItem);
	 ...
	 */
	EXTERN_API(OSStatus)
	CopyMenuItems(MenuRef inSourceMenu, MenuItemIndex inFirstItem, ItemCount inNumItems, MenuRef inDestMenu,
	 ...
	 */
	EXTERN_API(OSStatus)
	DeleteMenuItems(MenuRef inMenu, MenuItemIndex inFirstItem, ItemCount inNumItems);
	 ...
	 */
	EXTERN_API(OSStatus)
	AppendMenuItemTextWithCFString(MenuRef inMenu, CFStringRef inString, MenuItemAttributes inAttributes,
								   MenuCommand inCommandID, MenuItemIndex *outNewItem); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSStatus)
	InsertMenuItemTextWithCFString(MenuRef inMenu, CFStringRef inString, MenuItemIndex inAfterItem,
								   MenuItemAttributes inAttributes, MenuCommand inCommandID);
	 ...
	 */
	EXTERN_API(long)
	PopUpMenuSelect(MenuRef menu, short top, short left, short popUpItem) ONEWORDINLINE(0xA80B);
	 ...
	 */
	EXTERN_API(Boolean)
	IsMenuKeyEvent(MenuRef inStartMenu, EventRef inEvent, MenuEventOptions inOptions,
...
#endif
	EXTERN_API(void)
	MacCheckMenuItem(MenuRef theMenu, short item, Boolean checked) ONEWORDINLINE(0xA945);
#if CALL_NOT_IN_CARBON && !TARGET_CPU_68K
#ifdef __cplusplus
...
#define MacCheckMenuItem(theMenu, item, checked) (CheckItem(theMenu, item, checked))
	 ...
	 */
	EXTERN_API(void)
	SetMenuItemText(MenuRef theMenu, short item, ConstStr255Param itemString) ONEWORDINLINE(0xA947);
	 ...
	 */
	EXTERN_API(void)
	GetMenuItemText(MenuRef theMenu, short item, Str255 itemString) ONEWORDINLINE(0xA946);
	 ...
	 */
	EXTERN_API(void)
	SetItemMark(MenuRef theMenu, short item, CharParameter markChar) ONEWORDINLINE(0xA944);
	 ...
	 */
	EXTERN_API(void)
	GetItemMark(MenuRef theMenu, short item, CharParameter *markChar) ONEWORDINLINE(0xA943);
	 ...
	 */
	EXTERN_API(void)
	SetItemCmd(MenuRef theMenu, short item, CharParameter cmdChar) ONEWORDINLINE(0xA84F);
	 ...
	 */
	EXTERN_API(void)
	GetItemCmd(MenuRef theMenu, short item, CharParameter *cmdChar) ONEWORDINLINE(0xA84E);
	 ...
	 */
	EXTERN_API(void)
	GetItemIcon(MenuRef theMenu, short item, short *iconIndex) ONEWORDINLINE(0xA93F);
	 ...
	 */
	EXTERN_API(void)
	SetItemStyle(MenuRef theMenu, short item, StyleParameter chStyle) ONEWORDINLINE(0xA942);
...
/* DisableMenuItem (available back through Mac OS 8.5) instead.          */
	 ...
	 */
	EXTERN_API(OSErr)
	SetMenuItemModifiers(MenuRef inMenu, SInt16 inItem, UInt8 inModifiers) THREEWORDINLINE(0x303C, 0x0404, 0xA825);
	 ...
	 */
	EXTERN_API(OSErr)
	GetMenuItemModifiers(MenuRef inMenu, SInt16 inItem, UInt8 *outModifiers) THREEWORDINLINE(0x303C, 0x0505, 0xA825);
	 ...
	 */
	EXTERN_API(OSErr)
	SetMenuItemIconHandle(MenuRef inMenu, SInt16 inItem, UInt8 inIconType, Handle inIconHandle)
	 ...
	 */
	EXTERN_API(OSErr)
	GetMenuItemIconHandle(MenuRef inMenu, SInt16 inItem, UInt8 *outIconType, Handle *outIconHandle)
	 ...
	 */
	EXTERN_API(OSErr)
	GetMenuItemTextEncoding(MenuRef inMenu, SInt16 inItem, TextEncoding *outScriptID)
	 ...
	 */
	EXTERN_API(OSErr)
	SetMenuItemHierarchicalID(MenuRef inMenu, SInt16 inItem, MenuID inHierID) THREEWORDINLINE(0x303C, 0x040D, 0xA825);
	 ...
	 */
	EXTERN_API(OSErr)
	GetMenuItemHierarchicalID(MenuRef inMenu, SInt16 inItem, MenuID *outHierID) THREEWORDINLINE(0x303C, 0x050E, 0xA825);
	 ...
	 */
	EXTERN_API(OSErr)
	SetMenuItemFontID(MenuRef inMenu, SInt16 inItem, SInt16 inFontID) THREEWORDINLINE(0x303C, 0x040F, 0xA825);
	 ...
	 */
	EXTERN_API(OSErr)
	GetMenuItemFontID(MenuRef inMenu, SInt16 inItem, SInt16 *outFontID) THREEWORDINLINE(0x303C, 0x0510, 0xA825);
	 ...
	 */
	EXTERN_API(OSErr)
	SetMenuItemRefCon(MenuRef inMenu, SInt16 inItem, UInt32 inRefCon) THREEWORDINLINE(0x303C, 0x050A, 0xA825);
	 ...
	 */
	EXTERN_API(OSErr)
	GetMenuItemRefCon(MenuRef inMenu, SInt16 inItem, UInt32 *outRefCon) THREEWORDINLINE(0x303C, 0x050B, 0xA825);
...
/* Please use the menu item property APIs in Carbon.*/
	 ...
	 */
	EXTERN_API(OSErr)
	SetMenuItemRefCon2(MenuRef inMenu, SInt16 inItem, UInt32 inRefCon2) THREEWORDINLINE(0x303C, 0x0511, 0xA825);
	 ...
	 */
	EXTERN_API(OSErr)
	GetMenuItemRefCon2(MenuRef inMenu, SInt16 inItem, UInt32 *outRefCon2) THREEWORDINLINE(0x303C, 0x0512, 0xA825);
	 ...
	 */
	EXTERN_API(OSErr)
	SetMenuItemKeyGlyph(MenuRef inMenu, SInt16 inItem, SInt16 inGlyph) THREEWORDINLINE(0x303C, 0x0513, 0xA825);
	 ...
	 */
	EXTERN_API(OSErr)
	GetMenuItemKeyGlyph(MenuRef inMenu, SInt16 inItem, SInt16 *outGlyph) THREEWORDINLINE(0x303C, 0x0514, 0xA825);
...
#define MacEnableMenuItem EnableMenuItem
	 ...
	 */
	EXTERN_API(void)
	EnableMenuItemIcon(MenuRef theMenu, MenuItemIndex item) THREEWORDINLINE(0x303C, 0x0019, 0xA825);
	 ...
	 */
	EXTERN_API(void)
	DisableMenuItemIcon(MenuRef theMenu, MenuItemIndex item) THREEWORDINLINE(0x303C, 0x0020, 0xA825);
	 ...
	 */
	EXTERN_API(Boolean)
	IsMenuItemIconEnabled(MenuRef menu, MenuItemIndex item) THREEWORDINLINE(0x303C, 0x0018, 0xA825);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetMenuItemHierarchicalMenu(MenuRef inMenu, MenuItemIndex inItem, MenuRef inHierMenu); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSStatus)
	GetMenuItemHierarchicalMenu(MenuRef inMenu, MenuItemIndex inItem, MenuRef *outHierMenu);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetMenuItemTextWithCFString(MenuRef inMenu, MenuItemIndex inItem, CFStringRef inString);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetMenuItemCommandKey(MenuRef inMenu, MenuItemIndex inItem, Boolean inGetVirtualKey, UInt16 *outKey);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetMenuItemCommandKey(MenuRef inMenu, MenuItemIndex inItem, Boolean inSetVirtualKey, UInt16 inKey);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetMenuItemProperty(MenuRef menu, MenuItemIndex item, OSType propertyCreator, OSType propertyTag, UInt32 bufferSize,
	 ...
	 */
	EXTERN_API(OSStatus)
	GetMenuItemPropertySize(MenuRef menu, MenuItemIndex item, OSType propertyCreator, OSType propertyTag, UInt32 *size);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetMenuItemProperty(MenuRef menu, MenuItemIndex item, OSType propertyCreator, OSType propertyTag,
						UInt32 propertySize, const void *propertyData);
	 ...
	 */
	EXTERN_API(OSStatus)
	RemoveMenuItemProperty(MenuRef menu, MenuItemIndex item, OSType propertyCreator, OSType propertyTag);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetMenuItemPropertyAttributes(MenuRef menu, MenuItemIndex item, OSType propertyCreator, OSType propertyTag,
								  UInt32 *attributes);
	 ...
	 */
	EXTERN_API(OSStatus)
	ChangeMenuItemPropertyAttributes(MenuRef menu, MenuItemIndex item, OSType propertyCreator, OSType propertyTag,
	 ...
	 */
	EXTERN_API(OSStatus)
	ChangeMenuAttributes(MenuRef menu, MenuAttributes setTheseAttributes, MenuAttributes clearTheseAttributes);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetMenuItemAttributes(MenuRef menu, MenuItemIndex item, MenuItemAttributes *outAttributes);
	 ...
	 */
	EXTERN_API(OSStatus)
	ChangeMenuItemAttributes(MenuRef menu, MenuItemIndex item, MenuItemAttributes setTheseAttributes,
	 ...
	 */
	EXTERN_API(OSStatus)
	GetIndMenuItemWithCommandID(MenuRef inMenu, MenuCommand inCommandID, UInt32 inItemIndex,
								MenuRef *outMenu,		  /* can be NULL */
	 ...
	 */
	EXTERN_API(OSStatus)
	GetMenuCommandProperty(MenuRef inMenu, MenuCommand inCommandID, OSType inPropertyCreator, OSType inPropertyTag,
						   ByteCount inBufferSize, ByteCount *outActualSize, /* can be NULL */
	 ...
	 */
	EXTERN_API(OSStatus)
	GetMenuCommandPropertySize(MenuRef inMenu, MenuCommand inCommandID, OSType inPropertyCreator, OSType inPropertyTag,
							   ByteCount *outSize);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetMenuCommandProperty(MenuRef inMenu, MenuCommand inCommandID, OSType inPropertyCreator, OSType inPropertyTag,
	 ...
	 */
	EXTERN_API(OSStatus)
	RemoveMenuCommandProperty(MenuRef inMenu, MenuCommand inCommandID, OSType inPropertyCreator, OSType inPropertyTag);
	 ...
	 */
	EXTERN_API(OSStatus)
	CopyMenuItemData(MenuRef inMenu, /* can be NULL */
					 MenuItemID inItem, Boolean inIsCommandID, MenuItemDataPtr ioData);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetMenuItemData(MenuRef inMenu, MenuItemID inItem, Boolean inIsCommandID, const MenuItemDataRec *inData);
	 ...
	 */
	EXTERN_API(Boolean)
	IsMenuItemInvalid(MenuRef inMenu, MenuItemIndex inItem);
	 ...
	 */
	EXTERN_API(OSStatus)
	InvalidateMenuItems(MenuRef inMenu, MenuItemIndex inFirstItem, ItemCount inNumItems);
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateStandardFontMenu(MenuRef menu, MenuItemIndex afterItem, MenuID firstHierMenuID, OptionBits options,
	 ...
	 */
	EXTERN_API(OSStatus)
	GetFontFamilyFromMenuSelection(MenuRef menu, MenuItemIndex item, FMFontFamily *outFontFamily,
	...
	enum
	{
		...
		gestaltContextualMenuHasAttributeAndModifierKeys =
			2, /* Contextual Menu Manager supports keyContextualMenuAttributes and keyContextualMenuModifiers */
		gestaltContextualMenuHasUnicodeSupport =
			3 /* Contextual Menu Manager supports typeUnicodeText and typeCFStringRef */
	};
	 ...
	 */
	EXTERN_API(OSStatus)
	ContextualMenuSelect(MenuRef inMenu, Point inGlobalLocation, Boolean inReserved, UInt32 inHelpType,
						 ConstStr255Param inHelpItemString, /* can be NULL */
						 const AEDesc *inSelection,			/* can be NULL */
						 UInt32 *outUserSelectionType, SInt16 *outMenuID, MenuItemIndex *outMenuItem)
...
#define kContextualMenuTypeID                                                                                     \
	(CFUUIDGetConstantUUIDWithBytes(NULL, 0x2F, 0x65, 0x22, 0xE9, 0x3E, 0x66, 0x11, 0xD5, 0x80, 0xA7, 0x00, 0x30, \
									0x65, 0xB3, 0x00, 0xBC))
...
#define kContextualMenuInterfaceID                                                                                \
	(CFUUIDGetConstantUUIDWithBytes(NULL, 0x32, 0x99, 0x7B, 0x62, 0x3E, 0x66, 0x11, 0xD5, 0xBE, 0xAB, 0x00, 0x30, \
									0x65, 0xB3, 0x00, 0xBC))
...
#define CM_IUNKNOWN_C_GUTS                                                    \
	...
	{
		CM_IUNKNOWN_C_GUTS;
		OSStatus (*ExamineContext)(void *thisInstance, const AEDesc *inContext, AEDescList *outCommandPairs);
		OSStatus (*HandleSelection)(void *thisInstance, AEDesc *inContext, SInt32 inCommandID);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	CMPluginHandleSelection(void *thisInstance, AEDesc *inContext, SInt32 inCommandID);
