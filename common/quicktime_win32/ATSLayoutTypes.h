...
#pragma pack(2)
	...
	enum
	{
		...
		kATSLineDisableAllLayoutOperations =
			kATSLineDisableAllJustification | kATSLineDisableAllGlyphMorphing | kATSLineDisableAllKerningAdjustments |
	...
	typedef CALLBACK_API_C(OSStatus, ATSUDirectLayoutOperationOverrideProcPtr)(
		ATSULayoutOperationSelector iCurrentOperation, ATSULineRef iLineRef, UInt32 iRefCon,
	...
	enum
	{
		uppATSUDirectLayoutOperationOverrideProcInfo = 0x0000FFF1
	}; /* 4_bytes Func(4_bytes, 4_bytes, 4_bytes, 4_bytes, 4_bytes) */
#ifdef __cplusplus
	inline DEFINE_API_C(ATSUDirectLayoutOperationOverrideUPP)
		NewATSUDirectLayoutOperationOverrideUPP(ATSUDirectLayoutOperationOverrideProcPtr userRoutine)
	{
		return userRoutine;
	}
...
#define DisposeATSUDirectLayoutOperationOverrideUPP(userUPP)
	...
	InvokeATSUDirectLayoutOperationOverrideUPP(ATSULayoutOperationSelector iCurrentOperation, ATSULineRef iLineRef,
											   UInt32 iRefCon, void *iOperationCallbackParameterPtr,
...
#else
#define InvokeATSUDirectLayoutOperationOverrideUPP(iCurrentOperation, iLineRef, iRefCon,                     \
												   iOperationCallbackParameterPtr, oCallbackStatus, userUPP) \
	(*userUPP)(iCurrentOperation, iLineRef, iRefCon, iOperationCallbackParameterPtr, oCallbackStatus)
#endif
#endif
