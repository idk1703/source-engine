...
#define kQ3XMethodTypeElementDelete		   Q3_METHOD_TYPE('e', 'd', 'e', 'l')
	...
	Q3XElementClass_Register(TQ3ElementType *elementType, const char *name, unsigned long sizeOfElement,
...
#define kQ3XMethodTypeAttributeCopyInherit Q3_METHOD_TYPE('a', 'c', 'p', 'i')
	 ...
	 */
	EXTERN_API_C(TQ3XObjectClass)
	Q3XAttributeClass_Register(TQ3AttributeType *attributeType, const char *creatorName, unsigned long sizeOfElement,
							   TQ3XMetaHandler metaHandler);
