...
#pragma pack(2)
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	ICDDisposeObject(ICD_DisposeObjectPB *pb, ICDCompletion completion); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	ICDNewProperty(ICD_NewPropertyPB *pb, ICDCompletion completion); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	ICDDisposeProperty(ICD_DisposePropertyPB *pb, ICDCompletion completion); /* can be NULL */
