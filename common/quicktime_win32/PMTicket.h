...
#define kPMPaperInfoTicket CFSTR("com.apple.print.PaperInfoTicket")
	...
	enum
	{
		...
		kPMDuplexDefault =
			kPMDuplexNone /* If the kPMDuplexingKey is not in a ticket then kPMDuplexDefault should be assumed.*/
	};
...
/* CFNumber - kCFNumberSInt32Type, PMOrientation, 1 = portrait, 2 = landscape, 3 = reverse landscape, 4 = reverse
 * portrait. */
...
/* CFArray of kCFNumberSInt32Type, each pair indicating valid range of pages that the application is able to print. Does
 * not signify user choices. */
...
/* Note, we've removed the PMLanguageInfoKey because it's not valid to store strings or structures, everything needs to
 * be a CFType.*/
...
#define kPMCVColorSyncProfileIDKey CFSTR("com.apple.print.ConverterSetup.PMProfileID")
	...
	PMTicketCreate(CFAllocatorRef allocator, CFStringRef ticketType, PMTicketRef *newTicket);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketCopy(CFAllocatorRef allocator, PMTicketRef sourceTicket, PMTicketRef *destinationTicket);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketGetRetainCount(PMTicketRef ticket, CFIndex *retainCount);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketGetLockedState(PMTicketRef ticket, Boolean *lockedState);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketValidate(PMTicketRef ticket, PMTemplateRef verifyingTemplate, CFArrayRef *invalidItems);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketGetType(PMTicketRef ticket, CFStringRef *ticketType);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketGetEnumType(PMTicketRef ticket, PMTicketType *ticketType);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketGetAllocator(PMTicketRef ticket, CFAllocatorRef *allocator);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketGetAPIVersion(PMTicketRef ticket, CFStringRef *apiVersion);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketToXML(PMTicketRef ticket, CFDataRef *anXMLTicket);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketWriteXMLToFile(PMTicketRef ticket, const char *path);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketWriteXML(PMTicketRef ticket, FILE *xmlFile);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMXMLToTicket(CFAllocatorRef allocator, CFDataRef anXMLTicket, PMTicketRef *ticket, CFStringRef *conversionError);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketReadXMLFromFile(CFAllocatorRef allocator, const char *path, PMTicketRef *ticket, CFStringRef *errorString);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketSetCFString(PMTicketRef ticket, CFStringRef clientID, CFStringRef key, CFStringRef item, Boolean locked);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketSetPString(PMTicketRef ticket, CFStringRef clientID, CFStringRef key, ConstStringPtr value, Boolean locked);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketSetCString(PMTicketRef ticket, CFStringRef clientID, CFStringRef key, const char *value, Boolean locked);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketSetCStringArray(PMTicketRef ticket, CFStringRef clientID, CFStringRef key, const char **cStringArray,
							UInt32 count, Boolean locked);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketSetCFNumber(PMTicketRef ticket, CFStringRef clientID, CFStringRef key, CFNumberRef item, Boolean locked);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketSetSInt32(PMTicketRef ticket, CFStringRef clientID, CFStringRef key, SInt32 value, Boolean locked);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketSetSInt32Array(PMTicketRef ticket, CFStringRef clientID, CFStringRef key, const SInt32 *sInt32Array,
						   UInt32 count, Boolean locked);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketSetUInt32(PMTicketRef ticket, CFStringRef clientID, CFStringRef key, UInt32 value, Boolean locked);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketSetUInt32Array(PMTicketRef ticket, CFStringRef clientID, CFStringRef key, const UInt32 *uInt32Array,
						   UInt32 count, Boolean locked);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketSetDouble(PMTicketRef ticket, CFStringRef clientID, CFStringRef key, double value, Boolean locked);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketSetDoubleArray(PMTicketRef ticket, CFStringRef clientID, CFStringRef key, const double *doubleArray,
						   UInt32 count, Boolean changeable);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketSetPMResolution(PMTicketRef ticket, CFStringRef clientID, CFStringRef key, PMResolution *value,
							Boolean locked);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketSetPMResolutionArray(PMTicketRef ticket, CFStringRef clientID, CFStringRef key,
								 PMResolution *pmResolutionArray, UInt32 count, Boolean locked);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketSetPMRect(PMTicketRef ticket, CFStringRef clientID, CFStringRef key, PMRect *value, Boolean locked);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketSetPMRectArray(PMTicketRef ticket, CFStringRef clientID, CFStringRef key, PMRect *pmRectArray, UInt32 count,
						   Boolean locked);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketSetCFData(PMTicketRef ticket, CFStringRef clientID, CFStringRef key, CFDataRef item, Boolean locked);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketSetBytes(PMTicketRef ticket, CFStringRef clientID, CFStringRef key, const UInt8 *data, UInt32 size,
					 Boolean locked);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketSetCFBoolean(PMTicketRef ticket, CFStringRef clientID, CFStringRef key, CFBooleanRef item, Boolean locked);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketSetBoolean(PMTicketRef ticket, CFStringRef clientID, CFStringRef key, Boolean value, Boolean locked);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketSetCFDate(PMTicketRef ticket, CFStringRef clientID, CFStringRef key, CFDateRef item, Boolean locked);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketSetCFArray(PMTicketRef ticket, CFStringRef clientID, CFStringRef key, CFArrayRef item, Boolean locked);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketSetCFDictionary(PMTicketRef ticket, CFStringRef clientID, CFStringRef key, CFDictionaryRef item,
							Boolean locked);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketSetTemplate(PMTicketRef ticket, CFStringRef clientID, CFStringRef key, PMTemplateRef item, Boolean locked);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketSetItem(PMTicketRef ticket, CFStringRef clientID, CFStringRef key, CFTypeRef item, Boolean locked);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketSetMetaItem(PMTicketRef ticket, CFStringRef key, CFTypeRef item);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketFillFromArray(PMTicketRef ticket, CFStringRef clientID, const PMTicketItemStruct *items, UInt32 itemCount);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketCopyItem(PMTicketRef sourceTicket, PMTicketRef destTicket, CFStringRef clientID, CFStringRef key,
					 Boolean locked);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketIsItemLocked(PMTicketRef ticket, CFStringRef key, Boolean *locked);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketLockItem(PMTicketRef ticket, CFStringRef clientID, CFStringRef key);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketUnlockItem(PMTicketRef ticket, CFStringRef clientID, CFStringRef key);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketDeleteItem(PMTicketRef ticket, CFStringRef clientID, CFStringRef key);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketReleaseItem(PMTicketRef ticket, CFStringRef key);
	...
	PMTicketContainsItem(PMTicketRef ticket, UInt32 nodeIndex1, UInt32 nodeIndex2, CFStringRef key);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketGetCFString(PMTicketRef ticket, UInt32 nodeIndex1, UInt32 nodeIndex2, CFStringRef key, CFStringRef *item);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketGetPString(PMTicketRef ticket, UInt32 nodeIndex1, UInt32 nodeIndex2, CFStringRef key, UInt32 bufferSize,
					   CFStringEncoding encoding, StringPtr value);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketGetCString(PMTicketRef ticket, UInt32 nodeIndex1, UInt32 nodeIndex2, CFStringRef key, UInt32 bufferSize,
					   CFStringEncoding encoding, char *value);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketGetCFNumber(PMTicketRef ticket, UInt32 nodeIndex1, UInt32 nodeIndex2, CFStringRef key, CFNumberRef *item);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketGetSInt32(PMTicketRef ticket, UInt32 nodeIndex1, UInt32 nodeIndex2, CFStringRef key, SInt32 *value);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketGetUInt32(PMTicketRef ticket, UInt32 nodeIndex1, UInt32 nodeIndex2, CFStringRef key, UInt32 *value);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketGetDouble(PMTicketRef ticket, UInt32 nodeIndex1, UInt32 nodeIndex2, CFStringRef key, double *value);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketGetPMResolution(PMTicketRef ticket, UInt32 nodeIndex1, UInt32 nodeIndex2, CFStringRef key,
							PMResolution *res);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketGetIndexPMResolution(PMTicketRef ticket, UInt32 nodeIndex1, UInt32 nodeIndex2, CFStringRef key,
								 UInt32 index, PMResolution *res);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketGetPMRect(PMTicketRef ticket, UInt32 nodeIndex1, UInt32 nodeIndex2, CFStringRef key, PMRect *value);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketGetCFData(PMTicketRef ticket, UInt32 nodeIndex1, UInt32 nodeIndex2, CFStringRef key, CFDataRef *item);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketGetBytes(PMTicketRef ticket, UInt32 nodeIndex1, UInt32 nodeIndex2, CFStringRef key, UInt8 *data,
					 UInt32 *size);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketGetCFBoolean(PMTicketRef ticket, UInt32 nodeIndex1, UInt32 nodeIndex2, CFStringRef key, CFBooleanRef *item);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketGetBoolean(PMTicketRef ticket, UInt32 nodeIndex1, UInt32 nodeIndex2, CFStringRef key, Boolean *value);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketGetCFDate(PMTicketRef ticket, UInt32 nodeIndex1, UInt32 nodeIndex2, CFStringRef key, CFDateRef *item);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketGetCFArray(PMTicketRef ticket, UInt32 nodeIndex1, UInt32 nodeIndex2, CFStringRef key, CFArrayRef *item);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketGetCFDictionary(PMTicketRef ticket, UInt32 nodeIndex1, UInt32 nodeIndex2, CFStringRef key,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketCreateTemplate(PMTicketRef ticket, UInt32 nodeIndex1, UInt32 nodeIndex2, CFStringRef key,
						   PMTemplateRef *item);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketGetItem(PMTicketRef ticket, UInt32 nodeIndex1, UInt32 nodeIndex2, CFStringRef key, CFTypeRef *item);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketGetMetaItem(PMTicketRef ticket, CFStringRef key, CFTypeRef *item);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketSetTicket(PMTicketRef ticket, PMTicketRef ticketToAdd, UInt32 index);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketContainsTicket(PMTicketRef ticket, CFStringRef requestedType, UInt32 index, Boolean *exists);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketGetTicket(PMTicketRef ticket, CFStringRef requestedType, UInt32 index, PMTicketRef *retreivedTicket);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketRemoveTicket(PMTicketRef ticket, CFStringRef typeToRemove, UInt32 index);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTicketGetPPDDict(PMTicketRef ticket, UInt32 nodeIndex1, UInt32 nodeIndex2, CFMutableDictionaryRef *dict);
