...
#pragma pack(2)
	...
	typedef CALLBACK_API_REGISTER68K(unsigned short, WidthHookProcPtr,
									 (unsigned short textLen, unsigned short textOffset, void *textBufferPtr, TEPtr pTE,
									  TEHandle hTE));
	...
	typedef CALLBACK_API_REGISTER68K(unsigned short, NWidthHookProcPtr,
									 (unsigned short styleRunLen, unsigned short styleRunOffset, short slop,
									  short direction, void *textBufferPtr, short *lineStart, TEPtr pTE, TEHandle hTE));
	typedef CALLBACK_API_REGISTER68K(void, DrawHookProcPtr,
									 (unsigned short textOffset, unsigned short drawLen, void *textBufferPtr, TEPtr pTE,
									  TEHandle hTE));
	typedef CALLBACK_API_REGISTER68K(Boolean, HitTestHookProcPtr,
									 (unsigned short styleRunLen, unsigned short styleRunOffset, unsigned short slop,
									  void *textBufferPtr, TEPtr pTE, TEHandle hTE, unsigned short *pixelWidth,
									  unsigned short *charOffset, Boolean *pixelInChar));
	typedef CALLBACK_API_REGISTER68K(void, TEFindWordProcPtr,
									 (unsigned short currentPos, short caller, TEPtr pTE, TEHandle hTE,
									  unsigned short *wordStart, unsigned short *wordEnd));
	typedef CALLBACK_API_REGISTER68K(void, TERecalcProcPtr,
									 (TEPtr pTE, unsigned short changeLength, unsigned short *lineStart,
									  unsigned short *firstChar, unsigned short *lastChar));
	typedef CALLBACK_API_REGISTER68K(void, TEDoTextProcPtr,
									 (TEPtr pTE, unsigned short firstChar, unsigned short lastChar, short selector,
...
#define NewEOLHookUPP(userRoutine) \
	...
	{
		return (CaretHookUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppCaretHookProcInfo,
...
#define NewCaretHookUPP(userRoutine) \
	...
	{
		return (WidthHookUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppWidthHookProcInfo,
												  GetCurrentArchitecture());
	}
#else
#define NewWidthHookUPP(userRoutine) \
	...
	{
		return (TextWidthHookUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppTextWidthHookProcInfo,
													  GetCurrentArchitecture());
	}
#else
#define NewTextWidthHookUPP(userRoutine) \
	...
	{
		return (NWidthHookUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppNWidthHookProcInfo,
												   GetCurrentArchitecture());
	}
#else
...
#define NewDrawHookUPP(userRoutine) \
	...
	{
		return (HitTestHookUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppHitTestHookProcInfo,
													GetCurrentArchitecture());
	}
#else
#define NewHitTestHookUPP(userRoutine) \
	...
	{
		return (TEFindWordUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppTEFindWordProcInfo,
												   GetCurrentArchitecture());
	}
#else
...
#define NewTEDoTextUPP(userRoutine) \
	...
	{
		return (TEClickLoopUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppTEClickLoopProcInfo,
													GetCurrentArchitecture());
	}
#else
#define NewTEClickLoopUPP(userRoutine) \
	...
	{
		return (WordBreakUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppWordBreakProcInfo,
												  GetCurrentArchitecture());
	}
#else
...
#define InvokeEOLHookUPP(theChar, pTE, hTE, userUPP) \
	(Boolean) CALL_THREE_PARAMETER_UPP((userUPP), uppEOLHookProcInfo, (theChar), (pTE), (hTE))
#endif
#endif
...
#define InvokeCaretHookUPP(r, pTE, userUPP) CALL_TWO_PARAMETER_UPP((userUPP), uppCaretHookProcInfo, (r), (pTE))
	...
	InvokeWidthHookUPP(unsigned short textLen, unsigned short textOffset, void *textBufferPtr, TEPtr pTE, TEHandle hTE,
					   WidthHookUPP userUPP);
#if !OPAQUE_UPP_TYPES && (!TARGET_OS_MAC || !TARGET_CPU_68K || TARGET_RT_MAC_CFM)
#ifdef __cplusplus
	inline DEFINE_API_C(unsigned short)
		InvokeWidthHookUPP(unsigned short textLen, unsigned short textOffset, void *textBufferPtr, TEPtr pTE,
						   TEHandle hTE, WidthHookUPP userUPP)
	{
		return (unsigned short)CALL_FIVE_PARAMETER_UPP(userUPP, uppWidthHookProcInfo, textLen, textOffset,
													   textBufferPtr, pTE, hTE);
	}
#else
#define InvokeWidthHookUPP(textLen, textOffset, textBufferPtr, pTE, hTE, userUPP)                                      \
	(unsigned short)CALL_FIVE_PARAMETER_UPP((userUPP), uppWidthHookProcInfo, (textLen), (textOffset), (textBufferPtr), \
											(pTE), (hTE))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(unsigned short)
	InvokeTextWidthHookUPP(unsigned short textLen, unsigned short textOffset, void *textBufferPtr, TEPtr pTE,
						   TEHandle hTE, TextWidthHookUPP userUPP);
#if !OPAQUE_UPP_TYPES && (!TARGET_OS_MAC || !TARGET_CPU_68K || TARGET_RT_MAC_CFM)
#ifdef __cplusplus
	inline DEFINE_API_C(unsigned short)
		InvokeTextWidthHookUPP(unsigned short textLen, unsigned short textOffset, void *textBufferPtr, TEPtr pTE,
							   TEHandle hTE, TextWidthHookUPP userUPP)
	{
		return (unsigned short)CALL_FIVE_PARAMETER_UPP(userUPP, uppTextWidthHookProcInfo, textLen, textOffset,
													   textBufferPtr, pTE, hTE);
	}
#else
#define InvokeTextWidthHookUPP(textLen, textOffset, textBufferPtr, pTE, hTE, userUPP)                     \
	(unsigned short)CALL_FIVE_PARAMETER_UPP((userUPP), uppTextWidthHookProcInfo, (textLen), (textOffset), \
											(textBufferPtr), (pTE), (hTE))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(unsigned short)
	InvokeNWidthHookUPP(unsigned short styleRunLen, unsigned short styleRunOffset, short slop, short direction,
						void *textBufferPtr, short *lineStart, TEPtr pTE, TEHandle hTE, NWidthHookUPP userUPP);
#if !OPAQUE_UPP_TYPES && (!TARGET_OS_MAC || !TARGET_CPU_68K || TARGET_RT_MAC_CFM)
#ifdef __cplusplus
	inline DEFINE_API_C(unsigned short)
		InvokeNWidthHookUPP(unsigned short styleRunLen, unsigned short styleRunOffset, short slop, short direction,
							void *textBufferPtr, short *lineStart, TEPtr pTE, TEHandle hTE, NWidthHookUPP userUPP)
	{
		return (unsigned short)CALL_EIGHT_PARAMETER_UPP(userUPP, uppNWidthHookProcInfo, styleRunLen, styleRunOffset,
...
#define InvokeNWidthHookUPP(styleRunLen, styleRunOffset, slop, direction, textBufferPtr, lineStart, pTE, hTE, userUPP) \
	(unsigned short)CALL_EIGHT_PARAMETER_UPP((userUPP), uppNWidthHookProcInfo, (styleRunLen), (styleRunOffset),        \
											 (slop), (direction), (textBufferPtr), (lineStart), (pTE), (hTE))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(void)
	InvokeDrawHookUPP(unsigned short textOffset, unsigned short drawLen, void *textBufferPtr, TEPtr pTE, TEHandle hTE,
					  DrawHookUPP userUPP);
#if !OPAQUE_UPP_TYPES && (!TARGET_OS_MAC || !TARGET_CPU_68K || TARGET_RT_MAC_CFM)
#ifdef __cplusplus
	inline DEFINE_API_C(void) InvokeDrawHookUPP(unsigned short textOffset, unsigned short drawLen, void *textBufferPtr,
												TEPtr pTE, TEHandle hTE, DrawHookUPP userUPP)
	{
...
#define InvokeDrawHookUPP(textOffset, drawLen, textBufferPtr, pTE, hTE, userUPP) \
	 ...
	 */
	EXTERN_API_C(Boolean)
	InvokeHitTestHookUPP(unsigned short styleRunLen, unsigned short styleRunOffset, unsigned short slop,
						 void *textBufferPtr, TEPtr pTE, TEHandle hTE, unsigned short *pixelWidth,
						 unsigned short *charOffset, Boolean *pixelInChar, HitTestHookUPP userUPP);
#if !OPAQUE_UPP_TYPES && (!TARGET_OS_MAC || !TARGET_CPU_68K || TARGET_RT_MAC_CFM)
#ifdef __cplusplus
	inline DEFINE_API_C(Boolean)
		InvokeHitTestHookUPP(unsigned short styleRunLen, unsigned short styleRunOffset, unsigned short slop,
							 ...
							 unsigned short *charOffset, Boolean *pixelInChar, HitTestHookUPP userUPP)
	{
		return (Boolean)CALL_NINE_PARAMETER_UPP(userUPP, uppHitTestHookProcInfo, styleRunLen, styleRunOffset, slop,
												textBufferPtr, pTE, hTE, pixelWidth, charOffset, pixelInChar);
	}
#else
#define InvokeHitTestHookUPP(styleRunLen, styleRunOffset, slop, textBufferPtr, pTE, hTE, pixelWidth, charOffset,  \
							 pixelInChar, userUPP)                                                                \
	(Boolean) CALL_NINE_PARAMETER_UPP((userUPP), uppHitTestHookProcInfo, (styleRunLen), (styleRunOffset), (slop), \
									  (textBufferPtr), (pTE), (hTE), (pixelWidth), (charOffset), (pixelInChar))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(void)
	InvokeTEFindWordUPP(unsigned short currentPos, short caller, TEPtr pTE, TEHandle hTE, unsigned short *wordStart,
...
#define InvokeTEFindWordUPP(currentPos, caller, pTE, hTE, wordStart, wordEnd, userUPP)                          \
	CALL_SIX_PARAMETER_UPP((userUPP), uppTEFindWordProcInfo, (currentPos), (caller), (pTE), (hTE), (wordStart), \
						   (wordEnd))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(void)
	InvokeTERecalcUPP(TEPtr pTE, unsigned short changeLength, unsigned short *lineStart, unsigned short *firstChar,
...
#define InvokeTERecalcUPP(pTE, changeLength, lineStart, firstChar, lastChar, userUPP) \
	 ...
	 */
	EXTERN_API_C(void)
	InvokeTEDoTextUPP(TEPtr pTE, unsigned short firstChar, unsigned short lastChar, short selector,
					  GrafPtr *currentGrafPort, short *charPosition, TEDoTextUPP userUPP);
#if !OPAQUE_UPP_TYPES && (!TARGET_OS_MAC || !TARGET_CPU_68K || TARGET_RT_MAC_CFM)
#ifdef __cplusplus
	inline DEFINE_API_C(void)
		InvokeTEDoTextUPP(TEPtr pTE, unsigned short firstChar, unsigned short lastChar, short selector,
						  GrafPtr *currentGrafPort, short *charPosition, TEDoTextUPP userUPP)
	{
		CALL_SIX_PARAMETER_UPP(userUPP, uppTEDoTextProcInfo, pTE, firstChar, lastChar, selector, currentGrafPort,
							   charPosition);
	}
#else
#define InvokeTEDoTextUPP(pTE, firstChar, lastChar, selector, currentGrafPort, charPosition, userUPP)  \
	CALL_SIX_PARAMETER_UPP((userUPP), uppTEDoTextProcInfo, (pTE), (firstChar), (lastChar), (selector), \
...
#endif
	EXTERN_API_C(Boolean)
	InvokeWordBreakUPP(Ptr text, short charPos, WordBreakUPP userUPP) ONEWORDINLINE(0x4E91);
#if !OPAQUE_UPP_TYPES && (!TARGET_OS_MAC || !TARGET_CPU_68K || TARGET_RT_MAC_CFM)
#ifdef __cplusplus
...
#define InvokeWordBreakUPP(text, charPos, userUPP) \
	(Boolean) CALL_TWO_PARAMETER_UPP((userUPP), uppWordBreakProcInfo, (text), (charPos))
#endif
#endif
...
#define CallTextWidthHookProc(userRoutine, textLen, textOffset, textBufferPtr, pTE, hTE) \
	InvokeTextWidthHookUPP(textLen, textOffset, textBufferPtr, pTE, hTE, userRoutine)
#define CallNWidthHookProc(userRoutine, styleRunLen, styleRunOffset, slop, direction, textBufferPtr, lineStart, pTE, \
						   hTE)                                                                                      \
	InvokeNWidthHookUPP(styleRunLen, styleRunOffset, slop, direction, textBufferPtr, lineStart, pTE, hTE, userRoutine)
...
#define CallHitTestHookProc(userRoutine, styleRunLen, styleRunOffset, slop, textBufferPtr, pTE, hTE, pixelWidth, \
							charOffset, pixelInChar)                                                             \
	InvokeHitTestHookUPP(styleRunLen, styleRunOffset, slop, textBufferPtr, pTE, hTE, pixelWidth, charOffset,     \
						 pixelInChar, userRoutine)
#define CallTEFindWordProc(userRoutine, currentPos, caller, pTE, hTE, wordStart, wordEnd) \
	InvokeTEFindWordUPP(currentPos, caller, pTE, hTE, wordStart, wordEnd, userRoutine)
#define CallTERecalcProc(userRoutine, pTE, changeLength, lineStart, firstChar, lastChar) \
	InvokeTERecalcUPP(pTE, changeLength, lineStart, firstChar, lastChar, userRoutine)
#define CallTEDoTextProc(userRoutine, pTE, firstChar, lastChar, selector, currentGrafPort, charPosition) \
	InvokeTEDoTextUPP(pTE, firstChar, lastChar, selector, currentGrafPort, charPosition, userRoutine)
...
#define TEGetScrapLength() ((long)*(unsigned short *)0x0AB0)
	 ...
	 */
	EXTERN_API(void)
	TETextBox(const void *text, long length, const Rect *box, short just) ONEWORDINLINE(0xA9CE);
	 ...
	 */
	EXTERN_API(void)
	TESetStyleHandle(TEStyleHandle theHandle, TEHandle hTE) THREEWORDINLINE(0x3F3C, 0x0005, 0xA83D);
	 ...
	 */
	EXTERN_API(void)
	TEGetStyle(short offset, TextStyle *theStyle, short *lineHeight, short *fontAscent, TEHandle hTE)
	 ...
	 */
	EXTERN_API(void)
	TEReplaceStyle(short mode, const TextStyle *oldStyle, const TextStyle *newStyle, Boolean fRedraw, TEHandle hTE)
	 ...
	 */
	EXTERN_API(Boolean)
	TEContinuousStyle(short *mode, TextStyle *aStyle, TEHandle hTE) THREEWORDINLINE(0x3F3C, 0x000A, 0xA83D);
	 ...
	 */
	EXTERN_API(void)
	TEUseStyleScrap(long rangeStart, long rangeEnd, StScrpHandle newStyles, Boolean fRedraw, TEHandle hTE)
	 ...
	 */
	EXTERN_API(void)
	TECustomHook(TEIntHook which, UniversalProcPtr *addr, TEHandle hTE) THREEWORDINLINE(0x3F3C, 0x000C, 0xA83D);
	 ...
	 */
	EXTERN_API(long)
	TENumStyles(long rangeStart, long rangeEnd, TEHandle hTE) THREEWORDINLINE(0x3F3C, 0x000D, 0xA83D);
	 ...
	 */
	EXTERN_API(short)
	TEFeatureFlag(short feature, short action, TEHandle hTE) THREEWORDINLINE(0x3F3C, 0x000E, 0xA83D);
	 ...
	 */
	EXTERN_API(OSErr)
	TEGetHiliteRgn(RgnHandle region, TEHandle hTE) THREEWORDINLINE(0x3F3C, 0x000F, 0xA83D);
