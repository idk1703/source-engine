...
#pragma pack(2)
	...
	*/
	...
	enum
	{
		kICAProperty = FOUR_CHAR_CODE('prop'), /* */
											   /*    file properties */
											   /* */
		/* for images, refer to 'Digital Still Camera Image File Format Standard' Exif Version 2.1 section 2.6.4.
		 * and 2.6.5.*/
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	ICAGetChildCount(ICAGetChildCountPB *pb, ICACompletion completion); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	ICAGetNthChild(ICAGetNthChildPB *pb, ICACompletion completion); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	ICAGetObjectInfo(ICAGetObjectInfoPB *pb, ICACompletion completion); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	ICAGetParentOfObject(ICAGetParentOfObjectPB *pb, ICACompletion completion); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	ICAGetRootOfObject(ICAGetRootOfObjectPB *pb, ICACompletion completion); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	ICAGetObjectRefCon(ICAGetObjectRefConPB *pb, ICACompletion completion); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	ICASetObjectRefCon(ICASetObjectRefConPB *pb, ICACompletion completion); /* can be NULL */
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	ICAGetPropertyCount(ICAGetPropertyCountPB *pb, ICACompletion completion); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	ICAGetNthProperty(ICAGetNthPropertyPB *pb, ICACompletion completion); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	ICAGetPropertyByType(ICAGetPropertyByTypePB *pb, ICACompletion completion); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	ICAGetPropertyInfo(ICAGetPropertyInfoPB *pb, ICACompletion completion); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	ICAGetPropertyData(ICAGetPropertyDataPB *pb, ICACompletion completion); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	ICASetPropertyData(ICASetPropertyDataPB *pb, ICACompletion completion); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	ICAGetParentOfProperty(ICAGetParentOfPropertyPB *pb, ICACompletion completion); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	ICAGetRootOfProperty(ICAGetRootOfPropertyPB *pb, ICACompletion completion); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	ICAGetPropertyRefCon(ICAGetPropertyRefConPB *pb, ICACompletion completion); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	ICASetPropertyRefCon(ICASetPropertyRefConPB *pb, ICACompletion completion); /* can be NULL */
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	ICAGetDeviceList(ICAGetDeviceListPB *pb, ICACompletion completion); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	ICAObjectSendMessage(ICAObjectSendMessagePB *pb, ICACompletion completion); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	ICARegisterEventNotification(ICARegisterEventNotificationPB *pb, ICACompletion completion); /* can be NULL */
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	ICADownloadFile(ICADownloadFilePB *pb, ICACompletion completion); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	ICACopyObjectPropertyDictionary(ICACopyObjectPropertyDictionaryPB *pb, ICACompletion completion); /* can be NULL */
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	ICAScannerOpenSession(ICAScannerOpenSessionPB *pb, ICACompletion completion); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	ICAScannerCloseSession(ICAScannerCloseSessionPB *pb, ICACompletion completion); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	ICAScannerInitialize(ICAScannerInitializePB *pb, ICACompletion completion); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	ICAScannerGetParameters(ICAScannerGetParametersPB *pb, ICACompletion completion); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	ICAScannerSetParameters(ICAScannerSetParametersPB *pb, ICACompletion completion); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	ICAScannerStatus(ICAScannerStatusPB *pb, ICACompletion completion); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSErr)
	ICAScannerStart(ICAScannerStartPB *pb, ICACompletion completion); /* can be NULL */
