...
#pragma pack(2)
	...
	enum
	{
		...
		kSelectRegistryEntryPropertyMod =
			30, /* if you add more selectors here, remember to change 'kSelectRegistryHighestSelector' below*/
 ...
 */
	...
	RegistryEntryIDCompare(const RegEntryID *id1, const RegEntryID *id2) TWOWORDINLINE(0x7001, 0xABE9);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	RegistryEntryIDCopy(const RegEntryID *src, RegEntryID *dst) TWOWORDINLINE(0x7002, 0xABE9);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	RegistryCStrEntryCreate(const RegEntryID *parentEntry, const RegCStrPathName *name, RegEntryID *newEntry)
 ...
 */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	RegistryEntryIterateSet(RegEntryIter *cookie, const RegEntryID *startEntryID) TWOWORDINLINE(0x7009, 0xABE9);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	RegistryEntryIterate(RegEntryIter *cookie, RegEntryIterationOp relationship, RegEntryID *foundEntry, Boolean *done)
	 ...
	 */
	EXTERN_API_C(OSStatus)
	RegistryEntrySearch(RegEntryIter *cookie, RegEntryIterationOp relationship, RegEntryID *foundEntry, Boolean *done,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	RegistryCStrEntryLookup(const RegEntryID *searchPointID, const RegCStrPathName *pathName, RegEntryID *foundEntry)
	 ...
	 */
	EXTERN_API_C(OSStatus)
	RegistryEntryToPathSize(const RegEntryID *entryID, RegPathNameSize *pathSize) TWOWORDINLINE(0x700D, 0xABE9);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	RegistryCStrEntryToPath(const RegEntryID *entryID, RegCStrPathName *pathName, RegPathNameSize pathSize)
		TWOWORDINLINE(0x700E, 0xABE9);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	RegistryCStrEntryToName(const RegEntryID *entryID, RegEntryID *parentEntry, RegCStrEntryName *nameComponent,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	RegistryPropertyCreate(const RegEntryID *entryID, const RegPropertyName *propertyName, const void *propertyValue,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	RegistryPropertyDelete(const RegEntryID *entryID, const RegPropertyName *propertyName)
	 ...
	 */
	EXTERN_API_C(OSStatus)
	RegistryPropertyRename(const RegEntryID *entry, const RegPropertyName *oldName, const RegPropertyName *newName)
 ...
 */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	RegistryPropertyIterateCreate(const RegEntryID *entry, RegPropertyIter *cookie) TWOWORDINLINE(0x7013, 0xABE9);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	RegistryPropertyIterate(RegPropertyIter *cookie, RegPropertyName *foundProperty, Boolean *done)
		TWOWORDINLINE(0x7015, 0xABE9);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	RegistryPropertyGetSize(const RegEntryID *entryID, const RegPropertyName *propertyName,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	RegistryPropertyGet(const RegEntryID *entryID, const RegPropertyName *propertyName, void *propertyValue,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	RegistryPropertySet(const RegEntryID *entryID, const RegPropertyName *propertyName, const void *propertyValue,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	RegistryEntryGetMod(const RegEntryID *entry, RegEntryModifiers *modifiers) TWOWORDINLINE(0x7019, 0xABE9);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	RegistryEntrySetMod(const RegEntryID *entry, RegEntryModifiers modifiers) TWOWORDINLINE(0x701A, 0xABE9);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	RegistryPropertyGetMod(const RegEntryID *entry, const RegPropertyName *name, RegPropertyModifiers *modifiers)
	 ...
	 */
	EXTERN_API_C(OSStatus)
	RegistryPropertySetMod(const RegEntryID *entry, const RegPropertyName *name, RegPropertyModifiers modifiers)
	 ...
	 */
	EXTERN_API_C(OSStatus)
	RegistryEntryMod(RegEntryIter *cookie, RegEntryIterationOp relationship, RegEntryID *foundEntry, Boolean *done,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	RegistryEntryPropertyMod(RegEntryIter *cookie, RegEntryIterationOp relationship, RegEntryID *foundEntry,
							 Boolean *done, RegPropertyModifiers matchingModifiers) TWOWORDINLINE(0x701E, 0xABE9);
