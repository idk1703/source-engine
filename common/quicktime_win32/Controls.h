	...
	*/
	...
	enum
	{
		kControlCanAutoInvalidate =
			1L << 0 /* Control component automatically invalidates areas left behind after hide/move operation.*/
	};
...
/*------------------------------------------------------------------------------------------------------*/
	...
	{
		return (ControlActionUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppControlActionProcInfo,
...
#define DisposeControlActionUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(void)
	InvokeControlActionUPP(ControlRef theControl, ControlPartCode partCode, ControlActionUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
/*------------------------------------------------------------------------------------------------------*/
	...
	enum
	{
		...
		kControlCollectionTagUnicodeTitle =
			FOUR_CHAR_CODE('uttl'), /* bytes as received via CFStringCreateExternalRepresentation*/
	...
	enum
	{
		kControlKeyScriptBehaviorAllowAnyScript =
			FOUR_CHAR_CODE('any '), /* leaves the current keyboard alone and allows user to change the keyboard.*/
		kControlKeyScriptBehaviorPrefersRoman =
			FOUR_CHAR_CODE('prmn'), /* switches the keyboard to roman, but allows them to change it as desired.*/
		kControlKeyScriptBehaviorRequiresRoman =
			FOUR_CHAR_CODE('rrmn') /* switches the keyboard to roman and prevents the user from changing it.*/
	};
	...
	*/
	...
	enum
	{
		...
		kDoNotActivateAndHandleClick =
			1, /* let the control handle the click while the window is still in the background.*/
		kActivateAndIgnoreClick =
			2, /* control doesn't want to respond directly to the click, but window should still be brought forward.*/
		kActivateAndHandleClick =
			3 /* control wants to respond to the click, but only after the window has been activated.*/
	};
	...
	enum
	{
		...
		kControlIdlesWithTimer =
			1 << 23 /* Available in Carbon - this bit indicates that the control animates automatically*/
	};
	...
	enum
	{
		...
		kControlMsgDragEnter =
			38, /* Available in Carbon. Param is DragRef, result is boolean indicating acceptibility of drag.*/
		...
		kControlMsgDragReceive =
			41, /* Available in Carbon. Param is DragRef, result is OSStatus indicating success/failure.*/
	...
	/*  o 'CDEF' entrypoint                                                                 */
	/*--------------------------------------------------------------------------------------*/
	typedef CALLBACK_API(SInt32, ControlDefProcPtr)(SInt16 varCode, ControlRef theControl,
	...
	{
		return (ControlDefUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppControlDefProcInfo,
												   GetCurrentArchitecture());
	}
#else
...
#define DisposeControlDefUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(SInt32)
	InvokeControlDefUPP(SInt16 varCode, ControlRef theControl, ControlDefProcMessage message, SInt32 param,
						ControlDefUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(SInt32) InvokeControlDefUPP(SInt16 varCode, ControlRef theControl,
													ControlDefProcMessage message, SInt32 param, ControlDefUPP userUPP)
	{
...
#define InvokeControlDefUPP(varCode, theControl, message, param, userUPP) \
	(SInt32) CALL_FOUR_PARAMETER_UPP((userUPP), uppControlDefProcInfo, (varCode), (theControl), (message), (param))
#endif
#endif
...
#define CallControlDefProc(userRoutine, varCode, theControl, message, param) \
	...
	typedef CALLBACK_API(ControlKeyFilterResult, ControlKeyFilterProcPtr)(ControlRef theControl, SInt16 *keyCode,
	...
	{
		return (ControlKeyFilterUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppControlKeyFilterProcInfo,
														 GetCurrentArchitecture());
	}
#else
#define NewControlKeyFilterUPP(userRoutine) \
	(ControlKeyFilterUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppControlKeyFilterProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeControlKeyFilterUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	...
	InvokeControlKeyFilterUPP(ControlRef theControl, SInt16 *keyCode, SInt16 *charCode, EventModifiers *modifiers,
							  ControlKeyFilterUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(ControlKeyFilterResult)
		InvokeControlKeyFilterUPP(ControlRef theControl, SInt16 *keyCode, SInt16 *charCode, EventModifiers *modifiers,
								  ControlKeyFilterUPP userUPP)
	{
		return (ControlKeyFilterResult)CALL_FOUR_PARAMETER_UPP(userUPP, uppControlKeyFilterProcInfo, theControl,
															   keyCode, charCode, modifiers);
	}
#else
#define InvokeControlKeyFilterUPP(theControl, keyCode, charCode, modifiers, userUPP)                                  \
	(ControlKeyFilterResult) CALL_FOUR_PARAMETER_UPP((userUPP), uppControlKeyFilterProcInfo, (theControl), (keyCode), \
													 (charCode), (modifiers))
#endif
#endif
...
#define CallControlKeyFilterProc(userRoutine, theControl, keyCode, charCode, modifiers) \
	InvokeControlKeyFilterUPP(theControl, keyCode, charCode, modifiers, userRoutine)
#endif /* CALL_NOT_IN_CARBON */
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateCustomControl(WindowRef owningWindow, const Rect *contBounds, const ControlDefSpec *def, Collection initData,
	...
	NewControl(WindowRef owningWindow, const Rect *boundsRect, ConstStr255Param controlTitle, Boolean initiallyVisible,
			   SInt16 initialValue, SInt16 minimumValue, SInt16 maximumValue, SInt16 procID, SInt32 controlReference)
	...
	/*--------------------------------------------------------------------------------------*/
	typedef CALLBACK_API(OSStatus, ControlCNTLToCollectionProcPtr)(const Rect *bounds, SInt16 value, Boolean visible,
																   SInt16 max, SInt16 min, SInt16 procID, SInt32 refCon,
	...
	}; /* pascal 4_bytes Func(4_bytes, 2_bytes, 1_byte, 2_bytes, 2_bytes, 2_bytes, 4_bytes, 4_bytes, 4_bytes) */
#ifdef __cplusplus
	inline DEFINE_API_C(ControlCNTLToCollectionUPP)
		NewControlCNTLToCollectionUPP(ControlCNTLToCollectionProcPtr userRoutine)
	{
		return (ControlCNTLToCollectionUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppControlCNTLToCollectionProcInfo, GetCurrentArchitecture());
	}
#else
#define NewControlCNTLToCollectionUPP(userRoutine) \
	(ControlCNTLToCollectionUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppControlCNTLToCollectionProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeControlCNTLToCollectionUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	...
	InvokeControlCNTLToCollectionUPP(const Rect *bounds, SInt16 value, Boolean visible, SInt16 max, SInt16 min,
	...
	inline DEFINE_API_C(OSStatus)
		InvokeControlCNTLToCollectionUPP(const Rect *bounds, SInt16 value, Boolean visible, SInt16 max, SInt16 min,
										 ...
										 ControlCNTLToCollectionUPP userUPP)
	{
		return (OSStatus)CALL_NINE_PARAMETER_UPP(userUPP, uppControlCNTLToCollectionProcInfo, bounds, value, visible,
												 max, min, procID, refCon, title, collection);
	}
#else
#define InvokeControlCNTLToCollectionUPP(bounds, value, visible, max, min, procID, refCon, title, collection, userUPP) \
	(OSStatus) CALL_NINE_PARAMETER_UPP((userUPP), uppControlCNTLToCollectionProcInfo, (bounds), (value), (visible),    \
									   (max), (min), (procID), (refCon), (title), (collection))
#endif
#endif
...
#define CallControlCNTLToCollectionProc(userRoutine, bounds, value, visible, max, min, procID, refCon, title, \
										collection)                                                           \
	InvokeControlCNTLToCollectionUPP(bounds, value, visible, max, min, procID, refCon, title, collection, userRoutine)
#endif /* CALL_NOT_IN_CARBON */
	 ...
	 */
	EXTERN_API(OSStatus)
	RegisterControlDefinition(SInt16 inCDEFResID, const ControlDefSpec *inControlDef,
	 ...
	 */
	EXTERN_API(void)
	HiliteControl(ControlRef theControl, ControlPartCode hiliteState) ONEWORDINLINE(0xA95D);
	 ...
	 */
	EXTERN_API(OSErr)
	SetControlVisibility(ControlRef inControl, Boolean inIsVisible, Boolean inDoDraw)
		THREEWORDINLINE(0x303C, 0x001E, 0xAA73);
...
#define DrawOneControl(theControl) Draw1Control(theControl)
	 ...
	 */
	EXTERN_API(void)
	UpdateControls(WindowRef inWindow, RgnHandle inUpdateRegion) /* can be NULL */ ONEWORDINLINE(0xA953);
	 ...
	 */
	EXTERN_API(OSErr)
	GetBestControlRect(ControlRef inControl, Rect *outRect, SInt16 *outBaseLineOffset)
	 ...
	 */
	EXTERN_API(OSErr)
	SetUpControlBackground(ControlRef inControl, SInt16 inDepth, Boolean inIsColorDevice)
	 ...
	 */
	EXTERN_API(OSErr)
	SetUpControlTextColor(ControlRef inControl, SInt16 inDepth, Boolean inIsColorDevice);
	 ...
	 */
	typedef CALLBACK_API(OSStatus, ControlColorProcPtr)(ControlRef inControl, SInt16 inMessage, SInt16 inDrawDepth,
	...
	{
		return (ControlColorUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppControlColorProcInfo,
													 GetCurrentArchitecture());
	}
#else
#define NewControlColorUPP(userRoutine) \
	(ControlColorUPP) NewRoutineDescriptor((ProcPtr)(userRoutine), uppControlColorProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeControlColorUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(OSStatus)
	InvokeControlColorUPP(ControlRef inControl, SInt16 inMessage, SInt16 inDrawDepth, Boolean inDrawInColor,
						  ControlColorUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSStatus) InvokeControlColorUPP(ControlRef inControl, SInt16 inMessage, SInt16 inDrawDepth,
														Boolean inDrawInColor, ControlColorUPP userUPP)
	{
		return (OSStatus)CALL_FOUR_PARAMETER_UPP(userUPP, uppControlColorProcInfo, inControl, inMessage, inDrawDepth,
												 inDrawInColor);
	}
#else
#define InvokeControlColorUPP(inControl, inMessage, inDrawDepth, inDrawInColor, userUPP)                            \
	(OSStatus) CALL_FOUR_PARAMETER_UPP((userUPP), uppControlColorProcInfo, (inControl), (inMessage), (inDrawDepth), \
									   (inDrawInColor))
#endif
#endif
...
#define CallControlColorProc(userRoutine, inControl, inMessage, inDrawDepth, inDrawInColor) \
	InvokeControlColorUPP(inControl, inMessage, inDrawDepth, inDrawInColor, userRoutine)
#endif /* CALL_NOT_IN_CARBON */
	...
	*/
	...
	TrackControl(ControlRef theControl, Point startPoint,
	 ...
	 */
	EXTERN_API(void)
	DragControl(ControlRef theControl, Point startPoint, const Rect *limitRect, const Rect *slopRect,
	 ...
	 */
	EXTERN_API(ControlPartCode)
	FindControl(Point testPoint, WindowRef theWindow, ControlRef *theControl) ONEWORDINLINE(0xA96C);
	 ...
	 */
	EXTERN_API(ControlPartCode)
	HandleControlClick(ControlRef inControl, Point inWhere, EventModifiers inModifiers,
	 ...
	 */
	EXTERN_API(OSStatus)
	HandleControlContextualMenuClick(ControlRef inControl, Point inWhere, Boolean *menuDisplayed);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetControlClickActivation(ControlRef inControl, Point inWhere, EventModifiers inModifiers,
	 ...
	 */
	EXTERN_API(ControlPartCode)
	HandleControlKey(ControlRef inControl, SInt16 inKeyCode, SInt16 inCharCode, EventModifiers inModifiers)
	 ...
	 */
	EXTERN_API(OSStatus)
	HandleControlSetCursor(ControlRef control, Point localPoint, EventModifiers modifiers, Boolean *cursorWasSet);
	 ...
	 */
	EXTERN_API(void)
	SetControlTitle(ControlRef theControl, ConstStr255Param title) ONEWORDINLINE(0xA95F);
	 ...
	 */
	EXTERN_API(void)
	SetControlMinimum(ControlRef theControl, SInt16 newMinimum) ONEWORDINLINE(0xA964);
	 ...
	 */
	EXTERN_API(void)
	SetControlMaximum(ControlRef theControl, SInt16 newMaximum) ONEWORDINLINE(0xA965);
	...
	*/
	 ...
	 */
	EXTERN_API(OSStatus)
	GetControlByID(WindowRef inWindow, const ControlID *inID, ControlRef *outControl);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetControlProperty(ControlRef control, OSType propertyCreator, OSType propertyTag, UInt32 bufferSize,
	 ...
	 */
	EXTERN_API(OSStatus)
	GetControlPropertySize(ControlRef control, OSType propertyCreator, OSType propertyTag, UInt32 *size);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetControlProperty(ControlRef control, OSType propertyCreator, OSType propertyTag, UInt32 propertySize,
	 ...
	 */
	EXTERN_API(OSStatus)
	RemoveControlProperty(ControlRef control, OSType propertyCreator, OSType propertyTag);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetControlPropertyAttributes(ControlRef control, OSType propertyCreator, OSType propertyTag, UInt32 *attributes);
	 ...
	 */
	EXTERN_API(OSStatus)
	ChangeControlPropertyAttributes(ControlRef control, OSType propertyCreator, OSType propertyTag,
	 ...
	 */
	EXTERN_API(OSStatus)
	GetControlRegion(ControlRef inControl, ControlPartCode inPart, RgnHandle outRegion);
	 ...
	 */
	EXTERN_API(void)
	SetControlAction(ControlRef theControl, ControlActionUPP actionProc) ONEWORDINLINE(0xA96B);
	 ...
	 */
	EXTERN_API(Boolean)
	GetAuxiliaryControlRecord(ControlRef theControl, AuxCtlHandle *acHndl) ONEWORDINLINE(0xAA44);
	 ...
	 */
	EXTERN_API(void)
	SetControlColor(ControlRef theControl, CCTabHandle newColorTable) ONEWORDINLINE(0xAA43);
...
/*--------------------------------------------------------------------------------------*/
	 ...
	 */
	EXTERN_API(SInt32)
	SendControlMessage(ControlRef inControl, SInt16 inMessage, void *inParam) THREEWORDINLINE(0x303C, 0xFFFE, 0xAA73);
	 ...
	 */
	EXTERN_API(OSErr)
	DumpControlHierarchy(WindowRef inWindow, const FSSpec *inDumpFile) THREEWORDINLINE(0x303C, 0xFFFF, 0xAA73);
	 ...
	 */
	EXTERN_API(OSErr)
	CreateRootControl(WindowRef inWindow, ControlRef *outControl) /* can be NULL */ THREEWORDINLINE(0x303C, 0x0001,
																									0xAA73);
	 ...
	 */
	EXTERN_API(OSErr)
	GetRootControl(WindowRef inWindow, ControlRef *outControl) THREEWORDINLINE(0x303C, 0x0002, 0xAA73);
	 ...
	 */
	EXTERN_API(OSErr)
	EmbedControl(ControlRef inControl, ControlRef inContainer) THREEWORDINLINE(0x303C, 0x0003, 0xAA73);
	 ...
	 */
	EXTERN_API(OSErr)
	AutoEmbedControl(ControlRef inControl, WindowRef inWindow) THREEWORDINLINE(0x303C, 0x0004, 0xAA73);
	 ...
	 */
	EXTERN_API(OSErr)
	GetSuperControl(ControlRef inControl, ControlRef *outParent) THREEWORDINLINE(0x303C, 0x0015, 0xAA73);
	 ...
	 */
	EXTERN_API(OSErr)
	CountSubControls(ControlRef inControl, UInt16 *outNumChildren) THREEWORDINLINE(0x303C, 0x0016, 0xAA73);
	 ...
	 */
	EXTERN_API(OSErr)
	GetIndexedSubControl(ControlRef inControl, UInt16 inIndex, ControlRef *outSubControl)
	 ...
	 */
	EXTERN_API(OSErr)
	SetControlSupervisor(ControlRef inControl, ControlRef inBoss) THREEWORDINLINE(0x303C, 0x001A, 0xAA73);
	 ...
	 */
	EXTERN_API(OSErr)
	GetKeyboardFocus(WindowRef inWindow, ControlRef *outControl) THREEWORDINLINE(0x303C, 0x000D, 0xAA73);
	 ...
	 */
	EXTERN_API(OSErr)
	SetKeyboardFocus(WindowRef inWindow, ControlRef inControl, ControlFocusPart inPart)
	 ...
	 */
	EXTERN_API(OSErr)
	GetControlFeatures(ControlRef inControl, UInt32 *outFeatures) THREEWORDINLINE(0x303C, 0x0011, 0xAA73);
	 ...
	 */
	EXTERN_API(OSErr)
	SetControlData(ControlRef inControl, ControlPartCode inPart, ResType inTagName, Size inSize, const void *inData)
	 ...
	 */
	EXTERN_API(OSErr)
	GetControlData(ControlRef inControl, ControlPartCode inPart, ResType inTagName, Size inBufferSize, void *inBuffer,
	 ...
	 */
	EXTERN_API(OSErr)
	GetControlDataSize(ControlRef inControl, ControlPartCode inPart, ResType inTagName, Size *outMaxSize)
	 ...
	 */
	EXTERN_API(OSStatus)
	HandleControlDragTracking(ControlRef inControl, DragTrackingMessage inMessage, DragReference inDrag,
	 ...
	 */
	EXTERN_API(OSStatus)
	SetControlDragTrackingEnabled(ControlRef inControl, Boolean inTracks);
	 ...
	 */
	EXTERN_API(OSStatus)
	IsControlDragTrackingEnabled(ControlRef inControl, Boolean *outTracks);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetAutomaticControlDragTrackingEnabledForWindow(WindowRef inWindow, Boolean inTracks);
	 ...
	 */
	EXTERN_API(OSStatus)
	IsAutomaticControlDragTrackingEnabledForWindow(WindowRef inWindow, Boolean *outTracks);
	...
	typedef CALLBACK_API_C(void, ControlNotificationProcPtr)(WindowRef theWindow, ControlRef theControl,
															 ControlNotification notification, long param1,
															 long param2);
	/*
...
/*--------------------------------------------------------------------------------------*/
	 ...
	 */
	EXTERN_API_C(void)
	dragcontrol(ControlRef theControl, Point *startPt, const Rect *limitRect, const Rect *slopRect, short axis);
	 ...
	 */
	EXTERN_API_C(ControlRef)
	newcontrol(WindowRef theWindow, const Rect *boundsRect, const char *title, Boolean visible, short value, short min,
	 ...
	 */
	EXTERN_API_C(short)
	trackcontrol(ControlRef theControl, Point *thePoint, ControlActionUPP actionProc);
