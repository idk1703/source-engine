...
#pragma pack(2)
	...
	*/
	 ...
	 */
	EXTERN_API_C(OSStatus)
	AEBuildAppleEvent(AEEventClass theClass, AEEventID theID, DescType addressType, const void *addressData,
					  long addressLength, short returnID, long transactionID, AppleEvent *result,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	vAEBuildAppleEvent(AEEventClass theClass, AEEventID theID, DescType addressType, const void *addressData,
					   long addressLength, short returnID, long transactionID, AppleEvent *resultEvt,
					   AEBuildError *error, /* can be NULL */
	...
	*/
	 ...
	 */
	EXTERN_API_C(OSStatus)
	AEStreamWriteDesc(AEStreamRef ref, DescType newType, const void *data, Size length);
	...
	*/
	 ...
	 */
	EXTERN_API_C(OSStatus)
	AEStreamWriteKeyDesc(AEStreamRef ref, AEKeyword key, DescType newType, const void *data, Size length);
	...
	*/
	 ...
	 */
	EXTERN_API_C(AEStreamRef)
	AEStreamCreateEvent(AEEventClass clazz, AEEventID id, DescType targetType, const void *targetData,
						long targetLength, short returnID, long transactionID);
