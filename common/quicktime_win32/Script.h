...
#pragma pack(2)
	...
	*/
	...
	enum
	{
		...
		smKeyRoman = -17 /* Set keyscript to Roman. Does nothing if Roman-only system, unlike KeyScript(smRoman) which
							forces an update to current default Roman keyboard */
	};
	...
	enum
	{
		...
		smfDisableKeyScriptSyncMask =
			1L << smfDisableKeyScriptSync /*Disable font and keyboard script synchronization mask*/
	};
	 ...
	 */
	EXTERN_API(OSErr)
	SetScriptManagerVariable(short selector, long param) FOURWORDINLINE(0x2F3C, 0x8206, 0x000A, 0xA8B5);
	 ...
	 */
	EXTERN_API(long)
	GetScriptVariable(short script, short selector) FOURWORDINLINE(0x2F3C, 0x8404, 0x000C, 0xA8B5);
	 ...
	 */
	EXTERN_API(OSErr)
	SetScriptVariable(short script, short selector, long param) FOURWORDINLINE(0x2F3C, 0x8208, 0x000E, 0xA8B5);
	 ...
	 */
	EXTERN_API(short)
	CharacterByteType(Ptr textBuf, short textOffset, ScriptCode script) FOURWORDINLINE(0x2F3C, 0xC206, 0x0010, 0xA8B5);
	 ...
	 */
	EXTERN_API(short)
	CharacterType(Ptr textBuf, short textOffset, ScriptCode script) FOURWORDINLINE(0x2F3C, 0xC206, 0x0012, 0xA8B5);
	 ...
	 */
	EXTERN_API(OSErr)
	TransliterateText(Handle srcHandle, Handle dstHandle, short target, long srcMask, ScriptCode script)
	 ...
	 */
	EXTERN_API(Boolean)
	FillParseTable(CharByteTable table, ScriptCode script) FOURWORDINLINE(0x2F3C, 0xC204, 0x0022, 0xA8B5);
	 ...
	 */
	EXTERN_API(void)
	GetIntlResourceTable(ScriptCode script, short tableCode, Handle *itlHandle, long *offset, long *length)
	 ...
	 */
	EXTERN_API(void)
	SetScriptUtilityAddress(short selector, Boolean Before, UniversalProcPtr routineAddr, ScriptCode script)
	 ...
	 */
	EXTERN_API(UniversalProcPtr)
	GetScriptQDPatchAddress(short trapNum, Boolean Before, Boolean forPrinting, ScriptCode script)
	 ...
	 */
	EXTERN_API(void)
	SetScriptQDPatchAddress(short trapNum, Boolean Before, Boolean forPrinting, UniversalProcPtr routineAddr,
	 ...
	 */
	EXTERN_API(void)
	SetIntlResource(short refNum, short theID, Handle intlHandle) THREEWORDINLINE(0x3F3C, 0x0008, 0xA9ED);
	 ...
	 */
	EXTERN_API(short)
	CharByte(Ptr textBuf, short textOffset) FOURWORDINLINE(0x2F3C, 0x8206, 0x0010, 0xA8B5);
	 ...
	 */
	EXTERN_API(short)
	CharType(Ptr textBuf, short textOffset) FOURWORDINLINE(0x2F3C, 0x8206, 0x0012, 0xA8B5);
