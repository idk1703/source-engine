...
#define kCFTypeDictionaryKeyCallBacks \
	(*((const CFDictionaryKeyCallBacks *)QTGetCFConstant("kCFTypeDictionaryKeyCallBacks")))
#else
CF_EXPORT
...
#define kCFCopyStringDictionaryKeyCallBacks \
	(*((const CFDictionaryKeyCallBacks *)QTGetCFConstant("kCFCopyStringDictionaryKeyCallBacks")))
#else
CF_EXPORT
...
#define kCFTypeDictionaryValueCallBacks \
	(*((const CFDictionaryValueCallBacks *)QTGetCFConstant("kCFTypeDictionaryValueCallBacks")))
#else
CF_EXPORT
