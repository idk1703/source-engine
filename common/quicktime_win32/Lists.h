...
#pragma pack(2)
	...
	*/
	...
	typedef CALLBACK_API(void, ListDefProcPtr)(short lMessage, Boolean lSelect, Rect *lRect, Cell lCell,
	...
	{
		return (ListSearchUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppListSearchProcInfo,
...
#define NewListSearchUPP(userRoutine) \
	...
	{
		return (ListClickLoopUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppListClickLoopProcInfo,
													  GetCurrentArchitecture());
	}
#else
...
#define DisposeListDefUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(short)
	InvokeListSearchUPP(Ptr aPtr, Ptr bPtr, short aLen, short bLen, ListSearchUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeListSearchUPP(aPtr, bPtr, aLen, bLen, userUPP) \
	(short)CALL_FOUR_PARAMETER_UPP((userUPP), uppListSearchProcInfo, (aPtr), (bPtr), (aLen), (bLen))
#endif
#endif
...
#define InvokeListClickLoopUPP(userUPP) (Boolean) CALL_ZERO_PARAMETER_UPP((userUPP), uppListClickLoopProcInfo)
	 ...
	 */
	EXTERN_API_C(void)
	InvokeListDefUPP(short lMessage, Boolean lSelect, Rect *lRect, Cell lCell, short lDataOffset, short lDataLen,
	...
	inline DEFINE_API_C(void)
		InvokeListDefUPP(short lMessage, Boolean lSelect, Rect *lRect, Cell lCell, short lDataOffset, short lDataLen,
						 ListHandle lHandle, ListDefUPP userUPP)
	{
		CALL_SEVEN_PARAMETER_UPP(userUPP, uppListDefProcInfo, lMessage, lSelect, lRect, lCell, lDataOffset, lDataLen,
								 lHandle);
	}
#else
#define InvokeListDefUPP(lMessage, lSelect, lRect, lCell, lDataOffset, lDataLen, lHandle, userUPP)                  \
	CALL_SEVEN_PARAMETER_UPP((userUPP), uppListDefProcInfo, (lMessage), (lSelect), (lRect), (lCell), (lDataOffset), \
							 (lDataLen), (lHandle))
#endif
#endif
...
#define CallListDefProc(userRoutine, lMessage, lSelect, lRect, lCell, lDataOffset, lDataLen, lHandle) \
	InvokeListDefUPP(lMessage, lSelect, lRect, lCell, lDataOffset, lDataLen, lHandle, userRoutine)
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateCustomList(const Rect *rView, const ListBounds *dataBounds, Point cellSize, const ListDefSpec *theSpec,
					 WindowRef theWindow, Boolean drawIt, Boolean hasGrow, Boolean scrollHoriz, Boolean scrollVert,
					 ListHandle *outList);
	...
	LNew(const Rect *rView, const ListBounds *dataBounds, Point cSize, short theProc, WindowRef theWindow,
		 Boolean drawIt, Boolean hasGrow, Boolean scrollHoriz, Boolean scrollVert)
	 ...
	 */
	EXTERN_API(short)
	LAddColumn(short count, short colNum, ListHandle lHandle) THREEWORDINLINE(0x3F3C, 0x0004, 0xA9E7);
	 ...
	 */
	EXTERN_API(short)
	LAddRow(short count, short rowNum, ListHandle lHandle) THREEWORDINLINE(0x3F3C, 0x0008, 0xA9E7);
	 ...
	 */
	EXTERN_API(void)
	LDelColumn(short count, short colNum, ListHandle lHandle) THREEWORDINLINE(0x3F3C, 0x0020, 0xA9E7);
	 ...
	 */
	EXTERN_API(void)
	LDelRow(short count, short rowNum, ListHandle lHandle) THREEWORDINLINE(0x3F3C, 0x0024, 0xA9E7);
	 ...
	 */
	EXTERN_API(Boolean)
	LGetSelect(Boolean next, Cell *theCell, ListHandle lHandle) THREEWORDINLINE(0x3F3C, 0x003C, 0xA9E7);
	 ...
	 */
	EXTERN_API(Boolean)
	LNextCell(Boolean hNext, Boolean vNext, Cell *theCell, ListHandle lHandle) THREEWORDINLINE(0x3F3C, 0x0048, 0xA9E7);
	 ...
	 */
	EXTERN_API(Boolean)
	LSearch(const void *dataPtr, short dataLen, ListSearchUPP searchProc, Cell *theCell, ListHandle lHandle)
	 ...
	 */
	EXTERN_API(void)
	LSize(short listWidth, short listHeight, ListHandle lHandle) THREEWORDINLINE(0x3F3C, 0x0060, 0xA9E7);
	 ...
	 */
	EXTERN_API(void)
	LSetDrawingMode(Boolean drawIt, ListHandle lHandle) THREEWORDINLINE(0x3F3C, 0x002C, 0xA9E7);
	 ...
	 */
	EXTERN_API(void)
	LScroll(short dCols, short dRows, ListHandle lHandle) THREEWORDINLINE(0x3F3C, 0x0050, 0xA9E7);
	 ...
	 */
	EXTERN_API(void)
	LUpdate(RgnHandle theRgn, ListHandle lHandle) THREEWORDINLINE(0x3F3C, 0x0064, 0xA9E7);
	 ...
	 */
	EXTERN_API(void)
	LCellSize(Point cSize, ListHandle lHandle) THREEWORDINLINE(0x3F3C, 0x0014, 0xA9E7);
	 ...
	 */
	EXTERN_API(Boolean)
	LClick(Point pt, EventModifiers modifiers, ListHandle lHandle) THREEWORDINLINE(0x3F3C, 0x0018, 0xA9E7);
	 ...
	 */
	EXTERN_API(void)
	LClrCell(Cell theCell, ListHandle lHandle) THREEWORDINLINE(0x3F3C, 0x001C, 0xA9E7);
	 ...
	 */
	EXTERN_API(void)
	LGetCell(void *dataPtr, short *dataLen, Cell theCell, ListHandle lHandle) THREEWORDINLINE(0x3F3C, 0x0038, 0xA9E7);
	 ...
	 */
	EXTERN_API(void)
	LRect(Rect *cellRect, Cell theCell, ListHandle lHandle) THREEWORDINLINE(0x3F3C, 0x004C, 0xA9E7);
	 ...
	 */
	EXTERN_API(void)
	LSetSelect(Boolean setIt, Cell theCell, ListHandle lHandle) THREEWORDINLINE(0x3F3C, 0x005C, 0xA9E7);
	 ...
	 */
	EXTERN_API(void)
	LGetCellDataLocation(short *offset, short *len, Cell theCell, ListHandle lHandle)
...
/* QuickTime 3.0 */
	 ...
	 */
	EXTERN_API_C(void)
	LSetLDEF(ListDefProcPtr proc, ListHandle lHandle);
	 ...
	 */
	EXTERN_API_C(void)
	laddtocell(const void *dataPtr, short dataLen, const Cell *theCell, ListHandle lHandle);
	 ...
	 */
	EXTERN_API_C(void)
	lgetcelldatalocation(short *offset, short *len, const Cell *theCell, ListHandle lHandle);
	 ...
	 */
	EXTERN_API_C(void)
	lgetcell(void *dataPtr, short *dataLen, const Cell *theCell, ListHandle lHandle);
	 ...
	 */
	EXTERN_API_C(void)
	lsetcell(const void *dataPtr, short dataLen, const Cell *theCell, ListHandle lHandle);
...
#define lfind(offset, len, theCell, lHandle) lgetcelldatalocation(offset, len, theCell, lHandle)
	 ...
	 */
	EXTERN_API(Rect *)
	GetListViewBounds(ListHandle list, Rect *view);
	 ...
	 */
	EXTERN_API(Point *)
	GetListCellIndent(ListHandle list, Point *indent);
	 ...
	 */
	EXTERN_API(Point *)
	GetListCellSize(ListHandle list, Point *size);
	...
	GetListVisibleCells(ListHandle list, ListBounds *visible);
	 ...
	 */
	EXTERN_API(Point *)
	GetListClickLocation(ListHandle list, Point *click);
	 ...
	 */
	EXTERN_API(Point *)
	GetListMouseLocation(ListHandle list, Point *mouse);
	 ...
	 */
	EXTERN_API(ListBounds *)
	GetListDataBounds(ListHandle list, ListBounds *bounds);
	 ...
	 */
	EXTERN_API(void)
	SetListViewBounds(ListHandle list, const Rect *view);
	 ...
	 */
	EXTERN_API(void)
	SetListPort(ListHandle list, CGrafPtr port);
	 ...
	 */
	EXTERN_API(void)
	SetListCellIndent(ListHandle list, Point *indent);
	 ...
	 */
	EXTERN_API(void)
	SetListClickTime(ListHandle list, SInt32 time);
	 ...
	 */
	EXTERN_API(void)
	SetListClickLoop(ListHandle list, ListClickLoopUPP clickLoop);
	 ...
	 */
	EXTERN_API(void)
	SetListLastClick(ListHandle list, Cell *lastClick);
	 ...
	 */
	EXTERN_API(void)
	SetListRefCon(ListHandle list, SInt32 refCon);
	 ...
	 */
	EXTERN_API(void)
	SetListUserHandle(ListHandle list, Handle userHandle);
	 ...
	 */
	EXTERN_API(void)
	SetListFlags(ListHandle list, OptionBits listFlags);
	 ...
	 */
	EXTERN_API(void)
	SetListSelectionFlags(ListHandle list, OptionBits selectionFlags);
