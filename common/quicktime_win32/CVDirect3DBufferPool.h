...
/*! @header CVDirect3DBufferPool.h
   @copyright 2004 Apple Computer, Inc. All rights reserved.
   @discussion CVDirect3DBufferPool is a utility object for managing a set of CVDirect3DBuffer objects that are going to
   be recycled.
...
#define kCVDirect3DBufferPoolMaximumBufferAgeKey   CFSTR("MaximumBufferAge")
	...
	*/
	...
	/*!
		...
		@param      pixelBufferAttributes   A CFDictionaryRef containing the attributes to be used for creating new
	   D3DBuffers within the pool.
	...
	*/
	CV_EXPORT CVReturn CVDirect3DBufferPoolCreate(CFAllocatorRef allocator, CFDictionaryRef poolAttributes,
												  CFDictionaryRef pixelBufferAttributes, void *d3dDevice,
	...
	*/
	...
	/*!
		...
		@discussion The function creates a new (attachment-free) CVDirect3DBuffer using the pixel buffer attributes
