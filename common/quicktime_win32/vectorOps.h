...
*/
	...
	*************************************************************/
	 ...
	 */
	EXTERN_API_C(void)
	vSnaxpy(long n, long m, const vector float a[], const vector float x[], vector float y[]);
	...
	*************************************************************/
	 ...
	 */
	EXTERN_API_C(void)
	vSndot(long n, long m, float s[], long isw, const vector float x[], const vector float y[]);
	...
	*************************************************************/
	 ...
	 */
	EXTERN_API_C(void)
	vSzaxpy(long n, float alpha, const vector float x[], const vector float yY[], vector float z[]);
	...
	*************************************************************/
	 ...
	 */
	EXTERN_API_C(void)
	vSgemv(char forma, long m, long n, float alpha, const vector float a[], const vector float x[], float beta,
		   vector float y[]);
	...
	*************************************************************/
	 ...
	 */
	EXTERN_API_C(void)
	vSgemx(long m, long n, float alpha, const vector float a[], const vector float x[], vector float y[]);
	...
	*************************************************************/
	 ...
	 */
	EXTERN_API_C(void)
	vSgemtx(long m, long n, float alpha, const vector float a[], const vector float x[], vector float y[]);
	...
	*************************************************************/
	 ...
	 */
	EXTERN_API_C(void)
	vSgeadd(long height, long width, const vector float a[], char forma, const vector float b[], char formb,
			vector float c[]);
	...
	*************************************************************/
	 ...
	 */
	EXTERN_API_C(void)
	vSgesub(long height, long width, const vector float a[], char forma, const vector float b[], char formb,
			vector float c[]);
	...
	*************************************************************/
	 ...
	 */
	EXTERN_API_C(void)
	vSgemul(long l, long m, long n, const vector float a[], char forma, const vector float b[], char formb,
			vector float matrix[]);
	...
	*************************************************************/
	 ...
	 */
	EXTERN_API_C(void)
	vSgemm(long l, long m, long n, const vector float a[], char forma, const vector float b[], char formb,
		   vector float c[], float alpha, float beta, vector float matrix[]);
	...
	*************************************************************/
	 ...
	 */
	EXTERN_API_C(void)
	vSgevv(long l, long n, const vector float a[], const vector float b[], vector float m[]);
