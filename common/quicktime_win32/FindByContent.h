...
#define DisposeFBCCallbackUPP(userUPP)
	...
	InvokeFBCCallbackUPP(UInt16 phase, float percentDone, void *data, FBCCallbackUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeFBCCallbackUPP(phase, percentDone, data, userUPP) (*userUPP)(phase, percentDone, data)
	...
	*/
	 ...
	 */
	EXTERN_API_C(void)
	FBCSetSessionCallback(FBCSearchSession searchSession, FBCCallbackUPP fn, void *data);
	...
	*/
	...
	enum
	{
		uppFBCHitTestProcInfo = 0x000003D1
...
#define DisposeFBCHitTestUPP(userUPP)
	 ...
	 */
	EXTERN_API_C(Boolean)
	InvokeFBCHitTestUPP(const FSRef *theFile, void *data, FBCHitTestUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeFBCHitTestUPP(theFile, data, userUPP) (*userUPP)(theFile, data)
	...
	*/
	 ...
	 */
	EXTERN_API_C(void)
	FBCSetSessionHitTest(FBCSearchSession theSession, FBCHitTestUPP fn, void *data);
	...
	*/
	 ...
	 */
	EXTERN_API_C(OSErr)
	FBCSetSessionVolumes(FBCSearchSession theSession, const SInt16 vRefNums[], UInt16 numVolumes);
	...
	*/
	 ...
	 */
	EXTERN_API_C(OSErr)
	FBCDoQuerySearch(FBCSearchSession theSession, char *queryText, const FSSpec targetDirs[], UInt32 numTargets,
	 ...
	 */
	EXTERN_API_C(OSErr)
	FBCDoCFStringSearch(FBCSearchSession theSession, CFStringRef queryString, const FSSpec targetDirs[],
	 ...
	 */
	EXTERN_API_C(OSErr)
	FBCDoExampleSearch(FBCSearchSession theSession, const UInt32 *exampleHitNums, UInt32 numExamples,
					   const FSSpec targetDirs[], UInt32 numTargets, UInt32 maxHits, UInt32 maxHitWords);
	 ...
	 */
	EXTERN_API_C(OSErr)
	FBCBlindExampleSearch(const FSSpec examples[], UInt32 numExamples, const FSSpec targetDirs[], UInt32 numTargets,
						  UInt32 maxHits, UInt32 maxHitWords, Boolean allIndexes, Boolean includeRemote,
	 ...
	 */
	EXTERN_API_C(OSErr)
	FBCBlindExampleSearchWithCallback(const FSSpec examples[], UInt32 numExamples, const FSSpec targetDirs[],
									  UInt32 numTargets, UInt32 maxHits, UInt32 maxHitWords, Boolean allIndexes,
									  Boolean includeRemote, FBCSearchSession *theSession, FBCCallbackUPP callback,
									  void *callbackData, FBCHitTestUPP userHitTest, void *userHitTestData);
	...
	*/
	 ...
	 */
	EXTERN_API_C(OSErr)
	FBCGetHitDocument(FBCSearchSession theSession, UInt32 hitNumber, FSSpec *theDocument);
	 ...
	 */
	EXTERN_API_C(OSErr)
	FBCGetHitDocumentRef(FBCSearchSession theSession, UInt32 hitNumber, FSRef *theDocument);
	...
	*/
	 ...
	 */
	EXTERN_API_C(OSErr)
	FBCSummarize(const void *inBuf, UInt32 inLength, void *outBuf, UInt32 *outLength, UInt32 *numSentences);
	...
	FBCSummarizeCFString(CFStringRef inString, CFStringRef *outString, UInt32 *numSentences);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	FBCGetSummaryOfCFString(CFStringRef inString, FBCSummaryRef *summary);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	FBCGetSummarySentenceCount(FBCSummaryRef summary, UInt32 *numSentences);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	FBCGetSummarySentences(FBCSummaryRef summary, CFStringRef *outString, UInt32 *numSentences, Boolean paragraphs);
	...
	*/
	 ...
	 */
	EXTERN_API_C(OSErr)
	FBCIndexItemsInLanguages(FSSpecArrayPtr theItems, UInt32 itemCount, UInt32 languageHighBits,
	...
	*/
	 ...
	 */
	EXTERN_API_C(OSErr)
	FBCFindIndexFileFolderForFolder(const FSRef *inFolder, FSRef *outFolder);
	...
	*/
	 ...
	 */
	EXTERN_API_C(OSErr)
	FBCGetMatchedWords(FBCSearchSession theSession, UInt32 hitNumber, UInt32 *wordCount, FBCWordList *list);
	 ...
	 */
	EXTERN_API_C(OSErr)
	FBCGetTopicWords(FBCSearchSession theSession, UInt32 hitNumber, UInt32 *wordCount, FBCWordList *list);
