...
#pragma pack(2)
	...
	typedef CALLBACK_API(void, ActivateYDProcPtr)(DialogRef theDialog, short itemNo, Boolean activating,
												  void *yourDataPtr);
...
#define NewDlgHookUPP(userRoutine) \
	...
	{
		return (FileFilterUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppFileFilterProcInfo,
...
#define NewFileFilterUPP(userRoutine) \
	...
	{
		return (DlgHookYDUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppDlgHookYDProcInfo,
												  GetCurrentArchitecture());
	}
#else
#define NewDlgHookYDUPP(userRoutine) \
	...
	{
		return (FileFilterYDUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppFileFilterYDProcInfo,
													 GetCurrentArchitecture());
	}
#else
#define NewFileFilterYDUPP(userRoutine) \
	...
	{
		return (ActivateYDUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppActivateYDProcInfo,
												   GetCurrentArchitecture());
	}
#else
...
#define InvokeDlgHookUPP(item, theDialog, userUPP) \
	(short)CALL_TWO_PARAMETER_UPP((userUPP), uppDlgHookProcInfo, (item), (theDialog))
#endif
#endif
...
#define InvokeFileFilterUPP(pb, userUPP) (Boolean) CALL_ONE_PARAMETER_UPP((userUPP), uppFileFilterProcInfo, (pb))
	 ...
	 */
	EXTERN_API_C(short)
	InvokeDlgHookYDUPP(short item, DialogRef theDialog, void *yourDataPtr, DlgHookYDUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeDlgHookYDUPP(item, theDialog, yourDataPtr, userUPP) \
	(short)CALL_THREE_PARAMETER_UPP((userUPP), uppDlgHookYDProcInfo, (item), (theDialog), (yourDataPtr))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(Boolean)
	InvokeFileFilterYDUPP(CInfoPBPtr pb, void *yourDataPtr, FileFilterYDUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeFileFilterYDUPP(pb, yourDataPtr, userUPP) \
	(Boolean) CALL_TWO_PARAMETER_UPP((userUPP), uppFileFilterYDProcInfo, (pb), (yourDataPtr))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(void)
	InvokeActivateYDUPP(DialogRef theDialog, short itemNo, Boolean activating, void *yourDataPtr,
						ActivateYDUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void) InvokeActivateYDUPP(DialogRef theDialog, short itemNo, Boolean activating,
...
#define CallActivateYDProc(userRoutine, theDialog, itemNo, activating, yourDataPtr) \
	...
	*/
	 ...
	 */
	EXTERN_API(void)
	SFGetFile(Point where, ConstStr255Param prompt, FileFilterUPP fileFilter, /* can be NULL */
	...
	SFPPutFile(Point where, ConstStr255Param prompt, /* can be NULL */
			   ConstStr255Param origName, DlgHookUPP dlgHook, SFReply *reply, short dlgID,
	 ...
	 */
	EXTERN_API(void)
	SFPGetFile(Point where, ConstStr255Param prompt, FileFilterUPP fileFilter, /* can be NULL */
			   short numTypes, ConstSFTypeListPtr typeList,					   /* can be NULL */
			   DlgHookUPP dlgHook,											   /* can be NULL */
	...
	StandardPutFile(ConstStr255Param prompt, /* can be NULL */
					ConstStr255Param defaultName, StandardFileReply *reply) THREEWORDINLINE(0x3F3C, 0x0005, 0xA9EA);
	...
	CustomPutFile(ConstStr255Param prompt, /* can be NULL */
				  ConstStr255Param defaultName, StandardFileReply *reply, short dlgID, Point where,
	...
	CustomGetFile(FileFilterYDUPP fileFilter,												/* can be NULL */
				  short numTypes, ConstSFTypeListPtr typeList,								/* can be NULL */
				  StandardFileReply *reply, short dlgID, Point where, DlgHookYDUPP dlgHook, /* can be NULL */
				  ModalFilterYDUPP filterProc,												/* can be NULL */
				  ActivationOrderListPtr activeList,										/* can be NULL */
				  ActivateYDUPP activate,													/* can be NULL */
	 ...
	 */
	EXTERN_API_C(void)
	sfpputfile(Point *where, const char *prompt, const char *origName, DlgHookUPP dlgHook, /* can be NULL */
			   SFReply *reply, short dlgID, ModalFilterUPP filterProc);					   /* can be NULL */
	 ...
	 */
	EXTERN_API_C(void)
	sfgetfile(Point *where, const char *prompt, FileFilterUPP fileFilter, /* can be NULL */
			  short numTypes, ConstSFTypeListPtr typeList,				  /* can be NULL */
			  DlgHookUPP dlgHook,										  /* can be NULL */
			  SFReply *reply);
	 ...
	 */
	EXTERN_API_C(void)
	sfpgetfile(Point *where, const char *prompt, FileFilterUPP fileFilter, /* can be NULL */
			   short numTypes, ConstSFTypeListPtr typeList,				   /* can be NULL */
			   DlgHookUPP dlgHook,										   /* can be NULL */
			   SFReply *reply, short dlgID, ModalFilterUPP filterProc);	   /* can be NULL */
	 ...
	 */
	EXTERN_API_C(void)
	sfputfile(Point *where, const char *prompt, const char *origName, DlgHookUPP dlgHook, /* can be NULL */
			  SFReply *reply);
