...
#pragma pack(2)
	...
	CTRLGetCookie(ComponentInstance ctrl, void *cookie) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0001, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	CTRLSetCookie(ComponentInstance ctrl, long cookie) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0002, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	CTRLGetCapabilities(ComponentInstance ctrl, long *capabilities)
	 ...
	 */
	EXTERN_API(ComponentResult)
	CTRLCreate(ComponentInstance ctrl, ControlHandle hControl) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0004, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	CTRLSetControlTitle(ComponentInstance ctrl, ControlHandle hControl)
	 ...
	 */
	EXTERN_API(ComponentResult)
	CTRLDisposeControl(ComponentInstance ctrl, ControlHandle hControl)
	 ...
	 */
	EXTERN_API(ComponentResult)
	CTRLHideControl(ComponentInstance ctrl, ControlHandle hControl)
	 ...
	 */
	EXTERN_API(ComponentResult)
	CTRLShowControl(ComponentInstance ctrl, ControlHandle hControl)
	 ...
	 */
	EXTERN_API(ComponentResult)
	CTRLDraw1Control(ComponentInstance ctrl, ControlHandle hControl)
	 ...
	 */
	EXTERN_API(ComponentResult)
	CTRLHiliteControl(ComponentInstance ctrl, ControlHandle hControl)
	 ...
	 */
	EXTERN_API(ComponentResult)
	CTRLMoveControl(ComponentInstance ctrl, ControlHandle hControl)
	 ...
	 */
	EXTERN_API(ComponentResult)
	CTRLSizeControl(ComponentInstance ctrl, ControlHandle hControl)
	 ...
	 */
	EXTERN_API(ComponentResult)
	CTRLSetControlValue(ComponentInstance ctrl, ControlHandle hControl)
	 ...
	 */
	EXTERN_API(ComponentResult)
	CTRLSetControlMinimum(ComponentInstance ctrl, ControlHandle hControl)
	 ...
	 */
	EXTERN_API(ComponentResult)
	CTRLSetControlMaximum(ComponentInstance ctrl, ControlHandle hControl)
	 ...
	 */
	EXTERN_API(ComponentResult)
	CTRLHaveFocus(ComponentInstance ctrl, short *haveFocus) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0010, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	CTRLSetPreFilterProc(ComponentInstance ctrl, long preFilterProc)
	 ...
	 */
	EXTERN_API(ComponentResult)
	CTRLGetPreFilterProc(ComponentInstance ctrl, void *preFilterProc)
	 ...
	 */
	EXTERN_API(ComponentResult)
	CTRLSetText(ComponentInstance ctrl, StringPtr str) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0013, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	CTRLGetText(ComponentInstance ctrl, StringPtr str) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0014, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	CTRLSelectText(ComponentInstance ctrl, short startSel, short endSel)
	 ...
	 */
	EXTERN_API(ComponentResult)
	CTRLSetDrawProc(ComponentInstance ctrl, short theItem, ProcPtr drawProc)
		FIVEWORDINLINE(0x2F3C, 0x0006, 0x0017, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	CTRLTrackControl(ComponentInstance ctrl, ControlHandle hControl, Point localPt, ControlActionUPP actionProc)
	 ...
	 */
	EXTERN_API(ComponentResult)
	CTRLSetFocus(ComponentInstance ctrl, ControlHandle hControl) FIVEWORDINLINE(0x2F3C, 0x0004, 0x0019, 0x7000, 0xA82A);
	 ...
	 */
	EXTERN_API(ComponentResult)
	CTRLTestControl(ComponentInstance ctrl, ControlHandle hControl, Point localPt)
	 ...
	 */
	EXTERN_API(ComponentResult)
	CTRLSetControlData(ComponentInstance ctrl, ControlHandle hControl, ControlPartCode part, ResType tagName, Size size,
	 ...
	 */
	EXTERN_API(ComponentResult)
	CTRLGetControlData(ComponentInstance ctrl, ControlHandle hControl, ControlPartCode part, ResType tagName,
					   Size bufferSize, Ptr buffer, Size *actualSize)
		FIVEWORDINLINE(0x2F3C, 0x0016, 0x001C, 0x7000, 0xA82A);
