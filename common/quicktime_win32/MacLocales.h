...
#pragma pack(2)
	...
	*/
	...
	LocaleRefFromLangOrRegionCode(LangCode lang, RegionCode region, LocaleRef *locale);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	LocaleRefGetPartString(LocaleRef locale, LocalePartMask partMask, ByteCount maxStringLen, char partString[]);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	LocaleStringToLangAndRegionCodes(const char localeString[], LangCode *lang, RegionCode *region);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	LocaleOperationCountLocales(LocaleOperationClass opClass, ItemCount *localeCount);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	LocaleOperationGetLocales(LocaleOperationClass opClass, ItemCount maxLocaleCount, ItemCount *actualLocaleCount,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	LocaleGetName(LocaleRef locale, LocaleOperationVariant opVariant, LocaleNameMask nameMask, LocaleRef displayLocale,
				  UniCharCount maxNameLen, UniCharCount *actualNameLen, UniChar displayName[]);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	LocaleCountNames(LocaleRef locale, LocaleOperationVariant opVariant, LocaleNameMask nameMask, ItemCount *nameCount);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	LocaleGetIndName(LocaleRef locale, LocaleOperationVariant opVariant, LocaleNameMask nameMask, ItemCount nameIndex,
					 UniCharCount maxNameLen, UniCharCount *actualNameLen, UniChar displayName[],
	 ...
	 */
	EXTERN_API_C(OSStatus)
	LocaleOperationGetName(LocaleOperationClass opClass, LocaleRef displayLocale, UniCharCount maxNameLen,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	LocaleOperationGetIndName(LocaleOperationClass opClass, ItemCount nameIndex, UniCharCount maxNameLen,
							  UniCharCount *actualNameLen, UniChar displayName[], LocaleRef *displayLocale);
