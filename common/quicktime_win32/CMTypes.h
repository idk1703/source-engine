...
#pragma import on
	...
	typedef CALLBACK_API(OSErr, CMProfileAccessProcPtr)(long command, long offset, long *size, void *data,
														void *refCon);
	...
	{
		return (CMFlattenUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppCMFlattenProcInfo,
...
#define NewCMFlattenUPP(userRoutine) \
	...
	{
		return (CMBitmapCallBackUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppCMBitmapCallBackProcInfo,
														 GetCurrentArchitecture());
	}
#else
#define NewCMBitmapCallBackUPP(userRoutine) \
	(CMBitmapCallBackUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppCMBitmapCallBackProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (CMConcatCallBackUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppCMConcatCallBackProcInfo,
														 GetCurrentArchitecture());
	}
#else
#define NewCMConcatCallBackUPP(userRoutine) \
	(CMConcatCallBackUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppCMConcatCallBackProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (CMProfileFilterUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppCMProfileFilterProcInfo,
														GetCurrentArchitecture());
	}
#else
#define NewCMProfileFilterUPP(userRoutine) \
	(CMProfileFilterUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppCMProfileFilterProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (CMProfileAccessUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppCMProfileAccessProcInfo,
														GetCurrentArchitecture());
	}
#else
#define NewCMProfileAccessUPP(userRoutine) \
	(CMProfileAccessUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppCMProfileAccessProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeCMProfileAccessUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeCMFlattenUPP(long command, long *size, void *data, void *refCon, CMFlattenUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeCMFlattenUPP(command, size, data, refCon, userUPP) \
	(OSErr) CALL_FOUR_PARAMETER_UPP((userUPP), uppCMFlattenProcInfo, (command), (size), (data), (refCon))
#endif
#endif
	...
	InvokeCMBitmapCallBackUPP(long progress, void *refCon, CMBitmapCallBackUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeCMBitmapCallBackUPP(progress, refCon, userUPP) \
	(Boolean) CALL_TWO_PARAMETER_UPP((userUPP), uppCMBitmapCallBackProcInfo, (progress), (refCon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(Boolean)
	InvokeCMConcatCallBackUPP(long progress, void *refCon, CMConcatCallBackUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeCMConcatCallBackUPP(progress, refCon, userUPP) \
	(Boolean) CALL_TWO_PARAMETER_UPP((userUPP), uppCMConcatCallBackProcInfo, (progress), (refCon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(Boolean)
	InvokeCMProfileFilterUPP(CMProfileRef prof, void *refCon, CMProfileFilterUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeCMProfileFilterUPP(prof, refCon, userUPP) \
	(Boolean) CALL_TWO_PARAMETER_UPP((userUPP), uppCMProfileFilterProcInfo, (prof), (refCon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeCMProfileAccessUPP(long command, long offset, long *size, void *data, void *refCon,
							 CMProfileAccessUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSErr) InvokeCMProfileAccessUPP(long command, long offset, long *size, void *data, void *refCon,
														CMProfileAccessUPP userUPP)
	{
...
#define InvokeCMProfileAccessUPP(command, offset, size, data, refCon, userUPP) \
	(OSErr)                                                                    \
		CALL_FIVE_PARAMETER_UPP((userUPP), uppCMProfileAccessProcInfo, (command), (offset), (size), (data), (refCon))
#endif
#endif
...
#define CallCMProfileAccessProc(userRoutine, command, offset, size, data, refCon) \
