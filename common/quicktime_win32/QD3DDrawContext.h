 ...
 *****************************************************************************/
	 ...
	 */
	EXTERN_API_C(void)
	Q3XDrawContext_Set(TQ3DrawContextObject drawContext, unsigned long flag, void *data);
	 ...
	 */
	EXTERN_API_C(void)
	Q3XDrawContext_Get(TQ3DrawContextObject drawContext, unsigned long flag, void *data);
