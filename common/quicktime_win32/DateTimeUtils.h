...
typedef union LongDateCvt LongDateCvt;
	...
	*/
	...
	UCConvertUTCDateTimeToCFAbsoluteTime(const UTCDateTime *iUTCDate, CFAbsoluteTime *oCFTime);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	UCConvertSecondsToCFAbsoluteTime(UInt32 iSeconds, CFAbsoluteTime *oCFTime);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	UCConvertLongDateTimeToCFAbsoluteTime(LongDateTime iLongTime, CFAbsoluteTime *oCFTime);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	UCConvertCFAbsoluteTimeToUTCDateTime(CFAbsoluteTime iCFTime, UTCDateTime *oUTCDate);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	UCConvertCFAbsoluteTimeToSeconds(CFAbsoluteTime iCFTime, UInt32 *oSeconds);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	UCConvertCFAbsoluteTimeToLongDateTime(CFAbsoluteTime iCFTime, LongDateTime *oLongDate);
	...
	*/
	 ...
	 */
	EXTERN_API(void)
	LongDateString(const LongDateTime *dateTime, DateForm longFlag, Str255 result, Handle intlHandle)
	 ...
	 */
	EXTERN_API(void)
	LongTimeString(const LongDateTime *dateTime, Boolean wantSeconds, Str255 result, Handle intlHandle)
	...
	*/
	...
	StringToDate(Ptr textPtr, long textLen, DateCachePtr theCache, long *lengthUsed, LongDateRec *dateTime)
	 ...
	 */
	EXTERN_API(StringToDateStatus)
	StringToTime(Ptr textPtr, long textLen, DateCachePtr theCache, long *lengthUsed, LongDateRec *dateTime)
	 ...
	 */
	EXTERN_API(void)
	LongDateToSeconds(const LongDateRec *lDate, LongDateTime *lSecs) FOURWORDINLINE(0x2F3C, 0x8008, 0xFFF2, 0xA8B5);
	 ...
	 */
	EXTERN_API(void)
	LongSecondsToDate(const LongDateTime *lSecs, LongDateRec *lDate) FOURWORDINLINE(0x2F3C, 0x8008, 0xFFF0, 0xA8B5);
	...
	ToggleDate(LongDateTime *lSecs, LongDateField field, DateDelta delta, short ch, const TogglePB *params)
...
*/
	 ...
	 */
	EXTERN_API(void)
	IUDateString(long dateTime, DateForm longFlag, Str255 result) TWOWORDINLINE(0x4267, 0xA9ED);
	 ...
	 */
	EXTERN_API(void)
	IUTimeString(long dateTime, Boolean wantSeconds, Str255 result) THREEWORDINLINE(0x3F3C, 0x0002, 0xA9ED);
	 ...
	 */
	EXTERN_API(void)
	IUDatePString(long dateTime, DateForm longFlag, Str255 result, Handle intlHandle)
		THREEWORDINLINE(0x3F3C, 0x000E, 0xA9ED);
	 ...
	 */
	EXTERN_API(void)
	IUTimePString(long dateTime, Boolean wantSeconds, Str255 result, Handle intlHandle)
		THREEWORDINLINE(0x3F3C, 0x0010, 0xA9ED);
	 ...
	 */
	EXTERN_API(void)
	IULDateString(LongDateTime *dateTime, DateForm longFlag, Str255 result, Handle intlHandle)
		THREEWORDINLINE(0x3F3C, 0x0014, 0xA9ED);
	 ...
	 */
	EXTERN_API(void)
	IULTimeString(LongDateTime *dateTime, Boolean wantSeconds, Str255 result, Handle intlHandle)
		THREEWORDINLINE(0x3F3C, 0x0016, 0xA9ED);
...
#define Secs2Date(secs, d)			SecondsToDate(secs, d)
	 ...
	 */
	EXTERN_API_C(void)
	iudatepstring(long dateTime, DateForm longFlag, char *result, Handle intlHandle);
	 ...
	 */
	EXTERN_API_C(void)
	iutimepstring(long dateTime, Boolean wantSeconds, char *result, Handle intlHandle);
	 ...
	 */
	EXTERN_API_C(void)
	iuldatestring(LongDateTime *dateTime, DateForm longFlag, char *result, Handle intlHandle);
	 ...
	 */
	EXTERN_API_C(void)
	iultimestring(LongDateTime *dateTime, Boolean wantSeconds, char *result, Handle intlHandle);
