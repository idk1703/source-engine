...
#define kUniqueArena ((AppletArena)NULL)
	 ...
	 */
	typedef CALLBACK_API_C(void, JE_ShowDocumentCallback)(jobject applet, CFURLRef url, CFStringRef windowName,
														  void *userData);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	CreateJavaApplet(JNIEnv *env, AppletDescriptor applet, Boolean trusted, AppletArena arena, /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	SetJavaAppletState(JNIEnv *env, jobject inAppletFrame, AppletState inNewState);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	RegisterStatusCallback(JNIEnv *env, jobject inJavaFrame, JE_SetStatusCallback showStatusFunction, void *userData);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	RegisterShowDocumentCallback(JNIEnv *env, jobject inJavaFrame, JE_ShowDocumentCallback showDocumentFunction,
								 void *userData);
