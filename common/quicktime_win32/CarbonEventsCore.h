...
#define GetEventTypeCount(t) (sizeof((t)) / sizeof(EventTypeSpec))
	 ...
	 */
	EXTERN_API(OSStatus)
	ReceiveNextEvent(UInt32 inNumTypes, const EventTypeSpec *inList, EventTimeout inTimeout, Boolean inPullEvent,
					 EventRef *outEvent);
...
#define MacCreateEvent CreateEvent
	...
	MacCreateEvent(CFAllocatorRef inAllocator, /* can be NULL */
				   UInt32 inClassID, UInt32 kind, EventTime when, EventAttributes flags, EventRef *outEvent);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetEventParameter(EventRef inEvent, EventParamName inName, EventParamType inType, UInt32 inSize,
	 ...
	 */
	EXTERN_API(OSStatus)
	GetEventParameter(EventRef inEvent, EventParamName inName, EventParamType inDesiredType,
	...
	{
		return (EventComparatorUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppEventComparatorProcInfo,
														GetCurrentArchitecture());
	}
#else
#define NewEventComparatorUPP(userRoutine) \
	(EventComparatorUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppEventComparatorProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeEventComparatorUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	...
	InvokeEventComparatorUPP(EventRef inEvent, void *inCompareData, EventComparatorUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeEventComparatorUPP(inEvent, inCompareData, userUPP) \
	(Boolean) CALL_TWO_PARAMETER_UPP((userUPP), uppEventComparatorProcInfo, (inEvent), (inCompareData))
#endif
#endif
...
#define CallEventComparatorProc(userRoutine, inEvent, inCompareData) \
	 ...
	 */
	EXTERN_API(OSStatus)
	PostEventToQueue(EventQueueRef inQueue, EventRef inEvent, EventPriority inPriority);
	 ...
	 */
	EXTERN_API(OSStatus)
	FlushEventsMatchingListFromQueue(EventQueueRef inQueue, UInt32 inNumTypes, const EventTypeSpec *inList);
	 ...
	 */
	EXTERN_API(OSStatus)
	FlushSpecificEventsFromQueue(EventQueueRef inQueue, EventComparatorUPP inComparator, void *inCompareData);
	 ...
	 */
	EXTERN_API(EventRef)
	FindSpecificEventInQueue(EventQueueRef inQueue, EventComparatorUPP inComparator, void *inCompareData);
	 ...
	 *      The data passed into InstallEventLoopTimer.
	 */
	typedef CALLBACK_API(void, EventLoopIdleTimerProcPtr)(EventLoopTimerRef inTimer, EventLoopIdleTimerMessage inState,
														  void *inUserData);
	...
	{
		return (EventLoopTimerUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppEventLoopTimerProcInfo,
													   GetCurrentArchitecture());
	}
#else
#define NewEventLoopTimerUPP(userRoutine) \
	(EventLoopTimerUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppEventLoopTimerProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	enum
	{
		uppEventLoopIdleTimerProcInfo = 0x00000EC0
	...
	{
		return (EventLoopIdleTimerUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppEventLoopIdleTimerProcInfo,
														   GetCurrentArchitecture());
	}
#else
#define NewEventLoopIdleTimerUPP(userRoutine) \
	(EventLoopIdleTimerUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppEventLoopIdleTimerProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeEventLoopIdleTimerUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(void)
	InvokeEventLoopTimerUPP(EventLoopTimerRef inTimer, void *inUserData, EventLoopTimerUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeEventLoopTimerUPP(inTimer, inUserData, userUPP) \
	 ...
	 */
	EXTERN_API_C(void)
	InvokeEventLoopIdleTimerUPP(EventLoopTimerRef inTimer, EventLoopIdleTimerMessage inState, void *inUserData,
								EventLoopIdleTimerUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void) InvokeEventLoopIdleTimerUPP(EventLoopTimerRef inTimer, EventLoopIdleTimerMessage inState,
														  void *inUserData, EventLoopIdleTimerUPP userUPP)
	{
		CALL_THREE_PARAMETER_UPP(userUPP, uppEventLoopIdleTimerProcInfo, inTimer, inState, inUserData);
	}
#else
#define InvokeEventLoopIdleTimerUPP(inTimer, inState, inUserData, userUPP) \
	CALL_THREE_PARAMETER_UPP((userUPP), uppEventLoopIdleTimerProcInfo, (inTimer), (inState), (inUserData))
#endif
#endif
...
#define CallEventLoopIdleTimerProc(userRoutine, inTimer, inState, inUserData) \
	InvokeEventLoopIdleTimerUPP(inTimer, inState, inUserData, userRoutine)
#endif /* CALL_NOT_IN_CARBON */
	 ...
	 */
	EXTERN_API(OSStatus)
	InstallEventLoopTimer(EventLoopRef inEventLoop, EventTimerInterval inFireDelay, EventTimerInterval inInterval,
						  EventLoopTimerUPP inTimerProc, void *inTimerData, EventLoopTimerRef *outTimer);
	 ...
	 */
	EXTERN_API(OSStatus)
	InstallEventLoopIdleTimer(EventLoopRef inEventLoop, EventTimerInterval inDelay, EventTimerInterval inInterval,
							  EventLoopIdleTimerUPP inTimerProc, void *inTimerData, EventLoopTimerRef *outTimer);
	 ...
	 */
	EXTERN_API(OSStatus)
	InstallIdleTimer(EventLoopRef inEventLoop, EventTimerInterval inDelay, EventTimerInterval inInterval,
					 EventLoopTimerUPP inTimerProc, void *inTimerData, EventLoopTimerRef *outTimer);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetEventLoopTimerNextFireTime(EventLoopTimerRef inTimer, EventTimerInterval inNextFire);
	 ...
	 *    action.
	 */
	typedef CALLBACK_API(OSStatus, EventHandlerProcPtr)(EventHandlerCallRef inHandlerCallRef, EventRef inEvent,
														void *inUserData);
	...
	{
		return (EventHandlerUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppEventHandlerProcInfo,
													 GetCurrentArchitecture());
	}
#else
#define NewEventHandlerUPP(userRoutine) \
	(EventHandlerUPP) NewRoutineDescriptor((ProcPtr)(userRoutine), uppEventHandlerProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeEventHandlerUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	...
	InvokeEventHandlerUPP(EventHandlerCallRef inHandlerCallRef, EventRef inEvent, void *inUserData,
						  EventHandlerUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSStatus) InvokeEventHandlerUPP(EventHandlerCallRef inHandlerCallRef, EventRef inEvent,
														void *inUserData, EventHandlerUPP userUPP)
	{
		return (OSStatus)CALL_THREE_PARAMETER_UPP(userUPP, uppEventHandlerProcInfo, inHandlerCallRef, inEvent,
												  inUserData);
	}
#else
#define InvokeEventHandlerUPP(inHandlerCallRef, inEvent, inUserData, userUPP) \
	(OSStatus) CALL_THREE_PARAMETER_UPP((userUPP), uppEventHandlerProcInfo, (inHandlerCallRef), (inEvent), (inUserData))
#endif
#endif
...
#define CallEventHandlerProc(userRoutine, inHandlerCallRef, inEvent, inUserData) \
	 ...
	 */
	EXTERN_API(OSStatus)
	InstallEventHandler(EventTargetRef inTarget, EventHandlerUPP inHandler, UInt32 inNumTypes,
						const EventTypeSpec *inList, void *inUserData, EventHandlerRef *outRef); /* can be NULL */
	 ...
	 */
	EXTERN_API(OSStatus)
	AddEventTypesToHandler(EventHandlerRef inHandlerRef, UInt32 inNumTypes, const EventTypeSpec *inList);
	 ...
	 */
	EXTERN_API(OSStatus)
	RemoveEventTypesFromHandler(EventHandlerRef inHandlerRef, UInt32 inNumTypes, const EventTypeSpec *inList);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	SendEventToEventTargetWithOptions(EventRef inEvent, EventTargetRef inTarget, OptionBits inOptions);
