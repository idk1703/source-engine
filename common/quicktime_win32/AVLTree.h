...
#pragma pack(2)
	...
	*/
	typedef CALLBACK_API(SInt32, AVLCompareItemsProcPtr)(AVLTreePtr tree, const void *i1, const void *i2,
														 AVLNodeType nd_typ);
	/*
	...
	*/
	typedef CALLBACK_API(OSErr, AVLWalkProcPtr)(AVLTreePtr tree, const void *dataP, AVLVisitStage visitStage,
	...
	{
		return (AVLCompareItemsUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppAVLCompareItemsProcInfo,
														GetCurrentArchitecture());
	}
#else
#define NewAVLCompareItemsUPP(userRoutine) \
	(AVLCompareItemsUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppAVLCompareItemsProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (AVLItemSizeUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppAVLItemSizeProcInfo,
													GetCurrentArchitecture());
	}
#else
#define NewAVLItemSizeUPP(userRoutine) \
	(AVLItemSizeUPP) NewRoutineDescriptor((ProcPtr)(userRoutine), uppAVLItemSizeProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (AVLDisposeItemUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppAVLDisposeItemProcInfo,
													   GetCurrentArchitecture());
	}
#else
#define NewAVLDisposeItemUPP(userRoutine) \
	(AVLDisposeItemUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppAVLDisposeItemProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define NewAVLWalkUPP(userRoutine) \
	(AVLWalkUPP) NewRoutineDescriptor((ProcPtr)(userRoutine), uppAVLWalkProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeAVLWalkUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(SInt32)
	InvokeAVLCompareItemsUPP(AVLTreePtr tree, const void *i1, const void *i2, AVLNodeType nd_typ,
							 AVLCompareItemsUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(SInt32) InvokeAVLCompareItemsUPP(AVLTreePtr tree, const void *i1, const void *i2,
...
#define InvokeAVLCompareItemsUPP(tree, i1, i2, nd_typ, userUPP) \
	(SInt32) CALL_FOUR_PARAMETER_UPP((userUPP), uppAVLCompareItemsProcInfo, (tree), (i1), (i2), (nd_typ))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(UInt32)
	InvokeAVLItemSizeUPP(AVLTreePtr tree, const void *itemPtr, AVLItemSizeUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeAVLItemSizeUPP(tree, itemPtr, userUPP) \
	(UInt32) CALL_TWO_PARAMETER_UPP((userUPP), uppAVLItemSizeProcInfo, (tree), (itemPtr))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(void)
	InvokeAVLDisposeItemUPP(AVLTreePtr tree, const void *dataP, AVLDisposeItemUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeAVLDisposeItemUPP(tree, dataP, userUPP) \
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeAVLWalkUPP(AVLTreePtr tree, const void *dataP, AVLVisitStage visitStage, AVLNodeType node, UInt32 level,
					 SInt32 balance, void *refCon, AVLWalkUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSErr)
		InvokeAVLWalkUPP(AVLTreePtr tree, const void *dataP, AVLVisitStage visitStage, AVLNodeType node, UInt32 level,
						 SInt32 balance, void *refCon, AVLWalkUPP userUPP)
	{
		return (OSErr)CALL_SEVEN_PARAMETER_UPP(userUPP, uppAVLWalkProcInfo, tree, dataP, visitStage, node, level,
											   balance, refCon);
	}
#else
#define InvokeAVLWalkUPP(tree, dataP, visitStage, node, level, balance, refCon, userUPP)                            \
	(OSErr) CALL_SEVEN_PARAMETER_UPP((userUPP), uppAVLWalkProcInfo, (tree), (dataP), (visitStage), (node), (level), \
									 (balance), (refCon))
#endif
#endif
...
#define CallAVLWalkProc(userRoutine, tree, dataP, visitStage, node, level, balance, refCon) \
	InvokeAVLWalkUPP(tree, dataP, visitStage, node, level, balance, refCon, userRoutine)
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	AVLInit(UInt32 flags, AVLCompareItemsUPP compareItemsProc, AVLItemSizeUPP sizeItemProc,
			AVLDisposeItemUPP disposeItemProc, void *refCon, AVLTreePtr *tree) THREEWORDINLINE(0x303C, 0x0C01, 0xAA80);
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	AVLDispose(AVLTreePtr *tree, AVLOrder order) THREEWORDINLINE(0x303C, 0x0302, 0xAA80);
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	AVLCount(AVLTreePtr tree, UInt32 *count) THREEWORDINLINE(0x303C, 0x0804, 0xAA80);
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	AVLInsert(AVLTreePtr tree, const void *data) THREEWORDINLINE(0x303C, 0x0406, 0xAA80);
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	AVLFind(AVLTreePtr tree, const void *key, void *dataPtr, UInt32 *itemSize) THREEWORDINLINE(0x303C, 0x0808, 0xAA80);
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	AVLGetRefcon(AVLTreePtr tree, void **refCon) THREEWORDINLINE(0x303C, 0x0409, 0xAA80);
