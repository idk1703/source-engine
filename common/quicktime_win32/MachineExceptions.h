...
#pragma pack(2)
	...
	enum
	{
		...
		kDataAlignmentException =
			17 /* May occur when a task is in little endian mode or created with kMPTaskTakesAllExceptions.*/
	};
...
#define DisposeExceptionHandlerUPP(userUPP)
	...
	InvokeExceptionHandlerUPP(ExceptionInformation *theException, ExceptionHandlerUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
