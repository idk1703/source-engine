...
#define PEFMaskedBasicOpcodes                                                                                          \
                                                                                                                       \
	kPEFRelocBySectDWithSkip, kPEFRelocBySectDWithSkip, kPEFRelocBySectDWithSkip,                                      \
		kPEFRelocBySectDWithSkip, /* 0x00 .. 0x03 */                                                                   \
		kPEFRelocBySectDWithSkip, kPEFRelocBySectDWithSkip, kPEFRelocBySectDWithSkip,                                  \
		kPEFRelocBySectDWithSkip, /* 0x04 .. 0x07 */                                                                   \
		kPEFRelocBySectDWithSkip, kPEFRelocBySectDWithSkip, kPEFRelocBySectDWithSkip,                                  \
		kPEFRelocBySectDWithSkip, /* 0x08 .. 0x0B */                                                                   \
		kPEFRelocBySectDWithSkip, kPEFRelocBySectDWithSkip, kPEFRelocBySectDWithSkip,                                  \
		kPEFRelocBySectDWithSkip, /* 0x0C .. 0x0F */                                                                   \
                                                                                                                       \
		kPEFRelocBySectDWithSkip, kPEFRelocBySectDWithSkip, kPEFRelocBySectDWithSkip,                                  \
		kPEFRelocBySectDWithSkip, /* 0x10 .. 0x13 */                                                                   \
		kPEFRelocBySectDWithSkip, kPEFRelocBySectDWithSkip, kPEFRelocBySectDWithSkip,                                  \
		kPEFRelocBySectDWithSkip, /* 0x14 .. 0x17 */                                                                   \
		kPEFRelocBySectDWithSkip, kPEFRelocBySectDWithSkip, kPEFRelocBySectDWithSkip,                                  \
		kPEFRelocBySectDWithSkip, /* 0x18 .. 0x1B */                                                                   \
		kPEFRelocBySectDWithSkip, kPEFRelocBySectDWithSkip, kPEFRelocBySectDWithSkip,                                  \
		kPEFRelocBySectDWithSkip, /* 0x1C .. 0x1F */                                                                   \
                                                                                                                       \
		...
		kPEFRelocVTable8, kPEFRelocImportRun, kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode, /* 0x24 .. 0x27 */   \
                                                                                                                       \
		kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode,                                  \
		kPEFRelocUndefinedOpcode, /* 0x28 .. 0x2B */                                                                   \
		kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode,                                  \
		kPEFRelocUndefinedOpcode, /* 0x2C .. 0x2F */                                                                   \
                                                                                                                       \
		kPEFRelocSmByImport, kPEFRelocSmSetSectC, kPEFRelocSmSetSectD, kPEFRelocSmBySection, /* 0x30 .. 0x33 */        \
                                                                                                                       \
		kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode,                                  \
		kPEFRelocUndefinedOpcode, /* 0x34 .. 0x37 */                                                                   \
		kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode,                                  \
		kPEFRelocUndefinedOpcode, /* 0x38 .. 0x3B */                                                                   \
		kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode,                                  \
		kPEFRelocUndefinedOpcode, /* 0x3C .. 0x3F */                                                                   \
                                                                                                                       \
		...
		kPEFRelocSetPosition, kPEFRelocSetPosition, kPEFRelocLgByImport, kPEFRelocLgByImport, /* 0x50 .. 0x53 */       \
                                                                                                                       \
		kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode,                                  \
		kPEFRelocUndefinedOpcode, /* 0x54 .. 0x57 */                                                                   \
                                                                                                                       \
		kPEFRelocLgRepeat, kPEFRelocLgRepeat, kPEFRelocLgSetOrBySection, kPEFRelocLgSetOrBySection, /* 0x58 .. 0x5B */ \
                                                                                                                       \
		kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode,                                  \
		kPEFRelocUndefinedOpcode, /* 0x5C .. 0x5F */                                                                   \
                                                                                                                       \
		kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode,                                  \
		kPEFRelocUndefinedOpcode, /* 0x60 .. 0x63 */                                                                   \
		kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode,                                  \
		kPEFRelocUndefinedOpcode, /* 0x64 .. 0x67 */                                                                   \
		kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode,                                  \
		kPEFRelocUndefinedOpcode, /* 0x68 .. 0x6B */                                                                   \
		kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode,                                  \
		kPEFRelocUndefinedOpcode, /* 0x6C .. 0x6F */                                                                   \
                                                                                                                       \
		kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode,                                  \
		kPEFRelocUndefinedOpcode, /* 0x70 .. 0x73 */                                                                   \
		kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode,                                  \
		kPEFRelocUndefinedOpcode, /* 0x74 .. 0x77 */                                                                   \
		kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode,                                  \
		kPEFRelocUndefinedOpcode, /* 0x78 .. 0x7B */                                                                   \
		kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode, kPEFRelocUndefinedOpcode,                                  \
		kPEFRelocUndefinedOpcode /* 0x7C .. 0x7F */
