...
#pragma pack(2)
	...
	NewPalette(short entries, CTabHandle srcColors, short srcUsage, short srcTolerance) ONEWORDINLINE(0xAA91);
	 ...
	 */
	EXTERN_API(void)
	SetPalette(WindowRef dstWindow, PaletteHandle srcPalette, Boolean cUpdates) ONEWORDINLINE(0xAA95);
	 ...
	 */
	EXTERN_API(void)
	NSetPalette(WindowRef dstWindow, PaletteHandle srcPalette, short nCUpdates) ONEWORDINLINE(0xAA95);
	 ...
	 */
	EXTERN_API(void)
	CopyPalette(PaletteHandle srcPalette, PaletteHandle dstPalette, short srcEntry, short dstEntry, short dstLength)
	 ...
	 */
	EXTERN_API(void)
	AnimateEntry(WindowRef dstWindow, short dstEntry, const RGBColor *srcRGB) ONEWORDINLINE(0xAA99);
...
#define MacAnimatePalette AnimatePalette
#endif
	EXTERN_API(void)
	MacAnimatePalette(WindowRef dstWindow, CTabHandle srcCTab, short srcIndex, short dstEntry, short dstLength)
	 ...
	 */
	EXTERN_API(void)
	GetEntryColor(PaletteHandle srcPalette, short srcEntry, RGBColor *dstRGB) ONEWORDINLINE(0xAA9B);
	 ...
	 */
	EXTERN_API(void)
	SetEntryColor(PaletteHandle dstPalette, short dstEntry, const RGBColor *srcRGB) ONEWORDINLINE(0xAA9C);
	 ...
	 */
	EXTERN_API(void)
	GetEntryUsage(PaletteHandle srcPalette, short srcEntry, short *dstUsage, short *dstTolerance) ONEWORDINLINE(0xAA9D);
	 ...
	 */
	EXTERN_API(void)
	SetEntryUsage(PaletteHandle dstPalette, short dstEntry, short srcUsage, short srcTolerance) ONEWORDINLINE(0xAA9E);
	 ...
	 */
	EXTERN_API(void)
	CTab2Palette(CTabHandle srcCTab, PaletteHandle dstPalette, short srcUsage, short srcTolerance)
	 ...
	 */
	EXTERN_API(void)
	Palette2CTab(PaletteHandle srcPalette, CTabHandle dstCTab) ONEWORDINLINE(0xAAA0);
...
#define MacResizePalette ResizePalette
	 ...
	 */
	EXTERN_API(OSErr)
	SetDepth(GDHandle gd, short depth, short whichFlags, short flags) THREEWORDINLINE(0x303C, 0x0A13, 0xAAA2);
	 ...
	 */
	EXTERN_API(short)
	HasDepth(GDHandle gd, short depth, short whichFlags, short flags) THREEWORDINLINE(0x303C, 0x0A14, 0xAAA2);
	 ...
	 */
	EXTERN_API(void)
	SetPaletteUpdates(PaletteHandle p, short updates) THREEWORDINLINE(0x303C, 0x0616, 0xAAA2);
	 ...
	 */
	EXTERN_API(Boolean)
	GetGray(GDHandle device, const RGBColor *backGround, RGBColor *foreGround) THREEWORDINLINE(0x303C, 0x0C19, 0xAAA2);
