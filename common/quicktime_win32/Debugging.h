...
/* no debugger message */
#define DEBUGASSERTMSG(componentSignature, options, assertionString, exceptionLabelString, errorString, fileName, \
					   lineNumber, value)
...
#define DEBUGASSERTMSG(componentSignature, options, assertionString, exceptionLabelString, errorString, fileName,      \
					   lineNumber, value)                                                                              \
	DebugAssert(componentSignature, options, assertionString, exceptionLabelString, errorString, fileName, lineNumber, \
				(void *)value)
#endif
#endif
...
#define DEBUG_ASSERT_MESSAGE(componentNameString, assertionString, exceptionLabelString, errorString, fileName, \
							 lineNumber, value)                                                                 \
	DEBUGASSERTMSG(COMPONENT_SIGNATURE, DEBUG_NO_OPTIONS, componentNameString ": " assertionString,             \
...
#define SafeDebugger()                                                                                         \
	do                                                                                                         \
	{                                                                                                          \
		if(((*((UInt8 *)0x0BFF)) != (UInt8)0xff) && (((*((UInt8 *)0x0BFF)) & (UInt8)0xe0) == (UInt8)0x60) &&   \
		   ((*((unsigned long *)0x0120)) != 0) && ((*((unsigned long *)0x0120)) != (unsigned long)0xffffffff)) \
		{                                                                                                      \
			Debugger();                                                                                        \
		}                                                                                                      \
	} while(false)
...
#define ISCAPSLOCKKEYDOWN() ((((UInt16 *)(0x0174))[3] & 0x0002) == 0x0002)
#endif

#ifndef ISLOWLEVELDEBUGGERCALLABLE
#define ISLOWLEVELDEBUGGERCALLABLE()                                                                   \
	(((*((UInt8 *)0x0BFF)) != (UInt8)0xff) && (((*((UInt8 *)0x0BFF)) & (UInt8)0xe0) == (UInt8)0x60) && \
	 ((*((unsigned long *)0x0120)) != 0) && ((*((unsigned long *)0x0120)) != (unsigned long)0xffffffff))
#endif
#endif
...
#define DPRINTF(x) \
	 ...
	 */
	EXTERN_API(void)
	DebugAssert(OSType componentSignature, UInt32 options, const char *assertionString,
				const char *exceptionLabelString, const char *errorString, const char *fileName, long lineNumber,
	 ...
	 *      kSetDebugOption
	 */
	typedef CALLBACK_API(void, DebugComponentCallbackProcPtr)(SInt32 optionSelectorNum, UInt32 command,
	 ...
	 */
	EXTERN_API(OSStatus)
	NewDebugOption(OSType componentSignature, SInt32 optionSelectorNum, ConstStr255Param optionName)
		TWOWORDINLINE(0x7003, 0xAA7E);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDebugComponentInfo(UInt32 index, OSType *componentSignature, Str255 componentName) TWOWORDINLINE(0x7005, 0xAA7E);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDebugOptionInfo(UInt32 index, OSType componentSignature, SInt32 *optionSelectorNum, Str255 optionName,
	 ...
	 */
	EXTERN_API(OSStatus)
	SetDebugOptionValue(OSType componentSignature, SInt32 optionSelectorNum, Boolean newOptionSetting)
		TWOWORDINLINE(0x7007, 0xAA7E);
	...
	typedef CALLBACK_API(void,
						 DebugAssertOutputHandlerProcPtr)(OSType componentSignature, UInt32 options,
...
#ifdef __cplusplus
	inline DEFINE_API_C(DebugComponentCallbackUPP)
		NewDebugComponentCallbackUPP(DebugComponentCallbackProcPtr userRoutine)
	{
		return (DebugComponentCallbackUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppDebugComponentCallbackProcInfo, GetCurrentArchitecture());
	}
#else
#define NewDebugComponentCallbackUPP(userRoutine) \
	(DebugComponentCallbackUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppDebugComponentCallbackProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	enum
	{
		...
		*/
#ifdef __cplusplus
	inline DEFINE_API_C(DebugAssertOutputHandlerUPP)
		NewDebugAssertOutputHandlerUPP(DebugAssertOutputHandlerProcPtr userRoutine)
	{
		return (DebugAssertOutputHandlerUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppDebugAssertOutputHandlerProcInfo, GetCurrentArchitecture());
	}
#else
#define NewDebugAssertOutputHandlerUPP(userRoutine) \
	(DebugAssertOutputHandlerUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppDebugAssertOutputHandlerProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeDebugAssertOutputHandlerUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(void)
	InvokeDebugComponentCallbackUPP(SInt32 optionSelectorNum, UInt32 command, Boolean *optionSetting,
									DebugComponentCallbackUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void) InvokeDebugComponentCallbackUPP(SInt32 optionSelectorNum, UInt32 command,
															  Boolean *optionSetting, DebugComponentCallbackUPP userUPP)
	{
...
#define InvokeDebugComponentCallbackUPP(optionSelectorNum, command, optionSetting, userUPP)                \
	CALL_THREE_PARAMETER_UPP((userUPP), uppDebugComponentCallbackProcInfo, (optionSelectorNum), (command), \
							 (optionSetting))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(void)
	InvokeDebugAssertOutputHandlerUPP(OSType componentSignature, UInt32 options, const char *assertionString,
	...
	inline DEFINE_API_C(void)
		InvokeDebugAssertOutputHandlerUPP(OSType componentSignature, UInt32 options, const char *assertionString,
										  ...
										  const char *fileName, long lineNumber, void *value,
										  ConstStr255Param outputMsg, DebugAssertOutputHandlerUPP userUPP)
	{
		CALL_NINE_PARAMETER_UPP(userUPP, uppDebugAssertOutputHandlerProcInfo, componentSignature, options,
								assertionString, exceptionLabelString, errorString, fileName, lineNumber, value,
								outputMsg);
	}
#else
#define InvokeDebugAssertOutputHandlerUPP(componentSignature, options, assertionString, exceptionLabelString,   \
										  errorString, fileName, lineNumber, value, outputMsg, userUPP)         \
	CALL_NINE_PARAMETER_UPP((userUPP), uppDebugAssertOutputHandlerProcInfo, (componentSignature), (options),    \
							(assertionString), (exceptionLabelString), (errorString), (fileName), (lineNumber), \
							(value), (outputMsg))
#endif
#endif
...
#define CallDebugComponentCallbackProc(userRoutine, optionSelectorNum, command, optionSetting) \
	InvokeDebugComponentCallbackUPP(optionSelectorNum, command, optionSetting, userRoutine)
#define CallDebugAssertOutputHandlerProc(userRoutine, componentSignature, options, assertionString,                    \
										 exceptionLabelString, errorString, fileName, lineNumber, value, outputMsg)    \
	InvokeDebugAssertOutputHandlerUPP(componentSignature, options, assertionString, exceptionLabelString, errorString, \
									  fileName, lineNumber, value, outputMsg, userRoutine)
#endif /* CALL_NOT_IN_CARBON */
