...
#define kHIMovieViewClassID CFSTR("com.apple.quicktime.HIMovieView")
	...
	enum
	{
		 ...
		 */
		kHIMovieViewStandardAttributes = (kHIMovieViewControllerVisibleAttribute | kHIMovieViewAutoIdlingAttribute |
										  kHIMovieViewAcceptsFocusAttribute)
	};
	...
	HIMovieViewCreate(Movie inMovie, OptionBits inAttributes, HIViewRef *outMovieView);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIMovieViewSetMovie(HIViewRef inView, Movie inMovie);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIMovieViewChangeAttributes(HIViewRef inView, OptionBits inAttributesToSet, OptionBits inAttributesToClear);
