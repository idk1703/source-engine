...
#pragma import on
	...
	*/
	...
	{
		return (CollectionFlattenUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppCollectionFlattenProcInfo,
														  GetCurrentArchitecture());
	}
#else
#define NewCollectionFlattenUPP(userRoutine) \
	(CollectionFlattenUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppCollectionFlattenProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (CollectionExceptionUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppCollectionExceptionProcInfo,
															GetCurrentArchitecture());
	}
#else
#define NewCollectionExceptionUPP(userRoutine) \
	(CollectionExceptionUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppCollectionExceptionProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeCollectionExceptionUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeCollectionFlattenUPP(SInt32 size, void *data, void *refCon, CollectionFlattenUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeCollectionFlattenUPP(size, data, refCon, userUPP) \
	(OSErr) CALL_THREE_PARAMETER_UPP((userUPP), uppCollectionFlattenProcInfo, (size), (data), (refCon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeCollectionExceptionUPP(Collection c, OSErr status, CollectionExceptionUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeCollectionExceptionUPP(c, status, userUPP) \
	(OSErr) CALL_TWO_PARAMETER_UPP((userUPP), uppCollectionExceptionProcInfo, (c), (status))
#endif
#endif
...
#define CallCollectionExceptionProc(userRoutine, c, status) InvokeCollectionExceptionUPP(c, status, userRoutine)
	 ...
	 */
	EXTERN_API(Collection)
	CopyCollection(Collection srcCollection, Collection dstCollection) TWOWORDINLINE(0x7004, 0xABF6);
	 ...
	 */
	EXTERN_API(void)
	SetCollectionDefaultAttributes(Collection c, SInt32 whichAttributes, SInt32 newAttributes)
	 ...
	 */
	EXTERN_API(OSErr)
	AddCollectionItem(Collection c, CollectionTag tag, SInt32 id, SInt32 itemSize, const void *itemData)
	 ...
	 */
	EXTERN_API(OSErr)
	GetCollectionItem(Collection c, CollectionTag tag, SInt32 id, SInt32 *itemSize, void *itemData)
	 ...
	 */
	EXTERN_API(OSErr)
	RemoveCollectionItem(Collection c, CollectionTag tag, SInt32 id) TWOWORDINLINE(0x700A, 0xABF6);
	 ...
	 */
	EXTERN_API(OSErr)
	SetCollectionItemInfo(Collection c, CollectionTag tag, SInt32 id, SInt32 whichAttributes, SInt32 newAttributes)
	 ...
	 */
	EXTERN_API(OSErr)
	GetCollectionItemInfo(Collection c, CollectionTag tag, SInt32 id, SInt32 *index, SInt32 *itemSize,
	 ...
	 */
	EXTERN_API(OSErr)
	ReplaceIndexedCollectionItem(Collection c, SInt32 index, SInt32 itemSize, const void *itemData)
	 ...
	 */
	EXTERN_API(OSErr)
	GetIndexedCollectionItem(Collection c, SInt32 index, SInt32 *itemSize, void *itemData)
	 ...
	 */
	EXTERN_API(OSErr)
	RemoveIndexedCollectionItem(Collection c, SInt32 index) TWOWORDINLINE(0x700F, 0xABF6);
	 ...
	 */
	EXTERN_API(OSErr)
	SetIndexedCollectionItemInfo(Collection c, SInt32 index, SInt32 whichAttributes, SInt32 newAttributes)
	 ...
	 */
	EXTERN_API(OSErr)
	GetIndexedCollectionItemInfo(Collection c, SInt32 index, CollectionTag *tag, SInt32 *id, SInt32 *itemSize,
	 ...
	 */
	EXTERN_API(Boolean)
	CollectionTagExists(Collection c, CollectionTag tag) TWOWORDINLINE(0x7012, 0xABF6);
	 ...
	 */
	EXTERN_API(OSErr)
	GetIndexedCollectionTag(Collection c, SInt32 tagIndex, CollectionTag *tag) TWOWORDINLINE(0x7014, 0xABF6);
	 ...
	 */
	EXTERN_API(SInt32)
	CountTaggedCollectionItems(Collection c, CollectionTag tag) TWOWORDINLINE(0x7015, 0xABF6);
	 ...
	 */
	EXTERN_API(OSErr)
	GetTaggedCollectionItem(Collection c, CollectionTag tag, SInt32 whichItem, SInt32 *itemSize, void *itemData)
	 ...
	 */
	EXTERN_API(OSErr)
	GetTaggedCollectionItemInfo(Collection c, CollectionTag tag, SInt32 whichItem, SInt32 *id, SInt32 *index,
								SInt32 *itemSize, SInt32 *attributes) TWOWORDINLINE(0x7017, 0xABF6);
	 ...
	 */
	EXTERN_API(void)
	PurgeCollection(Collection c, SInt32 whichAttributes, SInt32 matchingAttributes) TWOWORDINLINE(0x7018, 0xABF6);
	 ...
	 */
	EXTERN_API(void)
	PurgeCollectionTag(Collection c, CollectionTag tag) TWOWORDINLINE(0x7019, 0xABF6);
	 ...
	 */
	EXTERN_API(OSErr)
	FlattenCollection(Collection c, CollectionFlattenUPP flattenProc, void *refCon) TWOWORDINLINE(0x701B, 0xABF6);
	 ...
	 */
	EXTERN_API(OSErr)
	FlattenPartialCollection(Collection c, CollectionFlattenUPP flattenProc, void *refCon, SInt32 whichAttributes,
	 ...
	 */
	EXTERN_API(OSErr)
	UnflattenCollection(Collection c, CollectionFlattenUPP flattenProc, void *refCon) TWOWORDINLINE(0x701D, 0xABF6);
	 ...
	 */
	EXTERN_API(void)
	SetCollectionExceptionProc(Collection c, CollectionExceptionUPP exceptionProc) TWOWORDINLINE(0x701F, 0xABF6);
	 ...
	 */
	EXTERN_API(OSErr)
	AddCollectionItemHdl(Collection aCollection, CollectionTag tag, SInt32 id, Handle itemData)
	 ...
	 */
	EXTERN_API(OSErr)
	GetCollectionItemHdl(Collection aCollection, CollectionTag tag, SInt32 id, Handle itemData)
	 ...
	 */
	EXTERN_API(OSErr)
	ReplaceIndexedCollectionItemHdl(Collection aCollection, SInt32 index, Handle itemData)
	 ...
	 */
	EXTERN_API(OSErr)
	GetIndexedCollectionItemHdl(Collection aCollection, SInt32 index, Handle itemData) TWOWORDINLINE(0x7024, 0xABF6);
	 ...
	 */
	EXTERN_API(OSErr)
	FlattenCollectionToHdl(Collection aCollection, Handle flattened) TWOWORDINLINE(0x7025, 0xABF6);
	 ...
	 */
	EXTERN_API(OSErr)
	UnflattenCollectionFromHdl(Collection aCollection, Handle flattened) TWOWORDINLINE(0x7026, 0xABF6);
