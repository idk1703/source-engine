...
#pragma pack(2)
	...
	typedef CALLBACK_API(OSStatus, PowerHandlerProcPtr)(UInt32 message, void *param, UInt32 refCon,
	...
	{
		return (PowerHandlerUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppPowerHandlerProcInfo,
													 GetCurrentArchitecture());
	}
#else
#define NewPowerHandlerUPP(userRoutine) \
	(PowerHandlerUPP) NewRoutineDescriptor((ProcPtr)(userRoutine), uppPowerHandlerProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposePowerHandlerUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	...
	InvokePowerHandlerUPP(UInt32 message, void *param, UInt32 refCon, RegEntryID *regEntryID, PowerHandlerUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSStatus) InvokePowerHandlerUPP(UInt32 message, void *param, UInt32 refCon,
...
#define InvokePowerHandlerUPP(message, param, refCon, regEntryID, userUPP) \
	(OSStatus) CALL_FOUR_PARAMETER_UPP((userUPP), uppPowerHandlerProcInfo, (message), (param), (refCon), (regEntryID))
#endif
#endif
...
#define kIdleQueueDeviceType "idle-queue"
	...
	*/
	...
	enum
	{
		...
		bSourceIsUPS =
			3, /* power source is UPS. NOTE: software should set bSourceIsBattery and bSourceIsAC also, as appropriate*/
...
#endif
	EXTERN_API(void)
	GetBatteryTimes(short whichBattery, BatteryTimeRec *theTimes) FOURWORDINLINE(0x4840, 0x303C, 0x001C, 0xA09E);
...
#pragma parameter __D0 NumBatteriesInstalled
	 ...
	 */
	EXTERN_API_C(OSStatus)
	AddDevicePowerHandler(RegEntryIDPtr regEntryID, PowerHandlerProcPtr handler, UInt32 refCon, char *deviceType);
...
#define NewSleepQUPP(userRoutine) \
	...
	{
		return (HDSpindownUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppHDSpindownProcInfo,
												   GetCurrentArchitecture());
	}
#else
#define NewHDSpindownUPP(userRoutine) \
	...
	{
		return (PMgrStateChangeUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppPMgrStateChangeProcInfo,
														GetCurrentArchitecture());
	}
#else
#define NewPMgrStateChangeUPP(userRoutine) \
	(PMgrStateChangeUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppPMgrStateChangeProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#endif
	EXTERN_API_C(long)
	InvokeSleepQUPP(long message, SleepQRecPtr qRecPtr, SleepQUPP userUPP) ONEWORDINLINE(0x4E91);
...
#define InvokeSleepQUPP(message, qRecPtr, userUPP) \
	(long)CALL_TWO_PARAMETER_UPP((userUPP), uppSleepQProcInfo, (message), (qRecPtr))
#endif
#endif
...
#define InvokeHDSpindownUPP(theElement, userUPP) CALL_ONE_PARAMETER_UPP((userUPP), uppHDSpindownProcInfo, (theElement))
	 ...
	 */
	EXTERN_API_C(void)
	InvokePMgrStateChangeUPP(PMgrQueueElement *theElement, long stateBits, PMgrStateChangeUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
