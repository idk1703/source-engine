...
#pragma import on
	...
	*/
	 ...
	 */
	EXTERN_API(OSErr)
	KBSetupPS2Keyboard(SInt16 keyboardType, SInt8 *alternativeTable) THREEWORDINLINE(0x303C, 0x0001, 0xAA7A);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	KLGetKeyboardLayoutAtIndex(CFIndex iIndex, KeyboardLayoutRef *oKeyboardLayout);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	KLGetIndexedKeyboardLayout(CFIndex iIndex, KeyboardLayoutRef *oKeyboardLayout);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	KLGetKeyboardLayoutProperty(KeyboardLayoutRef iKeyboardLayout, KeyboardLayoutPropertyTag iPropertyTag,
								const void **oValue);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	KLGetKeyboardLayoutWithIdentifier(SInt32 iIdentifier, KeyboardLayoutRef *oKeyboardLayout);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	KLGetKeyboardLayoutWithName(CFStringRef iName, KeyboardLayoutRef *oKeyboardLayout);
