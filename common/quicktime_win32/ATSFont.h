...
#pragma options(!pack_enums)
	...
	ATSFontActivateFromFileSpecification(const FSSpec *iFile, ATSFontContext iContext, ATSFontFormat iFormat,
										 void *iReserved, ATSOptionFlags iOptions, ATSFontContainerRef *oContainer);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ATSFontActivateFromMemory(LogicalAddress iData, ByteCount iLength, ATSFontContext iContext, ATSFontFormat iFormat,
							  void *iReserved, ATSOptionFlags iOptions, ATSFontContainerRef *oContainer);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ATSFontDeactivate(ATSFontContainerRef iContainer, void *iRefCon, ATSOptionFlags iOptions);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ATSFontFamilyApplyFunction(ATSFontFamilyApplierFunction iFunction, void *iRefCon);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ATSFontFamilyIteratorCreate(ATSFontContext iContext, const ATSFontFilter *iFilter, /* can be NULL */
								void *iRefCon, ATSOptionFlags iOptions, ATSFontFamilyIterator *ioIterator);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ATSFontFamilyIteratorReset(ATSFontContext iContext, const ATSFontFilter *iFilter, /* can be NULL */
							   void *iRefCon, ATSOptionFlags iOptions, ATSFontFamilyIterator *ioIterator);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ATSFontFamilyIteratorNext(ATSFontFamilyIterator iIterator, ATSFontFamilyRef *oFamily);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ATSFontFamilyGetName(ATSFontFamilyRef iFamily, ATSOptionFlags iOptions, CFStringRef *oName);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ATSFontIteratorCreate(ATSFontContext iContext, const ATSFontFilter *iFilter, /* can be NULL */
						  void *iRefCon, ATSOptionFlags iOptions, ATSFontIterator *ioIterator);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ATSFontIteratorReset(ATSFontContext iContext, const ATSFontFilter *iFilter, /* can be NULL */
						 void *iRefCon, ATSOptionFlags iOptions, ATSFontIterator *ioIterator);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ATSFontFindFromContainer(ATSFontContainerRef iContainer, ATSOptionFlags iOptions, ItemCount iCount,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ATSFontGetPostScriptName(ATSFontRef iFont, ATSOptionFlags iOptions, CFStringRef *oName);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ATSFontGetTableDirectory(ATSFontRef iFont, ByteCount iBufferSize, void *ioBuffer,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ATSFontGetTable(ATSFontRef iFont, FourCharCode iTag, ByteOffset iOffset, ByteCount iBufferSize, void *ioBuffer,
					ByteCount *oSize); /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ATSFontGetHorizontalMetrics(ATSFontRef iFont, ATSOptionFlags iOptions, ATSFontMetrics *oMetrics);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ATSFontGetVerticalMetrics(ATSFontRef iFont, ATSOptionFlags iOptions, ATSFontMetrics *oMetrics);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ATSFontGetFontFamilyResource(ATSFontRef iFont, ByteCount iBufferSize, void *ioBuffer,
								 ByteCount *oSize); /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ATSFontNotify(ATSFontNotifyAction action, void *info); /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ATSFontNotificationSubscribe(ATSNotificationCallback callback, ATSFontNotifyOption options,
	 ...
	 */
	typedef CALLBACK_API_C(CFPropertyListRef, ATSFontQueryCallback)(ATSFontQueryMessageID msgid, CFPropertyListRef data,
																	void *refCon);
	/*
	 *  ATSCreateFontQueryRunLoopSource()
	 *
	...
	ATSCreateFontQueryRunLoopSource(CFIndex queryOrder, CFIndex sourceOrder, ATSFontQueryCallback callout,
