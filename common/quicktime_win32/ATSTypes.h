...
#ifdef __cplusplus
	inline DEFINE_API_C(FMFontFamilyCallbackFilterUPP)
		NewFMFontFamilyCallbackFilterUPP(FMFontFamilyCallbackFilterProcPtr userRoutine)
	{
		return (FMFontFamilyCallbackFilterUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppFMFontFamilyCallbackFilterProcInfo, GetCurrentArchitecture());
	}
#else
#define NewFMFontFamilyCallbackFilterUPP(userRoutine) \
	(FMFontFamilyCallbackFilterUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppFMFontFamilyCallbackFilterProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (FMFontCallbackFilterUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppFMFontCallbackFilterProcInfo,
...
#define DisposeFMFontCallbackFilterUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	...
	InvokeFMFontFamilyCallbackFilterUPP(FMFontFamily iFontFamily, void *iRefCon, FMFontFamilyCallbackFilterUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSStatus) InvokeFMFontFamilyCallbackFilterUPP(FMFontFamily iFontFamily, void *iRefCon,
...
#define InvokeFMFontFamilyCallbackFilterUPP(iFontFamily, iRefCon, userUPP) \
	(OSStatus) CALL_TWO_PARAMETER_UPP((userUPP), uppFMFontFamilyCallbackFilterProcInfo, (iFontFamily), (iRefCon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSStatus)
	InvokeFMFontCallbackFilterUPP(FMFont iFont, void *iRefCon, FMFontCallbackFilterUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeFMFontCallbackFilterUPP(iFont, iRefCon, userUPP) \
	(OSStatus) CALL_TWO_PARAMETER_UPP((userUPP), uppFMFontCallbackFilterProcInfo, (iFont), (iRefCon))
#endif
#endif
...
#define CallFMFontCallbackFilterProc(userRoutine, iFont, iRefCon) \
	...
	struct ATSFontMetrics
	{
		...
		Float32 xHeight; /* Height of lowercase characters in a font, specifically the letter x, excluding ascenders and
							descenders */
		Float32 italicAngle; /* Angle in degrees counterclockwise from the vertical of the dominant vertical strokes of
