...
#pragma options(!pack_enums)
	...
	*/
	 ...
	 */
	EXTERN_API_C(void)
	WSMethodInvocationSetParameters(WSMethodInvocationRef invocation, CFDictionaryRef parameters,
	...
	*/
	 ...
	 *      fault, and optional debug information.
	 */
	typedef CALLBACK_API(void, WSMethodInvocationCallBackProcPtr)(WSMethodInvocationRef invocation, void *info,
	 ...
	 */
	EXTERN_API_C(void)
	WSMethodInvocationSetCallBack(WSMethodInvocationRef invocation, WSMethodInvocationCallBackProcPtr clientCB,
	...
	*/
	 ...
	 */
	EXTERN_API_C(void)
	WSMethodInvocationScheduleWithRunLoop(WSMethodInvocationRef invocation, CFRunLoopRef runLoop,
	...
	*/
	 ...
	 */
	EXTERN_API_C(void)
	WSMethodInvocationUnscheduleFromRunLoop(WSMethodInvocationRef invocation, CFRunLoopRef runLoop,
											CFStringRef runLoopMode);
	...
	*/
	 ...
	 */
	typedef CALLBACK_API(CFStringRef, WSMethodInvocationSerializationProcPtr)(WSMethodInvocationRef invocation,
	 ...
	 */
	EXTERN_API_C(void)
	WSMethodInvocationAddSerializationOverride(WSMethodInvocationRef invocation, CFTypeID objType,
	 ...
	 */
	typedef CALLBACK_API(CFTypeRef, WSMethodInvocationDeserializationProcPtr)(WSMethodInvocationRef invocation,
																			  CFXMLTreeRef msgRoot,
																			  CFXMLTreeRef deserializeRoot, void *info);
	/*
	 ...
	 */
	EXTERN_API_C(void)
	WSMethodInvocationAddDeserializationOverride(WSMethodInvocationRef invocation, CFStringRef typeNamespace,
