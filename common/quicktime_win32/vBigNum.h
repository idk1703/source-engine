...
#pragma pack(2)
	 ...
	 */
	EXTERN_API_C(void)
	vU256Divide(const vU256 *numerator, const vU256 *divisor, vU256 *result, vU256 *remainder);
	 ...
	 */
	EXTERN_API_C(void)
	vS256Divide(const vS256 *numerator, const vS256 *divisor, vS256 *result, vS256 *remainder);
	 ...
	 */
	EXTERN_API_C(void)
	vU512Divide(const vU512 *numerator, const vU512 *divisor, vU512 *result, vU512 *remainder);
	 ...
	 */
	EXTERN_API_C(void)
	vS512Divide(const vS512 *numerator, const vS512 *divisor, vS512 *result, vS512 *remainder);
	 ...
	 */
	EXTERN_API_C(void)
	vU1024Divide(const vU1024 *numerator, const vU1024 *divisor, vU1024 *result, vU1024 *remainder);
	 ...
	 */
	EXTERN_API_C(void)
	vS1024Divide(const vS1024 *numerator, const vS1024 *divisor, vS1024 *result, vS1024 *remainder);
