...
#define __SEC_TYPES__
	...
	{
		return ((KCGetKeychainManagerVersion != (void *)kUnresolvedCFragSymbolAddress) &&
...
#define KeychainManagerAvailable() (true)
	...
	{
		return (KCCallbackUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppKCCallbackProcInfo,
												   GetCurrentArchitecture());
	}
#else
#define NewKCCallbackUPP(userRoutine) \
	(KCCallbackUPP) NewRoutineDescriptor((ProcPtr)(userRoutine), uppKCCallbackProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeKCCallbackUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	...
	InvokeKCCallbackUPP(KCEvent keychainEvent, KCCallbackInfo *info, void *userContext, KCCallbackUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeKCCallbackUPP(keychainEvent, info, userContext, userUPP) \
	(OSStatus) CALL_THREE_PARAMETER_UPP((userUPP), uppKCCallbackProcInfo, (keychainEvent), (info), (userContext))
#endif
#endif
...
#define CallKCCallbackProc(userRoutine, keychainEvent, info, userContext) \
	...
	KCFindAppleSharePassword(AFPServerSignature *serverSignature, /* can be NULL */
							 ...
							 UInt32 maxLength, void *passwordData, UInt32 *actualLength,
	...
	KCFindInternetPassword(StringPtr serverName,	 /* can be NULL */
						   ...
						   StringPtr accountName,	 /* can be NULL */
						   UInt16 port, OSType protocol, OSType authType, UInt32 maxLength, void *passwordData,
	 ...
	 */
	EXTERN_API(OSStatus)
	KCAddCallback(KCCallbackUPP callbackProc, KCEventMask eventMask, void *userContext);
	 ...
	 */
	EXTERN_API(OSStatus)
	KCNewItem(KCItemClass itemClass, OSType itemCreator, UInt32 length, const void *data, KCItemRef *item);
