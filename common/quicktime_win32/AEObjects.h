...
#pragma pack(2)
	...
	*/
	...
	typedef CALLBACK_API(OSErr, OSLAccessorProcPtr)(DescType desiredClass, const AEDesc *container,
													DescType containerClass, DescType form, const AEDesc *selectionData,
													AEDesc *value, long accessorRefcon);
	typedef CALLBACK_API(OSErr, OSLCompareProcPtr)(DescType oper, const AEDesc *obj1, const AEDesc *obj2,
												   Boolean *result);
	typedef CALLBACK_API(OSErr, OSLCountProcPtr)(DescType desiredType, DescType containerClass, const AEDesc *container,
												 long *result);
	typedef CALLBACK_API(OSErr, OSLDisposeTokenProcPtr)(AEDesc *unneededToken);
	typedef CALLBACK_API(OSErr, OSLGetMarkTokenProcPtr)(const AEDesc *dContainerToken, DescType containerClass,
														AEDesc *result);
	...
	}; /* pascal 2_bytes Func(4_bytes, 4_bytes, 4_bytes, 4_bytes, 4_bytes, 4_bytes, 4_bytes) */
#ifdef __cplusplus
	inline DEFINE_API_C(OSLAccessorUPP) NewOSLAccessorUPP(OSLAccessorProcPtr userRoutine)
	{
		return (OSLAccessorUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppOSLAccessorProcInfo,
...
#define NewOSLAccessorUPP(userRoutine) \
	...
	{
		return (OSLCompareUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppOSLCompareProcInfo,
												   GetCurrentArchitecture());
	}
#else
...
#define NewOSLCountUPP(userRoutine) \
	...
	{
		return (OSLDisposeTokenUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppOSLDisposeTokenProcInfo,
														GetCurrentArchitecture());
	}
#else
#define NewOSLDisposeTokenUPP(userRoutine) \
	(OSLDisposeTokenUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppOSLDisposeTokenProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (OSLGetMarkTokenUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppOSLGetMarkTokenProcInfo,
														GetCurrentArchitecture());
	}
#else
#define NewOSLGetMarkTokenUPP(userRoutine) \
	(OSLGetMarkTokenUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppOSLGetMarkTokenProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (OSLGetErrDescUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppOSLGetErrDescProcInfo,
													  GetCurrentArchitecture());
	}
#else
...
#define NewOSLMarkUPP(userRoutine) \
	...
	{
		return (OSLAdjustMarksUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppOSLAdjustMarksProcInfo,
													   GetCurrentArchitecture());
	}
#else
#define NewOSLAdjustMarksUPP(userRoutine) \
	(OSLAdjustMarksUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppOSLAdjustMarksProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeOSLAdjustMarksUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	...
	InvokeOSLAccessorUPP(DescType desiredClass, const AEDesc *container, DescType containerClass, DescType form,
						 const AEDesc *selectionData, AEDesc *value, long accessorRefcon, OSLAccessorUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSErr)
		InvokeOSLAccessorUPP(DescType desiredClass, const AEDesc *container, DescType containerClass, DescType form,
							 const AEDesc *selectionData, AEDesc *value, long accessorRefcon, OSLAccessorUPP userUPP)
	{
		return (OSErr)CALL_SEVEN_PARAMETER_UPP(userUPP, uppOSLAccessorProcInfo, desiredClass, container, containerClass,
											   form, selectionData, value, accessorRefcon);
	}
#else
#define InvokeOSLAccessorUPP(desiredClass, container, containerClass, form, selectionData, value, accessorRefcon,      \
							 userUPP)                                                                                  \
	(OSErr) CALL_SEVEN_PARAMETER_UPP((userUPP), uppOSLAccessorProcInfo, (desiredClass), (container), (containerClass), \
									 (form), (selectionData), (value), (accessorRefcon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeOSLCompareUPP(DescType oper, const AEDesc *obj1, const AEDesc *obj2, Boolean *result, OSLCompareUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSErr) InvokeOSLCompareUPP(DescType oper, const AEDesc *obj1, const AEDesc *obj2,
...
#define InvokeOSLCompareUPP(oper, obj1, obj2, result, userUPP) \
	(OSErr) CALL_FOUR_PARAMETER_UPP((userUPP), uppOSLCompareProcInfo, (oper), (obj1), (obj2), (result))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeOSLCountUPP(DescType desiredType, DescType containerClass, const AEDesc *container, long *result,
					  OSLCountUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSErr) InvokeOSLCountUPP(DescType desiredType, DescType containerClass, const AEDesc *container,
												 long *result, OSLCountUPP userUPP)
	{
		return (OSErr)CALL_FOUR_PARAMETER_UPP(userUPP, uppOSLCountProcInfo, desiredType, containerClass, container,
											  result);
	}
#else
#define InvokeOSLCountUPP(desiredType, containerClass, container, result, userUPP)                                \
	(OSErr) CALL_FOUR_PARAMETER_UPP((userUPP), uppOSLCountProcInfo, (desiredType), (containerClass), (container), \
									(result))
#endif
#endif
...
#define InvokeOSLDisposeTokenUPP(unneededToken, userUPP) \
	(OSErr) CALL_ONE_PARAMETER_UPP((userUPP), uppOSLDisposeTokenProcInfo, (unneededToken))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeOSLGetMarkTokenUPP(const AEDesc *dContainerToken, DescType containerClass, AEDesc *result,
							 OSLGetMarkTokenUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSErr) InvokeOSLGetMarkTokenUPP(const AEDesc *dContainerToken, DescType containerClass,
														AEDesc *result, OSLGetMarkTokenUPP userUPP)
	{
		return (OSErr)CALL_THREE_PARAMETER_UPP(userUPP, uppOSLGetMarkTokenProcInfo, dContainerToken, containerClass,
											   result);
	}
#else
#define InvokeOSLGetMarkTokenUPP(dContainerToken, containerClass, result, userUPP) \
	(OSErr)                                                                        \
		CALL_THREE_PARAMETER_UPP((userUPP), uppOSLGetMarkTokenProcInfo, (dContainerToken), (containerClass), (result))
#endif
#endif
...
#define InvokeOSLGetErrDescUPP(appDescPtr, userUPP) \
	(OSErr) CALL_ONE_PARAMETER_UPP((userUPP), uppOSLGetErrDescProcInfo, (appDescPtr))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeOSLMarkUPP(const AEDesc *dToken, const AEDesc *markToken, long index, OSLMarkUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSErr)
		InvokeOSLMarkUPP(const AEDesc *dToken, const AEDesc *markToken, long index, OSLMarkUPP userUPP)
...
#define InvokeOSLMarkUPP(dToken, markToken, index, userUPP) \
	(OSErr) CALL_THREE_PARAMETER_UPP((userUPP), uppOSLMarkProcInfo, (dToken), (markToken), (index))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeOSLAdjustMarksUPP(long newStart, long newStop, const AEDesc *markToken, OSLAdjustMarksUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSErr)
		InvokeOSLAdjustMarksUPP(long newStart, long newStop, const AEDesc *markToken, OSLAdjustMarksUPP userUPP)
...
#define InvokeOSLAdjustMarksUPP(newStart, newStop, markToken, userUPP) \
	(OSErr) CALL_THREE_PARAMETER_UPP((userUPP), uppOSLAdjustMarksProcInfo, (newStart), (newStop), (markToken))
#endif
#endif
...
#define CallOSLAccessorProc(userRoutine, desiredClass, container, containerClass, form, selectionData, value, \
							accessorRefcon)                                                                   \
	InvokeOSLAccessorUPP(desiredClass, container, containerClass, form, selectionData, value, accessorRefcon, \
						 userRoutine)
...
#define CallOSLAdjustMarksProc(userRoutine, newStart, newStop, markToken) \
	...
	AESetObjectCallbacks(OSLCompareUPP myCompareProc, OSLCountUPP myCountProc, OSLDisposeTokenUPP myDisposeTokenProc,
						 ...
						 OSLAdjustMarksUPP myAdjustMarksProc, OSLGetErrDescUPP myGetErrDescProcPtr)
	...
	AEInstallObjectAccessor(DescType desiredClass, DescType containerType, OSLAccessorUPP theAccessor,
							long accessorRefcon, Boolean isSysHandler) THREEWORDINLINE(0x303C, 0x0937, 0xA816);
	 ...
	 */
	EXTERN_API(OSErr)
	AERemoveObjectAccessor(DescType desiredClass, DescType containerType, OSLAccessorUPP theAccessor,
	 ...
	 */
	EXTERN_API(OSErr)
	AEGetObjectAccessor(DescType desiredClass, DescType containerType, OSLAccessorUPP *accessor, long *accessorRefcon,
	...
	AECallObjectAccessor(DescType desiredClass, const AEDesc *containerToken, DescType containerClass, DescType keyForm,
						 const AEDesc *keyData, AEDesc *token) THREEWORDINLINE(0x303C, 0x0C3B, 0xA816);
