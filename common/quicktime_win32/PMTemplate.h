...
#pragma pack(2)
	...
	enum
	{
		...
		kPMConstraintList = 2,	 /* List has an array CFTypeRefs, listing possible values. DefaultValues are CFNumberRef
...
#define kPMPaperInfoList	CFSTR("com.apple.print.TemplateSpecific.PMTemplatePaperInfoTicket")
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateCreateXML(PMTemplateRef srcTemplate, CFDataRef *xmlData);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateLoadFromXML(CFDataRef srcData, PMTemplateRef *destTemplate);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateIsLocked(PMTemplateRef srcTemplate, Boolean *locked);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateMakeFullEntry(PMTemplateRef pmTemplate, CFStringRef key, PMValueType valueType,
							PMConstraintType constraintType, CFTypeRef defaultValue, CFTypeRef constraintValue);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateMakeEntry(PMTemplateRef pmTemplate, CFStringRef key, PMValueType valueType,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateSetCFDefaultValue(PMTemplateRef pmTemplate, CFStringRef key, CFTypeRef defaultValue);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateSetSInt32DefaultValue(PMTemplateRef pmTemplate, CFStringRef key, SInt32 defaultValue);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateSetSInt32RangeDefaultValue(PMTemplateRef pmTemplate, CFStringRef key, SInt32 min, SInt32 max);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateSetBooleanDefaultValue(PMTemplateRef pmTemplate, CFStringRef key, Boolean defaultValue);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateSetDoubleDefaultValue(PMTemplateRef pmTemplate, CFStringRef key, double defaultValue);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateSetDoubleRangeDefaultValue(PMTemplateRef pmTemplate, CFStringRef key, double min, double max);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateSetCFDataDefaultValue(PMTemplateRef pmTemplate, CFStringRef key, CFDataRef defaultValue);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateSetPMRectDefaultValue(PMTemplateRef pmTemplate, CFStringRef key, PMRect *defaultValue);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateSetPMTicketDefaultValue(PMTemplateRef pmTemplate, CFStringRef key, PMTicketRef defaultValue);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateSetCFArrayConstraintValue(PMTemplateRef pmTemplate, CFStringRef key, CFArrayRef constraintValue);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateSetCFRangeConstraint(PMTemplateRef pmTemplate, CFStringRef key, CFTypeRef min, CFTypeRef max);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateSetSInt32RangeConstraint(PMTemplateRef pmTemplate, CFStringRef key, SInt32 min, SInt32 max);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateSetSInt32RangesConstraint(PMTemplateRef pmTemplate, CFStringRef key, SInt32 minForMin, SInt32 maxForMin,
										SInt32 minForMax, SInt32 maxForMax);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateSetDoubleRangeConstraint(PMTemplateRef pmTemplate, CFStringRef key, double min, double max);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateSetDoubleRangesConstraint(PMTemplateRef pmTemplate, CFStringRef key, double minForMin, double maxForMin,
										double minForMax, double maxForMax);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateSetSInt32ListConstraint(PMTemplateRef pmTemplate, CFStringRef key, int listSize, SInt32 *sint32List);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateSetDoubleListConstraint(PMTemplateRef pmTemplate, CFStringRef key, int listSize, double *doubleList);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateSetPMRectListConstraint(PMTemplateRef pmTemplate, CFStringRef key, int listSize, PMRect *rectList);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateSetPMTicketListConstraint(PMTemplateRef pmTemplate, CFStringRef key, PMTicketRef listTicket);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateGetValueType(PMTemplateRef pmTemplate, CFStringRef key, PMValueType *valueType);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateGetConstraintType(PMTemplateRef pmTemplate, CFStringRef key, PMConstraintType *constraintType);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateGetCFDefaultValue(PMTemplateRef pmTemplate, CFStringRef key, CFTypeRef *defaultValue);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateGetSInt32DefaultValue(PMTemplateRef pmTemplate, CFStringRef key, SInt32 *defaultValue);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateGetSInt32RangeDefaultValue(PMTemplateRef pmTemplate, CFStringRef key, SInt32 *min, SInt32 *max);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateGetBooleanDefaultValue(PMTemplateRef pmTemplate, CFStringRef key, Boolean *defaultValue);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateGetDoubleDefaultValue(PMTemplateRef pmTemplate, CFStringRef key, double *defaultValue);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateGetDoubleRangeDefaultValue(PMTemplateRef pmTemplate, CFStringRef key, double *min, double *max);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateGetCFDataDefaultValue(PMTemplateRef pmTemplate, CFStringRef key, CFDataRef *defaultValue);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateGetPMRectDefaultValue(PMTemplateRef pmTemplate, CFStringRef key, PMRect *defaultValue);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateGetPMTicketDefaultValue(PMTemplateRef pmTemplate, CFStringRef key, PMTicketRef *defaultValue);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateGetCFArrayConstraintValue(PMTemplateRef pmTemplate, CFStringRef key, CFArrayRef *constraintValue);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateGetCFRangeConstraintValue(PMTemplateRef pmTemplate, CFStringRef key, CFTypeRef *min, CFTypeRef *max);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateGetSInt32RangeConstraintValue(PMTemplateRef pmTemplate, CFStringRef key, SInt32 *min, SInt32 *max);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateGetSInt32RangesConstraintValue(PMTemplateRef pmTemplate, CFStringRef key, SInt32 *minForMin,
											 SInt32 *maxForMin, SInt32 *minForMax, SInt32 *maxForMax);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateGetDoubleRangeConstraintValue(PMTemplateRef pmTemplate, CFStringRef key, double *min, double *max);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateGetDoubleRangesConstraintValue(PMTemplateRef pmTemplate, CFStringRef key, double *minForMin,
											 double *maxForMin, double *minForMax, double *maxForMax);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateGetSInt32ListConstraintValue(PMTemplateRef pmTemplate, CFStringRef key, int *listSize,
										   SInt32 *sint32List);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateGetDoubleListConstraintValue(PMTemplateRef pmTemplate, CFStringRef key, int *listSize,
										   double *doubleList);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateGetPMRectListConstraintValue(PMTemplateRef pmTemplate, CFStringRef key, int *listSize, PMRect *rectList);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateGetListTicketConstraintValue(PMTemplateRef pmTemplate, CFStringRef key, PMTicketRef *listTicket);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateRemoveEntry(PMTemplateRef pmTemplate, CFStringRef key);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateValidateItem(PMTemplateRef pmTemplate, CFStringRef key, CFTypeRef item, Boolean *validationResults);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	PMTemplateMergeTemplates(PMTemplateRef sourceTemplate, PMTemplateRef destTemplate);
