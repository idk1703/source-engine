...
#pragma pack(2)
	...
	enum
	{
		...
		kURLAllNonBufferEventsMask = kURLInitiatedEventMask + kURLDownloadingMask + kURLUploadingMask +
									 kURLAbortInitiatedMask + kURLCompletedEventMask + kURLErrorOccurredEventMask +
									 kURLPercentEventMask + kURLPeriodicEventMask + kURLPropertyChangedEventMask,
...
#define DisposeURLSystemEventUPP(userUPP)
	...
	InvokeURLNotifyUPP(void *userContext, URLEvent event, URLCallbackInfo *callbackInfo, URLNotifyUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeURLNotifyUPP(userContext, event, callbackInfo, userUPP) (*userUPP)(userContext, event, callbackInfo)
	 ...
	 */
	EXTERN_API_C(OSStatus)
	InvokeURLSystemEventUPP(void *userContext, EventRecord *event, URLSystemEventUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSStatus)
		InvokeURLSystemEventUPP(void *userContext, EventRecord *event, URLSystemEventUPP userUPP)
...
#define InvokeURLSystemEventUPP(userContext, event, userUPP) (*userUPP)(userContext, event)
	...
	URLSimpleDownload(const char *url, FSSpec *destination,				   /* can be NULL */
					  ...
					  URLOpenFlags openFlags, URLSystemEventUPP eventProc, /* can be NULL */
	 ...
	 */
	EXTERN_API(OSStatus)
	URLGetProperty(URLReference urlRef, const char *property, void *propertyBuffer, Size bufferSize);
	 ...
	 */
	EXTERN_API(OSStatus)
	URLGetPropertySize(URLReference urlRef, const char *property, Size *propertySize);
	 ...
	 */
	EXTERN_API(OSStatus)
	URLSetProperty(URLReference urlRef, const char *property, void *propertyBuffer, Size bufferSize);
