...
#define PM_USE_SESSION_APIS 1
	 ...
	 */
	EXTERN_API(OSStatus)
	PMSessionCreatePrinterList(PMPrintSession printSession, CFArrayRef *printerList, CFIndex *currentIndex,
	 ...
	 */
	EXTERN_API(OSStatus)
	PMSessionSetDestination(PMPrintSession printSession, PMPrintSettings printSettings, PMDestinationType destType,
							CFStringRef destFormat, CFURLRef destLocation);
	 ...
	 */
	EXTERN_API(OSStatus)
	PMSessionGetDestinationType(PMPrintSession printSession, PMPrintSettings printSettings,
	 ...
	 */
	EXTERN_API(OSStatus)
	PMSessionCopyDestinationFormat(PMPrintSession printSession, PMPrintSettings printSettings,
	 ...
	 */
	EXTERN_API(OSStatus)
	PMSessionCopyDestinationLocation(PMPrintSession printSession, PMPrintSettings printSettings,
	 ...
	 */
	EXTERN_API(OSStatus)
	PMSessionCopyOutputFormatList(PMPrintSession printSession, PMDestinationType destType, CFArrayRef *documentFormatP);
	 ...
	 */
	EXTERN_API(OSStatus)
	PMSessionCreatePageFormatList(PMPrintSession printSession, PMPrinter printer, CFArrayRef *pageFormatList);
	 ...
	 */
	EXTERN_API(OSStatus)
	PMSessionBeginDocumentNoDialog(PMPrintSession printSession, PMPrintSettings printSettings, PMPageFormat pageFormat);
	 ...
	 */
	EXTERN_API(OSStatus)
	PMSessionBeginPageNoDialog(PMPrintSession printSession, PMPageFormat pageFormat, const PMRect *pageFrame);
 ...
 */
EXTERN_API(OSStatus)
PMConvertOldPrintRecord(Handle printRecordHandle, PMPrintSettings *printSettings, PMPageFormat *pageFormat);
 ...
 */
EXTERN_API(OSStatus)
PMMakeOldPrintRecord(PMPrintSettings printSettings, PMPageFormat pageFormat, Handle *printRecordHandle);
...
PMSetError(OSStatus printError);
	 ...
	 */
	EXTERN_API(OSStatus)
	PMGetPageFormatExtendedData(PMPageFormat pageFormat, OSType dataID, UInt32 *size, void *extendedData);
	 ...
	 */
	EXTERN_API(OSStatus)
	PMSetPageFormatExtendedData(PMPageFormat pageFormat, OSType dataID, UInt32 size, void *extendedData);
	 ...
	 */
	EXTERN_API(OSStatus)
	PMSetOrientation(PMPageFormat pageFormat, PMOrientation orientation, Boolean lock);
	 ...
	 */
	EXTERN_API(OSStatus)
	PMGetPrintSettingsExtendedData(PMPrintSettings printSettings, OSType dataID, UInt32 *size, void *extendedData);
	 ...
	 */
	EXTERN_API(OSStatus)
	PMSetPrintSettingsExtendedData(PMPrintSettings printSettings, OSType dataID, UInt32 size, void *extendedData);
	 ...
	 */
	EXTERN_API(OSStatus)
	PMGetDestination(PMPrintSettings printSettings, PMDestinationType *destType, CFURLRef *fileURL);
	 ...
	 */
	EXTERN_API(OSStatus)
	PMSetProfile(PMPrintSettings printSettings, PMTag tag, const CMProfileLocation *profile);
	 ...
	 */
	EXTERN_API(OSStatus)
	PMSetCollate(PMPrintSettings printSettings, Boolean collate);
	 ...
	 */
	EXTERN_API(OSStatus)
	PMGetCollate(PMPrintSettings printSettings, Boolean *collate);
	 ...
	 */
	EXTERN_API(OSStatus)
	PMServerCreatePrinterList(PMServer server, CFArrayRef *printerList);
	 ...
	 */
	EXTERN_API(OSStatus)
	PMPrinterGetState(PMPrinter printer, PMPrinterState *state);
	 ...
	 */
	EXTERN_API(OSStatus)
	PMPrinterGetDeviceURI(PMPrinter printer, CFURLRef *deviceURI);
	...
	PMCGImageCreateWithEPSDataProvider(CGDataProviderRef epsDataProvider, CGImageRef epsPreview);
