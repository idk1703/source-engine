...
#pragma pack(2)
	...
	{
		return (SlotIntServiceUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppSlotIntServiceProcInfo,
													   GetCurrentArchitecture());
	}
#else
#define NewSlotIntServiceUPP(userRoutine) \
	(SlotIntServiceUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppSlotIntServiceProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#endif
	EXTERN_API_C(short)
	InvokeSlotIntServiceUPP(long sqParameter, SlotIntServiceUPP userUPP) ONEWORDINLINE(0x4E90);
...
#define InvokeSlotIntServiceUPP(sqParameter, userUPP) \
	(short)CALL_ONE_PARAMETER_UPP((userUPP), uppSlotIntServiceProcInfo, (sqParameter))
#endif
#endif
...
#define CallSlotIntServiceProc(userRoutine, sqParameter) InvokeSlotIntServiceUPP(sqParameter, userRoutine)
	...
	/*
			...
			Extended Format header block  -  extended declaration ROM format header for super sRsrc directories.
	   <H2><SM0>
