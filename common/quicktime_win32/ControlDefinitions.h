...
/*------------------------------------------------------------------------------------------------------*/
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateBevelButtonControl(WindowRef window, const Rect *boundsRect, CFStringRef title,
							 ControlBevelThickness thickness, ControlBevelButtonBehavior behavior,
							 ControlButtonContentInfoPtr info, SInt16 menuID,
							 ControlBevelButtonMenuBehavior menuBehavior, ControlBevelButtonMenuPlacement menuPlacement,
	...
	enum
	{
		...
		kControlBevelButtonKindTag =
			FOUR_CHAR_CODE('bebk') /* ThemeButtonKind ( kTheme[Small,Medium,Large,Rounded]BevelButton )*/
	};
...
#define GetBevelButtonMenuRef GetBevelButtonMenuHandle
	 ...
	 */
	EXTERN_API(OSErr)
	GetBevelButtonContentInfo(ControlRef inButton, ControlButtonContentInfoPtr outContent);
	 ...
	 */
	EXTERN_API(OSErr)
	SetBevelButtonContentInfo(ControlRef inButton, ControlButtonContentInfoPtr inContent);
	 ...
	 */
	EXTERN_API(OSErr)
	SetBevelButtonGraphicAlignment(ControlRef inButton, ControlButtonGraphicAlignment inAlign, SInt16 inHOffset,
								   SInt16 inVOffset);
	 ...
	 */
	EXTERN_API(OSErr)
	SetBevelButtonTextAlignment(ControlRef inButton, ControlButtonTextAlignment inAlign, SInt16 inHOffset);
	 ...
	 */
	EXTERN_API(OSErr)
	SetBevelButtonTextPlacement(ControlRef inButton, ControlButtonTextPlacement inWhere);
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateSliderControl(WindowRef window, const Rect *boundsRect, SInt32 value, SInt32 minimum, SInt32 maximum,
						ControlSliderOrientation orientation, UInt16 numTickMarks, Boolean liveTracking,
						ControlActionUPP liveTrackingProc, ControlRef *outControl);
	...
	enum
	{
		kControlDisclosureTrianglePointDefault =
			0, /* points right on a left-to-right script system (Mac OS X and later or CarbonLib 1.5 and later only)*/
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateDisclosureTriangleControl(WindowRef inWindow, const Rect *inBoundsRect,
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateProgressBarControl(WindowRef window, const Rect *boundsRect, SInt32 value, SInt32 minimum, SInt32 maximum,
							 Boolean indeterminate, ControlRef *outControl);
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateRelevanceBarControl(WindowRef window, const Rect *boundsRect, SInt32 value, SInt32 minimum, SInt32 maximum,
							  ControlRef *outControl);
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateLittleArrowsControl(WindowRef window, const Rect *boundsRect, SInt32 value, SInt32 minimum, SInt32 maximum,
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateChasingArrowsControl(WindowRef window, const Rect *boundsRect, ControlRef *outControl);
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateTabsControl(WindowRef window, const Rect *boundsRect, ControlTabSize size, ControlTabDirection direction,
					  UInt16 numTabs, const ControlTabEntry *tabArray, ControlRef *outControl);
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateSeparatorControl(WindowRef window, const Rect *boundsRect, ControlRef *outControl);
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateGroupBoxControl(WindowRef window, const Rect *boundsRect, CFStringRef title, Boolean primary,
						  ControlRef *outControl);
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateCheckGroupBoxControl(WindowRef window, const Rect *boundsRect, CFStringRef title, SInt32 initialValue,
							   Boolean primary, Boolean autoToggle, ControlRef *outControl);
	 ...
	 */
	EXTERN_API(OSStatus)
	CreatePopupGroupBoxControl(WindowRef window, const Rect *boundsRect, CFStringRef title, Boolean primary,
							   SInt16 menuID, Boolean variableWidth, SInt16 titleWidth, SInt16 titleJustification,
							   Style titleStyle, ControlRef *outControl);
	...
	enum
	{
		kControlGroupBoxTitleRectTag =
			FOUR_CHAR_CODE('trec') /* Rect. Rectangle that the title text/control is drawn in. (get only)*/
	};
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateImageWellControl(WindowRef window, const Rect *boundsRect, const ControlButtonContentInfo *info,
						   ControlRef *outControl);
	 ...
	 */
	EXTERN_API(OSErr)
	GetImageWellContentInfo(ControlRef inButton, ControlButtonContentInfoPtr outContent);
	 ...
	 */
	EXTERN_API(OSErr)
	SetImageWellContentInfo(ControlRef inButton, ControlButtonContentInfoPtr inContent);
	 ...
	 */
	EXTERN_API(OSStatus)
	CreatePopupArrowControl(WindowRef window, const Rect *boundsRect, ControlPopupArrowOrientation orientation,
	 ...
	 */
	EXTERN_API(OSStatus)
	CreatePlacardControl(WindowRef window, const Rect *boundsRect, ControlRef *outControl);
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateClockControl(WindowRef window, const Rect *boundsRect, ControlClockType clockType,
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateUserPaneControl(WindowRef window, const Rect *boundsRect, UInt32 features, ControlRef *outControl);
	...
	typedef CALLBACK_API(ControlPartCode, ControlUserPaneTrackingProcPtr)(ControlRef control, Point startPt,
																		  ControlActionUPP actionProc);
	typedef CALLBACK_API(void, ControlUserPaneIdleProcPtr)(ControlRef control);
	typedef CALLBACK_API(ControlPartCode, ControlUserPaneKeyDownProcPtr)(ControlRef control, SInt16 keyCode,
	...
	{
		return (ControlUserPaneDrawUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppControlUserPaneDrawProcInfo,
															GetCurrentArchitecture());
	}
#else
#define NewControlUserPaneDrawUPP(userRoutine) \
	(ControlUserPaneDrawUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppControlUserPaneDrawProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#ifdef __cplusplus
	inline DEFINE_API_C(ControlUserPaneHitTestUPP)
		NewControlUserPaneHitTestUPP(ControlUserPaneHitTestProcPtr userRoutine)
	{
		return (ControlUserPaneHitTestUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppControlUserPaneHitTestProcInfo, GetCurrentArchitecture());
	}
#else
#define NewControlUserPaneHitTestUPP(userRoutine) \
	(ControlUserPaneHitTestUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppControlUserPaneHitTestProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#ifdef __cplusplus
	inline DEFINE_API_C(ControlUserPaneTrackingUPP)
		NewControlUserPaneTrackingUPP(ControlUserPaneTrackingProcPtr userRoutine)
	{
		return (ControlUserPaneTrackingUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppControlUserPaneTrackingProcInfo, GetCurrentArchitecture());
	}
#else
#define NewControlUserPaneTrackingUPP(userRoutine) \
	(ControlUserPaneTrackingUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppControlUserPaneTrackingProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (ControlUserPaneIdleUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppControlUserPaneIdleProcInfo,
															GetCurrentArchitecture());
	}
#else
#define NewControlUserPaneIdleUPP(userRoutine) \
	(ControlUserPaneIdleUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppControlUserPaneIdleProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#ifdef __cplusplus
	inline DEFINE_API_C(ControlUserPaneKeyDownUPP)
		NewControlUserPaneKeyDownUPP(ControlUserPaneKeyDownProcPtr userRoutine)
	{
		return (ControlUserPaneKeyDownUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppControlUserPaneKeyDownProcInfo, GetCurrentArchitecture());
	}
#else
#define NewControlUserPaneKeyDownUPP(userRoutine) \
	(ControlUserPaneKeyDownUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppControlUserPaneKeyDownProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#ifdef __cplusplus
	inline DEFINE_API_C(ControlUserPaneActivateUPP)
		NewControlUserPaneActivateUPP(ControlUserPaneActivateProcPtr userRoutine)
	{
		return (ControlUserPaneActivateUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppControlUserPaneActivateProcInfo, GetCurrentArchitecture());
	}
#else
#define NewControlUserPaneActivateUPP(userRoutine) \
	(ControlUserPaneActivateUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppControlUserPaneActivateProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (ControlUserPaneFocusUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppControlUserPaneFocusProcInfo,
															 GetCurrentArchitecture());
	}
#else
#define NewControlUserPaneFocusUPP(userRoutine) \
	(ControlUserPaneFocusUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppControlUserPaneFocusProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#ifdef __cplusplus
	inline DEFINE_API_C(ControlUserPaneBackgroundUPP)
		NewControlUserPaneBackgroundUPP(ControlUserPaneBackgroundProcPtr userRoutine)
	{
		return (ControlUserPaneBackgroundUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppControlUserPaneBackgroundProcInfo, GetCurrentArchitecture());
	}
#else
#define NewControlUserPaneBackgroundUPP(userRoutine) \
	(ControlUserPaneBackgroundUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppControlUserPaneBackgroundProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeControlUserPaneBackgroundUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(void)
	InvokeControlUserPaneDrawUPP(ControlRef control, SInt16 part, ControlUserPaneDrawUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeControlUserPaneDrawUPP(control, part, userUPP) \
	...
	InvokeControlUserPaneHitTestUPP(ControlRef control, Point where, ControlUserPaneHitTestUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(ControlPartCode)
		InvokeControlUserPaneHitTestUPP(ControlRef control, Point where, ControlUserPaneHitTestUPP userUPP)
	{
...
#define InvokeControlUserPaneHitTestUPP(control, where, userUPP) \
	(ControlPartCode) CALL_TWO_PARAMETER_UPP((userUPP), uppControlUserPaneHitTestProcInfo, (control), (where))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(ControlPartCode)
	InvokeControlUserPaneTrackingUPP(ControlRef control, Point startPt, ControlActionUPP actionProc,
	...
	inline DEFINE_API_C(ControlPartCode)
		InvokeControlUserPaneTrackingUPP(ControlRef control, Point startPt, ControlActionUPP actionProc,
										 ControlUserPaneTrackingUPP userUPP)
	{
		return (ControlPartCode)CALL_THREE_PARAMETER_UPP(userUPP, uppControlUserPaneTrackingProcInfo, control, startPt,
														 actionProc);
	}
#else
#define InvokeControlUserPaneTrackingUPP(control, startPt, actionProc, userUPP) \
	(ControlPartCode)                                                           \
		CALL_THREE_PARAMETER_UPP((userUPP), uppControlUserPaneTrackingProcInfo, (control), (startPt), (actionProc))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(void)
	InvokeControlUserPaneIdleUPP(ControlRef control, ControlUserPaneIdleUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeControlUserPaneIdleUPP(control, userUPP) \
	 ...
	 */
	EXTERN_API_C(ControlPartCode)
	InvokeControlUserPaneKeyDownUPP(ControlRef control, SInt16 keyCode, SInt16 charCode, SInt16 modifiers,
	...
	inline DEFINE_API_C(ControlPartCode)
		InvokeControlUserPaneKeyDownUPP(ControlRef control, SInt16 keyCode, SInt16 charCode, SInt16 modifiers,
										ControlUserPaneKeyDownUPP userUPP)
	{
		return (ControlPartCode)CALL_FOUR_PARAMETER_UPP(userUPP, uppControlUserPaneKeyDownProcInfo, control, keyCode,
														charCode, modifiers);
	}
#else
#define InvokeControlUserPaneKeyDownUPP(control, keyCode, charCode, modifiers, userUPP)                           \
	(ControlPartCode) CALL_FOUR_PARAMETER_UPP((userUPP), uppControlUserPaneKeyDownProcInfo, (control), (keyCode), \
											  (charCode), (modifiers))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(void)
	InvokeControlUserPaneActivateUPP(ControlRef control, Boolean activating, ControlUserPaneActivateUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void)
		InvokeControlUserPaneActivateUPP(ControlRef control, Boolean activating, ControlUserPaneActivateUPP userUPP)
...
#define InvokeControlUserPaneActivateUPP(control, activating, userUPP) \
	 ...
	 */
	EXTERN_API_C(ControlPartCode)
	InvokeControlUserPaneFocusUPP(ControlRef control, ControlFocusPart action, ControlUserPaneFocusUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(ControlPartCode)
		InvokeControlUserPaneFocusUPP(ControlRef control, ControlFocusPart action, ControlUserPaneFocusUPP userUPP)
...
#define InvokeControlUserPaneFocusUPP(control, action, userUPP) \
	(ControlPartCode) CALL_TWO_PARAMETER_UPP((userUPP), uppControlUserPaneFocusProcInfo, (control), (action))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(void)
	InvokeControlUserPaneBackgroundUPP(ControlRef control, ControlBackgroundPtr info,
									   ControlUserPaneBackgroundUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void) InvokeControlUserPaneBackgroundUPP(ControlRef control, ControlBackgroundPtr info,
																 ControlUserPaneBackgroundUPP userUPP)
	{
...
#define CallControlUserPaneTrackingProc(userRoutine, control, startPt, actionProc) \
...
#define CallControlUserPaneKeyDownProc(userRoutine, control, keyCode, charCode, modifiers) \
	InvokeControlUserPaneKeyDownUPP(control, keyCode, charCode, modifiers, userRoutine)
...
#define CallControlUserPaneBackgroundProc(userRoutine, control, info) \
	...
	*/
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateEditTextControl(WindowRef window, const Rect *boundsRect, CFStringRef text, Boolean isPassword,
						  Boolean useInlineInput, const ControlFontStyleRec *style, /* can be NULL */
						  ControlRef *outControl);
	...
	enum
	{
		kControlEditTextKeyScriptBehaviorTag =
			FOUR_CHAR_CODE('kscr'), /* ControlKeyScriptBehavior. Defaults to "PrefersRoman" for password fields,*/
		...
		kControlEditTextFixedTextTag =
			FOUR_CHAR_CODE('ftxt'), /* Like the normal text tag, but fixes inline input first*/
		kControlEditTextValidationProcTag = FOUR_CHAR_CODE(
			'vali'), /* ControlEditTextValidationUPP. Called when a key filter can't be: after cut, paste, etc.*/
		kControlEditTextInlinePreUpdateProcTag =
			FOUR_CHAR_CODE('prup'), /* TSMTEPreUpdateUPP and TSMTEPostUpdateUpp. For use with inline input variant...*/
...
#ifdef __cplusplus
	inline DEFINE_API_C(ControlEditTextValidationUPP)
		NewControlEditTextValidationUPP(ControlEditTextValidationProcPtr userRoutine)
	{
		return (ControlEditTextValidationUPP)NewRoutineDescriptor(
			(ProcPtr)(userRoutine), uppControlEditTextValidationProcInfo, GetCurrentArchitecture());
	}
#else
...
#define DisposeControlEditTextValidationUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(void)
	InvokeControlEditTextValidationUPP(ControlRef control, ControlEditTextValidationUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void)
		InvokeControlEditTextValidationUPP(ControlRef control, ControlEditTextValidationUPP userUPP)
...
#define CallControlEditTextValidationProc(userRoutine, control) InvokeControlEditTextValidationUPP(control, userRoutine)
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateStaticTextControl(WindowRef window, const Rect *boundsRect, CFStringRef text,
	 ...
	 */
	EXTERN_API(OSStatus)
	CreatePictureControl(WindowRef window, const Rect *boundsRect, const ControlButtonContentInfo *content,
						 Boolean dontTrack, ControlRef *outControl);
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateIconControl(WindowRef inWindow, const Rect *inBoundsRect, const ControlButtonContentInfo *inIconContent,
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateWindowHeaderControl(WindowRef window, const Rect *boundsRect, Boolean isListHeader, ControlRef *outControl);
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateListBoxControl(WindowRef window, const Rect *boundsRect, Boolean autoSize, SInt16 numRows, SInt16 numColumns,
						 Boolean horizScroll, Boolean vertScroll, SInt16 cellHeight, SInt16 cellWidth,
	 ...
	 */
	EXTERN_API(OSStatus)
	CreatePushButtonControl(WindowRef window, const Rect *boundsRect, CFStringRef title, ControlRef *outControl);
	 ...
	 */
	EXTERN_API(OSStatus)
	CreatePushButtonWithIconControl(WindowRef window, const Rect *boundsRect, CFStringRef title,
									ControlButtonContentInfo *icon, ControlPushButtonIconAlignment iconAlignment,
									ControlRef *outControl);
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateRadioButtonControl(WindowRef window, const Rect *boundsRect, CFStringRef title, SInt32 initialValue,
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateCheckBoxControl(WindowRef window, const Rect *boundsRect, CFStringRef title, SInt32 initialValue,
						  Boolean autoToggle, ControlRef *outControl);
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateScrollBarControl(WindowRef window, const Rect *boundsRect, SInt32 value, SInt32 minimum, SInt32 maximum,
						   SInt32 viewSize, Boolean liveTracking, ControlActionUPP liveTrackingProc,
						   ControlRef *outControl);
	 ...
	 */
	EXTERN_API(OSStatus)
	CreatePopupButtonControl(WindowRef window, const Rect *boundsRect, CFStringRef title, SInt16 menuID,
							 Boolean variableWidth, SInt16 titleWidth, SInt16 titleJustification, Style titleStyle,
							 ControlRef *outControl);
	...
	enum
	{
		kControlPopupButtonExtraHeightTag =
			FOUR_CHAR_CODE('exht'), /* SInt16 - extra vertical whitespace within the button*/
	...
	enum
	{
		kControlPopupButtonCheckCurrentTag = FOUR_CHAR_CODE(
			'chck') /* Boolean    - whether the popup puts a checkmark next to the current item (defaults to true)*/
	};
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateRadioGroupControl(WindowRef window, const Rect *boundsRect, ControlRef *outControl);
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateScrollingTextBoxControl(WindowRef window, const Rect *boundsRect, SInt16 contentResID, Boolean autoScroll,
								  UInt32 delayBeforeAutoScroll, UInt32 delayBetweenAutoScroll, UInt16 autoScrollAmount,
								  ControlRef *outControl);
	...
	enum
	{
		...
		kControlScrollTextBoxContentsTag =
			FOUR_CHAR_CODE('tres'), /* SInt16 (resource ID of 'TEXT'/'styl') -- write only!*/
		kControlScrollTextBoxAnimatingTag =
			FOUR_CHAR_CODE('anim') /* Boolean (whether the text box should auto-scroll)*/
	};
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateDisclosureButtonControl(WindowRef inWindow, const Rect *inBoundsRect, SInt32 inValue, Boolean inAutoToggles,
								  ControlRef *outControl);
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateRoundButtonControl(WindowRef inWindow, const Rect *inBoundsRect, ControlRoundButtonSize inSize,
							 ControlButtonContentInfo *inContent, ControlRef *outControl);
	...
	enum
	{
		...
		kDataBrowserItemIsEditableProperty =
			3L, /* Boolean typed data (defaults to false, used for editable properties) */
		...
		kDataBrowserItemParentContainerProperty =
			11L /* DataBrowserItemID (the parent of the specified item, used by ColumnView) */
	};
	...
	enum
	{
		...
		kDataBrowserSliderUpwardThumb = kThemeThumbUpward
										<< kDataBrowserPropertyFlagsOffset, /* kDataBrowserSliderType */
		kDataBrowserSliderDownwardThumb = kThemeThumbDownward
										  << kDataBrowserPropertyFlagsOffset, /* kDataBrowserSliderType */
		kDataBrowserDoNotTruncateText =
			3 << kDataBrowserPropertyFlagsOffset, /* kDataBrowserTextType && kDataBrowserIconAndTextType */
		kDataBrowserTruncateTextAtEnd =
			2 << kDataBrowserPropertyFlagsOffset, /* kDataBrowserTextType && kDataBrowserIconAndTextType */
		kDataBrowserTruncateTextMiddle =
			0 << kDataBrowserPropertyFlagsOffset, /* kDataBrowserTextType && kDataBrowserIconAndTextType */
		kDataBrowserTruncateTextAtStart =
			1 << kDataBrowserPropertyFlagsOffset, /* kDataBrowserTextType && kDataBrowserIconAndTextType */
	...
	*/
	...
	typedef CALLBACK_API(void, DataBrowserItemProcPtr)(DataBrowserItemID item, DataBrowserItemState state,
													   void *clientData);
	 ...
	 */
	EXTERN_API_C(void)
	InvokeDataBrowserItemUPP(DataBrowserItemID item, DataBrowserItemState state, void *clientData,
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateDataBrowserControl(WindowRef window, const Rect *boundsRect, DataBrowserViewStyle style,
							 ControlRef *outControl);
	 ...
	 */
	EXTERN_API(OSStatus)
	AddDataBrowserItems(ControlRef browser, DataBrowserItemID container, UInt32 numItems,
	 ...
	 */
	EXTERN_API(OSStatus)
	RemoveDataBrowserItems(ControlRef browser, DataBrowserItemID container, UInt32 numItems,
						   const DataBrowserItemID *items, /* can be NULL */
						   DataBrowserPropertyID preSortProperty);
	 ...
	 */
	EXTERN_API(OSStatus)
	UpdateDataBrowserItems(ControlRef browser, DataBrowserItemID container, UInt32 numItems,
						   const DataBrowserItemID *items, /* can be NULL */
	 ...
	 */
	EXTERN_API(Boolean)
	EnableDataBrowserEditCommand(ControlRef browser, DataBrowserEditCommand command);
	 ...
	 */
	EXTERN_API(OSStatus)
	ExecuteDataBrowserEditCommand(ControlRef browser, DataBrowserEditCommand command);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserSelectionAnchor(ControlRef browser, DataBrowserItemID *first, DataBrowserItemID *last);
	 ...
	 */
	EXTERN_API(OSStatus)
	MoveDataBrowserSelectionAnchor(ControlRef browser, DataBrowserSelectionAnchorDirection direction,
	 ...
	 */
	EXTERN_API(OSStatus)
	SortDataBrowserContainer(ControlRef browser, DataBrowserItemID container, Boolean sortChildren);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserItems(ControlRef browser, DataBrowserItemID container, Boolean recurse, DataBrowserItemState state,
						Handle items);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserItemCount(ControlRef browser, DataBrowserItemID container, Boolean recurse,
							DataBrowserItemState state, UInt32 *numItems);
	 ...
	 */
	EXTERN_API(OSStatus)
	ForEachDataBrowserItem(ControlRef browser, DataBrowserItemID container, Boolean recurse, DataBrowserItemState state,
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserItemState(ControlRef browser, DataBrowserItemID item, DataBrowserItemState *state);
	 ...
	 */
	EXTERN_API(OSStatus)
	RevealDataBrowserItem(ControlRef browser, DataBrowserItemID item, DataBrowserPropertyID propertyID,
	 ...
	 */
	EXTERN_API(OSStatus)
	SetDataBrowserSelectedItems(ControlRef browser, UInt32 numItems, const DataBrowserItemID *items,
	 ...
	 */
	EXTERN_API(OSStatus)
	SetDataBrowserSelectionFlags(ControlRef browser, DataBrowserSelectionFlags selectionFlags);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserSelectionFlags(ControlRef browser, DataBrowserSelectionFlags *selectionFlags);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetDataBrowserPropertyFlags(ControlRef browser, DataBrowserPropertyID property, DataBrowserPropertyFlags flags);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserPropertyFlags(ControlRef browser, DataBrowserPropertyID property, DataBrowserPropertyFlags *flags);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetDataBrowserEditItem(ControlRef browser, DataBrowserItemID item, DataBrowserPropertyID property);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserEditItem(ControlRef browser, DataBrowserItemID *item, DataBrowserPropertyID *property);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserItemPartBounds(ControlRef browser, DataBrowserItemID item, DataBrowserPropertyID property,
	 ...
	 */
	EXTERN_API(OSStatus)
	SetDataBrowserItemDataText(DataBrowserItemDataRef itemData, CFStringRef theData);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserItemDataText(DataBrowserItemDataRef itemData, CFStringRef *theData);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetDataBrowserItemDataBooleanValue(DataBrowserItemDataRef itemData, Boolean theData);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserItemDataBooleanValue(DataBrowserItemDataRef itemData, Boolean *theData);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserItemDataMenuRef(DataBrowserItemDataRef itemData, MenuRef *theData);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetDataBrowserItemDataRGBColor(DataBrowserItemDataRef itemData, const RGBColor *theData);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserItemDataRGBColor(DataBrowserItemDataRef itemData, RGBColor *theData);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetDataBrowserItemDataDrawState(DataBrowserItemDataRef itemData, ThemeDrawState theData);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserItemDataDrawState(DataBrowserItemDataRef itemData, ThemeDrawState *theData);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetDataBrowserItemDataButtonValue(DataBrowserItemDataRef itemData, ThemeButtonValue theData);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserItemDataButtonValue(DataBrowserItemDataRef itemData, ThemeButtonValue *theData);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetDataBrowserItemDataIconTransform(DataBrowserItemDataRef itemData, IconTransformType theData);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserItemDataIconTransform(DataBrowserItemDataRef itemData, IconTransformType *theData);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetDataBrowserItemDataLongDateTime(DataBrowserItemDataRef itemData, const LongDateTime *theData);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserItemDataLongDateTime(DataBrowserItemDataRef itemData, LongDateTime *theData);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetDataBrowserItemDataItemID(DataBrowserItemDataRef itemData, DataBrowserItemID theData);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserItemDataItemID(DataBrowserItemDataRef itemData, DataBrowserItemID *theData);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserItemDataProperty(DataBrowserItemDataRef itemData, DataBrowserPropertyID *theData);

	/* Standard DataBrowser Callbacks */

	/* Basic Item Management & Manipulation */
	typedef CALLBACK_API(OSStatus, DataBrowserItemDataProcPtr)(ControlRef browser, DataBrowserItemID item,
	...
	/* Item Comparison */
	typedef CALLBACK_API(Boolean, DataBrowserItemCompareProcPtr)(ControlRef browser, DataBrowserItemID itemOne,
	...
	typedef CALLBACK_API(void, DataBrowserItemNotificationWithItemProcPtr)(ControlRef browser, DataBrowserItemID item,
																		   DataBrowserItemNotification message,
																		   DataBrowserItemDataRef itemData);
	typedef CALLBACK_API(void, DataBrowserItemNotificationProcPtr)(ControlRef browser, DataBrowserItemID item,
																   DataBrowserItemNotification message);
	...
	typedef CALLBACK_API(Boolean, DataBrowserAddDragItemProcPtr)(ControlRef browser, DragReference theDrag,
																 DataBrowserItemID item, ItemReference *itemRef);
	typedef CALLBACK_API(Boolean, DataBrowserAcceptDragProcPtr)(ControlRef browser, DragReference theDrag,
																DataBrowserItemID item);
	typedef CALLBACK_API(Boolean, DataBrowserReceiveDragProcPtr)(ControlRef browser, DragReference theDrag,
																 DataBrowserItemID item);
	typedef CALLBACK_API(void, DataBrowserPostProcessDragProcPtr)(ControlRef browser, DragReference theDrag,
	...
	typedef CALLBACK_API(void, DataBrowserGetContextualMenuProcPtr)(ControlRef browser, MenuRef *menu, UInt32 *helpType,
																	CFStringRef *helpItemString, AEDesc *selection);
	typedef CALLBACK_API(void, DataBrowserSelectContextualMenuProcPtr)(ControlRef browser, MenuRef menu,
	...
	typedef CALLBACK_API(void, DataBrowserItemHelpContentProcPtr)(ControlRef browser, DataBrowserItemID item,
																  DataBrowserPropertyID property,
	...
	InvokeDataBrowserItemDataUPP(ControlRef browser, DataBrowserItemID item, DataBrowserPropertyID property,
								 DataBrowserItemDataRef itemData, Boolean setValue, DataBrowserItemDataUPP userUPP);
	...
	InvokeDataBrowserItemCompareUPP(ControlRef browser, DataBrowserItemID itemOne, DataBrowserItemID itemTwo,
									DataBrowserPropertyID sortProperty, DataBrowserItemCompareUPP userUPP);
	 ...
	 */
	EXTERN_API_C(void)
	InvokeDataBrowserItemNotificationWithItemUPP(ControlRef browser, DataBrowserItemID item,
	...
	InvokeDataBrowserItemNotificationUPP(ControlRef browser, DataBrowserItemID item,
										 DataBrowserItemNotification message, DataBrowserItemNotificationUPP userUPP);
	 ...
	 */
	EXTERN_API_C(Boolean)
	InvokeDataBrowserAddDragItemUPP(ControlRef browser, DragReference theDrag, DataBrowserItemID item,
									ItemReference *itemRef, DataBrowserAddDragItemUPP userUPP);
	 ...
	 */
	EXTERN_API_C(Boolean)
	InvokeDataBrowserAcceptDragUPP(ControlRef browser, DragReference theDrag, DataBrowserItemID item,
	 ...
	 */
	EXTERN_API_C(Boolean)
	InvokeDataBrowserReceiveDragUPP(ControlRef browser, DragReference theDrag, DataBrowserItemID item,
	 ...
	 */
	EXTERN_API_C(void)
	InvokeDataBrowserPostProcessDragUPP(ControlRef browser, DragReference theDrag, OSStatus trackDragResult,
	 ...
	 */
	EXTERN_API_C(void)
	InvokeDataBrowserGetContextualMenuUPP(ControlRef browser, MenuRef *menu, UInt32 *helpType,
										  CFStringRef *helpItemString, AEDesc *selection,
	 ...
	 */
	EXTERN_API_C(void)
	InvokeDataBrowserSelectContextualMenuUPP(ControlRef browser, MenuRef menu, UInt32 selectionType, SInt16 menuID,
	 ...
	 */
	EXTERN_API_C(void)
	InvokeDataBrowserItemHelpContentUPP(ControlRef browser, DataBrowserItemID item, DataBrowserPropertyID property,
...
#define InitializeDataBrowserCallbacks(callbacks, vers) \
	 ...
	 */
	EXTERN_API(OSStatus)
	SetDataBrowserCallbacks(ControlRef browser, const DataBrowserCallbacks *callbacks);
	...
	typedef CALLBACK_API(void, DataBrowserDrawItemProcPtr)(ControlRef browser, DataBrowserItemID item,
														   DataBrowserPropertyID property,
														   DataBrowserItemState itemState, const Rect *theRect,
														   SInt16 gdDepth, Boolean colorDevice);
	typedef CALLBACK_API(Boolean, DataBrowserEditItemProcPtr)(ControlRef browser, DataBrowserItemID item,
															  DataBrowserPropertyID property, CFStringRef theString,
															  Rect *maxEditTextRect, Boolean *shrinkToFit);
	typedef CALLBACK_API(Boolean, DataBrowserHitTestProcPtr)(ControlRef browser, DataBrowserItemID itemID,
															 DataBrowserPropertyID property, const Rect *theRect,
															 const Rect *mouseRect);
	typedef CALLBACK_API(DataBrowserTrackingResult,
						 DataBrowserTrackingProcPtr)(ControlRef browser, DataBrowserItemID itemID,
													 DataBrowserPropertyID property, const Rect *theRect, Point startPt,
													 EventModifiers modifiers);
	typedef CALLBACK_API(void, DataBrowserItemDragRgnProcPtr)(ControlRef browser, DataBrowserItemID itemID,
															  DataBrowserPropertyID property, const Rect *theRect,
															  RgnHandle dragRgn);
	typedef CALLBACK_API(DataBrowserDragFlags,
						 DataBrowserItemAcceptDragProcPtr)(ControlRef browser, DataBrowserItemID itemID,
														   DataBrowserPropertyID property, const Rect *theRect,
														   DragReference theDrag);
	typedef CALLBACK_API(Boolean, DataBrowserItemReceiveDragProcPtr)(ControlRef browser, DataBrowserItemID itemID,
																	 DataBrowserPropertyID property,
	 ...
	 */
	EXTERN_API_C(void)
	InvokeDataBrowserDrawItemUPP(ControlRef browser, DataBrowserItemID item, DataBrowserPropertyID property,
								 DataBrowserItemState itemState, const Rect *theRect, SInt16 gdDepth,
								 Boolean colorDevice, DataBrowserDrawItemUPP userUPP);
	 ...
	 */
	EXTERN_API_C(Boolean)
	InvokeDataBrowserEditItemUPP(ControlRef browser, DataBrowserItemID item, DataBrowserPropertyID property,
	 ...
	 */
	EXTERN_API_C(Boolean)
	InvokeDataBrowserHitTestUPP(ControlRef browser, DataBrowserItemID itemID, DataBrowserPropertyID property,
								const Rect *theRect, const Rect *mouseRect, DataBrowserHitTestUPP userUPP);
	...
	InvokeDataBrowserTrackingUPP(ControlRef browser, DataBrowserItemID itemID, DataBrowserPropertyID property,
								 const Rect *theRect, Point startPt, EventModifiers modifiers,
	 ...
	 */
	EXTERN_API_C(void)
	InvokeDataBrowserItemDragRgnUPP(ControlRef browser, DataBrowserItemID itemID, DataBrowserPropertyID property,
									const Rect *theRect, RgnHandle dragRgn, DataBrowserItemDragRgnUPP userUPP);
	...
	InvokeDataBrowserItemAcceptDragUPP(ControlRef browser, DataBrowserItemID itemID, DataBrowserPropertyID property,
	 ...
	 */
	EXTERN_API_C(Boolean)
	InvokeDataBrowserItemReceiveDragUPP(ControlRef browser, DataBrowserItemID itemID, DataBrowserPropertyID property,
										DataBrowserDragFlags dragFlags, DragReference theDrag,
...
#define InitializeDataBrowserCustomCallbacks(callbacks, vers) \
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserCustomCallbacks(ControlRef browser, DataBrowserCustomCallbacks *callbacks);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetDataBrowserCustomCallbacks(ControlRef browser, const DataBrowserCustomCallbacks *callbacks);
	 ...
	 */
	EXTERN_API(OSStatus)
	RemoveDataBrowserTableViewColumn(ControlRef browser, DataBrowserTableViewColumnID column);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetDataBrowserTableViewHiliteStyle(ControlRef browser, DataBrowserTableViewHiliteStyle hiliteStyle);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserTableViewHiliteStyle(ControlRef browser, DataBrowserTableViewHiliteStyle *hiliteStyle);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetDataBrowserTableViewItemRowHeight(ControlRef browser, DataBrowserItemID item, UInt16 height);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserTableViewItemRowHeight(ControlRef browser, DataBrowserItemID item, UInt16 *height);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetDataBrowserTableViewNamedColumnWidth(ControlRef browser, DataBrowserTableViewColumnID column, UInt16 width);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserTableViewNamedColumnWidth(ControlRef browser, DataBrowserTableViewColumnID column, UInt16 *width);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetDataBrowserTableViewGeometry(ControlRef browser, Boolean variableWidthColumns, Boolean variableHeightRows);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserTableViewGeometry(ControlRef browser, Boolean *variableWidthColumns, Boolean *variableHeightRows);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserTableViewItemID(ControlRef browser, DataBrowserTableViewRowIndex row, DataBrowserItemID *item);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetDataBrowserTableViewItemRow(ControlRef browser, DataBrowserItemID item, DataBrowserTableViewRowIndex row);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserTableViewItemRow(ControlRef browser, DataBrowserItemID item, DataBrowserTableViewRowIndex *row);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetDataBrowserTableViewColumnPosition(ControlRef browser, DataBrowserTableViewColumnID column,
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserTableViewColumnPosition(ControlRef browser, DataBrowserTableViewColumnID column,
										  DataBrowserTableViewColumnIndex *position);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserTableViewColumnProperty(ControlRef browser, DataBrowserTableViewColumnIndex column,
	 ...
	 */
	EXTERN_API(OSStatus)
	AddDataBrowserListViewColumn(ControlRef browser, DataBrowserListViewColumnDesc *columnDesc,
								 DataBrowserTableViewColumnIndex position);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserListViewHeaderDesc(ControlRef browser, DataBrowserTableViewColumnID column,
	 ...
	 */
	EXTERN_API(OSStatus)
	SetDataBrowserListViewHeaderDesc(ControlRef browser, DataBrowserTableViewColumnID column,
									 DataBrowserListViewHeaderDesc *desc);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetDataBrowserListViewUsePlainBackground(ControlRef browser, Boolean usePlainBackground);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserListViewUsePlainBackground(ControlRef browser, Boolean *usePlainBackground);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetDataBrowserListViewDisclosureColumn(ControlRef browser, DataBrowserTableViewColumnID column,
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserListViewDisclosureColumn(ControlRef browser, DataBrowserTableViewColumnID *column,
										   Boolean *expandableRows);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetDataBrowserColumnViewPath(ControlRef browser, UInt32 length, const DataBrowserItemID *path);
	 ...
	 */
	EXTERN_API(OSStatus)
	SetDataBrowserColumnViewDisplayType(ControlRef browser, DataBrowserPropertyType propertyType);
	 ...
	 */
	EXTERN_API(OSStatus)
	GetDataBrowserColumnViewDisplayType(ControlRef browser, DataBrowserPropertyType *propertyType);
	...
	typedef CALLBACK_API(Boolean, EditUnicodePostUpdateProcPtr)(UniCharArrayHandle uniText, UniCharCount uniTextLength,
	 ...
	 */
	EXTERN_API_C(Boolean)
	InvokeEditUnicodePostUpdateUPP(UniCharArrayHandle uniText, UniCharCount uniTextLength,
								   UniCharArrayOffset iStartOffset, UniCharArrayOffset iEndOffset, void *refcon,
	 ...
	 */
	EXTERN_API(OSStatus)
	CreateEditUnicodeTextControl(WindowRef window, const Rect *boundsRect, CFStringRef text, Boolean isPassword,
