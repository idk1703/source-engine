...
#pragma import on
	...
	ATSUDirectGetLayoutDataArrayPtrFromLineRef(ATSULineRef iLineRef, ATSUDirectDataSelector iDataSelector,
											   Boolean iCreate, void *oLayoutDataArrayPtr[], /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ATSUDirectGetLayoutDataArrayPtrFromTextLayout(ATSUTextLayout iTextLayout, UniCharArrayOffset iLineOffset,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ATSUDirectReleaseLayoutDataArrayPtr(ATSULineRef iLineRef, /* can be NULL */
										ATSUDirectDataSelector iDataSelector, void *iLayoutDataArrayPtr[]);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	ATSUDirectAddStyleSettingRef(ATSULineRef iLineRef, ATSUStyleSettingRef iStyleSettingRef, UInt16 *oStyleIndex);
