...
#define kQTVRUnknownType '\?\?\?\?' /* Unknown node type */
	...
	enum
	{
		kQTVRInteractionMouseClickHysteresis =
			1, /* pixels within which the mouse is considered not to have moved (UInt16)*/
		kQTVRInteractionMouseClickTimeout =
			2, /* ticks after which a mouse click times out and turns into panning (UInt32)*/
		kQTVRInteractionPanTiltSpeed =
			3, /* control the relative pan/tilt speed from 1 (slowest) to 10 (fastest). (UInt32) Default is 5;*/
		kQTVRInteractionZoomSpeed =
			4, /* control the relative zooming speed from 1 (slowest) to 10 (fastest). (UInt32) Default is 5;*/
		kQTVRInteractionTranslateOnMouseDown =
			101, /* Holding MouseDown with this setting translates zoomed object movies (Boolean)*/
		kQTVRInteractionMouseMotionScale =
			102, /* The maximum angle of rotation caused by dragging across the display window. (* float)*/
		kQTVRInteractionNudgeMode =
			103 /* A QTVRNudgeMode: rotate, translate, or the same as the current mouse mode. Requires QTVR 2.1*/
	};
	...
	/* QTVR-specific pixelFormat constants used in QTVRSetBackBufferPrefs, QTVRGetBackBufferSettings,
	...
	enum
	{
		...
		mcFlagQTVRExplicitFlagSet =
			1L << 31 /* bits 0->30 should be interpreted as "explicit on" for the corresponding suppression bits*/
	};
	...
	enum
	{
		...
		kQTVRBackBufferHorizontal =
			1L << 3 /* Requires that backbuffer proc be long-rowBytes aware (gestaltQDHasLongRowBytes)*/
	};
	...
	*/
	...
	typedef CALLBACK_API(OSErr, QTVRLeavingNodeProcPtr)(QTVRInstance qtvr, UInt32 fromNodeID, UInt32 toNodeID,
	...
	typedef CALLBACK_API(OSErr, QTVRMouseOverHotSpotProcPtr)(QTVRInstance qtvr, UInt32 hotSpotID, UInt32 flags,
															 SInt32 refCon);
	typedef CALLBACK_API(OSErr, QTVRImagingCompleteProcPtr)(QTVRInstance qtvr, SInt32 refCon);
	typedef CALLBACK_API(OSErr, QTVRBackBufferImagingProcPtr)(QTVRInstance qtvr, Rect *drawRect, UInt16 areaIndex,
															  UInt32 flagsIn, UInt32 *flagsOut, SInt32 refCon);
	...
	{
		return (QTVRLeavingNodeUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppQTVRLeavingNodeProcInfo,
														GetCurrentArchitecture());
	}
#else
#define NewQTVRLeavingNodeUPP(userRoutine) \
	(QTVRLeavingNodeUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppQTVRLeavingNodeProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (QTVREnteringNodeUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppQTVREnteringNodeProcInfo,
														 GetCurrentArchitecture());
	}
#else
#define NewQTVREnteringNodeUPP(userRoutine) \
	(QTVREnteringNodeUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppQTVREnteringNodeProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (QTVRMouseOverHotSpotUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppQTVRMouseOverHotSpotProcInfo,
															 GetCurrentArchitecture());
	}
#else
#define NewQTVRMouseOverHotSpotUPP(userRoutine) \
	(QTVRMouseOverHotSpotUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppQTVRMouseOverHotSpotProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (QTVRImagingCompleteUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppQTVRImagingCompleteProcInfo,
															GetCurrentArchitecture());
	}
#else
#define NewQTVRImagingCompleteUPP(userRoutine) \
	(QTVRImagingCompleteUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppQTVRImagingCompleteProcInfo, GetCurrentArchitecture())
#endif
#endif
	...
	{
		return (QTVRBackBufferImagingUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppQTVRBackBufferImagingProcInfo,
															  GetCurrentArchitecture());
	}
#else
#define NewQTVRBackBufferImagingUPP(userRoutine) \
	(QTVRBackBufferImagingUPP)                   \
		NewRoutineDescriptor((ProcPtr)(userRoutine), uppQTVRBackBufferImagingProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeQTVRBackBufferImagingUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeQTVRLeavingNodeUPP(QTVRInstance qtvr, UInt32 fromNodeID, UInt32 toNodeID, Boolean *cancel, SInt32 refCon,
							 QTVRLeavingNodeUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSErr) InvokeQTVRLeavingNodeUPP(QTVRInstance qtvr, UInt32 fromNodeID, UInt32 toNodeID,
														Boolean *cancel, SInt32 refCon, QTVRLeavingNodeUPP userUPP)
	{
		return (OSErr)CALL_FIVE_PARAMETER_UPP(userUPP, uppQTVRLeavingNodeProcInfo, qtvr, fromNodeID, toNodeID, cancel,
											  refCon);
	}
#else
#define InvokeQTVRLeavingNodeUPP(qtvr, fromNodeID, toNodeID, cancel, refCon, userUPP)                                  \
	(OSErr) CALL_FIVE_PARAMETER_UPP((userUPP), uppQTVRLeavingNodeProcInfo, (qtvr), (fromNodeID), (toNodeID), (cancel), \
									(refCon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeQTVREnteringNodeUPP(QTVRInstance qtvr, UInt32 nodeID, SInt32 refCon, QTVREnteringNodeUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
...
#define InvokeQTVREnteringNodeUPP(qtvr, nodeID, refCon, userUPP) \
	(OSErr) CALL_THREE_PARAMETER_UPP((userUPP), uppQTVREnteringNodeProcInfo, (qtvr), (nodeID), (refCon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeQTVRMouseOverHotSpotUPP(QTVRInstance qtvr, UInt32 hotSpotID, UInt32 flags, SInt32 refCon,
								  QTVRMouseOverHotSpotUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSErr) InvokeQTVRMouseOverHotSpotUPP(QTVRInstance qtvr, UInt32 hotSpotID, UInt32 flags,
...
#define InvokeQTVRMouseOverHotSpotUPP(qtvr, hotSpotID, flags, refCon, userUPP) \
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeQTVRImagingCompleteUPP(QTVRInstance qtvr, SInt32 refCon, QTVRImagingCompleteUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSErr)
		InvokeQTVRImagingCompleteUPP(QTVRInstance qtvr, SInt32 refCon, QTVRImagingCompleteUPP userUPP)
...
#define InvokeQTVRImagingCompleteUPP(qtvr, refCon, userUPP) \
	(OSErr) CALL_TWO_PARAMETER_UPP((userUPP), uppQTVRImagingCompleteProcInfo, (qtvr), (refCon))
#endif
#endif
	 ...
	 */
	EXTERN_API_C(OSErr)
	InvokeQTVRBackBufferImagingUPP(QTVRInstance qtvr, Rect *drawRect, UInt16 areaIndex, UInt32 flagsIn,
								   UInt32 *flagsOut, SInt32 refCon, QTVRBackBufferImagingUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(OSErr)
		InvokeQTVRBackBufferImagingUPP(QTVRInstance qtvr, Rect *drawRect, UInt16 areaIndex, UInt32 flagsIn,
									   UInt32 *flagsOut, SInt32 refCon, QTVRBackBufferImagingUPP userUPP)
	{
		return (OSErr)CALL_SIX_PARAMETER_UPP(userUPP, uppQTVRBackBufferImagingProcInfo, qtvr, drawRect, areaIndex,
											 flagsIn, flagsOut, refCon);
	}
#else
#define InvokeQTVRBackBufferImagingUPP(qtvr, drawRect, areaIndex, flagsIn, flagsOut, refCon, userUPP)            \
	(OSErr) CALL_SIX_PARAMETER_UPP((userUPP), uppQTVRBackBufferImagingProcInfo, (qtvr), (drawRect), (areaIndex), \
								   (flagsIn), (flagsOut), (refCon))
#endif
#endif
...
#define CallQTVRLeavingNodeProc(userRoutine, qtvr, fromNodeID, toNodeID, cancel, refCon) \
	InvokeQTVRLeavingNodeUPP(qtvr, fromNodeID, toNodeID, cancel, refCon, userRoutine)
#define CallQTVREnteringNodeProc(userRoutine, qtvr, nodeID, refCon) \
	InvokeQTVREnteringNodeUPP(qtvr, nodeID, refCon, userRoutine)
#define CallQTVRMouseOverHotSpotProc(userRoutine, qtvr, hotSpotID, flags, refCon) \
...
#define CallQTVRBackBufferImagingProc(userRoutine, qtvr, drawRect, areaIndex, flagsIn, flagsOut, refCon) \
	InvokeQTVRBackBufferImagingUPP(qtvr, drawRect, areaIndex, flagsIn, flagsOut, refCon, userRoutine)
	...
	*/
	...
	typedef CALLBACK_API(void, QTVRInterceptProcPtr)(QTVRInstance qtvr, QTVRInterceptPtr qtvrMsg, SInt32 refCon,
													 Boolean *cancel);
	...
	{
		return (QTVRInterceptUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppQTVRInterceptProcInfo,
													  GetCurrentArchitecture());
	}
#else
#define NewQTVRInterceptUPP(userRoutine) \
	(QTVRInterceptUPP) NewRoutineDescriptor((ProcPtr)(userRoutine), uppQTVRInterceptProcInfo, GetCurrentArchitecture())
#endif
#endif
...
#define DisposeQTVRInterceptUPP(userUPP) DisposeRoutineDescriptor(userUPP)
	 ...
	 */
	EXTERN_API_C(void)
	InvokeQTVRInterceptUPP(QTVRInstance qtvr, QTVRInterceptPtr qtvrMsg, SInt32 refCon, Boolean *cancel,
						   QTVRInterceptUPP userUPP);
#if !OPAQUE_UPP_TYPES
#ifdef __cplusplus
	inline DEFINE_API_C(void) InvokeQTVRInterceptUPP(QTVRInstance qtvr, QTVRInterceptPtr qtvrMsg, SInt32 refCon,
													 Boolean *cancel, QTVRInterceptUPP userUPP)
	{
...
*/
	...
	*/
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRSetViewParameter(QTVRInstance qtvr, UInt32 viewParameter, void *value, UInt32 flagsIn);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRGetViewParameter(QTVRInstance qtvr, UInt32 viewParameter, void *value, UInt32 flagsIn, UInt32 *flagsOut);
	...
	*/
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRTriggerHotSpot(QTVRInstance qtvr, UInt32 hotSpotID, QTAtomContainer nodeInfo, QTAtom selectedAtom);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRSetMouseOverHotSpotProc(QTVRInstance qtvr, QTVRMouseOverHotSpotUPP mouseOverHotSpotProc, SInt32 refCon,
								UInt32 flags);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVREnableHotSpot(QTVRInstance qtvr, UInt32 enableFlag, UInt32 hotSpotValue, Boolean enable);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRGetHotSpotRegion(QTVRInstance qtvr, UInt32 hotSpotID, RgnHandle hotSpotRegion);
	...
	*/
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRMouseDown(QTVRInstance qtvr, Point pt, UInt32 when, UInt16 modifiers, UInt32 *hotSpotID, WindowRef w);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRMouseStillDownExtended(QTVRInstance qtvr, Point pt, UInt32 *hotSpotID, WindowRef w, UInt32 when,
							   UInt16 modifiers);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRMouseUpExtended(QTVRInstance qtvr, Point pt, UInt32 *hotSpotID, WindowRef w, UInt32 when, UInt16 modifiers);
	...
	*/
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRInstallInterceptProc(QTVRInstance qtvr, QTVRProcSelector selector, QTVRInterceptUPP interceptProc,
	...
	*/
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRSetViewState(QTVRInstance qtvr, QTVRViewStateType viewStateType, UInt16 state);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRGetViewState(QTVRInstance qtvr, QTVRViewStateType viewStateType, UInt16 *state);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRSetAnimationSetting(QTVRInstance qtvr, QTVRObjectAnimationSetting setting, Boolean enable);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRGetAnimationSetting(QTVRInstance qtvr, QTVRObjectAnimationSetting setting, Boolean *enable);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRSetControlSetting(QTVRInstance qtvr, QTVRControlSetting setting, Boolean enable);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRGetControlSetting(QTVRInstance qtvr, QTVRControlSetting setting, Boolean *enable);
	...
	*/
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRSetImagingProperty(QTVRInstance qtvr, QTVRImagingMode imagingMode, UInt32 imagingProperty,
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRGetImagingProperty(QTVRInstance qtvr, QTVRImagingMode imagingMode, UInt32 imagingProperty,
						   SInt32 *propertyValue);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRSetTransitionProperty(QTVRInstance qtvr, UInt32 transitionType, UInt32 transitionProperty,
	...
	*/
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRCoordToAngles(QTVRInstance qtvr, QTVRFloatPoint *coord, float *panAngle, float *tiltAngle);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRAnglesToCoord(QTVRInstance qtvr, float panAngle, float tiltAngle, QTVRFloatPoint *coord);
	...
	*/
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRSetEnteringNodeProc(QTVRInstance qtvr, QTVREnteringNodeUPP enteringNodeProc, SInt32 refCon, UInt32 flags);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRSetLeavingNodeProc(QTVRInstance qtvr, QTVRLeavingNodeUPP leavingNodeProc, SInt32 refCon, UInt32 flags);
	...
	*/
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRGetViewingLimits(QTVRInstance qtvr, UInt16 kind, float *minValue, float *maxValue);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRGetConstraints(QTVRInstance qtvr, UInt16 kind, float *minValue, float *maxValue);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRSetConstraints(QTVRInstance qtvr, UInt16 kind, float minValue, float maxValue);
	...
	*/
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRGetBackBufferMemInfo(QTVRInstance qtvr, UInt32 geometry, UInt16 resolution, UInt32 cachePixelFormat,
							 SInt32 *minCacheBytes, SInt32 *suggestedCacheBytes, SInt32 *fullCacheBytes);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRGetBackBufferSettings(QTVRInstance qtvr, UInt32 *geometry, UInt16 *resolution, UInt32 *cachePixelFormat,
							  SInt16 *cacheSize);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRSetBackBufferPrefs(QTVRInstance qtvr, UInt32 geometry, UInt16 resolution, UInt32 cachePixelFormat,
						   SInt16 cacheSize);
	...
	*/
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRSetPrescreenImagingCompleteProc(QTVRInstance qtvr, QTVRImagingCompleteUPP imagingCompleteProc, SInt32 refCon,
										UInt32 flags);
	 ...
	 */
	EXTERN_API_C(OSErr)
	QTVRSetBackBufferImagingProc(QTVRInstance qtvr, QTVRBackBufferImagingUPP backBufferImagingProc, UInt16 numAreas,
								 QTVRAreaOfInterest areasOfInterest[], SInt32 refCon);
