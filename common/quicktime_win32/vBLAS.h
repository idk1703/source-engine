...
#pragma options(!pack_enums)
	...
	*/
	...
	/*
		------------------------------------------------------------------------------------------------------------------
		IsAlignedCount   - True if an integer is positive and a multiple of 4.  Negative strides are considered
	   unaligned. IsAlignedAddr    - True if an address is a multiple of 16.
	*/
...
#define IsAlignedAddr(a)  (((long)a & 15L) == 0)
	...
	*/
	 ...
	 */
	EXTERN_API_C(void)
	cblas_sgemv(CBLAS_ORDER order, CBLAS_TRANSPOSE transA, int M, int N, float alpha, const float *A, int lda,
	...
	*/
	 ...
	 */
	EXTERN_API_C(void)
	cblas_sgemm(CBLAS_ORDER order, CBLAS_TRANSPOSE transA, CBLAS_TRANSPOSE transB, int M, int N, int K, float alpha,
	...
	*/
	 ...
	 */
	EXTERN_API_C(void)
	vMultVecMat_4x4(ConstVectorFloat X[1], ConstVectorFloat A[4][1], vector float Y[1]);
	 ...
	 */
	EXTERN_API_C(void)
	vMultMatVec_4x4(ConstVectorFloat A[4][1], ConstVectorFloat X[1], vector float Y[1]);
	 ...
	 */
	EXTERN_API_C(void)
	vMultMatMat_4x4(ConstVectorFloat A[4][1], ConstVectorFloat B[4][1], vector float C[4][1]);
	 ...
	 */
	EXTERN_API_C(void)
	vMultVecMat_8x8(ConstVectorFloat X[2], ConstVectorFloat A[8][2], vector float Y[2]);
	 ...
	 */
	EXTERN_API_C(void)
	vMultMatVec_8x8(ConstVectorFloat A[8][2], ConstVectorFloat X[2], vector float Y[2]);
	 ...
	 */
	EXTERN_API_C(void)
	vMultMatMat_8x8(ConstVectorFloat A[8][2], ConstVectorFloat B[8][2], vector float C[8][2]);
	 ...
	 */
	EXTERN_API_C(void)
	vMultVecMat_16x16(ConstVectorFloat X[4], ConstVectorFloat A[16][4], vector float Y[4]);
	 ...
	 */
	EXTERN_API_C(void)
	vMultMatVec_16x16(ConstVectorFloat A[16][4], ConstVectorFloat X[4], vector float Y[4]);
	 ...
	 */
	EXTERN_API_C(void)
	vMultMatMat_16x16(ConstVectorFloat A[16][4], ConstVectorFloat B[16][4], vector float C[16][4]);
	 ...
	 */
	EXTERN_API_C(void)
	vMultVecMat_32x32(ConstVectorFloat X[8], ConstVectorFloat A[32][8], vector float Y[8]);
	 ...
	 */
	EXTERN_API_C(void)
	vMultMatVec_32x32(ConstVectorFloat A[32][8], ConstVectorFloat X[8], vector float Y[8]);
	 ...
	 */
	EXTERN_API_C(void)
	vMultMatMat_32x32(ConstVectorFloat A[32][8], ConstVectorFloat B[32][8], vector float C[32][8]);
	...
	*/
	...
	typedef CALLBACK_API_C(void, BLASParamErrorProc)(const char *funcName, const char *paramName, const int *paramPos,
