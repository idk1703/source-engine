...
#define kHIViewClassID CFSTR("com.apple.hiview")
	...
	HIViewAddSubview(HIViewRef inParent, HIViewRef inNewChild);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewSetZOrder(HIViewRef inView, HIViewZOrderOp inOp, HIViewRef inOther); /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewSetVisible(HIViewRef inView, Boolean inVisible);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewGetBounds(HIViewRef inView, HIRect *outRect);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewGetFrame(HIViewRef inView, HIRect *outRect);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewSetFrame(HIViewRef inView, const HIRect *inRect);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewMoveBy(HIViewRef inView, float inDX, float inDY);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewPlaceInSuperviewAt(HIViewRef inView, float inX, float inY);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewGetViewForMouseEvent(HIViewRef inView, EventRef inEvent, HIViewRef *outView);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewClick(HIViewRef inView, EventRef inEvent);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewSimulateClick(HIViewRef inView, HIViewPartCode inPartToClick, UInt32 inModifiers,
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewGetPartHit(HIViewRef inView, const HIPoint *inPoint, HIViewPartCode *outPart);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewGetSubviewHit(HIViewRef inView, const HIPoint *inPoint, Boolean inDeep, HIViewRef *outView);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewSetNeedsDisplay(HIViewRef inView, Boolean inNeedsDisplay);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewSetNeedsDisplayInRegion(HIViewRef inView, RgnHandle inRgn, Boolean inNeedsDisplay);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewGetSizeConstraints(HIViewRef inView, HISize *outMinSize, HISize *outMaxSize);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewConvertPoint(HIPoint *ioPoint, HIViewRef inSourceView, HIViewRef inDestView);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewConvertRect(HIRect *ioRect, HIViewRef inSourceView, HIViewRef inDestView);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewConvertRegion(RgnHandle ioRgn, HIViewRef inSourceView, HIViewRef inDestView);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewSetDrawingEnabled(HIViewRef inView, Boolean inEnabled);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewScrollRect(HIViewRef inView, const HIRect *inRect, /* can be NULL */
					 float inDX, float inDY);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewSetBoundsOrigin(HIViewRef inView, float inX, float inY);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewAdvanceFocus(HIViewRef inRootForFocus, EventModifiers inModifiers);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewGetFocusPart(HIViewRef inView, HIViewPartCode *outFocusPart);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewSetNextFocus(HIViewRef inView, HIViewRef inNextFocus); /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewSetFirstSubViewFocus(HIViewRef inParent, HIViewRef inSubView); /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewFindByID(HIViewRef inStartView, HIViewID inID, HIViewRef *outControl);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewGetAttributes(HIViewRef inView, OptionBits *outAttrs);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewChangeAttributes(HIViewRef inView, OptionBits inAttrsToSet, OptionBits inAttrsToClear);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewCreateOffscreenImage(HIViewRef inView, OptionBits inOptions, HIRect *outFrame, /* can be NULL */
							   CGImageRef *outImage);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIViewDrawCGImage(CGContextRef inContext, const HIRect *inBounds, CGImageRef inImage);
...
#define kHIGrowBoxViewClassID CFSTR("com.apple.higrowboxview")
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIGrowBoxViewSetTransparent(HIViewRef inGrowBoxView, Boolean inTransparent);
	...
	enum
	{
		...
		kHIScrollViewValidOptions =
			(kHIScrollViewOptionsVertScroll | kHIScrollViewOptionsHorizScroll | kHIScrollViewOptionsAllowGrow)
	};
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIScrollViewCreate(OptionBits inOptions, HIViewRef *outView);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIScrollViewSetScrollBarAutoHide(HIViewRef inView, Boolean inAutoHide);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIImageViewCreate(CGImageRef inImage, /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIImageViewSetOpaque(HIViewRef inView, Boolean inOpaque);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIImageViewSetAlpha(HIViewRef inView, float inAlpha);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIImageViewSetScaleToFit(HIViewRef inView, Boolean inScaleToFit);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIImageViewSetImage(HIViewRef inView, CGImageRef inImage); /* can be NULL */
	...
	enum
	{
		...
		kHIComboBoxStandardAttributes =
			(kHIComboBoxAutoCompletionAttribute | kHIComboBoxAutoDisclosureAttribute | kHIComboBoxAutoSizeListAttribute)
	};
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIComboBoxCreate(const HIRect *boundsRect, CFStringRef text, /* can be NULL */
					 const ControlFontStyleRec *style,			 /* can be NULL */
					 CFArrayRef list,							 /* can be NULL */
					 OptionBits inAttributes, HIViewRef *outComboBox);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIComboBoxInsertTextItemAtIndex(HIViewRef inComboBox, CFIndex inIndex, CFStringRef inText);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIComboBoxAppendTextItem(HIViewRef inComboBox, CFStringRef inText, CFIndex *outIndex); /* can be NULL */
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIComboBoxCopyTextItemAtIndex(HIViewRef inComboBox, CFIndex inIndex, CFStringRef *outString);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIComboBoxRemoveItemAtIndex(HIViewRef inComboBox, CFIndex inIndex);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIComboBoxChangeAttributes(HIViewRef inComboBox, OptionBits inAttributesToSet, OptionBits inAttributesToClear);
	 ...
	 */
	EXTERN_API_C(OSStatus)
	HIComboBoxGetAttributes(HIViewRef inComboBox, OptionBits *outAttributes);
