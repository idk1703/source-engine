...
#define FOUR_CHAR_CODE(x)                                                                  \
	(((unsigned long)((x)&0x000000FF)) << 24) | (((unsigned long)((x)&0x0000FF00)) << 8) | \
		(((unsigned long)((x)&0x00FF0000)) >> 8) | (((unsigned long)((x)&0xFF000000)) >> 24)
#define TYPE_EXTENDED			  0
#define TYPE_LONGDOUBLE_IS_DOUBLE 1
#define TYPE_LONGLONG			  0
#define TYPE_BOOL				  0
...
/****************************************************************************************************
	...
	CGLUESUPPORTED          - Clients can use all lowercase toolbox functions that take C strings instead of pascal
strings
