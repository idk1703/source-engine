...
#define Endian64_Swap(value)                                                                           \
	(((((UInt64)value) << 56) & 0xFF00000000000000) | ((((UInt64)value) << 40) & 0x00FF000000000000) | \
	 ((((UInt64)value) << 24) & 0x0000FF0000000000) | ((((UInt64)value) << 8) & 0x000000FF00000000) |  \
	 ((((UInt64)value) >> 8) & 0x00000000FF000000) | ((((UInt64)value) >> 24) & 0x0000000000FF0000) |  \
	 ((((UInt64)value) >> 40) & 0x000000000000FF00) | ((((UInt64)value) >> 56) & 0x00000000000000FF))
#else
#define Endian64_Swap(value)                                                                                 \
	(((((UInt64)value) << 56) & 0xFF00000000000000ULL) | ((((UInt64)value) << 40) & 0x00FF000000000000ULL) | \
	 ((((UInt64)value) << 24) & 0x0000FF0000000000ULL) | ((((UInt64)value) << 8) & 0x000000FF00000000ULL) |  \
	 ((((UInt64)value) >> 8) & 0x00000000FF000000ULL) | ((((UInt64)value) >> 24) & 0x0000000000FF0000ULL) |  \
	 ((((UInt64)value) >> 40) & 0x000000000000FF00ULL) | ((((UInt64)value) >> 56) & 0x00000000000000FFULL))
#endif
#else
/*
