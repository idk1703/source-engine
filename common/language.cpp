...
struct Language_t
{
	...
	const char
		*m_pchICUName; // used by osx; ISO-639-1 + ISO-3166-1 alpha-2. http://userguide.icu-project.org/locale/examples
...
static const Language_t s_LanguageNames[] = {
	...
	{"Traditional_Chinese", "tchinese", "#GameUI_Language_Traditional_Chinese", "zh_TW", k_Lang_Traditional_Chinese,
	 1028},
