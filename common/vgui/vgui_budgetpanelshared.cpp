...
// Global ConVars.
ConVar budget_history_range_ms("budget_history_range_ms", "66.666666667", FCVAR_ARCHIVE,
							   "budget history range in milliseconds", BUDGET_CVAR_CALLBACK);
ConVar budget_panel_bottom_of_history_fraction("budget_panel_bottom_of_history_fraction", ".25", FCVAR_ARCHIVE,
											   "number between 0 and 1", BUDGET_CVAR_CALLBACK);
ConVar budget_bargraph_range_ms("budget_bargraph_range_ms", "16.6666666667", FCVAR_ARCHIVE,
								"budget bargraph range in milliseconds", BUDGET_CVAR_CALLBACK);
...
ConVar budget_panel_y("budget_panel_y", "50", FCVAR_ARCHIVE,
					  ...
					  BUDGET_CVAR_CALLBACK);
ConVar budget_panel_width("budget_panel_width", "512", FCVAR_ARCHIVE, "width in pixels of the budget panel",
						  BUDGET_CVAR_CALLBACK);
ConVar budget_panel_height("budget_panel_height", "384", FCVAR_ARCHIVE, "height in pixels of the budget panel",
						   BUDGET_CVAR_CALLBACK);
...
void CBudgetPanelShared::DrawColoredText(vgui::HFont font, int x, int y, int r, int g, int b, int a, const char *pText,
										 ...)
{
	char msg[4096];
	va_list marker;
